...
// checks if the ViewLinkRequestKeys type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewLinkRequestKeys{}
...
func (o ViewLinkRequestKeys) MarshalJSON() ([]byte, error) {
...
func (o *ViewLinkRequestKeys) UnmarshalJSON(data []byte) (err error) {
...
type NullableViewLinkRequestKeys struct {
	value *ViewLinkRequestKeys
	isSet bool
}

func (v NullableViewLinkRequestKeys) Get() *ViewLinkRequestKeys {
	return v.value
}

func (v *NullableViewLinkRequestKeys) Set(val *ViewLinkRequestKeys) {
	v.value = val
	v.isSet = true
}

func (v NullableViewLinkRequestKeys) IsSet() bool {
	return v.isSet
}

func (v *NullableViewLinkRequestKeys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewLinkRequestKeys(val *ViewLinkRequestKeys) *NullableViewLinkRequestKeys {
	return &NullableViewLinkRequestKeys{value: val, isSet: true}
}

func (v NullableViewLinkRequestKeys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewLinkRequestKeys) UnmarshalJSON(src []byte) error {
	v.isSet = true
