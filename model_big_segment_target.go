...
// checks if the BigSegmentTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BigSegmentTarget{}
...
type _BigSegmentTarget BigSegmentTarget
...
func (o BigSegmentTarget) ToMap() (map[string]interface{}, error) {
...
func (o *BigSegmentTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varBigSegmentTarget := _BigSegmentTarget{}

	err = json.Unmarshal(data, &varBigSegmentTarget)

	if err != nil {
		return err
	}

	*o = BigSegmentTarget(varBigSegmentTarget)
