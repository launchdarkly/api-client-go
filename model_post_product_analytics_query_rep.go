...
// PostProductAnalyticsQueryRep struct for PostProductAnalyticsQueryRep
type PostProductAnalyticsQueryRep struct {
	StartTimestamp int64 `json:"startTimestamp"`
	EndTimestamp int64 `json:"endTimestamp"`
	MetricQueries []MetricQueryRep `json:"metricQueries"`
}
...
func NewPostProductAnalyticsQueryRep(startTimestamp int64, endTimestamp int64, metricQueries []MetricQueryRep) *PostProductAnalyticsQueryRep {
	this := PostProductAnalyticsQueryRep{}
...
// GetMetricQueries returns the MetricQueries field value
func (o *PostProductAnalyticsQueryRep) GetMetricQueries() []MetricQueryRep {
	if o == nil {
		var ret []MetricQueryRep
		return ret
	}
...
// GetMetricQueriesOk returns a tuple with the MetricQueries field value
// and a boolean to check if the value has been set.
...
// SetMetricQueries sets field value
func (o *PostProductAnalyticsQueryRep) SetMetricQueries(v []MetricQueryRep) {
	o.MetricQueries = v
}

func (o PostProductAnalyticsQueryRep) MarshalJSON() ([]byte, error) {
...
type NullablePostProductAnalyticsQueryRep struct {
	value *PostProductAnalyticsQueryRep
	isSet bool
}

func (v NullablePostProductAnalyticsQueryRep) Get() *PostProductAnalyticsQueryRep {
	return v.value
}

func (v *NullablePostProductAnalyticsQueryRep) Set(val *PostProductAnalyticsQueryRep) {
	v.value = val
	v.isSet = true
}

func (v NullablePostProductAnalyticsQueryRep) IsSet() bool {
	return v.isSet
}

func (v *NullablePostProductAnalyticsQueryRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostProductAnalyticsQueryRep(val *PostProductAnalyticsQueryRep) *NullablePostProductAnalyticsQueryRep {
	return &NullablePostProductAnalyticsQueryRep{value: val, isSet: true}
}

func (v NullablePostProductAnalyticsQueryRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostProductAnalyticsQueryRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
