...
// checks if the AIConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfig{}
...
func (o AIConfig) ToMap() (map[string]interface{}, error) {
...
func (o *AIConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varAIConfig := _AIConfig{}

	err = json.Unmarshal(data, &varAIConfig)

	if err != nil {
		return err
	}

	*o = AIConfig(varAIConfig)
