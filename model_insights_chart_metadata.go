...
// checks if the InsightsChartMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightsChartMetadata{}
...
type _InsightsChartMetadata InsightsChartMetadata
...
func (o InsightsChartMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *InsightsChartMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightsChartMetadata := _InsightsChartMetadata{}

	err = json.Unmarshal(data, &varInsightsChartMetadata)

	if err != nil {
		return err
	}

	*o = InsightsChartMetadata(varInsightsChartMetadata)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "yAxis")
