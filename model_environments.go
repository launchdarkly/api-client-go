...
type _Environments Environments
...
func (o *Environments) UnmarshalJSON(data []byte) (err error) {
	...
	varEnvironments := _Environments{}

	err = json.Unmarshal(data, &varEnvironments)

	if err != nil {
		return err
	}

	*o = Environments(varEnvironments)
