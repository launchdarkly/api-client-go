...
// checks if the MetricGroupPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricGroupPost{}
...
type _MetricGroupPost MetricGroupPost
...
func (o MetricGroupPost) ToMap() (map[string]interface{}, error) {
...
func (o *MetricGroupPost) UnmarshalJSON(data []byte) (err error) {
	...
	varMetricGroupPost := _MetricGroupPost{}

	err = json.Unmarshal(data, &varMetricGroupPost)

	if err != nil {
		return err
	}

	*o = MetricGroupPost(varMetricGroupPost)
