...
// checks if the IntegrationDeliveryConfigurationCollectionLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationDeliveryConfigurationCollectionLinks{}
...
type _IntegrationDeliveryConfigurationCollectionLinks IntegrationDeliveryConfigurationCollectionLinks
...
func NewIntegrationDeliveryConfigurationCollectionLinks(self Link) *IntegrationDeliveryConfigurationCollectionLinks {
	this := IntegrationDeliveryConfigurationCollectionLinks{}
	this.Self = self
	return &this
}
...
func (o IntegrationDeliveryConfigurationCollectionLinks) ToMap() (map[string]interface{}, error) {
...
func (o *IntegrationDeliveryConfigurationCollectionLinks) UnmarshalJSON(data []byte) (err error) {
	...
	varIntegrationDeliveryConfigurationCollectionLinks := _IntegrationDeliveryConfigurationCollectionLinks{}

	err = json.Unmarshal(data, &varIntegrationDeliveryConfigurationCollectionLinks)

	if err != nil {
		return err
	}

	*o = IntegrationDeliveryConfigurationCollectionLinks(varIntegrationDeliveryConfigurationCollectionLinks)
...
type NullableIntegrationDeliveryConfigurationCollectionLinks struct {
	value *IntegrationDeliveryConfigurationCollectionLinks
	isSet bool
}
...
func NewNullableIntegrationDeliveryConfigurationCollectionLinks(val *IntegrationDeliveryConfigurationCollectionLinks) *NullableIntegrationDeliveryConfigurationCollectionLinks {
	return &NullableIntegrationDeliveryConfigurationCollectionLinks{value: val, isSet: true}
}
