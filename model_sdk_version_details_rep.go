...
// checks if the SdkVersionDetailsRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdkVersionDetailsRep{}

// SdkVersionDetailsRep struct for SdkVersionDetailsRep
type SdkVersionDetailsRep struct {
	...
	LdLatestVersion *string `json:"ldLatestVersion,omitempty"`
	...
	EolStatus *string `json:"eolStatus,omitempty"`
	...
	RelayEolStatus *string `json:"relayEolStatus,omitempty"`
	RelayLatestVersion *string `json:"relayLatestVersion,omitempty"`
	RelayLatestReleaseUrl *string `json:"relayLatestReleaseUrl,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SdkVersionDetailsRep SdkVersionDetailsRep
...
// GetLdLatestVersion returns the LdLatestVersion field value if set, zero value otherwise.
func (o *SdkVersionDetailsRep) GetLdLatestVersion() string {
	if o == nil || IsNil(o.LdLatestVersion) {
		var ret string
		return ret
	}
	return *o.LdLatestVersion
}

// GetLdLatestVersionOk returns a tuple with the LdLatestVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SdkVersionDetailsRep) GetLdLatestVersionOk() (*string, bool) {
	if o == nil || IsNil(o.LdLatestVersion) {
		return nil, false
	}
	return o.LdLatestVersion, true
}
...
// SetLdLatestVersion gets a reference to the given string and assigns it to the LdLatestVersion field.
func (o *SdkVersionDetailsRep) SetLdLatestVersion(v string) {
	o.LdLatestVersion = &v
}

// GetEolStatus returns the EolStatus field value if set, zero value otherwise.
func (o *SdkVersionDetailsRep) GetEolStatus() string {
	if o == nil || IsNil(o.EolStatus) {
		var ret string
		return ret
	}
	return *o.EolStatus
...
// GetEolStatusOk returns a tuple with the EolStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SdkVersionDetailsRep) GetEolStatusOk() (*string, bool) {
	if o == nil || IsNil(o.EolStatus) {
		return nil, false
	}
	return o.EolStatus, true
}
...
// SetEolStatus gets a reference to the given string and assigns it to the EolStatus field.
func (o *SdkVersionDetailsRep) SetEolStatus(v string) {
	o.EolStatus = &v
}

// GetLatestReleaseUrl returns the LatestReleaseUrl field value if set, zero value otherwise.
func (o *SdkVersionDetailsRep) GetLatestReleaseUrl() string {
	if o == nil || IsNil(o.LatestReleaseUrl) {
		var ret string
		return ret
	}
	return *o.LatestReleaseUrl
}

// GetLatestReleaseUrlOk returns a tuple with the LatestReleaseUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SdkVersionDetailsRep) GetLatestReleaseUrlOk() (*string, bool) {
	if o == nil || IsNil(o.LatestReleaseUrl) {
		return nil, false
	}
	return o.LatestReleaseUrl, true
}
...
// SetLatestReleaseUrl gets a reference to the given string and assigns it to the LatestReleaseUrl field.
func (o *SdkVersionDetailsRep) SetLatestReleaseUrl(v string) {
	o.LatestReleaseUrl = &v
}
...
// GetRelayVersion returns the RelayVersion field value if set, zero value otherwise.
func (o *SdkVersionDetailsRep) GetRelayVersion() string {
	if o == nil || IsNil(o.RelayVersion) {
		var ret string
		return ret
	}
	return *o.RelayVersion
}

// GetRelayVersionOk returns a tuple with the RelayVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SdkVersionDetailsRep) GetRelayVersionOk() (*string, bool) {
	if o == nil || IsNil(o.RelayVersion) {
		return nil, false
	}
	return o.RelayVersion, true
}
...
// SetRelayVersion gets a reference to the given string and assigns it to the RelayVersion field.
func (o *SdkVersionDetailsRep) SetRelayVersion(v string) {
	o.RelayVersion = &v
}

// GetRelayEolStatus returns the RelayEolStatus field value if set, zero value otherwise.
func (o *SdkVersionDetailsRep) GetRelayEolStatus() string {
	if o == nil || IsNil(o.RelayEolStatus) {
		var ret string
		return ret
	}
	return *o.RelayEolStatus
}

// GetRelayEolStatusOk returns a tuple with the RelayEolStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SdkVersionDetailsRep) GetRelayEolStatusOk() (*string, bool) {
	if o == nil || IsNil(o.RelayEolStatus) {
		return nil, false
	}
	return o.RelayEolStatus, true
}
...
// SetRelayEolStatus gets a reference to the given string and assigns it to the RelayEolStatus field.
func (o *SdkVersionDetailsRep) SetRelayEolStatus(v string) {
	o.RelayEolStatus = &v
}

// GetRelayLatestVersion returns the RelayLatestVersion field value if set, zero value otherwise.
func (o *SdkVersionDetailsRep) GetRelayLatestVersion() string {
	if o == nil || IsNil(o.RelayLatestVersion) {
		var ret string
		return ret
	}
	return *o.RelayLatestVersion
}

// GetRelayLatestVersionOk returns a tuple with the RelayLatestVersion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SdkVersionDetailsRep) GetRelayLatestVersionOk() (*string, bool) {
	if o == nil || IsNil(o.RelayLatestVersion) {
		return nil, false
	}
	return o.RelayLatestVersion, true
}
...
// SetRelayLatestVersion gets a reference to the given string and assigns it to the RelayLatestVersion field.
func (o *SdkVersionDetailsRep) SetRelayLatestVersion(v string) {
	o.RelayLatestVersion = &v
}

// GetRelayLatestReleaseUrl returns the RelayLatestReleaseUrl field value if set, zero value otherwise.
func (o *SdkVersionDetailsRep) GetRelayLatestReleaseUrl() string {
	if o == nil || IsNil(o.RelayLatestReleaseUrl) {
		var ret string
		return ret
	}
	return *o.RelayLatestReleaseUrl
}

// GetRelayLatestReleaseUrlOk returns a tuple with the RelayLatestReleaseUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SdkVersionDetailsRep) GetRelayLatestReleaseUrlOk() (*string, bool) {
	if o == nil || IsNil(o.RelayLatestReleaseUrl) {
		return nil, false
	}
	return o.RelayLatestReleaseUrl, true
}
...
// SetRelayLatestReleaseUrl gets a reference to the given string and assigns it to the RelayLatestReleaseUrl field.
func (o *SdkVersionDetailsRep) SetRelayLatestReleaseUrl(v string) {
	o.RelayLatestReleaseUrl = &v
}

func (o SdkVersionDetailsRep) MarshalJSON() ([]byte, error) {
...
func (o SdkVersionDetailsRep) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LdLatestVersion) {
		toSerialize["ldLatestVersion"] = o.LdLatestVersion
	}
	if !IsNil(o.EolStatus) {
		toSerialize["eolStatus"] = o.EolStatus
	}
	if !IsNil(o.LatestReleaseUrl) {
		toSerialize["latestReleaseUrl"] = o.LatestReleaseUrl
	}
	if !IsNil(o.ConnectionType) {
		toSerialize["connectionType"] = o.ConnectionType
	}
	if !IsNil(o.RelayVersion) {
		toSerialize["relayVersion"] = o.RelayVersion
	}
	if !IsNil(o.RelayEolStatus) {
		toSerialize["relayEolStatus"] = o.RelayEolStatus
	}
	if !IsNil(o.RelayLatestVersion) {
		toSerialize["relayLatestVersion"] = o.RelayLatestVersion
	}
	if !IsNil(o.RelayLatestReleaseUrl) {
		toSerialize["relayLatestReleaseUrl"] = o.RelayLatestReleaseUrl
	}
...
func (o *SdkVersionDetailsRep) UnmarshalJSON(data []byte) (err error) {
	varSdkVersionDetailsRep := _SdkVersionDetailsRep{}

	err = json.Unmarshal(data, &varSdkVersionDetailsRep)

	if err != nil {
		return err
	}

	*o = SdkVersionDetailsRep(varSdkVersionDetailsRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "ldLatestVersion")
		delete(additionalProperties, "eolStatus")
		delete(additionalProperties, "latestReleaseUrl")
		delete(additionalProperties, "connectionType")
		delete(additionalProperties, "relayVersion")
		delete(additionalProperties, "relayEolStatus")
		delete(additionalProperties, "relayLatestVersion")
		delete(additionalProperties, "relayLatestReleaseUrl")
...
type NullableSdkVersionDetailsRep struct {
	value *SdkVersionDetailsRep
	isSet bool
}

func (v NullableSdkVersionDetailsRep) Get() *SdkVersionDetailsRep {
	return v.value
}

func (v *NullableSdkVersionDetailsRep) Set(val *SdkVersionDetailsRep) {
	v.value = val
	v.isSet = true
}

func (v NullableSdkVersionDetailsRep) IsSet() bool {
	return v.isSet
}

func (v *NullableSdkVersionDetailsRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdkVersionDetailsRep(val *SdkVersionDetailsRep) *NullableSdkVersionDetailsRep {
	return &NullableSdkVersionDetailsRep{value: val, isSet: true}
}

func (v NullableSdkVersionDetailsRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdkVersionDetailsRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
