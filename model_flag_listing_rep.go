...
// checks if the FlagListingRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagListingRep{}
...
type _FlagListingRep FlagListingRep
...
func (o FlagListingRep) ToMap() (map[string]interface{}, error) {
...
func (o *FlagListingRep) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagListingRep := _FlagListingRep{}

	err = json.Unmarshal(data, &varFlagListingRep)

	if err != nil {
		return err
	}

	*o = FlagListingRep(varFlagListingRep)
