...
// checks if the ExpandedLinkedMetrics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedLinkedMetrics{}

// ExpandedLinkedMetrics struct for ExpandedLinkedMetrics
type ExpandedLinkedMetrics struct {
	Items []ExpandedMetric `json:"items"`
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _ExpandedLinkedMetrics ExpandedLinkedMetrics
...
func (o ExpandedLinkedMetrics) MarshalJSON() ([]byte, error) {
...
func (o ExpandedLinkedMetrics) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedLinkedMetrics) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedLinkedMetrics := _ExpandedLinkedMetrics{}

	err = json.Unmarshal(data, &varExpandedLinkedMetrics)

	if err != nil {
		return err
	}

	*o = ExpandedLinkedMetrics(varExpandedLinkedMetrics)
...
type NullableExpandedLinkedMetrics struct {
	value *ExpandedLinkedMetrics
	isSet bool
}

func (v NullableExpandedLinkedMetrics) Get() *ExpandedLinkedMetrics {
	return v.value
}

func (v *NullableExpandedLinkedMetrics) Set(val *ExpandedLinkedMetrics) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedLinkedMetrics) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedLinkedMetrics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedLinkedMetrics(val *ExpandedLinkedMetrics) *NullableExpandedLinkedMetrics {
	return &NullableExpandedLinkedMetrics{value: val, isSet: true}
}

func (v NullableExpandedLinkedMetrics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedLinkedMetrics) UnmarshalJSON(src []byte) error {
	v.isSet = true
