...
// checks if the FileRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileRep{}
...
func (o FileRep) ToMap() (map[string]interface{}, error) {
...
func (o *FileRep) UnmarshalJSON(data []byte) (err error) {
	varFileRep := _FileRep{}

	err = json.Unmarshal(data, &varFileRep)

	if err != nil {
		return err
	}

	*o = FileRep(varFileRep)
