...
// checks if the BranchCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BranchCollectionRep{}
...
type _BranchCollectionRep BranchCollectionRep
...
func (o BranchCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *BranchCollectionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varBranchCollectionRep := _BranchCollectionRep{}

	err = json.Unmarshal(data, &varBranchCollectionRep)

	if err != nil {
		return err
	}

	*o = BranchCollectionRep(varBranchCollectionRep)
