...
// checks if the ContextInstanceEvaluations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextInstanceEvaluations{}
...
type _ContextInstanceEvaluations ContextInstanceEvaluations
...
func (o ContextInstanceEvaluations) ToMap() (map[string]interface{}, error) {
...
func (o *ContextInstanceEvaluations) UnmarshalJSON(data []byte) (err error) {
	...
	varContextInstanceEvaluations := _ContextInstanceEvaluations{}

	err = json.Unmarshal(data, &varContextInstanceEvaluations)

	if err != nil {
		return err
	}

	*o = ContextInstanceEvaluations(varContextInstanceEvaluations)
