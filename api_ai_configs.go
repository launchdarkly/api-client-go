...
type AIConfigsApi interface {
	...
	/*
	ListAIToolReferences List AI tool references
	...
	@param projectKey
	@param toolKey
	@return ApiListAIToolReferencesRequest
	*/
	ListAIToolReferences(ctx context.Context, projectKey string, toolKey string) ApiListAIToolReferencesRequest

	// ListAIToolReferencesExecute executes the request
	//  @return ToolReferences
	ListAIToolReferencesExecute(r ApiListAIToolReferencesRequest) (*ToolReferences, *http.Response, error)

	/*
	ListAgentOptimizationRuns List agent optimization runs
	...
	@return ApiListAgentOptimizationRunsRequest
	*/
	ListAgentOptimizationRuns(ctx context.Context, projectKey string, optimizationKey string) ApiListAgentOptimizationRunsRequest

	// ListAgentOptimizationRunsExecute executes the request
	//  @return AgentOptimizationRuns
	ListAgentOptimizationRunsExecute(r ApiListAgentOptimizationRunsRequest) (*AgentOptimizationRuns, *http.Response, error)
}

// AIConfigsApiService AIConfigsApi service
type AIConfigsApiService service

type ApiListAIToolReferencesRequest struct {
	ctx context.Context
...
func (r ApiListAIToolReferencesRequest) Limit(limit int32) ApiListAIToolReferencesRequest {
	r.limit = &limit
	return r
}

// Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
func (r ApiListAIToolReferencesRequest) Offset(offset int32) ApiListAIToolReferencesRequest {
	r.offset = &offset
	return r
}

func (r ApiListAIToolReferencesRequest) Execute() (*ToolReferences, *http.Response, error) {
	return r.ApiService.ListAIToolReferencesExecute(r)
}
...
Get all AgentControl config variations that currently reference this tool.
 ...
 @return ApiListAIToolReferencesRequest
*/
func (a *AIConfigsApiService) ListAIToolReferences(ctx context.Context, projectKey string, toolKey string) ApiListAIToolReferencesRequest {
	return ApiListAIToolReferencesRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return ToolReferences
func (a *AIConfigsApiService) ListAIToolReferencesExecute(r ApiListAIToolReferencesRequest) (*ToolReferences, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ToolReferences
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AIConfigsApiService.ListAIToolReferences")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/ai-tools/{toolKey}/references"
...
type ApiListAgentOptimizationRunsRequest struct {
	ctx context.Context
	ApiService AIConfigsApi
	projectKey string
...
// The number of resources to return.
func (r ApiListAgentOptimizationRunsRequest) Limit(limit int32) ApiListAgentOptimizationRunsRequest {
	r.limit = &limit
	return r
}

// Where to start in the list. Use this with pagination. For example, an offset of 10 skips the first ten items and then returns the next items in the list, up to the query &#x60;limit&#x60;.
func (r ApiListAgentOptimizationRunsRequest) Offset(offset int32) ApiListAgentOptimizationRunsRequest {
	r.offset = &offset
	return r
}

func (r ApiListAgentOptimizationRunsRequest) Execute() (*AgentOptimizationRuns, *http.Response, error) {
	return r.ApiService.ListAgentOptimizationRunsExecute(r)
}
...
Get one run summary per distinct run_id across all versions of an agent optimization config, ordered by created_at DESC.
 ...
 @return ApiListAgentOptimizationRunsRequest
*/
func (a *AIConfigsApiService) ListAgentOptimizationRuns(ctx context.Context, projectKey string, optimizationKey string) ApiListAgentOptimizationRunsRequest {
	return ApiListAgentOptimizationRunsRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return AgentOptimizationRuns
func (a *AIConfigsApiService) ListAgentOptimizationRunsExecute(r ApiListAgentOptimizationRunsRequest) (*AgentOptimizationRuns, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AgentOptimizationRuns
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AIConfigsApiService.ListAgentOptimizationRuns")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/agent-optimizations/{optimizationKey}/runs"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterValueToString(r.projectKey, "projectKey")), -1)
