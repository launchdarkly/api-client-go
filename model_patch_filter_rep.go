...
// PatchFilterRep struct for PatchFilterRep
type PatchFilterRep struct {
	// The filter name
...
func (o PatchFilterRep) MarshalJSON() ([]byte, error) {
...
type NullablePatchFilterRep struct {
	value *PatchFilterRep
	isSet bool
}

func (v NullablePatchFilterRep) Get() *PatchFilterRep {
	return v.value
}

func (v *NullablePatchFilterRep) Set(val *PatchFilterRep) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchFilterRep) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchFilterRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchFilterRep(val *PatchFilterRep) *NullablePatchFilterRep {
	return &NullablePatchFilterRep{value: val, isSet: true}
}

func (v NullablePatchFilterRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchFilterRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
