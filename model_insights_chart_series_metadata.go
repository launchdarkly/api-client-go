...
// checks if the InsightsChartSeriesMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightsChartSeriesMetadata{}
...
type _InsightsChartSeriesMetadata InsightsChartSeriesMetadata
...
func (o InsightsChartSeriesMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *InsightsChartSeriesMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightsChartSeriesMetadata := _InsightsChartSeriesMetadata{}

	err = json.Unmarshal(data, &varInsightsChartSeriesMetadata)

	if err != nil {
		return err
	}

	*o = InsightsChartSeriesMetadata(varInsightsChartSeriesMetadata)
