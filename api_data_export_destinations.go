...
type DataExportDestinationsApi interface {
	...
	*/
	...
	/*
	PostCompleteWarehouseDestinationSetup Complete warehouse destination setup
	...
	@param kind The destination kind (snowflake-v2, bigquery, clickhouse, redshift, databricks)
	@return ApiPostCompleteWarehouseDestinationSetupRequest
	*/
	PostCompleteWarehouseDestinationSetup(ctx context.Context, projKey string, envKey string, kind string) ApiPostCompleteWarehouseDestinationSetupRequest

	// PostCompleteWarehouseDestinationSetupExecute executes the request
	//  @return Destination
	PostCompleteWarehouseDestinationSetupExecute(r ApiPostCompleteWarehouseDestinationSetupRequest) (*Destination, *http.Response, error)
...
* `snowflakeHostAddress`: Your Snowflake account URL.
	...
	*/
	...
	/*
	PostGenerateProjectEnvWarehouseDestinationKeyPair Generate Snowflake destination key pair
	...
	@param projKey The project key
	@param envKey The environment key
	@return ApiPostGenerateProjectEnvWarehouseDestinationKeyPairRequest
	*/
	PostGenerateProjectEnvWarehouseDestinationKeyPair(ctx context.Context, projKey string, envKey string) ApiPostGenerateProjectEnvWarehouseDestinationKeyPairRequest

	// PostGenerateProjectEnvWarehouseDestinationKeyPairExecute executes the request
	//  @return GenerateWarehouseDestinationKeyPairPostRep
	PostGenerateProjectEnvWarehouseDestinationKeyPairExecute(r ApiPostGenerateProjectEnvWarehouseDestinationKeyPairRequest) (*GenerateWarehouseDestinationKeyPairPostRep, *http.Response, error)
	...
	*/
	...
	/*
	PostGenerateWarehouseDestinationSetupScript Generate warehouse destination setup script
	...
	@param projKey The project key
	@param envKey The environment key
	@param kind The destination kind (snowflake-v2, redshift, clickhouse)
	@return ApiPostGenerateWarehouseDestinationSetupScriptRequest
	*/
	PostGenerateWarehouseDestinationSetupScript(ctx context.Context, projKey string, envKey string, kind string) ApiPostGenerateWarehouseDestinationSetupScriptRequest

	// PostGenerateWarehouseDestinationSetupScriptExecute executes the request
	//  @return WarehouseDestinationSetupScriptRep
	PostGenerateWarehouseDestinationSetupScriptExecute(r ApiPostGenerateWarehouseDestinationSetupScriptRequest) (*WarehouseDestinationSetupScriptRep, *http.Response, error)
}
...
type ApiPostCompleteWarehouseDestinationSetupRequest struct {
	ctx context.Context
	ApiService DataExportDestinationsApi
	projKey string
	envKey string
...
func (r ApiPostCompleteWarehouseDestinationSetupRequest) CompleteSetupPostBody(completeSetupPostBody CompleteSetupPostBody) ApiPostCompleteWarehouseDestinationSetupRequest {
	r.completeSetupPostBody = &completeSetupPostBody
	return r
}

func (r ApiPostCompleteWarehouseDestinationSetupRequest) Execute() (*Destination, *http.Response, error) {
	return r.ApiService.PostCompleteWarehouseDestinationSetupExecute(r)
}
...
Complete the setup of a warehouse destination by providing the Snowflake host address and the public keys from the /setup response. The custom names are read from the stored configuration.
 ...
 @return ApiPostCompleteWarehouseDestinationSetupRequest
*/
func (a *DataExportDestinationsApiService) PostCompleteWarehouseDestinationSetup(ctx context.Context, projKey string, envKey string, kind string) ApiPostCompleteWarehouseDestinationSetupRequest {
	return ApiPostCompleteWarehouseDestinationSetupRequest{
		ApiService: a,
		ctx: ctx,
		projKey: projKey,
...
// Execute executes the request
//  @return Destination
func (a *DataExportDestinationsApiService) PostCompleteWarehouseDestinationSetupExecute(r ApiPostCompleteWarehouseDestinationSetupRequest) (*Destination, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DataExportDestinationsApiService.PostCompleteWarehouseDestinationSetup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/destinations/projects/{projKey}/environments/{envKey}/kinds/{kind}/complete-setup"
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.completeSetupPostBody == nil {
		return localVarReturnValue, nil, reportError("completeSetupPostBody is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.completeSetupPostBody
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
type ApiPostGenerateProjectEnvWarehouseDestinationKeyPairRequest struct {
	ctx context.Context
	ApiService DataExportDestinationsApi
	projKey string
	envKey string
...
func (r ApiPostGenerateProjectEnvWarehouseDestinationKeyPairRequest) Execute() (*GenerateWarehouseDestinationKeyPairPostRep, *http.Response, error) {
	return r.ApiService.PostGenerateProjectEnvWarehouseDestinationKeyPairExecute(r)
}
...
Generate key pair to allow Data Export to authenticate into a Snowflake warehouse destination
 ...
 @return ApiPostGenerateProjectEnvWarehouseDestinationKeyPairRequest
*/
func (a *DataExportDestinationsApiService) PostGenerateProjectEnvWarehouseDestinationKeyPair(ctx context.Context, projKey string, envKey string) ApiPostGenerateProjectEnvWarehouseDestinationKeyPairRequest {
	return ApiPostGenerateProjectEnvWarehouseDestinationKeyPairRequest{
		ApiService: a,
		ctx: ctx,
		projKey: projKey,
...
// Execute executes the request
//  @return GenerateWarehouseDestinationKeyPairPostRep
func (a *DataExportDestinationsApiService) PostGenerateProjectEnvWarehouseDestinationKeyPairExecute(r ApiPostGenerateProjectEnvWarehouseDestinationKeyPairRequest) (*GenerateWarehouseDestinationKeyPairPostRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DataExportDestinationsApiService.PostGenerateProjectEnvWarehouseDestinationKeyPair")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/destinations/projects/{projKey}/environments/{envKey}/generate-warehouse-destination-key-pair"
	localVarPath = strings.Replace(localVarPath, "{"+"projKey"+"}", url.PathEscape(parameterValueToString(r.projKey, "projKey")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"envKey"+"}", url.PathEscape(parameterValueToString(r.envKey, "envKey")), -1)
...
type ApiPostGenerateWarehouseDestinationSetupScriptRequest struct {
	ctx context.Context
	ApiService DataExportDestinationsApi
	projKey string
	envKey string
...
func (r ApiPostGenerateWarehouseDestinationSetupScriptRequest) WarehouseSetupScriptPostBody(warehouseSetupScriptPostBody WarehouseSetupScriptPostBody) ApiPostGenerateWarehouseDestinationSetupScriptRequest {
	r.warehouseSetupScriptPostBody = &warehouseSetupScriptPostBody
	return r
}

func (r ApiPostGenerateWarehouseDestinationSetupScriptRequest) Execute() (*WarehouseDestinationSetupScriptRep, *http.Response, error) {
	return r.ApiService.PostGenerateWarehouseDestinationSetupScriptExecute(r)
}
...
Generate the SQL setup script required to prepare a warehouse for LaunchDarkly Data Export. For Snowflake, this also generates a key pair. Custom Snowflake object names may be provided. If omitted, defaults are used.
 ...
 @return ApiPostGenerateWarehouseDestinationSetupScriptRequest
*/
func (a *DataExportDestinationsApiService) PostGenerateWarehouseDestinationSetupScript(ctx context.Context, projKey string, envKey string, kind string) ApiPostGenerateWarehouseDestinationSetupScriptRequest {
	return ApiPostGenerateWarehouseDestinationSetupScriptRequest{
		ApiService: a,
		ctx: ctx,
		projKey: projKey,
...
// Execute executes the request
//  @return WarehouseDestinationSetupScriptRep
func (a *DataExportDestinationsApiService) PostGenerateWarehouseDestinationSetupScriptExecute(r ApiPostGenerateWarehouseDestinationSetupScriptRequest) (*WarehouseDestinationSetupScriptRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *WarehouseDestinationSetupScriptRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DataExportDestinationsApiService.PostGenerateWarehouseDestinationSetupScript")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/destinations/projects/{projKey}/environments/{envKey}/kinds/{kind}/setup"
	localVarPath = strings.Replace(localVarPath, "{"+"projKey"+"}", url.PathEscape(parameterValueToString(r.projKey, "projKey")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"envKey"+"}", url.PathEscape(parameterValueToString(r.envKey, "envKey")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"kind"+"}", url.PathEscape(parameterValueToString(r.kind, "kind")), -1)
	...
	// body params
	localVarPostBody = r.warehouseSetupScriptPostBody
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
