...
// checks if the UserSegmentRule type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserSegmentRule{}
...
type _UserSegmentRule UserSegmentRule
...
func (o *UserSegmentRule) GetRolloutContextKind() string {
	if o == nil || IsNil(o.RolloutContextKind) {
		var ret string
		return ret
	}
...
func (o UserSegmentRule) ToMap() (map[string]interface{}, error) {
...
func (o *UserSegmentRule) UnmarshalJSON(data []byte) (err error) {
	...
	varUserSegmentRule := _UserSegmentRule{}

	err = json.Unmarshal(data, &varUserSegmentRule)

	if err != nil {
		return err
	}

	*o = UserSegmentRule(varUserSegmentRule)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "rolloutContextKind")
