...
// checks if the ExpandedSegment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedSegment{}

// ExpandedSegment Segment representation for Views API - contains only fields actually used by the Views service
...
type _ExpandedSegment ExpandedSegment
...
func (o ExpandedSegment) MarshalJSON() ([]byte, error) {
...
func (o ExpandedSegment) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedSegment) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedSegment := _ExpandedSegment{}

	err = json.Unmarshal(data, &varExpandedSegment)

	if err != nil {
		return err
	}

	*o = ExpandedSegment(varExpandedSegment)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "lastModifiedDate")
		delete(additionalProperties, "deleted")
		delete(additionalProperties, "tags")
		delete(additionalProperties, "unbounded")
...
type NullableExpandedSegment struct {
	value *ExpandedSegment
	isSet bool
}

func (v NullableExpandedSegment) Get() *ExpandedSegment {
	return v.value
}

func (v *NullableExpandedSegment) Set(val *ExpandedSegment) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedSegment) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedSegment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedSegment(val *ExpandedSegment) *NullableExpandedSegment {
	return &NullableExpandedSegment{value: val, isSet: true}
}

func (v NullableExpandedSegment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedSegment) UnmarshalJSON(src []byte) error {
	v.isSet = true
