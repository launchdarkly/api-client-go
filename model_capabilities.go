...
type Capabilities struct {
	...
	AuditLogEventsHook *AuditLogEventsHook `json:"auditLogEventsHook,omitempty"`
	BigSegmentStore *BigSegmentStore `json:"bigSegmentStore,omitempty"`
	ExternalConfigurationPages *ExternalConfigurationPages `json:"externalConfigurationPages,omitempty"`
	ExternalConfigurationURL *string `json:"externalConfigurationURL,omitempty"`
	FeatureStore *FeatureStore `json:"featureStore,omitempty"`
	FlagLink *FlagLink `json:"flagLink,omitempty"`
	HideConfiguration *bool `json:"hideConfiguration,omitempty"`
	ReservedCustomProperties []ReservedCustomPropertiesItems `json:"reservedCustomProperties,omitempty"`
	SyncedSegment *SyncedSegment `json:"syncedSegment,omitempty"`
...
// GetAuditLogEventsHook returns the AuditLogEventsHook field value if set, zero value otherwise.
func (o *Capabilities) GetAuditLogEventsHook() AuditLogEventsHook {
	if o == nil || o.AuditLogEventsHook == nil {
		var ret AuditLogEventsHook
		return ret
	}
	return *o.AuditLogEventsHook
}

// GetAuditLogEventsHookOk returns a tuple with the AuditLogEventsHook field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Capabilities) GetAuditLogEventsHookOk() (*AuditLogEventsHook, bool) {
	if o == nil || o.AuditLogEventsHook == nil {
		return nil, false
	}
	return o.AuditLogEventsHook, true
}
...
// SetAuditLogEventsHook gets a reference to the given AuditLogEventsHook and assigns it to the AuditLogEventsHook field.
func (o *Capabilities) SetAuditLogEventsHook(v AuditLogEventsHook) {
	o.AuditLogEventsHook = &v
}

// GetBigSegmentStore returns the BigSegmentStore field value if set, zero value otherwise.
func (o *Capabilities) GetBigSegmentStore() BigSegmentStore {
	if o == nil || o.BigSegmentStore == nil {
		var ret BigSegmentStore
		return ret
	}
	return *o.BigSegmentStore
}

// GetBigSegmentStoreOk returns a tuple with the BigSegmentStore field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Capabilities) GetBigSegmentStoreOk() (*BigSegmentStore, bool) {
	if o == nil || o.BigSegmentStore == nil {
		return nil, false
	}
	return o.BigSegmentStore, true
}
...
// SetBigSegmentStore gets a reference to the given BigSegmentStore and assigns it to the BigSegmentStore field.
func (o *Capabilities) SetBigSegmentStore(v BigSegmentStore) {
	o.BigSegmentStore = &v
}

// GetExternalConfigurationPages returns the ExternalConfigurationPages field value if set, zero value otherwise.
func (o *Capabilities) GetExternalConfigurationPages() ExternalConfigurationPages {
	if o == nil || o.ExternalConfigurationPages == nil {
		var ret ExternalConfigurationPages
		return ret
	}
	return *o.ExternalConfigurationPages
}

// GetExternalConfigurationPagesOk returns a tuple with the ExternalConfigurationPages field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Capabilities) GetExternalConfigurationPagesOk() (*ExternalConfigurationPages, bool) {
	if o == nil || o.ExternalConfigurationPages == nil {
		return nil, false
	}
	return o.ExternalConfigurationPages, true
}
...
// SetExternalConfigurationPages gets a reference to the given ExternalConfigurationPages and assigns it to the ExternalConfigurationPages field.
func (o *Capabilities) SetExternalConfigurationPages(v ExternalConfigurationPages) {
	o.ExternalConfigurationPages = &v
}

// GetExternalConfigurationURL returns the ExternalConfigurationURL field value if set, zero value otherwise.
func (o *Capabilities) GetExternalConfigurationURL() string {
	if o == nil || o.ExternalConfigurationURL == nil {
		var ret string
		return ret
	}
	return *o.ExternalConfigurationURL
}

// GetExternalConfigurationURLOk returns a tuple with the ExternalConfigurationURL field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Capabilities) GetExternalConfigurationURLOk() (*string, bool) {
	if o == nil || o.ExternalConfigurationURL == nil {
		return nil, false
	}
	return o.ExternalConfigurationURL, true
}
...
// SetExternalConfigurationURL gets a reference to the given string and assigns it to the ExternalConfigurationURL field.
func (o *Capabilities) SetExternalConfigurationURL(v string) {
	o.ExternalConfigurationURL = &v
}

// GetFeatureStore returns the FeatureStore field value if set, zero value otherwise.
func (o *Capabilities) GetFeatureStore() FeatureStore {
	if o == nil || o.FeatureStore == nil {
		var ret FeatureStore
		return ret
	}
	return *o.FeatureStore
}

// GetFeatureStoreOk returns a tuple with the FeatureStore field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Capabilities) GetFeatureStoreOk() (*FeatureStore, bool) {
	if o == nil || o.FeatureStore == nil {
		return nil, false
	}
	return o.FeatureStore, true
}
...
// SetFeatureStore gets a reference to the given FeatureStore and assigns it to the FeatureStore field.
func (o *Capabilities) SetFeatureStore(v FeatureStore) {
	o.FeatureStore = &v
}

// GetFlagLink returns the FlagLink field value if set, zero value otherwise.
func (o *Capabilities) GetFlagLink() FlagLink {
	if o == nil || o.FlagLink == nil {
		var ret FlagLink
		return ret
	}
	return *o.FlagLink
...
// GetFlagLinkOk returns a tuple with the FlagLink field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Capabilities) GetFlagLinkOk() (*FlagLink, bool) {
	if o == nil || o.FlagLink == nil {
		return nil, false
	}
	return o.FlagLink, true
}
...
// SetFlagLink gets a reference to the given FlagLink and assigns it to the FlagLink field.
func (o *Capabilities) SetFlagLink(v FlagLink) {
	o.FlagLink = &v
}

// GetHideConfiguration returns the HideConfiguration field value if set, zero value otherwise.
func (o *Capabilities) GetHideConfiguration() bool {
	if o == nil || o.HideConfiguration == nil {
		var ret bool
		return ret
	}
	return *o.HideConfiguration
}

// GetHideConfigurationOk returns a tuple with the HideConfiguration field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Capabilities) GetHideConfigurationOk() (*bool, bool) {
	if o == nil || o.HideConfiguration == nil {
		return nil, false
	}
	return o.HideConfiguration, true
}
...
// SetHideConfiguration gets a reference to the given bool and assigns it to the HideConfiguration field.
func (o *Capabilities) SetHideConfiguration(v bool) {
	o.HideConfiguration = &v
}

// GetReservedCustomProperties returns the ReservedCustomProperties field value if set, zero value otherwise.
func (o *Capabilities) GetReservedCustomProperties() []ReservedCustomPropertiesItems {
	if o == nil || o.ReservedCustomProperties == nil {
		var ret []ReservedCustomPropertiesItems
		return ret
	}
	return o.ReservedCustomProperties
}

// GetReservedCustomPropertiesOk returns a tuple with the ReservedCustomProperties field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Capabilities) GetReservedCustomPropertiesOk() ([]ReservedCustomPropertiesItems, bool) {
	if o == nil || o.ReservedCustomProperties == nil {
		return nil, false
	}
	return o.ReservedCustomProperties, true
}
...
// SetReservedCustomProperties gets a reference to the given []ReservedCustomPropertiesItems and assigns it to the ReservedCustomProperties field.
func (o *Capabilities) SetReservedCustomProperties(v []ReservedCustomPropertiesItems) {
	o.ReservedCustomProperties = v
}

// GetSyncedSegment returns the SyncedSegment field value if set, zero value otherwise.
func (o *Capabilities) GetSyncedSegment() SyncedSegment {
	if o == nil || o.SyncedSegment == nil {
		var ret SyncedSegment
		return ret
	}
	return *o.SyncedSegment
}

// GetSyncedSegmentOk returns a tuple with the SyncedSegment field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Capabilities) GetSyncedSegmentOk() (*SyncedSegment, bool) {
	if o == nil || o.SyncedSegment == nil {
		return nil, false
	}
	return o.SyncedSegment, true
}
...
// SetSyncedSegment gets a reference to the given SyncedSegment and assigns it to the SyncedSegment field.
...
func (o Capabilities) MarshalJSON() ([]byte, error) {
	...
	if o.AuditLogEventsHook != nil {
		toSerialize["auditLogEventsHook"] = o.AuditLogEventsHook
	}
	if o.BigSegmentStore != nil {
		toSerialize["bigSegmentStore"] = o.BigSegmentStore
	}
	if o.ExternalConfigurationPages != nil {
		toSerialize["externalConfigurationPages"] = o.ExternalConfigurationPages
	}
	if o.ExternalConfigurationURL != nil {
		toSerialize["externalConfigurationURL"] = o.ExternalConfigurationURL
	}
	if o.FeatureStore != nil {
		toSerialize["featureStore"] = o.FeatureStore
	}
	if o.FlagLink != nil {
		toSerialize["flagLink"] = o.FlagLink
	}
	if o.HideConfiguration != nil {
		toSerialize["hideConfiguration"] = o.HideConfiguration
	}
	if o.ReservedCustomProperties != nil {
		toSerialize["reservedCustomProperties"] = o.ReservedCustomProperties
	}
	if o.SyncedSegment != nil {
		toSerialize["syncedSegment"] = o.SyncedSegment
	}
	if o.Trigger != nil {
