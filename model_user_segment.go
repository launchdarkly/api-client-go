...
// checks if the UserSegment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserSegment{}
...
func (o *UserSegment) GetIncludedContexts() []SegmentTarget {
	if o == nil || IsNil(o.IncludedContexts) {
...
func (o *UserSegment) GetExcludedContexts() []SegmentTarget {
	if o == nil || IsNil(o.ExcludedContexts) {
		var ret []SegmentTarget
		return ret
	}
...
func (o *UserSegment) GetUnboundedContextKind() string {
	if o == nil || IsNil(o.UnboundedContextKind) {
		var ret string
		return ret
	}
...
func (o *UserSegment) GetUnboundedMetadata() SegmentMetadata {
	if o == nil || IsNil(o.UnboundedMetadata) {
...
func (o UserSegment) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IncludedContexts) {
		toSerialize["includedContexts"] = o.IncludedContexts
	}
	if !IsNil(o.ExcludedContexts) {
...
func (o *UserSegment) UnmarshalJSON(data []byte) (err error) {
	...
	varUserSegment := _UserSegment{}

	err = json.Unmarshal(data, &varUserSegment)

	if err != nil {
		return err
	}

	*o = UserSegment(varUserSegment)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "includedContexts")
		delete(additionalProperties, "excludedContexts")
		delete(additionalProperties, "_links")
		delete(additionalProperties, "rules")
		delete(additionalProperties, "version")
		delete(additionalProperties, "deleted")
		delete(additionalProperties, "_access")
		delete(additionalProperties, "_flags")
		delete(additionalProperties, "unbounded")
		delete(additionalProperties, "unboundedContextKind")
		delete(additionalProperties, "generation")
		delete(additionalProperties, "_unboundedMetadata")
		delete(additionalProperties, "_external")
		delete(additionalProperties, "_externalLink")
		delete(additionalProperties, "_importInProgress")
