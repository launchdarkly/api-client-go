...
// ReleaseGuardianFlagConfigRep struct for ReleaseGuardianFlagConfigRep
type ReleaseGuardianFlagConfigRep struct {
	Metrics []MetricV2Rep `json:"metrics,omitempty"`
...
func NewReleaseGuardianFlagConfigRep(links map[string]Link) *ReleaseGuardianFlagConfigRep {
	this := ReleaseGuardianFlagConfigRep{}
	this.Links = links
	return &this
}
...
// SetMetrics gets a reference to the given []MetricV2Rep and assigns it to the Metrics field.
...
func (o ReleaseGuardianFlagConfigRep) MarshalJSON() ([]byte, error) {
...
type NullableReleaseGuardianFlagConfigRep struct {
	value *ReleaseGuardianFlagConfigRep
	isSet bool
}

func (v NullableReleaseGuardianFlagConfigRep) Get() *ReleaseGuardianFlagConfigRep {
	return v.value
}

func (v *NullableReleaseGuardianFlagConfigRep) Set(val *ReleaseGuardianFlagConfigRep) {
	v.value = val
	v.isSet = true
}

func (v NullableReleaseGuardianFlagConfigRep) IsSet() bool {
	return v.isSet
}

func (v *NullableReleaseGuardianFlagConfigRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleaseGuardianFlagConfigRep(val *ReleaseGuardianFlagConfigRep) *NullableReleaseGuardianFlagConfigRep {
	return &NullableReleaseGuardianFlagConfigRep{value: val, isSet: true}
}

func (v NullableReleaseGuardianFlagConfigRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReleaseGuardianFlagConfigRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
