...
// checks if the SdkVersionListRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdkVersionListRep{}
...
type _SdkVersionListRep SdkVersionListRep
...
func (o *SdkVersionListRep) GetSdkVersions() []SdkVersionRep {
	if o == nil {
		var ret []SdkVersionRep
		return ret
	}

	return o.SdkVersions
}

// GetSdkVersionsOk returns a tuple with the SdkVersions field value
// and a boolean to check if the value has been set.
func (o *SdkVersionListRep) GetSdkVersionsOk() ([]SdkVersionRep, bool) {
	if o == nil {
		return nil, false
	}
	return o.SdkVersions, true
}
...
func (o SdkVersionListRep) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["_links"] = o.Links
	toSerialize["sdkVersions"] = o.SdkVersions
...
func (o *SdkVersionListRep) UnmarshalJSON(data []byte) (err error) {
	...
	varSdkVersionListRep := _SdkVersionListRep{}

	err = json.Unmarshal(data, &varSdkVersionListRep)

	if err != nil {
		return err
	}

	*o = SdkVersionListRep(varSdkVersionListRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "_links")
		delete(additionalProperties, "sdkVersions")
...
func NewNullableSdkVersionListRep(val *SdkVersionListRep) *NullableSdkVersionListRep {
	return &NullableSdkVersionListRep{value: val, isSet: true}
}
