...
// checks if the FormVariable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FormVariable{}
...
type _FormVariable FormVariable
...
func (o *FormVariable) GetDynamicOptions() DynamicOptions {
	if o == nil || IsNil(o.DynamicOptions) {
...
func (o FormVariable) ToMap() (map[string]interface{}, error) {
...
func (o *FormVariable) UnmarshalJSON(data []byte) (err error) {
	varFormVariable := _FormVariable{}

	err = json.Unmarshal(data, &varFormVariable)

	if err != nil {
		return err
	}

	*o = FormVariable(varFormVariable)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "dynamicOptions")
