...
type FormVariable struct {
	...
	DependsOn []DependsOnItems `json:"dependsOn,omitempty"`
...
// SetDependsOn gets a reference to the given []DependsOnItems and assigns it to the DependsOn field.
