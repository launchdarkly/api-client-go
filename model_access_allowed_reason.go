...
// checks if the AccessAllowedReason type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessAllowedReason{}
...
type _AccessAllowedReason AccessAllowedReason
...
func (o AccessAllowedReason) ToMap() (map[string]interface{}, error) {
...
func (o *AccessAllowedReason) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessAllowedReason := _AccessAllowedReason{}

	err = json.Unmarshal(data, &varAccessAllowedReason)

	if err != nil {
		return err
	}

	*o = AccessAllowedReason(varAccessAllowedReason)
