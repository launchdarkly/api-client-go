...
// checks if the AIConfigTargetingEnvironmentFallthrough type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigTargetingEnvironmentFallthrough{}

// AIConfigTargetingEnvironmentFallthrough struct for AIConfigTargetingEnvironmentFallthrough
type AIConfigTargetingEnvironmentFallthrough struct {
	Variation *int32 `json:"variation,omitempty"`
	Rollout *AIConfigTargetingEnvironmentFallthroughRollout `json:"rollout,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AIConfigTargetingEnvironmentFallthrough AIConfigTargetingEnvironmentFallthrough
...
func NewAIConfigTargetingEnvironmentFallthrough() *AIConfigTargetingEnvironmentFallthrough {
	this := AIConfigTargetingEnvironmentFallthrough{}
	return &this
}
...
func (o *AIConfigTargetingEnvironmentFallthrough) GetRollout() AIConfigTargetingEnvironmentFallthroughRollout {
	if o == nil || IsNil(o.Rollout) {
		var ret AIConfigTargetingEnvironmentFallthroughRollout
		return ret
	}
	return *o.Rollout
}
...
// SetRollout gets a reference to the given AIConfigTargetingEnvironmentFallthroughRollout and assigns it to the Rollout field.
func (o *AIConfigTargetingEnvironmentFallthrough) SetRollout(v AIConfigTargetingEnvironmentFallthroughRollout) {
	o.Rollout = &v
}

func (o AIConfigTargetingEnvironmentFallthrough) MarshalJSON() ([]byte, error) {
...
func (o AIConfigTargetingEnvironmentFallthrough) ToMap() (map[string]interface{}, error) {
...
func (o *AIConfigTargetingEnvironmentFallthrough) UnmarshalJSON(data []byte) (err error) {
	varAIConfigTargetingEnvironmentFallthrough := _AIConfigTargetingEnvironmentFallthrough{}

	err = json.Unmarshal(data, &varAIConfigTargetingEnvironmentFallthrough)

	if err != nil {
		return err
	}

	*o = AIConfigTargetingEnvironmentFallthrough(varAIConfigTargetingEnvironmentFallthrough)
...
type NullableAIConfigTargetingEnvironmentFallthrough struct {
	value *AIConfigTargetingEnvironmentFallthrough
	isSet bool
}

func (v NullableAIConfigTargetingEnvironmentFallthrough) Get() *AIConfigTargetingEnvironmentFallthrough {
	return v.value
}

func (v *NullableAIConfigTargetingEnvironmentFallthrough) Set(val *AIConfigTargetingEnvironmentFallthrough) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigTargetingEnvironmentFallthrough) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigTargetingEnvironmentFallthrough) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigTargetingEnvironmentFallthrough(val *AIConfigTargetingEnvironmentFallthrough) *NullableAIConfigTargetingEnvironmentFallthrough {
	return &NullableAIConfigTargetingEnvironmentFallthrough{value: val, isSet: true}
}

func (v NullableAIConfigTargetingEnvironmentFallthrough) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigTargetingEnvironmentFallthrough) UnmarshalJSON(src []byte) error {
	v.isSet = true
