...
// MemberRepTeams struct for MemberRepTeams
type MemberRepTeams struct {
...
func (o MemberRepTeams) MarshalJSON() ([]byte, error) {
...
type NullableMemberRepTeams struct {
	value *MemberRepTeams
	isSet bool
}

func (v NullableMemberRepTeams) Get() *MemberRepTeams {
	return v.value
}

func (v *NullableMemberRepTeams) Set(val *MemberRepTeams) {
	v.value = val
	v.isSet = true
}

func (v NullableMemberRepTeams) IsSet() bool {
	return v.isSet
}

func (v *NullableMemberRepTeams) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemberRepTeams(val *MemberRepTeams) *NullableMemberRepTeams {
	return &NullableMemberRepTeams{value: val, isSet: true}
}

func (v NullableMemberRepTeams) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemberRepTeams) UnmarshalJSON(src []byte) error {
	v.isSet = true
