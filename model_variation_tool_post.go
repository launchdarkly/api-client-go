...
// checks if the VariationToolPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VariationToolPost{}

// VariationToolPost struct for VariationToolPost
type VariationToolPost struct {
...
type _VariationToolPost VariationToolPost
...
func (o VariationToolPost) MarshalJSON() ([]byte, error) {
...
func (o VariationToolPost) ToMap() (map[string]interface{}, error) {
...
func (o *VariationToolPost) UnmarshalJSON(data []byte) (err error) {
	...
	varVariationToolPost := _VariationToolPost{}

	err = json.Unmarshal(data, &varVariationToolPost)

	if err != nil {
		return err
	}

	*o = VariationToolPost(varVariationToolPost)
...
type NullableVariationToolPost struct {
	value *VariationToolPost
	isSet bool
}

func (v NullableVariationToolPost) Get() *VariationToolPost {
	return v.value
}

func (v *NullableVariationToolPost) Set(val *VariationToolPost) {
	v.value = val
	v.isSet = true
}

func (v NullableVariationToolPost) IsSet() bool {
	return v.isSet
}

func (v *NullableVariationToolPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVariationToolPost(val *VariationToolPost) *NullableVariationToolPost {
	return &NullableVariationToolPost{value: val, isSet: true}
}

func (v NullableVariationToolPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVariationToolPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
