...
// checks if the AIConfigTargetingEnvironmentFallthroughRollout type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigTargetingEnvironmentFallthroughRollout{}

// AIConfigTargetingEnvironmentFallthroughRollout struct for AIConfigTargetingEnvironmentFallthroughRollout
type AIConfigTargetingEnvironmentFallthroughRollout struct {
	BucketBy *string `json:"bucketBy,omitempty"`
	ContextKind string `json:"contextKind"`
	ExperimentAllocation *AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation `json:"experimentAllocation,omitempty"`
	Seed *int32 `json:"seed,omitempty"`
	Variations []AIConfigTargetingEnvironmentFallthroughRolloutVariation `json:"variations"`
	AdditionalProperties map[string]interface{}
}

type _AIConfigTargetingEnvironmentFallthroughRollout AIConfigTargetingEnvironmentFallthroughRollout
...
func NewAIConfigTargetingEnvironmentFallthroughRollout(contextKind string, variations []AIConfigTargetingEnvironmentFallthroughRolloutVariation) *AIConfigTargetingEnvironmentFallthroughRollout {
	this := AIConfigTargetingEnvironmentFallthroughRollout{}
...
func (o *AIConfigTargetingEnvironmentFallthroughRollout) GetExperimentAllocation() AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation {
	if o == nil || IsNil(o.ExperimentAllocation) {
		var ret AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation
		return ret
	}
...
// SetExperimentAllocation gets a reference to the given AIConfigTargetingEnvironmentFallthroughRolloutExperimentationAllocation and assigns it to the ExperimentAllocation field.
...
func (o *AIConfigTargetingEnvironmentFallthroughRollout) GetVariations() []AIConfigTargetingEnvironmentFallthroughRolloutVariation {
	if o == nil {
		var ret []AIConfigTargetingEnvironmentFallthroughRolloutVariation
		return ret
	}
...
func (o AIConfigTargetingEnvironmentFallthroughRollout) MarshalJSON() ([]byte, error) {
...
func (o AIConfigTargetingEnvironmentFallthroughRollout) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.BucketBy) {
		toSerialize["bucketBy"] = o.BucketBy
	}
	toSerialize["contextKind"] = o.ContextKind
	if !IsNil(o.ExperimentAllocation) {
...
func (o *AIConfigTargetingEnvironmentFallthroughRollout) UnmarshalJSON(data []byte) (err error) {
	...
	varAIConfigTargetingEnvironmentFallthroughRollout := _AIConfigTargetingEnvironmentFallthroughRollout{}

	err = json.Unmarshal(data, &varAIConfigTargetingEnvironmentFallthroughRollout)

	if err != nil {
		return err
	}

	*o = AIConfigTargetingEnvironmentFallthroughRollout(varAIConfigTargetingEnvironmentFallthroughRollout)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "bucketBy")
		delete(additionalProperties, "contextKind")
		delete(additionalProperties, "experimentAllocation")
...
type NullableAIConfigTargetingEnvironmentFallthroughRollout struct {
	value *AIConfigTargetingEnvironmentFallthroughRollout
	isSet bool
}

func (v NullableAIConfigTargetingEnvironmentFallthroughRollout) Get() *AIConfigTargetingEnvironmentFallthroughRollout {
	return v.value
}

func (v *NullableAIConfigTargetingEnvironmentFallthroughRollout) Set(val *AIConfigTargetingEnvironmentFallthroughRollout) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigTargetingEnvironmentFallthroughRollout) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigTargetingEnvironmentFallthroughRollout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigTargetingEnvironmentFallthroughRollout(val *AIConfigTargetingEnvironmentFallthroughRollout) *NullableAIConfigTargetingEnvironmentFallthroughRollout {
	return &NullableAIConfigTargetingEnvironmentFallthroughRollout{value: val, isSet: true}
}

func (v NullableAIConfigTargetingEnvironmentFallthroughRollout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigTargetingEnvironmentFallthroughRollout) UnmarshalJSON(src []byte) error {
	v.isSet = true
