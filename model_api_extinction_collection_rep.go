...
func NewApiExtinctionCollectionRep() *ApiExtinctionCollectionRep {
	this := ApiExtinctionCollectionRep{}
	return &this
}
...
func (o ApiExtinctionCollectionRep) MarshalJSON() ([]byte, error) {
...
type NullableApiExtinctionCollectionRep struct {
	value *ApiExtinctionCollectionRep
	isSet bool
}

func (v NullableApiExtinctionCollectionRep) Get() *ApiExtinctionCollectionRep {
	return v.value
}

func (v *NullableApiExtinctionCollectionRep) Set(val *ApiExtinctionCollectionRep) {
	v.value = val
	v.isSet = true
}

func (v NullableApiExtinctionCollectionRep) IsSet() bool {
	return v.isSet
}

func (v *NullableApiExtinctionCollectionRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiExtinctionCollectionRep(val *ApiExtinctionCollectionRep) *NullableApiExtinctionCollectionRep {
	return &NullableApiExtinctionCollectionRep{value: val, isSet: true}
}

func (v NullableApiExtinctionCollectionRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiExtinctionCollectionRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
