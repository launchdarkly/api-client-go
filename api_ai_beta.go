...
// AIBetaApiService AIBetaApi service
type AIBetaApiService service

type ApiPostGenerateExperimentRequest struct {
	ctx context.Context
	ApiService *AIBetaApiService
	projectKey string
	environmentKey string
	generateExperimentPost *GenerateExperimentPost
}

func (r ApiPostGenerateExperimentRequest) GenerateExperimentPost(generateExperimentPost GenerateExperimentPost) ApiPostGenerateExperimentRequest {
	r.generateExperimentPost = &generateExperimentPost
	return r
}

func (r ApiPostGenerateExperimentRequest) Execute() (*AIGeneratedExperimentConfig, *http.Response, error) {
	return r.ApiService.PostGenerateExperimentExecute(r)
}

/*
PostGenerateExperiment Generate an experiment config using AI.

Generate the configuration for an experiment based on the hypothesis.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectKey Project key
 @param environmentKey Environment key
 @return ApiPostGenerateExperimentRequest
*/
func (a *AIBetaApiService) PostGenerateExperiment(ctx context.Context, projectKey string, environmentKey string) ApiPostGenerateExperimentRequest {
	return ApiPostGenerateExperimentRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return AIGeneratedExperimentConfig
func (a *AIBetaApiService) PostGenerateExperimentExecute(r ApiPostGenerateExperimentRequest) (*AIGeneratedExperimentConfig, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AIGeneratedExperimentConfig
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AIBetaApiService.PostGenerateExperiment")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/ai/projects/{projectKey}/environments/{environmentKey}/generate-experiment"
	...
	if r.generateExperimentPost == nil {
		return localVarReturnValue, nil, reportError("generateExperimentPost is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.generateExperimentPost
	if r.ctx != nil {
...
type ApiPostGenerateVariationsRequest struct {
	ctx context.Context
	ApiService *AIBetaApiService
	generateVariationsPost *GenerateVariationsPost
}

func (r ApiPostGenerateVariationsRequest) GenerateVariationsPost(generateVariationsPost GenerateVariationsPost) ApiPostGenerateVariationsRequest {
	r.generateVariationsPost = &generateVariationsPost
	return r
}

func (r ApiPostGenerateVariationsRequest) Execute() (*AIGeneratedVariations, *http.Response, error) {
	return r.ApiService.PostGenerateVariationsExecute(r)
}

/*
PostGenerateVariations Generate new variations for a feature flag

Generate a list of new variations for a flag, using AI.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostGenerateVariationsRequest
*/
func (a *AIBetaApiService) PostGenerateVariations(ctx context.Context) ApiPostGenerateVariationsRequest {
	return ApiPostGenerateVariationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return AIGeneratedVariations
func (a *AIBetaApiService) PostGenerateVariationsExecute(r ApiPostGenerateVariationsRequest) (*AIGeneratedVariations, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *AIGeneratedVariations
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AIBetaApiService.PostGenerateVariations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/ai/generate-variations"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.generateVariationsPost == nil {
		return localVarReturnValue, nil, reportError("generateVariationsPost is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.generateVariationsPost
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
