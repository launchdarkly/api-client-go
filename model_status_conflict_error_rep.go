...
// checks if the StatusConflictErrorRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatusConflictErrorRep{}
...
type _StatusConflictErrorRep StatusConflictErrorRep
...
func (o StatusConflictErrorRep) ToMap() (map[string]interface{}, error) {
...
func (o *StatusConflictErrorRep) UnmarshalJSON(data []byte) (err error) {
	...
	varStatusConflictErrorRep := _StatusConflictErrorRep{}

	err = json.Unmarshal(data, &varStatusConflictErrorRep)

	if err != nil {
		return err
	}

	*o = StatusConflictErrorRep(varStatusConflictErrorRep)
