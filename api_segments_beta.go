...
func (r ApiCreateBigSegmentExportRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *SegmentsBetaApiService) CreateBigSegmentExport(ctx _context.Context, projectKey string, environmentKey string, segmentKey string) ApiCreateBigSegmentExportRequest {
	return ApiCreateBigSegmentExportRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *SegmentsBetaApiService) CreateBigSegmentExportExecute(r ApiCreateBigSegmentExportRequest) (*_nethttp.Response, error) {
	var (
...
func (r ApiCreateBigSegmentImportRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *SegmentsBetaApiService) CreateBigSegmentImport(ctx _context.Context, projectKey string, environmentKey string, segmentKey string) ApiCreateBigSegmentImportRequest {
	return ApiCreateBigSegmentImportRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
func (a *SegmentsBetaApiService) CreateBigSegmentImportExecute(r ApiCreateBigSegmentImportRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetBigSegmentExportRequest) Execute() (Export, *_nethttp.Response, error) {
...
*/
func (a *SegmentsBetaApiService) GetBigSegmentExport(ctx _context.Context, projectKey string, environmentKey string, segmentKey string, exportID string) ApiGetBigSegmentExportRequest {
	return ApiGetBigSegmentExportRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return Export
func (a *SegmentsBetaApiService) GetBigSegmentExportExecute(r ApiGetBigSegmentExportRequest) (Export, *_nethttp.Response, error) {
	var (
...
func (r ApiGetBigSegmentImportRequest) Execute() (Import, *_nethttp.Response, error) {
...
*/
func (a *SegmentsBetaApiService) GetBigSegmentImport(ctx _context.Context, projectKey string, environmentKey string, segmentKey string, importID string) ApiGetBigSegmentImportRequest {
	return ApiGetBigSegmentImportRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return Import
func (a *SegmentsBetaApiService) GetBigSegmentImportExecute(r ApiGetBigSegmentImportRequest) (Import, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
