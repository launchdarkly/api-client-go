...
// checks if the ViewsAccessAllowedReason type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewsAccessAllowedReason{}

// ViewsAccessAllowedReason struct for ViewsAccessAllowedReason
type ViewsAccessAllowedReason struct {
...
type _ViewsAccessAllowedReason ViewsAccessAllowedReason
...
func (o ViewsAccessAllowedReason) MarshalJSON() ([]byte, error) {
...
func (o ViewsAccessAllowedReason) ToMap() (map[string]interface{}, error) {
...
func (o *ViewsAccessAllowedReason) UnmarshalJSON(data []byte) (err error) {
	...
	varViewsAccessAllowedReason := _ViewsAccessAllowedReason{}

	err = json.Unmarshal(data, &varViewsAccessAllowedReason)

	if err != nil {
		return err
	}

	*o = ViewsAccessAllowedReason(varViewsAccessAllowedReason)
...
type NullableViewsAccessAllowedReason struct {
	value *ViewsAccessAllowedReason
	isSet bool
}

func (v NullableViewsAccessAllowedReason) Get() *ViewsAccessAllowedReason {
	return v.value
}

func (v *NullableViewsAccessAllowedReason) Set(val *ViewsAccessAllowedReason) {
	v.value = val
	v.isSet = true
}

func (v NullableViewsAccessAllowedReason) IsSet() bool {
	return v.isSet
}

func (v *NullableViewsAccessAllowedReason) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewsAccessAllowedReason(val *ViewsAccessAllowedReason) *NullableViewsAccessAllowedReason {
	return &NullableViewsAccessAllowedReason{value: val, isSet: true}
}

func (v NullableViewsAccessAllowedReason) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewsAccessAllowedReason) UnmarshalJSON(src []byte) error {
	v.isSet = true
