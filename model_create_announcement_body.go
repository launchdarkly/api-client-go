...
// checks if the CreateAnnouncementBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAnnouncementBody{}
...
type _CreateAnnouncementBody CreateAnnouncementBody
...
func (o CreateAnnouncementBody) ToMap() (map[string]interface{}, error) {
...
func (o *CreateAnnouncementBody) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAnnouncementBody := _CreateAnnouncementBody{}

	err = json.Unmarshal(data, &varCreateAnnouncementBody)

	if err != nil {
		return err
	}

	*o = CreateAnnouncementBody(varCreateAnnouncementBody)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "isDismissible")
