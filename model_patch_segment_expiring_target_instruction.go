...
// checks if the PatchSegmentExpiringTargetInstruction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchSegmentExpiringTargetInstruction{}
...
type _PatchSegmentExpiringTargetInstruction PatchSegmentExpiringTargetInstruction
...
func (o PatchSegmentExpiringTargetInstruction) ToMap() (map[string]interface{}, error) {
...
func (o *PatchSegmentExpiringTargetInstruction) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchSegmentExpiringTargetInstruction := _PatchSegmentExpiringTargetInstruction{}

	err = json.Unmarshal(data, &varPatchSegmentExpiringTargetInstruction)

	if err != nil {
		return err
	}

	*o = PatchSegmentExpiringTargetInstruction(varPatchSegmentExpiringTargetInstruction)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "kind")
		delete(additionalProperties, "contextKey")
