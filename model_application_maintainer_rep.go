...
// checks if the ApplicationMaintainerRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationMaintainerRep{}

// ApplicationMaintainerRep struct for ApplicationMaintainerRep
type ApplicationMaintainerRep struct {
	Member *MemberSummary `json:"member,omitempty"`
	Team *MemberTeamSummaryRep `json:"team,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ApplicationMaintainerRep ApplicationMaintainerRep
...
func (o ApplicationMaintainerRep) MarshalJSON() ([]byte, error) {
...
func (o ApplicationMaintainerRep) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationMaintainerRep) UnmarshalJSON(data []byte) (err error) {
	varApplicationMaintainerRep := _ApplicationMaintainerRep{}

	err = json.Unmarshal(data, &varApplicationMaintainerRep)

	if err != nil {
		return err
	}

	*o = ApplicationMaintainerRep(varApplicationMaintainerRep)
...
type NullableApplicationMaintainerRep struct {
	value *ApplicationMaintainerRep
	isSet bool
}

func (v NullableApplicationMaintainerRep) Get() *ApplicationMaintainerRep {
	return v.value
}

func (v *NullableApplicationMaintainerRep) Set(val *ApplicationMaintainerRep) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationMaintainerRep) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationMaintainerRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationMaintainerRep(val *ApplicationMaintainerRep) *NullableApplicationMaintainerRep {
	return &NullableApplicationMaintainerRep{value: val, isSet: true}
}

func (v NullableApplicationMaintainerRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationMaintainerRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
