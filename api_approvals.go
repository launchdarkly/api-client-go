...
func (r ApiPostFlagCopyConfigApprovalRequestRequest) ApprovalsEndpointsCreateCopyFlagConfigApprovalRequestRequest(approvalsEndpointsCreateCopyFlagConfigApprovalRequestRequest ApprovalsEndpointsCreateCopyFlagConfigApprovalRequestRequest) ApiPostFlagCopyConfigApprovalRequestRequest {
...
func (r ApiPostFlagCopyConfigApprovalRequestRequest) Execute() (WebFlagConfigApprovalRequestResponse, *_nethttp.Response, error) {
 ...
 * @return WebFlagConfigApprovalRequestResponse
 */
func (a *ApprovalsApiService) PostFlagCopyConfigApprovalRequestExecute(r ApiPostFlagCopyConfigApprovalRequestRequest) (WebFlagConfigApprovalRequestResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
