...
// checks if the FlagImportIntegrationCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagImportIntegrationCollection{}

// FlagImportIntegrationCollection struct for FlagImportIntegrationCollection
type FlagImportIntegrationCollection struct {
	Links FlagImportIntegrationCollectionLinks `json:"_links"`
	// An array of flag import configurations
	Items []FlagImportIntegration `json:"items"`
	AdditionalProperties map[string]interface{}
}

type _FlagImportIntegrationCollection FlagImportIntegrationCollection
...
func NewFlagImportIntegrationCollection(links FlagImportIntegrationCollectionLinks, items []FlagImportIntegration) *FlagImportIntegrationCollection {
	this := FlagImportIntegrationCollection{}
	this.Links = links
	this.Items = items
	return &this
}
...
func (o *FlagImportIntegrationCollection) GetLinks() FlagImportIntegrationCollectionLinks {
	if o == nil {
		var ret FlagImportIntegrationCollectionLinks
		return ret
	}
...
func (o FlagImportIntegrationCollection) MarshalJSON() ([]byte, error) {
...
func (o FlagImportIntegrationCollection) ToMap() (map[string]interface{}, error) {
...
func (o *FlagImportIntegrationCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagImportIntegrationCollection := _FlagImportIntegrationCollection{}

	err = json.Unmarshal(data, &varFlagImportIntegrationCollection)

	if err != nil {
		return err
	}

	*o = FlagImportIntegrationCollection(varFlagImportIntegrationCollection)
...
type NullableFlagImportIntegrationCollection struct {
	value *FlagImportIntegrationCollection
	isSet bool
}

func (v NullableFlagImportIntegrationCollection) Get() *FlagImportIntegrationCollection {
	return v.value
}

func (v *NullableFlagImportIntegrationCollection) Set(val *FlagImportIntegrationCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableFlagImportIntegrationCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableFlagImportIntegrationCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlagImportIntegrationCollection(val *FlagImportIntegrationCollection) *NullableFlagImportIntegrationCollection {
	return &NullableFlagImportIntegrationCollection{value: val, isSet: true}
}

func (v NullableFlagImportIntegrationCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlagImportIntegrationCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
