...
// checks if the InsightsChartBounds type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightsChartBounds{}

// InsightsChartBounds struct for InsightsChartBounds
type InsightsChartBounds struct {
	// Name of the bound
...
type _InsightsChartBounds InsightsChartBounds

// NewInsightsChartBounds instantiates a new InsightsChartBounds object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInsightsChartBounds(name string, value int64) *InsightsChartBounds {
	this := InsightsChartBounds{}
	this.Name = name
	this.Value = value
	return &this
}

// NewInsightsChartBoundsWithDefaults instantiates a new InsightsChartBounds object
...
func (o InsightsChartBounds) ToMap() (map[string]interface{}, error) {
...
func (o *InsightsChartBounds) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightsChartBounds := _InsightsChartBounds{}

	err = json.Unmarshal(data, &varInsightsChartBounds)

	if err != nil {
		return err
	}

	*o = InsightsChartBounds(varInsightsChartBounds)
...
func NewNullableInsightsChartBounds(val *InsightsChartBounds) *NullableInsightsChartBounds {
	return &NullableInsightsChartBounds{value: val, isSet: true}
}
