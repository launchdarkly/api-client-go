...
// checks if the ExpiringTargetGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpiringTargetGetResponse{}

// ExpiringTargetGetResponse struct for ExpiringTargetGetResponse
type ExpiringTargetGetResponse struct {
...
type _ExpiringTargetGetResponse ExpiringTargetGetResponse
...
func NewExpiringTargetGetResponse(items []ExpiringTarget) *ExpiringTargetGetResponse {
	this := ExpiringTargetGetResponse{}
	this.Items = items
	return &this
}
...
func (o ExpiringTargetGetResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ExpiringTargetGetResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varExpiringTargetGetResponse := _ExpiringTargetGetResponse{}

	err = json.Unmarshal(data, &varExpiringTargetGetResponse)

	if err != nil {
		return err
	}

	*o = ExpiringTargetGetResponse(varExpiringTargetGetResponse)
...
type NullableExpiringTargetGetResponse struct {
	value *ExpiringTargetGetResponse
	isSet bool
}
...
func NewNullableExpiringTargetGetResponse(val *ExpiringTargetGetResponse) *NullableExpiringTargetGetResponse {
	return &NullableExpiringTargetGetResponse{value: val, isSet: true}
}
