...
// checks if the AgentSkillPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentSkillPost{}

// AgentSkillPost struct for AgentSkillPost
type AgentSkillPost struct {
	Key string `json:"key"`
...
type _AgentSkillPost AgentSkillPost
...
func (o AgentSkillPost) MarshalJSON() ([]byte, error) {
...
func (o AgentSkillPost) ToMap() (map[string]interface{}, error) {
...
func (o *AgentSkillPost) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentSkillPost := _AgentSkillPost{}

	err = json.Unmarshal(data, &varAgentSkillPost)

	if err != nil {
		return err
	}

	*o = AgentSkillPost(varAgentSkillPost)
...
type NullableAgentSkillPost struct {
	value *AgentSkillPost
	isSet bool
}

func (v NullableAgentSkillPost) Get() *AgentSkillPost {
	return v.value
}

func (v *NullableAgentSkillPost) Set(val *AgentSkillPost) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentSkillPost) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentSkillPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentSkillPost(val *AgentSkillPost) *NullableAgentSkillPost {
	return &NullableAgentSkillPost{value: val, isSet: true}
}

func (v NullableAgentSkillPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentSkillPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
