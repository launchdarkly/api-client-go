...
// checks if the ExperimentEnvironmentSettingRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExperimentEnvironmentSettingRep{}
...
type _ExperimentEnvironmentSettingRep ExperimentEnvironmentSettingRep
...
func (o ExperimentEnvironmentSettingRep) ToMap() (map[string]interface{}, error) {
...
func (o *ExperimentEnvironmentSettingRep) UnmarshalJSON(data []byte) (err error) {
	varExperimentEnvironmentSettingRep := _ExperimentEnvironmentSettingRep{}

	err = json.Unmarshal(data, &varExperimentEnvironmentSettingRep)

	if err != nil {
		return err
	}

	*o = ExperimentEnvironmentSettingRep(varExperimentEnvironmentSettingRep)
