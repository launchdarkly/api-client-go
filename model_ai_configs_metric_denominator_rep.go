...
func (o *AiConfigsMetricDenominatorRep) GetValueColumn() string {
...
// and a boolean to check if the value has been set.
func (o *AiConfigsMetricDenominatorRep) GetValueColumnOk() (*string, bool) {
	if o == nil || IsNil(o.ValueColumn) {
		return nil, false
	}
...
func (o *AiConfigsMetricDenominatorRep) HasValueColumn() bool {
	if o != nil && !IsNil(o.ValueColumn) {
		return true
	}
...
func (o *AiConfigsMetricDenominatorRep) SetValueColumn(v string) {
	o.ValueColumn = &v
}
...
func (o *AiConfigsMetricDenominatorRep) UnmarshalJSON(data []byte) (err error) {
	...
	*o = AiConfigsMetricDenominatorRep(varAiConfigsMetricDenominatorRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "valueColumn")
