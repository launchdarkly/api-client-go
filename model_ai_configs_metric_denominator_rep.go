...
// checks if the AiConfigsMetricDenominatorRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsMetricDenominatorRep{}

// AiConfigsMetricDenominatorRep struct for AiConfigsMetricDenominatorRep
type AiConfigsMetricDenominatorRep struct {
...
type _AiConfigsMetricDenominatorRep AiConfigsMetricDenominatorRep
...
func NewAiConfigsMetricDenominatorRep() *AiConfigsMetricDenominatorRep {
	this := AiConfigsMetricDenominatorRep{}
	return &this
}
...
// GetUnitAggregationField returns the UnitAggregationField field value if set, zero value otherwise.
func (o *AiConfigsMetricDenominatorRep) GetUnitAggregationField() string {
	if o == nil || IsNil(o.UnitAggregationField) {
		var ret string
		return ret
	}
	return *o.UnitAggregationField
}

// GetUnitAggregationFieldOk returns a tuple with the UnitAggregationField field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AiConfigsMetricDenominatorRep) GetUnitAggregationFieldOk() (*string, bool) {
	if o == nil || IsNil(o.UnitAggregationField) {
		return nil, false
	}
	return o.UnitAggregationField, true
}
...
// SetUnitAggregationField gets a reference to the given string and assigns it to the UnitAggregationField field.
func (o *AiConfigsMetricDenominatorRep) SetUnitAggregationField(v string) {
	o.UnitAggregationField = &v
}
...
func (o AiConfigsMetricDenominatorRep) MarshalJSON() ([]byte, error) {
...
func (o AiConfigsMetricDenominatorRep) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UnitAggregationField) {
		toSerialize["unitAggregationField"] = o.UnitAggregationField
	}
...
func (o *AiConfigsMetricDenominatorRep) UnmarshalJSON(data []byte) (err error) {
	varAiConfigsMetricDenominatorRep := _AiConfigsMetricDenominatorRep{}

	err = json.Unmarshal(data, &varAiConfigsMetricDenominatorRep)

	if err != nil {
		return err
	}

	*o = AiConfigsMetricDenominatorRep(varAiConfigsMetricDenominatorRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "unitAggregationField")
...
type NullableAiConfigsMetricDenominatorRep struct {
	value *AiConfigsMetricDenominatorRep
	isSet bool
}

func (v NullableAiConfigsMetricDenominatorRep) Get() *AiConfigsMetricDenominatorRep {
	return v.value
}

func (v *NullableAiConfigsMetricDenominatorRep) Set(val *AiConfigsMetricDenominatorRep) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsMetricDenominatorRep) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsMetricDenominatorRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsMetricDenominatorRep(val *AiConfigsMetricDenominatorRep) *NullableAiConfigsMetricDenominatorRep {
	return &NullableAiConfigsMetricDenominatorRep{value: val, isSet: true}
}

func (v NullableAiConfigsMetricDenominatorRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsMetricDenominatorRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
