...
// MultiEnvDependentFlagsCollectionRepItems struct for MultiEnvDependentFlagsCollectionRepItems
type MultiEnvDependentFlagsCollectionRepItems struct {
...
func NewMultiEnvDependentFlagsCollectionRepItems(key string, environments []DependentFlagWithEnvsEnvironments) *MultiEnvDependentFlagsCollectionRepItems {
	this := MultiEnvDependentFlagsCollectionRepItems{}
	this.Key = key
...
func (o MultiEnvDependentFlagsCollectionRepItems) MarshalJSON() ([]byte, error) {
...
type NullableMultiEnvDependentFlagsCollectionRepItems struct {
	value *MultiEnvDependentFlagsCollectionRepItems
	isSet bool
}

func (v NullableMultiEnvDependentFlagsCollectionRepItems) Get() *MultiEnvDependentFlagsCollectionRepItems {
	return v.value
}

func (v *NullableMultiEnvDependentFlagsCollectionRepItems) Set(val *MultiEnvDependentFlagsCollectionRepItems) {
	v.value = val
	v.isSet = true
}

func (v NullableMultiEnvDependentFlagsCollectionRepItems) IsSet() bool {
	return v.isSet
}

func (v *NullableMultiEnvDependentFlagsCollectionRepItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMultiEnvDependentFlagsCollectionRepItems(val *MultiEnvDependentFlagsCollectionRepItems) *NullableMultiEnvDependentFlagsCollectionRepItems {
	return &NullableMultiEnvDependentFlagsCollectionRepItems{value: val, isSet: true}
}

func (v NullableMultiEnvDependentFlagsCollectionRepItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMultiEnvDependentFlagsCollectionRepItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
