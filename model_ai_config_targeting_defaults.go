...
// checks if the AIConfigTargetingDefaults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigTargetingDefaults{}

// AIConfigTargetingDefaults struct for AIConfigTargetingDefaults
type AIConfigTargetingDefaults struct {
	OnVariation int32 `json:"onVariation"`
	OffVariation int32 `json:"offVariation"`
	AdditionalProperties map[string]interface{}
}

type _AIConfigTargetingDefaults AIConfigTargetingDefaults
...
func NewAIConfigTargetingDefaults(onVariation int32, offVariation int32) *AIConfigTargetingDefaults {
	this := AIConfigTargetingDefaults{}
...
func (o AIConfigTargetingDefaults) MarshalJSON() ([]byte, error) {
...
func (o AIConfigTargetingDefaults) ToMap() (map[string]interface{}, error) {
...
func (o *AIConfigTargetingDefaults) UnmarshalJSON(data []byte) (err error) {
	...
	varAIConfigTargetingDefaults := _AIConfigTargetingDefaults{}

	err = json.Unmarshal(data, &varAIConfigTargetingDefaults)

	if err != nil {
		return err
	}

	*o = AIConfigTargetingDefaults(varAIConfigTargetingDefaults)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "onVariation")
...
type NullableAIConfigTargetingDefaults struct {
	value *AIConfigTargetingDefaults
	isSet bool
}

func (v NullableAIConfigTargetingDefaults) Get() *AIConfigTargetingDefaults {
	return v.value
}

func (v *NullableAIConfigTargetingDefaults) Set(val *AIConfigTargetingDefaults) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigTargetingDefaults) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigTargetingDefaults) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigTargetingDefaults(val *AIConfigTargetingDefaults) *NullableAIConfigTargetingDefaults {
	return &NullableAIConfigTargetingDefaults{value: val, isSet: true}
}

func (v NullableAIConfigTargetingDefaults) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigTargetingDefaults) UnmarshalJSON(src []byte) error {
	v.isSet = true
