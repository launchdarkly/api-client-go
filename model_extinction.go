...
// checks if the Extinction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Extinction{}
...
func (o Extinction) ToMap() (map[string]interface{}, error) {
...
func (o *Extinction) UnmarshalJSON(data []byte) (err error) {
	...
	varExtinction := _Extinction{}

	err = json.Unmarshal(data, &varExtinction)

	if err != nil {
		return err
	}

	*o = Extinction(varExtinction)
