...
// checks if the InsightGroupCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightGroupCollection{}
...
type _InsightGroupCollection InsightGroupCollection
...
func (o *InsightGroupCollection) GetScoreMetadata() InsightGroupCollectionScoreMetadata {
	if o == nil || IsNil(o.ScoreMetadata) {
...
func (o InsightGroupCollection) ToMap() (map[string]interface{}, error) {
...
func (o *InsightGroupCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightGroupCollection := _InsightGroupCollection{}

	err = json.Unmarshal(data, &varInsightGroupCollection)

	if err != nil {
		return err
	}

	*o = InsightGroupCollection(varInsightGroupCollection)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "scoreMetadata")
