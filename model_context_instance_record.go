...
// checks if the ContextInstanceRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextInstanceRecord{}
...
type _ContextInstanceRecord ContextInstanceRecord
...
func (o *ContextInstanceRecord) GetAnonymousKinds() []string {
	if o == nil || IsNil(o.AnonymousKinds) {
		var ret []string
		return ret
	}
...
func (o ContextInstanceRecord) ToMap() (map[string]interface{}, error) {
...
func (o *ContextInstanceRecord) UnmarshalJSON(data []byte) (err error) {
	...
	varContextInstanceRecord := _ContextInstanceRecord{}

	err = json.Unmarshal(data, &varContextInstanceRecord)

	if err != nil {
		return err
	}

	*o = ContextInstanceRecord(varContextInstanceRecord)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "anonymousKinds")
