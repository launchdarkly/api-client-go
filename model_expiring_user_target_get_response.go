...
// checks if the ExpiringUserTargetGetResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpiringUserTargetGetResponse{}
...
type _ExpiringUserTargetGetResponse ExpiringUserTargetGetResponse
...
func (o ExpiringUserTargetGetResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ExpiringUserTargetGetResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varExpiringUserTargetGetResponse := _ExpiringUserTargetGetResponse{}

	err = json.Unmarshal(data, &varExpiringUserTargetGetResponse)

	if err != nil {
		return err
	}

	*o = ExpiringUserTargetGetResponse(varExpiringUserTargetGetResponse)
