...
// ProductAnalyticsQueryResultsRep struct for ProductAnalyticsQueryResultsRep
type ProductAnalyticsQueryResultsRep struct {
	QueryParameters []QueryParameters `json:"queryParameters"`
	Series []map[string]int32 `json:"series"`
	Metadata []MetricAnalyticsMetadata `json:"metadata"`
}
...
func NewProductAnalyticsQueryResultsRep(queryParameters []QueryParameters, series []map[string]int32, metadata []MetricAnalyticsMetadata) *ProductAnalyticsQueryResultsRep {
	this := ProductAnalyticsQueryResultsRep{}
...
func (o *ProductAnalyticsQueryResultsRep) GetMetadata() []MetricAnalyticsMetadata {
	if o == nil {
		var ret []MetricAnalyticsMetadata
		return ret
	}
...
func (o ProductAnalyticsQueryResultsRep) MarshalJSON() ([]byte, error) {
...
type NullableProductAnalyticsQueryResultsRep struct {
	value *ProductAnalyticsQueryResultsRep
	isSet bool
}

func (v NullableProductAnalyticsQueryResultsRep) Get() *ProductAnalyticsQueryResultsRep {
	return v.value
}

func (v *NullableProductAnalyticsQueryResultsRep) Set(val *ProductAnalyticsQueryResultsRep) {
	v.value = val
	v.isSet = true
}

func (v NullableProductAnalyticsQueryResultsRep) IsSet() bool {
	return v.isSet
}

func (v *NullableProductAnalyticsQueryResultsRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductAnalyticsQueryResultsRep(val *ProductAnalyticsQueryResultsRep) *NullableProductAnalyticsQueryResultsRep {
	return &NullableProductAnalyticsQueryResultsRep{value: val, isSet: true}
}

func (v NullableProductAnalyticsQueryResultsRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductAnalyticsQueryResultsRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
