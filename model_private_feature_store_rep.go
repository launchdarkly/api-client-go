...
// PrivateFeatureStoreRep struct for PrivateFeatureStoreRep
type PrivateFeatureStoreRep struct {
	Id string `json:"_id"`
...
func (o PrivateFeatureStoreRep) MarshalJSON() ([]byte, error) {
...
type NullablePrivateFeatureStoreRep struct {
	value *PrivateFeatureStoreRep
	isSet bool
}

func (v NullablePrivateFeatureStoreRep) Get() *PrivateFeatureStoreRep {
	return v.value
}

func (v *NullablePrivateFeatureStoreRep) Set(val *PrivateFeatureStoreRep) {
	v.value = val
	v.isSet = true
}

func (v NullablePrivateFeatureStoreRep) IsSet() bool {
	return v.isSet
}

func (v *NullablePrivateFeatureStoreRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrivateFeatureStoreRep(val *PrivateFeatureStoreRep) *NullablePrivateFeatureStoreRep {
	return &NullablePrivateFeatureStoreRep{value: val, isSet: true}
}

func (v NullablePrivateFeatureStoreRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrivateFeatureStoreRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
