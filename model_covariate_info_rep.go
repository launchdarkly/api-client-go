...
// checks if the CovariateInfoRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CovariateInfoRep{}

// CovariateInfoRep struct for CovariateInfoRep
type CovariateInfoRep struct {
...
type _CovariateInfoRep CovariateInfoRep

// NewCovariateInfoRep instantiates a new CovariateInfoRep object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCovariateInfoRep(id string, fileName string, createdAt int64) *CovariateInfoRep {
	this := CovariateInfoRep{}
	this.Id = id
...
// NewCovariateInfoRepWithDefaults instantiates a new CovariateInfoRep object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCovariateInfoRepWithDefaults() *CovariateInfoRep {
	this := CovariateInfoRep{}
	return &this
}

// GetId returns the Id field value
func (o *CovariateInfoRep) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CovariateInfoRep) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *CovariateInfoRep) SetId(v string) {
	o.Id = v
}

// GetFileName returns the FileName field value
func (o *CovariateInfoRep) GetFileName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CovariateInfoRep) GetFileNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CovariateInfoRep) SetFileName(v string) {
	o.FileName = v
}

// GetCreatedAt returns the CreatedAt field value
func (o *CovariateInfoRep) GetCreatedAt() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CovariateInfoRep) GetCreatedAtOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CovariateInfoRep) SetCreatedAt(v int64) {
	o.CreatedAt = v
}

func (o CovariateInfoRep) MarshalJSON() ([]byte, error) {
...
func (o CovariateInfoRep) ToMap() (map[string]interface{}, error) {
...
func (o *CovariateInfoRep) UnmarshalJSON(data []byte) (err error) {
	...
	varCovariateInfoRep := _CovariateInfoRep{}

	err = json.Unmarshal(data, &varCovariateInfoRep)

	if err != nil {
		return err
	}

	*o = CovariateInfoRep(varCovariateInfoRep)
...
type NullableCovariateInfoRep struct {
	value *CovariateInfoRep
	isSet bool
}

func (v NullableCovariateInfoRep) Get() *CovariateInfoRep {
	return v.value
}

func (v *NullableCovariateInfoRep) Set(val *CovariateInfoRep) {
	v.value = val
	v.isSet = true
}

func (v NullableCovariateInfoRep) IsSet() bool {
	return v.isSet
}

func (v *NullableCovariateInfoRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCovariateInfoRep(val *CovariateInfoRep) *NullableCovariateInfoRep {
	return &NullableCovariateInfoRep{value: val, isSet: true}
}

func (v NullableCovariateInfoRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCovariateInfoRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
