...
// ApiV2IntegrationsItems struct for ApiV2IntegrationsItems
type ApiV2IntegrationsItems struct {
...
func (o ApiV2IntegrationsItems) MarshalJSON() ([]byte, error) {
...
type NullableApiV2IntegrationsItems struct {
	value *ApiV2IntegrationsItems
	isSet bool
}

func (v NullableApiV2IntegrationsItems) Get() *ApiV2IntegrationsItems {
	return v.value
}

func (v *NullableApiV2IntegrationsItems) Set(val *ApiV2IntegrationsItems) {
	v.value = val
	v.isSet = true
}

func (v NullableApiV2IntegrationsItems) IsSet() bool {
	return v.isSet
}

func (v *NullableApiV2IntegrationsItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiV2IntegrationsItems(val *ApiV2IntegrationsItems) *NullableApiV2IntegrationsItems {
	return &NullableApiV2IntegrationsItems{value: val, isSet: true}
}

func (v NullableApiV2IntegrationsItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiV2IntegrationsItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
