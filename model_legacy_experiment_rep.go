...
// checks if the LegacyExperimentRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LegacyExperimentRep{}
...
type _LegacyExperimentRep LegacyExperimentRep
...
func (o LegacyExperimentRep) ToMap() (map[string]interface{}, error) {
...
func (o *LegacyExperimentRep) UnmarshalJSON(data []byte) (err error) {
	varLegacyExperimentRep := _LegacyExperimentRep{}

	err = json.Unmarshal(data, &varLegacyExperimentRep)

	if err != nil {
		return err
	}

	*o = LegacyExperimentRep(varLegacyExperimentRep)
