...
// RuleMetricsRep struct for RuleMetricsRep
type RuleMetricsRep struct {
	RuleId *string `json:"ruleId,omitempty"`
	Summary map[string]interface{} `json:"summary,omitempty"`
	Data []MigrationMetricRep `json:"data,omitempty"`
}
...
// SetData gets a reference to the given []MigrationMetricRep and assigns it to the Data field.
func (o *RuleMetricsRep) SetData(v []MigrationMetricRep) {
	o.Data = v
}

func (o RuleMetricsRep) MarshalJSON() ([]byte, error) {
...
type NullableRuleMetricsRep struct {
	value *RuleMetricsRep
	isSet bool
}

func (v NullableRuleMetricsRep) Get() *RuleMetricsRep {
	return v.value
}

func (v *NullableRuleMetricsRep) Set(val *RuleMetricsRep) {
	v.value = val
	v.isSet = true
}

func (v NullableRuleMetricsRep) IsSet() bool {
	return v.isSet
}

func (v *NullableRuleMetricsRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRuleMetricsRep(val *RuleMetricsRep) *NullableRuleMetricsRep {
	return &NullableRuleMetricsRep{value: val, isSet: true}
}

func (v NullableRuleMetricsRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRuleMetricsRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
