...
// checks if the TeamPostInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamPostInput{}
...
type _TeamPostInput TeamPostInput
...
func (o *TeamPostInput) GetCustomRoleKeys() []string {
	if o == nil || IsNil(o.CustomRoleKeys) {
		var ret []string
		return ret
	}
...
func (o TeamPostInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CustomRoleKeys) {
...
func (o *TeamPostInput) UnmarshalJSON(data []byte) (err error) {
	...
	varTeamPostInput := _TeamPostInput{}

	err = json.Unmarshal(data, &varTeamPostInput)

	if err != nil {
		return err
	}

	*o = TeamPostInput(varTeamPostInput)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "memberIDs")
