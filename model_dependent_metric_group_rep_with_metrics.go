...
// checks if the DependentMetricGroupRepWithMetrics type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DependentMetricGroupRepWithMetrics{}
...
type _DependentMetricGroupRepWithMetrics DependentMetricGroupRepWithMetrics
...
func (o DependentMetricGroupRepWithMetrics) ToMap() (map[string]interface{}, error) {
...
func (o *DependentMetricGroupRepWithMetrics) UnmarshalJSON(data []byte) (err error) {
	...
	varDependentMetricGroupRepWithMetrics := _DependentMetricGroupRepWithMetrics{}

	err = json.Unmarshal(data, &varDependentMetricGroupRepWithMetrics)

	if err != nil {
		return err
	}

	*o = DependentMetricGroupRepWithMetrics(varDependentMetricGroupRepWithMetrics)
