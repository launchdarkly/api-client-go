...
// checks if the FlagLinkCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagLinkCollectionRep{}
...
type _FlagLinkCollectionRep FlagLinkCollectionRep
...
func (o FlagLinkCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *FlagLinkCollectionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagLinkCollectionRep := _FlagLinkCollectionRep{}

	err = json.Unmarshal(data, &varFlagLinkCollectionRep)

	if err != nil {
		return err
	}

	*o = FlagLinkCollectionRep(varFlagLinkCollectionRep)
...
func NewNullableFlagLinkCollectionRep(val *FlagLinkCollectionRep) *NullableFlagLinkCollectionRep {
	return &NullableFlagLinkCollectionRep{value: val, isSet: true}
}
