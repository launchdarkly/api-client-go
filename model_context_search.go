...
// checks if the ContextSearch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextSearch{}
...
type _ContextSearch ContextSearch
...
func (o ContextSearch) ToMap() (map[string]interface{}, error) {
...
func (o *ContextSearch) UnmarshalJSON(data []byte) (err error) {
	varContextSearch := _ContextSearch{}

	err = json.Unmarshal(data, &varContextSearch)

	if err != nil {
		return err
	}

	*o = ContextSearch(varContextSearch)
