...
// checks if the AiConfigsMetricListingRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsMetricListingRep{}

// AiConfigsMetricListingRep struct for AiConfigsMetricListingRep
type AiConfigsMetricListingRep struct {
	...
	Links map[string]AiConfigsLink `json:"_links"`
	Site *AiConfigsLink `json:"_site,omitempty"`
	Access *AiConfigsAccess `json:"_access,omitempty"`
	// Tags for the metric
	Tags []string `json:"tags"`
	CreationDate int64 `json:"_creationDate"`
	LastModified *AiConfigsModification `json:"lastModified,omitempty"`
	// The ID of the member who maintains this metric
	MaintainerId *string `json:"maintainerId,omitempty"`
	Maintainer *AiConfigsMemberSummary `json:"_maintainer,omitempty"`
	...
	Filters *AiConfigsFilter `json:"filters,omitempty"`
	...
	WinsorExcludeImputed *bool `json:"winsorExcludeImputed,omitempty"`
	...
	Denominator *AiConfigsMetricDenominatorRep `json:"denominator,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AiConfigsMetricListingRep AiConfigsMetricListingRep
...
// GetGuardedRolloutCount returns the GuardedRolloutCount field value if set, zero value otherwise.
func (o *AiConfigsMetricListingRep) GetGuardedRolloutCount() int32 {
	if o == nil || IsNil(o.GuardedRolloutCount) {
		var ret int32
		return ret
	}
	return *o.GuardedRolloutCount
}

// GetGuardedRolloutCountOk returns a tuple with the GuardedRolloutCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AiConfigsMetricListingRep) GetGuardedRolloutCountOk() (*int32, bool) {
	if o == nil || IsNil(o.GuardedRolloutCount) {
		return nil, false
	}
	return o.GuardedRolloutCount, true
}
...
func (o *AiConfigsMetricListingRep) GetLinks() map[string]AiConfigsLink {
	if o == nil {
		var ret map[string]AiConfigsLink
		return ret
	}
...
// SetSite gets a reference to the given AiConfigsLink and assigns it to the Site field.
...
// SetLastModified gets a reference to the given AiConfigsModification and assigns it to the LastModified field.
...
func (o *AiConfigsMetricListingRep) GetMaintainer() AiConfigsMemberSummary {
	if o == nil || IsNil(o.Maintainer) {
		var ret AiConfigsMemberSummary
		return ret
	}
	return *o.Maintainer
}
...
// SetMaintainer gets a reference to the given AiConfigsMemberSummary and assigns it to the Maintainer field.
...
func (o *AiConfigsMetricListingRep) GetAnalysisUnits() []string {
...
// and a boolean to check if the value has been set.
func (o *AiConfigsMetricListingRep) GetAnalysisUnitsOk() ([]string, bool) {
	if o == nil || IsNil(o.AnalysisUnits) {
		return nil, false
	}
...
func (o *AiConfigsMetricListingRep) HasAnalysisUnits() bool {
	if o != nil && !IsNil(o.AnalysisUnits) {
		return true
	}
...
func (o *AiConfigsMetricListingRep) SetAnalysisUnits(v []string) {
	o.AnalysisUnits = v
}
...
// SetFilters gets a reference to the given AiConfigsFilter and assigns it to the Filters field.
...
func (o *AiConfigsMetricListingRep) GetEventDefault() AiConfigsMetricEventDefaultRep {
	if o == nil || IsNil(o.EventDefault) {
		var ret AiConfigsMetricEventDefaultRep
		return ret
	}
...
// SetEventDefault gets a reference to the given AiConfigsMetricEventDefaultRep and assigns it to the EventDefault field.
...
func (o *AiConfigsMetricListingRep) GetWindowStartOffset() int64 {
...
// and a boolean to check if the value has been set.
func (o *AiConfigsMetricListingRep) GetWindowStartOffsetOk() (*int64, bool) {
	if o == nil || IsNil(o.WindowStartOffset) {
		return nil, false
	}
...
func (o *AiConfigsMetricListingRep) HasWindowStartOffset() bool {
	if o != nil && !IsNil(o.WindowStartOffset) {
		return true
	}
...
func (o *AiConfigsMetricListingRep) SetWindowStartOffset(v int64) {
	o.WindowStartOffset = &v
}

// GetWindowEndOffset returns the WindowEndOffset field value if set, zero value otherwise.
func (o *AiConfigsMetricListingRep) GetWindowEndOffset() int64 {
...
// and a boolean to check if the value has been set.
func (o *AiConfigsMetricListingRep) GetWindowEndOffsetOk() (*int64, bool) {
	if o == nil || IsNil(o.WindowEndOffset) {
		return nil, false
	}
...
func (o *AiConfigsMetricListingRep) HasWindowEndOffset() bool {
	if o != nil && !IsNil(o.WindowEndOffset) {
		return true
	}
...
func (o *AiConfigsMetricListingRep) SetWindowEndOffset(v int64) {
	o.WindowEndOffset = &v
}

// GetWinsorLowerPercentile returns the WinsorLowerPercentile field value if set, zero value otherwise.
func (o *AiConfigsMetricListingRep) GetWinsorLowerPercentile() float32 {
...
// and a boolean to check if the value has been set.
func (o *AiConfigsMetricListingRep) GetWinsorLowerPercentileOk() (*float32, bool) {
	if o == nil || IsNil(o.WinsorLowerPercentile) {
		return nil, false
	}
...
func (o *AiConfigsMetricListingRep) HasWinsorLowerPercentile() bool {
	if o != nil && !IsNil(o.WinsorLowerPercentile) {
		return true
	}
...
func (o *AiConfigsMetricListingRep) SetWinsorLowerPercentile(v float32) {
...
func (o *AiConfigsMetricListingRep) GetWinsorUpperPercentile() float32 {
...
// and a boolean to check if the value has been set.
func (o *AiConfigsMetricListingRep) GetWinsorUpperPercentileOk() (*float32, bool) {
	if o == nil || IsNil(o.WinsorUpperPercentile) {
		return nil, false
	}
...
func (o *AiConfigsMetricListingRep) HasWinsorUpperPercentile() bool {
	if o != nil && !IsNil(o.WinsorUpperPercentile) {
		return true
	}
...
func (o *AiConfigsMetricListingRep) SetWinsorUpperPercentile(v float32) {
	o.WinsorUpperPercentile = &v
}

// GetWinsorExcludeImputed returns the WinsorExcludeImputed field value if set, zero value otherwise.
func (o *AiConfigsMetricListingRep) GetWinsorExcludeImputed() bool {
	if o == nil || IsNil(o.WinsorExcludeImputed) {
		var ret bool
		return ret
	}
	return *o.WinsorExcludeImputed
}

// GetWinsorExcludeImputedOk returns a tuple with the WinsorExcludeImputed field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AiConfigsMetricListingRep) GetWinsorExcludeImputedOk() (*bool, bool) {
	if o == nil || IsNil(o.WinsorExcludeImputed) {
		return nil, false
	}
	return o.WinsorExcludeImputed, true
}

// HasWinsorExcludeImputed returns a boolean if a field has been set.
func (o *AiConfigsMetricListingRep) HasWinsorExcludeImputed() bool {
	if o != nil && !IsNil(o.WinsorExcludeImputed) {
		return true
	}
...
// SetWinsorExcludeImputed gets a reference to the given bool and assigns it to the WinsorExcludeImputed field.
func (o *AiConfigsMetricListingRep) SetWinsorExcludeImputed(v bool) {
	o.WinsorExcludeImputed = &v
}

// GetWinsorIncludeImputed returns the WinsorIncludeImputed field value if set, zero value otherwise.
func (o *AiConfigsMetricListingRep) GetWinsorIncludeImputed() bool {
...
// and a boolean to check if the value has been set.
func (o *AiConfigsMetricListingRep) GetWinsorIncludeImputedOk() (*bool, bool) {
	if o == nil || IsNil(o.WinsorIncludeImputed) {
		return nil, false
	}
...
func (o *AiConfigsMetricListingRep) HasWinsorIncludeImputed() bool {
	if o != nil && !IsNil(o.WinsorIncludeImputed) {
		return true
	}
...
func (o *AiConfigsMetricListingRep) SetWinsorIncludeImputed(v bool) {
	o.WinsorIncludeImputed = &v
}

// GetTraceQuery returns the TraceQuery field value if set, zero value otherwise.
func (o *AiConfigsMetricListingRep) GetTraceQuery() string {
...
// and a boolean to check if the value has been set.
func (o *AiConfigsMetricListingRep) GetTraceQueryOk() (*string, bool) {
	if o == nil || IsNil(o.TraceQuery) {
		return nil, false
	}
...
func (o *AiConfigsMetricListingRep) HasTraceQuery() bool {
	if o != nil && !IsNil(o.TraceQuery) {
		return true
	}
...
func (o *AiConfigsMetricListingRep) SetTraceQuery(v string) {
	o.TraceQuery = &v
}

// GetTraceValueLocation returns the TraceValueLocation field value if set, zero value otherwise.
func (o *AiConfigsMetricListingRep) GetTraceValueLocation() string {
...
// and a boolean to check if the value has been set.
func (o *AiConfigsMetricListingRep) GetTraceValueLocationOk() (*string, bool) {
	if o == nil || IsNil(o.TraceValueLocation) {
		return nil, false
	}
...
func (o *AiConfigsMetricListingRep) HasTraceValueLocation() bool {
	if o != nil && !IsNil(o.TraceValueLocation) {
		return true
	}
...
func (o *AiConfigsMetricListingRep) SetTraceValueLocation(v string) {
	o.TraceValueLocation = &v
}

// GetDenominator returns the Denominator field value if set, zero value otherwise.
func (o *AiConfigsMetricListingRep) GetDenominator() AiConfigsMetricDenominatorRep {
	if o == nil || IsNil(o.Denominator) {
		var ret AiConfigsMetricDenominatorRep
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AiConfigsMetricListingRep) GetDenominatorOk() (*AiConfigsMetricDenominatorRep, bool) {
	if o == nil || IsNil(o.Denominator) {
		return nil, false
	}
...
func (o *AiConfigsMetricListingRep) HasDenominator() bool {
	if o != nil && !IsNil(o.Denominator) {
		return true
	}
...
// SetDenominator gets a reference to the given AiConfigsMetricDenominatorRep and assigns it to the Denominator field.
func (o *AiConfigsMetricListingRep) SetDenominator(v AiConfigsMetricDenominatorRep) {
	o.Denominator = &v
}

func (o AiConfigsMetricListingRep) MarshalJSON() ([]byte, error) {
...
func (o AiConfigsMetricListingRep) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.WinsorExcludeImputed) {
		toSerialize["winsorExcludeImputed"] = o.WinsorExcludeImputed
	}
...
func (o *AiConfigsMetricListingRep) UnmarshalJSON(data []byte) (err error) {
	...
	varAiConfigsMetricListingRep := _AiConfigsMetricListingRep{}

	err = json.Unmarshal(data, &varAiConfigsMetricListingRep)

	if err != nil {
		return err
	}

	*o = AiConfigsMetricListingRep(varAiConfigsMetricListingRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "winsorExcludeImputed")
...
type NullableAiConfigsMetricListingRep struct {
	value *AiConfigsMetricListingRep
	isSet bool
}

func (v NullableAiConfigsMetricListingRep) Get() *AiConfigsMetricListingRep {
	return v.value
}

func (v *NullableAiConfigsMetricListingRep) Set(val *AiConfigsMetricListingRep) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsMetricListingRep) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsMetricListingRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsMetricListingRep(val *AiConfigsMetricListingRep) *NullableAiConfigsMetricListingRep {
	return &NullableAiConfigsMetricListingRep{value: val, isSet: true}
}

func (v NullableAiConfigsMetricListingRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsMetricListingRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
