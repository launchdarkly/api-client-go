...
// checks if the AiConfigsAccessDeniedReason type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsAccessDeniedReason{}
...
type _AiConfigsAccessDeniedReason AiConfigsAccessDeniedReason
...
func (o AiConfigsAccessDeniedReason) ToMap() (map[string]interface{}, error) {
...
func (o *AiConfigsAccessDeniedReason) UnmarshalJSON(data []byte) (err error) {
	...
	varAiConfigsAccessDeniedReason := _AiConfigsAccessDeniedReason{}

	err = json.Unmarshal(data, &varAiConfigsAccessDeniedReason)

	if err != nil {
		return err
	}

	*o = AiConfigsAccessDeniedReason(varAiConfigsAccessDeniedReason)
