...
// checks if the ViewsMaintainerMember type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewsMaintainerMember{}

// ViewsMaintainerMember struct for ViewsMaintainerMember
type ViewsMaintainerMember struct {
	Id string `json:"id"`
...
type _ViewsMaintainerMember ViewsMaintainerMember
...
func (o ViewsMaintainerMember) MarshalJSON() ([]byte, error) {
...
func (o ViewsMaintainerMember) ToMap() (map[string]interface{}, error) {
...
func (o *ViewsMaintainerMember) UnmarshalJSON(data []byte) (err error) {
	...
	varViewsMaintainerMember := _ViewsMaintainerMember{}

	err = json.Unmarshal(data, &varViewsMaintainerMember)

	if err != nil {
		return err
	}

	*o = ViewsMaintainerMember(varViewsMaintainerMember)
...
type NullableViewsMaintainerMember struct {
	value *ViewsMaintainerMember
	isSet bool
}

func (v NullableViewsMaintainerMember) Get() *ViewsMaintainerMember {
	return v.value
}

func (v *NullableViewsMaintainerMember) Set(val *ViewsMaintainerMember) {
	v.value = val
	v.isSet = true
}

func (v NullableViewsMaintainerMember) IsSet() bool {
	return v.isSet
}

func (v *NullableViewsMaintainerMember) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewsMaintainerMember(val *ViewsMaintainerMember) *NullableViewsMaintainerMember {
	return &NullableViewsMaintainerMember{value: val, isSet: true}
}

func (v NullableViewsMaintainerMember) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewsMaintainerMember) UnmarshalJSON(src []byte) error {
	v.isSet = true
