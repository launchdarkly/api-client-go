...
// checks if the SegmentBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SegmentBody{}
...
func (o SegmentBody) ToMap() (map[string]interface{}, error) {
...
func (o *SegmentBody) UnmarshalJSON(data []byte) (err error) {
	...
	varSegmentBody := _SegmentBody{}

	err = json.Unmarshal(data, &varSegmentBody)

	if err != nil {
		return err
	}

	*o = SegmentBody(varSegmentBody)
