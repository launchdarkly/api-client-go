...
// checks if the ExpandedResourceRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedResourceRep{}

// ExpandedResourceRep struct for ExpandedResourceRep
type ExpandedResourceRep struct {
	// The type of resource
	Kind string `json:"kind"`
	AiConfig *AIConfigRep `json:"aiConfig,omitempty"`
	Experiment *ExpandedExperimentRep `json:"experiment,omitempty"`
	Flag *ExpandedFlagRep `json:"flag,omitempty"`
	Segment *UserSegment `json:"segment,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ExpandedResourceRep ExpandedResourceRep
...
// SetAiConfig gets a reference to the given AIConfigRep and assigns it to the AiConfig field.
...
// SetExperiment gets a reference to the given ExpandedExperimentRep and assigns it to the Experiment field.
...
func (o ExpandedResourceRep) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedResourceRep) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedResourceRep := _ExpandedResourceRep{}

	err = json.Unmarshal(data, &varExpandedResourceRep)

	if err != nil {
		return err
	}

	*o = ExpandedResourceRep(varExpandedResourceRep)
