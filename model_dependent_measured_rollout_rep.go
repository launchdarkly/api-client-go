...
// checks if the DependentMeasuredRolloutRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DependentMeasuredRolloutRep{}

// DependentMeasuredRolloutRep struct for DependentMeasuredRolloutRep
type DependentMeasuredRolloutRep struct {
	...
	FlagPurpose *string `json:"flagPurpose,omitempty"`
...
type _DependentMeasuredRolloutRep DependentMeasuredRolloutRep
...
func NewDependentMeasuredRolloutRep(id string, flagKey string, flagName string, environmentKey string, environmentName string, status string, creationDate int64, links map[string]Link) *DependentMeasuredRolloutRep {
	this := DependentMeasuredRolloutRep{}
	this.Id = id
...
// GetFlagPurpose returns the FlagPurpose field value if set, zero value otherwise.
func (o *DependentMeasuredRolloutRep) GetFlagPurpose() string {
	if o == nil || IsNil(o.FlagPurpose) {
		var ret string
		return ret
	}
	return *o.FlagPurpose
}

// GetFlagPurposeOk returns a tuple with the FlagPurpose field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DependentMeasuredRolloutRep) GetFlagPurposeOk() (*string, bool) {
	if o == nil || IsNil(o.FlagPurpose) {
		return nil, false
	}
	return o.FlagPurpose, true
}
...
// SetFlagPurpose gets a reference to the given string and assigns it to the FlagPurpose field.
...
func (o DependentMeasuredRolloutRep) MarshalJSON() ([]byte, error) {
...
func (o DependentMeasuredRolloutRep) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["_id"] = o.Id
	toSerialize["flagKey"] = o.FlagKey
	toSerialize["flagName"] = o.FlagName
	if !IsNil(o.FlagPurpose) {
		toSerialize["flagPurpose"] = o.FlagPurpose
	}
...
func (o *DependentMeasuredRolloutRep) UnmarshalJSON(data []byte) (err error) {
	...
	varDependentMeasuredRolloutRep := _DependentMeasuredRolloutRep{}

	err = json.Unmarshal(data, &varDependentMeasuredRolloutRep)

	if err != nil {
		return err
	}

	*o = DependentMeasuredRolloutRep(varDependentMeasuredRolloutRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "_id")
		delete(additionalProperties, "flagKey")
		delete(additionalProperties, "flagName")
		delete(additionalProperties, "flagPurpose")
...
type NullableDependentMeasuredRolloutRep struct {
	value *DependentMeasuredRolloutRep
	isSet bool
}

func (v NullableDependentMeasuredRolloutRep) Get() *DependentMeasuredRolloutRep {
	return v.value
}

func (v *NullableDependentMeasuredRolloutRep) Set(val *DependentMeasuredRolloutRep) {
	v.value = val
	v.isSet = true
}

func (v NullableDependentMeasuredRolloutRep) IsSet() bool {
	return v.isSet
}

func (v *NullableDependentMeasuredRolloutRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDependentMeasuredRolloutRep(val *DependentMeasuredRolloutRep) *NullableDependentMeasuredRolloutRep {
	return &NullableDependentMeasuredRolloutRep{value: val, isSet: true}
}

func (v NullableDependentMeasuredRolloutRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDependentMeasuredRolloutRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
