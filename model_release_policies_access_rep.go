...
// checks if the ReleasePoliciesAccessRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleasePoliciesAccessRep{}

// ReleasePoliciesAccessRep struct for ReleasePoliciesAccessRep
type ReleasePoliciesAccessRep struct {
	Denied []ReleasePoliciesAccessDenied `json:"denied"`
	Allowed []ReleasePoliciesAccessAllowedRep `json:"allowed"`
	AdditionalProperties map[string]interface{}
}

type _ReleasePoliciesAccessRep ReleasePoliciesAccessRep
...
func (o *ReleasePoliciesAccessRep) GetDenied() []ReleasePoliciesAccessDenied {
	if o == nil {
		var ret []ReleasePoliciesAccessDenied
		return ret
	}
...
func (o *ReleasePoliciesAccessRep) GetAllowed() []ReleasePoliciesAccessAllowedRep {
	if o == nil {
		var ret []ReleasePoliciesAccessAllowedRep
		return ret
	}
...
func (o ReleasePoliciesAccessRep) MarshalJSON() ([]byte, error) {
...
func (o ReleasePoliciesAccessRep) ToMap() (map[string]interface{}, error) {
...
func (o *ReleasePoliciesAccessRep) UnmarshalJSON(data []byte) (err error) {
	...
	varReleasePoliciesAccessRep := _ReleasePoliciesAccessRep{}

	err = json.Unmarshal(data, &varReleasePoliciesAccessRep)

	if err != nil {
		return err
	}

	*o = ReleasePoliciesAccessRep(varReleasePoliciesAccessRep)
...
type NullableReleasePoliciesAccessRep struct {
	value *ReleasePoliciesAccessRep
	isSet bool
}

func (v NullableReleasePoliciesAccessRep) Get() *ReleasePoliciesAccessRep {
	return v.value
}

func (v *NullableReleasePoliciesAccessRep) Set(val *ReleasePoliciesAccessRep) {
	v.value = val
	v.isSet = true
}

func (v NullableReleasePoliciesAccessRep) IsSet() bool {
	return v.isSet
}

func (v *NullableReleasePoliciesAccessRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleasePoliciesAccessRep(val *ReleasePoliciesAccessRep) *NullableReleasePoliciesAccessRep {
	return &NullableReleasePoliciesAccessRep{value: val, isSet: true}
}

func (v NullableReleasePoliciesAccessRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReleasePoliciesAccessRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
