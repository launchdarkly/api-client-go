...
// checks if the CustomWorkflowOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomWorkflowOutput{}
...
type _CustomWorkflowOutput CustomWorkflowOutput
...
func (o CustomWorkflowOutput) ToMap() (map[string]interface{}, error) {
...
func (o *CustomWorkflowOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomWorkflowOutput := _CustomWorkflowOutput{}

	err = json.Unmarshal(data, &varCustomWorkflowOutput)

	if err != nil {
		return err
	}

	*o = CustomWorkflowOutput(varCustomWorkflowOutput)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_conflicts")
