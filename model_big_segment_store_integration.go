...
// checks if the BigSegmentStoreIntegration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BigSegmentStoreIntegration{}
...
type _BigSegmentStoreIntegration BigSegmentStoreIntegration
...
func (o BigSegmentStoreIntegration) ToMap() (map[string]interface{}, error) {
...
func (o *BigSegmentStoreIntegration) UnmarshalJSON(data []byte) (err error) {
	...
	varBigSegmentStoreIntegration := _BigSegmentStoreIntegration{}

	err = json.Unmarshal(data, &varBigSegmentStoreIntegration)

	if err != nil {
		return err
	}

	*o = BigSegmentStoreIntegration(varBigSegmentStoreIntegration)
