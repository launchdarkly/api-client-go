...
// checks if the InsightsRepositoryProjectCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightsRepositoryProjectCollection{}
...
type _InsightsRepositoryProjectCollection InsightsRepositoryProjectCollection
...
func (o InsightsRepositoryProjectCollection) ToMap() (map[string]interface{}, error) {
...
func (o *InsightsRepositoryProjectCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightsRepositoryProjectCollection := _InsightsRepositoryProjectCollection{}

	err = json.Unmarshal(data, &varInsightsRepositoryProjectCollection)

	if err != nil {
		return err
	}

	*o = InsightsRepositoryProjectCollection(varInsightsRepositoryProjectCollection)
