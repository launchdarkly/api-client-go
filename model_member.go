...
type Member struct {
	...
	MfaGracePeriodExpiresAt *int64 `json:"mfaGracePeriodExpiresAt,omitempty"`
...
func (o *Member) GetExcludedDashboards() []string {
	if o == nil || IsNil(o.ExcludedDashboards) {
		var ret []string
		return ret
	}
...
func (o *Member) GetLastSeenMetadata() LastSeenMetadata {
	if o == nil || IsNil(o.LastSeenMetadata) {
...
func (o *Member) GetRoleAttributes() map[string][]string {
	if o == nil || IsNil(o.RoleAttributes) {
...
// GetMfaGracePeriodExpiresAt returns the MfaGracePeriodExpiresAt field value if set, zero value otherwise.
func (o *Member) GetMfaGracePeriodExpiresAt() int64 {
	if o == nil || IsNil(o.MfaGracePeriodExpiresAt) {
		var ret int64
		return ret
	}
	return *o.MfaGracePeriodExpiresAt
}

// GetMfaGracePeriodExpiresAtOk returns a tuple with the MfaGracePeriodExpiresAt field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Member) GetMfaGracePeriodExpiresAtOk() (*int64, bool) {
	if o == nil || IsNil(o.MfaGracePeriodExpiresAt) {
		return nil, false
	}
	return o.MfaGracePeriodExpiresAt, true
}
...
// SetMfaGracePeriodExpiresAt gets a reference to the given int64 and assigns it to the MfaGracePeriodExpiresAt field.
func (o *Member) SetMfaGracePeriodExpiresAt(v int64) {
	o.MfaGracePeriodExpiresAt = &v
}
...
func (o Member) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RoleAttributes) {
		toSerialize["roleAttributes"] = o.RoleAttributes
	}
	if !IsNil(o.MfaEnforced) {
		toSerialize["mfaEnforced"] = o.MfaEnforced
	}
	if !IsNil(o.MfaGracePeriodExpiresAt) {
		toSerialize["mfaGracePeriodExpiresAt"] = o.MfaGracePeriodExpiresAt
	}
...
func (o *Member) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Member(varMember)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_pendingInvite")
		delete(additionalProperties, "_verified")
		delete(additionalProperties, "_pendingEmail")
		delete(additionalProperties, "customRoles")
		delete(additionalProperties, "mfa")
		delete(additionalProperties, "excludedDashboards")
		delete(additionalProperties, "_lastSeen")
		delete(additionalProperties, "_lastSeenMetadata")
		delete(additionalProperties, "_integrationMetadata")
		delete(additionalProperties, "teams")
		delete(additionalProperties, "permissionGrants")
		delete(additionalProperties, "creationDate")
		delete(additionalProperties, "oauthProviders")
		delete(additionalProperties, "hasPassword")
		delete(additionalProperties, "version")
		delete(additionalProperties, "roleAttributes")
		delete(additionalProperties, "mfaEnforced")
		delete(additionalProperties, "mfaGracePeriodExpiresAt")
