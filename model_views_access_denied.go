...
// checks if the ViewsAccessDenied type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewsAccessDenied{}

// ViewsAccessDenied struct for ViewsAccessDenied
type ViewsAccessDenied struct {
	Action string `json:"action"`
	Reason ViewsAccessDeniedReason `json:"reason"`
	AdditionalProperties map[string]interface{}
}

type _ViewsAccessDenied ViewsAccessDenied
...
func (o *ViewsAccessDenied) GetReason() ViewsAccessDeniedReason {
	if o == nil {
		var ret ViewsAccessDeniedReason
		return ret
	}
...
func (o ViewsAccessDenied) MarshalJSON() ([]byte, error) {
...
func (o ViewsAccessDenied) ToMap() (map[string]interface{}, error) {
...
func (o *ViewsAccessDenied) UnmarshalJSON(data []byte) (err error) {
	...
	varViewsAccessDenied := _ViewsAccessDenied{}

	err = json.Unmarshal(data, &varViewsAccessDenied)

	if err != nil {
		return err
	}

	*o = ViewsAccessDenied(varViewsAccessDenied)
...
type NullableViewsAccessDenied struct {
	value *ViewsAccessDenied
	isSet bool
}

func (v NullableViewsAccessDenied) Get() *ViewsAccessDenied {
	return v.value
}

func (v *NullableViewsAccessDenied) Set(val *ViewsAccessDenied) {
	v.value = val
	v.isSet = true
}

func (v NullableViewsAccessDenied) IsSet() bool {
	return v.isSet
}

func (v *NullableViewsAccessDenied) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewsAccessDenied(val *ViewsAccessDenied) *NullableViewsAccessDenied {
	return &NullableViewsAccessDenied{value: val, isSet: true}
}

func (v NullableViewsAccessDenied) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewsAccessDenied) UnmarshalJSON(src []byte) error {
	v.isSet = true
