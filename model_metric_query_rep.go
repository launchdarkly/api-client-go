...
// MetricQueryRep struct for MetricQueryRep
type MetricQueryRep struct {
...
func (o MetricQueryRep) MarshalJSON() ([]byte, error) {
...
type NullableMetricQueryRep struct {
	value *MetricQueryRep
	isSet bool
}

func (v NullableMetricQueryRep) Get() *MetricQueryRep {
	return v.value
}

func (v *NullableMetricQueryRep) Set(val *MetricQueryRep) {
	v.value = val
	v.isSet = true
}

func (v NullableMetricQueryRep) IsSet() bool {
	return v.isSet
}

func (v *NullableMetricQueryRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetricQueryRep(val *MetricQueryRep) *NullableMetricQueryRep {
	return &NullableMetricQueryRep{value: val, isSet: true}
}

func (v NullableMetricQueryRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetricQueryRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
