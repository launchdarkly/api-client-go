...
// checks if the MetricInGroupRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricInGroupRep{}
...
type MetricInGroupRep struct {
	...
	AnalysisUnit *string `json:"analysisUnit,omitempty"`
...
type _MetricInGroupRep MetricInGroupRep
...
func (o *MetricInGroupRep) GetAnalysisType() string {
...
// and a boolean to check if the value has been set.
func (o *MetricInGroupRep) GetAnalysisTypeOk() (*string, bool) {
	if o == nil || IsNil(o.AnalysisType) {
		return nil, false
	}
...
func (o *MetricInGroupRep) HasAnalysisType() bool {
	if o != nil && !IsNil(o.AnalysisType) {
		return true
	}
...
func (o *MetricInGroupRep) SetAnalysisType(v string) {
	o.AnalysisType = &v
}
...
// GetAnalysisUnit returns the AnalysisUnit field value if set, zero value otherwise.
func (o *MetricInGroupRep) GetAnalysisUnit() string {
	if o == nil || IsNil(o.AnalysisUnit) {
		var ret string
		return ret
	}
	return *o.AnalysisUnit
}

// GetAnalysisUnitOk returns a tuple with the AnalysisUnit field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MetricInGroupRep) GetAnalysisUnitOk() (*string, bool) {
	if o == nil || IsNil(o.AnalysisUnit) {
		return nil, false
	}
	return o.AnalysisUnit, true
}
...
// SetAnalysisUnit gets a reference to the given string and assigns it to the AnalysisUnit field.
...
func (o *MetricInGroupRep) GetAnalysisUnits() []string {
...
// and a boolean to check if the value has been set.
func (o *MetricInGroupRep) GetAnalysisUnitsOk() ([]string, bool) {
	if o == nil || IsNil(o.AnalysisUnits) {
		return nil, false
	}
...
func (o *MetricInGroupRep) HasAnalysisUnits() bool {
	if o != nil && !IsNil(o.AnalysisUnits) {
		return true
	}
...
func (o *MetricInGroupRep) SetAnalysisUnits(v []string) {
	o.AnalysisUnits = v
}
...
func (o MetricInGroupRep) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AnalysisUnit) {
		toSerialize["analysisUnit"] = o.AnalysisUnit
	}
	toSerialize["_links"] = o.Links
	if !IsNil(o.NameInGroup) {
...
func (o *MetricInGroupRep) UnmarshalJSON(data []byte) (err error) {
	...
	varMetricInGroupRep := _MetricInGroupRep{}

	err = json.Unmarshal(data, &varMetricInGroupRep)

	if err != nil {
		return err
	}

	*o = MetricInGroupRep(varMetricInGroupRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "analysisUnit")
		delete(additionalProperties, "_links")
		delete(additionalProperties, "nameInGroup")
