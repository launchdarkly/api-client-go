...
// checks if the ContextAttributeName type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextAttributeName{}
...
type _ContextAttributeName ContextAttributeName
...
func (o ContextAttributeName) ToMap() (map[string]interface{}, error) {
...
func (o *ContextAttributeName) UnmarshalJSON(data []byte) (err error) {
	...
	varContextAttributeName := _ContextAttributeName{}

	err = json.Unmarshal(data, &varContextAttributeName)

	if err != nil {
		return err
	}

	*o = ContextAttributeName(varContextAttributeName)
