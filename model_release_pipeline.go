...
// checks if the ReleasePipeline type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleasePipeline{}
...
type _ReleasePipeline ReleasePipeline
...
func (o ReleasePipeline) ToMap() (map[string]interface{}, error) {
...
func (o *ReleasePipeline) UnmarshalJSON(data []byte) (err error) {
	...
	varReleasePipeline := _ReleasePipeline{}

	err = json.Unmarshal(data, &varReleasePipeline)

	if err != nil {
		return err
	}

	*o = ReleasePipeline(varReleasePipeline)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_isLegacy")
