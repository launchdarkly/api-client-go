...
// checks if the FeatureFlagScheduledChanges type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeatureFlagScheduledChanges{}
...
type _FeatureFlagScheduledChanges FeatureFlagScheduledChanges
...
func (o FeatureFlagScheduledChanges) ToMap() (map[string]interface{}, error) {
...
func (o *FeatureFlagScheduledChanges) UnmarshalJSON(data []byte) (err error) {
	...
	varFeatureFlagScheduledChanges := _FeatureFlagScheduledChanges{}

	err = json.Unmarshal(data, &varFeatureFlagScheduledChanges)

	if err != nil {
		return err
	}

	*o = FeatureFlagScheduledChanges(varFeatureFlagScheduledChanges)
