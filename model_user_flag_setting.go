...
// checks if the UserFlagSetting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserFlagSetting{}
...
type _UserFlagSetting UserFlagSetting
...
func (o UserFlagSetting) ToMap() (map[string]interface{}, error) {
...
func (o *UserFlagSetting) UnmarshalJSON(data []byte) (err error) {
	...
	varUserFlagSetting := _UserFlagSetting{}

	err = json.Unmarshal(data, &varUserFlagSetting)

	if err != nil {
		return err
	}

	*o = UserFlagSetting(varUserFlagSetting)
