...
// checks if the ExperimentInfoRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExperimentInfoRep{}
...
type _ExperimentInfoRep ExperimentInfoRep
...
func (o ExperimentInfoRep) ToMap() (map[string]interface{}, error) {
...
func (o *ExperimentInfoRep) UnmarshalJSON(data []byte) (err error) {
	...
	varExperimentInfoRep := _ExperimentInfoRep{}

	err = json.Unmarshal(data, &varExperimentInfoRep)

	if err != nil {
		return err
	}

	*o = ExperimentInfoRep(varExperimentInfoRep)
