...
// checks if the ModelConfigPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelConfigPatch{}

// ModelConfigPatch struct for ModelConfigPatch
type ModelConfigPatch struct {
	...
	CostPerCachedInputToken *float64 `json:"costPerCachedInputToken,omitempty"`
...
type _ModelConfigPatch ModelConfigPatch
...
func (o *ModelConfigPatch) GetCostPerInputToken() float64 {
	if o == nil || IsNil(o.CostPerInputToken) {
		var ret float64
		return ret
	}
...
func (o *ModelConfigPatch) GetCostPerOutputToken() float64 {
	if o == nil || IsNil(o.CostPerOutputToken) {
		var ret float64
		return ret
	}
...
// GetCostPerCachedInputToken returns the CostPerCachedInputToken field value if set, zero value otherwise.
func (o *ModelConfigPatch) GetCostPerCachedInputToken() float64 {
	if o == nil || IsNil(o.CostPerCachedInputToken) {
		var ret float64
		return ret
	}
	return *o.CostPerCachedInputToken
}

// GetCostPerCachedInputTokenOk returns a tuple with the CostPerCachedInputToken field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ModelConfigPatch) GetCostPerCachedInputTokenOk() (*float64, bool) {
	if o == nil || IsNil(o.CostPerCachedInputToken) {
		return nil, false
	}
	return o.CostPerCachedInputToken, true
}
...
// SetCostPerCachedInputToken gets a reference to the given float64 and assigns it to the CostPerCachedInputToken field.
func (o *ModelConfigPatch) SetCostPerCachedInputToken(v float64) {
	o.CostPerCachedInputToken = &v
}
...
func (o ModelConfigPatch) MarshalJSON() ([]byte, error) {
...
func (o ModelConfigPatch) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CostPerInputToken) {
		toSerialize["costPerInputToken"] = o.CostPerInputToken
	}
	if !IsNil(o.CostPerOutputToken) {
		toSerialize["costPerOutputToken"] = o.CostPerOutputToken
	}
	if !IsNil(o.CostPerCachedInputToken) {
		toSerialize["costPerCachedInputToken"] = o.CostPerCachedInputToken
	}
	if !IsNil(o.Params) {
...
func (o *ModelConfigPatch) UnmarshalJSON(data []byte) (err error) {
	varModelConfigPatch := _ModelConfigPatch{}

	err = json.Unmarshal(data, &varModelConfigPatch)

	if err != nil {
		return err
	}

	*o = ModelConfigPatch(varModelConfigPatch)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "costPerInputToken")
		delete(additionalProperties, "costPerOutputToken")
		delete(additionalProperties, "costPerCachedInputToken")
		delete(additionalProperties, "params")
		delete(additionalProperties, "customParams")
...
type NullableModelConfigPatch struct {
	value *ModelConfigPatch
	isSet bool
}

func (v NullableModelConfigPatch) Get() *ModelConfigPatch {
	return v.value
}

func (v *NullableModelConfigPatch) Set(val *ModelConfigPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableModelConfigPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableModelConfigPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelConfigPatch(val *ModelConfigPatch) *NullableModelConfigPatch {
	return &NullableModelConfigPatch{value: val, isSet: true}
}

func (v NullableModelConfigPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelConfigPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
