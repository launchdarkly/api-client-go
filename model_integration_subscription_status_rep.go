...
// checks if the IntegrationSubscriptionStatusRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationSubscriptionStatusRep{}
...
type _IntegrationSubscriptionStatusRep IntegrationSubscriptionStatusRep
...
func (o IntegrationSubscriptionStatusRep) ToMap() (map[string]interface{}, error) {
...
func (o *IntegrationSubscriptionStatusRep) UnmarshalJSON(data []byte) (err error) {
	varIntegrationSubscriptionStatusRep := _IntegrationSubscriptionStatusRep{}

	err = json.Unmarshal(data, &varIntegrationSubscriptionStatusRep)

	if err != nil {
		return err
	}

	*o = IntegrationSubscriptionStatusRep(varIntegrationSubscriptionStatusRep)
