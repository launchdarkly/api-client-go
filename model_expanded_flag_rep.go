...
// checks if the ExpandedFlagRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedFlagRep{}
...
type _ExpandedFlagRep ExpandedFlagRep
...
func (o ExpandedFlagRep) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedFlagRep) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedFlagRep := _ExpandedFlagRep{}

	err = json.Unmarshal(data, &varExpandedFlagRep)

	if err != nil {
		return err
	}

	*o = ExpandedFlagRep(varExpandedFlagRep)
