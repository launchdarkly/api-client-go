...
// checks if the UsersRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UsersRep{}
...
func (o UsersRep) ToMap() (map[string]interface{}, error) {
...
func (o *UsersRep) UnmarshalJSON(data []byte) (err error) {
	...
	varUsersRep := _UsersRep{}

	err = json.Unmarshal(data, &varUsersRep)

	if err != nil {
		return err
	}

	*o = UsersRep(varUsersRep)
