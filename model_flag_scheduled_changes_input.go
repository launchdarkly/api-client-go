...
// checks if the FlagScheduledChangesInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagScheduledChangesInput{}
...
type _FlagScheduledChangesInput FlagScheduledChangesInput
...
func (o FlagScheduledChangesInput) ToMap() (map[string]interface{}, error) {
...
func (o *FlagScheduledChangesInput) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagScheduledChangesInput := _FlagScheduledChangesInput{}

	err = json.Unmarshal(data, &varFlagScheduledChangesInput)

	if err != nil {
		return err
	}

	*o = FlagScheduledChangesInput(varFlagScheduledChangesInput)
