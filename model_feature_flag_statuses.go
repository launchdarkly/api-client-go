...
// checks if the FeatureFlagStatuses type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeatureFlagStatuses{}
...
type _FeatureFlagStatuses FeatureFlagStatuses
...
func (o FeatureFlagStatuses) ToMap() (map[string]interface{}, error) {
...
func (o *FeatureFlagStatuses) UnmarshalJSON(data []byte) (err error) {
	...
	varFeatureFlagStatuses := _FeatureFlagStatuses{}

	err = json.Unmarshal(data, &varFeatureFlagStatuses)

	if err != nil {
		return err
	}

	*o = FeatureFlagStatuses(varFeatureFlagStatuses)
