...
// checks if the PatchFailedErrorRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchFailedErrorRep{}
...
type _PatchFailedErrorRep PatchFailedErrorRep
...
func (o PatchFailedErrorRep) ToMap() (map[string]interface{}, error) {
...
func (o *PatchFailedErrorRep) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchFailedErrorRep := _PatchFailedErrorRep{}

	err = json.Unmarshal(data, &varPatchFailedErrorRep)

	if err != nil {
		return err
	}

	*o = PatchFailedErrorRep(varPatchFailedErrorRep)
