...
// checks if the CapabilityConfigRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilityConfigRep{}

// CapabilityConfigRep struct for CapabilityConfigRep
type CapabilityConfigRep struct {
	Approvals *ApprovalsCapabilityConfig `json:"approvals,omitempty"`
	AuditLogEventsHook *AuditLogEventsHookCapabilityConfigRep `json:"auditLogEventsHook,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CapabilityConfigRep CapabilityConfigRep
...
func (o *CapabilityConfigRep) GetAuditLogEventsHook() AuditLogEventsHookCapabilityConfigRep {
	if o == nil || IsNil(o.AuditLogEventsHook) {
		var ret AuditLogEventsHookCapabilityConfigRep
		return ret
	}
...
// SetAuditLogEventsHook gets a reference to the given AuditLogEventsHookCapabilityConfigRep and assigns it to the AuditLogEventsHook field.
func (o *CapabilityConfigRep) SetAuditLogEventsHook(v AuditLogEventsHookCapabilityConfigRep) {
	o.AuditLogEventsHook = &v
}

func (o CapabilityConfigRep) MarshalJSON() ([]byte, error) {
...
func (o CapabilityConfigRep) ToMap() (map[string]interface{}, error) {
...
func (o *CapabilityConfigRep) UnmarshalJSON(data []byte) (err error) {
	varCapabilityConfigRep := _CapabilityConfigRep{}

	err = json.Unmarshal(data, &varCapabilityConfigRep)

	if err != nil {
		return err
	}

	*o = CapabilityConfigRep(varCapabilityConfigRep)
...
type NullableCapabilityConfigRep struct {
	value *CapabilityConfigRep
	isSet bool
}

func (v NullableCapabilityConfigRep) Get() *CapabilityConfigRep {
	return v.value
}

func (v *NullableCapabilityConfigRep) Set(val *CapabilityConfigRep) {
	v.value = val
	v.isSet = true
}

func (v NullableCapabilityConfigRep) IsSet() bool {
	return v.isSet
}

func (v *NullableCapabilityConfigRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCapabilityConfigRep(val *CapabilityConfigRep) *NullableCapabilityConfigRep {
	return &NullableCapabilityConfigRep{value: val, isSet: true}
}

func (v NullableCapabilityConfigRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCapabilityConfigRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
