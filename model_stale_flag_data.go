...
// checks if the StaleFlagData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StaleFlagData{}

// StaleFlagData struct for StaleFlagData
type StaleFlagData struct {
	// Whether the flag is ready for code removal
	ReadyForCodeRemoval *bool `json:"readyForCodeRemoval,omitempty"`
	// Whether the flag is ready to be archived
	ReadyToArchive *bool `json:"readyToArchive,omitempty"`
	// If a third-party system helps clean up the flag, the ID from that system
	CleanupId *string `json:"cleanupId,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _StaleFlagData StaleFlagData
...
// GetReadyForCodeRemoval returns the ReadyForCodeRemoval field value if set, zero value otherwise.
func (o *StaleFlagData) GetReadyForCodeRemoval() bool {
	if o == nil || IsNil(o.ReadyForCodeRemoval) {
		var ret bool
		return ret
	}
	return *o.ReadyForCodeRemoval
}

// GetReadyForCodeRemovalOk returns a tuple with the ReadyForCodeRemoval field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StaleFlagData) GetReadyForCodeRemovalOk() (*bool, bool) {
	if o == nil || IsNil(o.ReadyForCodeRemoval) {
		return nil, false
	}
	return o.ReadyForCodeRemoval, true
}
...
// SetReadyForCodeRemoval gets a reference to the given bool and assigns it to the ReadyForCodeRemoval field.
func (o *StaleFlagData) SetReadyForCodeRemoval(v bool) {
	o.ReadyForCodeRemoval = &v
}

// GetReadyToArchive returns the ReadyToArchive field value if set, zero value otherwise.
func (o *StaleFlagData) GetReadyToArchive() bool {
	if o == nil || IsNil(o.ReadyToArchive) {
		var ret bool
		return ret
	}
	return *o.ReadyToArchive
}

// GetReadyToArchiveOk returns a tuple with the ReadyToArchive field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StaleFlagData) GetReadyToArchiveOk() (*bool, bool) {
	if o == nil || IsNil(o.ReadyToArchive) {
		return nil, false
	}
	return o.ReadyToArchive, true
}
...
// SetReadyToArchive gets a reference to the given bool and assigns it to the ReadyToArchive field.
func (o *StaleFlagData) SetReadyToArchive(v bool) {
	o.ReadyToArchive = &v
}

// GetCleanupId returns the CleanupId field value if set, zero value otherwise.
func (o *StaleFlagData) GetCleanupId() string {
	if o == nil || IsNil(o.CleanupId) {
		var ret string
		return ret
	}
	return *o.CleanupId
...
// GetCleanupIdOk returns a tuple with the CleanupId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StaleFlagData) GetCleanupIdOk() (*string, bool) {
	if o == nil || IsNil(o.CleanupId) {
		return nil, false
	}
	return o.CleanupId, true
}
...
// SetCleanupId gets a reference to the given string and assigns it to the CleanupId field.
func (o *StaleFlagData) SetCleanupId(v string) {
	o.CleanupId = &v
}

func (o StaleFlagData) MarshalJSON() ([]byte, error) {
...
func (o StaleFlagData) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ReadyForCodeRemoval) {
		toSerialize["readyForCodeRemoval"] = o.ReadyForCodeRemoval
	}
	if !IsNil(o.ReadyToArchive) {
		toSerialize["readyToArchive"] = o.ReadyToArchive
	}
	if !IsNil(o.CleanupId) {
		toSerialize["cleanupId"] = o.CleanupId
	}
...
func (o *StaleFlagData) UnmarshalJSON(data []byte) (err error) {
	varStaleFlagData := _StaleFlagData{}

	err = json.Unmarshal(data, &varStaleFlagData)

	if err != nil {
		return err
	}

	*o = StaleFlagData(varStaleFlagData)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "readyForCodeRemoval")
		delete(additionalProperties, "readyToArchive")
		delete(additionalProperties, "cleanupId")
...
type NullableStaleFlagData struct {
	value *StaleFlagData
	isSet bool
}

func (v NullableStaleFlagData) Get() *StaleFlagData {
	return v.value
}

func (v *NullableStaleFlagData) Set(val *StaleFlagData) {
	v.value = val
	v.isSet = true
}

func (v NullableStaleFlagData) IsSet() bool {
	return v.isSet
}

func (v *NullableStaleFlagData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStaleFlagData(val *StaleFlagData) *NullableStaleFlagData {
	return &NullableStaleFlagData{value: val, isSet: true}
}

func (v NullableStaleFlagData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStaleFlagData) UnmarshalJSON(src []byte) error {
	v.isSet = true
