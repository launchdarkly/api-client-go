...
GetAllHoldouts Get all holdouts
 ...
 @return ApiGetAllHoldoutsRequest
*/
func (a *HoldoutsApiService) GetAllHoldouts(ctx context.Context, projectKey string, environmentKey string) ApiGetAllHoldoutsRequest {
	return ApiGetAllHoldoutsRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return HoldoutsCollectionRep
func (a *HoldoutsApiService) GetAllHoldoutsExecute(r ApiGetAllHoldoutsRequest) (*HoldoutsCollectionRep, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HoldoutsApiService.GetAllHoldouts")
	if err != nil {
...
For example, `expand=draftIteration,rel-draftIteration` includes the `draftIteration` and `rel-draftIteration` fields in the response. If fields that you request with the `expand` query parameter are empty, they are not included in the response.
 ...
 @return ApiGetHoldoutRequest
*/
func (a *HoldoutsApiService) GetHoldout(ctx context.Context, projectKey string, environmentKey string, holdoutKey string) ApiGetHoldoutRequest {
	return ApiGetHoldoutRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return HoldoutDetailRep
func (a *HoldoutsApiService) GetHoldoutExecute(r ApiGetHoldoutRequest) (*HoldoutDetailRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HoldoutsApiService.GetHoldout")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterValueToString(r.projectKey, "projectKey")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", url.PathEscape(parameterValueToString(r.environmentKey, "environmentKey")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"holdoutKey"+"}", url.PathEscape(parameterValueToString(r.holdoutKey, "holdoutKey")), -1)
...
GetHoldoutById Get Holdout by Id
 ...
 @return ApiGetHoldoutByIdRequest
*/
func (a *HoldoutsApiService) GetHoldoutById(ctx context.Context, projectKey string, environmentKey string, holdoutId string) ApiGetHoldoutByIdRequest {
	return ApiGetHoldoutByIdRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return HoldoutRep
func (a *HoldoutsApiService) GetHoldoutByIdExecute(r ApiGetHoldoutByIdRequest) (*HoldoutRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HoldoutsApiService.GetHoldoutById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterValueToString(r.projectKey, "projectKey")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", url.PathEscape(parameterValueToString(r.environmentKey, "environmentKey")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"holdoutId"+"}", url.PathEscape(parameterValueToString(r.holdoutId, "holdoutId")), -1)
...
```
 ...
 @return ApiPatchHoldoutRequest
*/
func (a *HoldoutsApiService) PatchHoldout(ctx context.Context, projectKey string, environmentKey string, holdoutKey string) ApiPatchHoldoutRequest {
	return ApiPatchHoldoutRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return HoldoutRep
func (a *HoldoutsApiService) PatchHoldoutExecute(r ApiPatchHoldoutRequest) (*HoldoutRep, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HoldoutsApiService.PatchHoldout")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Create a new holdout in the specified project.
 ...
 @return ApiPostHoldoutRequest
*/
func (a *HoldoutsApiService) PostHoldout(ctx context.Context, projectKey string, environmentKey string) ApiPostHoldoutRequest {
	return ApiPostHoldoutRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return HoldoutRep
func (a *HoldoutsApiService) PostHoldoutExecute(r ApiPostHoldoutRequest) (*HoldoutRep, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "HoldoutsApiService.PostHoldout")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
