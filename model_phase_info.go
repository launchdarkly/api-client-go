...
// checks if the PhaseInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhaseInfo{}
...
func (o PhaseInfo) ToMap() (map[string]interface{}, error) {
...
func (o *PhaseInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varPhaseInfo := _PhaseInfo{}

	err = json.Unmarshal(data, &varPhaseInfo)

	if err != nil {
		return err
	}

	*o = PhaseInfo(varPhaseInfo)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "releaseCount")
