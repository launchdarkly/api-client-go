...
// InternalApplicationVersionAdoption struct for InternalApplicationVersionAdoption
type InternalApplicationVersionAdoption struct {
	// The application version number
	Key *string `json:"key,omitempty"`
	// The application version name
	Name *string `json:"name,omitempty"`
	// The number of devices that have adopted this version
	DeviceCount *int32 `json:"deviceCount,omitempty"`
	// The percentage of total devices that have adopted this version
	AdoptionPercentage *float32 `json:"adoptionPercentage,omitempty"`
	// Whether the application version is supported
...
func NewInternalApplicationVersionAdoption() *InternalApplicationVersionAdoption {
	this := InternalApplicationVersionAdoption{}
	return &this
}
...
// GetAdoptionPercentage returns the AdoptionPercentage field value if set, zero value otherwise.
func (o *InternalApplicationVersionAdoption) GetAdoptionPercentage() float32 {
	if o == nil || o.AdoptionPercentage == nil {
		var ret float32
		return ret
	}
	return *o.AdoptionPercentage
}

// GetAdoptionPercentageOk returns a tuple with the AdoptionPercentage field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InternalApplicationVersionAdoption) GetAdoptionPercentageOk() (*float32, bool) {
	if o == nil || o.AdoptionPercentage == nil {
		return nil, false
	}
	return o.AdoptionPercentage, true
}
...
// SetAdoptionPercentage gets a reference to the given float32 and assigns it to the AdoptionPercentage field.
func (o *InternalApplicationVersionAdoption) SetAdoptionPercentage(v float32) {
	o.AdoptionPercentage = &v
}
...
func (o InternalApplicationVersionAdoption) MarshalJSON() ([]byte, error) {
	...
	if o.AdoptionPercentage != nil {
		toSerialize["adoptionPercentage"] = o.AdoptionPercentage
	}
	if o.Supported != nil {
...
type NullableInternalApplicationVersionAdoption struct {
	value *InternalApplicationVersionAdoption
	isSet bool
}

func (v NullableInternalApplicationVersionAdoption) Get() *InternalApplicationVersionAdoption {
	return v.value
}

func (v *NullableInternalApplicationVersionAdoption) Set(val *InternalApplicationVersionAdoption) {
	v.value = val
	v.isSet = true
}

func (v NullableInternalApplicationVersionAdoption) IsSet() bool {
	return v.isSet
}

func (v *NullableInternalApplicationVersionAdoption) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInternalApplicationVersionAdoption(val *InternalApplicationVersionAdoption) *NullableInternalApplicationVersionAdoption {
	return &NullableInternalApplicationVersionAdoption{value: val, isSet: true}
}

func (v NullableInternalApplicationVersionAdoption) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInternalApplicationVersionAdoption) UnmarshalJSON(src []byte) error {
	v.isSet = true
