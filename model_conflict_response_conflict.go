...
// ConflictResponseConflict struct for ConflictResponseConflict
type ConflictResponseConflict struct {
	Id string `json:"_id"`
	Reason string `json:"reason"`
	PendingChangeWillFail bool `json:"pendingChangeWillFail"`
}
...
func NewConflictResponseConflict(id string, reason string, pendingChangeWillFail bool) *ConflictResponseConflict {
	this := ConflictResponseConflict{}
	this.Id = id
	this.Reason = reason
	this.PendingChangeWillFail = pendingChangeWillFail
	return &this
}
...
// GetPendingChangeWillFail returns the PendingChangeWillFail field value
...
// GetPendingChangeWillFailOk returns a tuple with the PendingChangeWillFail field value
// and a boolean to check if the value has been set.
...
// SetPendingChangeWillFail sets field value
func (o *ConflictResponseConflict) SetPendingChangeWillFail(v bool) {
	o.PendingChangeWillFail = v
}

func (o ConflictResponseConflict) MarshalJSON() ([]byte, error) {
...
type NullableConflictResponseConflict struct {
	value *ConflictResponseConflict
	isSet bool
}

func (v NullableConflictResponseConflict) Get() *ConflictResponseConflict {
	return v.value
}

func (v *NullableConflictResponseConflict) Set(val *ConflictResponseConflict) {
	v.value = val
	v.isSet = true
}

func (v NullableConflictResponseConflict) IsSet() bool {
	return v.isSet
}

func (v *NullableConflictResponseConflict) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConflictResponseConflict(val *ConflictResponseConflict) *NullableConflictResponseConflict {
	return &NullableConflictResponseConflict{value: val, isSet: true}
}

func (v NullableConflictResponseConflict) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConflictResponseConflict) UnmarshalJSON(src []byte) error {
	v.isSet = true
