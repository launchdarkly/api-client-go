...
// StoreIntegrationStatus struct for StoreIntegrationStatus
type StoreIntegrationStatus struct {
...
func (o StoreIntegrationStatus) MarshalJSON() ([]byte, error) {
...
type NullableStoreIntegrationStatus struct {
	value *StoreIntegrationStatus
	isSet bool
}

func (v NullableStoreIntegrationStatus) Get() *StoreIntegrationStatus {
	return v.value
}

func (v *NullableStoreIntegrationStatus) Set(val *StoreIntegrationStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableStoreIntegrationStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableStoreIntegrationStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoreIntegrationStatus(val *StoreIntegrationStatus) *NullableStoreIntegrationStatus {
	return &NullableStoreIntegrationStatus{value: val, isSet: true}
}

func (v NullableStoreIntegrationStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoreIntegrationStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
