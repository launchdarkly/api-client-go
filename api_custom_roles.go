...
*/
func (a *CustomRolesApiService) DeleteCustomRole(ctx _context.Context, customRoleKey string) ApiDeleteCustomRoleRequest {
	return ApiDeleteCustomRoleRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *CustomRolesApiService) DeleteCustomRoleExecute(r ApiDeleteCustomRoleRequest) (*_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"customRoleKey"+"}", _neturl.PathEscape(parameterToString(r.customRoleKey, "")), -1)
...
*/
func (a *CustomRolesApiService) GetCustomRole(ctx _context.Context, customRoleKey string) ApiGetCustomRoleRequest {
	return ApiGetCustomRoleRequest{
		ApiService: a,
		ctx: ctx,
		customRoleKey: customRoleKey,
...
*/
func (a *CustomRolesApiService) PatchCustomRole(ctx _context.Context, customRoleKey string) ApiPatchCustomRoleRequest {
	return ApiPatchCustomRoleRequest{
		ApiService: a,
		ctx: ctx,
		customRoleKey: customRoleKey,
