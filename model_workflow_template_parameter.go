...
// checks if the WorkflowTemplateParameter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowTemplateParameter{}
...
type _WorkflowTemplateParameter WorkflowTemplateParameter
...
func (o WorkflowTemplateParameter) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowTemplateParameter) UnmarshalJSON(data []byte) (err error) {
	varWorkflowTemplateParameter := _WorkflowTemplateParameter{}

	err = json.Unmarshal(data, &varWorkflowTemplateParameter)

	if err != nil {
		return err
	}

	*o = WorkflowTemplateParameter(varWorkflowTemplateParameter)
