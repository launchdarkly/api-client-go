...
// checks if the TriggerWorkflowCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerWorkflowCollectionRep{}
...
type _TriggerWorkflowCollectionRep TriggerWorkflowCollectionRep
...
func (o TriggerWorkflowCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *TriggerWorkflowCollectionRep) UnmarshalJSON(data []byte) (err error) {
	varTriggerWorkflowCollectionRep := _TriggerWorkflowCollectionRep{}

	err = json.Unmarshal(data, &varTriggerWorkflowCollectionRep)

	if err != nil {
		return err
	}

	*o = TriggerWorkflowCollectionRep(varTriggerWorkflowCollectionRep)
