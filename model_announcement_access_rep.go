...
// checks if the AnnouncementAccessRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnnouncementAccessRep{}

// AnnouncementAccessRep struct for AnnouncementAccessRep
type AnnouncementAccessRep struct {
	Denied []AnnouncementAccessDenied `json:"denied"`
	Allowed []AnnouncementAccessAllowedRep `json:"allowed"`
	AdditionalProperties map[string]interface{}
}

type _AnnouncementAccessRep AnnouncementAccessRep
...
func (o *AnnouncementAccessRep) GetDenied() []AnnouncementAccessDenied {
	if o == nil {
		var ret []AnnouncementAccessDenied
		return ret
	}
...
func (o *AnnouncementAccessRep) GetAllowed() []AnnouncementAccessAllowedRep {
	if o == nil {
		var ret []AnnouncementAccessAllowedRep
		return ret
	}
...
func (o AnnouncementAccessRep) MarshalJSON() ([]byte, error) {
...
func (o AnnouncementAccessRep) ToMap() (map[string]interface{}, error) {
...
func (o *AnnouncementAccessRep) UnmarshalJSON(data []byte) (err error) {
	...
	varAnnouncementAccessRep := _AnnouncementAccessRep{}

	err = json.Unmarshal(data, &varAnnouncementAccessRep)

	if err != nil {
		return err
	}

	*o = AnnouncementAccessRep(varAnnouncementAccessRep)
...
type NullableAnnouncementAccessRep struct {
	value *AnnouncementAccessRep
	isSet bool
}

func (v NullableAnnouncementAccessRep) Get() *AnnouncementAccessRep {
	return v.value
}

func (v *NullableAnnouncementAccessRep) Set(val *AnnouncementAccessRep) {
	v.value = val
	v.isSet = true
}

func (v NullableAnnouncementAccessRep) IsSet() bool {
	return v.isSet
}

func (v *NullableAnnouncementAccessRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnnouncementAccessRep(val *AnnouncementAccessRep) *NullableAnnouncementAccessRep {
	return &NullableAnnouncementAccessRep{value: val, isSet: true}
}

func (v NullableAnnouncementAccessRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnnouncementAccessRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
