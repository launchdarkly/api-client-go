...
// checks if the MetricByVariation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricByVariation{}

// MetricByVariation struct for MetricByVariation
type MetricByVariation struct {
	VariationKey *string `json:"variationKey,omitempty"`
	Metrics *Metrics `json:"metrics,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MetricByVariation MetricByVariation
...
func (o MetricByVariation) MarshalJSON() ([]byte, error) {
...
func (o MetricByVariation) ToMap() (map[string]interface{}, error) {
...
func (o *MetricByVariation) UnmarshalJSON(data []byte) (err error) {
	varMetricByVariation := _MetricByVariation{}

	err = json.Unmarshal(data, &varMetricByVariation)

	if err != nil {
		return err
	}

	*o = MetricByVariation(varMetricByVariation)
...
type NullableMetricByVariation struct {
	value *MetricByVariation
	isSet bool
}

func (v NullableMetricByVariation) Get() *MetricByVariation {
	return v.value
}

func (v *NullableMetricByVariation) Set(val *MetricByVariation) {
	v.value = val
	v.isSet = true
}

func (v NullableMetricByVariation) IsSet() bool {
	return v.isSet
}

func (v *NullableMetricByVariation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetricByVariation(val *MetricByVariation) *NullableMetricByVariation {
	return &NullableMetricByVariation{value: val, isSet: true}
}

func (v NullableMetricByVariation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetricByVariation) UnmarshalJSON(src []byte) error {
	v.isSet = true
