...
// checks if the AIConfigRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigRep{}

// AIConfigRep struct for AIConfigRep
type AIConfigRep struct {
...
func (o AIConfigRep) MarshalJSON() ([]byte, error) {
...
func (o AIConfigRep) ToMap() (map[string]interface{}, error) {
...
func (o *AIConfigRep) UnmarshalJSON(data []byte) (err error) {
	...
	varAIConfigRep := _AIConfigRep{}

	err = json.Unmarshal(data, &varAIConfigRep)

	if err != nil {
		return err
	}

	*o = AIConfigRep(varAIConfigRep)
...
type NullableAIConfigRep struct {
	value *AIConfigRep
	isSet bool
}

func (v NullableAIConfigRep) Get() *AIConfigRep {
	return v.value
}

func (v *NullableAIConfigRep) Set(val *AIConfigRep) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigRep) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigRep(val *AIConfigRep) *NullableAIConfigRep {
	return &NullableAIConfigRep{value: val, isSet: true}
}

func (v NullableAIConfigRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
