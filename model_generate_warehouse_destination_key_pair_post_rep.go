...
// checks if the GenerateWarehouseDestinationKeyPairPostRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GenerateWarehouseDestinationKeyPairPostRep{}

// GenerateWarehouseDestinationKeyPairPostRep struct for GenerateWarehouseDestinationKeyPairPostRep
type GenerateWarehouseDestinationKeyPairPostRep struct {
	// The public key used by LaunchDarkly
	PublicKey *string `json:"public_key,omitempty"`
	// The public key to assign in your Snowflake worksheet
	PublicKeyPkcs8 *string `json:"public_key_pkcs8,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _GenerateWarehouseDestinationKeyPairPostRep GenerateWarehouseDestinationKeyPairPostRep
...
func NewGenerateWarehouseDestinationKeyPairPostRep() *GenerateWarehouseDestinationKeyPairPostRep {
	this := GenerateWarehouseDestinationKeyPairPostRep{}
	return &this
}
...
func (o GenerateWarehouseDestinationKeyPairPostRep) MarshalJSON() ([]byte, error) {
...
func (o GenerateWarehouseDestinationKeyPairPostRep) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.PublicKey) {
		toSerialize["public_key"] = o.PublicKey
	}
	if !IsNil(o.PublicKeyPkcs8) {
		toSerialize["public_key_pkcs8"] = o.PublicKeyPkcs8
	}
...
func (o *GenerateWarehouseDestinationKeyPairPostRep) UnmarshalJSON(data []byte) (err error) {
	varGenerateWarehouseDestinationKeyPairPostRep := _GenerateWarehouseDestinationKeyPairPostRep{}

	err = json.Unmarshal(data, &varGenerateWarehouseDestinationKeyPairPostRep)

	if err != nil {
		return err
	}

	*o = GenerateWarehouseDestinationKeyPairPostRep(varGenerateWarehouseDestinationKeyPairPostRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "public_key")
		delete(additionalProperties, "public_key_pkcs8")
...
type NullableGenerateWarehouseDestinationKeyPairPostRep struct {
	value *GenerateWarehouseDestinationKeyPairPostRep
	isSet bool
}

func (v NullableGenerateWarehouseDestinationKeyPairPostRep) Get() *GenerateWarehouseDestinationKeyPairPostRep {
	return v.value
}

func (v *NullableGenerateWarehouseDestinationKeyPairPostRep) Set(val *GenerateWarehouseDestinationKeyPairPostRep) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateWarehouseDestinationKeyPairPostRep) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateWarehouseDestinationKeyPairPostRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateWarehouseDestinationKeyPairPostRep(val *GenerateWarehouseDestinationKeyPairPostRep) *NullableGenerateWarehouseDestinationKeyPairPostRep {
	return &NullableGenerateWarehouseDestinationKeyPairPostRep{value: val, isSet: true}
}

func (v NullableGenerateWarehouseDestinationKeyPairPostRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateWarehouseDestinationKeyPairPostRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
