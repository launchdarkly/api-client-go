...
// checks if the UpsertContextKindPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpsertContextKindPayload{}
...
type _UpsertContextKindPayload UpsertContextKindPayload
...
func (o UpsertContextKindPayload) ToMap() (map[string]interface{}, error) {
...
func (o *UpsertContextKindPayload) UnmarshalJSON(data []byte) (err error) {
	...
	varUpsertContextKindPayload := _UpsertContextKindPayload{}

	err = json.Unmarshal(data, &varUpsertContextKindPayload)

	if err != nil {
		return err
	}

	*o = UpsertContextKindPayload(varUpsertContextKindPayload)
