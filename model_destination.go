...
type Destination struct {
	...
	CompletedArtifacts *RedshiftDataExportCompletedArtifactsRep `json:"completedArtifacts,omitempty"`
...
// GetCompletedArtifacts returns the CompletedArtifacts field value if set, zero value otherwise.
func (o *Destination) GetCompletedArtifacts() RedshiftDataExportCompletedArtifactsRep {
	if o == nil || IsNil(o.CompletedArtifacts) {
		var ret RedshiftDataExportCompletedArtifactsRep
		return ret
	}
	return *o.CompletedArtifacts
}

// GetCompletedArtifactsOk returns a tuple with the CompletedArtifacts field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Destination) GetCompletedArtifactsOk() (*RedshiftDataExportCompletedArtifactsRep, bool) {
	if o == nil || IsNil(o.CompletedArtifacts) {
		return nil, false
	}
	return o.CompletedArtifacts, true
}
...
// SetCompletedArtifacts gets a reference to the given RedshiftDataExportCompletedArtifactsRep and assigns it to the CompletedArtifacts field.
func (o *Destination) SetCompletedArtifacts(v RedshiftDataExportCompletedArtifactsRep) {
	o.CompletedArtifacts = &v
}
...
func (o Destination) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CompletedArtifacts) {
		toSerialize["completedArtifacts"] = o.CompletedArtifacts
	}
...
func (o *Destination) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Destination(varDestination)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "completedArtifacts")
