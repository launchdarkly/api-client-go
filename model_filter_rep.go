...
// FilterRep struct for FilterRep
type FilterRep struct {
	...
	// True if the filter's rules are active
	Enabled bool `json:"enabled"`
	// True if filter is archived
	Archived bool `json:"archived"`
	// Creation time
	CreatedAt time.Time `json:"createdAt"`
	// Last update time
	UpdatedAt time.Time `json:"updatedAt"`
	// Time the filter was last used to deliver a payload
	AppliedAt time.Time `json:"appliedAt"`
	// Time the filter was archived
	ArchivedAt time.Time `json:"archivedAt"`
	// An ETag value that may be sent in the If-Match header when updating the filter
...
func (o FilterRep) MarshalJSON() ([]byte, error) {
...
type NullableFilterRep struct {
	value *FilterRep
	isSet bool
}

func (v NullableFilterRep) Get() *FilterRep {
	return v.value
}

func (v *NullableFilterRep) Set(val *FilterRep) {
	v.value = val
	v.isSet = true
}

func (v NullableFilterRep) IsSet() bool {
	return v.isSet
}

func (v *NullableFilterRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFilterRep(val *FilterRep) *NullableFilterRep {
	return &NullableFilterRep{value: val, isSet: true}
}

func (v NullableFilterRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFilterRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
