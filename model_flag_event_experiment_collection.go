...
// checks if the FlagEventExperimentCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagEventExperimentCollection{}

// FlagEventExperimentCollection struct for FlagEventExperimentCollection
type FlagEventExperimentCollection struct {
	// The total number of experiments
	TotalCount int32 `json:"totalCount"`
	// A list of experiments
	Items []FlagEventExperiment `json:"items"`
	AdditionalProperties map[string]interface{}
}

type _FlagEventExperimentCollection FlagEventExperimentCollection
...
func NewFlagEventExperimentCollection(totalCount int32, items []FlagEventExperiment) *FlagEventExperimentCollection {
	this := FlagEventExperimentCollection{}
...
func (o FlagEventExperimentCollection) ToMap() (map[string]interface{}, error) {
...
func (o *FlagEventExperimentCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagEventExperimentCollection := _FlagEventExperimentCollection{}

	err = json.Unmarshal(data, &varFlagEventExperimentCollection)

	if err != nil {
		return err
	}

	*o = FlagEventExperimentCollection(varFlagEventExperimentCollection)
...
type NullableFlagEventExperimentCollection struct {
	value *FlagEventExperimentCollection
	isSet bool
}
...
func NewNullableFlagEventExperimentCollection(val *FlagEventExperimentCollection) *NullableFlagEventExperimentCollection {
	return &NullableFlagEventExperimentCollection{value: val, isSet: true}
}
