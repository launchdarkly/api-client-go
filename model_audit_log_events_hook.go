...
// AuditLogEventsHook struct for AuditLogEventsHook
type AuditLogEventsHook struct {
	DefaultPolicy []Policy `json:"defaultPolicy,omitempty"`
	DeliveryMethod *string `json:"deliveryMethod,omitempty"`
	Endpoint *Endpoint `json:"endpoint,omitempty"`
	IncludeErrorResponseBody *bool `json:"includeErrorResponseBody,omitempty"`
	Templates *WebhookBodyTemplate `json:"templates,omitempty"`
	UseStandardWebhookPayload *bool `json:"useStandardWebhookPayload,omitempty"`
}
...
// SetDefaultPolicy gets a reference to the given []Policy and assigns it to the DefaultPolicy field.
...
// GetIncludeErrorResponseBody returns the IncludeErrorResponseBody field value if set, zero value otherwise.
func (o *AuditLogEventsHook) GetIncludeErrorResponseBody() bool {
	if o == nil || o.IncludeErrorResponseBody == nil {
		var ret bool
		return ret
	}
	return *o.IncludeErrorResponseBody
}

// GetIncludeErrorResponseBodyOk returns a tuple with the IncludeErrorResponseBody field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuditLogEventsHook) GetIncludeErrorResponseBodyOk() (*bool, bool) {
	if o == nil || o.IncludeErrorResponseBody == nil {
		return nil, false
	}
	return o.IncludeErrorResponseBody, true
}
...
// SetIncludeErrorResponseBody gets a reference to the given bool and assigns it to the IncludeErrorResponseBody field.
func (o *AuditLogEventsHook) SetIncludeErrorResponseBody(v bool) {
	o.IncludeErrorResponseBody = &v
}

// GetTemplates returns the Templates field value if set, zero value otherwise.
func (o *AuditLogEventsHook) GetTemplates() WebhookBodyTemplate {
	if o == nil || o.Templates == nil {
		var ret WebhookBodyTemplate
		return ret
	}
	return *o.Templates
}
...
// SetTemplates gets a reference to the given WebhookBodyTemplate and assigns it to the Templates field.
func (o *AuditLogEventsHook) SetTemplates(v WebhookBodyTemplate) {
	o.Templates = &v
}

// GetUseStandardWebhookPayload returns the UseStandardWebhookPayload field value if set, zero value otherwise.
func (o *AuditLogEventsHook) GetUseStandardWebhookPayload() bool {
	if o == nil || o.UseStandardWebhookPayload == nil {
		var ret bool
		return ret
	}
	return *o.UseStandardWebhookPayload
}

// GetUseStandardWebhookPayloadOk returns a tuple with the UseStandardWebhookPayload field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuditLogEventsHook) GetUseStandardWebhookPayloadOk() (*bool, bool) {
	if o == nil || o.UseStandardWebhookPayload == nil {
		return nil, false
	}
	return o.UseStandardWebhookPayload, true
}
...
// SetUseStandardWebhookPayload gets a reference to the given bool and assigns it to the UseStandardWebhookPayload field.
func (o *AuditLogEventsHook) SetUseStandardWebhookPayload(v bool) {
	o.UseStandardWebhookPayload = &v
}

func (o AuditLogEventsHook) MarshalJSON() ([]byte, error) {
	...
	if o.IncludeErrorResponseBody != nil {
		toSerialize["includeErrorResponseBody"] = o.IncludeErrorResponseBody
	}
	if o.Templates != nil {
		toSerialize["templates"] = o.Templates
	}
	if o.UseStandardWebhookPayload != nil {
		toSerialize["useStandardWebhookPayload"] = o.UseStandardWebhookPayload
	}
	return json.Marshal(toSerialize)
}

type NullableAuditLogEventsHook struct {
	value *AuditLogEventsHook
	isSet bool
}

func (v NullableAuditLogEventsHook) Get() *AuditLogEventsHook {
	return v.value
}

func (v *NullableAuditLogEventsHook) Set(val *AuditLogEventsHook) {
	v.value = val
	v.isSet = true
}

func (v NullableAuditLogEventsHook) IsSet() bool {
	return v.isSet
}

func (v *NullableAuditLogEventsHook) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuditLogEventsHook(val *AuditLogEventsHook) *NullableAuditLogEventsHook {
	return &NullableAuditLogEventsHook{value: val, isSet: true}
}

func (v NullableAuditLogEventsHook) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuditLogEventsHook) UnmarshalJSON(src []byte) error {
	v.isSet = true
