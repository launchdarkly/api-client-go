...
// checks if the ContextKindRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextKindRep{}
...
type ContextKindRep struct {
	...
	EnvironmentObservations []ContextKindEnvironmentObservation `json:"environmentObservations,omitempty"`
...
type _ContextKindRep ContextKindRep
...
// GetEnvironmentObservations returns the EnvironmentObservations field value if set, zero value otherwise.
func (o *ContextKindRep) GetEnvironmentObservations() []ContextKindEnvironmentObservation {
	if o == nil || IsNil(o.EnvironmentObservations) {
		var ret []ContextKindEnvironmentObservation
		return ret
	}
	return o.EnvironmentObservations
}

// GetEnvironmentObservationsOk returns a tuple with the EnvironmentObservations field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ContextKindRep) GetEnvironmentObservationsOk() ([]ContextKindEnvironmentObservation, bool) {
	if o == nil || IsNil(o.EnvironmentObservations) {
		return nil, false
	}
	return o.EnvironmentObservations, true
}
...
// SetEnvironmentObservations gets a reference to the given []ContextKindEnvironmentObservation and assigns it to the EnvironmentObservations field.
func (o *ContextKindRep) SetEnvironmentObservations(v []ContextKindEnvironmentObservation) {
	o.EnvironmentObservations = v
}
...
func (o *ContextKindRep) GetHideInTargeting() bool {
	if o == nil || IsNil(o.HideInTargeting) {
		var ret bool
		return ret
	}
...
func (o ContextKindRep) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EnvironmentObservations) {
		toSerialize["environmentObservations"] = o.EnvironmentObservations
	}
	toSerialize["createdFrom"] = o.CreatedFrom
	if !IsNil(o.HideInTargeting) {
...
func (o *ContextKindRep) UnmarshalJSON(data []byte) (err error) {
	...
	varContextKindRep := _ContextKindRep{}

	err = json.Unmarshal(data, &varContextKindRep)

	if err != nil {
		return err
	}

	*o = ContextKindRep(varContextKindRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "environmentObservations")
		delete(additionalProperties, "createdFrom")
		delete(additionalProperties, "hideInTargeting")
