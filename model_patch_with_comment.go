...
// checks if the PatchWithComment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchWithComment{}
...
type _PatchWithComment PatchWithComment
...
func (o PatchWithComment) ToMap() (map[string]interface{}, error) {
...
func (o *PatchWithComment) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchWithComment := _PatchWithComment{}

	err = json.Unmarshal(data, &varPatchWithComment)

	if err != nil {
		return err
	}

	*o = PatchWithComment(varPatchWithComment)
