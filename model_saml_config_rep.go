...
// SamlConfigRep struct for SamlConfigRep
type SamlConfigRep struct {
	TestRedirectUrl *string `json:"_testRedirectUrl,omitempty"`
	...
	IsManagingTeams *bool `json:"isManagingTeams,omitempty"`
	SyncedTeamCount *int32 `json:"syncedTeamCount,omitempty"`
	UnSyncedTeamCount *int32 `json:"unSyncedTeamCount,omitempty"`
	SsoAcsUrl *string `json:"ssoAcsUrl,omitempty"`
	SsoEntityId *string `json:"ssoEntityId,omitempty"`
...
// GetTestRedirectUrl returns the TestRedirectUrl field value if set, zero value otherwise.
func (o *SamlConfigRep) GetTestRedirectUrl() string {
	if o == nil || o.TestRedirectUrl == nil {
		var ret string
		return ret
	}
	return *o.TestRedirectUrl
}

// GetTestRedirectUrlOk returns a tuple with the TestRedirectUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SamlConfigRep) GetTestRedirectUrlOk() (*string, bool) {
	if o == nil || o.TestRedirectUrl == nil {
		return nil, false
	}
	return o.TestRedirectUrl, true
}
...
// SetTestRedirectUrl gets a reference to the given string and assigns it to the TestRedirectUrl field.
...
func (o *SamlConfigRep) GetX509Certificate() string {
	if o == nil || o.X509Certificate == nil {
		var ret string
		return ret
	}
...
// GetIsManagingTeams returns the IsManagingTeams field value if set, zero value otherwise.
func (o *SamlConfigRep) GetIsManagingTeams() bool {
	if o == nil || o.IsManagingTeams == nil {
		var ret bool
		return ret
	}
	return *o.IsManagingTeams
}

// GetIsManagingTeamsOk returns a tuple with the IsManagingTeams field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SamlConfigRep) GetIsManagingTeamsOk() (*bool, bool) {
	if o == nil || o.IsManagingTeams == nil {
		return nil, false
	}
	return o.IsManagingTeams, true
}
...
// SetIsManagingTeams gets a reference to the given bool and assigns it to the IsManagingTeams field.
func (o *SamlConfigRep) SetIsManagingTeams(v bool) {
	o.IsManagingTeams = &v
}

// GetSyncedTeamCount returns the SyncedTeamCount field value if set, zero value otherwise.
func (o *SamlConfigRep) GetSyncedTeamCount() int32 {
	if o == nil || o.SyncedTeamCount == nil {
		var ret int32
		return ret
	}
	return *o.SyncedTeamCount
}

// GetSyncedTeamCountOk returns a tuple with the SyncedTeamCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SamlConfigRep) GetSyncedTeamCountOk() (*int32, bool) {
	if o == nil || o.SyncedTeamCount == nil {
		return nil, false
	}
	return o.SyncedTeamCount, true
}
...
// SetSyncedTeamCount gets a reference to the given int32 and assigns it to the SyncedTeamCount field.
func (o *SamlConfigRep) SetSyncedTeamCount(v int32) {
	o.SyncedTeamCount = &v
}

// GetUnSyncedTeamCount returns the UnSyncedTeamCount field value if set, zero value otherwise.
func (o *SamlConfigRep) GetUnSyncedTeamCount() int32 {
	if o == nil || o.UnSyncedTeamCount == nil {
		var ret int32
		return ret
	}
	return *o.UnSyncedTeamCount
}

// GetUnSyncedTeamCountOk returns a tuple with the UnSyncedTeamCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SamlConfigRep) GetUnSyncedTeamCountOk() (*int32, bool) {
	if o == nil || o.UnSyncedTeamCount == nil {
		return nil, false
	}
	return o.UnSyncedTeamCount, true
}
...
// SetUnSyncedTeamCount gets a reference to the given int32 and assigns it to the UnSyncedTeamCount field.
func (o *SamlConfigRep) SetUnSyncedTeamCount(v int32) {
	o.UnSyncedTeamCount = &v
}
...
// GetSsoEntityId returns the SsoEntityId field value if set, zero value otherwise.
func (o *SamlConfigRep) GetSsoEntityId() string {
	if o == nil || o.SsoEntityId == nil {
		var ret string
		return ret
	}
	return *o.SsoEntityId
}

// GetSsoEntityIdOk returns a tuple with the SsoEntityId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SamlConfigRep) GetSsoEntityIdOk() (*string, bool) {
	if o == nil || o.SsoEntityId == nil {
		return nil, false
	}
	return o.SsoEntityId, true
}
...
// SetSsoEntityId gets a reference to the given string and assigns it to the SsoEntityId field.
func (o *SamlConfigRep) SetSsoEntityId(v string) {
	o.SsoEntityId = &v
}

// GetSsoStartUrl returns the SsoStartUrl field value if set, zero value otherwise.
func (o *SamlConfigRep) GetSsoStartUrl() string {
	if o == nil || o.SsoStartUrl == nil {
		var ret string
		return ret
	}
	return *o.SsoStartUrl
}

// GetSsoStartUrlOk returns a tuple with the SsoStartUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SamlConfigRep) GetSsoStartUrlOk() (*string, bool) {
	if o == nil || o.SsoStartUrl == nil {
		return nil, false
	}
	return o.SsoStartUrl, true
}
...
// SetSsoStartUrl gets a reference to the given string and assigns it to the SsoStartUrl field.
func (o *SamlConfigRep) SetSsoStartUrl(v string) {
	o.SsoStartUrl = &v
}

func (o SamlConfigRep) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.TestRedirectUrl != nil {
		toSerialize["_testRedirectUrl"] = o.TestRedirectUrl
	}
	if o.Enabled != nil {
	...
	if o.IsManagingTeams != nil {
		toSerialize["isManagingTeams"] = o.IsManagingTeams
	}
	if o.SyncedTeamCount != nil {
		toSerialize["syncedTeamCount"] = o.SyncedTeamCount
	}
	if o.UnSyncedTeamCount != nil {
		toSerialize["unSyncedTeamCount"] = o.UnSyncedTeamCount
	}
	if o.SsoAcsUrl != nil {
		toSerialize["ssoAcsUrl"] = o.SsoAcsUrl
	}
	if o.SsoEntityId != nil {
		toSerialize["ssoEntityId"] = o.SsoEntityId
	}
	if o.SsoStartUrl != nil {
		toSerialize["ssoStartUrl"] = o.SsoStartUrl
	}
	return json.Marshal(toSerialize)
}

type NullableSamlConfigRep struct {
	value *SamlConfigRep
	isSet bool
}

func (v NullableSamlConfigRep) Get() *SamlConfigRep {
	return v.value
}

func (v *NullableSamlConfigRep) Set(val *SamlConfigRep) {
	v.value = val
	v.isSet = true
}

func (v NullableSamlConfigRep) IsSet() bool {
	return v.isSet
}

func (v *NullableSamlConfigRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSamlConfigRep(val *SamlConfigRep) *NullableSamlConfigRep {
	return &NullableSamlConfigRep{value: val, isSet: true}
}

func (v NullableSamlConfigRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSamlConfigRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
