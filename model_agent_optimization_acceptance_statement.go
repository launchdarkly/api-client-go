...
// checks if the AgentOptimizationAcceptanceStatement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentOptimizationAcceptanceStatement{}

// AgentOptimizationAcceptanceStatement struct for AgentOptimizationAcceptanceStatement
type AgentOptimizationAcceptanceStatement struct {
	Statement string `json:"statement"`
	Threshold float64 `json:"threshold"`
	AdditionalProperties map[string]interface{}
}

type _AgentOptimizationAcceptanceStatement AgentOptimizationAcceptanceStatement

// NewAgentOptimizationAcceptanceStatement instantiates a new AgentOptimizationAcceptanceStatement object
...
func NewAgentOptimizationAcceptanceStatement(statement string, threshold float64) *AgentOptimizationAcceptanceStatement {
	this := AgentOptimizationAcceptanceStatement{}
	this.Statement = statement
	this.Threshold = threshold
	return &this
}

// NewAgentOptimizationAcceptanceStatementWithDefaults instantiates a new AgentOptimizationAcceptanceStatement object
...
func (o AgentOptimizationAcceptanceStatement) MarshalJSON() ([]byte, error) {
...
func (o AgentOptimizationAcceptanceStatement) ToMap() (map[string]interface{}, error) {
...
func (o *AgentOptimizationAcceptanceStatement) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentOptimizationAcceptanceStatement := _AgentOptimizationAcceptanceStatement{}

	err = json.Unmarshal(data, &varAgentOptimizationAcceptanceStatement)

	if err != nil {
		return err
	}

	*o = AgentOptimizationAcceptanceStatement(varAgentOptimizationAcceptanceStatement)
...
type NullableAgentOptimizationAcceptanceStatement struct {
	value *AgentOptimizationAcceptanceStatement
	isSet bool
}

func (v NullableAgentOptimizationAcceptanceStatement) Get() *AgentOptimizationAcceptanceStatement {
	return v.value
}

func (v *NullableAgentOptimizationAcceptanceStatement) Set(val *AgentOptimizationAcceptanceStatement) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentOptimizationAcceptanceStatement) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentOptimizationAcceptanceStatement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentOptimizationAcceptanceStatement(val *AgentOptimizationAcceptanceStatement) *NullableAgentOptimizationAcceptanceStatement {
	return &NullableAgentOptimizationAcceptanceStatement{value: val, isSet: true}
}

func (v NullableAgentOptimizationAcceptanceStatement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentOptimizationAcceptanceStatement) UnmarshalJSON(src []byte) error {
	v.isSet = true
