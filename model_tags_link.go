...
// checks if the TagsLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagsLink{}

// TagsLink struct for TagsLink
...
func (o TagsLink) MarshalJSON() ([]byte, error) {
...
func (o TagsLink) ToMap() (map[string]interface{}, error) {
...
func (o *TagsLink) UnmarshalJSON(data []byte) (err error) {
	varTagsLink := _TagsLink{}

	err = json.Unmarshal(data, &varTagsLink)

	if err != nil {
		return err
	}

	*o = TagsLink(varTagsLink)
...
type NullableTagsLink struct {
	value *TagsLink
	isSet bool
}

func (v NullableTagsLink) Get() *TagsLink {
	return v.value
}

func (v *NullableTagsLink) Set(val *TagsLink) {
	v.value = val
	v.isSet = true
}

func (v NullableTagsLink) IsSet() bool {
	return v.isSet
}

func (v *NullableTagsLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTagsLink(val *TagsLink) *NullableTagsLink {
	return &NullableTagsLink{value: val, isSet: true}
}

func (v NullableTagsLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTagsLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
