...
// checks if the ReleaserAudienceConfigInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleaserAudienceConfigInput{}
...
type _ReleaserAudienceConfigInput ReleaserAudienceConfigInput
...
func (o *ReleaserAudienceConfigInput) GetReleaseGuardianConfiguration() ReleaseGuardianConfigurationInput {
	if o == nil || IsNil(o.ReleaseGuardianConfiguration) {
...
func (o ReleaserAudienceConfigInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.AudienceId) {
		toSerialize["audienceId"] = o.AudienceId
	}
	if !IsNil(o.ReleaseGuardianConfiguration) {
...
func (o *ReleaserAudienceConfigInput) UnmarshalJSON(data []byte) (err error) {
	varReleaserAudienceConfigInput := _ReleaserAudienceConfigInput{}

	err = json.Unmarshal(data, &varReleaserAudienceConfigInput)

	if err != nil {
		return err
	}

	*o = ReleaserAudienceConfigInput(varReleaserAudienceConfigInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "audienceId")
		delete(additionalProperties, "releaseGuardianConfiguration")
