...
// checks if the SegmentsSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SegmentsSummary{}

// SegmentsSummary struct for SegmentsSummary
type SegmentsSummary struct {
	Count int32 `json:"count"`
	LinkedSegments *ExpandedDirectlyLinkedSegments `json:"linkedSegments,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SegmentsSummary SegmentsSummary
...
// GetLinkedSegments returns the LinkedSegments field value if set, zero value otherwise.
func (o *SegmentsSummary) GetLinkedSegments() ExpandedDirectlyLinkedSegments {
	if o == nil || IsNil(o.LinkedSegments) {
		var ret ExpandedDirectlyLinkedSegments
		return ret
	}
	return *o.LinkedSegments
}

// GetLinkedSegmentsOk returns a tuple with the LinkedSegments field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SegmentsSummary) GetLinkedSegmentsOk() (*ExpandedDirectlyLinkedSegments, bool) {
	if o == nil || IsNil(o.LinkedSegments) {
		return nil, false
	}
	return o.LinkedSegments, true
}
...
// SetLinkedSegments gets a reference to the given ExpandedDirectlyLinkedSegments and assigns it to the LinkedSegments field.
func (o *SegmentsSummary) SetLinkedSegments(v ExpandedDirectlyLinkedSegments) {
	o.LinkedSegments = &v
}

func (o SegmentsSummary) MarshalJSON() ([]byte, error) {
...
func (o SegmentsSummary) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["count"] = o.Count
	if !IsNil(o.LinkedSegments) {
		toSerialize["linkedSegments"] = o.LinkedSegments
	}
...
func (o *SegmentsSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varSegmentsSummary := _SegmentsSummary{}

	err = json.Unmarshal(data, &varSegmentsSummary)

	if err != nil {
		return err
	}

	*o = SegmentsSummary(varSegmentsSummary)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "count")
		delete(additionalProperties, "linkedSegments")
...
type NullableSegmentsSummary struct {
	value *SegmentsSummary
	isSet bool
}

func (v NullableSegmentsSummary) Get() *SegmentsSummary {
	return v.value
}

func (v *NullableSegmentsSummary) Set(val *SegmentsSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableSegmentsSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableSegmentsSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSegmentsSummary(val *SegmentsSummary) *NullableSegmentsSummary {
	return &NullableSegmentsSummary{value: val, isSet: true}
}

func (v NullableSegmentsSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSegmentsSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
