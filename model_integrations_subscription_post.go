...
// IntegrationsSubscriptionPost struct for IntegrationsSubscriptionPost
type IntegrationsSubscriptionPost struct {
	Name *string `json:"name,omitempty"`
	Statements *[]RolesStatementPost `json:"statements,omitempty"`
...
func NewIntegrationsSubscriptionPost() *IntegrationsSubscriptionPost {
	this := IntegrationsSubscriptionPost{}
	return &this
}
...
// SetStatements gets a reference to the given []RolesStatementPost and assigns it to the Statements field.
...
func (o *IntegrationsSubscriptionPost) GetTags() []string {
	if o == nil || o.Tags == nil {
		var ret []string
		return ret
	}
...
func (o IntegrationsSubscriptionPost) MarshalJSON() ([]byte, error) {
...
type NullableIntegrationsSubscriptionPost struct {
	value *IntegrationsSubscriptionPost
	isSet bool
}

func (v NullableIntegrationsSubscriptionPost) Get() *IntegrationsSubscriptionPost {
	return v.value
}

func (v *NullableIntegrationsSubscriptionPost) Set(val *IntegrationsSubscriptionPost) {
	v.value = val
	v.isSet = true
}

func (v NullableIntegrationsSubscriptionPost) IsSet() bool {
	return v.isSet
}

func (v *NullableIntegrationsSubscriptionPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntegrationsSubscriptionPost(val *IntegrationsSubscriptionPost) *NullableIntegrationsSubscriptionPost {
	return &NullableIntegrationsSubscriptionPost{value: val, isSet: true}
}

func (v NullableIntegrationsSubscriptionPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntegrationsSubscriptionPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
