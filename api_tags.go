...
func (r ApiGetTagsRequest) Execute() (TagCollection, *_nethttp.Response, error) {
...
func (a *TagsApiService) GetTagsExecute(r ApiGetTagsRequest) (TagCollection, *_nethttp.Response, error) {
	var (
