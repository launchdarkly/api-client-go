...
// checks if the BooleanDefaults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BooleanDefaults{}
...
type _BooleanDefaults BooleanDefaults
...
func (o *BooleanDefaults) GetTrueDisplayName() string {
	if o == nil || IsNil(o.TrueDisplayName) {
		var ret string
		return ret
	}
...
func (o *BooleanDefaults) GetFalseDisplayName() string {
	if o == nil || IsNil(o.FalseDisplayName) {
		var ret string
		return ret
	}
...
func (o *BooleanDefaults) GetTrueDescription() string {
	if o == nil || IsNil(o.TrueDescription) {
		var ret string
		return ret
	}
...
func (o *BooleanDefaults) GetFalseDescription() string {
	if o == nil || IsNil(o.FalseDescription) {
		var ret string
		return ret
	}
...
func (o *BooleanDefaults) UnmarshalJSON(data []byte) (err error) {
	varBooleanDefaults := _BooleanDefaults{}

	err = json.Unmarshal(data, &varBooleanDefaults)

	if err != nil {
		return err
	}

	*o = BooleanDefaults(varBooleanDefaults)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "trueDisplayName")
		delete(additionalProperties, "falseDisplayName")
		delete(additionalProperties, "trueDescription")
		delete(additionalProperties, "falseDescription")
