...
// checks if the Maintainer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Maintainer{}

// Maintainer struct for Maintainer
type Maintainer struct {
	Id string `json:"id"`
	Kind string `json:"kind"`
	MaintainerMember *ViewsMaintainerMember `json:"maintainerMember,omitempty"`
	MaintainerTeam *ViewsMaintainerTeam `json:"maintainerTeam,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _Maintainer Maintainer
...
// GetMaintainerMember returns the MaintainerMember field value if set, zero value otherwise.
func (o *Maintainer) GetMaintainerMember() ViewsMaintainerMember {
	if o == nil || IsNil(o.MaintainerMember) {
		var ret ViewsMaintainerMember
		return ret
	}
	return *o.MaintainerMember
}

// GetMaintainerMemberOk returns a tuple with the MaintainerMember field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Maintainer) GetMaintainerMemberOk() (*ViewsMaintainerMember, bool) {
	if o == nil || IsNil(o.MaintainerMember) {
		return nil, false
	}
	return o.MaintainerMember, true
}
...
// SetMaintainerMember gets a reference to the given ViewsMaintainerMember and assigns it to the MaintainerMember field.
func (o *Maintainer) SetMaintainerMember(v ViewsMaintainerMember) {
	o.MaintainerMember = &v
}
...
func (o *Maintainer) GetMaintainerTeam() ViewsMaintainerTeam {
	if o == nil || IsNil(o.MaintainerTeam) {
		var ret ViewsMaintainerTeam
		return ret
	}
...
// SetMaintainerTeam gets a reference to the given ViewsMaintainerTeam and assigns it to the MaintainerTeam field.
func (o *Maintainer) SetMaintainerTeam(v ViewsMaintainerTeam) {
	o.MaintainerTeam = &v
}

func (o Maintainer) MarshalJSON() ([]byte, error) {
...
func (o Maintainer) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	toSerialize["kind"] = o.Kind
	if !IsNil(o.MaintainerMember) {
		toSerialize["maintainerMember"] = o.MaintainerMember
	}
	if !IsNil(o.MaintainerTeam) {
		toSerialize["maintainerTeam"] = o.MaintainerTeam
	}
...
func (o *Maintainer) UnmarshalJSON(data []byte) (err error) {
	...
	varMaintainer := _Maintainer{}

	err = json.Unmarshal(data, &varMaintainer)

	if err != nil {
		return err
	}

	*o = Maintainer(varMaintainer)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "maintainerMember")
		delete(additionalProperties, "maintainerTeam")
...
type NullableMaintainer struct {
	value *Maintainer
	isSet bool
}

func (v NullableMaintainer) Get() *Maintainer {
	return v.value
}

func (v *NullableMaintainer) Set(val *Maintainer) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintainer) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintainer) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintainer(val *Maintainer) *NullableMaintainer {
	return &NullableMaintainer{value: val, isSet: true}
}

func (v NullableMaintainer) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMaintainer) UnmarshalJSON(src []byte) error {
	v.isSet = true
