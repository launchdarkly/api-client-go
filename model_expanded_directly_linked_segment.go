...
// checks if the ExpandedDirectlyLinkedSegment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedDirectlyLinkedSegment{}

// ExpandedDirectlyLinkedSegment struct for ExpandedDirectlyLinkedSegment
type ExpandedDirectlyLinkedSegment struct {
	Key string `json:"key"`
	Name string `json:"name"`
	EnvironmentId string `json:"environmentId"`
	Links ViewsSelfLink `json:"links"`
	AdditionalProperties map[string]interface{}
}

type _ExpandedDirectlyLinkedSegment ExpandedDirectlyLinkedSegment
...
func NewExpandedDirectlyLinkedSegment(key string, name string, environmentId string, links ViewsSelfLink) *ExpandedDirectlyLinkedSegment {
	this := ExpandedDirectlyLinkedSegment{}
	this.Key = key
	this.Name = name
...
func (o ExpandedDirectlyLinkedSegment) MarshalJSON() ([]byte, error) {
...
func (o ExpandedDirectlyLinkedSegment) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedDirectlyLinkedSegment) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedDirectlyLinkedSegment := _ExpandedDirectlyLinkedSegment{}

	err = json.Unmarshal(data, &varExpandedDirectlyLinkedSegment)

	if err != nil {
		return err
	}

	*o = ExpandedDirectlyLinkedSegment(varExpandedDirectlyLinkedSegment)
...
type NullableExpandedDirectlyLinkedSegment struct {
	value *ExpandedDirectlyLinkedSegment
	isSet bool
}

func (v NullableExpandedDirectlyLinkedSegment) Get() *ExpandedDirectlyLinkedSegment {
	return v.value
}

func (v *NullableExpandedDirectlyLinkedSegment) Set(val *ExpandedDirectlyLinkedSegment) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedDirectlyLinkedSegment) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedDirectlyLinkedSegment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedDirectlyLinkedSegment(val *ExpandedDirectlyLinkedSegment) *NullableExpandedDirectlyLinkedSegment {
	return &NullableExpandedDirectlyLinkedSegment{value: val, isSet: true}
}

func (v NullableExpandedDirectlyLinkedSegment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedDirectlyLinkedSegment) UnmarshalJSON(src []byte) error {
	v.isSet = true
