...
// checks if the RelayAutoConfigPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RelayAutoConfigPost{}
...
type _RelayAutoConfigPost RelayAutoConfigPost
...
func (o RelayAutoConfigPost) ToMap() (map[string]interface{}, error) {
...
func (o *RelayAutoConfigPost) UnmarshalJSON(data []byte) (err error) {
	...
	varRelayAutoConfigPost := _RelayAutoConfigPost{}

	err = json.Unmarshal(data, &varRelayAutoConfigPost)

	if err != nil {
		return err
	}

	*o = RelayAutoConfigPost(varRelayAutoConfigPost)
