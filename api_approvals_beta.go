...
func (r ApiPatchApprovalRequest) Execute() (*FlagConfigApprovalRequestResponse, *http.Response, error) {
	return r.ApiService.PatchApprovalExecute(r)
}

/*
PatchApproval Update approval request
...
Semantic patch requests supports the following `kind` instruction for updating an approval request.
...
*/
func (a *ApprovalsBetaApiService) PatchApproval(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, id string) ApiPatchApprovalRequest {
	return ApiPatchApprovalRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *ApprovalsBetaApiService) PatchApprovalExecute(r ApiPatchApprovalRequest) (*FlagConfigApprovalRequestResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsBetaApiService.PatchApproval")
	if err != nil {
