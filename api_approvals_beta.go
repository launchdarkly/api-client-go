...
- `notifyTeamKeys`: (Optional) List of team keys.
	...
	*/
	PatchApprovalRequest(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, id string) ApiPatchApprovalRequestRequest
...
- `notifyTeamKeys`: (Optional) List of team keys.
 ...
 @return ApiPatchApprovalRequestRequest
*/
func (a *ApprovalsBetaApiService) PatchApprovalRequest(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, id string) ApiPatchApprovalRequestRequest {
	return ApiPatchApprovalRequestRequest{
		ApiService: a,
		ctx: ctx,
