...
type ApiDeleteApprovalRequestRequest struct {
	ctx context.Context
	ApiService *ApprovalsBetaApiService
	id string
}
...
*/
func (a *ApprovalsBetaApiService) DeleteApprovalRequest(ctx context.Context, id string) ApiDeleteApprovalRequestRequest {
	return ApiDeleteApprovalRequestRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *ApprovalsBetaApiService) DeleteApprovalRequestExecute(r ApiDeleteApprovalRequestRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsBetaApiService.DeleteApprovalRequest")
	if err != nil {
...
*/
func (a *ApprovalsBetaApiService) GetApprovalRequest(ctx context.Context, id string) ApiGetApprovalRequestRequest {
	return ApiGetApprovalRequestRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *ApprovalsBetaApiService) GetApprovalRequestExecute(r ApiGetApprovalRequestRequest) (*ExpandableApprovalRequestResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsBetaApiService.GetApprovalRequest")
	if err != nil {
...
*/
func (a *ApprovalsBetaApiService) GetApprovalRequests(ctx context.Context) ApiGetApprovalRequestsRequest {
	return ApiGetApprovalRequestsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ApprovalsBetaApiService) GetApprovalRequestsExecute(r ApiGetApprovalRequestsRequest) (*ExpandableApprovalRequestsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsBetaApiService.GetApprovalRequests")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ApprovalsBetaApiService) PostApprovalRequest(ctx context.Context) ApiPostApprovalRequestRequest {
	return ApiPostApprovalRequestRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ApprovalsBetaApiService) PostApprovalRequestExecute(r ApiPostApprovalRequestRequest) (*ApprovalRequestResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsBetaApiService.PostApprovalRequest")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ApprovalsBetaApiService) PostApprovalRequestApply(ctx context.Context, id string) ApiPostApprovalRequestApplyRequest {
	return ApiPostApprovalRequestApplyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ApprovalRequestResponse
func (a *ApprovalsBetaApiService) PostApprovalRequestApplyExecute(r ApiPostApprovalRequestApplyRequest) (*ApprovalRequestResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsBetaApiService.PostApprovalRequestApply")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ApprovalsBetaApiService) PostApprovalRequestReview(ctx context.Context, id string) ApiPostApprovalRequestReviewRequest {
	return ApiPostApprovalRequestReviewRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ApprovalRequestResponse
func (a *ApprovalsBetaApiService) PostApprovalRequestReviewExecute(r ApiPostApprovalRequestReviewRequest) (*ApprovalRequestResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApprovalsBetaApiService.PostApprovalRequestReview")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
