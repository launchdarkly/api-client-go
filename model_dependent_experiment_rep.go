...
// checks if the DependentExperimentRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DependentExperimentRep{}
...
type _DependentExperimentRep DependentExperimentRep
...
func (o DependentExperimentRep) ToMap() (map[string]interface{}, error) {
...
func (o *DependentExperimentRep) UnmarshalJSON(data []byte) (err error) {
	...
	varDependentExperimentRep := _DependentExperimentRep{}

	err = json.Unmarshal(data, &varDependentExperimentRep)

	if err != nil {
		return err
	}

	*o = DependentExperimentRep(varDependentExperimentRep)
