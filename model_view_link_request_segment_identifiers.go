...
// checks if the ViewLinkRequestSegmentIdentifiers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewLinkRequestSegmentIdentifiers{}

// ViewLinkRequestSegmentIdentifiers struct for ViewLinkRequestSegmentIdentifiers
...
func NewViewLinkRequestSegmentIdentifiers(segmentIdentifiers []ViewLinkRequestSegmentIdentifier) *ViewLinkRequestSegmentIdentifiers {
	this := ViewLinkRequestSegmentIdentifiers{}
...
// GetSegmentIdentifiers returns the SegmentIdentifiers field value
func (o *ViewLinkRequestSegmentIdentifiers) GetSegmentIdentifiers() []ViewLinkRequestSegmentIdentifier {
	if o == nil {
		var ret []ViewLinkRequestSegmentIdentifier
		return ret
	}

	return o.SegmentIdentifiers
}

// GetSegmentIdentifiersOk returns a tuple with the SegmentIdentifiers field value
// and a boolean to check if the value has been set.
func (o *ViewLinkRequestSegmentIdentifiers) GetSegmentIdentifiersOk() ([]ViewLinkRequestSegmentIdentifier, bool) {
	if o == nil {
		return nil, false
	}
	return o.SegmentIdentifiers, true
}

// SetSegmentIdentifiers sets field value
...
func (o ViewLinkRequestSegmentIdentifiers) MarshalJSON() ([]byte, error) {
...
func (o *ViewLinkRequestSegmentIdentifiers) UnmarshalJSON(data []byte) (err error) {
...
type NullableViewLinkRequestSegmentIdentifiers struct {
	value *ViewLinkRequestSegmentIdentifiers
	isSet bool
}

func (v NullableViewLinkRequestSegmentIdentifiers) Get() *ViewLinkRequestSegmentIdentifiers {
	return v.value
}

func (v *NullableViewLinkRequestSegmentIdentifiers) Set(val *ViewLinkRequestSegmentIdentifiers) {
	v.value = val
	v.isSet = true
}

func (v NullableViewLinkRequestSegmentIdentifiers) IsSet() bool {
	return v.isSet
}

func (v *NullableViewLinkRequestSegmentIdentifiers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewLinkRequestSegmentIdentifiers(val *ViewLinkRequestSegmentIdentifiers) *NullableViewLinkRequestSegmentIdentifiers {
	return &NullableViewLinkRequestSegmentIdentifiers{value: val, isSet: true}
}

func (v NullableViewLinkRequestSegmentIdentifiers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewLinkRequestSegmentIdentifiers) UnmarshalJSON(src []byte) error {
	v.isSet = true
