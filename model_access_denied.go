...
// checks if the AccessDenied type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessDenied{}
...
type _AccessDenied AccessDenied
...
func (o AccessDenied) ToMap() (map[string]interface{}, error) {
...
func (o *AccessDenied) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessDenied := _AccessDenied{}

	err = json.Unmarshal(data, &varAccessDenied)

	if err != nil {
		return err
	}

	*o = AccessDenied(varAccessDenied)
...
func NewNullableAccessDenied(val *AccessDenied) *NullableAccessDenied {
	return &NullableAccessDenied{value: val, isSet: true}
}
