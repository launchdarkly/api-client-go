...
type FeatureFlag struct {
	...
	Stale *StaleFlagData `json:"stale,omitempty"`
...
func (o *FeatureFlag) GetDeprecatedDate() int64 {
	if o == nil || IsNil(o.DeprecatedDate) {
		var ret int64
		return ret
	}
...
// SetStale gets a reference to the given StaleFlagData and assigns it to the Stale field.
...
func (o *FeatureFlag) UnmarshalJSON(data []byte) (err error) {
	...
	*o = FeatureFlag(varFeatureFlag)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_maintainerTeam")
		delete(additionalProperties, "goalIds")
		...
		delete(additionalProperties, "deprecatedDate")
		delete(additionalProperties, "defaults")
		delete(additionalProperties, "_purpose")
