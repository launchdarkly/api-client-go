...
// checks if the InsightsRepositoryProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightsRepositoryProject{}

// InsightsRepositoryProject struct for InsightsRepositoryProject
type InsightsRepositoryProject struct {
	// The repository key
...
type _InsightsRepositoryProject InsightsRepositoryProject
...
func NewInsightsRepositoryProject(repositoryKey string, projectKey string) *InsightsRepositoryProject {
	this := InsightsRepositoryProject{}
...
func (o *InsightsRepositoryProject) GetRepositoryKey() string {
	...
	return o.RepositoryKey
}

// GetRepositoryKeyOk returns a tuple with the RepositoryKey field value
// and a boolean to check if the value has been set.
func (o *InsightsRepositoryProject) GetRepositoryKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.RepositoryKey, true
}
...
func (o InsightsRepositoryProject) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["repositoryKey"] = o.RepositoryKey
...
func (o *InsightsRepositoryProject) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightsRepositoryProject := _InsightsRepositoryProject{}

	err = json.Unmarshal(data, &varInsightsRepositoryProject)

	if err != nil {
		return err
	}

	*o = InsightsRepositoryProject(varInsightsRepositoryProject)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "repositoryKey")
...
type NullableInsightsRepositoryProject struct {
	value *InsightsRepositoryProject
	isSet bool
}
...
func NewNullableInsightsRepositoryProject(val *InsightsRepositoryProject) *NullableInsightsRepositoryProject {
	return &NullableInsightsRepositoryProject{value: val, isSet: true}
}
