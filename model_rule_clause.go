...
// checks if the RuleClause type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RuleClause{}
...
func (o RuleClause) ToMap() (map[string]interface{}, error) {
...
func (o *RuleClause) UnmarshalJSON(data []byte) (err error) {
	varRuleClause := _RuleClause{}

	err = json.Unmarshal(data, &varRuleClause)

	if err != nil {
		return err
	}

	*o = RuleClause(varRuleClause)
