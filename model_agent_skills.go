...
// checks if the AgentSkills type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentSkills{}

// AgentSkills struct for AgentSkills
...
func (o AgentSkills) MarshalJSON() ([]byte, error) {
...
func (o AgentSkills) ToMap() (map[string]interface{}, error) {
...
func (o *AgentSkills) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentSkills := _AgentSkills{}

	err = json.Unmarshal(data, &varAgentSkills)

	if err != nil {
		return err
	}

	*o = AgentSkills(varAgentSkills)
...
type NullableAgentSkills struct {
	value *AgentSkills
	isSet bool
}

func (v NullableAgentSkills) Get() *AgentSkills {
	return v.value
}

func (v *NullableAgentSkills) Set(val *AgentSkills) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentSkills) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentSkills) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentSkills(val *AgentSkills) *NullableAgentSkills {
	return &NullableAgentSkills{value: val, isSet: true}
}

func (v NullableAgentSkills) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentSkills) UnmarshalJSON(src []byte) error {
	v.isSet = true
