...
// checks if the ViewSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewSummary{}

// ViewSummary struct for ViewSummary
type ViewSummary struct {
	...
	ResourceSummary ViewResourceSummary `json:"resourceSummary"`
	AdditionalProperties map[string]interface{}
}

type _ViewSummary ViewSummary
...
// GetResourceSummary returns the ResourceSummary field value
func (o *ViewSummary) GetResourceSummary() ViewResourceSummary {
	if o == nil {
		var ret ViewResourceSummary
		return ret
	}
...
// GetResourceSummaryOk returns a tuple with the ResourceSummary field value
// and a boolean to check if the value has been set.
...
// SetResourceSummary sets field value
func (o *ViewSummary) SetResourceSummary(v ViewResourceSummary) {
	o.ResourceSummary = v
}

func (o ViewSummary) MarshalJSON() ([]byte, error) {
...
func (o ViewSummary) ToMap() (map[string]interface{}, error) {
...
func (o *ViewSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varViewSummary := _ViewSummary{}

	err = json.Unmarshal(data, &varViewSummary)

	if err != nil {
		return err
	}

	*o = ViewSummary(varViewSummary)
...
type NullableViewSummary struct {
	value *ViewSummary
	isSet bool
}

func (v NullableViewSummary) Get() *ViewSummary {
	return v.value
}

func (v *NullableViewSummary) Set(val *ViewSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableViewSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableViewSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewSummary(val *ViewSummary) *NullableViewSummary {
	return &NullableViewSummary{value: val, isSet: true}
}

func (v NullableViewSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
