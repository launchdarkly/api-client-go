...
func (v NullableDecimal) Get() *Decimal {
	return v.value
}

func (v *NullableDecimal) Set(val *Decimal) {
	v.value = val
	v.isSet = true
}

func (v NullableDecimal) IsSet() bool {
	return v.isSet
}

func (v *NullableDecimal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDecimal(val *Decimal) *NullableDecimal {
	return &NullableDecimal{value: val, isSet: true}
}

func (v NullableDecimal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDecimal) UnmarshalJSON(src []byte) error {
	v.isSet = true
