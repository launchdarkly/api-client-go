...
// checks if the ReleaseProgressionCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleaseProgressionCollection{}
...
type _ReleaseProgressionCollection ReleaseProgressionCollection
...
func (o ReleaseProgressionCollection) ToMap() (map[string]interface{}, error) {
...
func (o *ReleaseProgressionCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varReleaseProgressionCollection := _ReleaseProgressionCollection{}

	err = json.Unmarshal(data, &varReleaseProgressionCollection)

	if err != nil {
		return err
	}

	*o = ReleaseProgressionCollection(varReleaseProgressionCollection)
