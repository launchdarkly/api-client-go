...
// checks if the ViewLinkedResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewLinkedResources{}

// ViewLinkedResources struct for ViewLinkedResources
type ViewLinkedResources struct {
	Links *ViewsPaginatedLinks `json:"_links,omitempty"`
	Items []ViewLinkedResource `json:"items"`
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _ViewLinkedResources ViewLinkedResources
...
// SetLinks gets a reference to the given ViewsPaginatedLinks and assigns it to the Links field.
...
func (o ViewLinkedResources) MarshalJSON() ([]byte, error) {
...
func (o ViewLinkedResources) ToMap() (map[string]interface{}, error) {
...
func (o *ViewLinkedResources) UnmarshalJSON(data []byte) (err error) {
	...
	varViewLinkedResources := _ViewLinkedResources{}

	err = json.Unmarshal(data, &varViewLinkedResources)

	if err != nil {
		return err
	}

	*o = ViewLinkedResources(varViewLinkedResources)
...
type NullableViewLinkedResources struct {
	value *ViewLinkedResources
	isSet bool
}

func (v NullableViewLinkedResources) Get() *ViewLinkedResources {
	return v.value
}

func (v *NullableViewLinkedResources) Set(val *ViewLinkedResources) {
	v.value = val
	v.isSet = true
}

func (v NullableViewLinkedResources) IsSet() bool {
	return v.isSet
}

func (v *NullableViewLinkedResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewLinkedResources(val *ViewLinkedResources) *NullableViewLinkedResources {
	return &NullableViewLinkedResources{value: val, isSet: true}
}

func (v NullableViewLinkedResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewLinkedResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
