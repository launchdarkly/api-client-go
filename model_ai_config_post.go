...
// checks if the AIConfigPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigPost{}
...
type _AIConfigPost AIConfigPost
...
// GetViewKeys returns the ViewKeys field value if set, zero value otherwise.
func (o *AIConfigPost) GetViewKeys() []string {
	if o == nil || IsNil(o.ViewKeys) {
		var ret []string
		return ret
	}
	return o.ViewKeys
...
// GetViewKeysOk returns a tuple with the ViewKeys field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AIConfigPost) GetViewKeysOk() ([]string, bool) {
	if o == nil || IsNil(o.ViewKeys) {
		return nil, false
	}
	return o.ViewKeys, true
}
...
// SetViewKeys gets a reference to the given []string and assigns it to the ViewKeys field.
...
// GetEvaluationMetricKey returns the EvaluationMetricKey field value if set, zero value otherwise.
func (o *AIConfigPost) GetEvaluationMetricKey() string {
	if o == nil || IsNil(o.EvaluationMetricKey) {
		var ret string
		return ret
	}
	return *o.EvaluationMetricKey
}

// GetEvaluationMetricKeyOk returns a tuple with the EvaluationMetricKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AIConfigPost) GetEvaluationMetricKeyOk() (*string, bool) {
	if o == nil || IsNil(o.EvaluationMetricKey) {
		return nil, false
	}
	return o.EvaluationMetricKey, true
}
...
// SetEvaluationMetricKey gets a reference to the given string and assigns it to the EvaluationMetricKey field.
func (o *AIConfigPost) SetEvaluationMetricKey(v string) {
	o.EvaluationMetricKey = &v
}
...
func (o AIConfigPost) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ViewKeys) {
		toSerialize["viewKeys"] = o.ViewKeys
	}
	if !IsNil(o.DefaultVariation) {
		toSerialize["defaultVariation"] = o.DefaultVariation
	}
	if !IsNil(o.EvaluationMetricKey) {
		toSerialize["evaluationMetricKey"] = o.EvaluationMetricKey
	}
...
func (o *AIConfigPost) UnmarshalJSON(data []byte) (err error) {
	...
	varAIConfigPost := _AIConfigPost{}

	err = json.Unmarshal(data, &varAIConfigPost)

	if err != nil {
		return err
	}

	*o = AIConfigPost(varAIConfigPost)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "viewKeys")
