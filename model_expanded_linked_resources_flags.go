...
// checks if the ExpandedLinkedResourcesFlags type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedLinkedResourcesFlags{}

// ExpandedLinkedResourcesFlags struct for ExpandedLinkedResourcesFlags
type ExpandedLinkedResourcesFlags struct {
	Items []ExpandedFlag `json:"items"`
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _ExpandedLinkedResourcesFlags ExpandedLinkedResourcesFlags
...
func NewExpandedLinkedResourcesFlags(items []ExpandedFlag, totalCount int32) *ExpandedLinkedResourcesFlags {
	this := ExpandedLinkedResourcesFlags{}
	this.Items = items
...
func (o ExpandedLinkedResourcesFlags) MarshalJSON() ([]byte, error) {
...
func (o ExpandedLinkedResourcesFlags) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedLinkedResourcesFlags) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedLinkedResourcesFlags := _ExpandedLinkedResourcesFlags{}

	err = json.Unmarshal(data, &varExpandedLinkedResourcesFlags)

	if err != nil {
		return err
	}

	*o = ExpandedLinkedResourcesFlags(varExpandedLinkedResourcesFlags)
...
type NullableExpandedLinkedResourcesFlags struct {
	value *ExpandedLinkedResourcesFlags
	isSet bool
}

func (v NullableExpandedLinkedResourcesFlags) Get() *ExpandedLinkedResourcesFlags {
	return v.value
}

func (v *NullableExpandedLinkedResourcesFlags) Set(val *ExpandedLinkedResourcesFlags) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedLinkedResourcesFlags) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedLinkedResourcesFlags) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedLinkedResourcesFlags(val *ExpandedLinkedResourcesFlags) *NullableExpandedLinkedResourcesFlags {
	return &NullableExpandedLinkedResourcesFlags{value: val, isSet: true}
}

func (v NullableExpandedLinkedResourcesFlags) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedLinkedResourcesFlags) UnmarshalJSON(src []byte) error {
	v.isSet = true
