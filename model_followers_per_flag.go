...
// checks if the FollowersPerFlag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FollowersPerFlag{}
...
type _FollowersPerFlag FollowersPerFlag
...
func (o FollowersPerFlag) ToMap() (map[string]interface{}, error) {
...
func (o *FollowersPerFlag) UnmarshalJSON(data []byte) (err error) {
	varFollowersPerFlag := _FollowersPerFlag{}

	err = json.Unmarshal(data, &varFollowersPerFlag)

	if err != nil {
		return err
	}

	*o = FollowersPerFlag(varFollowersPerFlag)
...
func NewNullableFollowersPerFlag(val *FollowersPerFlag) *NullableFollowersPerFlag {
	return &NullableFollowersPerFlag{value: val, isSet: true}
}
