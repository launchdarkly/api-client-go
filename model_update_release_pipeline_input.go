...
// checks if the UpdateReleasePipelineInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateReleasePipelineInput{}
...
type _UpdateReleasePipelineInput UpdateReleasePipelineInput
...
func (o UpdateReleasePipelineInput) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateReleasePipelineInput) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateReleasePipelineInput := _UpdateReleasePipelineInput{}

	err = json.Unmarshal(data, &varUpdateReleasePipelineInput)

	if err != nil {
		return err
	}

	*o = UpdateReleasePipelineInput(varUpdateReleasePipelineInput)
