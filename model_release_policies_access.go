...
// checks if the ReleasePoliciesAccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleasePoliciesAccess{}

// ReleasePoliciesAccess struct for ReleasePoliciesAccess
type ReleasePoliciesAccess struct {
	Denied []ReleasePoliciesAccessDenied `json:"denied"`
	Allowed []ReleasePoliciesAccessAllowedRep `json:"allowed"`
	AdditionalProperties map[string]interface{}
}

type _ReleasePoliciesAccess ReleasePoliciesAccess
...
func (o ReleasePoliciesAccess) MarshalJSON() ([]byte, error) {
...
func (o ReleasePoliciesAccess) ToMap() (map[string]interface{}, error) {
...
func (o *ReleasePoliciesAccess) UnmarshalJSON(data []byte) (err error) {
	...
	varReleasePoliciesAccess := _ReleasePoliciesAccess{}

	err = json.Unmarshal(data, &varReleasePoliciesAccess)

	if err != nil {
		return err
	}

	*o = ReleasePoliciesAccess(varReleasePoliciesAccess)
...
type NullableReleasePoliciesAccess struct {
	value *ReleasePoliciesAccess
	isSet bool
}

func (v NullableReleasePoliciesAccess) Get() *ReleasePoliciesAccess {
	return v.value
}

func (v *NullableReleasePoliciesAccess) Set(val *ReleasePoliciesAccess) {
	v.value = val
	v.isSet = true
}

func (v NullableReleasePoliciesAccess) IsSet() bool {
	return v.isSet
}

func (v *NullableReleasePoliciesAccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleasePoliciesAccess(val *ReleasePoliciesAccess) *NullableReleasePoliciesAccess {
	return &NullableReleasePoliciesAccess{value: val, isSet: true}
}

func (v NullableReleasePoliciesAccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReleasePoliciesAccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
