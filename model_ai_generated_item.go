...
// AIGeneratedItem struct for AIGeneratedItem
type AIGeneratedItem struct {
	...
	// Items that are similar to the generated item
...
// GetSuggestedItems returns the SuggestedItems field value if set, zero value otherwise.
func (o *AIGeneratedItem) GetSuggestedItems() []SuggestedItem {
	if o == nil || o.SuggestedItems == nil {
		var ret []SuggestedItem
		return ret
	}
	return o.SuggestedItems
}

// GetSuggestedItemsOk returns a tuple with the SuggestedItems field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AIGeneratedItem) GetSuggestedItemsOk() ([]SuggestedItem, bool) {
	if o == nil || o.SuggestedItems == nil {
		return nil, false
	}
	return o.SuggestedItems, true
}
...
// SetSuggestedItems gets a reference to the given []SuggestedItem and assigns it to the SuggestedItems field.
func (o *AIGeneratedItem) SetSuggestedItems(v []SuggestedItem) {
	o.SuggestedItems = v
}

func (o AIGeneratedItem) MarshalJSON() ([]byte, error) {
	...
	if o.SuggestedItems != nil {
		toSerialize["suggestedItems"] = o.SuggestedItems
	}
	return json.Marshal(toSerialize)
}

type NullableAIGeneratedItem struct {
	value *AIGeneratedItem
	isSet bool
}

func (v NullableAIGeneratedItem) Get() *AIGeneratedItem {
	return v.value
}

func (v *NullableAIGeneratedItem) Set(val *AIGeneratedItem) {
	v.value = val
	v.isSet = true
}

func (v NullableAIGeneratedItem) IsSet() bool {
	return v.isSet
}

func (v *NullableAIGeneratedItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIGeneratedItem(val *AIGeneratedItem) *NullableAIGeneratedItem {
	return &NullableAIGeneratedItem{value: val, isSet: true}
}

func (v NullableAIGeneratedItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIGeneratedItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
