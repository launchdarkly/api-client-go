...
// checks if the DependentMetricOrMetricGroupRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DependentMetricOrMetricGroupRep{}
...
type _DependentMetricOrMetricGroupRep DependentMetricOrMetricGroupRep
...
func (o DependentMetricOrMetricGroupRep) ToMap() (map[string]interface{}, error) {
...
func (o *DependentMetricOrMetricGroupRep) UnmarshalJSON(data []byte) (err error) {
	...
	varDependentMetricOrMetricGroupRep := _DependentMetricOrMetricGroupRep{}

	err = json.Unmarshal(data, &varDependentMetricOrMetricGroupRep)

	if err != nil {
		return err
	}

	*o = DependentMetricOrMetricGroupRep(varDependentMetricOrMetricGroupRep)
