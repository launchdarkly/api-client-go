...
------------ | ------------- | ------------- | -------------
*AIBetaApi* | [**PostGenerateExperiment**](docs/AIBetaApi.md#postgenerateexperiment) | **Post** /api/v2/ai/projects/{projectKey}/environments/{environmentKey}/generate-experiment | Generate an experiment config using AI.
*AIBetaApi* | [**PostGenerateVariations**](docs/AIBetaApi.md#postgeneratevariations) | **Post** /api/v2/ai/generate-variations | Generate new variations for a feature flag
...
*AccountMembersApi* | [**ResendInvitation**](docs/AccountMembersApi.md#resendinvitation) | **Post** /api/v2/members/{id}/resend-invitation | Resend invitation for an account member
*AccountMembersApi* | [**SendMfaEnableRequest**](docs/AccountMembersApi.md#sendmfaenablerequest) | **Post** /api/v2/members/{id}/mfa/request | Send MFA enablement request for an account member
*AccountMembersApi* | [**SendMfaRecoveryCode**](docs/AccountMembersApi.md#sendmfarecoverycode) | **Post** /api/v2/members/{id}/mfa/recovery | Send MFA recovery code for an account member
...
*AccountUsageBetaApi* | [**GetCCMUsage**](docs/AccountUsageBetaApi.md#getccmusage) | **Get** /api/v2/usage/ccm | Get client connection minutes usage
*AccountUsageBetaApi* | [**GetCMCIUsage**](docs/AccountUsageBetaApi.md#getcmciusage) | **Get** /api/v2/usage/cmci | Get client-side monthly context instances usage
...
*AccountUsageBetaApi* | [**GetSCMUsage**](docs/AccountUsageBetaApi.md#getscmusage) | **Get** /api/v2/usage/scm | Get server connection minutes usage
...
*ApplicationsBetaApi* | [**GetApplicationVersionAdoption**](docs/ApplicationsBetaApi.md#getapplicationversionadoption) | **Get** /api/v2/applications/{applicationKey}/version-adoption | Get application version adoption data by application key
...
*ApplicationsInternalApi* | [**GetApplicationVersionSupported**](docs/ApplicationsInternalApi.md#getapplicationversionsupported) | **Get** /internal/applications/{applicationKey}/versions | Get number of supported versions for an application
*ApplicationsInternalApi* | [**InternalGetApplicationVersionAdoption**](docs/ApplicationsInternalApi.md#internalgetapplicationversionadoption) | **Get** /internal/applications/{applicationKey}/version-adoption | Get application version adoption data by application key
*ApplicationsPrivateApi* | [**PostApplicationAndVersionWithFlagsPrivate**](docs/ApplicationsPrivateApi.md#postapplicationandversionwithflagsprivate) | **Post** /api/private/applications | Create applications and versions with flag associations
...
*ApprovalsBetaApi* | [**PatchApproval**](docs/ApprovalsBetaApi.md#patchapproval) | **Patch** /api/v2/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{id} | Update approval request
...
*AuthenticationApi* | [**DeleteSession**](docs/AuthenticationApi.md#deletesession) | **Delete** /internal/account/session | Delete session (sign out)
...
*DefaultApi* | [**ApiV2ProjectsProjectKeyEnvironmentsEnvironmentKeyDiscoveredMetricEventsGet**](docs/DefaultApi.md#apiv2projectsprojectkeyenvironmentsenvironmentkeydiscoveredmetriceventsget) | **Get** /api/v2/projects/{projectKey}/environments/{environmentKey}/discovered-metric-events | Get Discovered Metric Events
*DefaultApi* | [**DeleteSdkConfigHandler**](docs/DefaultApi.md#deletesdkconfighandler) | **Delete** /private/accounts/{acctId}/projects/{projId}/environments/{envId}/flags/{flagKey}/sdk-config | Delete SDK config
*DefaultApi* | [**GetSdkConfigHandler**](docs/DefaultApi.md#getsdkconfighandler) | **Get** /private/accounts/{acctId}/projects/{projId}/environments/{envId}/flags/{flagKey}/sdk-config | Get SDK config
*DefaultApi* | [**PutSdkConfigHandler**](docs/DefaultApi.md#putsdkconfighandler) | **Put** /private/accounts/{acctId}/projects/{projId}/environments/{envId}/flags/{flagKey}/sdk-config | Put SDK config
...
*ExperimentsBetaApi* | [**GetAttributeValues**](docs/ExperimentsBetaApi.md#getattributevalues) | **Get** /projects/{projKey}/environments/{envKey}/experiments/{experimentKey}/iterations/{iterationId}/attributes/{attribute} | Get Iteration Attribute Values
...
*ExperimentsBetaApi* | [**GetExperimentsAnyEnv**](docs/ExperimentsBetaApi.md#getexperimentsanyenv) | **Get** /api/v2/projects/{projectKey}/experiments | Get experiments any environment
*ExperimentsBetaApi* | [**GetFlagMeasuredRolloutConfiguration**](docs/ExperimentsBetaApi.md#getflagmeasuredrolloutconfiguration) | **Get** /api/v2/projects/{projectKey}/flags/{flagKey}/measured-rollout-configuration | Get measured rollout configuration
...
*ExperimentsBetaApi* | [**GetQuantileExperimentResults**](docs/ExperimentsBetaApi.md#getquantileexperimentresults) | **Get** /api/v2/projects/{projectKey}/environments/{environmentKey}/experiments/{experimentKey}/metrics/{metricKey}/results/quantile | Get quantile experiment results
...
*ExperimentsBetaApi* | [**PostLegacyExperiment**](docs/ExperimentsBetaApi.md#postlegacyexperiment) | **Post** /api/v2/projects/{projectKey}/experiments | Create legacy experiment (deprecated)
...
*ExperimentsBetaApi* | [**PutFlagMeasuredRolloutConfiguration**](docs/ExperimentsBetaApi.md#putflagmeasuredrolloutconfiguration) | **Put** /api/v2/projects/{projectKey}/flags/{flagKey}/measured-rollout-configuration | Create or update measured rollout configuration
...
*FeatureFlagsApi* | [**GetFeatureFlagTemplates**](docs/FeatureFlagsApi.md#getfeatureflagtemplates) | **Get** /api/v2/flag-templates | List feature flag templates
...
*FeatureFlagsBetaApi* | [**PostFeatureFlagStatusesQuery**](docs/FeatureFlagsBetaApi.md#postfeatureflagstatusesquery) | **Post** /api/v2/projects/{projectKey}/flag-statuses/query | Query feature flag statuses for multiple flags and environments
*FeatureFlagsBetaApi* | [**PostGlobalFlagByKeyDryRun**](docs/FeatureFlagsBetaApi.md#postglobalflagbykeydryrun) | **Post** /api/v2/projects/{projectKey}/flags/{flagKey}/dry-run | Get dry run for flag changes
...
*FeatureFlagsBetaApi* | [**QueryFeatureFlagStatuses**](docs/FeatureFlagsBetaApi.md#queryfeatureflagstatuses) | **Post** /api/v2/projects/{projectKey}/flag-statuses/queries | Query feature flag statuses for multiple flags and environments
...
*FollowFlagsApi* | [**PatchFlagFollowers**](docs/FollowFlagsApi.md#patchflagfollowers) | **Patch** /internal/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/followers | Add a member as a follower of a flag in a project and environment
...
*IntegrationsPrivateApi* | [**CreatePrivateBigSegmentStoreIntegrationResponse**](docs/IntegrationsPrivateApi.md#createprivatebigsegmentstoreintegrationresponse) | **Post** /private/integrations/big-segment-store/{environmentId}/{integrationId}/responses | Create Big Segment store integration response
*IntegrationsPrivateApi* | [**CreatePrivateFeatureStoreIntegrationResponse**](docs/IntegrationsPrivateApi.md#createprivatefeaturestoreintegrationresponse) | **Post** /private/integrations/featureStore/{envId}/{integrationId}/responses | Create feature store integration response
*IntegrationsPrivateApi* | [**GetAllBigSegmentStoreIntegrationsPrivate**](docs/IntegrationsPrivateApi.md#getallbigsegmentstoreintegrationsprivate) | **Get** /private/integrations/big-segment-store/{accountId} | Get all enabled Big Segment store integrations
*IntegrationsPrivateApi* | [**PrivateGetFeatureStoreIntegration**](docs/IntegrationsPrivateApi.md#privategetfeaturestoreintegration) | **Get** /private/integrations/featureStore/{envId}/{integrationId} | Get feature store integration
*IntegrationsPrivateApi* | [**PrivateGetFeatureStoreIntegrationManifest**](docs/IntegrationsPrivateApi.md#privategetfeaturestoreintegrationmanifest) | **Get** /private/integrations/featureStore/{envId}/{integrationId}/manifest | Get feature store integration manifest
*IntegrationsPrivateApi* | [**PrivatePostFeatureStoresRefreshAll**](docs/IntegrationsPrivateApi.md#privatepostfeaturestoresrefreshall) | **Post** /private/integrations/featureStore/refresh | Send notifications to refresh all enabled feature stores
*InternalApi* | [**GetAccount**](docs/InternalApi.md#getaccount) | **Get** /internal/account | Get account
*InternalApi* | [**GetActions**](docs/InternalApi.md#getactions) | **Get** /internal/actions | Get actions
*InternalApi* | [**GetEnvironments**](docs/InternalApi.md#getenvironments) | **Get** /internal/projects/{projectKey}/environments | Get environments
*InternalApi* | [**GetMigrationFlagMetrics**](docs/InternalApi.md#getmigrationflagmetrics) | **Get** /internal/projects/{projectKey}/flags/{flagKey}/environments/{environmentKey}/migration-metrics | List migration flag metrics
*InternalApi* | [**GetSelectedEnvironments**](docs/InternalApi.md#getselectedenvironments) | **Get** /internal/profile/selected-environments/{projectKey} | Get selected environments
*InternalApi* | [**InternalGetWorkflows**](docs/InternalApi.md#internalgetworkflows) | **Get** /internal/projects/{projectKey}/flags/{featureFlagKey}/workflows | Get workflows across environments
*InternalApi* | [**InternalSearchFlags**](docs/InternalApi.md#internalsearchflags) | **Post** /internal/projects/{projectKey}/flags/search | Search for multiple flags with environment configurations
*InternalApi* | [**PutSelectedEnvironments**](docs/InternalApi.md#putselectedenvironments) | **Put** /internal/profile/selected-environments/{projectKey} | Put selected environments
...
*OtherApi* | [**GetProjectSummaries**](docs/OtherApi.md#getprojectsummaries) | **Get** /internal/list/projects | List projects
...
*ProductAnalyticsBetaApi* | [**PostMetricsAnalyticsEventsQuery**](docs/ProductAnalyticsBetaApi.md#postmetricsanalyticseventsquery) | **Post** /api/v2/projects/{projectKey}/environments/{environmentKey}/metrics/query | Query metrics analytics events
*ProductAnalyticsInternalApi* | [**GetProductAnalyticsContextsDimensionValues**](docs/ProductAnalyticsInternalApi.md#getproductanalyticscontextsdimensionvalues) | **Get** /internal/projects/{projectKey}/environments/{environmentKey}/analytics/metrics/{metricKey}/dimensions/{dimensionKey}/contexts/{contextKindKey}/values | List of dimension values for a context dimension for product analytics
*ProductAnalyticsInternalApi* | [**GetProductAnalyticsEventsDimensionValues**](docs/ProductAnalyticsInternalApi.md#getproductanalyticseventsdimensionvalues) | **Get** /internal/projects/{projectKey}/environments/{environmentKey}/analytics/metrics/{metricKey}/dimensions/{dimensionKey}/events | List of dimension values for an event dimension for product analytics
*ProductAnalyticsInternalApi* | [**GetProductAnalyticsMetricDimensions**](docs/ProductAnalyticsInternalApi.md#getproductanalyticsmetricdimensions) | **Get** /internal/projects/{projectKey}/environments/{environmentKey}/analytics/metrics/{metricKey}/dimensions | List metric dimensions for product analytics
*ProductAnalyticsInternalApi* | [**GetProductAnalyticsMetrics**](docs/ProductAnalyticsInternalApi.md#getproductanalyticsmetrics) | **Get** /internal/projects/{projectKey}/environments/{environmentKey}/analytics/metrics | List metrics for product analytics
...
## Documentation For Models
 ...
 - [AIGeneratedExperimentConfig](docs/AIGeneratedExperimentConfig.md)
 - [AIGeneratedItem](docs/AIGeneratedItem.md)
 - [AIGeneratedVariations](docs/AIGeneratedVariations.md)
 ...
 - [ActionAndDescription](docs/ActionAndDescription.md)
 ...
 - [ApplicationVersionAdoption](docs/ApplicationVersionAdoption.md)
 - [ApplicationVersionAdoptionCollection](docs/ApplicationVersionAdoptionCollection.md)
 - [ApplicationVersionBySupportedState](docs/ApplicationVersionBySupportedState.md)
 ...
 - [ApplicationWithVersions](docs/ApplicationWithVersions.md)
 ...
 - [AuditLogEventsHook](docs/AuditLogEventsHook.md)
 - [AuthorizedAppDataRep](docs/AuthorizedAppDataRep.md)
 - [BigSegmentStore](docs/BigSegmentStore.md)
 ...
 - [ConditionsItems](docs/ConditionsItems.md)
 ...
 - [CreateApplicationsAndVersionsInput](docs/CreateApplicationsAndVersionsInput.md)
 ...
 - [CreationRequest](docs/CreationRequest.md)
 ...
 - [DependsOnItems](docs/DependsOnItems.md)
 ...
 - [DiscoveredMetricEvent](docs/DiscoveredMetricEvent.md)
 - [DiscoveredMetricEventWithMetrics](docs/DiscoveredMetricEventWithMetrics.md)
 - [Distribution](docs/Distribution.md)
 - [DynamicOptions](docs/DynamicOptions.md)
 - [DynamicOptionsParser](docs/DynamicOptionsParser.md)
 - [EmptyState](docs/EmptyState.md)
 ...
 - [ExperimentQuantileResultsRep](docs/ExperimentQuantileResultsRep.md)
 ...
 - [ExternalConfigurationPages](docs/ExternalConfigurationPages.md)
 ...
 - [FeatureStoreRequest](docs/FeatureStoreRequest.md)
 - [FeatureStoreValidationParser](docs/FeatureStoreValidationParser.md)
 ...
 - [FlagLink](docs/FlagLink.md)
 - [FlagLinkCollectionRep](docs/FlagLinkCollectionRep.md)
 - [FlagLinkContext](docs/FlagLinkContext.md)
 ...
 - [FlagMeasuredRolloutConfigurationInput](docs/FlagMeasuredRolloutConfigurationInput.md)
 ...
 - [FlagSeen](docs/FlagSeen.md)
 - [FlagSempatch](docs/FlagSempatch.md)
 - [FlagStatusRep](docs/FlagStatusRep.md)
 - [FlagStatusesCollection](docs/FlagStatusesCollection.md)
 - [FlagStatusesQuery](docs/FlagStatusesQuery.md)
 - [FlagSummary](docs/FlagSummary.md)
 - [FlagTemplate](docs/FlagTemplate.md)
 - [FlagTriggerInput](docs/FlagTriggerInput.md)
 - [FollowFlagMember](docs/FollowFlagMember.md)
 - [FollowResourcePatchRep](docs/FollowResourcePatchRep.md)
 - [FollowersPerFlag](docs/FollowersPerFlag.md)
 - [ForbiddenErrorRep](docs/ForbiddenErrorRep.md)
 - [FormVariable](docs/FormVariable.md)
 - [GenerateExperimentPost](docs/GenerateExperimentPost.md)
 - [GenerateVariationsPost](docs/GenerateVariationsPost.md)
 ...
 - [InternalApplicationVersionAdoption](docs/InternalApplicationVersionAdoption.md)
 - [InternalApplicationVersionAdoptionCollection](docs/InternalApplicationVersionAdoptionCollection.md)
 - [InternalEnvironment](docs/InternalEnvironment.md)
 - [InternalEnvironmentCollection](docs/InternalEnvironmentCollection.md)
 - [InternalPubnubRep](docs/InternalPubnubRep.md)
 ...
 - [MemberArrayParser](docs/MemberArrayParser.md)
 - [MemberDataRep](docs/MemberDataRep.md)
 - [MemberImportItem](docs/MemberImportItem.md)
 - [MemberInput](docs/MemberInput.md)
 - [MemberItemsArray](docs/MemberItemsArray.md)
 - [MemberListParser](docs/MemberListParser.md)
 - [MemberListRequest](docs/MemberListRequest.md)
 ...
 - [MetricAnalyticsMetadata](docs/MetricAnalyticsMetadata.md)
 - [MetricCollectionRep](docs/MetricCollectionRep.md)
 - [MetricDimensionRep](docs/MetricDimensionRep.md)
 - [MetricDimensionValueRep](docs/MetricDimensionValueRep.md)
 - [MetricDimensionValuesRep](docs/MetricDimensionValuesRep.md)
 - [MetricDimensionsRep](docs/MetricDimensionsRep.md)
 ...
 - [MetricQueryFilterRep](docs/MetricQueryFilterRep.md)
 - [MetricQueryGroupByRep](docs/MetricQueryGroupByRep.md)
 - [MetricQueryRep](docs/MetricQueryRep.md)
 ...
 - [MigrationMetricRep](docs/MigrationMetricRep.md)
 - [MigrationMetricsRep](docs/MigrationMetricsRep.md)
 ...
 - [MonitoringPropertiesRep](docs/MonitoringPropertiesRep.md)
 ...
 - [OnProgressionRep](docs/OnProgressionRep.md)
 - [OnRegressionRep](docs/OnRegressionRep.md)
 - [OptionsArray](docs/OptionsArray.md)
 - [OverviewMetricsRep](docs/OverviewMetricsRep.md)
 ...
 - [PatchFlagFollowersRequest](docs/PatchFlagFollowersRequest.md)
 - [PatchFlagFollowersRequestInstructions](docs/PatchFlagFollowersRequestInstructions.md)
 - [PatchFlagInput](docs/PatchFlagInput.md)
 ...
 - [PostApplyRequest](docs/PostApplyRequest.md)
 ...
 - [PostProductAnalyticsQueryRep](docs/PostProductAnalyticsQueryRep.md)
 - [Prerequisite](docs/Prerequisite.md)
 - [PrivateFeatureStoreRep](docs/PrivateFeatureStoreRep.md)
 - [PrivateFeatureStoreResponseRep](docs/PrivateFeatureStoreResponseRep.md)
 - [PrivateStoreIntegrationCollectionRep](docs/PrivateStoreIntegrationCollectionRep.md)
 - [ProductAnalyticsMetricsRep](docs/ProductAnalyticsMetricsRep.md)
 - [ProductAnalyticsQueryResultsRep](docs/ProductAnalyticsQueryResultsRep.md)
 - [ProgressionRep](docs/ProgressionRep.md)
 ...
 - [QuantileSignificanceRep](docs/QuantileSignificanceRep.md)
 ...
 - [RegressionRep](docs/RegressionRep.md)
 ...
 - [ReleaseGuardianFlagConfigRep](docs/ReleaseGuardianFlagConfigRep.md)
 ...
 - [RequestParser](docs/RequestParser.md)
 - [ReservedCustomPropertiesItems](docs/ReservedCustomPropertiesItems.md)
 ...
 - [SelectedEnvironments](docs/SelectedEnvironments.md)
 - [SelectedEnvironmentsPayload](docs/SelectedEnvironmentsPayload.md)
 - [Series](docs/Series.md)
 - [SeriesIntervalsRep](docs/SeriesIntervalsRep.md)
 - [SeriesListRep](docs/SeriesListRep.md)
 - [SessionCfgRep](docs/SessionCfgRep.md)
 ...
 - [TreatmentQuantileResultRep](docs/TreatmentQuantileResultRep.md)
 - [TreatmentRep](docs/TreatmentRep.md)
 - [TreatmentResultRep](docs/TreatmentResultRep.md)
 - [Trigger](docs/Trigger.md)
 - [TriggerParser](docs/TriggerParser.md)
 ...
 - [UIBlockElement](docs/UIBlockElement.md)
 - [UIBlocks](docs/UIBlocks.md)
 ...
 - [UserSegmentMembership](docs/UserSegmentMembership.md)
 - [UserSegmentMemberships](docs/UserSegmentMemberships.md)
 ...
 - [WebhookBodyTemplate](docs/WebhookBodyTemplate.md)
