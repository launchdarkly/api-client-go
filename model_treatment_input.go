...
// checks if the TreatmentInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TreatmentInput{}
...
type _TreatmentInput TreatmentInput
...
func (o TreatmentInput) ToMap() (map[string]interface{}, error) {
...
func (o *TreatmentInput) UnmarshalJSON(data []byte) (err error) {
	...
	varTreatmentInput := _TreatmentInput{}

	err = json.Unmarshal(data, &varTreatmentInput)

	if err != nil {
		return err
	}

	*o = TreatmentInput(varTreatmentInput)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "allocationPercent")
