...
// checks if the FlagConfigApprovalRequestsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagConfigApprovalRequestsResponse{}
...
type _FlagConfigApprovalRequestsResponse FlagConfigApprovalRequestsResponse
...
func NewFlagConfigApprovalRequestsResponse(items []FlagConfigApprovalRequestResponse, links map[string]Link) *FlagConfigApprovalRequestsResponse {
	this := FlagConfigApprovalRequestsResponse{}
	this.Items = items
	this.Links = links
	return &this
}
...
func (o *FlagConfigApprovalRequestsResponse) GetItems() []FlagConfigApprovalRequestResponse {
	if o == nil {
		var ret []FlagConfigApprovalRequestResponse
		return ret
	}
...
func (o FlagConfigApprovalRequestsResponse) ToMap() (map[string]interface{}, error) {
...
func (o *FlagConfigApprovalRequestsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagConfigApprovalRequestsResponse := _FlagConfigApprovalRequestsResponse{}

	err = json.Unmarshal(data, &varFlagConfigApprovalRequestsResponse)

	if err != nil {
		return err
	}

	*o = FlagConfigApprovalRequestsResponse(varFlagConfigApprovalRequestsResponse)
...
type NullableFlagConfigApprovalRequestsResponse struct {
	value *FlagConfigApprovalRequestsResponse
	isSet bool
}
...
func NewNullableFlagConfigApprovalRequestsResponse(val *FlagConfigApprovalRequestsResponse) *NullableFlagConfigApprovalRequestsResponse {
	return &NullableFlagConfigApprovalRequestsResponse{value: val, isSet: true}
}
