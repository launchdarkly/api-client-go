...
// checks if the FollowFlagMember type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FollowFlagMember{}
...
type _FollowFlagMember FollowFlagMember
...
func (o FollowFlagMember) ToMap() (map[string]interface{}, error) {
...
func (o *FollowFlagMember) UnmarshalJSON(data []byte) (err error) {
	...
	varFollowFlagMember := _FollowFlagMember{}

	err = json.Unmarshal(data, &varFollowFlagMember)

	if err != nil {
		return err
	}

	*o = FollowFlagMember(varFollowFlagMember)
