...
// checks if the TokenSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TokenSummary{}
...
type _TokenSummary TokenSummary
...
func (o TokenSummary) ToMap() (map[string]interface{}, error) {
...
func (o *TokenSummary) UnmarshalJSON(data []byte) (err error) {
	varTokenSummary := _TokenSummary{}

	err = json.Unmarshal(data, &varTokenSummary)

	if err != nil {
		return err
	}

	*o = TokenSummary(varTokenSummary)
