...
// checks if the FlagImportStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagImportStatus{}
...
type _FlagImportStatus FlagImportStatus
...
func (o FlagImportStatus) ToMap() (map[string]interface{}, error) {
...
func (o *FlagImportStatus) UnmarshalJSON(data []byte) (err error) {
	varFlagImportStatus := _FlagImportStatus{}

	err = json.Unmarshal(data, &varFlagImportStatus)

	if err != nil {
		return err
	}

	*o = FlagImportStatus(varFlagImportStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "status")
		delete(additionalProperties, "lastImport")
