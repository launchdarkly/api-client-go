...
// checks if the ApprovalSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApprovalSettings{}
...
type _ApprovalSettings ApprovalSettings
...
func (o *ApprovalSettings) GetAutoApplyApprovedChanges() bool {
	if o == nil || IsNil(o.AutoApplyApprovedChanges) {
		var ret bool
		return ret
	}
...
func (o *ApprovalSettings) GetServiceKindConfigurationId() string {
	if o == nil || IsNil(o.ServiceKindConfigurationId) {
		var ret string
		return ret
	}
...
func (o ApprovalSettings) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AutoApplyApprovedChanges) {
	...
	if !IsNil(o.ServiceKindConfigurationId) {
...
func (o *ApprovalSettings) UnmarshalJSON(data []byte) (err error) {
	...
	varApprovalSettings := _ApprovalSettings{}

	err = json.Unmarshal(data, &varApprovalSettings)

	if err != nil {
		return err
	}

	*o = ApprovalSettings(varApprovalSettings)
