...
// checks if the CreateWorkflowTemplateInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateWorkflowTemplateInput{}
...
type _CreateWorkflowTemplateInput CreateWorkflowTemplateInput
...
func (o CreateWorkflowTemplateInput) ToMap() (map[string]interface{}, error) {
...
func (o *CreateWorkflowTemplateInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateWorkflowTemplateInput := _CreateWorkflowTemplateInput{}

	err = json.Unmarshal(data, &varCreateWorkflowTemplateInput)

	if err != nil {
		return err
	}

	*o = CreateWorkflowTemplateInput(varCreateWorkflowTemplateInput)
