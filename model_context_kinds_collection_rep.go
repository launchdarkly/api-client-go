...
// checks if the ContextKindsCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextKindsCollectionRep{}

// ContextKindsCollectionRep struct for ContextKindsCollectionRep
type ContextKindsCollectionRep struct {
	// An array of context kinds
	Items []ContextKindRep `json:"items"`
	// The location and content type of related resources
	Links map[string]Link `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ContextKindsCollectionRep ContextKindsCollectionRep
...
func NewContextKindsCollectionRep(items []ContextKindRep, links map[string]Link) *ContextKindsCollectionRep {
	this := ContextKindsCollectionRep{}
	this.Items = items
	this.Links = links
	return &this
}
...
func (o ContextKindsCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *ContextKindsCollectionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varContextKindsCollectionRep := _ContextKindsCollectionRep{}

	err = json.Unmarshal(data, &varContextKindsCollectionRep)

	if err != nil {
		return err
	}

	*o = ContextKindsCollectionRep(varContextKindsCollectionRep)
...
type NullableContextKindsCollectionRep struct {
	value *ContextKindsCollectionRep
	isSet bool
}
...
func NewNullableContextKindsCollectionRep(val *ContextKindsCollectionRep) *NullableContextKindsCollectionRep {
	return &NullableContextKindsCollectionRep{value: val, isSet: true}
}
