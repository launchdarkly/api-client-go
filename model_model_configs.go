...
// checks if the ModelConfigs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelConfigs{}

// ModelConfigs struct for ModelConfigs
...
type _ModelConfigs ModelConfigs
...
func (o ModelConfigs) MarshalJSON() ([]byte, error) {
...
func (o ModelConfigs) ToMap() (map[string]interface{}, error) {
...
func (o *ModelConfigs) UnmarshalJSON(data []byte) (err error) {
	...
	varModelConfigs := _ModelConfigs{}

	err = json.Unmarshal(data, &varModelConfigs)

	if err != nil {
		return err
	}

	*o = ModelConfigs(varModelConfigs)
...
type NullableModelConfigs struct {
	value *ModelConfigs
	isSet bool
}

func (v NullableModelConfigs) Get() *ModelConfigs {
	return v.value
}

func (v *NullableModelConfigs) Set(val *ModelConfigs) {
	v.value = val
	v.isSet = true
}

func (v NullableModelConfigs) IsSet() bool {
	return v.isSet
}

func (v *NullableModelConfigs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModelConfigs(val *ModelConfigs) *NullableModelConfigs {
	return &NullableModelConfigs{value: val, isSet: true}
}

func (v NullableModelConfigs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModelConfigs) UnmarshalJSON(src []byte) error {
	v.isSet = true
