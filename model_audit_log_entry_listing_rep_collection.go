...
// checks if the AuditLogEntryListingRepCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditLogEntryListingRepCollection{}
...
type _AuditLogEntryListingRepCollection AuditLogEntryListingRepCollection
...
func (o AuditLogEntryListingRepCollection) ToMap() (map[string]interface{}, error) {
...
func (o *AuditLogEntryListingRepCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varAuditLogEntryListingRepCollection := _AuditLogEntryListingRepCollection{}

	err = json.Unmarshal(data, &varAuditLogEntryListingRepCollection)

	if err != nil {
		return err
	}

	*o = AuditLogEntryListingRepCollection(varAuditLogEntryListingRepCollection)
