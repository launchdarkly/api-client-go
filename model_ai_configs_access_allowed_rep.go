...
// checks if the AiConfigsAccessAllowedRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsAccessAllowedRep{}

// AiConfigsAccessAllowedRep struct for AiConfigsAccessAllowedRep
type AiConfigsAccessAllowedRep struct {
	Action string `json:"action"`
	Reason AiConfigsAccessAllowedReason `json:"reason"`
	AdditionalProperties map[string]interface{}
}

type _AiConfigsAccessAllowedRep AiConfigsAccessAllowedRep
...
func NewAiConfigsAccessAllowedRep(action string, reason AiConfigsAccessAllowedReason) *AiConfigsAccessAllowedRep {
	this := AiConfigsAccessAllowedRep{}
	this.Action = action
	this.Reason = reason
	return &this
}
...
func (o *AiConfigsAccessAllowedRep) GetReason() AiConfigsAccessAllowedReason {
	if o == nil {
		var ret AiConfigsAccessAllowedReason
		return ret
	}
...
func (o AiConfigsAccessAllowedRep) MarshalJSON() ([]byte, error) {
...
func (o AiConfigsAccessAllowedRep) ToMap() (map[string]interface{}, error) {
...
func (o *AiConfigsAccessAllowedRep) UnmarshalJSON(data []byte) (err error) {
	...
	varAiConfigsAccessAllowedRep := _AiConfigsAccessAllowedRep{}

	err = json.Unmarshal(data, &varAiConfigsAccessAllowedRep)

	if err != nil {
		return err
	}

	*o = AiConfigsAccessAllowedRep(varAiConfigsAccessAllowedRep)
...
type NullableAiConfigsAccessAllowedRep struct {
	value *AiConfigsAccessAllowedRep
	isSet bool
}

func (v NullableAiConfigsAccessAllowedRep) Get() *AiConfigsAccessAllowedRep {
	return v.value
}

func (v *NullableAiConfigsAccessAllowedRep) Set(val *AiConfigsAccessAllowedRep) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsAccessAllowedRep) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsAccessAllowedRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsAccessAllowedRep(val *AiConfigsAccessAllowedRep) *NullableAiConfigsAccessAllowedRep {
	return &NullableAiConfigsAccessAllowedRep{value: val, isSet: true}
}

func (v NullableAiConfigsAccessAllowedRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsAccessAllowedRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
