...
// checks if the CopiedFromEnv type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CopiedFromEnv{}
...
type _CopiedFromEnv CopiedFromEnv
...
func (o CopiedFromEnv) ToMap() (map[string]interface{}, error) {
...
func (o *CopiedFromEnv) UnmarshalJSON(data []byte) (err error) {
	...
	varCopiedFromEnv := _CopiedFromEnv{}

	err = json.Unmarshal(data, &varCopiedFromEnv)

	if err != nil {
		return err
	}

	*o = CopiedFromEnv(varCopiedFromEnv)
