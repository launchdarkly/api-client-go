...
// checks if the IpAllowlistEntryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IpAllowlistEntryResponse{}

// IpAllowlistEntryResponse struct for IpAllowlistEntryResponse
...
type _IpAllowlistEntryResponse IpAllowlistEntryResponse
...
func (o IpAllowlistEntryResponse) MarshalJSON() ([]byte, error) {
...
func (o IpAllowlistEntryResponse) ToMap() (map[string]interface{}, error) {
...
func (o *IpAllowlistEntryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varIpAllowlistEntryResponse := _IpAllowlistEntryResponse{}

	err = json.Unmarshal(data, &varIpAllowlistEntryResponse)

	if err != nil {
		return err
	}

	*o = IpAllowlistEntryResponse(varIpAllowlistEntryResponse)
...
type NullableIpAllowlistEntryResponse struct {
	value *IpAllowlistEntryResponse
	isSet bool
}

func (v NullableIpAllowlistEntryResponse) Get() *IpAllowlistEntryResponse {
	return v.value
}

func (v *NullableIpAllowlistEntryResponse) Set(val *IpAllowlistEntryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableIpAllowlistEntryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableIpAllowlistEntryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIpAllowlistEntryResponse(val *IpAllowlistEntryResponse) *NullableIpAllowlistEntryResponse {
	return &NullableIpAllowlistEntryResponse{value: val, isSet: true}
}

func (v NullableIpAllowlistEntryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIpAllowlistEntryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
