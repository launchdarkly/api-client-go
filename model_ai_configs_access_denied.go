...
// checks if the AiConfigsAccessDenied type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsAccessDenied{}

// AiConfigsAccessDenied struct for AiConfigsAccessDenied
type AiConfigsAccessDenied struct {
	Action string `json:"action"`
	Reason AiConfigsAccessDeniedReason `json:"reason"`
	AdditionalProperties map[string]interface{}
}

type _AiConfigsAccessDenied AiConfigsAccessDenied
...
func (o *AiConfigsAccessDenied) GetReason() AiConfigsAccessDeniedReason {
	if o == nil {
		var ret AiConfigsAccessDeniedReason
		return ret
	}
...
func (o AiConfigsAccessDenied) MarshalJSON() ([]byte, error) {
...
func (o AiConfigsAccessDenied) ToMap() (map[string]interface{}, error) {
...
func (o *AiConfigsAccessDenied) UnmarshalJSON(data []byte) (err error) {
	...
	varAiConfigsAccessDenied := _AiConfigsAccessDenied{}

	err = json.Unmarshal(data, &varAiConfigsAccessDenied)

	if err != nil {
		return err
	}

	*o = AiConfigsAccessDenied(varAiConfigsAccessDenied)
...
type NullableAiConfigsAccessDenied struct {
	value *AiConfigsAccessDenied
	isSet bool
}

func (v NullableAiConfigsAccessDenied) Get() *AiConfigsAccessDenied {
	return v.value
}

func (v *NullableAiConfigsAccessDenied) Set(val *AiConfigsAccessDenied) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsAccessDenied) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsAccessDenied) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsAccessDenied(val *AiConfigsAccessDenied) *NullableAiConfigsAccessDenied {
	return &NullableAiConfigsAccessDenied{value: val, isSet: true}
}

func (v NullableAiConfigsAccessDenied) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsAccessDenied) UnmarshalJSON(src []byte) error {
	v.isSet = true
