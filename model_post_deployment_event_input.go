...
// checks if the PostDeploymentEventInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostDeploymentEventInput{}
...
type _PostDeploymentEventInput PostDeploymentEventInput
...
func (o *PostDeploymentEventInput) GetApplicationKind() string {
	if o == nil || IsNil(o.ApplicationKind) {
		var ret string
		return ret
	}
...
func (o PostDeploymentEventInput) ToMap() (map[string]interface{}, error) {
...
func (o *PostDeploymentEventInput) UnmarshalJSON(data []byte) (err error) {
	...
	varPostDeploymentEventInput := _PostDeploymentEventInput{}

	err = json.Unmarshal(data, &varPostDeploymentEventInput)

	if err != nil {
		return err
	}

	*o = PostDeploymentEventInput(varPostDeploymentEventInput)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "applicationKind")
		delete(additionalProperties, "version")
		delete(additionalProperties, "versionName")
		delete(additionalProperties, "eventType")
		delete(additionalProperties, "eventTime")
		delete(additionalProperties, "eventMetadata")
		delete(additionalProperties, "deploymentMetadata")
