...
// checks if the ApplicationFlagCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationFlagCollectionRep{}
...
type _ApplicationFlagCollectionRep ApplicationFlagCollectionRep
...
func (o ApplicationFlagCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationFlagCollectionRep) UnmarshalJSON(data []byte) (err error) {
	varApplicationFlagCollectionRep := _ApplicationFlagCollectionRep{}

	err = json.Unmarshal(data, &varApplicationFlagCollectionRep)

	if err != nil {
		return err
	}

	*o = ApplicationFlagCollectionRep(varApplicationFlagCollectionRep)
