...
// checks if the PatchSegmentInstruction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchSegmentInstruction{}
...
type _PatchSegmentInstruction PatchSegmentInstruction
...
func (o PatchSegmentInstruction) ToMap() (map[string]interface{}, error) {
...
func (o *PatchSegmentInstruction) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchSegmentInstruction := _PatchSegmentInstruction{}

	err = json.Unmarshal(data, &varPatchSegmentInstruction)

	if err != nil {
		return err
	}

	*o = PatchSegmentInstruction(varPatchSegmentInstruction)
