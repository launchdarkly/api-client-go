...
// checks if the DestinationPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DestinationPost{}
...
type _DestinationPost DestinationPost
...
func (o DestinationPost) ToMap() (map[string]interface{}, error) {
...
func (o *DestinationPost) UnmarshalJSON(data []byte) (err error) {
	varDestinationPost := _DestinationPost{}

	err = json.Unmarshal(data, &varDestinationPost)

	if err != nil {
		return err
	}

	*o = DestinationPost(varDestinationPost)
