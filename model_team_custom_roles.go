...
// checks if the TeamCustomRoles type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamCustomRoles{}
...
type _TeamCustomRoles TeamCustomRoles
...
func (o TeamCustomRoles) ToMap() (map[string]interface{}, error) {
...
func (o *TeamCustomRoles) UnmarshalJSON(data []byte) (err error) {
	varTeamCustomRoles := _TeamCustomRoles{}

	err = json.Unmarshal(data, &varTeamCustomRoles)

	if err != nil {
		return err
	}

	*o = TeamCustomRoles(varTeamCustomRoles)
