...
// checks if the HoldoutRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HoldoutRep{}
...
func (o HoldoutRep) ToMap() (map[string]interface{}, error) {
...
func (o *HoldoutRep) UnmarshalJSON(data []byte) (err error) {
	...
	varHoldoutRep := _HoldoutRep{}

	err = json.Unmarshal(data, &varHoldoutRep)

	if err != nil {
		return err
	}

	*o = HoldoutRep(varHoldoutRep)
