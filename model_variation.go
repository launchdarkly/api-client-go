...
// checks if the Variation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Variation{}
...
func (o Variation) ToMap() (map[string]interface{}, error) {
...
func (o *Variation) UnmarshalJSON(data []byte) (err error) {
	...
	varVariation := _Variation{}

	err = json.Unmarshal(data, &varVariation)

	if err != nil {
		return err
	}

	*o = Variation(varVariation)
