...
// checks if the MaintainerRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintainerRep{}

// MaintainerRep struct for MaintainerRep
type MaintainerRep struct {
	...
	Team *MemberTeamSummaryRep `json:"_team,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MaintainerRep MaintainerRep
...
func (o MaintainerRep) ToMap() (map[string]interface{}, error) {
...
func (o *MaintainerRep) UnmarshalJSON(data []byte) (err error) {
	...
	varMaintainerRep := _MaintainerRep{}

	err = json.Unmarshal(data, &varMaintainerRep)

	if err != nil {
		return err
	}

	*o = MaintainerRep(varMaintainerRep)
...
func NewNullableMaintainerRep(val *MaintainerRep) *NullableMaintainerRep {
	return &NullableMaintainerRep{value: val, isSet: true}
}
