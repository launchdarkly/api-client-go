...
// checks if the AuditLogEntryRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditLogEntryRep{}
...
type _AuditLogEntryRep AuditLogEntryRep
...
func (o AuditLogEntryRep) ToMap() (map[string]interface{}, error) {
...
func (o *AuditLogEntryRep) UnmarshalJSON(data []byte) (err error) {
	...
	varAuditLogEntryRep := _AuditLogEntryRep{}

	err = json.Unmarshal(data, &varAuditLogEntryRep)

	if err != nil {
		return err
	}

	*o = AuditLogEntryRep(varAuditLogEntryRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "triggerBody")
		delete(additionalProperties, "merge")
		delete(additionalProperties, "previousVersion")
		delete(additionalProperties, "currentVersion")
		delete(additionalProperties, "subentries")
