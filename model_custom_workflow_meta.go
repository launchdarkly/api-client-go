...
// checks if the CustomWorkflowMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomWorkflowMeta{}
...
type _CustomWorkflowMeta CustomWorkflowMeta
...
func (o CustomWorkflowMeta) ToMap() (map[string]interface{}, error) {
...
func (o *CustomWorkflowMeta) UnmarshalJSON(data []byte) (err error) {
	varCustomWorkflowMeta := _CustomWorkflowMeta{}

	err = json.Unmarshal(data, &varCustomWorkflowMeta)

	if err != nil {
		return err
	}

	*o = CustomWorkflowMeta(varCustomWorkflowMeta)
