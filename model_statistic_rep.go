...
// checks if the StatisticRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatisticRep{}
...
type _StatisticRep StatisticRep
...
func (o *StatisticRep) GetLatestCommitTime() int64 {
	if o == nil || IsNil(o.LatestCommitTime) {
		var ret int64
		return ret
	}
...
func (o StatisticRep) ToMap() (map[string]interface{}, error) {
...
func (o *StatisticRep) UnmarshalJSON(data []byte) (err error) {
	...
	varStatisticRep := _StatisticRep{}

	err = json.Unmarshal(data, &varStatisticRep)

	if err != nil {
		return err
	}

	*o = StatisticRep(varStatisticRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "hunkCount")
		delete(additionalProperties, "fileCount")
		delete(additionalProperties, "_links")
		delete(additionalProperties, "latestCommitTime")
