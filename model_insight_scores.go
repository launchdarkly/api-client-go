...
// checks if the InsightScores type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightScores{}
...
type _InsightScores InsightScores
...
func (o InsightScores) ToMap() (map[string]interface{}, error) {
...
func (o *InsightScores) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightScores := _InsightScores{}

	err = json.Unmarshal(data, &varInsightScores)

	if err != nil {
		return err
	}

	*o = InsightScores(varInsightScores)
