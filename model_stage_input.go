...
// checks if the StageInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StageInput{}
...
func (o *StageInput) GetExecuteConditionsInSequence() bool {
	if o == nil || IsNil(o.ExecuteConditionsInSequence) {
		var ret bool
		return ret
	}
...
func (o StageInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Name) {
		toSerialize["name"] = o.Name
	}
	if !IsNil(o.ExecuteConditionsInSequence) {
...
func (o *StageInput) UnmarshalJSON(data []byte) (err error) {
	varStageInput := _StageInput{}

	err = json.Unmarshal(data, &varStageInput)

	if err != nil {
		return err
	}

	*o = StageInput(varStageInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "name")
		delete(additionalProperties, "executeConditionsInSequence")
