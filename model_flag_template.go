...
// FlagTemplate struct for FlagTemplate
type FlagTemplate struct {
	...
	DefaultVariations *Defaults `json:"defaultVariations,omitempty"`
}
...
// GetVariationType returns the VariationType field value if set, zero value otherwise.
func (o *FlagTemplate) GetVariationType() string {
	if o == nil || o.VariationType == nil {
		var ret string
		return ret
	}
...
// GetVariationTypeOk returns a tuple with the VariationType field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetVariationType gets a reference to the given string and assigns it to the VariationType field.
...
// GetDefaultVariations returns the DefaultVariations field value if set, zero value otherwise.
func (o *FlagTemplate) GetDefaultVariations() Defaults {
	if o == nil || o.DefaultVariations == nil {
		var ret Defaults
		return ret
	}
	return *o.DefaultVariations
}

// GetDefaultVariationsOk returns a tuple with the DefaultVariations field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlagTemplate) GetDefaultVariationsOk() (*Defaults, bool) {
	if o == nil || o.DefaultVariations == nil {
		return nil, false
	}
	return o.DefaultVariations, true
}
...
// SetDefaultVariations gets a reference to the given Defaults and assigns it to the DefaultVariations field.
func (o *FlagTemplate) SetDefaultVariations(v Defaults) {
	o.DefaultVariations = &v
}

func (o FlagTemplate) MarshalJSON() ([]byte, error) {
	...
	if o.DefaultVariations != nil {
		toSerialize["defaultVariations"] = o.DefaultVariations
	}
	return json.Marshal(toSerialize)
}

type NullableFlagTemplate struct {
	value *FlagTemplate
	isSet bool
}

func (v NullableFlagTemplate) Get() *FlagTemplate {
	return v.value
}

func (v *NullableFlagTemplate) Set(val *FlagTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableFlagTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableFlagTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlagTemplate(val *FlagTemplate) *NullableFlagTemplate {
	return &NullableFlagTemplate{value: val, isSet: true}
}

func (v NullableFlagTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlagTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
