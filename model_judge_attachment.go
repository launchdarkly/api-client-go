...
// checks if the JudgeAttachment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JudgeAttachment{}

// JudgeAttachment struct for JudgeAttachment
type JudgeAttachment struct {
	// Key of the judge AI Config
	JudgeConfigKey string `json:"judgeConfigKey"`
	// Sampling rate for this judge attachment (0.0 to 1.0)
	SamplingRate float32 `json:"samplingRate"`
	AdditionalProperties map[string]interface{}
}

type _JudgeAttachment JudgeAttachment
...
// GetJudgeConfigKey returns the JudgeConfigKey field value
func (o *JudgeAttachment) GetJudgeConfigKey() string {
	...
	return o.JudgeConfigKey
}

// GetJudgeConfigKeyOk returns a tuple with the JudgeConfigKey field value
// and a boolean to check if the value has been set.
func (o *JudgeAttachment) GetJudgeConfigKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.JudgeConfigKey, true
}

// SetJudgeConfigKey sets field value
...
func (o JudgeAttachment) MarshalJSON() ([]byte, error) {
...
func (o JudgeAttachment) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["judgeConfigKey"] = o.JudgeConfigKey
...
func (o *JudgeAttachment) UnmarshalJSON(data []byte) (err error) {
	...
	varJudgeAttachment := _JudgeAttachment{}

	err = json.Unmarshal(data, &varJudgeAttachment)

	if err != nil {
		return err
	}

	*o = JudgeAttachment(varJudgeAttachment)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "judgeConfigKey")
		delete(additionalProperties, "samplingRate")
...
type NullableJudgeAttachment struct {
	value *JudgeAttachment
	isSet bool
}

func (v NullableJudgeAttachment) Get() *JudgeAttachment {
	return v.value
}

func (v *NullableJudgeAttachment) Set(val *JudgeAttachment) {
	v.value = val
	v.isSet = true
}

func (v NullableJudgeAttachment) IsSet() bool {
	return v.isSet
}

func (v *NullableJudgeAttachment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJudgeAttachment(val *JudgeAttachment) *NullableJudgeAttachment {
	return &NullableJudgeAttachment{value: val, isSet: true}
}

func (v NullableJudgeAttachment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJudgeAttachment) UnmarshalJSON(src []byte) error {
	v.isSet = true
