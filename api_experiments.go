...
For example, `expand=draftIteration,treatments` includes the `draftIteration` and `treatments` fields in the response. If fields that you request with the `expand` query parameter are empty, they are not included in the response.
	...
	*/
	...
	Deprecated
	*/
	GetLegacyExperimentResults(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, metricKey string) ApiGetLegacyExperimentResultsRequest

	// GetLegacyExperimentResultsExecute executes the request
	//  @return ExperimentResults
	// Deprecated
	GetLegacyExperimentResultsExecute(r ApiGetLegacyExperimentResultsRequest) (*ExperimentResults, *http.Response, error)
...
Deprecated
*/
func (a *ExperimentsApiService) GetLegacyExperimentResults(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, metricKey string) ApiGetLegacyExperimentResultsRequest {
	return ApiGetLegacyExperimentResultsRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
//  @return ExperimentResults
// Deprecated
func (a *ExperimentsApiService) GetLegacyExperimentResultsExecute(r ApiGetLegacyExperimentResultsRequest) (*ExperimentResults, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExperimentsApiService.GetLegacyExperimentResults")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
