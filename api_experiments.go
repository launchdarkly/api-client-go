...
To learn more, read [Creating experiments](https://launchdarkly.com/docs/home/experimentation/create).
	...
	*/
	...
	> **Deprecated**: This endpoint will be removed in a future version. Use the `updateExperimentFields` and `saveAndStartNewIteration` instructions on [Update experiment](https://launchdarkly.com/docs/api/experiments/patch-experiment) instead.
...
For example, `expand=draftIteration,treatments` includes the `draftIteration` and `treatments` fields in the response. If fields that you request with the `expand` query parameter are empty, they are not included in the response.
	...
	*/
	GetExperimentsAnyEnv(ctx context.Context, projectKey string) ApiGetExperimentsAnyEnvRequest

	// GetExperimentsAnyEnvExecute executes the request
	//  @return ExperimentCollectionRep
	GetExperimentsAnyEnvExecute(r ApiGetExperimentsAnyEnvRequest) (*ExperimentCollectionRep, *http.Response, error)
...
func (a *ExperimentsApiService) CreateIterationExecute(r ApiCreateIterationRequest) (*IterationRep, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterValueToString(r.projectKey, "projectKey")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", url.PathEscape(parameterValueToString(r.environmentKey, "environmentKey")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"experimentKey"+"}", url.PathEscape(parameterValueToString(r.experimentKey, "experimentKey")), -1)
...
func (a *ExperimentsApiService) GetExperimentsExecute(r ApiGetExperimentsRequest) (*ExperimentCollectionRep, *http.Response, error) {
	...
	if r.lifecycleState != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "lifecycleState", r.lifecycleState, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
Get a list of experiments from across all environments in the project
 ...
 @return ApiGetExperimentsAnyEnvRequest
*/
func (a *ExperimentsApiService) GetExperimentsAnyEnv(ctx context.Context, projectKey string) ApiGetExperimentsAnyEnvRequest {
	return ApiGetExperimentsAnyEnvRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return ExperimentCollectionRep
func (a *ExperimentsApiService) GetExperimentsAnyEnvExecute(r ApiGetExperimentsAnyEnvRequest) (*ExperimentCollectionRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExperimentsApiService.GetExperimentsAnyEnv")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
