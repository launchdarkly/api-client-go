...
// checks if the AIConfigPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigPatch{}
...
type _AIConfigPatch AIConfigPatch
...
func (o AIConfigPatch) ToMap() (map[string]interface{}, error) {
...
func (o *AIConfigPatch) UnmarshalJSON(data []byte) (err error) {
	varAIConfigPatch := _AIConfigPatch{}

	err = json.Unmarshal(data, &varAIConfigPatch)

	if err != nil {
		return err
	}

	*o = AIConfigPatch(varAIConfigPatch)
