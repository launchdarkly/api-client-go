...
// checks if the AIConfigVariation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigVariation{}
...
type AIConfigVariation struct {
	...
	OutputFormat map[string]interface{} `json:"outputFormat,omitempty"`
	CreatedAt int64 `json:"createdAt"`
	Version int32 `json:"version"`
	State *string `json:"state,omitempty"`
	ArchivedAt *int64 `json:"_archivedAt,omitempty"`
	PublishedAt *int64 `json:"_publishedAt,omitempty"`
	Tools []VariationTool `json:"tools,omitempty"`
	Skills []VariationSkill `json:"skills,omitempty"`
	JudgeConfiguration *JudgeConfiguration `json:"judgeConfiguration,omitempty"`
	JudgingConfigKeys []string `json:"judgingConfigKeys,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AIConfigVariation AIConfigVariation
...
func (o *AIConfigVariation) GetModelConfigKey() string {
	if o == nil || IsNil(o.ModelConfigKey) {
		var ret string
		return ret
	}
...
// SetTools gets a reference to the given []VariationTool and assigns it to the Tools field.
...
// SetSkills gets a reference to the given []VariationSkill and assigns it to the Skills field.
func (o *AIConfigVariation) SetSkills(v []VariationSkill) {
	o.Skills = v
}

// GetJudgeConfiguration returns the JudgeConfiguration field value if set, zero value otherwise.
func (o *AIConfigVariation) GetJudgeConfiguration() JudgeConfiguration {
	if o == nil || IsNil(o.JudgeConfiguration) {
		var ret JudgeConfiguration
		return ret
	}
	return *o.JudgeConfiguration
}

// GetJudgeConfigurationOk returns a tuple with the JudgeConfiguration field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AIConfigVariation) GetJudgeConfigurationOk() (*JudgeConfiguration, bool) {
	if o == nil || IsNil(o.JudgeConfiguration) {
		return nil, false
	}
	return o.JudgeConfiguration, true
}
...
// SetJudgeConfiguration gets a reference to the given JudgeConfiguration and assigns it to the JudgeConfiguration field.
func (o *AIConfigVariation) SetJudgeConfiguration(v JudgeConfiguration) {
	o.JudgeConfiguration = &v
}

// GetJudgingConfigKeys returns the JudgingConfigKeys field value if set, zero value otherwise.
func (o *AIConfigVariation) GetJudgingConfigKeys() []string {
	if o == nil || IsNil(o.JudgingConfigKeys) {
		var ret []string
		return ret
	}
	return o.JudgingConfigKeys
}

// GetJudgingConfigKeysOk returns a tuple with the JudgingConfigKeys field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AIConfigVariation) GetJudgingConfigKeysOk() ([]string, bool) {
	if o == nil || IsNil(o.JudgingConfigKeys) {
		return nil, false
	}
	return o.JudgingConfigKeys, true
}
...
// SetJudgingConfigKeys gets a reference to the given []string and assigns it to the JudgingConfigKeys field.
func (o *AIConfigVariation) SetJudgingConfigKeys(v []string) {
	o.JudgingConfigKeys = v
}
...
func (o AIConfigVariation) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.JudgeConfiguration) {
		toSerialize["judgeConfiguration"] = o.JudgeConfiguration
	}
	if !IsNil(o.JudgingConfigKeys) {
		toSerialize["judgingConfigKeys"] = o.JudgingConfigKeys
	}
...
func (o *AIConfigVariation) UnmarshalJSON(data []byte) (err error) {
	...
	varAIConfigVariation := _AIConfigVariation{}

	err = json.Unmarshal(data, &varAIConfigVariation)

	if err != nil {
		return err
	}

	*o = AIConfigVariation(varAIConfigVariation)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "modelConfigKey")
		delete(additionalProperties, "name")
		delete(additionalProperties, "outputFormat")
		delete(additionalProperties, "createdAt")
		delete(additionalProperties, "version")
		delete(additionalProperties, "state")
		delete(additionalProperties, "_archivedAt")
		delete(additionalProperties, "_publishedAt")
		delete(additionalProperties, "tools")
		delete(additionalProperties, "skills")
		delete(additionalProperties, "judgeConfiguration")
		delete(additionalProperties, "judgingConfigKeys")
