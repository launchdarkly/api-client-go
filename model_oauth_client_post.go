...
// checks if the OauthClientPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OauthClientPost{}
...
type _OauthClientPost OauthClientPost
...
func (o OauthClientPost) ToMap() (map[string]interface{}, error) {
...
func (o *OauthClientPost) UnmarshalJSON(data []byte) (err error) {
	varOauthClientPost := _OauthClientPost{}

	err = json.Unmarshal(data, &varOauthClientPost)

	if err != nil {
		return err
	}

	*o = OauthClientPost(varOauthClientPost)
