...
// checks if the AIConfigs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigs{}
...
func (o AIConfigs) ToMap() (map[string]interface{}, error) {
...
func (o *AIConfigs) UnmarshalJSON(data []byte) (err error) {
	...
	varAIConfigs := _AIConfigs{}

	err = json.Unmarshal(data, &varAIConfigs)

	if err != nil {
		return err
	}

	*o = AIConfigs(varAIConfigs)
