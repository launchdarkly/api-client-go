...
// checks if the ReleasePolicyScope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleasePolicyScope{}

// ReleasePolicyScope struct for ReleasePolicyScope
...
type _ReleasePolicyScope ReleasePolicyScope
...
// GetEnvironmentKeys returns the EnvironmentKeys field value if set, zero value otherwise.
func (o *ReleasePolicyScope) GetEnvironmentKeys() []string {
	if o == nil || IsNil(o.EnvironmentKeys) {
		var ret []string
		return ret
	}
...
// GetEnvironmentKeysOk returns a tuple with the EnvironmentKeys field value if set, nil otherwise
...
// SetEnvironmentKeys gets a reference to the given []string and assigns it to the EnvironmentKeys field.
...
func (o ReleasePolicyScope) ToMap() (map[string]interface{}, error) {
...
func (o *ReleasePolicyScope) UnmarshalJSON(data []byte) (err error) {
	varReleasePolicyScope := _ReleasePolicyScope{}

	err = json.Unmarshal(data, &varReleasePolicyScope)

	if err != nil {
		return err
	}

	*o = ReleasePolicyScope(varReleasePolicyScope)
...
type NullableReleasePolicyScope struct {
	value *ReleasePolicyScope
	isSet bool
}

func (v NullableReleasePolicyScope) Get() *ReleasePolicyScope {
	return v.value
}

func (v *NullableReleasePolicyScope) Set(val *ReleasePolicyScope) {
	v.value = val
	v.isSet = true
}

func (v NullableReleasePolicyScope) IsSet() bool {
	return v.isSet
}

func (v *NullableReleasePolicyScope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleasePolicyScope(val *ReleasePolicyScope) *NullableReleasePolicyScope {
	return &NullableReleasePolicyScope{value: val, isSet: true}
}

func (v NullableReleasePolicyScope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReleasePolicyScope) UnmarshalJSON(src []byte) error {
	v.isSet = true
