...
// ExperimentEnvironmentSettingRepEnabledPeriods struct for ExperimentEnvironmentSettingRepEnabledPeriods
type ExperimentEnvironmentSettingRepEnabledPeriods struct {
...
func NewExperimentEnvironmentSettingRepEnabledPeriods() *ExperimentEnvironmentSettingRepEnabledPeriods {
	this := ExperimentEnvironmentSettingRepEnabledPeriods{}
	return &this
}
...
func (o ExperimentEnvironmentSettingRepEnabledPeriods) MarshalJSON() ([]byte, error) {
...
type NullableExperimentEnvironmentSettingRepEnabledPeriods struct {
	value *ExperimentEnvironmentSettingRepEnabledPeriods
	isSet bool
}

func (v NullableExperimentEnvironmentSettingRepEnabledPeriods) Get() *ExperimentEnvironmentSettingRepEnabledPeriods {
	return v.value
}

func (v *NullableExperimentEnvironmentSettingRepEnabledPeriods) Set(val *ExperimentEnvironmentSettingRepEnabledPeriods) {
	v.value = val
	v.isSet = true
}

func (v NullableExperimentEnvironmentSettingRepEnabledPeriods) IsSet() bool {
	return v.isSet
}

func (v *NullableExperimentEnvironmentSettingRepEnabledPeriods) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExperimentEnvironmentSettingRepEnabledPeriods(val *ExperimentEnvironmentSettingRepEnabledPeriods) *NullableExperimentEnvironmentSettingRepEnabledPeriods {
	return &NullableExperimentEnvironmentSettingRepEnabledPeriods{value: val, isSet: true}
}

func (v NullableExperimentEnvironmentSettingRepEnabledPeriods) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExperimentEnvironmentSettingRepEnabledPeriods) UnmarshalJSON(src []byte) error {
	v.isSet = true
