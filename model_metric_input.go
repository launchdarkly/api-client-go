...
// checks if the MetricInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricInput{}
...
func (o MetricInput) ToMap() (map[string]interface{}, error) {
...
func (o *MetricInput) UnmarshalJSON(data []byte) (err error) {
	...
	varMetricInput := _MetricInput{}

	err = json.Unmarshal(data, &varMetricInput)

	if err != nil {
		return err
	}

	*o = MetricInput(varMetricInput)
