...
// checks if the SegmentTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SegmentTarget{}
...
type _SegmentTarget SegmentTarget
...
func (o SegmentTarget) ToMap() (map[string]interface{}, error) {
...
func (o *SegmentTarget) UnmarshalJSON(data []byte) (err error) {
	varSegmentTarget := _SegmentTarget{}

	err = json.Unmarshal(data, &varSegmentTarget)

	if err != nil {
		return err
	}

	*o = SegmentTarget(varSegmentTarget)
...
func NewNullableSegmentTarget(val *SegmentTarget) *NullableSegmentTarget {
	return &NullableSegmentTarget{value: val, isSet: true}
}
