...
// FollowFlagsBetaApiService FollowFlagsBetaApi service
type FollowFlagsBetaApiService service

type ApiDeleteFlagFollowersRequest struct {
	ctx _context.Context
	ApiService *FollowFlagsBetaApiService
	projectKey string
...
func (r ApiDeleteFlagFollowersRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.DeleteFlagFollowersExecute(r)
}

/*
DeleteFlagFollowers Remove a member as a follower to a flag in a project and environment
...
Remove a member as a follower to a flag in a project and environment
 ...
 @param memberId memberId of the member following the flag resource
 @return ApiDeleteFlagFollowersRequest
*/
func (a *FollowFlagsBetaApiService) DeleteFlagFollowers(ctx _context.Context, projectKey string, featureFlagKey string, environmentKey string, memberId string) ApiDeleteFlagFollowersRequest {
	return ApiDeleteFlagFollowersRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *FollowFlagsBetaApiService) DeleteFlagFollowersExecute(r ApiDeleteFlagFollowersRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FollowFlagsBetaApiService.DeleteFlagFollowers")
	if err != nil {
...
func (r ApiGetFlagFollowersRequest) Execute() (FlagFollowersGetRep, *_nethttp.Response, error) {
...
Get list of members following a flag in a project and environment
...
*/
func (a *FollowFlagsBetaApiService) GetFlagFollowers(ctx _context.Context, projectKey string, featureFlagKey string, environmentKey string) ApiGetFlagFollowersRequest {
	return ApiGetFlagFollowersRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
func (a *FollowFlagsBetaApiService) GetFlagFollowersExecute(r ApiGetFlagFollowersRequest) (FlagFollowersGetRep, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FollowFlagsBetaApiService.GetFlagFollowers")
	if err != nil {
...
func (r ApiPutFlagFollowersRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.PutFlagFollowersExecute(r)
}

/*
PutFlagFollowers Add a member as a follower to a flag in a project and environment
...
*/
func (a *FollowFlagsBetaApiService) PutFlagFollowers(ctx _context.Context, projectKey string, featureFlagKey string, environmentKey string, memberId string) ApiPutFlagFollowersRequest {
	return ApiPutFlagFollowersRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
func (a *FollowFlagsBetaApiService) PutFlagFollowersExecute(r ApiPutFlagFollowersRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FollowFlagsBetaApiService.PutFlagFollowers")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}
