...
func ViewLinkRequestKeysAsViewLinkRequest(v *ViewLinkRequestKeys) ViewLinkRequest {
	return ViewLinkRequest{
		ViewLinkRequestKeys: v,
	}
}

// ViewLinkRequestSegmentIdentifiersAsViewLinkRequest is a convenience function that returns ViewLinkRequestSegmentIdentifiers wrapped in ViewLinkRequest
func ViewLinkRequestSegmentIdentifiersAsViewLinkRequest(v *ViewLinkRequestSegmentIdentifiers) ViewLinkRequest {
	return ViewLinkRequest{
		ViewLinkRequestSegmentIdentifiers: v,
	}
}
...
func (dst *ViewLinkRequest) UnmarshalJSON(data []byte) error {
	...
	if err == nil {
		jsonViewLinkRequestKeys, _ := json.Marshal(dst.ViewLinkRequestKeys)
	...
	// try to unmarshal data into ViewLinkRequestSegmentIdentifiers
	err = newStrictDecoder(data).Decode(&dst.ViewLinkRequestSegmentIdentifiers)
	if err == nil {
		jsonViewLinkRequestSegmentIdentifiers, _ := json.Marshal(dst.ViewLinkRequestSegmentIdentifiers)
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(ViewLinkRequest)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(ViewLinkRequest)")
	}
}
...
func (src ViewLinkRequest) MarshalJSON() ([]byte, error) {
	...
	if src.ViewLinkRequestSegmentIdentifiers != nil {
		return json.Marshal(&src.ViewLinkRequestSegmentIdentifiers)
	}
...
func (obj *ViewLinkRequest) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableViewLinkRequest struct {
	value *ViewLinkRequest
	isSet bool
}

func (v NullableViewLinkRequest) Get() *ViewLinkRequest {
	return v.value
}

func (v *NullableViewLinkRequest) Set(val *ViewLinkRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableViewLinkRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableViewLinkRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewLinkRequest(val *ViewLinkRequest) *NullableViewLinkRequest {
	return &NullableViewLinkRequest{value: val, isSet: true}
}

func (v NullableViewLinkRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewLinkRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
