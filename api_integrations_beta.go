...
func (r ApiValidateConnectionRequest) Execute() (IntegrationSubscriptionTestEventRep, *_nethttp.Response, error) {
 ...
 */
func (a *IntegrationsBetaApiService) ValidateConnection(ctx _context.Context, integrationKey string, id string) ApiValidateConnectionRequest {
	return ApiValidateConnectionRequest{
		ApiService: a,
		ctx: ctx,
 ...
 */
func (a *IntegrationsBetaApiService) ValidateConnectionExecute(r ApiValidateConnectionRequest) (IntegrationSubscriptionTestEventRep, *_nethttp.Response, error) {
	var (
