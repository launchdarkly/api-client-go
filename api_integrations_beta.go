...
To learn more, read [Segment configuration](https://docs.launchdarkly.com/home/flags/segment-config).
	...
	*/
	...
	//  @return Object
	TriggerFlagImportJobExecute(r ApiTriggerFlagImportJobRequest) (*Object, *http.Response, error)
}
...
Create a new flag import configuration. The `integrationKey` path parameter identifies the feature management system from which the import occurs, for example, `split`. The `config` object in the request body schema is described by the global integration settings, as specified by the <code>formVariables</code> in the <code>manifest.json</code> for this integration. It varies slightly based on the `integrationKey`.
 ...
 @return ApiCreateFlagImportConfigurationRequest
*/
func (a *IntegrationsBetaApiService) CreateFlagImportConfiguration(ctx context.Context, projectKey string, integrationKey string) ApiCreateFlagImportConfigurationRequest {
	return ApiCreateFlagImportConfigurationRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return FlagImportIntegration
func (a *IntegrationsBetaApiService) CreateFlagImportConfigurationExecute(r ApiCreateFlagImportConfigurationRequest) (*FlagImportIntegration, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsBetaApiService.CreateFlagImportConfiguration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Delete a flag import configuration by ID. The `integrationKey` path parameter identifies the feature management system from which the import occurs, for example, `split`.
 ...
 @return ApiDeleteFlagImportConfigurationRequest
*/
func (a *IntegrationsBetaApiService) DeleteFlagImportConfiguration(ctx context.Context, projectKey string, integrationKey string, integrationId string) ApiDeleteFlagImportConfigurationRequest {
	return ApiDeleteFlagImportConfigurationRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
func (a *IntegrationsBetaApiService) DeleteFlagImportConfigurationExecute(r ApiDeleteFlagImportConfigurationRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsBetaApiService.DeleteFlagImportConfiguration")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Get a single flag import configuration by ID. The `integrationKey` path parameter identifies the feature management system from which the import occurs, for example, `split`.
 ...
 @return ApiGetFlagImportConfigurationRequest
*/
func (a *IntegrationsBetaApiService) GetFlagImportConfiguration(ctx context.Context, projectKey string, integrationKey string, integrationId string) ApiGetFlagImportConfigurationRequest {
	return ApiGetFlagImportConfigurationRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return FlagImportIntegration
func (a *IntegrationsBetaApiService) GetFlagImportConfigurationExecute(r ApiGetFlagImportConfigurationRequest) (*FlagImportIntegration, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsBetaApiService.GetFlagImportConfiguration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
List all flag import configurations.
 ...
 @return ApiGetFlagImportConfigurationsRequest
*/
func (a *IntegrationsBetaApiService) GetFlagImportConfigurations(ctx context.Context) ApiGetFlagImportConfigurationsRequest {
	return ApiGetFlagImportConfigurationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return FlagImportIntegrationCollection
func (a *IntegrationsBetaApiService) GetFlagImportConfigurationsExecute(r ApiGetFlagImportConfigurationsRequest) (*FlagImportIntegrationCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsBetaApiService.GetFlagImportConfigurations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Updating a flag import configuration uses a [JSON patch](https://datatracker.ietf.org/doc/html/rfc6902) representation of the desired changes. To learn more, read [Updates](/#section/Overview/Updates).<br/><br/>To add an element to the import configuration fields that are arrays, set the `path` to the name of the field and then append `/<array index>`. Use `/0` to add to the beginning of the array. Use `/-` to add to the end of the array.<br/><br/>You can update the `config`, `tags`, and `name` of the flag import configuration.
 ...
 @return ApiPatchFlagImportConfigurationRequest
*/
func (a *IntegrationsBetaApiService) PatchFlagImportConfiguration(ctx context.Context, projectKey string, integrationKey string, integrationId string) ApiPatchFlagImportConfigurationRequest {
	return ApiPatchFlagImportConfigurationRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return FlagImportIntegration
func (a *IntegrationsBetaApiService) PatchFlagImportConfigurationExecute(r ApiPatchFlagImportConfigurationRequest) (*FlagImportIntegration, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsBetaApiService.PatchFlagImportConfiguration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiTriggerFlagImportJobRequest) Execute() (*Object, *http.Response, error) {
...
Trigger a single flag import run for an existing flag import configuration. The `integrationKey` path parameter identifies the feature management system from which the import occurs, for example, `split`.
 ...
 @return ApiTriggerFlagImportJobRequest
*/
func (a *IntegrationsBetaApiService) TriggerFlagImportJob(ctx context.Context, projectKey string, integrationKey string, integrationId string) ApiTriggerFlagImportJobRequest {
	return ApiTriggerFlagImportJobRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return Object
func (a *IntegrationsBetaApiService) TriggerFlagImportJobExecute(r ApiTriggerFlagImportJobRequest) (*Object, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsBetaApiService.TriggerFlagImportJob")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
