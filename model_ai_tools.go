...
// checks if the AITools type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AITools{}

// AITools struct for AITools
type AITools struct {
	Links *PaginatedLinks `json:"_links,omitempty"`
	Items []AITool `json:"items"`
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _AITools AITools
...
func (o AITools) MarshalJSON() ([]byte, error) {
...
func (o AITools) ToMap() (map[string]interface{}, error) {
...
func (o *AITools) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAITools)

	if err != nil {
		return err
	}

	*o = AITools(varAITools)
...
type NullableAITools struct {
	value *AITools
	isSet bool
}

func (v NullableAITools) Get() *AITools {
	return v.value
}

func (v *NullableAITools) Set(val *AITools) {
	v.value = val
	v.isSet = true
}

func (v NullableAITools) IsSet() bool {
	return v.isSet
}

func (v *NullableAITools) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAITools(val *AITools) *NullableAITools {
	return &NullableAITools{value: val, isSet: true}
}

func (v NullableAITools) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAITools) UnmarshalJSON(src []byte) error {
	v.isSet = true
