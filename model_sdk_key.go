...
// checks if the SdkKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdkKey{}

// SdkKey struct for SdkKey
type SdkKey struct {
...
func (o SdkKey) MarshalJSON() ([]byte, error) {
...
func (o SdkKey) ToMap() (map[string]interface{}, error) {
...
func (o *SdkKey) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSdkKey)
...
type NullableSdkKey struct {
	value *SdkKey
	isSet bool
}

func (v NullableSdkKey) Get() *SdkKey {
	return v.value
}

func (v *NullableSdkKey) Set(val *SdkKey) {
	v.value = val
	v.isSet = true
}

func (v NullableSdkKey) IsSet() bool {
	return v.isSet
}

func (v *NullableSdkKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdkKey(val *SdkKey) *NullableSdkKey {
	return &NullableSdkKey{value: val, isSet: true}
}

func (v NullableSdkKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdkKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
