...
// CreationRequest struct for CreationRequest
...
func (o CreationRequest) MarshalJSON() ([]byte, error) {
...
type NullableCreationRequest struct {
	value *CreationRequest
	isSet bool
}

func (v NullableCreationRequest) Get() *CreationRequest {
	return v.value
}

func (v *NullableCreationRequest) Set(val *CreationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreationRequest(val *CreationRequest) *NullableCreationRequest {
	return &NullableCreationRequest{value: val, isSet: true}
}

func (v NullableCreationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
