 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "limit" (float32) Pagination limit.
     @param "offset" (float32) Specifies the first item to return in the collection.
...
func (a *UsersApiService) GetSearchUsers(ctx context.Context, projectKey string, environmentKey string, localVarOptionals map[string]interface{}) (Users,  *http.Response, error) {
	...
	if err := typeCheckParameter(localVarOptionals["offset"], "float32", "offset"); err != nil {
		return successPayload, nil, err
	}
	...
	if localVarTempParam, localVarOk := localVarOptionals["offset"].(float32); localVarOk {
