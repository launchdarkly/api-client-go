...
// checks if the FlagSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagSummary{}
...
func (o *FlagSummary) GetVariations() map[string]VariationSummary {
	if o == nil {
		var ret map[string]VariationSummary
		return ret
	}
...
func (o FlagSummary) ToMap() (map[string]interface{}, error) {
...
func (o *FlagSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagSummary := _FlagSummary{}

	err = json.Unmarshal(data, &varFlagSummary)

	if err != nil {
		return err
	}

	*o = FlagSummary(varFlagSummary)
