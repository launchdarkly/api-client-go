...
// WebExpiringUserTargetItem struct for WebExpiringUserTargetItem
type WebExpiringUserTargetItem struct {
...
func NewWebExpiringUserTargetItem() *WebExpiringUserTargetItem {
	this := WebExpiringUserTargetItem{}
	return &this
}
...
// and a boolean to check if the value has been set.
func (o *WebExpiringUserTargetItem) GetVariationIdOk() (*string, bool) {
	if o == nil || o.VariationId == nil {
		return nil, false
	}
...
func (o WebExpiringUserTargetItem) MarshalJSON() ([]byte, error) {
...
type NullableWebExpiringUserTargetItem struct {
	value *WebExpiringUserTargetItem
	isSet bool
}

func (v NullableWebExpiringUserTargetItem) Get() *WebExpiringUserTargetItem {
	return v.value
}

func (v *NullableWebExpiringUserTargetItem) Set(val *WebExpiringUserTargetItem) {
	v.value = val
	v.isSet = true
}

func (v NullableWebExpiringUserTargetItem) IsSet() bool {
	return v.isSet
}

func (v *NullableWebExpiringUserTargetItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebExpiringUserTargetItem(val *WebExpiringUserTargetItem) *NullableWebExpiringUserTargetItem {
	return &NullableWebExpiringUserTargetItem{value: val, isSet: true}
}

func (v NullableWebExpiringUserTargetItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebExpiringUserTargetItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
