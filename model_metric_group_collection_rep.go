...
// checks if the MetricGroupCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricGroupCollectionRep{}
...
type _MetricGroupCollectionRep MetricGroupCollectionRep
...
func (o MetricGroupCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *MetricGroupCollectionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varMetricGroupCollectionRep := _MetricGroupCollectionRep{}

	err = json.Unmarshal(data, &varMetricGroupCollectionRep)

	if err != nil {
		return err
	}

	*o = MetricGroupCollectionRep(varMetricGroupCollectionRep)
