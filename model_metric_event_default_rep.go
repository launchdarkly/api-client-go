...
// checks if the MetricEventDefaultRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricEventDefaultRep{}

// MetricEventDefaultRep struct for MetricEventDefaultRep
type MetricEventDefaultRep struct {
...
type _MetricEventDefaultRep MetricEventDefaultRep
...
func (o MetricEventDefaultRep) ToMap() (map[string]interface{}, error) {
...
func (o *MetricEventDefaultRep) UnmarshalJSON(data []byte) (err error) {
	varMetricEventDefaultRep := _MetricEventDefaultRep{}

	err = json.Unmarshal(data, &varMetricEventDefaultRep)

	if err != nil {
		return err
	}

	*o = MetricEventDefaultRep(varMetricEventDefaultRep)
...
func NewNullableMetricEventDefaultRep(val *MetricEventDefaultRep) *NullableMetricEventDefaultRep {
	return &NullableMetricEventDefaultRep{value: val, isSet: true}
}
