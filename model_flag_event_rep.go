...
// checks if the FlagEventRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagEventRep{}
...
type _FlagEventRep FlagEventRep
...
func (o *FlagEventRep) GetAuditLogEntryId() string {
	if o == nil || IsNil(o.AuditLogEntryId) {
		var ret string
		return ret
	}
...
func (o FlagEventRep) ToMap() (map[string]interface{}, error) {
...
func (o *FlagEventRep) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagEventRep := _FlagEventRep{}

	err = json.Unmarshal(data, &varFlagEventRep)

	if err != nil {
		return err
	}

	*o = FlagEventRep(varFlagEventRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "auditLogEntryId")
