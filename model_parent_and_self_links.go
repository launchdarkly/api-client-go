...
// checks if the ParentAndSelfLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParentAndSelfLinks{}

// ParentAndSelfLinks The location and content type of related resources
type ParentAndSelfLinks struct {
	Self CoreLink `json:"self"`
	Parent CoreLink `json:"parent"`
	AdditionalProperties map[string]interface{}
}

type _ParentAndSelfLinks ParentAndSelfLinks
...
func (o ParentAndSelfLinks) MarshalJSON() ([]byte, error) {
...
func (o ParentAndSelfLinks) ToMap() (map[string]interface{}, error) {
...
func (o *ParentAndSelfLinks) UnmarshalJSON(data []byte) (err error) {
	...
	varParentAndSelfLinks := _ParentAndSelfLinks{}

	err = json.Unmarshal(data, &varParentAndSelfLinks)

	if err != nil {
		return err
	}

	*o = ParentAndSelfLinks(varParentAndSelfLinks)
...
type NullableParentAndSelfLinks struct {
	value *ParentAndSelfLinks
	isSet bool
}

func (v NullableParentAndSelfLinks) Get() *ParentAndSelfLinks {
	return v.value
}

func (v *NullableParentAndSelfLinks) Set(val *ParentAndSelfLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableParentAndSelfLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableParentAndSelfLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableParentAndSelfLinks(val *ParentAndSelfLinks) *NullableParentAndSelfLinks {
	return &NullableParentAndSelfLinks{value: val, isSet: true}
}

func (v NullableParentAndSelfLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableParentAndSelfLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
