...
// checks if the AnnouncementLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnnouncementLink{}

// AnnouncementLink struct for AnnouncementLink
...
type _AnnouncementLink AnnouncementLink
...
func (o AnnouncementLink) MarshalJSON() ([]byte, error) {
...
func (o AnnouncementLink) ToMap() (map[string]interface{}, error) {
...
func (o *AnnouncementLink) UnmarshalJSON(data []byte) (err error) {
	varAnnouncementLink := _AnnouncementLink{}

	err = json.Unmarshal(data, &varAnnouncementLink)

	if err != nil {
		return err
	}

	*o = AnnouncementLink(varAnnouncementLink)
...
type NullableAnnouncementLink struct {
	value *AnnouncementLink
	isSet bool
}

func (v NullableAnnouncementLink) Get() *AnnouncementLink {
	return v.value
}

func (v *NullableAnnouncementLink) Set(val *AnnouncementLink) {
	v.value = val
	v.isSet = true
}

func (v NullableAnnouncementLink) IsSet() bool {
	return v.isSet
}

func (v *NullableAnnouncementLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnnouncementLink(val *AnnouncementLink) *NullableAnnouncementLink {
	return &NullableAnnouncementLink{value: val, isSet: true}
}

func (v NullableAnnouncementLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnnouncementLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
