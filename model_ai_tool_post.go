...
// checks if the AIToolPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIToolPost{}

// AIToolPost struct for AIToolPost
type AIToolPost struct {
	Key string `json:"key"`
...
func (o *AIToolPost) GetTags() []string {
...
// and a boolean to check if the value has been set.
func (o *AIToolPost) GetTagsOk() ([]string, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *AIToolPost) HasTags() bool {
	if o != nil && !IsNil(o.Tags) {
		return true
	}
...
func (o *AIToolPost) SetTags(v []string) {
	o.Tags = v
}
...
func (o AIToolPost) ToMap() (map[string]interface{}, error) {
...
func (o *AIToolPost) UnmarshalJSON(data []byte) (err error) {
	...
	varAIToolPost := _AIToolPost{}

	err = json.Unmarshal(data, &varAIToolPost)

	if err != nil {
		return err
	}

	*o = AIToolPost(varAIToolPost)
...
type NullableAIToolPost struct {
	value *AIToolPost
	isSet bool
}

func (v NullableAIToolPost) Get() *AIToolPost {
	return v.value
}

func (v *NullableAIToolPost) Set(val *AIToolPost) {
	v.value = val
	v.isSet = true
}

func (v NullableAIToolPost) IsSet() bool {
	return v.isSet
}

func (v *NullableAIToolPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIToolPost(val *AIToolPost) *NullableAIToolPost {
	return &NullableAIToolPost{value: val, isSet: true}
}

func (v NullableAIToolPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIToolPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
