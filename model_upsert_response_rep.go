...
// checks if the UpsertResponseRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpsertResponseRep{}

// UpsertResponseRep struct for UpsertResponseRep
type UpsertResponseRep struct {
...
type _UpsertResponseRep UpsertResponseRep
...
func (o UpsertResponseRep) ToMap() (map[string]interface{}, error) {
...
func (o *UpsertResponseRep) UnmarshalJSON(data []byte) (err error) {
	varUpsertResponseRep := _UpsertResponseRep{}

	err = json.Unmarshal(data, &varUpsertResponseRep)

	if err != nil {
		return err
	}

	*o = UpsertResponseRep(varUpsertResponseRep)
...
func NewNullableUpsertResponseRep(val *UpsertResponseRep) *NullableUpsertResponseRep {
	return &NullableUpsertResponseRep{value: val, isSet: true}
}
