...
// checks if the ExpandedLinkedResourcesSegments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedLinkedResourcesSegments{}

// ExpandedLinkedResourcesSegments struct for ExpandedLinkedResourcesSegments
type ExpandedLinkedResourcesSegments struct {
	Items []ExpandedSegment `json:"items"`
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _ExpandedLinkedResourcesSegments ExpandedLinkedResourcesSegments
...
func NewExpandedLinkedResourcesSegments(items []ExpandedSegment, totalCount int32) *ExpandedLinkedResourcesSegments {
	this := ExpandedLinkedResourcesSegments{}
	this.Items = items
...
func (o ExpandedLinkedResourcesSegments) MarshalJSON() ([]byte, error) {
...
func (o ExpandedLinkedResourcesSegments) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedLinkedResourcesSegments) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedLinkedResourcesSegments := _ExpandedLinkedResourcesSegments{}

	err = json.Unmarshal(data, &varExpandedLinkedResourcesSegments)

	if err != nil {
		return err
	}

	*o = ExpandedLinkedResourcesSegments(varExpandedLinkedResourcesSegments)
...
type NullableExpandedLinkedResourcesSegments struct {
	value *ExpandedLinkedResourcesSegments
	isSet bool
}

func (v NullableExpandedLinkedResourcesSegments) Get() *ExpandedLinkedResourcesSegments {
	return v.value
}

func (v *NullableExpandedLinkedResourcesSegments) Set(val *ExpandedLinkedResourcesSegments) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedLinkedResourcesSegments) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedLinkedResourcesSegments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedLinkedResourcesSegments(val *ExpandedLinkedResourcesSegments) *NullableExpandedLinkedResourcesSegments {
	return &NullableExpandedLinkedResourcesSegments{value: val, isSet: true}
}

func (v NullableExpandedLinkedResourcesSegments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedLinkedResourcesSegments) UnmarshalJSON(src []byte) error {
	v.isSet = true
