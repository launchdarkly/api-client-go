...
// checks if the MigrationSafetyIssueRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MigrationSafetyIssueRep{}
...
type _MigrationSafetyIssueRep MigrationSafetyIssueRep
...
func (o *MigrationSafetyIssueRep) GetCausingRuleId() string {
	if o == nil || IsNil(o.CausingRuleId) {
		var ret string
		return ret
	}
...
func (o *MigrationSafetyIssueRep) GetAffectedRuleIds() []string {
	if o == nil || IsNil(o.AffectedRuleIds) {
		var ret []string
		return ret
	}
...
func (o *MigrationSafetyIssueRep) GetOldSystemAffected() bool {
	if o == nil || IsNil(o.OldSystemAffected) {
		var ret bool
		return ret
	}
...
func (o MigrationSafetyIssueRep) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.CausingRuleId) {
		toSerialize["causingRuleId"] = o.CausingRuleId
	}
	if !IsNil(o.AffectedRuleIds) {
		toSerialize["affectedRuleIds"] = o.AffectedRuleIds
	}
	if !IsNil(o.Issue) {
		toSerialize["issue"] = o.Issue
	}
	if !IsNil(o.OldSystemAffected) {
...
func (o *MigrationSafetyIssueRep) UnmarshalJSON(data []byte) (err error) {
	varMigrationSafetyIssueRep := _MigrationSafetyIssueRep{}

	err = json.Unmarshal(data, &varMigrationSafetyIssueRep)

	if err != nil {
		return err
	}

	*o = MigrationSafetyIssueRep(varMigrationSafetyIssueRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "causingRuleId")
		delete(additionalProperties, "affectedRuleIds")
		delete(additionalProperties, "issue")
		delete(additionalProperties, "oldSystemAffected")
