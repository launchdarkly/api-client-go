...
// checks if the MemberImportItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MemberImportItem{}
...
type _MemberImportItem MemberImportItem
...
func (o MemberImportItem) ToMap() (map[string]interface{}, error) {
...
func (o *MemberImportItem) UnmarshalJSON(data []byte) (err error) {
	...
	varMemberImportItem := _MemberImportItem{}

	err = json.Unmarshal(data, &varMemberImportItem)

	if err != nil {
		return err
	}

	*o = MemberImportItem(varMemberImportItem)
