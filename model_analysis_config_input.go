...
// checks if the AnalysisConfigInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnalysisConfigInput{}

// AnalysisConfigInput struct for AnalysisConfigInput
type AnalysisConfigInput struct {
	...
	BayesianThreshold *string `json:"bayesianThreshold,omitempty"`
	// The significance threshold for the frequentist results analysis approach.
	SignificanceThreshold *string `json:"significanceThreshold,omitempty"`
	...
	MultipleComparisonCorrectionMethod *string `json:"multipleComparisonCorrectionMethod,omitempty"`
	// The scope of the multiple comparison correction.
	MultipleComparisonCorrectionScope *string `json:"multipleComparisonCorrectionScope,omitempty"`
	// Whether sequential testing is enabled for Frequentist analysis
	SequentialTestingEnabled *bool `json:"sequentialTestingEnabled,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AnalysisConfigInput AnalysisConfigInput
...
// GetBayesianThreshold returns the BayesianThreshold field value if set, zero value otherwise.
func (o *AnalysisConfigInput) GetBayesianThreshold() string {
	if o == nil || IsNil(o.BayesianThreshold) {
		var ret string
		return ret
	}
	return *o.BayesianThreshold
}

// GetBayesianThresholdOk returns a tuple with the BayesianThreshold field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AnalysisConfigInput) GetBayesianThresholdOk() (*string, bool) {
	if o == nil || IsNil(o.BayesianThreshold) {
		return nil, false
	}
	return o.BayesianThreshold, true
}
...
// SetBayesianThreshold gets a reference to the given string and assigns it to the BayesianThreshold field.
func (o *AnalysisConfigInput) SetBayesianThreshold(v string) {
	o.BayesianThreshold = &v
}
...
// SetSignificanceThreshold gets a reference to the given string and assigns it to the SignificanceThreshold field.
func (o *AnalysisConfigInput) SetSignificanceThreshold(v string) {
	o.SignificanceThreshold = &v
}

// GetTestDirection returns the TestDirection field value if set, zero value otherwise.
func (o *AnalysisConfigInput) GetTestDirection() string {
	if o == nil || IsNil(o.TestDirection) {
		var ret string
		return ret
	}
	return *o.TestDirection
}

// GetTestDirectionOk returns a tuple with the TestDirection field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AnalysisConfigInput) GetTestDirectionOk() (*string, bool) {
	if o == nil || IsNil(o.TestDirection) {
		return nil, false
	}
	return o.TestDirection, true
}
...
// SetTestDirection gets a reference to the given string and assigns it to the TestDirection field.
func (o *AnalysisConfigInput) SetTestDirection(v string) {
	o.TestDirection = &v
}

// GetMultipleComparisonCorrectionMethod returns the MultipleComparisonCorrectionMethod field value if set, zero value otherwise.
func (o *AnalysisConfigInput) GetMultipleComparisonCorrectionMethod() string {
	if o == nil || IsNil(o.MultipleComparisonCorrectionMethod) {
		var ret string
		return ret
	}
	return *o.MultipleComparisonCorrectionMethod
}

// GetMultipleComparisonCorrectionMethodOk returns a tuple with the MultipleComparisonCorrectionMethod field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AnalysisConfigInput) GetMultipleComparisonCorrectionMethodOk() (*string, bool) {
	if o == nil || IsNil(o.MultipleComparisonCorrectionMethod) {
		return nil, false
	}
	return o.MultipleComparisonCorrectionMethod, true
}
...
// SetMultipleComparisonCorrectionMethod gets a reference to the given string and assigns it to the MultipleComparisonCorrectionMethod field.
func (o *AnalysisConfigInput) SetMultipleComparisonCorrectionMethod(v string) {
	o.MultipleComparisonCorrectionMethod = &v
}

// GetMultipleComparisonCorrectionScope returns the MultipleComparisonCorrectionScope field value if set, zero value otherwise.
func (o *AnalysisConfigInput) GetMultipleComparisonCorrectionScope() string {
	if o == nil || IsNil(o.MultipleComparisonCorrectionScope) {
		var ret string
		return ret
	}
	return *o.MultipleComparisonCorrectionScope
}

// GetMultipleComparisonCorrectionScopeOk returns a tuple with the MultipleComparisonCorrectionScope field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AnalysisConfigInput) GetMultipleComparisonCorrectionScopeOk() (*string, bool) {
	if o == nil || IsNil(o.MultipleComparisonCorrectionScope) {
		return nil, false
	}
	return o.MultipleComparisonCorrectionScope, true
}
...
// SetMultipleComparisonCorrectionScope gets a reference to the given string and assigns it to the MultipleComparisonCorrectionScope field.
func (o *AnalysisConfigInput) SetMultipleComparisonCorrectionScope(v string) {
	o.MultipleComparisonCorrectionScope = &v
}

// GetSequentialTestingEnabled returns the SequentialTestingEnabled field value if set, zero value otherwise.
func (o *AnalysisConfigInput) GetSequentialTestingEnabled() bool {
	if o == nil || IsNil(o.SequentialTestingEnabled) {
		var ret bool
		return ret
	}
	return *o.SequentialTestingEnabled
}

// GetSequentialTestingEnabledOk returns a tuple with the SequentialTestingEnabled field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AnalysisConfigInput) GetSequentialTestingEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.SequentialTestingEnabled) {
		return nil, false
	}
	return o.SequentialTestingEnabled, true
}
...
// SetSequentialTestingEnabled gets a reference to the given bool and assigns it to the SequentialTestingEnabled field.
func (o *AnalysisConfigInput) SetSequentialTestingEnabled(v bool) {
	o.SequentialTestingEnabled = &v
}

func (o AnalysisConfigInput) MarshalJSON() ([]byte, error) {
...
func (o AnalysisConfigInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.BayesianThreshold) {
		toSerialize["bayesianThreshold"] = o.BayesianThreshold
	}
	if !IsNil(o.SignificanceThreshold) {
		toSerialize["significanceThreshold"] = o.SignificanceThreshold
	}
	if !IsNil(o.TestDirection) {
		toSerialize["testDirection"] = o.TestDirection
	}
	if !IsNil(o.MultipleComparisonCorrectionMethod) {
		toSerialize["multipleComparisonCorrectionMethod"] = o.MultipleComparisonCorrectionMethod
	}
	if !IsNil(o.MultipleComparisonCorrectionScope) {
		toSerialize["multipleComparisonCorrectionScope"] = o.MultipleComparisonCorrectionScope
	}
	if !IsNil(o.SequentialTestingEnabled) {
		toSerialize["sequentialTestingEnabled"] = o.SequentialTestingEnabled
	}
...
func (o *AnalysisConfigInput) UnmarshalJSON(data []byte) (err error) {
	varAnalysisConfigInput := _AnalysisConfigInput{}

	err = json.Unmarshal(data, &varAnalysisConfigInput)

	if err != nil {
		return err
	}

	*o = AnalysisConfigInput(varAnalysisConfigInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "bayesianThreshold")
		delete(additionalProperties, "significanceThreshold")
		delete(additionalProperties, "testDirection")
		delete(additionalProperties, "multipleComparisonCorrectionMethod")
		delete(additionalProperties, "multipleComparisonCorrectionScope")
		delete(additionalProperties, "sequentialTestingEnabled")
...
type NullableAnalysisConfigInput struct {
	value *AnalysisConfigInput
	isSet bool
}

func (v NullableAnalysisConfigInput) Get() *AnalysisConfigInput {
	return v.value
}

func (v *NullableAnalysisConfigInput) Set(val *AnalysisConfigInput) {
	v.value = val
	v.isSet = true
}

func (v NullableAnalysisConfigInput) IsSet() bool {
	return v.isSet
}

func (v *NullableAnalysisConfigInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnalysisConfigInput(val *AnalysisConfigInput) *NullableAnalysisConfigInput {
	return &NullableAnalysisConfigInput{value: val, isSet: true}
}

func (v NullableAnalysisConfigInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnalysisConfigInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
