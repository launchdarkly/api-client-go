...
// checks if the RepositoryRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RepositoryRep{}
...
type _RepositoryRep RepositoryRep
...
func (o RepositoryRep) ToMap() (map[string]interface{}, error) {
...
func (o *RepositoryRep) UnmarshalJSON(data []byte) (err error) {
	...
	varRepositoryRep := _RepositoryRep{}

	err = json.Unmarshal(data, &varRepositoryRep)

	if err != nil {
		return err
	}

	*o = RepositoryRep(varRepositoryRep)
