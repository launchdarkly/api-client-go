...
// checks if the SdkListRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdkListRep{}
...
func (o SdkListRep) ToMap() (map[string]interface{}, error) {
...
func (o *SdkListRep) UnmarshalJSON(data []byte) (err error) {
	...
	varSdkListRep := _SdkListRep{}

	err = json.Unmarshal(data, &varSdkListRep)

	if err != nil {
		return err
	}

	*o = SdkListRep(varSdkListRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "_links")
		delete(additionalProperties, "sdks")
