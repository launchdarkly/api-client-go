...
// checks if the FeatureFlagBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeatureFlagBody{}
...
type FeatureFlagBody struct {
	...
	IsFlagOn *bool `json:"isFlagOn,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _FeatureFlagBody FeatureFlagBody
...
func (o *FeatureFlagBody) GetIncludeInSnippet() bool {
	if o == nil || IsNil(o.IncludeInSnippet) {
		var ret bool
		return ret
	}
...
func (o *FeatureFlagBody) GetClientSideAvailability() ClientSideAvailabilityPost {
	if o == nil || IsNil(o.ClientSideAvailability) {
...
func (o *FeatureFlagBody) GetMigrationSettings() MigrationSettingsPost {
	if o == nil || IsNil(o.MigrationSettings) {
...
func (o *FeatureFlagBody) GetInitialPrerequisites() []FlagPrerequisitePost {
	if o == nil || IsNil(o.InitialPrerequisites) {
...
// GetIsFlagOn returns the IsFlagOn field value if set, zero value otherwise.
func (o *FeatureFlagBody) GetIsFlagOn() bool {
	if o == nil || IsNil(o.IsFlagOn) {
		var ret bool
		return ret
	}
	return *o.IsFlagOn
...
// GetIsFlagOnOk returns a tuple with the IsFlagOn field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FeatureFlagBody) GetIsFlagOnOk() (*bool, bool) {
	if o == nil || IsNil(o.IsFlagOn) {
		return nil, false
	}
	return o.IsFlagOn, true
}
...
// SetIsFlagOn gets a reference to the given bool and assigns it to the IsFlagOn field.
...
func (o FeatureFlagBody) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ClientSideAvailability) {
	...
	if !IsNil(o.InitialPrerequisites) {
		toSerialize["initialPrerequisites"] = o.InitialPrerequisites
	}
	if !IsNil(o.IsFlagOn) {
		toSerialize["isFlagOn"] = o.IsFlagOn
	}
...
func (o *FeatureFlagBody) UnmarshalJSON(data []byte) (err error) {
	...
	varFeatureFlagBody := _FeatureFlagBody{}

	err = json.Unmarshal(data, &varFeatureFlagBody)

	if err != nil {
		return err
	}

	*o = FeatureFlagBody(varFeatureFlagBody)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "clientSideAvailability")
		...
		delete(additionalProperties, "migrationSettings")
		delete(additionalProperties, "maintainerId")
		delete(additionalProperties, "maintainerTeamKey")
		delete(additionalProperties, "initialPrerequisites")
		delete(additionalProperties, "isFlagOn")
