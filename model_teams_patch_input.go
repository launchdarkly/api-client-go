...
// checks if the TeamsPatchInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamsPatchInput{}
...
type _TeamsPatchInput TeamsPatchInput
...
func (o TeamsPatchInput) ToMap() (map[string]interface{}, error) {
...
func (o *TeamsPatchInput) UnmarshalJSON(data []byte) (err error) {
	...
	varTeamsPatchInput := _TeamsPatchInput{}

	err = json.Unmarshal(data, &varTeamsPatchInput)

	if err != nil {
		return err
	}

	*o = TeamsPatchInput(varTeamsPatchInput)
...
func NewNullableTeamsPatchInput(val *TeamsPatchInput) *NullableTeamsPatchInput {
	return &NullableTeamsPatchInput{value: val, isSet: true}
}
