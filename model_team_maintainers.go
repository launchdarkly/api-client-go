...
// checks if the TeamMaintainers type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamMaintainers{}
...
type _TeamMaintainers TeamMaintainers
...
func (o TeamMaintainers) ToMap() (map[string]interface{}, error) {
...
func (o *TeamMaintainers) UnmarshalJSON(data []byte) (err error) {
	varTeamMaintainers := _TeamMaintainers{}

	err = json.Unmarshal(data, &varTeamMaintainers)

	if err != nil {
		return err
	}

	*o = TeamMaintainers(varTeamMaintainers)
