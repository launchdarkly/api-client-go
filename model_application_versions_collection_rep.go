...
// checks if the ApplicationVersionsCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationVersionsCollectionRep{}
...
type _ApplicationVersionsCollectionRep ApplicationVersionsCollectionRep
...
func (o ApplicationVersionsCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationVersionsCollectionRep) UnmarshalJSON(data []byte) (err error) {
	varApplicationVersionsCollectionRep := _ApplicationVersionsCollectionRep{}

	err = json.Unmarshal(data, &varApplicationVersionsCollectionRep)

	if err != nil {
		return err
	}

	*o = ApplicationVersionsCollectionRep(varApplicationVersionsCollectionRep)
