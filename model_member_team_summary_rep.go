...
// checks if the MemberTeamSummaryRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MemberTeamSummaryRep{}
...
type _MemberTeamSummaryRep MemberTeamSummaryRep
...
func (o MemberTeamSummaryRep) ToMap() (map[string]interface{}, error) {
...
func (o *MemberTeamSummaryRep) UnmarshalJSON(data []byte) (err error) {
	...
	varMemberTeamSummaryRep := _MemberTeamSummaryRep{}

	err = json.Unmarshal(data, &varMemberTeamSummaryRep)

	if err != nil {
		return err
	}

	*o = MemberTeamSummaryRep(varMemberTeamSummaryRep)
