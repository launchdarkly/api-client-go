...
// checks if the ExpandableApprovalRequestsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandableApprovalRequestsResponse{}
...
type _ExpandableApprovalRequestsResponse ExpandableApprovalRequestsResponse
...
func (o ExpandableApprovalRequestsResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandableApprovalRequestsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandableApprovalRequestsResponse := _ExpandableApprovalRequestsResponse{}

	err = json.Unmarshal(data, &varExpandableApprovalRequestsResponse)

	if err != nil {
		return err
	}

	*o = ExpandableApprovalRequestsResponse(varExpandableApprovalRequestsResponse)
