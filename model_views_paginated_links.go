...
// checks if the ViewsPaginatedLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewsPaginatedLinks{}

// ViewsPaginatedLinks struct for ViewsPaginatedLinks
type ViewsPaginatedLinks struct {
	First *ViewsLink `json:"first,omitempty"`
	Last *ViewsLink `json:"last,omitempty"`
	Next *ViewsLink `json:"next,omitempty"`
	Prev *ViewsLink `json:"prev,omitempty"`
	Self ViewsLink `json:"self"`
	AdditionalProperties map[string]interface{}
}

type _ViewsPaginatedLinks ViewsPaginatedLinks
...
// SetFirst gets a reference to the given ViewsLink and assigns it to the First field.
...
// SetLast gets a reference to the given ViewsLink and assigns it to the Last field.
...
// SetNext gets a reference to the given ViewsLink and assigns it to the Next field.
...
// SetPrev gets a reference to the given ViewsLink and assigns it to the Prev field.
...
func (o ViewsPaginatedLinks) MarshalJSON() ([]byte, error) {
...
func (o ViewsPaginatedLinks) ToMap() (map[string]interface{}, error) {
...
func (o *ViewsPaginatedLinks) UnmarshalJSON(data []byte) (err error) {
	...
	varViewsPaginatedLinks := _ViewsPaginatedLinks{}

	err = json.Unmarshal(data, &varViewsPaginatedLinks)

	if err != nil {
		return err
	}

	*o = ViewsPaginatedLinks(varViewsPaginatedLinks)
...
type NullableViewsPaginatedLinks struct {
	value *ViewsPaginatedLinks
	isSet bool
}

func (v NullableViewsPaginatedLinks) Get() *ViewsPaginatedLinks {
	return v.value
}

func (v *NullableViewsPaginatedLinks) Set(val *ViewsPaginatedLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableViewsPaginatedLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableViewsPaginatedLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewsPaginatedLinks(val *ViewsPaginatedLinks) *NullableViewsPaginatedLinks {
	return &NullableViewsPaginatedLinks{value: val, isSet: true}
}

func (v NullableViewsPaginatedLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewsPaginatedLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
