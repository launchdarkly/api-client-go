...
// checks if the DefaultClientSideAvailability type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DefaultClientSideAvailability{}
...
type _DefaultClientSideAvailability DefaultClientSideAvailability
...
func NewDefaultClientSideAvailability(usingMobileKey bool, usingEnvironmentId bool) *DefaultClientSideAvailability {
	this := DefaultClientSideAvailability{}
...
// GetUsingMobileKeyOk returns a tuple with the UsingMobileKey field value
...
// GetUsingEnvironmentIdOk returns a tuple with the UsingEnvironmentId field value
// and a boolean to check if the value has been set.
...
func (o DefaultClientSideAvailability) ToMap() (map[string]interface{}, error) {
...
func (o *DefaultClientSideAvailability) UnmarshalJSON(data []byte) (err error) {
	...
	varDefaultClientSideAvailability := _DefaultClientSideAvailability{}

	err = json.Unmarshal(data, &varDefaultClientSideAvailability)

	if err != nil {
		return err
	}

	*o = DefaultClientSideAvailability(varDefaultClientSideAvailability)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "usingMobileKey")
		delete(additionalProperties, "usingEnvironmentId")
...
type NullableDefaultClientSideAvailability struct {
	value *DefaultClientSideAvailability
	isSet bool
}
...
func NewNullableDefaultClientSideAvailability(val *DefaultClientSideAvailability) *NullableDefaultClientSideAvailability {
	return &NullableDefaultClientSideAvailability{value: val, isSet: true}
}
