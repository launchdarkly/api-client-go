...
type _SegmentMetadata SegmentMetadata
...
func (o *SegmentMetadata) UnmarshalJSON(data []byte) (err error) {
	varSegmentMetadata := _SegmentMetadata{}

	err = json.Unmarshal(data, &varSegmentMetadata)

	if err != nil {
		return err
	}

	*o = SegmentMetadata(varSegmentMetadata)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "envId")
		delete(additionalProperties, "segmentId")
		delete(additionalProperties, "version")
		delete(additionalProperties, "includedCount")
		delete(additionalProperties, "excludedCount")
