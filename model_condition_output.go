...
// checks if the ConditionOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConditionOutput{}
...
type ConditionOutput struct {
	...
	CreationConfig map[string]interface{} `json:"creationConfig,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ConditionOutput ConditionOutput
...
func (o *ConditionOutput) GetWaitDurationUnit() string {
	if o == nil || IsNil(o.WaitDurationUnit) {
		var ret string
		return ret
	}
...
// GetCreationConfig returns the CreationConfig field value if set, zero value otherwise.
func (o *ConditionOutput) GetCreationConfig() map[string]interface{} {
	if o == nil || IsNil(o.CreationConfig) {
		var ret map[string]interface{}
		return ret
	}
	return o.CreationConfig
}

// GetCreationConfigOk returns a tuple with the CreationConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ConditionOutput) GetCreationConfigOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.CreationConfig) {
		return map[string]interface{}{}, false
	}
	return o.CreationConfig, true
}
...
// SetCreationConfig gets a reference to the given map[string]interface{} and assigns it to the CreationConfig field.
...
func (o ConditionOutput) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CreationConfig) {
		toSerialize["creationConfig"] = o.CreationConfig
	}
...
func (o *ConditionOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varConditionOutput := _ConditionOutput{}

	err = json.Unmarshal(data, &varConditionOutput)

	if err != nil {
		return err
	}

	*o = ConditionOutput(varConditionOutput)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_execution")
		delete(additionalProperties, "scheduleKind")
		delete(additionalProperties, "executionDate")
		delete(additionalProperties, "waitDuration")
		delete(additionalProperties, "waitDurationUnit")
		...
		delete(additionalProperties, "creationConfig")
