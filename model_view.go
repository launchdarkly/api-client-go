...
type View struct {
	Access *ViewsAccessRep `json:"_access,omitempty"`
	...
	AffectsSdkPayload bool `json:"_affectsSdkPayload"`
	...
	FlagsSummary *FlagsSummary `json:"flagsSummary,omitempty"`
	SegmentsSummary *SegmentsSummary `json:"segmentsSummary,omitempty"`
	MetricsSummary *MetricsSummary `json:"metricsSummary,omitempty"`
	AiConfigsSummary *AIConfigsSummary `json:"aiConfigsSummary,omitempty"`
	ResourceSummary *ResourceSummary `json:"resourceSummary,omitempty"`
	FlagsExpanded *ExpandedLinkedFlags `json:"flagsExpanded,omitempty"`
	SegmentsExpanded *ExpandedLinkedSegments `json:"segmentsExpanded,omitempty"`
	MetricsExpanded *ExpandedLinkedMetrics `json:"metricsExpanded,omitempty"`
	AiConfigsExpanded *ExpandedLinkedAIConfigs `json:"aiConfigsExpanded,omitempty"`
	ResourcesExpanded *ExpandedLinkedResources `json:"resourcesExpanded,omitempty"`
...
// SetAccess gets a reference to the given ViewsAccessRep and assigns it to the Access field.
...
// GetAffectsSdkPayload returns the AffectsSdkPayload field value
func (o *View) GetAffectsSdkPayload() bool {
	...
	return o.AffectsSdkPayload
}

// GetAffectsSdkPayloadOk returns a tuple with the AffectsSdkPayload field value
// and a boolean to check if the value has been set.
func (o *View) GetAffectsSdkPayloadOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.AffectsSdkPayload, true
}

// SetAffectsSdkPayload sets field value
func (o *View) SetAffectsSdkPayload(v bool) {
	o.AffectsSdkPayload = v
}

// GetGenerateSdkKeys returns the GenerateSdkKeys field value if set, zero value otherwise.
// Deprecated
func (o *View) GetGenerateSdkKeys() bool {
	if o == nil || IsNil(o.GenerateSdkKeys) {
		var ret bool
		return ret
	}
	return *o.GenerateSdkKeys
}

// GetGenerateSdkKeysOk returns a tuple with the GenerateSdkKeys field value if set, nil otherwise
// and a boolean to check if the value has been set.
// Deprecated
...
// SetGenerateSdkKeys gets a reference to the given bool and assigns it to the GenerateSdkKeys field.
// Deprecated
...
// SetDeletedAt gets a reference to the given int64 and assigns it to the DeletedAt field.
...
// SetMaintainer gets a reference to the given Maintainer and assigns it to the Maintainer field.
func (o *View) SetMaintainer(v Maintainer) {
	o.Maintainer = &v
}

// GetFlagsSummary returns the FlagsSummary field value if set, zero value otherwise.
func (o *View) GetFlagsSummary() FlagsSummary {
	if o == nil || IsNil(o.FlagsSummary) {
		var ret FlagsSummary
		return ret
	}
	return *o.FlagsSummary
}

// GetFlagsSummaryOk returns a tuple with the FlagsSummary field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *View) GetFlagsSummaryOk() (*FlagsSummary, bool) {
	if o == nil || IsNil(o.FlagsSummary) {
		return nil, false
	}
	return o.FlagsSummary, true
}
...
// SetFlagsSummary gets a reference to the given FlagsSummary and assigns it to the FlagsSummary field.
func (o *View) SetFlagsSummary(v FlagsSummary) {
	o.FlagsSummary = &v
}

// GetSegmentsSummary returns the SegmentsSummary field value if set, zero value otherwise.
func (o *View) GetSegmentsSummary() SegmentsSummary {
	if o == nil || IsNil(o.SegmentsSummary) {
		var ret SegmentsSummary
		return ret
	}
	return *o.SegmentsSummary
}

// GetSegmentsSummaryOk returns a tuple with the SegmentsSummary field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *View) GetSegmentsSummaryOk() (*SegmentsSummary, bool) {
	if o == nil || IsNil(o.SegmentsSummary) {
		return nil, false
	}
	return o.SegmentsSummary, true
}
...
// SetSegmentsSummary gets a reference to the given SegmentsSummary and assigns it to the SegmentsSummary field.
func (o *View) SetSegmentsSummary(v SegmentsSummary) {
	o.SegmentsSummary = &v
}

// GetMetricsSummary returns the MetricsSummary field value if set, zero value otherwise.
func (o *View) GetMetricsSummary() MetricsSummary {
	if o == nil || IsNil(o.MetricsSummary) {
...
// GetMetricsSummaryOk returns a tuple with the MetricsSummary field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *View) GetMetricsSummaryOk() (*MetricsSummary, bool) {
	if o == nil || IsNil(o.MetricsSummary) {
		return nil, false
	}
	return o.MetricsSummary, true
}
...
// SetMetricsSummary gets a reference to the given MetricsSummary and assigns it to the MetricsSummary field.
func (o *View) SetMetricsSummary(v MetricsSummary) {
	o.MetricsSummary = &v
}

// GetAiConfigsSummary returns the AiConfigsSummary field value if set, zero value otherwise.
func (o *View) GetAiConfigsSummary() AIConfigsSummary {
	if o == nil || IsNil(o.AiConfigsSummary) {
		var ret AIConfigsSummary
		return ret
	}
	return *o.AiConfigsSummary
}

// GetAiConfigsSummaryOk returns a tuple with the AiConfigsSummary field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *View) GetAiConfigsSummaryOk() (*AIConfigsSummary, bool) {
	if o == nil || IsNil(o.AiConfigsSummary) {
		return nil, false
	}
	return o.AiConfigsSummary, true
}
...
// SetAiConfigsSummary gets a reference to the given AIConfigsSummary and assigns it to the AiConfigsSummary field.
func (o *View) SetAiConfigsSummary(v AIConfigsSummary) {
	o.AiConfigsSummary = &v
}
...
// GetFlagsExpanded returns the FlagsExpanded field value if set, zero value otherwise.
func (o *View) GetFlagsExpanded() ExpandedLinkedFlags {
	if o == nil || IsNil(o.FlagsExpanded) {
		var ret ExpandedLinkedFlags
		return ret
	}
	return *o.FlagsExpanded
}

// GetFlagsExpandedOk returns a tuple with the FlagsExpanded field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *View) GetFlagsExpandedOk() (*ExpandedLinkedFlags, bool) {
	if o == nil || IsNil(o.FlagsExpanded) {
		return nil, false
	}
	return o.FlagsExpanded, true
}
...
// SetFlagsExpanded gets a reference to the given ExpandedLinkedFlags and assigns it to the FlagsExpanded field.
func (o *View) SetFlagsExpanded(v ExpandedLinkedFlags) {
	o.FlagsExpanded = &v
}

// GetSegmentsExpanded returns the SegmentsExpanded field value if set, zero value otherwise.
func (o *View) GetSegmentsExpanded() ExpandedLinkedSegments {
	if o == nil || IsNil(o.SegmentsExpanded) {
		var ret ExpandedLinkedSegments
		return ret
	}
	return *o.SegmentsExpanded
}

// GetSegmentsExpandedOk returns a tuple with the SegmentsExpanded field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *View) GetSegmentsExpandedOk() (*ExpandedLinkedSegments, bool) {
	if o == nil || IsNil(o.SegmentsExpanded) {
		return nil, false
	}
	return o.SegmentsExpanded, true
}
...
// SetSegmentsExpanded gets a reference to the given ExpandedLinkedSegments and assigns it to the SegmentsExpanded field.
func (o *View) SetSegmentsExpanded(v ExpandedLinkedSegments) {
	o.SegmentsExpanded = &v
}

// GetMetricsExpanded returns the MetricsExpanded field value if set, zero value otherwise.
func (o *View) GetMetricsExpanded() ExpandedLinkedMetrics {
	if o == nil || IsNil(o.MetricsExpanded) {
		var ret ExpandedLinkedMetrics
		return ret
	}
	return *o.MetricsExpanded
}

// GetMetricsExpandedOk returns a tuple with the MetricsExpanded field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *View) GetMetricsExpandedOk() (*ExpandedLinkedMetrics, bool) {
	if o == nil || IsNil(o.MetricsExpanded) {
		return nil, false
	}
	return o.MetricsExpanded, true
}
...
// SetMetricsExpanded gets a reference to the given ExpandedLinkedMetrics and assigns it to the MetricsExpanded field.
func (o *View) SetMetricsExpanded(v ExpandedLinkedMetrics) {
	o.MetricsExpanded = &v
}

// GetAiConfigsExpanded returns the AiConfigsExpanded field value if set, zero value otherwise.
func (o *View) GetAiConfigsExpanded() ExpandedLinkedAIConfigs {
	if o == nil || IsNil(o.AiConfigsExpanded) {
		var ret ExpandedLinkedAIConfigs
		return ret
	}
	return *o.AiConfigsExpanded
}

// GetAiConfigsExpandedOk returns a tuple with the AiConfigsExpanded field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *View) GetAiConfigsExpandedOk() (*ExpandedLinkedAIConfigs, bool) {
	if o == nil || IsNil(o.AiConfigsExpanded) {
		return nil, false
	}
	return o.AiConfigsExpanded, true
}
...
// SetAiConfigsExpanded gets a reference to the given ExpandedLinkedAIConfigs and assigns it to the AiConfigsExpanded field.
func (o *View) SetAiConfigsExpanded(v ExpandedLinkedAIConfigs) {
	o.AiConfigsExpanded = &v
}

// GetResourcesExpanded returns the ResourcesExpanded field value if set, zero value otherwise.
func (o *View) GetResourcesExpanded() ExpandedLinkedResources {
	if o == nil || IsNil(o.ResourcesExpanded) {
		var ret ExpandedLinkedResources
		return ret
	}
	return *o.ResourcesExpanded
}

// GetResourcesExpandedOk returns a tuple with the ResourcesExpanded field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *View) GetResourcesExpandedOk() (*ExpandedLinkedResources, bool) {
	if o == nil || IsNil(o.ResourcesExpanded) {
		return nil, false
	}
	return o.ResourcesExpanded, true
}
...
// SetResourcesExpanded gets a reference to the given ExpandedLinkedResources and assigns it to the ResourcesExpanded field.
func (o *View) SetResourcesExpanded(v ExpandedLinkedResources) {
	o.ResourcesExpanded = &v
}
...
func (o View) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["_affectsSdkPayload"] = o.AffectsSdkPayload
	if !IsNil(o.GenerateSdkKeys) {
		toSerialize["generateSdkKeys"] = o.GenerateSdkKeys
	}
	...
	if !IsNil(o.FlagsSummary) {
		toSerialize["flagsSummary"] = o.FlagsSummary
	}
	if !IsNil(o.SegmentsSummary) {
		toSerialize["segmentsSummary"] = o.SegmentsSummary
	}
	if !IsNil(o.MetricsSummary) {
		toSerialize["metricsSummary"] = o.MetricsSummary
	}
	if !IsNil(o.AiConfigsSummary) {
		toSerialize["aiConfigsSummary"] = o.AiConfigsSummary
	}
	if !IsNil(o.ResourceSummary) {
		toSerialize["resourceSummary"] = o.ResourceSummary
	}
	if !IsNil(o.FlagsExpanded) {
		toSerialize["flagsExpanded"] = o.FlagsExpanded
	}
	if !IsNil(o.SegmentsExpanded) {
		toSerialize["segmentsExpanded"] = o.SegmentsExpanded
	}
	if !IsNil(o.MetricsExpanded) {
		toSerialize["metricsExpanded"] = o.MetricsExpanded
	}
	if !IsNil(o.AiConfigsExpanded) {
		toSerialize["aiConfigsExpanded"] = o.AiConfigsExpanded
	}
	if !IsNil(o.ResourcesExpanded) {
		toSerialize["resourcesExpanded"] = o.ResourcesExpanded
	}
...
func (o *View) UnmarshalJSON(data []byte) (err error) {
	...
	*o = View(varView)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_affectsSdkPayload")
		delete(additionalProperties, "generateSdkKeys")
		...
		delete(additionalProperties, "flagsSummary")
		delete(additionalProperties, "segmentsSummary")
		delete(additionalProperties, "metricsSummary")
		delete(additionalProperties, "aiConfigsSummary")
		delete(additionalProperties, "resourceSummary")
		delete(additionalProperties, "flagsExpanded")
		delete(additionalProperties, "segmentsExpanded")
		delete(additionalProperties, "metricsExpanded")
		delete(additionalProperties, "aiConfigsExpanded")
		delete(additionalProperties, "resourcesExpanded")
