...
type View struct {
	...
	GenerateSdkKeys bool `json:"generateSdkKeys"`
...
// GetGenerateSdkKeys returns the GenerateSdkKeys field value
...
// GetGenerateSdkKeysOk returns a tuple with the GenerateSdkKeys field value
// and a boolean to check if the value has been set.
...
// SetGenerateSdkKeys sets field value
