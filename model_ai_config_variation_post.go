...
// checks if the AIConfigVariationPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigVariationPost{}
...
type AIConfigVariationPost struct {
	...
	Tools []VariationToolPost `json:"tools,omitempty"`
	...
	Skills []VariationSkillPost `json:"skills,omitempty"`
	JudgeConfiguration *JudgeConfiguration `json:"judgeConfiguration,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AIConfigVariationPost AIConfigVariationPost
...
// SetTools gets a reference to the given []VariationToolPost and assigns it to the Tools field.
func (o *AIConfigVariationPost) SetTools(v []VariationToolPost) {
	o.Tools = v
}

// GetToolKeys returns the ToolKeys field value if set, zero value otherwise.
func (o *AIConfigVariationPost) GetToolKeys() []string {
	if o == nil || IsNil(o.ToolKeys) {
		var ret []string
		return ret
	}
	return o.ToolKeys
...
// GetToolKeysOk returns a tuple with the ToolKeys field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AIConfigVariationPost) GetToolKeysOk() ([]string, bool) {
	if o == nil || IsNil(o.ToolKeys) {
		return nil, false
	}
	return o.ToolKeys, true
}
...
// SetToolKeys gets a reference to the given []string and assigns it to the ToolKeys field.
func (o *AIConfigVariationPost) SetToolKeys(v []string) {
	o.ToolKeys = v
}

// GetSkills returns the Skills field value if set, zero value otherwise.
func (o *AIConfigVariationPost) GetSkills() []VariationSkillPost {
	if o == nil || IsNil(o.Skills) {
		var ret []VariationSkillPost
		return ret
	}
	return o.Skills
}
...
// and a boolean to check if the value has been set.
func (o *AIConfigVariationPost) GetSkillsOk() ([]VariationSkillPost, bool) {
	if o == nil || IsNil(o.Skills) {
		return nil, false
	}
...
func (o *AIConfigVariationPost) HasSkills() bool {
	if o != nil && !IsNil(o.Skills) {
		return true
	}
...
// SetSkills gets a reference to the given []VariationSkillPost and assigns it to the Skills field.
func (o *AIConfigVariationPost) SetSkills(v []VariationSkillPost) {
	o.Skills = v
}
...
func (o AIConfigVariationPost) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ToolKeys) {
		toSerialize["toolKeys"] = o.ToolKeys
	}
	if !IsNil(o.Skills) {
...
func (o *AIConfigVariationPost) UnmarshalJSON(data []byte) (err error) {
	...
	varAIConfigVariationPost := _AIConfigVariationPost{}

	err = json.Unmarshal(data, &varAIConfigVariationPost)

	if err != nil {
		return err
	}

	*o = AIConfigVariationPost(varAIConfigVariationPost)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "toolKeys")
