...
// IntegrationSubscriptionStatusRepErrors struct for IntegrationSubscriptionStatusRepErrors
type IntegrationSubscriptionStatusRepErrors struct {
...
func NewIntegrationSubscriptionStatusRepErrors() *IntegrationSubscriptionStatusRepErrors {
	this := IntegrationSubscriptionStatusRepErrors{}
	return &this
}
...
func (o IntegrationSubscriptionStatusRepErrors) MarshalJSON() ([]byte, error) {
...
type NullableIntegrationSubscriptionStatusRepErrors struct {
	value *IntegrationSubscriptionStatusRepErrors
	isSet bool
}

func (v NullableIntegrationSubscriptionStatusRepErrors) Get() *IntegrationSubscriptionStatusRepErrors {
	return v.value
}

func (v *NullableIntegrationSubscriptionStatusRepErrors) Set(val *IntegrationSubscriptionStatusRepErrors) {
	v.value = val
	v.isSet = true
}

func (v NullableIntegrationSubscriptionStatusRepErrors) IsSet() bool {
	return v.isSet
}

func (v *NullableIntegrationSubscriptionStatusRepErrors) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntegrationSubscriptionStatusRepErrors(val *IntegrationSubscriptionStatusRepErrors) *NullableIntegrationSubscriptionStatusRepErrors {
	return &NullableIntegrationSubscriptionStatusRepErrors{value: val, isSet: true}
}

func (v NullableIntegrationSubscriptionStatusRepErrors) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntegrationSubscriptionStatusRepErrors) UnmarshalJSON(src []byte) error {
	v.isSet = true
