...
// checks if the AIConfigTargetingEnvironment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigTargetingEnvironment{}

// AIConfigTargetingEnvironment struct for AIConfigTargetingEnvironment
type AIConfigTargetingEnvironment struct {
	ContextTargets []AIConfigTargetingEnvironmentTarget `json:"contextTargets"`
	Enabled bool `json:"enabled"`
	Fallthrough AIConfigTargetingEnvironmentFallthrough `json:"fallthrough"`
	LastModified int64 `json:"lastModified"`
	OffVariation *int32 `json:"offVariation,omitempty"`
	Rules []AIConfigTargetingEnvironmentRule `json:"rules"`
	Targets []AIConfigTargetingEnvironmentTarget `json:"targets"`
...
type _AIConfigTargetingEnvironment AIConfigTargetingEnvironment
...
func NewAIConfigTargetingEnvironment(contextTargets []AIConfigTargetingEnvironmentTarget, enabled bool, fallthrough_ AIConfigTargetingEnvironmentFallthrough, lastModified int64, rules []AIConfigTargetingEnvironmentRule, targets []AIConfigTargetingEnvironmentTarget, trackEvents bool, trackEventsFallthrough bool, environmentName string, version int32) *AIConfigTargetingEnvironment {
	this := AIConfigTargetingEnvironment{}
...
func (o *AIConfigTargetingEnvironment) GetContextTargets() []AIConfigTargetingEnvironmentTarget {
	if o == nil {
		var ret []AIConfigTargetingEnvironmentTarget
		return ret
	}
...
func (o *AIConfigTargetingEnvironment) GetFallthrough() AIConfigTargetingEnvironmentFallthrough {
	if o == nil {
		var ret AIConfigTargetingEnvironmentFallthrough
		return ret
	}
...
func (o *AIConfigTargetingEnvironment) GetRules() []AIConfigTargetingEnvironmentRule {
	if o == nil {
		var ret []AIConfigTargetingEnvironmentRule
		return ret
	}
...
func (o AIConfigTargetingEnvironment) MarshalJSON() ([]byte, error) {
...
func (o *AIConfigTargetingEnvironment) UnmarshalJSON(data []byte) (err error) {
	...
	varAIConfigTargetingEnvironment := _AIConfigTargetingEnvironment{}

	err = json.Unmarshal(data, &varAIConfigTargetingEnvironment)

	if err != nil {
		return err
	}

	*o = AIConfigTargetingEnvironment(varAIConfigTargetingEnvironment)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "contextTargets")
		delete(additionalProperties, "enabled")
		delete(additionalProperties, "fallthrough")
		delete(additionalProperties, "lastModified")
		delete(additionalProperties, "offVariation")
		delete(additionalProperties, "rules")
		delete(additionalProperties, "targets")
		delete(additionalProperties, "trackEvents")
		delete(additionalProperties, "trackEventsFallthrough")
		delete(additionalProperties, "_environmentName")
...
type NullableAIConfigTargetingEnvironment struct {
	value *AIConfigTargetingEnvironment
	isSet bool
}

func (v NullableAIConfigTargetingEnvironment) Get() *AIConfigTargetingEnvironment {
	return v.value
}

func (v *NullableAIConfigTargetingEnvironment) Set(val *AIConfigTargetingEnvironment) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigTargetingEnvironment) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigTargetingEnvironment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigTargetingEnvironment(val *AIConfigTargetingEnvironment) *NullableAIConfigTargetingEnvironment {
	return &NullableAIConfigTargetingEnvironment{value: val, isSet: true}
}

func (v NullableAIConfigTargetingEnvironment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigTargetingEnvironment) UnmarshalJSON(src []byte) error {
	v.isSet = true
