...
// checks if the AgentOptimizationResultPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentOptimizationResultPost{}

// AgentOptimizationResultPost struct for AgentOptimizationResultPost
type AgentOptimizationResultPost struct {
...
type _AgentOptimizationResultPost AgentOptimizationResultPost
...
func NewAgentOptimizationResultPost(runId string, agentOptimizationVersion int32, iteration int32, instructions string, userInput string) *AgentOptimizationResultPost {
	this := AgentOptimizationResultPost{}
	this.RunId = runId
...
func (o AgentOptimizationResultPost) MarshalJSON() ([]byte, error) {
...
func (o AgentOptimizationResultPost) ToMap() (map[string]interface{}, error) {
...
func (o *AgentOptimizationResultPost) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentOptimizationResultPost := _AgentOptimizationResultPost{}

	err = json.Unmarshal(data, &varAgentOptimizationResultPost)

	if err != nil {
		return err
	}

	*o = AgentOptimizationResultPost(varAgentOptimizationResultPost)
...
type NullableAgentOptimizationResultPost struct {
	value *AgentOptimizationResultPost
	isSet bool
}

func (v NullableAgentOptimizationResultPost) Get() *AgentOptimizationResultPost {
	return v.value
}

func (v *NullableAgentOptimizationResultPost) Set(val *AgentOptimizationResultPost) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentOptimizationResultPost) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentOptimizationResultPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentOptimizationResultPost(val *AgentOptimizationResultPost) *NullableAgentOptimizationResultPost {
	return &NullableAgentOptimizationResultPost{value: val, isSet: true}
}

func (v NullableAgentOptimizationResultPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentOptimizationResultPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
