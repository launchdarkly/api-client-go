...
// checks if the AiConfigsExperimentEnabledPeriodRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsExperimentEnabledPeriodRep{}

// AiConfigsExperimentEnabledPeriodRep struct for AiConfigsExperimentEnabledPeriodRep
type AiConfigsExperimentEnabledPeriodRep struct {
	StartDate *int64 `json:"startDate,omitempty"`
	StopDate *int64 `json:"stopDate,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AiConfigsExperimentEnabledPeriodRep AiConfigsExperimentEnabledPeriodRep
...
func NewAiConfigsExperimentEnabledPeriodRep() *AiConfigsExperimentEnabledPeriodRep {
	this := AiConfigsExperimentEnabledPeriodRep{}
	return &this
}
...
func (o AiConfigsExperimentEnabledPeriodRep) MarshalJSON() ([]byte, error) {
...
func (o AiConfigsExperimentEnabledPeriodRep) ToMap() (map[string]interface{}, error) {
...
func (o *AiConfigsExperimentEnabledPeriodRep) UnmarshalJSON(data []byte) (err error) {
	varAiConfigsExperimentEnabledPeriodRep := _AiConfigsExperimentEnabledPeriodRep{}

	err = json.Unmarshal(data, &varAiConfigsExperimentEnabledPeriodRep)

	if err != nil {
		return err
	}

	*o = AiConfigsExperimentEnabledPeriodRep(varAiConfigsExperimentEnabledPeriodRep)
...
type NullableAiConfigsExperimentEnabledPeriodRep struct {
	value *AiConfigsExperimentEnabledPeriodRep
	isSet bool
}

func (v NullableAiConfigsExperimentEnabledPeriodRep) Get() *AiConfigsExperimentEnabledPeriodRep {
	return v.value
}

func (v *NullableAiConfigsExperimentEnabledPeriodRep) Set(val *AiConfigsExperimentEnabledPeriodRep) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsExperimentEnabledPeriodRep) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsExperimentEnabledPeriodRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsExperimentEnabledPeriodRep(val *AiConfigsExperimentEnabledPeriodRep) *NullableAiConfigsExperimentEnabledPeriodRep {
	return &NullableAiConfigsExperimentEnabledPeriodRep{value: val, isSet: true}
}

func (v NullableAiConfigsExperimentEnabledPeriodRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsExperimentEnabledPeriodRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
