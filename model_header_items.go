...
// checks if the HeaderItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeaderItems{}

// HeaderItems struct for HeaderItems
...
func (o HeaderItems) MarshalJSON() ([]byte, error) {
...
func (o HeaderItems) ToMap() (map[string]interface{}, error) {
...
func (o *HeaderItems) UnmarshalJSON(data []byte) (err error) {
	varHeaderItems := _HeaderItems{}

	err = json.Unmarshal(data, &varHeaderItems)

	if err != nil {
		return err
	}

	*o = HeaderItems(varHeaderItems)
...
type NullableHeaderItems struct {
	value *HeaderItems
	isSet bool
}

func (v NullableHeaderItems) Get() *HeaderItems {
	return v.value
}

func (v *NullableHeaderItems) Set(val *HeaderItems) {
	v.value = val
	v.isSet = true
}

func (v NullableHeaderItems) IsSet() bool {
	return v.isSet
}

func (v *NullableHeaderItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHeaderItems(val *HeaderItems) *NullableHeaderItems {
	return &NullableHeaderItems{value: val, isSet: true}
}

func (v NullableHeaderItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHeaderItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
