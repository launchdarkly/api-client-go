...
// IntegrationSubscriptionRepCollection struct for IntegrationSubscriptionRepCollection
type IntegrationSubscriptionRepCollection struct {
...
func NewIntegrationSubscriptionRepCollection() *IntegrationSubscriptionRepCollection {
	this := IntegrationSubscriptionRepCollection{}
	return &this
}
...
func (o IntegrationSubscriptionRepCollection) MarshalJSON() ([]byte, error) {
...
type NullableIntegrationSubscriptionRepCollection struct {
	value *IntegrationSubscriptionRepCollection
	isSet bool
}

func (v NullableIntegrationSubscriptionRepCollection) Get() *IntegrationSubscriptionRepCollection {
	return v.value
}

func (v *NullableIntegrationSubscriptionRepCollection) Set(val *IntegrationSubscriptionRepCollection) {
	v.value = val
	v.isSet = true
}

func (v NullableIntegrationSubscriptionRepCollection) IsSet() bool {
	return v.isSet
}

func (v *NullableIntegrationSubscriptionRepCollection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntegrationSubscriptionRepCollection(val *IntegrationSubscriptionRepCollection) *NullableIntegrationSubscriptionRepCollection {
	return &NullableIntegrationSubscriptionRepCollection{value: val, isSet: true}
}

func (v NullableIntegrationSubscriptionRepCollection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntegrationSubscriptionRepCollection) UnmarshalJSON(src []byte) error {
	v.isSet = true
