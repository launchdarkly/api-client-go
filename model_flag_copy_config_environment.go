...
// checks if the FlagCopyConfigEnvironment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagCopyConfigEnvironment{}
...
type _FlagCopyConfigEnvironment FlagCopyConfigEnvironment
...
func (o FlagCopyConfigEnvironment) ToMap() (map[string]interface{}, error) {
...
func (o *FlagCopyConfigEnvironment) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagCopyConfigEnvironment := _FlagCopyConfigEnvironment{}

	err = json.Unmarshal(data, &varFlagCopyConfigEnvironment)

	if err != nil {
		return err
	}

	*o = FlagCopyConfigEnvironment(varFlagCopyConfigEnvironment)
