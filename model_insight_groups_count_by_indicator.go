...
// checks if the InsightGroupsCountByIndicator type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightGroupsCountByIndicator{}
...
type _InsightGroupsCountByIndicator InsightGroupsCountByIndicator
...
func (o InsightGroupsCountByIndicator) ToMap() (map[string]interface{}, error) {
...
func (o *InsightGroupsCountByIndicator) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightGroupsCountByIndicator := _InsightGroupsCountByIndicator{}

	err = json.Unmarshal(data, &varInsightGroupsCountByIndicator)

	if err != nil {
		return err
	}

	*o = InsightGroupsCountByIndicator(varInsightGroupsCountByIndicator)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "excellent")
		delete(additionalProperties, "good")
		delete(additionalProperties, "fair")
		delete(additionalProperties, "needsAttention")
		delete(additionalProperties, "notCalculated")
