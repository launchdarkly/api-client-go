...
// checks if the BranchRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BranchRep{}
...
func (o BranchRep) ToMap() (map[string]interface{}, error) {
...
func (o *BranchRep) UnmarshalJSON(data []byte) (err error) {
	...
	varBranchRep := _BranchRep{}

	err = json.Unmarshal(data, &varBranchRep)

	if err != nil {
		return err
	}

	*o = BranchRep(varBranchRep)
