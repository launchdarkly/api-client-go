...
// checks if the AgentOptimizationResults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentOptimizationResults{}

// AgentOptimizationResults struct for AgentOptimizationResults
type AgentOptimizationResults struct {
	Links *PaginatedLinks `json:"_links,omitempty"`
	Items []AgentOptimizationResult `json:"items"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AgentOptimizationResults AgentOptimizationResults
...
func (o *AgentOptimizationResults) GetItems() []AgentOptimizationResult {
	if o == nil {
		var ret []AgentOptimizationResult
		return ret
	}
...
func (o AgentOptimizationResults) MarshalJSON() ([]byte, error) {
...
func (o AgentOptimizationResults) ToMap() (map[string]interface{}, error) {
...
func (o *AgentOptimizationResults) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentOptimizationResults := _AgentOptimizationResults{}

	err = json.Unmarshal(data, &varAgentOptimizationResults)

	if err != nil {
		return err
	}

	*o = AgentOptimizationResults(varAgentOptimizationResults)
...
type NullableAgentOptimizationResults struct {
	value *AgentOptimizationResults
	isSet bool
}

func (v NullableAgentOptimizationResults) Get() *AgentOptimizationResults {
	return v.value
}

func (v *NullableAgentOptimizationResults) Set(val *AgentOptimizationResults) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentOptimizationResults) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentOptimizationResults) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentOptimizationResults(val *AgentOptimizationResults) *NullableAgentOptimizationResults {
	return &NullableAgentOptimizationResults{value: val, isSet: true}
}

func (v NullableAgentOptimizationResults) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentOptimizationResults) UnmarshalJSON(src []byte) error {
	v.isSet = true
