...
// checks if the LinkResourceSuccessResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkResourceSuccessResponse{}

// LinkResourceSuccessResponse struct for LinkResourceSuccessResponse
type LinkResourceSuccessResponse struct {
	...
	LinkedResources *ViewLinkedResources `json:"linkedResources,omitempty"`
	// Details of resources that failed to link.
	FailedResources []FailedResourceLink `json:"failedResources,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _LinkResourceSuccessResponse LinkResourceSuccessResponse
...
func NewLinkResourceSuccessResponse(successCount int32, failureCount int32) *LinkResourceSuccessResponse {
	this := LinkResourceSuccessResponse{}
...
// SetLinkedResources gets a reference to the given ViewLinkedResources and assigns it to the LinkedResources field.
func (o *LinkResourceSuccessResponse) SetLinkedResources(v ViewLinkedResources) {
	o.LinkedResources = &v
}

// GetFailedResources returns the FailedResources field value if set, zero value otherwise.
func (o *LinkResourceSuccessResponse) GetFailedResources() []FailedResourceLink {
	if o == nil || IsNil(o.FailedResources) {
		var ret []FailedResourceLink
		return ret
	}
	return o.FailedResources
}

// GetFailedResourcesOk returns a tuple with the FailedResources field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *LinkResourceSuccessResponse) GetFailedResourcesOk() ([]FailedResourceLink, bool) {
	if o == nil || IsNil(o.FailedResources) {
		return nil, false
	}
	return o.FailedResources, true
}
...
// SetFailedResources gets a reference to the given []FailedResourceLink and assigns it to the FailedResources field.
func (o *LinkResourceSuccessResponse) SetFailedResources(v []FailedResourceLink) {
	o.FailedResources = v
}

func (o LinkResourceSuccessResponse) MarshalJSON() ([]byte, error) {
...
func (o LinkResourceSuccessResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["successCount"] = o.SuccessCount
	toSerialize["failureCount"] = o.FailureCount
	if !IsNil(o.LinkedResources) {
		toSerialize["linkedResources"] = o.LinkedResources
	}
	if !IsNil(o.FailedResources) {
		toSerialize["failedResources"] = o.FailedResources
	}
...
func (o *LinkResourceSuccessResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varLinkResourceSuccessResponse := _LinkResourceSuccessResponse{}

	err = json.Unmarshal(data, &varLinkResourceSuccessResponse)

	if err != nil {
		return err
	}

	*o = LinkResourceSuccessResponse(varLinkResourceSuccessResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "linkedResources")
		delete(additionalProperties, "failedResources")
...
type NullableLinkResourceSuccessResponse struct {
	value *LinkResourceSuccessResponse
	isSet bool
}

func (v NullableLinkResourceSuccessResponse) Get() *LinkResourceSuccessResponse {
	return v.value
}

func (v *NullableLinkResourceSuccessResponse) Set(val *LinkResourceSuccessResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkResourceSuccessResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkResourceSuccessResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkResourceSuccessResponse(val *LinkResourceSuccessResponse) *NullableLinkResourceSuccessResponse {
	return &NullableLinkResourceSuccessResponse{value: val, isSet: true}
}

func (v NullableLinkResourceSuccessResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkResourceSuccessResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
