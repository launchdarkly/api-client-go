...
// checks if the IterationRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IterationRep{}
...
type IterationRep struct {
	...
	ReallocationFrequencyMillis *int32 `json:"reallocationFrequencyMillis,omitempty"`
	...
	CovariateInfo *CovariateInfoRep `json:"covariateInfo,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _IterationRep IterationRep
...
func (o *IterationRep) GetWinningTreatmentId() string {
	if o == nil || IsNil(o.WinningTreatmentId) {
		var ret string
		return ret
	}
...
func (o *IterationRep) GetWinningReason() string {
	if o == nil || IsNil(o.WinningReason) {
		var ret string
		return ret
	}
...
func (o *IterationRep) GetCanReshuffleTraffic() bool {
	if o == nil || IsNil(o.CanReshuffleTraffic) {
		var ret bool
		return ret
	}
...
// GetReallocationFrequencyMillis returns the ReallocationFrequencyMillis field value if set, zero value otherwise.
func (o *IterationRep) GetReallocationFrequencyMillis() int32 {
	if o == nil || IsNil(o.ReallocationFrequencyMillis) {
		var ret int32
		return ret
	}
	return *o.ReallocationFrequencyMillis
}

// GetReallocationFrequencyMillisOk returns a tuple with the ReallocationFrequencyMillis field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IterationRep) GetReallocationFrequencyMillisOk() (*int32, bool) {
	if o == nil || IsNil(o.ReallocationFrequencyMillis) {
		return nil, false
	}
	return o.ReallocationFrequencyMillis, true
}
...
// SetReallocationFrequencyMillis gets a reference to the given int32 and assigns it to the ReallocationFrequencyMillis field.
func (o *IterationRep) SetReallocationFrequencyMillis(v int32) {
	o.ReallocationFrequencyMillis = &v
}
...
func (o *IterationRep) GetPrimaryMetric() DependentMetricOrMetricGroupRep {
	if o == nil || IsNil(o.PrimaryMetric) {
...
func (o *IterationRep) GetPrimarySingleMetric() MetricV2Rep {
	if o == nil || IsNil(o.PrimarySingleMetric) {
		var ret MetricV2Rep
		return ret
	}
...
func (o *IterationRep) GetPrimaryFunnel() DependentMetricGroupRepWithMetrics {
	if o == nil || IsNil(o.PrimaryFunnel) {
...
func (o *IterationRep) GetRandomizationUnit() string {
	if o == nil || IsNil(o.RandomizationUnit) {
		var ret string
		return ret
	}
...
func (o *IterationRep) GetLayerSnapshot() LayerSnapshotRep {
	if o == nil || IsNil(o.LayerSnapshot) {
...
// GetCovariateInfo returns the CovariateInfo field value if set, zero value otherwise.
func (o *IterationRep) GetCovariateInfo() CovariateInfoRep {
	if o == nil || IsNil(o.CovariateInfo) {
		var ret CovariateInfoRep
		return ret
	}
	return *o.CovariateInfo
}

// GetCovariateInfoOk returns a tuple with the CovariateInfo field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IterationRep) GetCovariateInfoOk() (*CovariateInfoRep, bool) {
	if o == nil || IsNil(o.CovariateInfo) {
		return nil, false
	}
	return o.CovariateInfo, true
}
...
// SetCovariateInfo gets a reference to the given CovariateInfoRep and assigns it to the CovariateInfo field.
...
func (o IterationRep) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.WinningTreatmentId) {
		toSerialize["winningTreatmentId"] = o.WinningTreatmentId
	}
	if !IsNil(o.WinningReason) {
		toSerialize["winningReason"] = o.WinningReason
	}
	if !IsNil(o.CanReshuffleTraffic) {
		toSerialize["canReshuffleTraffic"] = o.CanReshuffleTraffic
	}
	if !IsNil(o.Flags) {
		toSerialize["flags"] = o.Flags
	}
	if !IsNil(o.ReallocationFrequencyMillis) {
		toSerialize["reallocationFrequencyMillis"] = o.ReallocationFrequencyMillis
	}
	if !IsNil(o.Version) {
		toSerialize["version"] = o.Version
	}
	if !IsNil(o.PrimaryMetric) {
		toSerialize["primaryMetric"] = o.PrimaryMetric
	}
	if !IsNil(o.PrimarySingleMetric) {
		toSerialize["primarySingleMetric"] = o.PrimarySingleMetric
	}
	if !IsNil(o.PrimaryFunnel) {
	...
	if !IsNil(o.CovariateInfo) {
		toSerialize["covariateInfo"] = o.CovariateInfo
	}
...
func (o *IterationRep) UnmarshalJSON(data []byte) (err error) {
	...
	varIterationRep := _IterationRep{}

	err = json.Unmarshal(data, &varIterationRep)

	if err != nil {
		return err
	}

	*o = IterationRep(varIterationRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "winningTreatmentId")
		delete(additionalProperties, "winningReason")
		delete(additionalProperties, "canReshuffleTraffic")
		delete(additionalProperties, "flags")
		delete(additionalProperties, "reallocationFrequencyMillis")
		delete(additionalProperties, "version")
		delete(additionalProperties, "primaryMetric")
		delete(additionalProperties, "primarySingleMetric")
		delete(additionalProperties, "primaryFunnel")
		...
		delete(additionalProperties, "covariateInfo")
