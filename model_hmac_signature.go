...
// checks if the HMACSignature type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HMACSignature{}

// HMACSignature struct for HMACSignature
type HMACSignature struct {
	HeaderName *string `json:"headerName,omitempty"`
	HmacSecretFormVariableKey *string `json:"hmacSecretFormVariableKey,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _HMACSignature HMACSignature
...
// GetHmacSecretFormVariableKey returns the HmacSecretFormVariableKey field value if set, zero value otherwise.
func (o *HMACSignature) GetHmacSecretFormVariableKey() string {
	if o == nil || IsNil(o.HmacSecretFormVariableKey) {
		var ret string
		return ret
	}
	return *o.HmacSecretFormVariableKey
}

// GetHmacSecretFormVariableKeyOk returns a tuple with the HmacSecretFormVariableKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HMACSignature) GetHmacSecretFormVariableKeyOk() (*string, bool) {
	if o == nil || IsNil(o.HmacSecretFormVariableKey) {
		return nil, false
	}
	return o.HmacSecretFormVariableKey, true
}
...
// SetHmacSecretFormVariableKey gets a reference to the given string and assigns it to the HmacSecretFormVariableKey field.
func (o *HMACSignature) SetHmacSecretFormVariableKey(v string) {
	o.HmacSecretFormVariableKey = &v
}

func (o HMACSignature) MarshalJSON() ([]byte, error) {
...
func (o HMACSignature) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.HeaderName) {
		toSerialize["headerName"] = o.HeaderName
	}
	if !IsNil(o.HmacSecretFormVariableKey) {
		toSerialize["hmacSecretFormVariableKey"] = o.HmacSecretFormVariableKey
	}
...
func (o *HMACSignature) UnmarshalJSON(data []byte) (err error) {
	varHMACSignature := _HMACSignature{}

	err = json.Unmarshal(data, &varHMACSignature)

	if err != nil {
		return err
	}

	*o = HMACSignature(varHMACSignature)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "headerName")
		delete(additionalProperties, "hmacSecretFormVariableKey")
...
type NullableHMACSignature struct {
	value *HMACSignature
	isSet bool
}

func (v NullableHMACSignature) Get() *HMACSignature {
	return v.value
}

func (v *NullableHMACSignature) Set(val *HMACSignature) {
	v.value = val
	v.isSet = true
}

func (v NullableHMACSignature) IsSet() bool {
	return v.isSet
}

func (v *NullableHMACSignature) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHMACSignature(val *HMACSignature) *NullableHMACSignature {
	return &NullableHMACSignature{value: val, isSet: true}
}

func (v NullableHMACSignature) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHMACSignature) UnmarshalJSON(src []byte) error {
	v.isSet = true
