...
// checks if the AITool type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AITool{}

// AITool struct for AITool
type AITool struct {
	Key string `json:"key"`
...
func (o AITool) MarshalJSON() ([]byte, error) {
...
func (o AITool) ToMap() (map[string]interface{}, error) {
...
func (o *AITool) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAITool)
...
type NullableAITool struct {
	value *AITool
	isSet bool
}

func (v NullableAITool) Get() *AITool {
	return v.value
}

func (v *NullableAITool) Set(val *AITool) {
	v.value = val
	v.isSet = true
}

func (v NullableAITool) IsSet() bool {
	return v.isSet
}

func (v *NullableAITool) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAITool(val *AITool) *NullableAITool {
	return &NullableAITool{value: val, isSet: true}
}

func (v NullableAITool) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAITool) UnmarshalJSON(src []byte) error {
	v.isSet = true
