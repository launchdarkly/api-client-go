...
// checks if the MaintainerTeam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintainerTeam{}
...
type _MaintainerTeam MaintainerTeam
...
func (o MaintainerTeam) ToMap() (map[string]interface{}, error) {
...
func (o *MaintainerTeam) UnmarshalJSON(data []byte) (err error) {
	...
	varMaintainerTeam := _MaintainerTeam{}

	err = json.Unmarshal(data, &varMaintainerTeam)

	if err != nil {
		return err
	}

	*o = MaintainerTeam(varMaintainerTeam)
