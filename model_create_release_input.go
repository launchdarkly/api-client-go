...
// checks if the CreateReleaseInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateReleaseInput{}

// CreateReleaseInput struct for CreateReleaseInput
type CreateReleaseInput struct {
	// The variation id to release to across all phases
	ReleaseVariationId *string `json:"releaseVariationId,omitempty"`
	// The key of the release pipeline to attach the flag to
	ReleasePipelineKey string `json:"releasePipelineKey"`
	AdditionalProperties map[string]interface{}
}

type _CreateReleaseInput CreateReleaseInput
...
func (o *CreateReleaseInput) GetReleaseVariationId() string {
	if o == nil || IsNil(o.ReleaseVariationId) {
		var ret string
		return ret
	}
...
func (o CreateReleaseInput) MarshalJSON() ([]byte, error) {
...
func (o CreateReleaseInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ReleaseVariationId) {
		toSerialize["releaseVariationId"] = o.ReleaseVariationId
	}
...
func (o *CreateReleaseInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateReleaseInput := _CreateReleaseInput{}

	err = json.Unmarshal(data, &varCreateReleaseInput)

	if err != nil {
		return err
	}

	*o = CreateReleaseInput(varCreateReleaseInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "releaseVariationId")
		delete(additionalProperties, "releasePipelineKey")
...
type NullableCreateReleaseInput struct {
	value *CreateReleaseInput
	isSet bool
}

func (v NullableCreateReleaseInput) Get() *CreateReleaseInput {
	return v.value
}

func (v *NullableCreateReleaseInput) Set(val *CreateReleaseInput) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateReleaseInput) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateReleaseInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateReleaseInput(val *CreateReleaseInput) *NullableCreateReleaseInput {
	return &NullableCreateReleaseInput{value: val, isSet: true}
}

func (v NullableCreateReleaseInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateReleaseInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
