...
// checks if the IntegrationConfigurationPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationConfigurationPost{}
...
type _IntegrationConfigurationPost IntegrationConfigurationPost
...
func (o IntegrationConfigurationPost) ToMap() (map[string]interface{}, error) {
...
func (o *IntegrationConfigurationPost) UnmarshalJSON(data []byte) (err error) {
	...
	varIntegrationConfigurationPost := _IntegrationConfigurationPost{}

	err = json.Unmarshal(data, &varIntegrationConfigurationPost)

	if err != nil {
		return err
	}

	*o = IntegrationConfigurationPost(varIntegrationConfigurationPost)
