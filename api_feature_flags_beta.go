...
type ApiPostFeatureFlagStatusesQueryRequest struct {
	ctx context.Context
	ApiService *FeatureFlagsBetaApiService
	projectKey string
...
func (r ApiPostFeatureFlagStatusesQueryRequest) FlagStatusesQuery(flagStatusesQuery FlagStatusesQuery) ApiPostFeatureFlagStatusesQueryRequest {
	r.flagStatusesQuery = &flagStatusesQuery
	return r
}

func (r ApiPostFeatureFlagStatusesQueryRequest) Execute() (*FlagStatusesCollection, *http.Response, error) {
	return r.ApiService.PostFeatureFlagStatusesQueryExecute(r)
}

/*
PostFeatureFlagStatusesQuery Query feature flag statuses for multiple flags and environments

Query feature flag statuses for multiple flags and environments.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectKey The project key
 @return ApiPostFeatureFlagStatusesQueryRequest
*/
func (a *FeatureFlagsBetaApiService) PostFeatureFlagStatusesQuery(ctx context.Context, projectKey string) ApiPostFeatureFlagStatusesQueryRequest {
	return ApiPostFeatureFlagStatusesQueryRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return FlagStatusesCollection
func (a *FeatureFlagsBetaApiService) PostFeatureFlagStatusesQueryExecute(r ApiPostFeatureFlagStatusesQueryRequest) (*FlagStatusesCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *FlagStatusesCollection
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FeatureFlagsBetaApiService.PostFeatureFlagStatusesQuery")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/flag-statuses/query"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
...
type ApiPostGlobalFlagByKeyDryRunRequest struct {
	ctx context.Context
	ApiService *FeatureFlagsBetaApiService
	projectKey string
	flagKey string
	patchFlagInput *PatchFlagInput
}

func (r ApiPostGlobalFlagByKeyDryRunRequest) PatchFlagInput(patchFlagInput PatchFlagInput) ApiPostGlobalFlagByKeyDryRunRequest {
	r.patchFlagInput = &patchFlagInput
	return r
}

func (r ApiPostGlobalFlagByKeyDryRunRequest) Execute() (*FeatureFlag, *http.Response, error) {
	return r.ApiService.PostGlobalFlagByKeyDryRunExecute(r)
}

/*
PostGlobalFlagByKeyDryRun Get dry run for flag changes

Preview the changes to a flag after applying semantic patch instructions.  The API response returns a preview representation of the given flag after the proposed semantic patch instructions are applied without persisting the changes.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectKey The project key
 @param flagKey The flag key
 @return ApiPostGlobalFlagByKeyDryRunRequest
*/
func (a *FeatureFlagsBetaApiService) PostGlobalFlagByKeyDryRun(ctx context.Context, projectKey string, flagKey string) ApiPostGlobalFlagByKeyDryRunRequest {
	return ApiPostGlobalFlagByKeyDryRunRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return FeatureFlag
func (a *FeatureFlagsBetaApiService) PostGlobalFlagByKeyDryRunExecute(r ApiPostGlobalFlagByKeyDryRunRequest) (*FeatureFlag, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FeatureFlagsBetaApiService.PostGlobalFlagByKeyDryRun")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/flags/{flagKey}/dry-run"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.patchFlagInput == nil {
		return localVarReturnValue, nil, reportError("patchFlagInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.patchFlagInput
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
type ApiQueryFeatureFlagStatusesRequest struct {
	ctx context.Context
	ApiService *FeatureFlagsBetaApiService
	projectKey string
	flagStatusesQuery *FlagStatusesQuery
...
func (r ApiQueryFeatureFlagStatusesRequest) FlagStatusesQuery(flagStatusesQuery FlagStatusesQuery) ApiQueryFeatureFlagStatusesRequest {
	r.flagStatusesQuery = &flagStatusesQuery
	return r
}

func (r ApiQueryFeatureFlagStatusesRequest) Execute() (*FlagStatusesCollection, *http.Response, error) {
	return r.ApiService.QueryFeatureFlagStatusesExecute(r)
}

/*
QueryFeatureFlagStatuses Query feature flag statuses for multiple flags and environments

Query feature flag statuses for multiple flags and environments.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectKey The project key
 @return ApiQueryFeatureFlagStatusesRequest
*/
func (a *FeatureFlagsBetaApiService) QueryFeatureFlagStatuses(ctx context.Context, projectKey string) ApiQueryFeatureFlagStatusesRequest {
	return ApiQueryFeatureFlagStatusesRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return FlagStatusesCollection
func (a *FeatureFlagsBetaApiService) QueryFeatureFlagStatusesExecute(r ApiQueryFeatureFlagStatusesRequest) (*FlagStatusesCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FeatureFlagsBetaApiService.QueryFeatureFlagStatuses")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/flag-statuses/queries"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterToString(r.projectKey, "")), -1)
