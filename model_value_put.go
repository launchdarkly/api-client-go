...
// checks if the ValuePut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValuePut{}
...
func (o ValuePut) ToMap() (map[string]interface{}, error) {
...
func (o *ValuePut) UnmarshalJSON(data []byte) (err error) {
	varValuePut := _ValuePut{}

	err = json.Unmarshal(data, &varValuePut)

	if err != nil {
		return err
	}

	*o = ValuePut(varValuePut)
