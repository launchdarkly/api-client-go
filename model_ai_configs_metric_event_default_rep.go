...
// checks if the AiConfigsMetricEventDefaultRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsMetricEventDefaultRep{}

// AiConfigsMetricEventDefaultRep struct for AiConfigsMetricEventDefaultRep
type AiConfigsMetricEventDefaultRep struct {
...
type _AiConfigsMetricEventDefaultRep AiConfigsMetricEventDefaultRep
...
func NewAiConfigsMetricEventDefaultRep() *AiConfigsMetricEventDefaultRep {
	this := AiConfigsMetricEventDefaultRep{}
	return &this
}
...
func (o AiConfigsMetricEventDefaultRep) MarshalJSON() ([]byte, error) {
...
func (o AiConfigsMetricEventDefaultRep) ToMap() (map[string]interface{}, error) {
...
func (o *AiConfigsMetricEventDefaultRep) UnmarshalJSON(data []byte) (err error) {
	varAiConfigsMetricEventDefaultRep := _AiConfigsMetricEventDefaultRep{}

	err = json.Unmarshal(data, &varAiConfigsMetricEventDefaultRep)

	if err != nil {
		return err
	}

	*o = AiConfigsMetricEventDefaultRep(varAiConfigsMetricEventDefaultRep)
...
type NullableAiConfigsMetricEventDefaultRep struct {
	value *AiConfigsMetricEventDefaultRep
	isSet bool
}

func (v NullableAiConfigsMetricEventDefaultRep) Get() *AiConfigsMetricEventDefaultRep {
	return v.value
}

func (v *NullableAiConfigsMetricEventDefaultRep) Set(val *AiConfigsMetricEventDefaultRep) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsMetricEventDefaultRep) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsMetricEventDefaultRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsMetricEventDefaultRep(val *AiConfigsMetricEventDefaultRep) *NullableAiConfigsMetricEventDefaultRep {
	return &NullableAiConfigsMetricEventDefaultRep{value: val, isSet: true}
}

func (v NullableAiConfigsMetricEventDefaultRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsMetricEventDefaultRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
