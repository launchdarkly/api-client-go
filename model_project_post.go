...
// checks if the ProjectPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectPost{}
...
func (o *ProjectPost) GetIncludeInSnippetByDefault() bool {
	if o == nil || IsNil(o.IncludeInSnippetByDefault) {
		var ret bool
		return ret
	}
...
func (o *ProjectPost) GetDefaultClientSideAvailability() DefaultClientSideAvailabilityPost {
	if o == nil || IsNil(o.DefaultClientSideAvailability) {
...
func (o *ProjectPost) GetNamingConvention() NamingConvention {
	if o == nil || IsNil(o.NamingConvention) {
...
func (o ProjectPost) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	toSerialize["key"] = o.Key
	if !IsNil(o.IncludeInSnippetByDefault) {
		toSerialize["includeInSnippetByDefault"] = o.IncludeInSnippetByDefault
	}
	if !IsNil(o.DefaultClientSideAvailability) {
...
func (o *ProjectPost) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectPost := _ProjectPost{}

	err = json.Unmarshal(data, &varProjectPost)

	if err != nil {
		return err
	}

	*o = ProjectPost(varProjectPost)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "includeInSnippetByDefault")
		delete(additionalProperties, "defaultClientSideAvailability")
		delete(additionalProperties, "tags")
		delete(additionalProperties, "environments")
		delete(additionalProperties, "namingConvention")
