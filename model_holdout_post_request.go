...
// checks if the HoldoutPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HoldoutPostRequest{}
...
type _HoldoutPostRequest HoldoutPostRequest
...
func (o *HoldoutPostRequest) GetHoldoutamount() string {
	if o == nil || IsNil(o.Holdoutamount) {
		var ret string
		return ret
	}
...
func (o *HoldoutPostRequest) GetPrimarymetrickey() string {
	if o == nil || IsNil(o.Primarymetrickey) {
		var ret string
		return ret
	}
...
func (o *HoldoutPostRequest) GetPrerequisiteflagkey() string {
	if o == nil || IsNil(o.Prerequisiteflagkey) {
		var ret string
		return ret
	}
...
func (o HoldoutPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *HoldoutPostRequest) UnmarshalJSON(data []byte) (err error) {
	varHoldoutPostRequest := _HoldoutPostRequest{}

	err = json.Unmarshal(data, &varHoldoutPostRequest)

	if err != nil {
		return err
	}

	*o = HoldoutPostRequest(varHoldoutPostRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "holdoutamount")
		delete(additionalProperties, "primarymetrickey")
		delete(additionalProperties, "metrics")
		delete(additionalProperties, "prerequisiteflagkey")
