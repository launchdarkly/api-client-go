...
// checks if the ViewsLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewsLink{}

// ViewsLink struct for ViewsLink
type ViewsLink struct {
	Href *string `json:"href,omitempty"`
	Type *string `json:"type,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ViewsLink ViewsLink
...
func (o ViewsLink) MarshalJSON() ([]byte, error) {
...
func (o ViewsLink) ToMap() (map[string]interface{}, error) {
...
func (o *ViewsLink) UnmarshalJSON(data []byte) (err error) {
	varViewsLink := _ViewsLink{}

	err = json.Unmarshal(data, &varViewsLink)

	if err != nil {
		return err
	}

	*o = ViewsLink(varViewsLink)
...
type NullableViewsLink struct {
	value *ViewsLink
	isSet bool
}

func (v NullableViewsLink) Get() *ViewsLink {
	return v.value
}

func (v *NullableViewsLink) Set(val *ViewsLink) {
	v.value = val
	v.isSet = true
}

func (v NullableViewsLink) IsSet() bool {
	return v.isSet
}

func (v *NullableViewsLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewsLink(val *ViewsLink) *NullableViewsLink {
	return &NullableViewsLink{value: val, isSet: true}
}

func (v NullableViewsLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewsLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
