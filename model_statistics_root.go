...
// checks if the StatisticsRoot type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatisticsRoot{}
...
type _StatisticsRoot StatisticsRoot
...
func (o StatisticsRoot) ToMap() (map[string]interface{}, error) {
...
func (o *StatisticsRoot) UnmarshalJSON(data []byte) (err error) {
	varStatisticsRoot := _StatisticsRoot{}

	err = json.Unmarshal(data, &varStatisticsRoot)

	if err != nil {
		return err
	}

	*o = StatisticsRoot(varStatisticsRoot)
