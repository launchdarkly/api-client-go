...
// ReservedCustomPropertiesItems struct for ReservedCustomPropertiesItems
type ReservedCustomPropertiesItems struct {
...
func NewReservedCustomPropertiesItems() *ReservedCustomPropertiesItems {
	this := ReservedCustomPropertiesItems{}
	return &this
}
...
func (o ReservedCustomPropertiesItems) MarshalJSON() ([]byte, error) {
...
type NullableReservedCustomPropertiesItems struct {
	value *ReservedCustomPropertiesItems
	isSet bool
}

func (v NullableReservedCustomPropertiesItems) Get() *ReservedCustomPropertiesItems {
	return v.value
}

func (v *NullableReservedCustomPropertiesItems) Set(val *ReservedCustomPropertiesItems) {
	v.value = val
	v.isSet = true
}

func (v NullableReservedCustomPropertiesItems) IsSet() bool {
	return v.isSet
}

func (v *NullableReservedCustomPropertiesItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReservedCustomPropertiesItems(val *ReservedCustomPropertiesItems) *NullableReservedCustomPropertiesItems {
	return &NullableReservedCustomPropertiesItems{value: val, isSet: true}
}

func (v NullableReservedCustomPropertiesItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReservedCustomPropertiesItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
