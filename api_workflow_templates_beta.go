...
*/
func (a *WorkflowTemplatesBetaApiService) CreateWorkflowTemplate(ctx context.Context) ApiCreateWorkflowTemplateRequest {
	return ApiCreateWorkflowTemplateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WorkflowTemplatesBetaApiService) CreateWorkflowTemplateExecute(r ApiCreateWorkflowTemplateRequest) (*WorkflowTemplateOutput, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowTemplatesBetaApiService.CreateWorkflowTemplate")
	if err != nil {
...
// Execute executes the request
func (a *WorkflowTemplatesBetaApiService) DeleteWorkflowTemplateExecute(r ApiDeleteWorkflowTemplateRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowTemplatesBetaApiService.DeleteWorkflowTemplate")
	if err != nil {
...
*/
func (a *WorkflowTemplatesBetaApiService) GetWorkflowTemplates(ctx context.Context) ApiGetWorkflowTemplatesRequest {
	return ApiGetWorkflowTemplatesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *WorkflowTemplatesBetaApiService) GetWorkflowTemplatesExecute(r ApiGetWorkflowTemplatesRequest) (*WorkflowTemplatesListingOutputRep, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "WorkflowTemplatesBetaApiService.GetWorkflowTemplates")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
