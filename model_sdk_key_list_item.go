...
// checks if the SdkKeyListItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdkKeyListItem{}

// SdkKeyListItem struct for SdkKeyListItem
type SdkKeyListItem struct {
	...
	EnvironmentSummary *SdkKeysEnvironmentSummary `json:"environmentSummary,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SdkKeyListItem SdkKeyListItem
...
// GetEnvironmentSummary returns the EnvironmentSummary field value if set, zero value otherwise.
func (o *SdkKeyListItem) GetEnvironmentSummary() SdkKeysEnvironmentSummary {
	if o == nil || IsNil(o.EnvironmentSummary) {
		var ret SdkKeysEnvironmentSummary
		return ret
	}
	return *o.EnvironmentSummary
}

// GetEnvironmentSummaryOk returns a tuple with the EnvironmentSummary field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SdkKeyListItem) GetEnvironmentSummaryOk() (*SdkKeysEnvironmentSummary, bool) {
	if o == nil || IsNil(o.EnvironmentSummary) {
		return nil, false
	}
	return o.EnvironmentSummary, true
}
...
// SetEnvironmentSummary gets a reference to the given SdkKeysEnvironmentSummary and assigns it to the EnvironmentSummary field.
func (o *SdkKeyListItem) SetEnvironmentSummary(v SdkKeysEnvironmentSummary) {
	o.EnvironmentSummary = &v
}

func (o SdkKeyListItem) MarshalJSON() ([]byte, error) {
...
func (o SdkKeyListItem) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EnvironmentSummary) {
		toSerialize["environmentSummary"] = o.EnvironmentSummary
	}
...
func (o *SdkKeyListItem) UnmarshalJSON(data []byte) (err error) {
	...
	varSdkKeyListItem := _SdkKeyListItem{}

	err = json.Unmarshal(data, &varSdkKeyListItem)

	if err != nil {
		return err
	}

	*o = SdkKeyListItem(varSdkKeyListItem)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "environmentSummary")
...
type NullableSdkKeyListItem struct {
	value *SdkKeyListItem
	isSet bool
}

func (v NullableSdkKeyListItem) Get() *SdkKeyListItem {
	return v.value
}

func (v *NullableSdkKeyListItem) Set(val *SdkKeyListItem) {
	v.value = val
	v.isSet = true
}

func (v NullableSdkKeyListItem) IsSet() bool {
	return v.isSet
}

func (v *NullableSdkKeyListItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdkKeyListItem(val *SdkKeyListItem) *NullableSdkKeyListItem {
	return &NullableSdkKeyListItem{value: val, isSet: true}
}

func (v NullableSdkKeyListItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdkKeyListItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
