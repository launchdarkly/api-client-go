...
// checks if the ReleasePolicy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleasePolicy{}

// ReleasePolicy struct for ReleasePolicy
type ReleasePolicy struct {
	Access *ReleasePoliciesAccessRep `json:"_access,omitempty"`
...
type _ReleasePolicy ReleasePolicy
...
func (o *ReleasePolicy) GetAccess() ReleasePoliciesAccessRep {
	if o == nil || IsNil(o.Access) {
		var ret ReleasePoliciesAccessRep
		return ret
	}
	return *o.Access
}
...
// SetAccess gets a reference to the given ReleasePoliciesAccessRep and assigns it to the Access field.
...
func (o ReleasePolicy) MarshalJSON() ([]byte, error) {
...
func (o ReleasePolicy) ToMap() (map[string]interface{}, error) {
...
func (o *ReleasePolicy) UnmarshalJSON(data []byte) (err error) {
	...
	varReleasePolicy := _ReleasePolicy{}

	err = json.Unmarshal(data, &varReleasePolicy)

	if err != nil {
		return err
	}

	*o = ReleasePolicy(varReleasePolicy)
...
type NullableReleasePolicy struct {
	value *ReleasePolicy
	isSet bool
}

func (v NullableReleasePolicy) Get() *ReleasePolicy {
	return v.value
}

func (v *NullableReleasePolicy) Set(val *ReleasePolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableReleasePolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableReleasePolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleasePolicy(val *ReleasePolicy) *NullableReleasePolicy {
	return &NullableReleasePolicy{value: val, isSet: true}
}

func (v NullableReleasePolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReleasePolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true
