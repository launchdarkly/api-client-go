...
// checks if the InsightsChartSeriesDataPoint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightsChartSeriesDataPoint{}
...
type _InsightsChartSeriesDataPoint InsightsChartSeriesDataPoint
...
func (o InsightsChartSeriesDataPoint) ToMap() (map[string]interface{}, error) {
...
func (o *InsightsChartSeriesDataPoint) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightsChartSeriesDataPoint := _InsightsChartSeriesDataPoint{}

	err = json.Unmarshal(data, &varInsightsChartSeriesDataPoint)

	if err != nil {
		return err
	}

	*o = InsightsChartSeriesDataPoint(varInsightsChartSeriesDataPoint)
