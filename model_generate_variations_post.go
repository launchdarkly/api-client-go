...
// GenerateVariationsPost struct for GenerateVariationsPost
type GenerateVariationsPost struct {
	Prompt *string `json:"prompt,omitempty"`
	Examples []string `json:"examples,omitempty"`
	NumVariations *int32 `json:"numVariations,omitempty"`
}
...
// GetNumVariations returns the NumVariations field value if set, zero value otherwise.
func (o *GenerateVariationsPost) GetNumVariations() int32 {
	if o == nil || o.NumVariations == nil {
		var ret int32
		return ret
	}
	return *o.NumVariations
}

// GetNumVariationsOk returns a tuple with the NumVariations field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GenerateVariationsPost) GetNumVariationsOk() (*int32, bool) {
	if o == nil || o.NumVariations == nil {
		return nil, false
	}
	return o.NumVariations, true
}
...
// SetNumVariations gets a reference to the given int32 and assigns it to the NumVariations field.
func (o *GenerateVariationsPost) SetNumVariations(v int32) {
	o.NumVariations = &v
}

func (o GenerateVariationsPost) MarshalJSON() ([]byte, error) {
	...
	if o.NumVariations != nil {
		toSerialize["numVariations"] = o.NumVariations
	}
	return json.Marshal(toSerialize)
}

type NullableGenerateVariationsPost struct {
	value *GenerateVariationsPost
	isSet bool
}

func (v NullableGenerateVariationsPost) Get() *GenerateVariationsPost {
	return v.value
}

func (v *NullableGenerateVariationsPost) Set(val *GenerateVariationsPost) {
	v.value = val
	v.isSet = true
}

func (v NullableGenerateVariationsPost) IsSet() bool {
	return v.isSet
}

func (v *NullableGenerateVariationsPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGenerateVariationsPost(val *GenerateVariationsPost) *NullableGenerateVariationsPost {
	return &NullableGenerateVariationsPost{value: val, isSet: true}
}

func (v NullableGenerateVariationsPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGenerateVariationsPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
