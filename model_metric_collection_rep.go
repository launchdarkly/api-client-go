...
// checks if the MetricCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricCollectionRep{}
...
type _MetricCollectionRep MetricCollectionRep
...
func (o MetricCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *MetricCollectionRep) UnmarshalJSON(data []byte) (err error) {
	varMetricCollectionRep := _MetricCollectionRep{}

	err = json.Unmarshal(data, &varMetricCollectionRep)

	if err != nil {
		return err
	}

	*o = MetricCollectionRep(varMetricCollectionRep)
