...
// checks if the UserFlagSettings type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserFlagSettings{}
...
type _UserFlagSettings UserFlagSettings
...
func (o *UserFlagSettings) GetItems() map[string]UserFlagSetting {
	if o == nil {
		var ret map[string]UserFlagSetting
		return ret
	}
...
func (o UserFlagSettings) ToMap() (map[string]interface{}, error) {
...
func (o *UserFlagSettings) UnmarshalJSON(data []byte) (err error) {
	...
	varUserFlagSettings := _UserFlagSettings{}

	err = json.Unmarshal(data, &varUserFlagSettings)

	if err != nil {
		return err
	}

	*o = UserFlagSettings(varUserFlagSettings)
...
func NewNullableUserFlagSettings(val *UserFlagSettings) *NullableUserFlagSettings {
	return &NullableUserFlagSettings{value: val, isSet: true}
}
