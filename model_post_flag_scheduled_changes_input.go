...
// checks if the PostFlagScheduledChangesInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostFlagScheduledChangesInput{}
...
type _PostFlagScheduledChangesInput PostFlagScheduledChangesInput
...
func (o PostFlagScheduledChangesInput) ToMap() (map[string]interface{}, error) {
...
func (o *PostFlagScheduledChangesInput) UnmarshalJSON(data []byte) (err error) {
	...
	varPostFlagScheduledChangesInput := _PostFlagScheduledChangesInput{}

	err = json.Unmarshal(data, &varPostFlagScheduledChangesInput)

	if err != nil {
		return err
	}

	*o = PostFlagScheduledChangesInput(varPostFlagScheduledChangesInput)
