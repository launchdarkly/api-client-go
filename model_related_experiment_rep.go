...
// checks if the RelatedExperimentRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RelatedExperimentRep{}
...
type _RelatedExperimentRep RelatedExperimentRep
...
func (o RelatedExperimentRep) ToMap() (map[string]interface{}, error) {
...
func (o *RelatedExperimentRep) UnmarshalJSON(data []byte) (err error) {
	varRelatedExperimentRep := _RelatedExperimentRep{}

	err = json.Unmarshal(data, &varRelatedExperimentRep)

	if err != nil {
		return err
	}

	*o = RelatedExperimentRep(varRelatedExperimentRep)
