...
// checks if the BigSegmentStoreIntegrationCollectionLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BigSegmentStoreIntegrationCollectionLinks{}

// BigSegmentStoreIntegrationCollectionLinks struct for BigSegmentStoreIntegrationCollectionLinks
type BigSegmentStoreIntegrationCollectionLinks struct {
	Self Link `json:"self"`
	Parent *Link `json:"parent,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _BigSegmentStoreIntegrationCollectionLinks BigSegmentStoreIntegrationCollectionLinks
...
func NewBigSegmentStoreIntegrationCollectionLinks(self Link) *BigSegmentStoreIntegrationCollectionLinks {
	this := BigSegmentStoreIntegrationCollectionLinks{}
	this.Self = self
	return &this
}
...
func (o BigSegmentStoreIntegrationCollectionLinks) ToMap() (map[string]interface{}, error) {
...
func (o *BigSegmentStoreIntegrationCollectionLinks) UnmarshalJSON(data []byte) (err error) {
	...
	varBigSegmentStoreIntegrationCollectionLinks := _BigSegmentStoreIntegrationCollectionLinks{}

	err = json.Unmarshal(data, &varBigSegmentStoreIntegrationCollectionLinks)

	if err != nil {
		return err
	}

	*o = BigSegmentStoreIntegrationCollectionLinks(varBigSegmentStoreIntegrationCollectionLinks)
...
type NullableBigSegmentStoreIntegrationCollectionLinks struct {
	value *BigSegmentStoreIntegrationCollectionLinks
	isSet bool
}
...
func NewNullableBigSegmentStoreIntegrationCollectionLinks(val *BigSegmentStoreIntegrationCollectionLinks) *NullableBigSegmentStoreIntegrationCollectionLinks {
	return &NullableBigSegmentStoreIntegrationCollectionLinks{value: val, isSet: true}
}
