...
// checks if the LayerCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LayerCollectionRep{}

// LayerCollectionRep struct for LayerCollectionRep
type LayerCollectionRep struct {
	// The layers in the project
	Items []LayerRep `json:"items"`
...
type _LayerCollectionRep LayerCollectionRep
...
func (o LayerCollectionRep) MarshalJSON() ([]byte, error) {
...
func (o LayerCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *LayerCollectionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varLayerCollectionRep := _LayerCollectionRep{}

	err = json.Unmarshal(data, &varLayerCollectionRep)

	if err != nil {
		return err
	}

	*o = LayerCollectionRep(varLayerCollectionRep)
...
type NullableLayerCollectionRep struct {
	value *LayerCollectionRep
	isSet bool
}

func (v NullableLayerCollectionRep) Get() *LayerCollectionRep {
	return v.value
}

func (v *NullableLayerCollectionRep) Set(val *LayerCollectionRep) {
	v.value = val
	v.isSet = true
}

func (v NullableLayerCollectionRep) IsSet() bool {
	return v.isSet
}

func (v *NullableLayerCollectionRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLayerCollectionRep(val *LayerCollectionRep) *NullableLayerCollectionRep {
	return &NullableLayerCollectionRep{value: val, isSet: true}
}

func (v NullableLayerCollectionRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLayerCollectionRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
