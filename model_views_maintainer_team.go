...
// checks if the ViewsMaintainerTeam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewsMaintainerTeam{}

// ViewsMaintainerTeam struct for ViewsMaintainerTeam
type ViewsMaintainerTeam struct {
	Id string `json:"id"`
	Key string `json:"key"`
...
type _ViewsMaintainerTeam ViewsMaintainerTeam
...
func (o ViewsMaintainerTeam) MarshalJSON() ([]byte, error) {
...
func (o ViewsMaintainerTeam) ToMap() (map[string]interface{}, error) {
...
func (o *ViewsMaintainerTeam) UnmarshalJSON(data []byte) (err error) {
	...
	varViewsMaintainerTeam := _ViewsMaintainerTeam{}

	err = json.Unmarshal(data, &varViewsMaintainerTeam)

	if err != nil {
		return err
	}

	*o = ViewsMaintainerTeam(varViewsMaintainerTeam)
...
type NullableViewsMaintainerTeam struct {
	value *ViewsMaintainerTeam
	isSet bool
}

func (v NullableViewsMaintainerTeam) Get() *ViewsMaintainerTeam {
	return v.value
}

func (v *NullableViewsMaintainerTeam) Set(val *ViewsMaintainerTeam) {
	v.value = val
	v.isSet = true
}

func (v NullableViewsMaintainerTeam) IsSet() bool {
	return v.isSet
}

func (v *NullableViewsMaintainerTeam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewsMaintainerTeam(val *ViewsMaintainerTeam) *NullableViewsMaintainerTeam {
	return &NullableViewsMaintainerTeam{value: val, isSet: true}
}

func (v NullableViewsMaintainerTeam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewsMaintainerTeam) UnmarshalJSON(src []byte) error {
	v.isSet = true
