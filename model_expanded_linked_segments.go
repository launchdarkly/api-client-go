...
// checks if the ExpandedLinkedSegments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedLinkedSegments{}

// ExpandedLinkedSegments Details on linked segments for a view - requires passing the 'allSegments' expand field
type ExpandedLinkedSegments struct {
	Items []ExpandedSegment `json:"items"`
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _ExpandedLinkedSegments ExpandedLinkedSegments
...
func (o ExpandedLinkedSegments) MarshalJSON() ([]byte, error) {
...
func (o ExpandedLinkedSegments) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedLinkedSegments) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedLinkedSegments := _ExpandedLinkedSegments{}

	err = json.Unmarshal(data, &varExpandedLinkedSegments)

	if err != nil {
		return err
	}

	*o = ExpandedLinkedSegments(varExpandedLinkedSegments)
...
type NullableExpandedLinkedSegments struct {
	value *ExpandedLinkedSegments
	isSet bool
}

func (v NullableExpandedLinkedSegments) Get() *ExpandedLinkedSegments {
	return v.value
}

func (v *NullableExpandedLinkedSegments) Set(val *ExpandedLinkedSegments) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedLinkedSegments) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedLinkedSegments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedLinkedSegments(val *ExpandedLinkedSegments) *NullableExpandedLinkedSegments {
	return &NullableExpandedLinkedSegments{value: val, isSet: true}
}

func (v NullableExpandedLinkedSegments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedLinkedSegments) UnmarshalJSON(src []byte) error {
	v.isSet = true
