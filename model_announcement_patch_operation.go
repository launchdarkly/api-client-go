...
// checks if the AnnouncementPatchOperation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnnouncementPatchOperation{}
...
type _AnnouncementPatchOperation AnnouncementPatchOperation
...
func (o AnnouncementPatchOperation) ToMap() (map[string]interface{}, error) {
...
func (o *AnnouncementPatchOperation) UnmarshalJSON(data []byte) (err error) {
	...
	varAnnouncementPatchOperation := _AnnouncementPatchOperation{}

	err = json.Unmarshal(data, &varAnnouncementPatchOperation)

	if err != nil {
		return err
	}

	*o = AnnouncementPatchOperation(varAnnouncementPatchOperation)
