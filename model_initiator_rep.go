...
// checks if the InitiatorRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InitiatorRep{}
...
type _InitiatorRep InitiatorRep
...
func (o InitiatorRep) ToMap() (map[string]interface{}, error) {
...
func (o *InitiatorRep) UnmarshalJSON(data []byte) (err error) {
	varInitiatorRep := _InitiatorRep{}

	err = json.Unmarshal(data, &varInitiatorRep)

	if err != nil {
		return err
	}

	*o = InitiatorRep(varInitiatorRep)
...
func NewNullableInitiatorRep(val *InitiatorRep) *NullableInitiatorRep {
	return &NullableInitiatorRep{value: val, isSet: true}
}
