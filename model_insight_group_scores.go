...
// checks if the InsightGroupScores type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightGroupScores{}
...
type _InsightGroupScores InsightGroupScores
...
func (o *InsightGroupScores) GetCreationRatio() InsightsMetricScore {
	if o == nil || IsNil(o.CreationRatio) {
		var ret InsightsMetricScore
		return ret
	}
...
func (o InsightGroupScores) ToMap() (map[string]interface{}, error) {
...
func (o *InsightGroupScores) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightGroupScores := _InsightGroupScores{}

	err = json.Unmarshal(data, &varInsightGroupScores)

	if err != nil {
		return err
	}

	*o = InsightGroupScores(varInsightGroupScores)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "overall")
		delete(additionalProperties, "deploymentFrequency")
		delete(additionalProperties, "deploymentFailureRate")
		delete(additionalProperties, "leadTime")
		delete(additionalProperties, "impactSize")
		delete(additionalProperties, "experimentationCoverage")
		delete(additionalProperties, "flagHealth")
		delete(additionalProperties, "velocity")
		delete(additionalProperties, "risk")
		delete(additionalProperties, "efficiency")
		delete(additionalProperties, "creationRatio")
