...
// checks if the ExpiringUserTargetPatchResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpiringUserTargetPatchResponse{}
...
type _ExpiringUserTargetPatchResponse ExpiringUserTargetPatchResponse
...
func (o *ExpiringUserTargetPatchResponse) GetTotalInstructions() int32 {
	if o == nil || IsNil(o.TotalInstructions) {
		var ret int32
		return ret
	}
...
func (o *ExpiringUserTargetPatchResponse) GetSuccessfulInstructions() int32 {
	if o == nil || IsNil(o.SuccessfulInstructions) {
		var ret int32
		return ret
	}
...
func (o *ExpiringUserTargetPatchResponse) GetFailedInstructions() int32 {
	if o == nil || IsNil(o.FailedInstructions) {
		var ret int32
		return ret
	}
...
func (o ExpiringUserTargetPatchResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	if !IsNil(o.Links) {
		toSerialize["_links"] = o.Links
	}
	if !IsNil(o.TotalInstructions) {
		toSerialize["totalInstructions"] = o.TotalInstructions
	}
	if !IsNil(o.SuccessfulInstructions) {
		toSerialize["successfulInstructions"] = o.SuccessfulInstructions
	}
	if !IsNil(o.FailedInstructions) {
...
func (o *ExpiringUserTargetPatchResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varExpiringUserTargetPatchResponse := _ExpiringUserTargetPatchResponse{}

	err = json.Unmarshal(data, &varExpiringUserTargetPatchResponse)

	if err != nil {
		return err
	}

	*o = ExpiringUserTargetPatchResponse(varExpiringUserTargetPatchResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "totalInstructions")
		delete(additionalProperties, "successfulInstructions")
		delete(additionalProperties, "failedInstructions")
