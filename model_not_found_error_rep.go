...
// checks if the NotFoundErrorRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotFoundErrorRep{}
...
type _NotFoundErrorRep NotFoundErrorRep
...
func (o NotFoundErrorRep) ToMap() (map[string]interface{}, error) {
...
func (o *NotFoundErrorRep) UnmarshalJSON(data []byte) (err error) {
	...
	varNotFoundErrorRep := _NotFoundErrorRep{}

	err = json.Unmarshal(data, &varNotFoundErrorRep)

	if err != nil {
		return err
	}

	*o = NotFoundErrorRep(varNotFoundErrorRep)
