...
// checks if the InsightsRepositoryCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightsRepositoryCollection{}
...
type _InsightsRepositoryCollection InsightsRepositoryCollection
...
func (o InsightsRepositoryCollection) ToMap() (map[string]interface{}, error) {
...
func (o *InsightsRepositoryCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightsRepositoryCollection := _InsightsRepositoryCollection{}

	err = json.Unmarshal(data, &varInsightsRepositoryCollection)

	if err != nil {
		return err
	}

	*o = InsightsRepositoryCollection(varInsightsRepositoryCollection)
