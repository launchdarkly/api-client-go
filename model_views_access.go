...
// checks if the ViewsAccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewsAccess{}

// ViewsAccess struct for ViewsAccess
type ViewsAccess struct {
	Denied []ViewsAccessDenied `json:"denied"`
	Allowed []ViewsAccessAllowedRep `json:"allowed"`
	AdditionalProperties map[string]interface{}
}

type _ViewsAccess ViewsAccess
...
func (o ViewsAccess) MarshalJSON() ([]byte, error) {
...
func (o ViewsAccess) ToMap() (map[string]interface{}, error) {
...
func (o *ViewsAccess) UnmarshalJSON(data []byte) (err error) {
	...
	varViewsAccess := _ViewsAccess{}

	err = json.Unmarshal(data, &varViewsAccess)

	if err != nil {
		return err
	}

	*o = ViewsAccess(varViewsAccess)
...
type NullableViewsAccess struct {
	value *ViewsAccess
	isSet bool
}

func (v NullableViewsAccess) Get() *ViewsAccess {
	return v.value
}

func (v *NullableViewsAccess) Set(val *ViewsAccess) {
	v.value = val
	v.isSet = true
}

func (v NullableViewsAccess) IsSet() bool {
	return v.isSet
}

func (v *NullableViewsAccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewsAccess(val *ViewsAccess) *NullableViewsAccess {
	return &NullableViewsAccess{value: val, isSet: true}
}

func (v NullableViewsAccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewsAccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
