...
// checks if the FlagLinkMember type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagLinkMember{}
...
type _FlagLinkMember FlagLinkMember
...
func (o FlagLinkMember) ToMap() (map[string]interface{}, error) {
...
func (o *FlagLinkMember) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagLinkMember := _FlagLinkMember{}

	err = json.Unmarshal(data, &varFlagLinkMember)

	if err != nil {
		return err
	}

	*o = FlagLinkMember(varFlagLinkMember)
