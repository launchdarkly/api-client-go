...
// checks if the ContextAttributeNames type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextAttributeNames{}

// ContextAttributeNames struct for ContextAttributeNames
type ContextAttributeNames struct {
	// The kind associated with this collection of context attribute names.
	Kind string `json:"kind"`
	// A collection of context attribute names.
	Names []ContextAttributeName `json:"names"`
	AdditionalProperties map[string]interface{}
}

type _ContextAttributeNames ContextAttributeNames
...
func (o ContextAttributeNames) ToMap() (map[string]interface{}, error) {
...
func (o *ContextAttributeNames) UnmarshalJSON(data []byte) (err error) {
	...
	varContextAttributeNames := _ContextAttributeNames{}

	err = json.Unmarshal(data, &varContextAttributeNames)

	if err != nil {
		return err
	}

	*o = ContextAttributeNames(varContextAttributeNames)
...
func NewNullableContextAttributeNames(val *ContextAttributeNames) *NullableContextAttributeNames {
	return &NullableContextAttributeNames{value: val, isSet: true}
}
