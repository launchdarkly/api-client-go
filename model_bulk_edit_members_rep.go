...
// checks if the BulkEditMembersRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkEditMembersRep{}
...
type _BulkEditMembersRep BulkEditMembersRep
...
func (o BulkEditMembersRep) ToMap() (map[string]interface{}, error) {
...
func (o *BulkEditMembersRep) UnmarshalJSON(data []byte) (err error) {
	varBulkEditMembersRep := _BulkEditMembersRep{}

	err = json.Unmarshal(data, &varBulkEditMembersRep)

	if err != nil {
		return err
	}

	*o = BulkEditMembersRep(varBulkEditMembersRep)
...
func NewNullableBulkEditMembersRep(val *BulkEditMembersRep) *NullableBulkEditMembersRep {
	return &NullableBulkEditMembersRep{value: val, isSet: true}
}
