...
// checks if the AnnouncementAccessAllowedRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnnouncementAccessAllowedRep{}

// AnnouncementAccessAllowedRep struct for AnnouncementAccessAllowedRep
type AnnouncementAccessAllowedRep struct {
	Action string `json:"action"`
	Reason AnnouncementAccessAllowedReason `json:"reason"`
	AdditionalProperties map[string]interface{}
}

type _AnnouncementAccessAllowedRep AnnouncementAccessAllowedRep
...
func NewAnnouncementAccessAllowedRep(action string, reason AnnouncementAccessAllowedReason) *AnnouncementAccessAllowedRep {
	this := AnnouncementAccessAllowedRep{}
	this.Action = action
	this.Reason = reason
	return &this
}
...
func (o *AnnouncementAccessAllowedRep) GetReason() AnnouncementAccessAllowedReason {
	if o == nil {
		var ret AnnouncementAccessAllowedReason
		return ret
	}
...
func (o AnnouncementAccessAllowedRep) MarshalJSON() ([]byte, error) {
...
func (o AnnouncementAccessAllowedRep) ToMap() (map[string]interface{}, error) {
...
func (o *AnnouncementAccessAllowedRep) UnmarshalJSON(data []byte) (err error) {
	...
	varAnnouncementAccessAllowedRep := _AnnouncementAccessAllowedRep{}

	err = json.Unmarshal(data, &varAnnouncementAccessAllowedRep)

	if err != nil {
		return err
	}

	*o = AnnouncementAccessAllowedRep(varAnnouncementAccessAllowedRep)
...
type NullableAnnouncementAccessAllowedRep struct {
	value *AnnouncementAccessAllowedRep
	isSet bool
}

func (v NullableAnnouncementAccessAllowedRep) Get() *AnnouncementAccessAllowedRep {
	return v.value
}

func (v *NullableAnnouncementAccessAllowedRep) Set(val *AnnouncementAccessAllowedRep) {
	v.value = val
	v.isSet = true
}

func (v NullableAnnouncementAccessAllowedRep) IsSet() bool {
	return v.isSet
}

func (v *NullableAnnouncementAccessAllowedRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnnouncementAccessAllowedRep(val *AnnouncementAccessAllowedRep) *NullableAnnouncementAccessAllowedRep {
	return &NullableAnnouncementAccessAllowedRep{value: val, isSet: true}
}

func (v NullableAnnouncementAccessAllowedRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnnouncementAccessAllowedRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
