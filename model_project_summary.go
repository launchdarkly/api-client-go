...
type _ProjectSummary ProjectSummary
...
func (o *ProjectSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectSummary := _ProjectSummary{}

	err = json.Unmarshal(data, &varProjectSummary)

	if err != nil {
		return err
	}

	*o = ProjectSummary(varProjectSummary)
