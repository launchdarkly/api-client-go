...
// checks if the RepositoryPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RepositoryPost{}
...
type _RepositoryPost RepositoryPost
...
func (o *RepositoryPost) GetCommitUrlTemplate() string {
	if o == nil || IsNil(o.CommitUrlTemplate) {
		var ret string
		return ret
	}
...
func (o *RepositoryPost) GetHunkUrlTemplate() string {
	if o == nil || IsNil(o.HunkUrlTemplate) {
		var ret string
		return ret
	}
...
func (o *RepositoryPost) UnmarshalJSON(data []byte) (err error) {
	...
	varRepositoryPost := _RepositoryPost{}

	err = json.Unmarshal(data, &varRepositoryPost)

	if err != nil {
		return err
	}

	*o = RepositoryPost(varRepositoryPost)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "name")
		delete(additionalProperties, "sourceLink")
		delete(additionalProperties, "commitUrlTemplate")
		delete(additionalProperties, "hunkUrlTemplate")
