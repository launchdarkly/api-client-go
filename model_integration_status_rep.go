...
// checks if the IntegrationStatusRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationStatusRep{}
...
type _IntegrationStatusRep IntegrationStatusRep
...
func (o IntegrationStatusRep) ToMap() (map[string]interface{}, error) {
...
func (o *IntegrationStatusRep) UnmarshalJSON(data []byte) (err error) {
	varIntegrationStatusRep := _IntegrationStatusRep{}

	err = json.Unmarshal(data, &varIntegrationStatusRep)

	if err != nil {
		return err
	}

	*o = IntegrationStatusRep(varIntegrationStatusRep)
