...
// checks if the SegmentUserState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SegmentUserState{}
...
type _SegmentUserState SegmentUserState
...
func (o SegmentUserState) ToMap() (map[string]interface{}, error) {
...
func (o *SegmentUserState) UnmarshalJSON(data []byte) (err error) {
	varSegmentUserState := _SegmentUserState{}

	err = json.Unmarshal(data, &varSegmentUserState)

	if err != nil {
		return err
	}

	*o = SegmentUserState(varSegmentUserState)
