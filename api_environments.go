...
*/
func (a *EnvironmentsApiService) ResetEnvironmentMobileKey(ctx _context.Context, projectKey string, environmentKey string) ApiResetEnvironmentMobileKeyRequest {
	return ApiResetEnvironmentMobileKeyRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
*/
func (a *EnvironmentsApiService) ResetEnvironmentSDKKey(ctx _context.Context, projectKey string, environmentKey string) ApiResetEnvironmentSDKKeyRequest {
	return ApiResetEnvironmentSDKKeyRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
