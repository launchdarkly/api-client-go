...
type APIClient struct {
	...
	AgentControlApi AgentControlApi
	...
	HoldoutsApi HoldoutsApi

	IPAllowlistBetaApi IPAllowlistBetaApi
	...
	ReleasePoliciesBetaApi ReleasePoliciesBetaApi

	ReleasesBetaApi ReleasesBetaApi

	SDKKeysBetaApi SDKKeysBetaApi
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AIConfigsApi = (*AIConfigsApiService)(&c.common)
	...
	c.AgentControlApi = (*AgentControlApiService)(&c.common)
	...
	c.IPAllowlistBetaApi = (*IPAllowlistBetaApiService)(&c.common)
	...
	c.ReleasePoliciesBetaApi = (*ReleasePoliciesBetaApiService)(&c.common)
	c.ReleasesBetaApi = (*ReleasesBetaApiService)(&c.common)
	c.SDKKeysBetaApi = (*SDKKeysBetaApiService)(&c.common)
	...
	c.ViewsBetaApi = (*ViewsBetaApiService)(&c.common)
...
func (c *APIClient) prepareRequest(
	...
	if _, exists := localVarRequest.Header["LD-API-Version"]; !exists {
	    localVarRequest.Header.Add("LD-API-Version", "20240415")
	}
    // CUSTOM-END
