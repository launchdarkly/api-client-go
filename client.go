...
// APIClient manages communication with the LaunchDarkly REST API API v5.0.0
...
type APIClient struct {
	...
	UserRecordApi *UserRecordApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.UserRecordApi = (*UserRecordApiService)(&c.common)
