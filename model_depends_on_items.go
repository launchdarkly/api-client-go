...
// DependsOnItems struct for DependsOnItems
type DependsOnItems struct {
	Action *string `json:"action,omitempty"`
	Conditions []ConditionsItems `json:"conditions,omitempty"`
	VariableKey *string `json:"variableKey,omitempty"`
	VariableLocation *string `json:"variableLocation,omitempty"`
}
...
// SetConditions gets a reference to the given []ConditionsItems and assigns it to the Conditions field.
...
// GetVariableLocation returns the VariableLocation field value if set, zero value otherwise.
func (o *DependsOnItems) GetVariableLocation() string {
	if o == nil || o.VariableLocation == nil {
		var ret string
		return ret
	}
	return *o.VariableLocation
}

// GetVariableLocationOk returns a tuple with the VariableLocation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DependsOnItems) GetVariableLocationOk() (*string, bool) {
	if o == nil || o.VariableLocation == nil {
		return nil, false
	}
	return o.VariableLocation, true
}
...
// SetVariableLocation gets a reference to the given string and assigns it to the VariableLocation field.
func (o *DependsOnItems) SetVariableLocation(v string) {
	o.VariableLocation = &v
}

func (o DependsOnItems) MarshalJSON() ([]byte, error) {
	...
	if o.VariableLocation != nil {
		toSerialize["variableLocation"] = o.VariableLocation
	}
	return json.Marshal(toSerialize)
}

type NullableDependsOnItems struct {
	value *DependsOnItems
	isSet bool
}

func (v NullableDependsOnItems) Get() *DependsOnItems {
	return v.value
}

func (v *NullableDependsOnItems) Set(val *DependsOnItems) {
	v.value = val
	v.isSet = true
}

func (v NullableDependsOnItems) IsSet() bool {
	return v.isSet
}

func (v *NullableDependsOnItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDependsOnItems(val *DependsOnItems) *NullableDependsOnItems {
	return &NullableDependsOnItems{value: val, isSet: true}
}

func (v NullableDependsOnItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDependsOnItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
