...
func (o *AgentSkill) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentSkill := _AgentSkill{}

	err = json.Unmarshal(data, &varAgentSkill)

	if err != nil {
		return err
	}

	*o = AgentSkill(varAgentSkill)
