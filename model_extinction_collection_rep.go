...
// checks if the ExtinctionCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtinctionCollectionRep{}
...
type _ExtinctionCollectionRep ExtinctionCollectionRep
...
func (o ExtinctionCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *ExtinctionCollectionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varExtinctionCollectionRep := _ExtinctionCollectionRep{}

	err = json.Unmarshal(data, &varExtinctionCollectionRep)

	if err != nil {
		return err
	}

	*o = ExtinctionCollectionRep(varExtinctionCollectionRep)
...
func NewNullableExtinctionCollectionRep(val *ExtinctionCollectionRep) *NullableExtinctionCollectionRep {
	return &NullableExtinctionCollectionRep{value: val, isSet: true}
}
