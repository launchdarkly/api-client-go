...
// checks if the DependentMetricGroupRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DependentMetricGroupRep{}
...
type _DependentMetricGroupRep DependentMetricGroupRep
...
func (o DependentMetricGroupRep) ToMap() (map[string]interface{}, error) {
...
func (o *DependentMetricGroupRep) UnmarshalJSON(data []byte) (err error) {
	...
	varDependentMetricGroupRep := _DependentMetricGroupRep{}

	err = json.Unmarshal(data, &varDependentMetricGroupRep)

	if err != nil {
		return err
	}

	*o = DependentMetricGroupRep(varDependentMetricGroupRep)
