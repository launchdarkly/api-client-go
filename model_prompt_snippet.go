...
// checks if the PromptSnippet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromptSnippet{}

// PromptSnippet struct for PromptSnippet
...
type _PromptSnippet PromptSnippet
...
func (o PromptSnippet) MarshalJSON() ([]byte, error) {
...
func (o PromptSnippet) ToMap() (map[string]interface{}, error) {
...
func (o *PromptSnippet) UnmarshalJSON(data []byte) (err error) {
	...
	varPromptSnippet := _PromptSnippet{}

	err = json.Unmarshal(data, &varPromptSnippet)

	if err != nil {
		return err
	}

	*o = PromptSnippet(varPromptSnippet)
...
type NullablePromptSnippet struct {
	value *PromptSnippet
	isSet bool
}

func (v NullablePromptSnippet) Get() *PromptSnippet {
	return v.value
}

func (v *NullablePromptSnippet) Set(val *PromptSnippet) {
	v.value = val
	v.isSet = true
}

func (v NullablePromptSnippet) IsSet() bool {
	return v.isSet
}

func (v *NullablePromptSnippet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromptSnippet(val *PromptSnippet) *NullablePromptSnippet {
	return &NullablePromptSnippet{value: val, isSet: true}
}

func (v NullablePromptSnippet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromptSnippet) UnmarshalJSON(src []byte) error {
	v.isSet = true
