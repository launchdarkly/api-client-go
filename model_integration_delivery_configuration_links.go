...
// checks if the IntegrationDeliveryConfigurationLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationDeliveryConfigurationLinks{}
...
type _IntegrationDeliveryConfigurationLinks IntegrationDeliveryConfigurationLinks
...
func (o IntegrationDeliveryConfigurationLinks) ToMap() (map[string]interface{}, error) {
...
func (o *IntegrationDeliveryConfigurationLinks) UnmarshalJSON(data []byte) (err error) {
	...
	varIntegrationDeliveryConfigurationLinks := _IntegrationDeliveryConfigurationLinks{}

	err = json.Unmarshal(data, &varIntegrationDeliveryConfigurationLinks)

	if err != nil {
		return err
	}

	*o = IntegrationDeliveryConfigurationLinks(varIntegrationDeliveryConfigurationLinks)
