...
// checks if the Views type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Views{}
...
func (o Views) ToMap() (map[string]interface{}, error) {
...
func (o *Views) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varViews)
