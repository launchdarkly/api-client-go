...
var _ MappedNullable = &MetricDataSourceRefRep{}
...
type _MetricDataSourceRefRep MetricDataSourceRefRep
...
func (o MetricDataSourceRefRep) MarshalJSON() ([]byte, error) {
...
func (o *MetricDataSourceRefRep) UnmarshalJSON(data []byte) (err error) {
	...
	*o = MetricDataSourceRefRep(varMetricDataSourceRefRep)
...
type NullableMetricDataSourceRefRep struct {
	value *MetricDataSourceRefRep
	isSet bool
}

func (v NullableMetricDataSourceRefRep) Get() *MetricDataSourceRefRep {
	return v.value
}

func (v *NullableMetricDataSourceRefRep) Set(val *MetricDataSourceRefRep) {
	v.value = val
	v.isSet = true
}

func (v NullableMetricDataSourceRefRep) IsSet() bool {
	return v.isSet
}

func (v *NullableMetricDataSourceRefRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetricDataSourceRefRep(val *MetricDataSourceRefRep) *NullableMetricDataSourceRefRep {
	return &NullableMetricDataSourceRefRep{value: val, isSet: true}
}

func (v NullableMetricDataSourceRefRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetricDataSourceRefRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
