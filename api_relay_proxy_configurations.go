 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The relay proxy configuration ID
 * @param optional nil or *ResetRelayProxyConfigOpts - Optional Parameters:
...
type ResetRelayProxyConfigOpts struct { 
	Expiry optional.Int64
}

func (a *RelayProxyConfigurationsApiService) ResetRelayProxyConfig(ctx context.Context, id string, localVarOptionals *ResetRelayProxyConfigOpts) (RelayProxyConfig, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
