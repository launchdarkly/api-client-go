...
// checks if the FlagLinkPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagLinkPost{}
...
type _FlagLinkPost FlagLinkPost
...
func (o FlagLinkPost) ToMap() (map[string]interface{}, error) {
...
func (o *FlagLinkPost) UnmarshalJSON(data []byte) (err error) {
	varFlagLinkPost := _FlagLinkPost{}

	err = json.Unmarshal(data, &varFlagLinkPost)

	if err != nil {
		return err
	}

	*o = FlagLinkPost(varFlagLinkPost)
