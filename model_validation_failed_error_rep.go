...
// checks if the ValidationFailedErrorRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidationFailedErrorRep{}
...
type _ValidationFailedErrorRep ValidationFailedErrorRep
...
func (o ValidationFailedErrorRep) ToMap() (map[string]interface{}, error) {
...
func (o *ValidationFailedErrorRep) UnmarshalJSON(data []byte) (err error) {
	...
	varValidationFailedErrorRep := _ValidationFailedErrorRep{}

	err = json.Unmarshal(data, &varValidationFailedErrorRep)

	if err != nil {
		return err
	}

	*o = ValidationFailedErrorRep(varValidationFailedErrorRep)
