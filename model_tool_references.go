...
// checks if the ToolReferences type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ToolReferences{}

// ToolReferences struct for ToolReferences
...
type _ToolReferences ToolReferences
...
func (o ToolReferences) MarshalJSON() ([]byte, error) {
...
func (o ToolReferences) ToMap() (map[string]interface{}, error) {
...
func (o *ToolReferences) UnmarshalJSON(data []byte) (err error) {
	...
	varToolReferences := _ToolReferences{}

	err = json.Unmarshal(data, &varToolReferences)

	if err != nil {
		return err
	}

	*o = ToolReferences(varToolReferences)
...
type NullableToolReferences struct {
	value *ToolReferences
	isSet bool
}

func (v NullableToolReferences) Get() *ToolReferences {
	return v.value
}

func (v *NullableToolReferences) Set(val *ToolReferences) {
	v.value = val
	v.isSet = true
}

func (v NullableToolReferences) IsSet() bool {
	return v.isSet
}

func (v *NullableToolReferences) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableToolReferences(val *ToolReferences) *NullableToolReferences {
	return &NullableToolReferences{value: val, isSet: true}
}

func (v NullableToolReferences) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableToolReferences) UnmarshalJSON(src []byte) error {
	v.isSet = true
