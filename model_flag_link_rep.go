...
// checks if the FlagLinkRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagLinkRep{}
...
func (o FlagLinkRep) ToMap() (map[string]interface{}, error) {
...
func (o *FlagLinkRep) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagLinkRep := _FlagLinkRep{}

	err = json.Unmarshal(data, &varFlagLinkRep)

	if err != nil {
		return err
	}

	*o = FlagLinkRep(varFlagLinkRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_deepLink")
