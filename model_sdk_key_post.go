...
// checks if the SdkKeyPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdkKeyPost{}

// SdkKeyPost struct for SdkKeyPost
type SdkKeyPost struct {
...
func (o SdkKeyPost) MarshalJSON() ([]byte, error) {
...
func (o SdkKeyPost) ToMap() (map[string]interface{}, error) {
...
func (o *SdkKeyPost) UnmarshalJSON(data []byte) (err error) {
	...
	varSdkKeyPost := _SdkKeyPost{}

	err = json.Unmarshal(data, &varSdkKeyPost)

	if err != nil {
		return err
	}

	*o = SdkKeyPost(varSdkKeyPost)
...
type NullableSdkKeyPost struct {
	value *SdkKeyPost
	isSet bool
}

func (v NullableSdkKeyPost) Get() *SdkKeyPost {
	return v.value
}

func (v *NullableSdkKeyPost) Set(val *SdkKeyPost) {
	v.value = val
	v.isSet = true
}

func (v NullableSdkKeyPost) IsSet() bool {
	return v.isSet
}

func (v *NullableSdkKeyPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdkKeyPost(val *SdkKeyPost) *NullableSdkKeyPost {
	return &NullableSdkKeyPost{value: val, isSet: true}
}

func (v NullableSdkKeyPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdkKeyPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
