...
// checks if the ParameterRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParameterRep{}
...
type _ParameterRep ParameterRep
...
func (o ParameterRep) ToMap() (map[string]interface{}, error) {
...
func (o *ParameterRep) UnmarshalJSON(data []byte) (err error) {
	varParameterRep := _ParameterRep{}

	err = json.Unmarshal(data, &varParameterRep)

	if err != nil {
		return err
	}

	*o = ParameterRep(varParameterRep)
...
func NewNullableParameterRep(val *ParameterRep) *NullableParameterRep {
	return &NullableParameterRep{value: val, isSet: true}
}
