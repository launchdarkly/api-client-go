...
// checks if the InsightGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightGroup{}
...
type _InsightGroup InsightGroup
...
func (o InsightGroup) ToMap() (map[string]interface{}, error) {
...
func (o *InsightGroup) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightGroup := _InsightGroup{}

	err = json.Unmarshal(data, &varInsightGroup)

	if err != nil {
		return err
	}

	*o = InsightGroup(varInsightGroup)
