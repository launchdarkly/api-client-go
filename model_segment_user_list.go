...
// checks if the SegmentUserList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SegmentUserList{}
...
type _SegmentUserList SegmentUserList
...
func (o SegmentUserList) ToMap() (map[string]interface{}, error) {
...
func (o *SegmentUserList) UnmarshalJSON(data []byte) (err error) {
	varSegmentUserList := _SegmentUserList{}

	err = json.Unmarshal(data, &varSegmentUserList)

	if err != nil {
		return err
	}

	*o = SegmentUserList(varSegmentUserList)
