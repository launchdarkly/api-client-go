...
// checks if the MetricDenominatorRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricDenominatorRep{}

// MetricDenominatorRep struct for MetricDenominatorRep
type MetricDenominatorRep struct {
...
type _MetricDenominatorRep MetricDenominatorRep
...
func (o MetricDenominatorRep) MarshalJSON() ([]byte, error) {
...
func (o MetricDenominatorRep) ToMap() (map[string]interface{}, error) {
...
func (o *MetricDenominatorRep) UnmarshalJSON(data []byte) (err error) {
	varMetricDenominatorRep := _MetricDenominatorRep{}

	err = json.Unmarshal(data, &varMetricDenominatorRep)

	if err != nil {
		return err
	}

	*o = MetricDenominatorRep(varMetricDenominatorRep)
...
type NullableMetricDenominatorRep struct {
	value *MetricDenominatorRep
	isSet bool
}

func (v NullableMetricDenominatorRep) Get() *MetricDenominatorRep {
	return v.value
}

func (v *NullableMetricDenominatorRep) Set(val *MetricDenominatorRep) {
	v.value = val
	v.isSet = true
}

func (v NullableMetricDenominatorRep) IsSet() bool {
	return v.isSet
}

func (v *NullableMetricDenominatorRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetricDenominatorRep(val *MetricDenominatorRep) *NullableMetricDenominatorRep {
	return &NullableMetricDenominatorRep{value: val, isSet: true}
}

func (v NullableMetricDenominatorRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetricDenominatorRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
