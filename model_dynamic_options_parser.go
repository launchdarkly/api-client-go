...
// checks if the DynamicOptionsParser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DynamicOptionsParser{}

// DynamicOptionsParser struct for DynamicOptionsParser
type DynamicOptionsParser struct {
	OptionsItems *OptionsArray `json:"optionsItems,omitempty"`
	OptionsPath *string `json:"optionsPath,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DynamicOptionsParser DynamicOptionsParser
...
// GetOptionsItems returns the OptionsItems field value if set, zero value otherwise.
func (o *DynamicOptionsParser) GetOptionsItems() OptionsArray {
	if o == nil || IsNil(o.OptionsItems) {
		var ret OptionsArray
		return ret
	}
	return *o.OptionsItems
}

// GetOptionsItemsOk returns a tuple with the OptionsItems field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DynamicOptionsParser) GetOptionsItemsOk() (*OptionsArray, bool) {
	if o == nil || IsNil(o.OptionsItems) {
		return nil, false
	}
	return o.OptionsItems, true
}
...
// SetOptionsItems gets a reference to the given OptionsArray and assigns it to the OptionsItems field.
func (o *DynamicOptionsParser) SetOptionsItems(v OptionsArray) {
	o.OptionsItems = &v
}

// GetOptionsPath returns the OptionsPath field value if set, zero value otherwise.
func (o *DynamicOptionsParser) GetOptionsPath() string {
	if o == nil || IsNil(o.OptionsPath) {
		var ret string
		return ret
	}
	return *o.OptionsPath
}

// GetOptionsPathOk returns a tuple with the OptionsPath field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DynamicOptionsParser) GetOptionsPathOk() (*string, bool) {
	if o == nil || IsNil(o.OptionsPath) {
		return nil, false
	}
	return o.OptionsPath, true
}
...
// SetOptionsPath gets a reference to the given string and assigns it to the OptionsPath field.
func (o *DynamicOptionsParser) SetOptionsPath(v string) {
	o.OptionsPath = &v
}

func (o DynamicOptionsParser) MarshalJSON() ([]byte, error) {
...
func (o DynamicOptionsParser) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.OptionsItems) {
		toSerialize["optionsItems"] = o.OptionsItems
	}
	if !IsNil(o.OptionsPath) {
		toSerialize["optionsPath"] = o.OptionsPath
	}
...
func (o *DynamicOptionsParser) UnmarshalJSON(data []byte) (err error) {
	varDynamicOptionsParser := _DynamicOptionsParser{}

	err = json.Unmarshal(data, &varDynamicOptionsParser)

	if err != nil {
		return err
	}

	*o = DynamicOptionsParser(varDynamicOptionsParser)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "optionsItems")
		delete(additionalProperties, "optionsPath")
...
type NullableDynamicOptionsParser struct {
	value *DynamicOptionsParser
	isSet bool
}

func (v NullableDynamicOptionsParser) Get() *DynamicOptionsParser {
	return v.value
}

func (v *NullableDynamicOptionsParser) Set(val *DynamicOptionsParser) {
	v.value = val
	v.isSet = true
}

func (v NullableDynamicOptionsParser) IsSet() bool {
	return v.isSet
}

func (v *NullableDynamicOptionsParser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDynamicOptionsParser(val *DynamicOptionsParser) *NullableDynamicOptionsParser {
	return &NullableDynamicOptionsParser{value: val, isSet: true}
}

func (v NullableDynamicOptionsParser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDynamicOptionsParser) UnmarshalJSON(src []byte) error {
	v.isSet = true
