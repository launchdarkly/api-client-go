...
// checks if the ApplicationRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationRep{}
...
type ApplicationRep struct {
	...
	Maintainer *ApplicationMaintainerRep `json:"_maintainer,omitempty"`
	// The name of the application
	Name string `json:"name"`
	AdditionalProperties map[string]interface{}
}

type _ApplicationRep ApplicationRep
...
func (o *ApplicationRep) GetMaintainer() ApplicationMaintainerRep {
	if o == nil || IsNil(o.Maintainer) {
		var ret ApplicationMaintainerRep
		return ret
	}
	return *o.Maintainer
}
...
// SetMaintainer gets a reference to the given ApplicationMaintainerRep and assigns it to the Maintainer field.
...
func (o ApplicationRep) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationRep) UnmarshalJSON(data []byte) (err error) {
	...
	varApplicationRep := _ApplicationRep{}

	err = json.Unmarshal(data, &varApplicationRep)

	if err != nil {
		return err
	}

	*o = ApplicationRep(varApplicationRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "autoAdded")
