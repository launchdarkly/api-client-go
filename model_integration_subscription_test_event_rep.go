...
// IntegrationSubscriptionTestEventRep struct for IntegrationSubscriptionTestEventRep
type IntegrationSubscriptionTestEventRep struct {
...
func NewIntegrationSubscriptionTestEventRep() *IntegrationSubscriptionTestEventRep {
	this := IntegrationSubscriptionTestEventRep{}
	return &this
}
...
func (o IntegrationSubscriptionTestEventRep) MarshalJSON() ([]byte, error) {
...
type NullableIntegrationSubscriptionTestEventRep struct {
	value *IntegrationSubscriptionTestEventRep
	isSet bool
}

func (v NullableIntegrationSubscriptionTestEventRep) Get() *IntegrationSubscriptionTestEventRep {
	return v.value
}

func (v *NullableIntegrationSubscriptionTestEventRep) Set(val *IntegrationSubscriptionTestEventRep) {
	v.value = val
	v.isSet = true
}

func (v NullableIntegrationSubscriptionTestEventRep) IsSet() bool {
	return v.isSet
}

func (v *NullableIntegrationSubscriptionTestEventRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntegrationSubscriptionTestEventRep(val *IntegrationSubscriptionTestEventRep) *NullableIntegrationSubscriptionTestEventRep {
	return &NullableIntegrationSubscriptionTestEventRep{value: val, isSet: true}
}

func (v NullableIntegrationSubscriptionTestEventRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntegrationSubscriptionTestEventRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
