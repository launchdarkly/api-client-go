...
// checks if the FlagEventExperiment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagEventExperiment{}
...
type _FlagEventExperiment FlagEventExperiment
...
func (o FlagEventExperiment) ToMap() (map[string]interface{}, error) {
...
func (o *FlagEventExperiment) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagEventExperiment := _FlagEventExperiment{}

	err = json.Unmarshal(data, &varFlagEventExperiment)

	if err != nil {
		return err
	}

	*o = FlagEventExperiment(varFlagEventExperiment)
