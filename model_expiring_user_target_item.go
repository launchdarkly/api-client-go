...
// checks if the ExpiringUserTargetItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpiringUserTargetItem{}
...
type _ExpiringUserTargetItem ExpiringUserTargetItem
...
func (o ExpiringUserTargetItem) ToMap() (map[string]interface{}, error) {
...
func (o *ExpiringUserTargetItem) UnmarshalJSON(data []byte) (err error) {
	...
	varExpiringUserTargetItem := _ExpiringUserTargetItem{}

	err = json.Unmarshal(data, &varExpiringUserTargetItem)

	if err != nil {
		return err
	}

	*o = ExpiringUserTargetItem(varExpiringUserTargetItem)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_resourceId")
