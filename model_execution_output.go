...
// checks if the ExecutionOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExecutionOutput{}
...
type _ExecutionOutput ExecutionOutput
...
func (o ExecutionOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ExecutionOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varExecutionOutput := _ExecutionOutput{}

	err = json.Unmarshal(data, &varExecutionOutput)

	if err != nil {
		return err
	}

	*o = ExecutionOutput(varExecutionOutput)
...
func NewNullableExecutionOutput(val *ExecutionOutput) *NullableExecutionOutput {
	return &NullableExecutionOutput{value: val, isSet: true}
}
