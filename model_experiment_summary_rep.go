...
func (o *ExperimentSummaryRep) GetLinks() map[string]Link {
...
// and a boolean to check if the value has been set.
func (o *ExperimentSummaryRep) GetLinksOk() (*map[string]Link, bool) {
	if o == nil || o.Links == nil {
		return nil, false
	}
	return o.Links, true
...
func (o *ExperimentSummaryRep) SetLinks(v map[string]Link) {
	o.Links = &v
}
