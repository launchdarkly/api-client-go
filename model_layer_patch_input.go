...
// checks if the LayerPatchInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LayerPatchInput{}
...
type _LayerPatchInput LayerPatchInput
...
func (o LayerPatchInput) ToMap() (map[string]interface{}, error) {
...
func (o *LayerPatchInput) UnmarshalJSON(data []byte) (err error) {
	...
	varLayerPatchInput := _LayerPatchInput{}

	err = json.Unmarshal(data, &varLayerPatchInput)

	if err != nil {
		return err
	}

	*o = LayerPatchInput(varLayerPatchInput)
