...
*/
func (a *AccountUsageBetaApiService) GetEvaluationsUsage(ctx _context.Context, projectKey string, environmentKey string, featureFlagKey string) ApiGetEvaluationsUsageRequest {
	return ApiGetEvaluationsUsageRequest{
		ApiService: a,
		ctx: ctx,
