...
type ApiGetCCMUsageRequest struct {
	ctx context.Context
...
func (r ApiGetCCMUsageRequest) From(from string) ApiGetCCMUsageRequest {
	r.from = &from
	return r
}

// The series of data returned ends at this timestamp (Unix seconds). Defaults to the current time.
func (r ApiGetCCMUsageRequest) To(to string) ApiGetCCMUsageRequest {
	r.to = &to
	return r
}

func (r ApiGetCCMUsageRequest) Execute() (*SeriesIntervalsRep, *http.Response, error) {
	return r.ApiService.GetCCMUsageExecute(r)
}

/*
GetCCMUsage Get client connection minutes usage

Get a time-series array of the quantity and duration of client side connections to our APIs. The granularity is always daily, with a maximum of 31 days.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetCCMUsageRequest
*/
func (a *AccountUsageBetaApiService) GetCCMUsage(ctx context.Context) ApiGetCCMUsageRequest {
	return ApiGetCCMUsageRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AccountUsageBetaApiService) GetCCMUsageExecute(r ApiGetCCMUsageRequest) (*SeriesIntervalsRep, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetCCMUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/usage/ccm"
...
type ApiGetCMCIUsageRequest struct {
	ctx context.Context
	ApiService *AccountUsageBetaApiService
	from *string
	to *string
...
// The series of data returned starts from this timestamp (Unix seconds). Defaults to the beginning of the current month.
func (r ApiGetCMCIUsageRequest) From(from string) ApiGetCMCIUsageRequest {
	r.from = &from
	return r
}

// The series of data returned ends at this timestamp (Unix seconds). Defaults to the current time.
func (r ApiGetCMCIUsageRequest) To(to string) ApiGetCMCIUsageRequest {
	r.to = &to
	return r
}

func (r ApiGetCMCIUsageRequest) Execute() (*SeriesIntervalsRep, *http.Response, error) {
	return r.ApiService.GetCMCIUsageExecute(r)
}

/*
GetCMCIUsage Get client-side monthly context instances usage

Get a time-series array of the number of monthly context instances from your account. The granularity is always daily, with a maximum of 31 days.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetCMCIUsageRequest
*/
func (a *AccountUsageBetaApiService) GetCMCIUsage(ctx context.Context) ApiGetCMCIUsageRequest {
	return ApiGetCMCIUsageRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SeriesIntervalsRep
func (a *AccountUsageBetaApiService) GetCMCIUsageExecute(r ApiGetCMCIUsageRequest) (*SeriesIntervalsRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetCMCIUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/usage/cmci"
...
type ApiGetSCMUsageRequest struct {
	ctx context.Context
	ApiService *AccountUsageBetaApiService
	from *string
	to *string
...
// The series of data returned starts from this timestamp (Unix seconds). Defaults to the beginning of the current month.
func (r ApiGetSCMUsageRequest) From(from string) ApiGetSCMUsageRequest {
	r.from = &from
	return r
}

// The series of data returned ends at this timestamp (Unix seconds). Defaults to the current time.
func (r ApiGetSCMUsageRequest) To(to string) ApiGetSCMUsageRequest {
	r.to = &to
	return r
}

func (r ApiGetSCMUsageRequest) Execute() (*SeriesIntervalsRep, *http.Response, error) {
	return r.ApiService.GetSCMUsageExecute(r)
}

/*
GetSCMUsage Get server connection minutes usage

Get a time-series array of the quantity and duration of server side connections to our APIs. The granularity is always daily, with a maximum of 31 days.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetSCMUsageRequest
*/
func (a *AccountUsageBetaApiService) GetSCMUsage(ctx context.Context) ApiGetSCMUsageRequest {
	return ApiGetSCMUsageRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SeriesIntervalsRep
func (a *AccountUsageBetaApiService) GetSCMUsageExecute(r ApiGetSCMUsageRequest) (*SeriesIntervalsRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetSCMUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/usage/scm"
