...
type AccountUsageBetaApi interface {
	...
	/*
	GetAIRunsUsage Get AI runs usage
	...
	@return ApiGetAIRunsUsageRequest
	*/
	GetAIRunsUsage(ctx context.Context) ApiGetAIRunsUsageRequest

	// GetAIRunsUsageExecute executes the request
	//  @return SeriesListRep
	GetAIRunsUsageExecute(r ApiGetAIRunsUsageRequest) (*SeriesListRep, *http.Response, error)
	...
	*/
	...
	/*
	GetSdkAllVersions Get usage details for all SDK versions
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetSdkAllVersionsRequest
	*/
	GetSdkAllVersions(ctx context.Context) ApiGetSdkAllVersionsRequest

	// GetSdkAllVersionsExecute executes the request
	//  @return []SdkVersionDetailsRep
	GetSdkAllVersionsExecute(r ApiGetSdkAllVersionsRequest) ([]SdkVersionDetailsRep, *http.Response, error)
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetSdkVersionsDetailsRequest
	*/
	GetSdkVersionsDetails(ctx context.Context) ApiGetSdkVersionsDetailsRequest

	// GetSdkVersionsDetailsExecute executes the request
	//  @return []SdkVersionDetailsRep
	GetSdkVersionsDetailsExecute(r ApiGetSdkVersionsDetailsRequest) ([]SdkVersionDetailsRep, *http.Response, error)
	...
	*/
	...
	/*
	GetWarehouseExportUsage Get warehouse Data Export usage
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetWarehouseExportUsageRequest
	*/
	GetWarehouseExportUsage(ctx context.Context) ApiGetWarehouseExportUsageRequest

	// GetWarehouseExportUsageExecute executes the request
	//  @return SeriesListRep
	GetWarehouseExportUsageExecute(r ApiGetWarehouseExportUsageRequest) (*SeriesListRep, *http.Response, error)
}

// AccountUsageBetaApiService AccountUsageBetaApi service
type AccountUsageBetaApiService service

type ApiGetAIRunsUsageRequest struct {
	ctx context.Context
...
func (r ApiGetAIRunsUsageRequest) From(from string) ApiGetAIRunsUsageRequest {
	r.from = &from
	return r
}

// The series of data returned ends at this timestamp (Unix milliseconds). Defaults to the current time.
func (r ApiGetAIRunsUsageRequest) To(to string) ApiGetAIRunsUsageRequest {
	r.to = &to
	return r
}

// A project key to filter results by. Can be specified multiple times, one query parameter per project key.
func (r ApiGetAIRunsUsageRequest) ProjectKey(projectKey string) ApiGetAIRunsUsageRequest {
...
func (r ApiGetAIRunsUsageRequest) EnvironmentKey(environmentKey string) ApiGetAIRunsUsageRequest {
...
func (r ApiGetAIRunsUsageRequest) SdkName(sdkName string) ApiGetAIRunsUsageRequest {
	r.sdkName = &sdkName
	return r
}

// An SDK version to filter results by. Can be specified multiple times, one query parameter per SDK version.
func (r ApiGetAIRunsUsageRequest) SdkVersion(sdkVersion string) ApiGetAIRunsUsageRequest {
	r.sdkVersion = &sdkVersion
	return r
}

// An SDK type to filter results by. Can be specified multiple times, one query parameter per SDK type.
func (r ApiGetAIRunsUsageRequest) SdkType(sdkType string) ApiGetAIRunsUsageRequest {
	r.sdkType = &sdkType
	return r
}
...
func (r ApiGetAIRunsUsageRequest) GroupBy(groupBy string) ApiGetAIRunsUsageRequest {
	r.groupBy = &groupBy
	return r
}

// Specifies the aggregation method. Defaults to &#x60;month_to_date&#x60;.&lt;br/&gt;Valid values: &#x60;month_to_date&#x60;, &#x60;incremental&#x60;.
func (r ApiGetAIRunsUsageRequest) AggregationType(aggregationType string) ApiGetAIRunsUsageRequest {
...
func (r ApiGetAIRunsUsageRequest) Granularity(granularity string) ApiGetAIRunsUsageRequest {
	r.granularity = &granularity
	return r
}

func (r ApiGetAIRunsUsageRequest) Execute() (*SeriesListRep, *http.Response, error) {
	return r.ApiService.GetAIRunsUsageExecute(r)
}
...
Get a time series array showing the number of AI runs recorded for your account. The supported granularity varies by aggregation type. The maximum time range is 365 days.
 ...
 @return ApiGetAIRunsUsageRequest
*/
func (a *AccountUsageBetaApiService) GetAIRunsUsage(ctx context.Context) ApiGetAIRunsUsageRequest {
	return ApiGetAIRunsUsageRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return SeriesListRep
func (a *AccountUsageBetaApiService) GetAIRunsUsageExecute(r ApiGetAIRunsUsageRequest) (*SeriesListRep, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetAIRunsUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/usage/ai-runs"
...
type ApiGetSdkAllVersionsRequest struct {
	ctx context.Context
	ApiService AccountUsageBetaApi
...
func (r ApiGetSdkAllVersionsRequest) EnvironmentId(environmentId string) ApiGetSdkAllVersionsRequest {
	r.environmentId = &environmentId
	return r
}

// Filter to a specific project ID.
func (r ApiGetSdkAllVersionsRequest) ProjectId(projectId string) ApiGetSdkAllVersionsRequest {
	r.projectId = &projectId
	return r
}

// Filter to a specific SDK name.
func (r ApiGetSdkAllVersionsRequest) SdkName(sdkName string) ApiGetSdkAllVersionsRequest {
	r.sdkName = &sdkName
	return r
}

// Filter to a specific SDK type (for example, &#39;server&#39;, &#39;browser&#39;, &#39;mobile&#39;).
func (r ApiGetSdkAllVersionsRequest) SdkType(sdkType string) ApiGetSdkAllVersionsRequest {
	r.sdkType = &sdkType
	return r
}

// Filter to a specific SDK application ID.
func (r ApiGetSdkAllVersionsRequest) SdkAppId(sdkAppId string) ApiGetSdkAllVersionsRequest {
	r.sdkAppId = &sdkAppId
	return r
}

// Filter to a specific connection type (for example, &#39;direct&#39;, &#39;proxy&#39;).
func (r ApiGetSdkAllVersionsRequest) ConnectionType(connectionType string) ApiGetSdkAllVersionsRequest {
	r.connectionType = &connectionType
	return r
}

func (r ApiGetSdkAllVersionsRequest) Execute() ([]SdkVersionDetailsRep, *http.Response, error) {
	return r.ApiService.GetSdkAllVersionsExecute(r)
}
...
Get detailed SDK version usage data for all versions observed in the last 24 hours in your account. Unlike the `/details` endpoint which returns only the max version per SDK, this endpoint returns all SDK versions for the specified filters. This data is refreshed hourly.<br/><br/>All query parameters are optional, allowing you to filter results as broadly or narrowly as needed.
 ...
 @return ApiGetSdkAllVersionsRequest
*/
func (a *AccountUsageBetaApiService) GetSdkAllVersions(ctx context.Context) ApiGetSdkAllVersionsRequest {
	return ApiGetSdkAllVersionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []SdkVersionDetailsRep
func (a *AccountUsageBetaApiService) GetSdkAllVersionsExecute(r ApiGetSdkAllVersionsRequest) ([]SdkVersionDetailsRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []SdkVersionDetailsRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetSdkAllVersions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/usage/sdk-versions/all"
	...
	if r.sdkAppId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sdkAppId", r.sdkAppId, "form", "")
	}
...
type ApiGetSdkVersionsDetailsRequest struct {
	ctx context.Context
	ApiService AccountUsageBetaApi
}

func (r ApiGetSdkVersionsDetailsRequest) Execute() ([]SdkVersionDetailsRep, *http.Response, error) {
	return r.ApiService.GetSdkVersionsDetailsExecute(r)
}
...
Get detailed SDK version usage data for your account, including version information, EOL status, and relay proxy metadata. Refreshed hourly, returns the max version for each SDK observed in the last 24 hours, including those without EOL metadata available.<br/><br/>This endpoint provides comprehensive information about SDK versions in use across your projects and environments.
 ...
 @return ApiGetSdkVersionsDetailsRequest
*/
func (a *AccountUsageBetaApiService) GetSdkVersionsDetails(ctx context.Context) ApiGetSdkVersionsDetailsRequest {
	return ApiGetSdkVersionsDetailsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []SdkVersionDetailsRep
func (a *AccountUsageBetaApiService) GetSdkVersionsDetailsExecute(r ApiGetSdkVersionsDetailsRequest) ([]SdkVersionDetailsRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetSdkVersionsDetails")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/usage/sdk-versions/details"
...
func (r ApiGetServiceConnectionsUsageRequest) SdkAppId(sdkAppId string) ApiGetServiceConnectionsUsageRequest {
	r.sdkAppId = &sdkAppId
	return r
}
...
type ApiGetWarehouseExportUsageRequest struct {
	ctx context.Context
	ApiService AccountUsageBetaApi
	from *string
	to *string
...
// The series of data returned starts from this timestamp (Unix milliseconds). Defaults to the beginning of the current month.
func (r ApiGetWarehouseExportUsageRequest) From(from string) ApiGetWarehouseExportUsageRequest {
	r.from = &from
	return r
}

// The series of data returned ends at this timestamp (Unix milliseconds). Defaults to the current time.
func (r ApiGetWarehouseExportUsageRequest) To(to string) ApiGetWarehouseExportUsageRequest {
	r.to = &to
	return r
}

// A project key to filter results by. Can be specified multiple times, one query parameter per project key.
func (r ApiGetWarehouseExportUsageRequest) ProjectKey(projectKey string) ApiGetWarehouseExportUsageRequest {
	r.projectKey = &projectKey
	return r
}

// An environment key to filter results by. If specified, exactly one &#x60;projectKey&#x60; must be provided. Can be specified multiple times, one query parameter per environment key.
func (r ApiGetWarehouseExportUsageRequest) EnvironmentKey(environmentKey string) ApiGetWarehouseExportUsageRequest {
	r.environmentKey = &environmentKey
	return r
}
...
func (r ApiGetWarehouseExportUsageRequest) Destination(destination string) ApiGetWarehouseExportUsageRequest {
...
func (r ApiGetWarehouseExportUsageRequest) GroupBy(groupBy string) ApiGetWarehouseExportUsageRequest {
	r.groupBy = &groupBy
	return r
}

// Specifies the aggregation method. Defaults to &#x60;month_to_date&#x60;.&lt;br/&gt;Valid values: &#x60;month_to_date&#x60;, &#x60;incremental&#x60;.
func (r ApiGetWarehouseExportUsageRequest) AggregationType(aggregationType string) ApiGetWarehouseExportUsageRequest {
	r.aggregationType = &aggregationType
	return r
}

// Specifies the data granularity. Defaults to &#x60;daily&#x60;. &#x60;monthly&#x60; granularity is only supported with the **month_to_date** aggregation type.&lt;br/&gt;Valid values: &#x60;daily&#x60;, &#x60;hourly&#x60;, &#x60;monthly&#x60;.
func (r ApiGetWarehouseExportUsageRequest) Granularity(granularity string) ApiGetWarehouseExportUsageRequest {
	r.granularity = &granularity
	return r
}

func (r ApiGetWarehouseExportUsageRequest) Execute() (*SeriesListRep, *http.Response, error) {
	return r.ApiService.GetWarehouseExportUsageExecute(r)
}
...
Get a time series array showing the number of rows exported to your warehouse Data Export destinations. The supported granularity varies by aggregation type. The maximum time range is 365 days.
 ...
 @return ApiGetWarehouseExportUsageRequest
*/
func (a *AccountUsageBetaApiService) GetWarehouseExportUsage(ctx context.Context) ApiGetWarehouseExportUsageRequest {
	return ApiGetWarehouseExportUsageRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SeriesListRep
func (a *AccountUsageBetaApiService) GetWarehouseExportUsageExecute(r ApiGetWarehouseExportUsageRequest) (*SeriesListRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountUsageBetaApiService.GetWarehouseExportUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/usage/warehouse-export"
