...
// checks if the OptionsArray type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OptionsArray{}

// OptionsArray struct for OptionsArray
...
type _OptionsArray OptionsArray
...
func (o OptionsArray) MarshalJSON() ([]byte, error) {
...
func (o OptionsArray) ToMap() (map[string]interface{}, error) {
...
func (o *OptionsArray) UnmarshalJSON(data []byte) (err error) {
	varOptionsArray := _OptionsArray{}

	err = json.Unmarshal(data, &varOptionsArray)

	if err != nil {
		return err
	}

	*o = OptionsArray(varOptionsArray)
...
type NullableOptionsArray struct {
	value *OptionsArray
	isSet bool
}

func (v NullableOptionsArray) Get() *OptionsArray {
	return v.value
}

func (v *NullableOptionsArray) Set(val *OptionsArray) {
	v.value = val
	v.isSet = true
}

func (v NullableOptionsArray) IsSet() bool {
	return v.isSet
}

func (v *NullableOptionsArray) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOptionsArray(val *OptionsArray) *NullableOptionsArray {
	return &NullableOptionsArray{value: val, isSet: true}
}

func (v NullableOptionsArray) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOptionsArray) UnmarshalJSON(src []byte) error {
	v.isSet = true
