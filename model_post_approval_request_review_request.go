...
// checks if the PostApprovalRequestReviewRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostApprovalRequestReviewRequest{}
...
type _PostApprovalRequestReviewRequest PostApprovalRequestReviewRequest
...
func (o PostApprovalRequestReviewRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PostApprovalRequestReviewRequest) UnmarshalJSON(data []byte) (err error) {
	varPostApprovalRequestReviewRequest := _PostApprovalRequestReviewRequest{}

	err = json.Unmarshal(data, &varPostApprovalRequestReviewRequest)

	if err != nil {
		return err
	}

	*o = PostApprovalRequestReviewRequest(varPostApprovalRequestReviewRequest)
