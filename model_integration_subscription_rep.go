...
func NewIntegrationSubscriptionRep() *IntegrationSubscriptionRep {
	this := IntegrationSubscriptionRep{}
	return &this
}
...
func (o IntegrationSubscriptionRep) MarshalJSON() ([]byte, error) {
...
type NullableIntegrationSubscriptionRep struct {
	value *IntegrationSubscriptionRep
	isSet bool
}

func (v NullableIntegrationSubscriptionRep) Get() *IntegrationSubscriptionRep {
	return v.value
}

func (v *NullableIntegrationSubscriptionRep) Set(val *IntegrationSubscriptionRep) {
	v.value = val
	v.isSet = true
}

func (v NullableIntegrationSubscriptionRep) IsSet() bool {
	return v.isSet
}

func (v *NullableIntegrationSubscriptionRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntegrationSubscriptionRep(val *IntegrationSubscriptionRep) *NullableIntegrationSubscriptionRep {
	return &NullableIntegrationSubscriptionRep{value: val, isSet: true}
}

func (v NullableIntegrationSubscriptionRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntegrationSubscriptionRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
