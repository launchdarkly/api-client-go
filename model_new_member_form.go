...
// checks if the NewMemberForm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewMemberForm{}
...
type _NewMemberForm NewMemberForm
...
func (o NewMemberForm) ToMap() (map[string]interface{}, error) {
...
func (o *NewMemberForm) UnmarshalJSON(data []byte) (err error) {
	...
	varNewMemberForm := _NewMemberForm{}

	err = json.Unmarshal(data, &varNewMemberForm)

	if err != nil {
		return err
	}

	*o = NewMemberForm(varNewMemberForm)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "teamKeys")
