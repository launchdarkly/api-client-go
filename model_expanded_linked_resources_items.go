...
// checks if the ExpandedLinkedResourcesItems type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedLinkedResourcesItems{}

// ExpandedLinkedResourcesItems struct for ExpandedLinkedResourcesItems
...
type _ExpandedLinkedResourcesItems ExpandedLinkedResourcesItems
...
func NewExpandedLinkedResourcesItems(flags ExpandedLinkedResourcesFlags) *ExpandedLinkedResourcesItems {
	this := ExpandedLinkedResourcesItems{}
	this.Flags = flags
	return &this
}
...
func (o *ExpandedLinkedResourcesItems) GetFlags() ExpandedLinkedResourcesFlags {
	if o == nil {
		var ret ExpandedLinkedResourcesFlags
		return ret
	}
...
func (o *ExpandedLinkedResourcesItems) GetSegments() ExpandedLinkedResourcesSegments {
	if o == nil || IsNil(o.Segments) {
		var ret ExpandedLinkedResourcesSegments
		return ret
	}
	return *o.Segments
}
...
// SetSegments gets a reference to the given ExpandedLinkedResourcesSegments and assigns it to the Segments field.
...
func (o ExpandedLinkedResourcesItems) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedLinkedResourcesItems) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedLinkedResourcesItems := _ExpandedLinkedResourcesItems{}

	err = json.Unmarshal(data, &varExpandedLinkedResourcesItems)

	if err != nil {
		return err
	}

	*o = ExpandedLinkedResourcesItems(varExpandedLinkedResourcesItems)
...
type NullableExpandedLinkedResourcesItems struct {
	value *ExpandedLinkedResourcesItems
	isSet bool
}

func (v NullableExpandedLinkedResourcesItems) Get() *ExpandedLinkedResourcesItems {
	return v.value
}

func (v *NullableExpandedLinkedResourcesItems) Set(val *ExpandedLinkedResourcesItems) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedLinkedResourcesItems) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedLinkedResourcesItems) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedLinkedResourcesItems(val *ExpandedLinkedResourcesItems) *NullableExpandedLinkedResourcesItems {
	return &NullableExpandedLinkedResourcesItems{value: val, isSet: true}
}

func (v NullableExpandedLinkedResourcesItems) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedLinkedResourcesItems) UnmarshalJSON(src []byte) error {
	v.isSet = true
