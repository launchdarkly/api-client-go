...
// PrivateFeatureStoreResponseRep struct for PrivateFeatureStoreResponseRep
type PrivateFeatureStoreResponseRep struct {
...
func NewPrivateFeatureStoreResponseRep(statusCode int32) *PrivateFeatureStoreResponseRep {
	this := PrivateFeatureStoreResponseRep{}
...
func (o PrivateFeatureStoreResponseRep) MarshalJSON() ([]byte, error) {
...
type NullablePrivateFeatureStoreResponseRep struct {
	value *PrivateFeatureStoreResponseRep
	isSet bool
}

func (v NullablePrivateFeatureStoreResponseRep) Get() *PrivateFeatureStoreResponseRep {
	return v.value
}

func (v *NullablePrivateFeatureStoreResponseRep) Set(val *PrivateFeatureStoreResponseRep) {
	v.value = val
	v.isSet = true
}

func (v NullablePrivateFeatureStoreResponseRep) IsSet() bool {
	return v.isSet
}

func (v *NullablePrivateFeatureStoreResponseRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrivateFeatureStoreResponseRep(val *PrivateFeatureStoreResponseRep) *NullablePrivateFeatureStoreResponseRep {
	return &NullablePrivateFeatureStoreResponseRep{value: val, isSet: true}
}

func (v NullablePrivateFeatureStoreResponseRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrivateFeatureStoreResponseRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
