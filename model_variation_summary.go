...
// checks if the VariationSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VariationSummary{}
...
type _VariationSummary VariationSummary
...
func (o *VariationSummary) GetIsFallthrough() bool {
	if o == nil || IsNil(o.IsFallthrough) {
		var ret bool
		return ret
	}
...
func (o *VariationSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varVariationSummary := _VariationSummary{}

	err = json.Unmarshal(data, &varVariationSummary)

	if err != nil {
		return err
	}

	*o = VariationSummary(varVariationSummary)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "rules")
		delete(additionalProperties, "nullRules")
		delete(additionalProperties, "targets")
		delete(additionalProperties, "contextTargets")
		delete(additionalProperties, "isFallthrough")
		delete(additionalProperties, "isOff")
