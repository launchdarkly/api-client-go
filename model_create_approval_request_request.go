...
type _CreateApprovalRequestRequest CreateApprovalRequestRequest
...
func (o *CreateApprovalRequestRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateApprovalRequestRequest := _CreateApprovalRequestRequest{}

	err = json.Unmarshal(data, &varCreateApprovalRequestRequest)

	if err != nil {
		return err
	}

	*o = CreateApprovalRequestRequest(varCreateApprovalRequestRequest)
