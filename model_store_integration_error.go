...
// checks if the StoreIntegrationError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoreIntegrationError{}
...
type _StoreIntegrationError StoreIntegrationError
...
func (o StoreIntegrationError) ToMap() (map[string]interface{}, error) {
...
func (o *StoreIntegrationError) UnmarshalJSON(data []byte) (err error) {
	varStoreIntegrationError := _StoreIntegrationError{}

	err = json.Unmarshal(data, &varStoreIntegrationError)

	if err != nil {
		return err
	}

	*o = StoreIntegrationError(varStoreIntegrationError)
