...
type FollowFlagsApi interface {
	...
	*/
	DeleteFlagFollowers(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, memberId string) ApiDeleteFlagFollowersRequest

	// DeleteFlagFollowersExecute executes the request
	DeleteFlagFollowersExecute(r ApiDeleteFlagFollowersRequest) (*http.Response, error)
	...
	*/
	PutFlagFollowers(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, memberId string) ApiPutFlagFollowersRequest

	// PutFlagFollowersExecute executes the request
	PutFlagFollowersExecute(r ApiPutFlagFollowersRequest) (*http.Response, error)
}
