...
// checks if the AiConfigsExperimentInfoRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsExperimentInfoRep{}

// AiConfigsExperimentInfoRep struct for AiConfigsExperimentInfoRep
type AiConfigsExperimentInfoRep struct {
	BaselineIdx int32 `json:"baselineIdx"`
	Items []AiConfigsLegacyExperimentRep `json:"items"`
	AdditionalProperties map[string]interface{}
}

type _AiConfigsExperimentInfoRep AiConfigsExperimentInfoRep
...
func NewAiConfigsExperimentInfoRep(baselineIdx int32, items []AiConfigsLegacyExperimentRep) *AiConfigsExperimentInfoRep {
	this := AiConfigsExperimentInfoRep{}
...
// GetBaselineIdxOk returns a tuple with the BaselineIdx field value
...
func (o *AiConfigsExperimentInfoRep) GetItems() []AiConfigsLegacyExperimentRep {
	if o == nil {
		var ret []AiConfigsLegacyExperimentRep
		return ret
	}
...
func (o AiConfigsExperimentInfoRep) MarshalJSON() ([]byte, error) {
...
func (o AiConfigsExperimentInfoRep) ToMap() (map[string]interface{}, error) {
...
func (o *AiConfigsExperimentInfoRep) UnmarshalJSON(data []byte) (err error) {
	...
	varAiConfigsExperimentInfoRep := _AiConfigsExperimentInfoRep{}

	err = json.Unmarshal(data, &varAiConfigsExperimentInfoRep)

	if err != nil {
		return err
	}

	*o = AiConfigsExperimentInfoRep(varAiConfigsExperimentInfoRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "baselineIdx")
...
type NullableAiConfigsExperimentInfoRep struct {
	value *AiConfigsExperimentInfoRep
	isSet bool
}

func (v NullableAiConfigsExperimentInfoRep) Get() *AiConfigsExperimentInfoRep {
	return v.value
}

func (v *NullableAiConfigsExperimentInfoRep) Set(val *AiConfigsExperimentInfoRep) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsExperimentInfoRep) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsExperimentInfoRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsExperimentInfoRep(val *AiConfigsExperimentInfoRep) *NullableAiConfigsExperimentInfoRep {
	return &NullableAiConfigsExperimentInfoRep{value: val, isSet: true}
}

func (v NullableAiConfigsExperimentInfoRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsExperimentInfoRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
