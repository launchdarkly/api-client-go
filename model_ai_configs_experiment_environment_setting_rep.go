...
// checks if the AiConfigsExperimentEnvironmentSettingRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsExperimentEnvironmentSettingRep{}

// AiConfigsExperimentEnvironmentSettingRep struct for AiConfigsExperimentEnvironmentSettingRep
type AiConfigsExperimentEnvironmentSettingRep struct {
	StartDate *int64 `json:"startDate,omitempty"`
	StopDate *int64 `json:"stopDate,omitempty"`
	EnabledPeriods []AiConfigsExperimentEnabledPeriodRep `json:"enabledPeriods,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AiConfigsExperimentEnvironmentSettingRep AiConfigsExperimentEnvironmentSettingRep
...
func NewAiConfigsExperimentEnvironmentSettingRep() *AiConfigsExperimentEnvironmentSettingRep {
	this := AiConfigsExperimentEnvironmentSettingRep{}
	return &this
}
...
func (o *AiConfigsExperimentEnvironmentSettingRep) GetEnabledPeriods() []AiConfigsExperimentEnabledPeriodRep {
	if o == nil || IsNil(o.EnabledPeriods) {
		var ret []AiConfigsExperimentEnabledPeriodRep
		return ret
	}
...
// SetEnabledPeriods gets a reference to the given []AiConfigsExperimentEnabledPeriodRep and assigns it to the EnabledPeriods field.
func (o *AiConfigsExperimentEnvironmentSettingRep) SetEnabledPeriods(v []AiConfigsExperimentEnabledPeriodRep) {
	o.EnabledPeriods = v
}

func (o AiConfigsExperimentEnvironmentSettingRep) MarshalJSON() ([]byte, error) {
...
func (o AiConfigsExperimentEnvironmentSettingRep) ToMap() (map[string]interface{}, error) {
...
func (o *AiConfigsExperimentEnvironmentSettingRep) UnmarshalJSON(data []byte) (err error) {
	varAiConfigsExperimentEnvironmentSettingRep := _AiConfigsExperimentEnvironmentSettingRep{}

	err = json.Unmarshal(data, &varAiConfigsExperimentEnvironmentSettingRep)

	if err != nil {
		return err
	}

	*o = AiConfigsExperimentEnvironmentSettingRep(varAiConfigsExperimentEnvironmentSettingRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "startDate")
		delete(additionalProperties, "stopDate")
		delete(additionalProperties, "enabledPeriods")
...
type NullableAiConfigsExperimentEnvironmentSettingRep struct {
	value *AiConfigsExperimentEnvironmentSettingRep
	isSet bool
}

func (v NullableAiConfigsExperimentEnvironmentSettingRep) Get() *AiConfigsExperimentEnvironmentSettingRep {
	return v.value
}

func (v *NullableAiConfigsExperimentEnvironmentSettingRep) Set(val *AiConfigsExperimentEnvironmentSettingRep) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsExperimentEnvironmentSettingRep) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsExperimentEnvironmentSettingRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsExperimentEnvironmentSettingRep(val *AiConfigsExperimentEnvironmentSettingRep) *NullableAiConfigsExperimentEnvironmentSettingRep {
	return &NullableAiConfigsExperimentEnvironmentSettingRep{value: val, isSet: true}
}

func (v NullableAiConfigsExperimentEnvironmentSettingRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsExperimentEnvironmentSettingRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
