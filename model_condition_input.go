...
// checks if the ConditionInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConditionInput{}
...
type _ConditionInput ConditionInput
...
func (o ConditionInput) ToMap() (map[string]interface{}, error) {
...
func (o *ConditionInput) UnmarshalJSON(data []byte) (err error) {
	varConditionInput := _ConditionInput{}

	err = json.Unmarshal(data, &varConditionInput)

	if err != nil {
		return err
	}

	*o = ConditionInput(varConditionInput)
