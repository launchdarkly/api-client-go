...
// checks if the ContextInstanceSegmentMembership type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextInstanceSegmentMembership{}
...
type _ContextInstanceSegmentMembership ContextInstanceSegmentMembership
...
func (o ContextInstanceSegmentMembership) ToMap() (map[string]interface{}, error) {
...
func (o *ContextInstanceSegmentMembership) UnmarshalJSON(data []byte) (err error) {
	...
	varContextInstanceSegmentMembership := _ContextInstanceSegmentMembership{}

	err = json.Unmarshal(data, &varContextInstanceSegmentMembership)

	if err != nil {
		return err
	}

	*o = ContextInstanceSegmentMembership(varContextInstanceSegmentMembership)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "isIndividuallyTargeted")
		delete(additionalProperties, "isRuleTargeted")
