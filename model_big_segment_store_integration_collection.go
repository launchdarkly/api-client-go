...
// checks if the BigSegmentStoreIntegrationCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BigSegmentStoreIntegrationCollection{}

// BigSegmentStoreIntegrationCollection struct for BigSegmentStoreIntegrationCollection
type BigSegmentStoreIntegrationCollection struct {
	Links BigSegmentStoreIntegrationCollectionLinks `json:"_links"`
	// An array of persistent store integration configurations
	Items []BigSegmentStoreIntegration `json:"items"`
	AdditionalProperties map[string]interface{}
}

type _BigSegmentStoreIntegrationCollection BigSegmentStoreIntegrationCollection
...
func NewBigSegmentStoreIntegrationCollection(links BigSegmentStoreIntegrationCollectionLinks, items []BigSegmentStoreIntegration) *BigSegmentStoreIntegrationCollection {
	this := BigSegmentStoreIntegrationCollection{}
	this.Links = links
	this.Items = items
	return &this
}
...
func (o *BigSegmentStoreIntegrationCollection) GetLinks() BigSegmentStoreIntegrationCollectionLinks {
	if o == nil {
		var ret BigSegmentStoreIntegrationCollectionLinks
		return ret
	}
...
func (o *BigSegmentStoreIntegrationCollection) GetItems() []BigSegmentStoreIntegration {
	if o == nil {
		var ret []BigSegmentStoreIntegration
		return ret
	}
...
func (o BigSegmentStoreIntegrationCollection) ToMap() (map[string]interface{}, error) {
...
func (o *BigSegmentStoreIntegrationCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varBigSegmentStoreIntegrationCollection := _BigSegmentStoreIntegrationCollection{}

	err = json.Unmarshal(data, &varBigSegmentStoreIntegrationCollection)

	if err != nil {
		return err
	}

	*o = BigSegmentStoreIntegrationCollection(varBigSegmentStoreIntegrationCollection)
...
type NullableBigSegmentStoreIntegrationCollection struct {
	value *BigSegmentStoreIntegrationCollection
	isSet bool
}
...
func NewNullableBigSegmentStoreIntegrationCollection(val *BigSegmentStoreIntegrationCollection) *NullableBigSegmentStoreIntegrationCollection {
	return &NullableBigSegmentStoreIntegrationCollection{value: val, isSet: true}
}
