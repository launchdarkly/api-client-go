...
// MigrationMetricRep struct for MigrationMetricRep
type MigrationMetricRep struct {
	Key *string `json:"key,omitempty"`
	Series []map[string]float32 `json:"series,omitempty"`
...
// SetSeries gets a reference to the given []map[string]float32 and assigns it to the Series field.
...
func (o MigrationMetricRep) MarshalJSON() ([]byte, error) {
...
type NullableMigrationMetricRep struct {
	value *MigrationMetricRep
	isSet bool
}

func (v NullableMigrationMetricRep) Get() *MigrationMetricRep {
	return v.value
}

func (v *NullableMigrationMetricRep) Set(val *MigrationMetricRep) {
	v.value = val
	v.isSet = true
}

func (v NullableMigrationMetricRep) IsSet() bool {
	return v.isSet
}

func (v *NullableMigrationMetricRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMigrationMetricRep(val *MigrationMetricRep) *NullableMigrationMetricRep {
	return &NullableMigrationMetricRep{value: val, isSet: true}
}

func (v NullableMigrationMetricRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMigrationMetricRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
