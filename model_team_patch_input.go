...
// checks if the TeamPatchInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamPatchInput{}
...
type _TeamPatchInput TeamPatchInput
...
func (o TeamPatchInput) ToMap() (map[string]interface{}, error) {
...
func (o *TeamPatchInput) UnmarshalJSON(data []byte) (err error) {
	...
	varTeamPatchInput := _TeamPatchInput{}

	err = json.Unmarshal(data, &varTeamPatchInput)

	if err != nil {
		return err
	}

	*o = TeamPatchInput(varTeamPatchInput)
