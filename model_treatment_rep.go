...
// checks if the TreatmentRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TreatmentRep{}
...
type _TreatmentRep TreatmentRep
...
func (o TreatmentRep) ToMap() (map[string]interface{}, error) {
...
func (o *TreatmentRep) UnmarshalJSON(data []byte) (err error) {
	...
	varTreatmentRep := _TreatmentRep{}

	err = json.Unmarshal(data, &varTreatmentRep)

	if err != nil {
		return err
	}

	*o = TreatmentRep(varTreatmentRep)
