...
// checks if the MemberPermissionGrantSummaryRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MemberPermissionGrantSummaryRep{}
...
type _MemberPermissionGrantSummaryRep MemberPermissionGrantSummaryRep
...
func (o MemberPermissionGrantSummaryRep) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ActionSet) {
...
func (o *MemberPermissionGrantSummaryRep) UnmarshalJSON(data []byte) (err error) {
	...
	varMemberPermissionGrantSummaryRep := _MemberPermissionGrantSummaryRep{}

	err = json.Unmarshal(data, &varMemberPermissionGrantSummaryRep)

	if err != nil {
		return err
	}

	*o = MemberPermissionGrantSummaryRep(varMemberPermissionGrantSummaryRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "actionSet")
