...
type Account struct {
	...
	SamlConfig *SamlConfigRep `json:"samlConfig,omitempty"`
	BillingContact *BillingContact `json:"billingContact,omitempty"`
	SessionConfig *SessionCfgRep `json:"sessionConfig,omitempty"`
	Access *Access `json:"_access,omitempty"`
	OwnerEmail *string `json:"ownerEmail,omitempty"`
	EnableAccountImpersonationUntil *int64 `json:"enableAccountImpersonationUntil,omitempty"`
}
...
func (o *Account) GetSamlConfig() SamlConfigRep {
	if o == nil || o.SamlConfig == nil {
		var ret SamlConfigRep
		return ret
	}
	return *o.SamlConfig
}
...
// SetSamlConfig gets a reference to the given SamlConfigRep and assigns it to the SamlConfig field.
...
func (o *Account) GetSessionConfig() SessionCfgRep {
	if o == nil || o.SessionConfig == nil {
		var ret SessionCfgRep
		return ret
	}
...
// SetSessionConfig gets a reference to the given SessionCfgRep and assigns it to the SessionConfig field.
...
// GetEnableAccountImpersonationUntil returns the EnableAccountImpersonationUntil field value if set, zero value otherwise.
func (o *Account) GetEnableAccountImpersonationUntil() int64 {
	if o == nil || o.EnableAccountImpersonationUntil == nil {
		var ret int64
		return ret
	}
	return *o.EnableAccountImpersonationUntil
}

// GetEnableAccountImpersonationUntilOk returns a tuple with the EnableAccountImpersonationUntil field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Account) GetEnableAccountImpersonationUntilOk() (*int64, bool) {
	if o == nil || o.EnableAccountImpersonationUntil == nil {
		return nil, false
	}
	return o.EnableAccountImpersonationUntil, true
}
...
// SetEnableAccountImpersonationUntil gets a reference to the given int64 and assigns it to the EnableAccountImpersonationUntil field.
func (o *Account) SetEnableAccountImpersonationUntil(v int64) {
	o.EnableAccountImpersonationUntil = &v
}
...
func (o Account) MarshalJSON() ([]byte, error) {
	...
	if o.SessionConfig != nil {
		toSerialize["sessionConfig"] = o.SessionConfig
	}
	if o.Access != nil {
	...
	if o.EnableAccountImpersonationUntil != nil {
		toSerialize["enableAccountImpersonationUntil"] = o.EnableAccountImpersonationUntil
	}
