...
// checks if the CustomWorkflowsListingOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomWorkflowsListingOutput{}
...
type _CustomWorkflowsListingOutput CustomWorkflowsListingOutput
...
func (o CustomWorkflowsListingOutput) ToMap() (map[string]interface{}, error) {
...
func (o *CustomWorkflowsListingOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomWorkflowsListingOutput := _CustomWorkflowsListingOutput{}

	err = json.Unmarshal(data, &varCustomWorkflowsListingOutput)

	if err != nil {
		return err
	}

	*o = CustomWorkflowsListingOutput(varCustomWorkflowsListingOutput)
