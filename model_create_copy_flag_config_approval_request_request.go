...
// checks if the CreateCopyFlagConfigApprovalRequestRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCopyFlagConfigApprovalRequestRequest{}
...
type _CreateCopyFlagConfigApprovalRequestRequest CreateCopyFlagConfigApprovalRequestRequest
...
func (o *CreateCopyFlagConfigApprovalRequestRequest) GetNotifyMemberIds() []string {
	if o == nil || IsNil(o.NotifyMemberIds) {
		var ret []string
		return ret
	}
...
func (o *CreateCopyFlagConfigApprovalRequestRequest) GetNotifyTeamKeys() []string {
	if o == nil || IsNil(o.NotifyTeamKeys) {
		var ret []string
		return ret
	}
...
func (o *CreateCopyFlagConfigApprovalRequestRequest) GetIncludedActions() []string {
	if o == nil || IsNil(o.IncludedActions) {
		var ret []string
		return ret
	}
...
func (o *CreateCopyFlagConfigApprovalRequestRequest) GetExcludedActions() []string {
	if o == nil || IsNil(o.ExcludedActions) {
		var ret []string
		return ret
	}
...
func (o CreateCopyFlagConfigApprovalRequestRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Comment) {
		toSerialize["comment"] = o.Comment
	}
	toSerialize["description"] = o.Description
	if !IsNil(o.NotifyMemberIds) {
		toSerialize["notifyMemberIds"] = o.NotifyMemberIds
	}
	if !IsNil(o.NotifyTeamKeys) {
		toSerialize["notifyTeamKeys"] = o.NotifyTeamKeys
	}
	toSerialize["source"] = o.Source
	if !IsNil(o.IncludedActions) {
		toSerialize["includedActions"] = o.IncludedActions
	}
	if !IsNil(o.ExcludedActions) {
...
func (o *CreateCopyFlagConfigApprovalRequestRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateCopyFlagConfigApprovalRequestRequest := _CreateCopyFlagConfigApprovalRequestRequest{}

	err = json.Unmarshal(data, &varCreateCopyFlagConfigApprovalRequestRequest)

	if err != nil {
		return err
	}

	*o = CreateCopyFlagConfigApprovalRequestRequest(varCreateCopyFlagConfigApprovalRequestRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "notifyTeamKeys")
		delete(additionalProperties, "source")
		delete(additionalProperties, "includedActions")
		delete(additionalProperties, "excludedActions")
