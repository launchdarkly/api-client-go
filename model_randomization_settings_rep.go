...
// checks if the RandomizationSettingsRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RandomizationSettingsRep{}
...
type _RandomizationSettingsRep RandomizationSettingsRep
...
func (o RandomizationSettingsRep) ToMap() (map[string]interface{}, error) {
...
func (o *RandomizationSettingsRep) UnmarshalJSON(data []byte) (err error) {
	varRandomizationSettingsRep := _RandomizationSettingsRep{}

	err = json.Unmarshal(data, &varRandomizationSettingsRep)

	if err != nil {
		return err
	}

	*o = RandomizationSettingsRep(varRandomizationSettingsRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "_projectId")
		delete(additionalProperties, "_projectKey")
