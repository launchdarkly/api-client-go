...
// checks if the FlagsSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagsSummary{}

// FlagsSummary struct for FlagsSummary
type FlagsSummary struct {
	Count int32 `json:"count"`
	LinkedFlags *ExpandedDirectlyLinkedFlags `json:"linkedFlags,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _FlagsSummary FlagsSummary
...
// GetLinkedFlags returns the LinkedFlags field value if set, zero value otherwise.
func (o *FlagsSummary) GetLinkedFlags() ExpandedDirectlyLinkedFlags {
	if o == nil || IsNil(o.LinkedFlags) {
		var ret ExpandedDirectlyLinkedFlags
		return ret
	}
	return *o.LinkedFlags
}

// GetLinkedFlagsOk returns a tuple with the LinkedFlags field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlagsSummary) GetLinkedFlagsOk() (*ExpandedDirectlyLinkedFlags, bool) {
	if o == nil || IsNil(o.LinkedFlags) {
		return nil, false
	}
	return o.LinkedFlags, true
}
...
// SetLinkedFlags gets a reference to the given ExpandedDirectlyLinkedFlags and assigns it to the LinkedFlags field.
func (o *FlagsSummary) SetLinkedFlags(v ExpandedDirectlyLinkedFlags) {
	o.LinkedFlags = &v
}

func (o FlagsSummary) MarshalJSON() ([]byte, error) {
...
func (o FlagsSummary) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["count"] = o.Count
	if !IsNil(o.LinkedFlags) {
		toSerialize["linkedFlags"] = o.LinkedFlags
	}
...
func (o *FlagsSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagsSummary := _FlagsSummary{}

	err = json.Unmarshal(data, &varFlagsSummary)

	if err != nil {
		return err
	}

	*o = FlagsSummary(varFlagsSummary)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "count")
		delete(additionalProperties, "linkedFlags")
...
type NullableFlagsSummary struct {
	value *FlagsSummary
	isSet bool
}

func (v NullableFlagsSummary) Get() *FlagsSummary {
	return v.value
}

func (v *NullableFlagsSummary) Set(val *FlagsSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableFlagsSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableFlagsSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlagsSummary(val *FlagsSummary) *NullableFlagsSummary {
	return &NullableFlagsSummary{value: val, isSet: true}
}

func (v NullableFlagsSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlagsSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
