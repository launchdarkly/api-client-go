...
// checks if the ViewResourceSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewResourceSummary{}

// ViewResourceSummary struct for ViewResourceSummary
type ViewResourceSummary struct {
...
type _ViewResourceSummary ViewResourceSummary

// NewViewResourceSummary instantiates a new ViewResourceSummary object
...
func NewViewResourceSummary(flagCount int32, segmentCount int32) *ViewResourceSummary {
	this := ViewResourceSummary{}
	this.FlagCount = flagCount
	this.SegmentCount = segmentCount
	return &this
}

// NewViewResourceSummaryWithDefaults instantiates a new ViewResourceSummary object
...
func (o ViewResourceSummary) MarshalJSON() ([]byte, error) {
...
func (o ViewResourceSummary) ToMap() (map[string]interface{}, error) {
...
func (o *ViewResourceSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varViewResourceSummary := _ViewResourceSummary{}

	err = json.Unmarshal(data, &varViewResourceSummary)

	if err != nil {
		return err
	}

	*o = ViewResourceSummary(varViewResourceSummary)
...
type NullableViewResourceSummary struct {
	value *ViewResourceSummary
	isSet bool
}

func (v NullableViewResourceSummary) Get() *ViewResourceSummary {
	return v.value
}

func (v *NullableViewResourceSummary) Set(val *ViewResourceSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableViewResourceSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableViewResourceSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewResourceSummary(val *ViewResourceSummary) *NullableViewResourceSummary {
	return &NullableViewResourceSummary{value: val, isSet: true}
}

func (v NullableViewResourceSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewResourceSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
