...
// DeletionRequest struct for DeletionRequest
...
func (o DeletionRequest) MarshalJSON() ([]byte, error) {
...
type NullableDeletionRequest struct {
	value *DeletionRequest
	isSet bool
}

func (v NullableDeletionRequest) Get() *DeletionRequest {
	return v.value
}

func (v *NullableDeletionRequest) Set(val *DeletionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeletionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeletionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeletionRequest(val *DeletionRequest) *NullableDeletionRequest {
	return &NullableDeletionRequest{value: val, isSet: true}
}

func (v NullableDeletionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeletionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
