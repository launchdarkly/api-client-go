...
// checks if the FlagReferenceCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagReferenceCollectionRep{}

// FlagReferenceCollectionRep struct for FlagReferenceCollectionRep
type FlagReferenceCollectionRep struct {
	// The total number of flag references
	TotalCount int32 `json:"totalCount"`
	// A list of flag references
	Items []FlagReferenceRep `json:"items"`
	AdditionalProperties map[string]interface{}
}

type _FlagReferenceCollectionRep FlagReferenceCollectionRep
...
func NewFlagReferenceCollectionRep(totalCount int32, items []FlagReferenceRep) *FlagReferenceCollectionRep {
	this := FlagReferenceCollectionRep{}
...
func (o FlagReferenceCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *FlagReferenceCollectionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagReferenceCollectionRep := _FlagReferenceCollectionRep{}

	err = json.Unmarshal(data, &varFlagReferenceCollectionRep)

	if err != nil {
		return err
	}

	*o = FlagReferenceCollectionRep(varFlagReferenceCollectionRep)
...
type NullableFlagReferenceCollectionRep struct {
	value *FlagReferenceCollectionRep
	isSet bool
}
...
func NewNullableFlagReferenceCollectionRep(val *FlagReferenceCollectionRep) *NullableFlagReferenceCollectionRep {
	return &NullableFlagReferenceCollectionRep{value: val, isSet: true}
}
