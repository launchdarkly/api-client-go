...
// checks if the TimestampRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimestampRep{}
...
type _TimestampRep TimestampRep
...
func (o TimestampRep) ToMap() (map[string]interface{}, error) {
...
func (o *TimestampRep) UnmarshalJSON(data []byte) (err error) {
	varTimestampRep := _TimestampRep{}

	err = json.Unmarshal(data, &varTimestampRep)

	if err != nil {
		return err
	}

	*o = TimestampRep(varTimestampRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "rfc3339")
