...
// checks if the SeriesListRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SeriesListRep{}
...
type _SeriesListRep SeriesListRep
...
func (o SeriesListRep) ToMap() (map[string]interface{}, error) {
...
func (o *SeriesListRep) UnmarshalJSON(data []byte) (err error) {
	...
	varSeriesListRep := _SeriesListRep{}

	err = json.Unmarshal(data, &varSeriesListRep)

	if err != nil {
		return err
	}

	*o = SeriesListRep(varSeriesListRep)
