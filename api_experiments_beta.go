...
*/
func (a *ExperimentsBetaApiService) CreateExperiment(ctx _context.Context, projectKey string, environmentKey string) ApiCreateExperimentRequest {
	return ApiCreateExperimentRequest{
		ApiService: a,
		ctx: ctx,
...
func (r ApiCreateIterationRequest) Execute() (IterationRep, *_nethttp.Response, error) {
...
*/
func (a *ExperimentsBetaApiService) CreateIteration(ctx _context.Context, projectKey string, environmentKey string, experimentKey string) ApiCreateIterationRequest {
	return ApiCreateIterationRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return IterationRep
func (a *ExperimentsBetaApiService) CreateIterationExecute(r ApiCreateIterationRequest) (IterationRep, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", _neturl.PathEscape(parameterToString(r.projectKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", _neturl.PathEscape(parameterToString(r.environmentKey, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"experimentKey"+"}", _neturl.PathEscape(parameterToString(r.experimentKey, "")), -1)
...
*/
func (a *ExperimentsBetaApiService) GetExperiment(ctx _context.Context, projectKey string, environmentKey string, experimentKey string) ApiGetExperimentRequest {
	return ApiGetExperimentRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
func (r ApiGetExperimentResultsRequest) Execute() (ExperimentResults, *_nethttp.Response, error) {
...
*/
func (a *ExperimentsBetaApiService) GetExperimentResults(ctx _context.Context, projectKey string, environmentKey string, experimentKey string, metricKey string) ApiGetExperimentResultsRequest {
	return ApiGetExperimentResultsRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
func (a *ExperimentsBetaApiService) GetExperimentResultsExecute(r ApiGetExperimentResultsRequest) (ExperimentResults, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetExperimentsRequest) Execute() (ExperimentCollectionRep, *_nethttp.Response, error) {
...
*/
func (a *ExperimentsBetaApiService) GetExperiments(ctx _context.Context, projectKey string, environmentKey string) ApiGetExperimentsRequest {
	return ApiGetExperimentsRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
func (a *ExperimentsBetaApiService) GetExperimentsExecute(r ApiGetExperimentsRequest) (ExperimentCollectionRep, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiGetLegacyExperimentResultsRequest) Execute() (ExperimentResults, *_nethttp.Response, error) {
...
*/
func (a *ExperimentsBetaApiService) GetLegacyExperimentResults(ctx _context.Context, projectKey string, featureFlagKey string, environmentKey string, metricKey string) ApiGetLegacyExperimentResultsRequest {
	return ApiGetLegacyExperimentResultsRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return ExperimentResults
func (a *ExperimentsBetaApiService) GetLegacyExperimentResultsExecute(r ApiGetLegacyExperimentResultsRequest) (ExperimentResults, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *ExperimentsBetaApiService) PatchExperiment(ctx _context.Context, projectKey string, environmentKey string, experimentKey string) ApiPatchExperimentRequest {
	return ApiPatchExperimentRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
*/
func (a *ExperimentsBetaApiService) ResetExperiment(ctx _context.Context, projectKey string, featureFlagKey string, environmentKey string, metricKey string) ApiResetExperimentRequest {
	return ApiResetExperimentRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
