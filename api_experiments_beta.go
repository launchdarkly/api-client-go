...
*/
func (a *ExperimentsBetaApiService) GetExperiment(ctx _context.Context, projectKey string, featureFlagKey string, environmentKey string, metricKey string) ApiGetExperimentRequest {
	return ApiGetExperimentRequest{
		ApiService: a,
		ctx: ctx,
