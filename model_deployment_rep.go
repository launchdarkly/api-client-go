...
// checks if the DeploymentRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeploymentRep{}
...
type _DeploymentRep DeploymentRep
...
func (o *DeploymentRep) GetLeadTimeStages() LeadTimeStagesRep {
	if o == nil || IsNil(o.LeadTimeStages) {
...
func (o DeploymentRep) ToMap() (map[string]interface{}, error) {
...
func (o *DeploymentRep) UnmarshalJSON(data []byte) (err error) {
	...
	varDeploymentRep := _DeploymentRep{}

	err = json.Unmarshal(data, &varDeploymentRep)

	if err != nil {
		return err
	}

	*o = DeploymentRep(varDeploymentRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "numberOfContributors")
		delete(additionalProperties, "numberOfPullRequests")
		...
		delete(additionalProperties, "leadTimeStages")
