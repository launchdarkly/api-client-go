...
// checks if the InstructionUserRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InstructionUserRequest{}
...
type _InstructionUserRequest InstructionUserRequest
...
func (o InstructionUserRequest) ToMap() (map[string]interface{}, error) {
...
func (o *InstructionUserRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varInstructionUserRequest := _InstructionUserRequest{}

	err = json.Unmarshal(data, &varInstructionUserRequest)

	if err != nil {
		return err
	}

	*o = InstructionUserRequest(varInstructionUserRequest)
