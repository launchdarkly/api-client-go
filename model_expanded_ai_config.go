...
// checks if the ExpandedAIConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedAIConfig{}

// ExpandedAIConfig AI Config representation for Views API - contains only fields actually used by the Views service
type ExpandedAIConfig struct {
...
type _ExpandedAIConfig ExpandedAIConfig
...
func (o ExpandedAIConfig) MarshalJSON() ([]byte, error) {
...
func (o ExpandedAIConfig) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedAIConfig) UnmarshalJSON(data []byte) (err error) {
	varExpandedAIConfig := _ExpandedAIConfig{}

	err = json.Unmarshal(data, &varExpandedAIConfig)

	if err != nil {
		return err
	}

	*o = ExpandedAIConfig(varExpandedAIConfig)
...
type NullableExpandedAIConfig struct {
	value *ExpandedAIConfig
	isSet bool
}

func (v NullableExpandedAIConfig) Get() *ExpandedAIConfig {
	return v.value
}

func (v *NullableExpandedAIConfig) Set(val *ExpandedAIConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedAIConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedAIConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedAIConfig(val *ExpandedAIConfig) *NullableExpandedAIConfig {
	return &NullableExpandedAIConfig{value: val, isSet: true}
}

func (v NullableExpandedAIConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedAIConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
