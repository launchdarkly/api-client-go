...
// checks if the AccessTokenPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessTokenPost{}
...
type _AccessTokenPost AccessTokenPost
...
func (o *AccessTokenPost) GetCustomRoleIds() []string {
	if o == nil || IsNil(o.CustomRoleIds) {
		var ret []string
		return ret
	}
...
func (o AccessTokenPost) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CustomRoleIds) {
		toSerialize["customRoleIds"] = o.CustomRoleIds
	}
	if !IsNil(o.InlineRole) {
...
func (o *AccessTokenPost) UnmarshalJSON(data []byte) (err error) {
	varAccessTokenPost := _AccessTokenPost{}

	err = json.Unmarshal(data, &varAccessTokenPost)

	if err != nil {
		return err
	}

	*o = AccessTokenPost(varAccessTokenPost)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "customRoleIds")
		delete(additionalProperties, "inlineRole")
		delete(additionalProperties, "serviceToken")
		delete(additionalProperties, "defaultApiVersion")
