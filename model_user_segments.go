...
// checks if the UserSegments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserSegments{}
...
type _UserSegments UserSegments
...
func (o UserSegments) ToMap() (map[string]interface{}, error) {
...
func (o *UserSegments) UnmarshalJSON(data []byte) (err error) {
	...
	varUserSegments := _UserSegments{}

	err = json.Unmarshal(data, &varUserSegments)

	if err != nil {
		return err
	}

	*o = UserSegments(varUserSegments)
