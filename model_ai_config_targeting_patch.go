...
// checks if the AIConfigTargetingPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigTargetingPatch{}

// AIConfigTargetingPatch struct for AIConfigTargetingPatch
type AIConfigTargetingPatch struct {
...
type _AIConfigTargetingPatch AIConfigTargetingPatch
...
func (o AIConfigTargetingPatch) MarshalJSON() ([]byte, error) {
...
func (o AIConfigTargetingPatch) ToMap() (map[string]interface{}, error) {
...
func (o *AIConfigTargetingPatch) UnmarshalJSON(data []byte) (err error) {
	...
	varAIConfigTargetingPatch := _AIConfigTargetingPatch{}

	err = json.Unmarshal(data, &varAIConfigTargetingPatch)

	if err != nil {
		return err
	}

	*o = AIConfigTargetingPatch(varAIConfigTargetingPatch)
...
type NullableAIConfigTargetingPatch struct {
	value *AIConfigTargetingPatch
	isSet bool
}

func (v NullableAIConfigTargetingPatch) Get() *AIConfigTargetingPatch {
	return v.value
}

func (v *NullableAIConfigTargetingPatch) Set(val *AIConfigTargetingPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigTargetingPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigTargetingPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigTargetingPatch(val *AIConfigTargetingPatch) *NullableAIConfigTargetingPatch {
	return &NullableAIConfigTargetingPatch{value: val, isSet: true}
}

func (v NullableAIConfigTargetingPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigTargetingPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
