...
// checks if the HoldoutPatchInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HoldoutPatchInput{}

// HoldoutPatchInput struct for HoldoutPatchInput
type HoldoutPatchInput struct {
...
type _HoldoutPatchInput HoldoutPatchInput
...
func (o HoldoutPatchInput) MarshalJSON() ([]byte, error) {
...
func (o HoldoutPatchInput) ToMap() (map[string]interface{}, error) {
...
func (o *HoldoutPatchInput) UnmarshalJSON(data []byte) (err error) {
	...
	varHoldoutPatchInput := _HoldoutPatchInput{}

	err = json.Unmarshal(data, &varHoldoutPatchInput)

	if err != nil {
		return err
	}

	*o = HoldoutPatchInput(varHoldoutPatchInput)
...
type NullableHoldoutPatchInput struct {
	value *HoldoutPatchInput
	isSet bool
}

func (v NullableHoldoutPatchInput) Get() *HoldoutPatchInput {
	return v.value
}

func (v *NullableHoldoutPatchInput) Set(val *HoldoutPatchInput) {
	v.value = val
	v.isSet = true
}

func (v NullableHoldoutPatchInput) IsSet() bool {
	return v.isSet
}

func (v *NullableHoldoutPatchInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHoldoutPatchInput(val *HoldoutPatchInput) *NullableHoldoutPatchInput {
	return &NullableHoldoutPatchInput{value: val, isSet: true}
}

func (v NullableHoldoutPatchInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHoldoutPatchInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
