...
// checks if the ReleasePoliciesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleasePoliciesResponse{}

// ReleasePoliciesResponse struct for ReleasePoliciesResponse
type ReleasePoliciesResponse struct {
...
type _ReleasePoliciesResponse ReleasePoliciesResponse
...
func (o ReleasePoliciesResponse) MarshalJSON() ([]byte, error) {
...
func (o ReleasePoliciesResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ReleasePoliciesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varReleasePoliciesResponse := _ReleasePoliciesResponse{}

	err = json.Unmarshal(data, &varReleasePoliciesResponse)

	if err != nil {
		return err
	}

	*o = ReleasePoliciesResponse(varReleasePoliciesResponse)
...
type NullableReleasePoliciesResponse struct {
	value *ReleasePoliciesResponse
	isSet bool
}

func (v NullableReleasePoliciesResponse) Get() *ReleasePoliciesResponse {
	return v.value
}

func (v *NullableReleasePoliciesResponse) Set(val *ReleasePoliciesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableReleasePoliciesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableReleasePoliciesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleasePoliciesResponse(val *ReleasePoliciesResponse) *NullableReleasePoliciesResponse {
	return &NullableReleasePoliciesResponse{value: val, isSet: true}
}

func (v NullableReleasePoliciesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReleasePoliciesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
