...
// checks if the ExpandedMetric type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedMetric{}

// ExpandedMetric Metric representation for Views API - contains only fields actually used by the Views service
...
type _ExpandedMetric ExpandedMetric
...
func (o ExpandedMetric) MarshalJSON() ([]byte, error) {
...
func (o ExpandedMetric) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedMetric) UnmarshalJSON(data []byte) (err error) {
	varExpandedMetric := _ExpandedMetric{}

	err = json.Unmarshal(data, &varExpandedMetric)

	if err != nil {
		return err
	}

	*o = ExpandedMetric(varExpandedMetric)
...
type NullableExpandedMetric struct {
	value *ExpandedMetric
	isSet bool
}

func (v NullableExpandedMetric) Get() *ExpandedMetric {
	return v.value
}

func (v *NullableExpandedMetric) Set(val *ExpandedMetric) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedMetric) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedMetric) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedMetric(val *ExpandedMetric) *NullableExpandedMetric {
	return &NullableExpandedMetric{value: val, isSet: true}
}

func (v NullableExpandedMetric) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedMetric) UnmarshalJSON(src []byte) error {
	v.isSet = true
