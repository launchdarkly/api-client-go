...
// checks if the FlagStatusRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagStatusRep{}
...
type _FlagStatusRep FlagStatusRep
...
func (o *FlagStatusRep) GetLastRequested() time.Time {
	if o == nil || IsNil(o.LastRequested) {
		var ret time.Time
		return ret
	}
...
func (o FlagStatusRep) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	if !IsNil(o.LastRequested) {
...
func (o *FlagStatusRep) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagStatusRep := _FlagStatusRep{}

	err = json.Unmarshal(data, &varFlagStatusRep)

	if err != nil {
		return err
	}

	*o = FlagStatusRep(varFlagStatusRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "name")
		delete(additionalProperties, "lastRequested")
