...
// ApplicationsPrivateApiService ApplicationsPrivateApi service
type ApplicationsPrivateApiService service

type ApiPostApplicationAndVersionWithFlagsPrivateRequest struct {
	ctx context.Context
	ApiService *ApplicationsPrivateApiService
	createApplicationsAndVersionsInput *CreateApplicationsAndVersionsInput
}

func (r ApiPostApplicationAndVersionWithFlagsPrivateRequest) CreateApplicationsAndVersionsInput(createApplicationsAndVersionsInput CreateApplicationsAndVersionsInput) ApiPostApplicationAndVersionWithFlagsPrivateRequest {
	r.createApplicationsAndVersionsInput = &createApplicationsAndVersionsInput
	return r
}

func (r ApiPostApplicationAndVersionWithFlagsPrivateRequest) Execute() (*http.Response, error) {
	return r.ApiService.PostApplicationAndVersionWithFlagsPrivateExecute(r)
}

/*
PostApplicationAndVersionWithFlagsPrivate Create applications and versions with flag associations

Used by internal systems. Creates applications and versions if they do not exist and create or update flag last seen

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiPostApplicationAndVersionWithFlagsPrivateRequest
*/
func (a *ApplicationsPrivateApiService) PostApplicationAndVersionWithFlagsPrivate(ctx context.Context) ApiPostApplicationAndVersionWithFlagsPrivateRequest {
	return ApiPostApplicationAndVersionWithFlagsPrivateRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ApplicationsPrivateApiService) PostApplicationAndVersionWithFlagsPrivateExecute(r ApiPostApplicationAndVersionWithFlagsPrivateRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ApplicationsPrivateApiService.PostApplicationAndVersionWithFlagsPrivate")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/private/applications"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createApplicationsAndVersionsInput == nil {
		return nil, reportError("createApplicationsAndVersionsInput is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createApplicationsAndVersionsInput
	if r.ctx != nil {
