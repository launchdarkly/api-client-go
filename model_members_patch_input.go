...
// checks if the MembersPatchInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MembersPatchInput{}
...
type _MembersPatchInput MembersPatchInput
...
func (o MembersPatchInput) ToMap() (map[string]interface{}, error) {
...
func (o *MembersPatchInput) UnmarshalJSON(data []byte) (err error) {
	...
	varMembersPatchInput := _MembersPatchInput{}

	err = json.Unmarshal(data, &varMembersPatchInput)

	if err != nil {
		return err
	}

	*o = MembersPatchInput(varMembersPatchInput)
...
func NewNullableMembersPatchInput(val *MembersPatchInput) *NullableMembersPatchInput {
	return &NullableMembersPatchInput{value: val, isSet: true}
}
