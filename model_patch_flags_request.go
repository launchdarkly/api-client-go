...
// checks if the PatchFlagsRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchFlagsRequest{}
...
type _PatchFlagsRequest PatchFlagsRequest
...
func (o PatchFlagsRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchFlagsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchFlagsRequest := _PatchFlagsRequest{}

	err = json.Unmarshal(data, &varPatchFlagsRequest)

	if err != nil {
		return err
	}

	*o = PatchFlagsRequest(varPatchFlagsRequest)
...
func NewNullablePatchFlagsRequest(val *PatchFlagsRequest) *NullablePatchFlagsRequest {
	return &NullablePatchFlagsRequest{value: val, isSet: true}
}
