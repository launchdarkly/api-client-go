...
// checks if the ContextInstanceSearch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextInstanceSearch{}
...
type _ContextInstanceSearch ContextInstanceSearch
...
func (o ContextInstanceSearch) ToMap() (map[string]interface{}, error) {
...
func (o *ContextInstanceSearch) UnmarshalJSON(data []byte) (err error) {
	varContextInstanceSearch := _ContextInstanceSearch{}

	err = json.Unmarshal(data, &varContextInstanceSearch)

	if err != nil {
		return err
	}

	*o = ContextInstanceSearch(varContextInstanceSearch)
