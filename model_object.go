...
type Object struct {
	...
	ValidPos *bool `json:"ValidPos,omitempty"`
	Shadow *map[string]bool `json:"Shadow,omitempty"`
}
...
// GetPkgPath returns the PkgPath field value if set, zero value otherwise.
func (o *Object) GetPkgPath() string {
	if o == nil || o.PkgPath == nil {
		var ret string
		return ret
	}
	return *o.PkgPath
...
// GetPkgPathOk returns a tuple with the PkgPath field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Object) GetPkgPathOk() (*string, bool) {
	if o == nil || o.PkgPath == nil {
		return nil, false
	}
	return o.PkgPath, true
}
...
// SetPkgPath gets a reference to the given string and assigns it to the PkgPath field.
func (o *Object) SetPkgPath(v string) {
	o.PkgPath = &v
}

// GetPkgName returns the PkgName field value if set, zero value otherwise.
func (o *Object) GetPkgName() string {
	if o == nil || o.PkgName == nil {
		var ret string
		return ret
	}
	return *o.PkgName
...
// GetPkgNameOk returns a tuple with the PkgName field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetPkgName gets a reference to the given string and assigns it to the PkgName field.
func (o *Object) SetPkgName(v string) {
	o.PkgName = &v
}

// GetValidPos returns the ValidPos field value if set, zero value otherwise.
func (o *Object) GetValidPos() bool {
	if o == nil || o.ValidPos == nil {
		var ret bool
		return ret
	}
	return *o.ValidPos
...
// GetValidPosOk returns a tuple with the ValidPos field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Object) GetValidPosOk() (*bool, bool) {
	if o == nil || o.ValidPos == nil {
		return nil, false
	}
	return o.ValidPos, true
}
...
// SetValidPos gets a reference to the given bool and assigns it to the ValidPos field.
...
// SetShadow gets a reference to the given map[string]bool and assigns it to the Shadow field.
...
func (o Object) MarshalJSON() ([]byte, error) {
	...
	if o.PkgPath != nil {
		toSerialize["PkgPath"] = o.PkgPath
	}
	if o.PkgName != nil {
		toSerialize["PkgName"] = o.PkgName
	}
	if o.ValidPos != nil {
		toSerialize["ValidPos"] = o.ValidPos
	}
	if o.Shadow != nil {
