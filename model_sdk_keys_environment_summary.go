...
// checks if the SdkKeysEnvironmentSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdkKeysEnvironmentSummary{}

// SdkKeysEnvironmentSummary struct for SdkKeysEnvironmentSummary
type SdkKeysEnvironmentSummary struct {
...
type _SdkKeysEnvironmentSummary SdkKeysEnvironmentSummary
...
func NewSdkKeysEnvironmentSummary(links map[string]Link, key string, name string, color string) *SdkKeysEnvironmentSummary {
	this := SdkKeysEnvironmentSummary{}
	this.Links = links
	this.Key = key
	this.Name = name
	this.Color = color
...
func (o SdkKeysEnvironmentSummary) MarshalJSON() ([]byte, error) {
...
func (o SdkKeysEnvironmentSummary) ToMap() (map[string]interface{}, error) {
...
func (o *SdkKeysEnvironmentSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varSdkKeysEnvironmentSummary := _SdkKeysEnvironmentSummary{}

	err = json.Unmarshal(data, &varSdkKeysEnvironmentSummary)

	if err != nil {
		return err
	}

	*o = SdkKeysEnvironmentSummary(varSdkKeysEnvironmentSummary)
...
type NullableSdkKeysEnvironmentSummary struct {
	value *SdkKeysEnvironmentSummary
	isSet bool
}

func (v NullableSdkKeysEnvironmentSummary) Get() *SdkKeysEnvironmentSummary {
	return v.value
}

func (v *NullableSdkKeysEnvironmentSummary) Set(val *SdkKeysEnvironmentSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableSdkKeysEnvironmentSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableSdkKeysEnvironmentSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdkKeysEnvironmentSummary(val *SdkKeysEnvironmentSummary) *NullableSdkKeysEnvironmentSummary {
	return &NullableSdkKeysEnvironmentSummary{value: val, isSet: true}
}

func (v NullableSdkKeysEnvironmentSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdkKeysEnvironmentSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
