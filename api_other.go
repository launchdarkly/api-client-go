...
type ApiGetProjectSummariesRequest struct {
	ctx context.Context
	ApiService *OtherApiService
}

func (r ApiGetProjectSummariesRequest) Execute() (*ProjectSummary, *http.Response, error) {
	return r.ApiService.GetProjectSummariesExecute(r)
}

/*
GetProjectSummaries List projects

Get a list of project summaries

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetProjectSummariesRequest
*/
func (a *OtherApiService) GetProjectSummaries(ctx context.Context) ApiGetProjectSummariesRequest {
	return ApiGetProjectSummariesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OtherApiService) GetProjectSummariesExecute(r ApiGetProjectSummariesRequest) (*ProjectSummary, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OtherApiService.GetProjectSummaries")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/internal/list/projects"
