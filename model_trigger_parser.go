...
// TriggerParser struct for TriggerParser
...
func (o TriggerParser) MarshalJSON() ([]byte, error) {
...
type NullableTriggerParser struct {
	value *TriggerParser
	isSet bool
}

func (v NullableTriggerParser) Get() *TriggerParser {
	return v.value
}

func (v *NullableTriggerParser) Set(val *TriggerParser) {
	v.value = val
	v.isSet = true
}

func (v NullableTriggerParser) IsSet() bool {
	return v.isSet
}

func (v *NullableTriggerParser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTriggerParser(val *TriggerParser) *NullableTriggerParser {
	return &NullableTriggerParser{value: val, isSet: true}
}

func (v NullableTriggerParser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTriggerParser) UnmarshalJSON(src []byte) error {
	v.isSet = true
