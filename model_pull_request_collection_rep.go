...
// checks if the PullRequestCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PullRequestCollectionRep{}
...
type _PullRequestCollectionRep PullRequestCollectionRep
...
func (o PullRequestCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *PullRequestCollectionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varPullRequestCollectionRep := _PullRequestCollectionRep{}

	err = json.Unmarshal(data, &varPullRequestCollectionRep)

	if err != nil {
		return err
	}

	*o = PullRequestCollectionRep(varPullRequestCollectionRep)
