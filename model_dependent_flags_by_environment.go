...
// checks if the DependentFlagsByEnvironment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DependentFlagsByEnvironment{}
...
type _DependentFlagsByEnvironment DependentFlagsByEnvironment
...
func (o DependentFlagsByEnvironment) ToMap() (map[string]interface{}, error) {
...
func (o *DependentFlagsByEnvironment) UnmarshalJSON(data []byte) (err error) {
	...
	varDependentFlagsByEnvironment := _DependentFlagsByEnvironment{}

	err = json.Unmarshal(data, &varDependentFlagsByEnvironment)

	if err != nil {
		return err
	}

	*o = DependentFlagsByEnvironment(varDependentFlagsByEnvironment)
