...
// checks if the MaintainerMember type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintainerMember{}
...
type _MaintainerMember MaintainerMember
...
func (o MaintainerMember) ToMap() (map[string]interface{}, error) {
...
func (o *MaintainerMember) UnmarshalJSON(data []byte) (err error) {
	...
	varMaintainerMember := _MaintainerMember{}

	err = json.Unmarshal(data, &varMaintainerMember)

	if err != nil {
		return err
	}

	*o = MaintainerMember(varMaintainerMember)
