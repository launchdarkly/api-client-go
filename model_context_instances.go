...
// checks if the ContextInstances type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextInstances{}
...
type _ContextInstances ContextInstances
...
func (o ContextInstances) ToMap() (map[string]interface{}, error) {
...
func (o *ContextInstances) UnmarshalJSON(data []byte) (err error) {
	...
	varContextInstances := _ContextInstances{}

	err = json.Unmarshal(data, &varContextInstances)

	if err != nil {
		return err
	}

	*o = ContextInstances(varContextInstances)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_environmentId")
