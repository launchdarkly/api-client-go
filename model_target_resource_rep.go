...
// checks if the TargetResourceRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TargetResourceRep{}
...
type _TargetResourceRep TargetResourceRep
...
func (o TargetResourceRep) ToMap() (map[string]interface{}, error) {
...
func (o *TargetResourceRep) UnmarshalJSON(data []byte) (err error) {
	varTargetResourceRep := _TargetResourceRep{}

	err = json.Unmarshal(data, &varTargetResourceRep)

	if err != nil {
		return err
	}

	*o = TargetResourceRep(varTargetResourceRep)
