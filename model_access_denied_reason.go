...
// checks if the AccessDeniedReason type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessDeniedReason{}
...
type _AccessDeniedReason AccessDeniedReason
...
func (o AccessDeniedReason) ToMap() (map[string]interface{}, error) {
...
func (o *AccessDeniedReason) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessDeniedReason := _AccessDeniedReason{}

	err = json.Unmarshal(data, &varAccessDeniedReason)

	if err != nil {
		return err
	}

	*o = AccessDeniedReason(varAccessDeniedReason)
