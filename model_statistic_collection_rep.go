...
// checks if the StatisticCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatisticCollectionRep{}
...
type _StatisticCollectionRep StatisticCollectionRep
...
func (o *StatisticCollectionRep) GetFlags() map[string][]StatisticRep {
	if o == nil {
		var ret map[string][]StatisticRep
		return ret
	}
...
func (o StatisticCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *StatisticCollectionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varStatisticCollectionRep := _StatisticCollectionRep{}

	err = json.Unmarshal(data, &varStatisticCollectionRep)

	if err != nil {
		return err
	}

	*o = StatisticCollectionRep(varStatisticCollectionRep)
...
func NewNullableStatisticCollectionRep(val *StatisticCollectionRep) *NullableStatisticCollectionRep {
	return &NullableStatisticCollectionRep{value: val, isSet: true}
}
