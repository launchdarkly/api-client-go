...
// TreatmentQuantileResultRep struct for TreatmentQuantileResultRep
type TreatmentQuantileResultRep struct {
	...
	PercentileInterval *CredibleIntervalRep `json:"percentileInterval,omitempty"`
	Significance *QuantileSignificanceRep `json:"significance,omitempty"`
	// Estimates of the relative difference between this treatment's percentile and the percentile of each other treatment
...
func NewTreatmentQuantileResultRep() *TreatmentQuantileResultRep {
	this := TreatmentQuantileResultRep{}
	return &this
}
...
// GetPercentileInterval returns the PercentileInterval field value if set, zero value otherwise.
func (o *TreatmentQuantileResultRep) GetPercentileInterval() CredibleIntervalRep {
	if o == nil || o.PercentileInterval == nil {
		var ret CredibleIntervalRep
		return ret
	}
	return *o.PercentileInterval
}

// GetPercentileIntervalOk returns a tuple with the PercentileInterval field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *TreatmentQuantileResultRep) GetPercentileIntervalOk() (*CredibleIntervalRep, bool) {
	if o == nil || o.PercentileInterval == nil {
		return nil, false
	}
	return o.PercentileInterval, true
}
...
// SetPercentileInterval gets a reference to the given CredibleIntervalRep and assigns it to the PercentileInterval field.
func (o *TreatmentQuantileResultRep) SetPercentileInterval(v CredibleIntervalRep) {
	o.PercentileInterval = &v
}
...
func (o *TreatmentQuantileResultRep) GetSignificance() QuantileSignificanceRep {
	if o == nil || o.Significance == nil {
		var ret QuantileSignificanceRep
		return ret
	}
...
// SetSignificance gets a reference to the given QuantileSignificanceRep and assigns it to the Significance field.
...
func (o TreatmentQuantileResultRep) MarshalJSON() ([]byte, error) {
	...
	if o.PercentileInterval != nil {
		toSerialize["percentileInterval"] = o.PercentileInterval
	}
...
type NullableTreatmentQuantileResultRep struct {
	value *TreatmentQuantileResultRep
	isSet bool
}

func (v NullableTreatmentQuantileResultRep) Get() *TreatmentQuantileResultRep {
	return v.value
}

func (v *NullableTreatmentQuantileResultRep) Set(val *TreatmentQuantileResultRep) {
	v.value = val
	v.isSet = true
}

func (v NullableTreatmentQuantileResultRep) IsSet() bool {
	return v.isSet
}

func (v *NullableTreatmentQuantileResultRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTreatmentQuantileResultRep(val *TreatmentQuantileResultRep) *NullableTreatmentQuantileResultRep {
	return &NullableTreatmentQuantileResultRep{value: val, isSet: true}
}

func (v NullableTreatmentQuantileResultRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTreatmentQuantileResultRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
