...
*/
func (a *ProjectsApiService) GetContextKindsByProjectKey(ctx context.Context, projectKey string) ApiGetContextKindsByProjectKeyRequest {
	return ApiGetContextKindsByProjectKeyRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
func (a *ProjectsApiService) GetContextKindsByProjectKeyExecute(r ApiGetContextKindsByProjectKeyRequest) (*ContextKindsCollectionRep, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectsApiService.GetContextKindsByProjectKey")
	if err != nil {
