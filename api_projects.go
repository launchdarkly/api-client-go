...
type ApiGetContextKindsByProjectIdRequest struct {
	ctx context.Context
	ApiService *ProjectsApiService
	projectKey string
}

func (r ApiGetContextKindsByProjectIdRequest) Execute() (*ContextKindsCollectionRep, *http.Response, error) {
	return r.ApiService.GetContextKindsByProjectIdExecute(r)
}

/*
GetContextKindsByProjectId Get context kinds

Get all context kinds for a given project.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectKey The project key
 @return ApiGetContextKindsByProjectIdRequest
*/
func (a *ProjectsApiService) GetContextKindsByProjectId(ctx context.Context, projectKey string) ApiGetContextKindsByProjectIdRequest {
	return ApiGetContextKindsByProjectIdRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
func (a *ProjectsApiService) GetContextKindsByProjectIdExecute(r ApiGetContextKindsByProjectIdRequest) (*ContextKindsCollectionRep, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectsApiService.GetContextKindsByProjectId")
	if err != nil {
...
/*
PutContextKind Put context kind

Create or update a context kind by key.
...
*/
func (a *ProjectsApiService) PutContextKind(ctx context.Context, projectKey string, key string) ApiPutContextKindRequest {
	return ApiPutContextKindRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
func (a *ProjectsApiService) PutContextKindExecute(r ApiPutContextKindRequest) (*UpsertResponseRep, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectsApiService.PutContextKind")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
