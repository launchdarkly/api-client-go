...
// checks if the MultiEnvironmentDependentFlag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiEnvironmentDependentFlag{}
...
type _MultiEnvironmentDependentFlag MultiEnvironmentDependentFlag
...
func (o MultiEnvironmentDependentFlag) ToMap() (map[string]interface{}, error) {
...
func (o *MultiEnvironmentDependentFlag) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiEnvironmentDependentFlag := _MultiEnvironmentDependentFlag{}

	err = json.Unmarshal(data, &varMultiEnvironmentDependentFlag)

	if err != nil {
		return err
	}

	*o = MultiEnvironmentDependentFlag(varMultiEnvironmentDependentFlag)
