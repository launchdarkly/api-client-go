...
// checks if the LayerSnapshotRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LayerSnapshotRep{}
...
type _LayerSnapshotRep LayerSnapshotRep
...
func (o LayerSnapshotRep) ToMap() (map[string]interface{}, error) {
...
func (o *LayerSnapshotRep) UnmarshalJSON(data []byte) (err error) {
	...
	varLayerSnapshotRep := _LayerSnapshotRep{}

	err = json.Unmarshal(data, &varLayerSnapshotRep)

	if err != nil {
		return err
	}

	*o = LayerSnapshotRep(varLayerSnapshotRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "otherReservationPercent")
