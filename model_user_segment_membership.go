...
// UserSegmentMembership struct for UserSegmentMembership
type UserSegmentMembership struct {
	...
	// If the segment is an externally-synced Big Segment, the name of the external source'
	External string `json:"external"`
	// Whether the user is a member of this segment, either by explicit inclusion or by rule matching
	IsMember bool `json:"isMember"`
	// Whether the user is explicitly included in this segment
	IsUserTargeted bool `json:"isUserTargeted"`
	// Whether the user is captured by this segment's rules. The value of this field is undefined if the user is also explicitly included (isUserTargeted = true).
...
func NewUserSegmentMembership(name string, key string, description string, unbounded bool, external string, isMember bool, isUserTargeted bool, isRuleTargeted bool, links map[string]Link) *UserSegmentMembership {
	...
	this.IsUserTargeted = isUserTargeted
...
// GetIsUserTargeted returns the IsUserTargeted field value
func (o *UserSegmentMembership) GetIsUserTargeted() bool {
	...
	return o.IsUserTargeted
}

// GetIsUserTargetedOk returns a tuple with the IsUserTargeted field value
// and a boolean to check if the value has been set.
func (o *UserSegmentMembership) GetIsUserTargetedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IsUserTargeted, true
}

// SetIsUserTargeted sets field value
...
func (o UserSegmentMembership) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["isUserTargeted"] = o.IsUserTargeted
	}
	if true {
...
type NullableUserSegmentMembership struct {
	value *UserSegmentMembership
	isSet bool
}

func (v NullableUserSegmentMembership) Get() *UserSegmentMembership {
	return v.value
}

func (v *NullableUserSegmentMembership) Set(val *UserSegmentMembership) {
	v.value = val
	v.isSet = true
}

func (v NullableUserSegmentMembership) IsSet() bool {
	return v.isSet
}

func (v *NullableUserSegmentMembership) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserSegmentMembership(val *UserSegmentMembership) *NullableUserSegmentMembership {
	return &NullableUserSegmentMembership{value: val, isSet: true}
}

func (v NullableUserSegmentMembership) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserSegmentMembership) UnmarshalJSON(src []byte) error {
	v.isSet = true
