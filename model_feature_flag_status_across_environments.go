...
// checks if the FeatureFlagStatusAcrossEnvironments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeatureFlagStatusAcrossEnvironments{}
...
type _FeatureFlagStatusAcrossEnvironments FeatureFlagStatusAcrossEnvironments
...
func (o FeatureFlagStatusAcrossEnvironments) ToMap() (map[string]interface{}, error) {
...
func (o *FeatureFlagStatusAcrossEnvironments) UnmarshalJSON(data []byte) (err error) {
	...
	varFeatureFlagStatusAcrossEnvironments := _FeatureFlagStatusAcrossEnvironments{}

	err = json.Unmarshal(data, &varFeatureFlagStatusAcrossEnvironments)

	if err != nil {
		return err
	}

	*o = FeatureFlagStatusAcrossEnvironments(varFeatureFlagStatusAcrossEnvironments)
