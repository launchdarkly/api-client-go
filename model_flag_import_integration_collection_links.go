...
// checks if the FlagImportIntegrationCollectionLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagImportIntegrationCollectionLinks{}

// FlagImportIntegrationCollectionLinks struct for FlagImportIntegrationCollectionLinks
type FlagImportIntegrationCollectionLinks struct {
	Self Link `json:"self"`
	Parent *Link `json:"parent,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _FlagImportIntegrationCollectionLinks FlagImportIntegrationCollectionLinks
...
func NewFlagImportIntegrationCollectionLinks(self Link) *FlagImportIntegrationCollectionLinks {
	this := FlagImportIntegrationCollectionLinks{}
	this.Self = self
	return &this
}
...
func (o FlagImportIntegrationCollectionLinks) MarshalJSON() ([]byte, error) {
...
func (o FlagImportIntegrationCollectionLinks) ToMap() (map[string]interface{}, error) {
...
func (o *FlagImportIntegrationCollectionLinks) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagImportIntegrationCollectionLinks := _FlagImportIntegrationCollectionLinks{}

	err = json.Unmarshal(data, &varFlagImportIntegrationCollectionLinks)

	if err != nil {
		return err
	}

	*o = FlagImportIntegrationCollectionLinks(varFlagImportIntegrationCollectionLinks)
...
type NullableFlagImportIntegrationCollectionLinks struct {
	value *FlagImportIntegrationCollectionLinks
	isSet bool
}

func (v NullableFlagImportIntegrationCollectionLinks) Get() *FlagImportIntegrationCollectionLinks {
	return v.value
}

func (v *NullableFlagImportIntegrationCollectionLinks) Set(val *FlagImportIntegrationCollectionLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableFlagImportIntegrationCollectionLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableFlagImportIntegrationCollectionLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlagImportIntegrationCollectionLinks(val *FlagImportIntegrationCollectionLinks) *NullableFlagImportIntegrationCollectionLinks {
	return &NullableFlagImportIntegrationCollectionLinks{value: val, isSet: true}
}

func (v NullableFlagImportIntegrationCollectionLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlagImportIntegrationCollectionLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
