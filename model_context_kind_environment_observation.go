...
// checks if the ContextKindEnvironmentObservation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextKindEnvironmentObservation{}

// ContextKindEnvironmentObservation struct for ContextKindEnvironmentObservation
type ContextKindEnvironmentObservation struct {
	// The environment key
...
type _ContextKindEnvironmentObservation ContextKindEnvironmentObservation

// NewContextKindEnvironmentObservation instantiates a new ContextKindEnvironmentObservation object
...
func NewContextKindEnvironmentObservation(environmentKey string, lastSeen int64) *ContextKindEnvironmentObservation {
	this := ContextKindEnvironmentObservation{}
	this.EnvironmentKey = environmentKey
	this.LastSeen = lastSeen
	return &this
}

// NewContextKindEnvironmentObservationWithDefaults instantiates a new ContextKindEnvironmentObservation object
...
func (o ContextKindEnvironmentObservation) MarshalJSON() ([]byte, error) {
...
func (o ContextKindEnvironmentObservation) ToMap() (map[string]interface{}, error) {
...
func (o *ContextKindEnvironmentObservation) UnmarshalJSON(data []byte) (err error) {
	...
	varContextKindEnvironmentObservation := _ContextKindEnvironmentObservation{}

	err = json.Unmarshal(data, &varContextKindEnvironmentObservation)

	if err != nil {
		return err
	}

	*o = ContextKindEnvironmentObservation(varContextKindEnvironmentObservation)
...
type NullableContextKindEnvironmentObservation struct {
	value *ContextKindEnvironmentObservation
	isSet bool
}

func (v NullableContextKindEnvironmentObservation) Get() *ContextKindEnvironmentObservation {
	return v.value
}

func (v *NullableContextKindEnvironmentObservation) Set(val *ContextKindEnvironmentObservation) {
	v.value = val
	v.isSet = true
}

func (v NullableContextKindEnvironmentObservation) IsSet() bool {
	return v.isSet
}

func (v *NullableContextKindEnvironmentObservation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContextKindEnvironmentObservation(val *ContextKindEnvironmentObservation) *NullableContextKindEnvironmentObservation {
	return &NullableContextKindEnvironmentObservation{value: val, isSet: true}
}

func (v NullableContextKindEnvironmentObservation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContextKindEnvironmentObservation) UnmarshalJSON(src []byte) error {
	v.isSet = true
