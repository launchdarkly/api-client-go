...
// checks if the BigSegmentStoreIntegrationLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BigSegmentStoreIntegrationLinks{}
...
type _BigSegmentStoreIntegrationLinks BigSegmentStoreIntegrationLinks
...
func (o BigSegmentStoreIntegrationLinks) ToMap() (map[string]interface{}, error) {
...
func (o *BigSegmentStoreIntegrationLinks) UnmarshalJSON(data []byte) (err error) {
	...
	varBigSegmentStoreIntegrationLinks := _BigSegmentStoreIntegrationLinks{}

	err = json.Unmarshal(data, &varBigSegmentStoreIntegrationLinks)

	if err != nil {
		return err
	}

	*o = BigSegmentStoreIntegrationLinks(varBigSegmentStoreIntegrationLinks)
