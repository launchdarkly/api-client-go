...
// DiscoveredMetricEvent struct for DiscoveredMetricEvent
type DiscoveredMetricEvent struct {
...
func (o DiscoveredMetricEvent) MarshalJSON() ([]byte, error) {
...
type NullableDiscoveredMetricEvent struct {
	value *DiscoveredMetricEvent
	isSet bool
}

func (v NullableDiscoveredMetricEvent) Get() *DiscoveredMetricEvent {
	return v.value
}

func (v *NullableDiscoveredMetricEvent) Set(val *DiscoveredMetricEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscoveredMetricEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscoveredMetricEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscoveredMetricEvent(val *DiscoveredMetricEvent) *NullableDiscoveredMetricEvent {
	return &NullableDiscoveredMetricEvent{value: val, isSet: true}
}

func (v NullableDiscoveredMetricEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscoveredMetricEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
