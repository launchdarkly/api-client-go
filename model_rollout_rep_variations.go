...
// RolloutRepVariations struct for RolloutRepVariations
type RolloutRepVariations struct {
...
func (o RolloutRepVariations) MarshalJSON() ([]byte, error) {
...
type NullableRolloutRepVariations struct {
	value *RolloutRepVariations
	isSet bool
}

func (v NullableRolloutRepVariations) Get() *RolloutRepVariations {
	return v.value
}

func (v *NullableRolloutRepVariations) Set(val *RolloutRepVariations) {
	v.value = val
	v.isSet = true
}

func (v NullableRolloutRepVariations) IsSet() bool {
	return v.isSet
}

func (v *NullableRolloutRepVariations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRolloutRepVariations(val *RolloutRepVariations) *NullableRolloutRepVariations {
	return &NullableRolloutRepVariations{value: val, isSet: true}
}

func (v NullableRolloutRepVariations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRolloutRepVariations) UnmarshalJSON(src []byte) error {
	v.isSet = true
