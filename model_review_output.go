...
// checks if the ReviewOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReviewOutput{}
...
type _ReviewOutput ReviewOutput
...
func (o *ReviewOutput) GetServiceTokenId() string {
	if o == nil || IsNil(o.ServiceTokenId) {
		var ret string
		return ret
	}
...
func (o ReviewOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ReviewOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varReviewOutput := _ReviewOutput{}

	err = json.Unmarshal(data, &varReviewOutput)

	if err != nil {
		return err
	}

	*o = ReviewOutput(varReviewOutput)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "serviceTokenId")
