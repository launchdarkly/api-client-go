...
// checks if the ApplicationCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationCollectionRep{}
...
type _ApplicationCollectionRep ApplicationCollectionRep
...
func (o ApplicationCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationCollectionRep) UnmarshalJSON(data []byte) (err error) {
	varApplicationCollectionRep := _ApplicationCollectionRep{}

	err = json.Unmarshal(data, &varApplicationCollectionRep)

	if err != nil {
		return err
	}

	*o = ApplicationCollectionRep(varApplicationCollectionRep)
