...
// checks if the AgentOptimizationJudge type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentOptimizationJudge{}

// AgentOptimizationJudge struct for AgentOptimizationJudge
type AgentOptimizationJudge struct {
	Key string `json:"key"`
	Threshold float64 `json:"threshold"`
	AdditionalProperties map[string]interface{}
}

type _AgentOptimizationJudge AgentOptimizationJudge

// NewAgentOptimizationJudge instantiates a new AgentOptimizationJudge object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAgentOptimizationJudge(key string, threshold float64) *AgentOptimizationJudge {
	this := AgentOptimizationJudge{}
	this.Key = key
	this.Threshold = threshold
	return &this
}

// NewAgentOptimizationJudgeWithDefaults instantiates a new AgentOptimizationJudge object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAgentOptimizationJudgeWithDefaults() *AgentOptimizationJudge {
	this := AgentOptimizationJudge{}
	return &this
}

// GetKey returns the Key field value
func (o *AgentOptimizationJudge) GetKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *AgentOptimizationJudge) GetKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Key, true
...
func (o *AgentOptimizationJudge) SetKey(v string) {
	o.Key = v
}

// GetThreshold returns the Threshold field value
func (o *AgentOptimizationJudge) GetThreshold() float64 {
	if o == nil {
		var ret float64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AgentOptimizationJudge) GetThresholdOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AgentOptimizationJudge) SetThreshold(v float64) {
	o.Threshold = v
}

func (o AgentOptimizationJudge) MarshalJSON() ([]byte, error) {
...
func (o AgentOptimizationJudge) ToMap() (map[string]interface{}, error) {
...
func (o *AgentOptimizationJudge) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentOptimizationJudge := _AgentOptimizationJudge{}

	err = json.Unmarshal(data, &varAgentOptimizationJudge)

	if err != nil {
		return err
	}

	*o = AgentOptimizationJudge(varAgentOptimizationJudge)
...
type NullableAgentOptimizationJudge struct {
	value *AgentOptimizationJudge
	isSet bool
}

func (v NullableAgentOptimizationJudge) Get() *AgentOptimizationJudge {
	return v.value
}

func (v *NullableAgentOptimizationJudge) Set(val *AgentOptimizationJudge) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentOptimizationJudge) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentOptimizationJudge) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentOptimizationJudge(val *AgentOptimizationJudge) *NullableAgentOptimizationJudge {
	return &NullableAgentOptimizationJudge{value: val, isSet: true}
}

func (v NullableAgentOptimizationJudge) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentOptimizationJudge) UnmarshalJSON(src []byte) error {
	v.isSet = true
