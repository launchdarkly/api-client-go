...
// MetricRepAttachedFeatures struct for MetricRepAttachedFeatures
type MetricRepAttachedFeatures struct {
...
func NewMetricRepAttachedFeatures(name string, key string) *MetricRepAttachedFeatures {
	this := MetricRepAttachedFeatures{}
	this.Name = name
	this.Key = key
	return &this
}
...
func (o MetricRepAttachedFeatures) MarshalJSON() ([]byte, error) {
...
type NullableMetricRepAttachedFeatures struct {
	value *MetricRepAttachedFeatures
	isSet bool
}

func (v NullableMetricRepAttachedFeatures) Get() *MetricRepAttachedFeatures {
	return v.value
}

func (v *NullableMetricRepAttachedFeatures) Set(val *MetricRepAttachedFeatures) {
	v.value = val
	v.isSet = true
}

func (v NullableMetricRepAttachedFeatures) IsSet() bool {
	return v.isSet
}

func (v *NullableMetricRepAttachedFeatures) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetricRepAttachedFeatures(val *MetricRepAttachedFeatures) *NullableMetricRepAttachedFeatures {
	return &NullableMetricRepAttachedFeatures{value: val, isSet: true}
}

func (v NullableMetricRepAttachedFeatures) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetricRepAttachedFeatures) UnmarshalJSON(src []byte) error {
	v.isSet = true
