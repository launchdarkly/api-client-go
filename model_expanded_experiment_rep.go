...
// checks if the ExpandedExperimentRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedExperimentRep{}

// ExpandedExperimentRep struct for ExpandedExperimentRep
type ExpandedExperimentRep struct {
...
type _ExpandedExperimentRep ExpandedExperimentRep
...
func (o ExpandedExperimentRep) MarshalJSON() ([]byte, error) {
...
func (o ExpandedExperimentRep) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedExperimentRep) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedExperimentRep := _ExpandedExperimentRep{}

	err = json.Unmarshal(data, &varExpandedExperimentRep)

	if err != nil {
		return err
	}

	*o = ExpandedExperimentRep(varExpandedExperimentRep)
...
type NullableExpandedExperimentRep struct {
	value *ExpandedExperimentRep
	isSet bool
}

func (v NullableExpandedExperimentRep) Get() *ExpandedExperimentRep {
	return v.value
}

func (v *NullableExpandedExperimentRep) Set(val *ExpandedExperimentRep) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedExperimentRep) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedExperimentRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedExperimentRep(val *ExpandedExperimentRep) *NullableExpandedExperimentRep {
	return &NullableExpandedExperimentRep{value: val, isSet: true}
}

func (v NullableExpandedExperimentRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedExperimentRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
