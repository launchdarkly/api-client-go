...
// checks if the AnnouncementPaginatedLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnnouncementPaginatedLinks{}
...
type _AnnouncementPaginatedLinks AnnouncementPaginatedLinks
...
func (o AnnouncementPaginatedLinks) ToMap() (map[string]interface{}, error) {
...
func (o *AnnouncementPaginatedLinks) UnmarshalJSON(data []byte) (err error) {
	...
	varAnnouncementPaginatedLinks := _AnnouncementPaginatedLinks{}

	err = json.Unmarshal(data, &varAnnouncementPaginatedLinks)

	if err != nil {
		return err
	}

	*o = AnnouncementPaginatedLinks(varAnnouncementPaginatedLinks)
