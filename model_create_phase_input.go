...
// checks if the CreatePhaseInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePhaseInput{}
...
type _CreatePhaseInput CreatePhaseInput
...
func (o CreatePhaseInput) ToMap() (map[string]interface{}, error) {
...
func (o *CreatePhaseInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCreatePhaseInput := _CreatePhaseInput{}

	err = json.Unmarshal(data, &varCreatePhaseInput)

	if err != nil {
		return err
	}

	*o = CreatePhaseInput(varCreatePhaseInput)
