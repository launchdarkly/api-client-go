...
type CreatePhaseInput struct {
	...
	Configuration *PhaseConfiguration `json:"configuration,omitempty"`
}
...
// SetConfiguration gets a reference to the given PhaseConfiguration and assigns it to the Configuration field.
