...
func (a *ContextsApiService) GetContextInstancesExecute(r ApiGetContextInstancesRequest) (*ContextInstances, *http.Response, error) {
	...
	if r.includeTotalCount != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "includeTotalCount", r.includeTotalCount, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiGetContextKindsByProjectKeyRequest) Expand(expand string) ApiGetContextKindsByProjectKeyRequest {
	r.expand = &expand
	return r
}
