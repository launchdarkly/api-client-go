...
// checks if the VariationSkillPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VariationSkillPost{}

// VariationSkillPost struct for VariationSkillPost
type VariationSkillPost struct {
...
type _VariationSkillPost VariationSkillPost

// NewVariationSkillPost instantiates a new VariationSkillPost object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewVariationSkillPost(key string, version int32) *VariationSkillPost {
	this := VariationSkillPost{}
	this.Key = key
	this.Version = version
	return &this
}

// NewVariationSkillPostWithDefaults instantiates a new VariationSkillPost object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewVariationSkillPostWithDefaults() *VariationSkillPost {
	this := VariationSkillPost{}
	return &this
}

// GetKey returns the Key field value
func (o *VariationSkillPost) GetKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *VariationSkillPost) GetKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Key, true
...
func (o *VariationSkillPost) SetKey(v string) {
	o.Key = v
}

// GetVersion returns the Version field value
func (o *VariationSkillPost) GetVersion() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *VariationSkillPost) GetVersionOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *VariationSkillPost) SetVersion(v int32) {
	o.Version = v
}

func (o VariationSkillPost) MarshalJSON() ([]byte, error) {
...
func (o VariationSkillPost) ToMap() (map[string]interface{}, error) {
...
func (o *VariationSkillPost) UnmarshalJSON(data []byte) (err error) {
	...
	varVariationSkillPost := _VariationSkillPost{}

	err = json.Unmarshal(data, &varVariationSkillPost)

	if err != nil {
		return err
	}

	*o = VariationSkillPost(varVariationSkillPost)
...
type NullableVariationSkillPost struct {
	value *VariationSkillPost
	isSet bool
}

func (v NullableVariationSkillPost) Get() *VariationSkillPost {
	return v.value
}

func (v *NullableVariationSkillPost) Set(val *VariationSkillPost) {
	v.value = val
	v.isSet = true
}

func (v NullableVariationSkillPost) IsSet() bool {
	return v.isSet
}

func (v *NullableVariationSkillPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVariationSkillPost(val *VariationSkillPost) *NullableVariationSkillPost {
	return &NullableVariationSkillPost{value: val, isSet: true}
}

func (v NullableVariationSkillPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVariationSkillPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
