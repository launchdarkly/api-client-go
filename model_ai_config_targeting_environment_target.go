...
// checks if the AIConfigTargetingEnvironmentTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigTargetingEnvironmentTarget{}

// AIConfigTargetingEnvironmentTarget struct for AIConfigTargetingEnvironmentTarget
type AIConfigTargetingEnvironmentTarget struct {
...
type _AIConfigTargetingEnvironmentTarget AIConfigTargetingEnvironmentTarget
...
func NewAIConfigTargetingEnvironmentTarget(contextKind string, values []string, variation int32) *AIConfigTargetingEnvironmentTarget {
	this := AIConfigTargetingEnvironmentTarget{}
...
func (o AIConfigTargetingEnvironmentTarget) MarshalJSON() ([]byte, error) {
...
func (o AIConfigTargetingEnvironmentTarget) ToMap() (map[string]interface{}, error) {
...
func (o *AIConfigTargetingEnvironmentTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varAIConfigTargetingEnvironmentTarget := _AIConfigTargetingEnvironmentTarget{}

	err = json.Unmarshal(data, &varAIConfigTargetingEnvironmentTarget)

	if err != nil {
		return err
	}

	*o = AIConfigTargetingEnvironmentTarget(varAIConfigTargetingEnvironmentTarget)
...
type NullableAIConfigTargetingEnvironmentTarget struct {
	value *AIConfigTargetingEnvironmentTarget
	isSet bool
}

func (v NullableAIConfigTargetingEnvironmentTarget) Get() *AIConfigTargetingEnvironmentTarget {
	return v.value
}

func (v *NullableAIConfigTargetingEnvironmentTarget) Set(val *AIConfigTargetingEnvironmentTarget) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigTargetingEnvironmentTarget) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigTargetingEnvironmentTarget) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigTargetingEnvironmentTarget(val *AIConfigTargetingEnvironmentTarget) *NullableAIConfigTargetingEnvironmentTarget {
	return &NullableAIConfigTargetingEnvironmentTarget{value: val, isSet: true}
}

func (v NullableAIConfigTargetingEnvironmentTarget) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigTargetingEnvironmentTarget) UnmarshalJSON(src []byte) error {
	v.isSet = true
