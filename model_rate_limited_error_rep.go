...
// checks if the RateLimitedErrorRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RateLimitedErrorRep{}
...
type _RateLimitedErrorRep RateLimitedErrorRep
...
func (o RateLimitedErrorRep) ToMap() (map[string]interface{}, error) {
...
func (o *RateLimitedErrorRep) UnmarshalJSON(data []byte) (err error) {
	...
	varRateLimitedErrorRep := _RateLimitedErrorRep{}

	err = json.Unmarshal(data, &varRateLimitedErrorRep)

	if err != nil {
		return err
	}

	*o = RateLimitedErrorRep(varRateLimitedErrorRep)
