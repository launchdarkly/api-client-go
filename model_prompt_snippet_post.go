...
// checks if the PromptSnippetPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromptSnippetPost{}

// PromptSnippetPost struct for PromptSnippetPost
type PromptSnippetPost struct {
	Key string `json:"key"`
...
type _PromptSnippetPost PromptSnippetPost
...
func (o PromptSnippetPost) MarshalJSON() ([]byte, error) {
...
func (o PromptSnippetPost) ToMap() (map[string]interface{}, error) {
...
func (o *PromptSnippetPost) UnmarshalJSON(data []byte) (err error) {
	...
	varPromptSnippetPost := _PromptSnippetPost{}

	err = json.Unmarshal(data, &varPromptSnippetPost)

	if err != nil {
		return err
	}

	*o = PromptSnippetPost(varPromptSnippetPost)
...
type NullablePromptSnippetPost struct {
	value *PromptSnippetPost
	isSet bool
}

func (v NullablePromptSnippetPost) Get() *PromptSnippetPost {
	return v.value
}

func (v *NullablePromptSnippetPost) Set(val *PromptSnippetPost) {
	v.value = val
	v.isSet = true
}

func (v NullablePromptSnippetPost) IsSet() bool {
	return v.isSet
}

func (v *NullablePromptSnippetPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromptSnippetPost(val *PromptSnippetPost) *NullablePromptSnippetPost {
	return &NullablePromptSnippetPost{value: val, isSet: true}
}

func (v NullablePromptSnippetPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromptSnippetPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
