...
// checks if the AIConfigTargeting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigTargeting{}

// AIConfigTargeting struct for AIConfigTargeting
type AIConfigTargeting struct {
	// Unix timestamp in milliseconds
	CreatedAt int64 `json:"createdAt"`
	Defaults *AIConfigTargetingDefaults `json:"defaults,omitempty"`
	Environments map[string]AIConfigTargetingEnvironment `json:"environments"`
	Experiments AiConfigsExperimentInfoRep `json:"experiments"`
	Key string `json:"key"`
	Name string `json:"name"`
	Tags []string `json:"tags"`
	Variations []AIConfigTargetingVariation `json:"variations"`
	Version int32 `json:"_version"`
	AdditionalProperties map[string]interface{}
}

type _AIConfigTargeting AIConfigTargeting
...
func (o *AIConfigTargeting) GetDefaults() AIConfigTargetingDefaults {
	if o == nil || IsNil(o.Defaults) {
		var ret AIConfigTargetingDefaults
		return ret
	}
	return *o.Defaults
}
...
// SetDefaults gets a reference to the given AIConfigTargetingDefaults and assigns it to the Defaults field.
...
func (o *AIConfigTargeting) GetEnvironments() map[string]AIConfigTargetingEnvironment {
	if o == nil {
		var ret map[string]AIConfigTargetingEnvironment
		return ret
	}
...
func (o *AIConfigTargeting) GetExperiments() AiConfigsExperimentInfoRep {
	if o == nil {
		var ret AiConfigsExperimentInfoRep
		return ret
	}
...
func (o *AIConfigTargeting) GetVariations() []AIConfigTargetingVariation {
	if o == nil {
		var ret []AIConfigTargetingVariation
		return ret
	}
...
func (o AIConfigTargeting) MarshalJSON() ([]byte, error) {
...
func (o AIConfigTargeting) ToMap() (map[string]interface{}, error) {
...
func (o *AIConfigTargeting) UnmarshalJSON(data []byte) (err error) {
	...
	varAIConfigTargeting := _AIConfigTargeting{}

	err = json.Unmarshal(data, &varAIConfigTargeting)

	if err != nil {
		return err
	}

	*o = AIConfigTargeting(varAIConfigTargeting)
...
type NullableAIConfigTargeting struct {
	value *AIConfigTargeting
	isSet bool
}

func (v NullableAIConfigTargeting) Get() *AIConfigTargeting {
	return v.value
}

func (v *NullableAIConfigTargeting) Set(val *AIConfigTargeting) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigTargeting) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigTargeting) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigTargeting(val *AIConfigTargeting) *NullableAIConfigTargeting {
	return &NullableAIConfigTargeting{value: val, isSet: true}
}

func (v NullableAIConfigTargeting) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigTargeting) UnmarshalJSON(src []byte) error {
	v.isSet = true
