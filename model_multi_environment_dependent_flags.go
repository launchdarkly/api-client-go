...
// checks if the MultiEnvironmentDependentFlags type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MultiEnvironmentDependentFlags{}
...
type _MultiEnvironmentDependentFlags MultiEnvironmentDependentFlags
...
func (o MultiEnvironmentDependentFlags) ToMap() (map[string]interface{}, error) {
...
func (o *MultiEnvironmentDependentFlags) UnmarshalJSON(data []byte) (err error) {
	...
	varMultiEnvironmentDependentFlags := _MultiEnvironmentDependentFlags{}

	err = json.Unmarshal(data, &varMultiEnvironmentDependentFlags)

	if err != nil {
		return err
	}

	*o = MultiEnvironmentDependentFlags(varMultiEnvironmentDependentFlags)
