...
// checks if the ClientSideAvailabilityPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClientSideAvailabilityPost{}
...
type _ClientSideAvailabilityPost ClientSideAvailabilityPost
...
func (o ClientSideAvailabilityPost) ToMap() (map[string]interface{}, error) {
...
func (o *ClientSideAvailabilityPost) UnmarshalJSON(data []byte) (err error) {
	...
	varClientSideAvailabilityPost := _ClientSideAvailabilityPost{}

	err = json.Unmarshal(data, &varClientSideAvailabilityPost)

	if err != nil {
		return err
	}

	*o = ClientSideAvailabilityPost(varClientSideAvailabilityPost)
