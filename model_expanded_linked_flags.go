...
// checks if the ExpandedLinkedFlags type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedLinkedFlags{}

// ExpandedLinkedFlags Details on linked flags for a view - requires passing the 'allFlags' expand field
type ExpandedLinkedFlags struct {
	Items []ExpandedFlag `json:"items"`
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _ExpandedLinkedFlags ExpandedLinkedFlags
...
func (o ExpandedLinkedFlags) MarshalJSON() ([]byte, error) {
...
func (o ExpandedLinkedFlags) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedLinkedFlags) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedLinkedFlags := _ExpandedLinkedFlags{}

	err = json.Unmarshal(data, &varExpandedLinkedFlags)

	if err != nil {
		return err
	}

	*o = ExpandedLinkedFlags(varExpandedLinkedFlags)
...
type NullableExpandedLinkedFlags struct {
	value *ExpandedLinkedFlags
	isSet bool
}

func (v NullableExpandedLinkedFlags) Get() *ExpandedLinkedFlags {
	return v.value
}

func (v *NullableExpandedLinkedFlags) Set(val *ExpandedLinkedFlags) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedLinkedFlags) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedLinkedFlags) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedLinkedFlags(val *ExpandedLinkedFlags) *NullableExpandedLinkedFlags {
	return &NullableExpandedLinkedFlags{value: val, isSet: true}
}

func (v NullableExpandedLinkedFlags) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedLinkedFlags) UnmarshalJSON(src []byte) error {
	v.isSet = true
