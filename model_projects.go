...
func (o *Projects) UnmarshalJSON(data []byte) (err error) {
	...
	varProjects := _Projects{}

	err = json.Unmarshal(data, &varProjects)

	if err != nil {
		return err
	}

	*o = Projects(varProjects)
