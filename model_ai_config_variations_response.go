...
// checks if the AIConfigVariationsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigVariationsResponse{}

// AIConfigVariationsResponse struct for AIConfigVariationsResponse
type AIConfigVariationsResponse struct {
	Items []AIConfigVariation `json:"items"`
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _AIConfigVariationsResponse AIConfigVariationsResponse
...
func NewAIConfigVariationsResponse(items []AIConfigVariation, totalCount int32) *AIConfigVariationsResponse {
	this := AIConfigVariationsResponse{}
	this.Items = items
...
func (o AIConfigVariationsResponse) MarshalJSON() ([]byte, error) {
...
func (o AIConfigVariationsResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AIConfigVariationsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAIConfigVariationsResponse := _AIConfigVariationsResponse{}

	err = json.Unmarshal(data, &varAIConfigVariationsResponse)

	if err != nil {
		return err
	}

	*o = AIConfigVariationsResponse(varAIConfigVariationsResponse)
...
type NullableAIConfigVariationsResponse struct {
	value *AIConfigVariationsResponse
	isSet bool
}

func (v NullableAIConfigVariationsResponse) Get() *AIConfigVariationsResponse {
	return v.value
}

func (v *NullableAIConfigVariationsResponse) Set(val *AIConfigVariationsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigVariationsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigVariationsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigVariationsResponse(val *AIConfigVariationsResponse) *NullableAIConfigVariationsResponse {
	return &NullableAIConfigVariationsResponse{value: val, isSet: true}
}

func (v NullableAIConfigVariationsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigVariationsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
