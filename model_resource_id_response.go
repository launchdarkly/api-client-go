...
// checks if the ResourceIDResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResourceIDResponse{}
...
type _ResourceIDResponse ResourceIDResponse
...
func (o ResourceIDResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ResourceIDResponse) UnmarshalJSON(data []byte) (err error) {
	varResourceIDResponse := _ResourceIDResponse{}

	err = json.Unmarshal(data, &varResourceIDResponse)

	if err != nil {
		return err
	}

	*o = ResourceIDResponse(varResourceIDResponse)
