...
func Test_ldapi_AccountUsageBetaApiService(t *testing.T) {
	...
	t.Run("Test AccountUsageBetaApiService GetMAUClientsideUsage", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.AccountUsageBetaApi.GetMAUClientsideUsage(context.Background()).Execute()
	...
	t.Run("Test AccountUsageBetaApiService GetMAUTotalUsage", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.AccountUsageBetaApi.GetMAUTotalUsage(context.Background()).Execute()
