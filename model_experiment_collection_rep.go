...
// checks if the ExperimentCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExperimentCollectionRep{}
...
type _ExperimentCollectionRep ExperimentCollectionRep
...
func (o ExperimentCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *ExperimentCollectionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varExperimentCollectionRep := _ExperimentCollectionRep{}

	err = json.Unmarshal(data, &varExperimentCollectionRep)

	if err != nil {
		return err
	}

	*o = ExperimentCollectionRep(varExperimentCollectionRep)
