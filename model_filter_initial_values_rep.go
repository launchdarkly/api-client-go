...
// FilterInitialValuesRep struct for FilterInitialValuesRep
type FilterInitialValuesRep struct {
	// The filter name
...
func (o FilterInitialValuesRep) MarshalJSON() ([]byte, error) {
...
type NullableFilterInitialValuesRep struct {
	value *FilterInitialValuesRep
	isSet bool
}

func (v NullableFilterInitialValuesRep) Get() *FilterInitialValuesRep {
	return v.value
}

func (v *NullableFilterInitialValuesRep) Set(val *FilterInitialValuesRep) {
	v.value = val
	v.isSet = true
}

func (v NullableFilterInitialValuesRep) IsSet() bool {
	return v.isSet
}

func (v *NullableFilterInitialValuesRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFilterInitialValuesRep(val *FilterInitialValuesRep) *NullableFilterInitialValuesRep {
	return &NullableFilterInitialValuesRep{value: val, isSet: true}
}

func (v NullableFilterInitialValuesRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFilterInitialValuesRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
