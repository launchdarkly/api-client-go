...
// checks if the InsightsMetricIndicatorRange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightsMetricIndicatorRange{}

// InsightsMetricIndicatorRange struct for InsightsMetricIndicatorRange
type InsightsMetricIndicatorRange struct {
...
type _InsightsMetricIndicatorRange InsightsMetricIndicatorRange
...
func NewInsightsMetricIndicatorRange(min int32, max int32) *InsightsMetricIndicatorRange {
	this := InsightsMetricIndicatorRange{}
	this.Min = min
	this.Max = max
	return &this
}
...
func (o InsightsMetricIndicatorRange) ToMap() (map[string]interface{}, error) {
...
func (o *InsightsMetricIndicatorRange) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightsMetricIndicatorRange := _InsightsMetricIndicatorRange{}

	err = json.Unmarshal(data, &varInsightsMetricIndicatorRange)

	if err != nil {
		return err
	}

	*o = InsightsMetricIndicatorRange(varInsightsMetricIndicatorRange)
...
type NullableInsightsMetricIndicatorRange struct {
	value *InsightsMetricIndicatorRange
	isSet bool
}
...
func NewNullableInsightsMetricIndicatorRange(val *InsightsMetricIndicatorRange) *NullableInsightsMetricIndicatorRange {
	return &NullableInsightsMetricIndicatorRange{value: val, isSet: true}
}
