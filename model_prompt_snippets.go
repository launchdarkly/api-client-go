...
// checks if the PromptSnippets type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromptSnippets{}

// PromptSnippets struct for PromptSnippets
type PromptSnippets struct {
	Links *PaginatedLinks `json:"_links,omitempty"`
	Items []PromptSnippet `json:"items"`
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _PromptSnippets PromptSnippets
...
func (o PromptSnippets) MarshalJSON() ([]byte, error) {
...
func (o PromptSnippets) ToMap() (map[string]interface{}, error) {
...
func (o *PromptSnippets) UnmarshalJSON(data []byte) (err error) {
	...
	varPromptSnippets := _PromptSnippets{}

	err = json.Unmarshal(data, &varPromptSnippets)

	if err != nil {
		return err
	}

	*o = PromptSnippets(varPromptSnippets)
...
type NullablePromptSnippets struct {
	value *PromptSnippets
	isSet bool
}

func (v NullablePromptSnippets) Get() *PromptSnippets {
	return v.value
}

func (v *NullablePromptSnippets) Set(val *PromptSnippets) {
	v.value = val
	v.isSet = true
}

func (v NullablePromptSnippets) IsSet() bool {
	return v.isSet
}

func (v *NullablePromptSnippets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromptSnippets(val *PromptSnippets) *NullablePromptSnippets {
	return &NullablePromptSnippets{value: val, isSet: true}
}

func (v NullablePromptSnippets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromptSnippets) UnmarshalJSON(src []byte) error {
	v.isSet = true
