...
```
 ...
 @return ApiPatchMembersRequest
*/
func (a *AccountMembersApiService) PatchMembers(ctx context.Context) ApiPatchMembersRequest {
	return ApiPatchMembersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return BulkEditMembersRep
func (a *AccountMembersApiService) PatchMembersExecute(r ApiPatchMembersRequest) (*BulkEditMembersRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AccountMembersApiService.PatchMembers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
