...
// checks if the AudienceConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AudienceConfiguration{}
...
type _AudienceConfiguration AudienceConfiguration
...
func (o AudienceConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *AudienceConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varAudienceConfiguration := _AudienceConfiguration{}

	err = json.Unmarshal(data, &varAudienceConfiguration)

	if err != nil {
		return err
	}

	*o = AudienceConfiguration(varAudienceConfiguration)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "releaseStrategy")
