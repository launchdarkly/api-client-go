...
// checks if the SnippetReferences type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SnippetReferences{}

// SnippetReferences struct for SnippetReferences
type SnippetReferences struct {
	...
	Items []SnippetReference `json:"items"`
	// The total number of references.
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _SnippetReferences SnippetReferences
...
func (o SnippetReferences) MarshalJSON() ([]byte, error) {
...
func (o SnippetReferences) ToMap() (map[string]interface{}, error) {
...
func (o *SnippetReferences) UnmarshalJSON(data []byte) (err error) {
	...
	varSnippetReferences := _SnippetReferences{}

	err = json.Unmarshal(data, &varSnippetReferences)

	if err != nil {
		return err
	}

	*o = SnippetReferences(varSnippetReferences)
...
type NullableSnippetReferences struct {
	value *SnippetReferences
	isSet bool
}

func (v NullableSnippetReferences) Get() *SnippetReferences {
	return v.value
}

func (v *NullableSnippetReferences) Set(val *SnippetReferences) {
	v.value = val
	v.isSet = true
}

func (v NullableSnippetReferences) IsSet() bool {
	return v.isSet
}

func (v *NullableSnippetReferences) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSnippetReferences(val *SnippetReferences) *NullableSnippetReferences {
	return &NullableSnippetReferences{value: val, isSet: true}
}

func (v NullableSnippetReferences) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSnippetReferences) UnmarshalJSON(src []byte) error {
	v.isSet = true
