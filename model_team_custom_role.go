...
// checks if the TeamCustomRole type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamCustomRole{}
...
type _TeamCustomRole TeamCustomRole
...
func (o TeamCustomRole) ToMap() (map[string]interface{}, error) {
...
func (o *TeamCustomRole) UnmarshalJSON(data []byte) (err error) {
	varTeamCustomRole := _TeamCustomRole{}

	err = json.Unmarshal(data, &varTeamCustomRole)

	if err != nil {
		return err
	}

	*o = TeamCustomRole(varTeamCustomRole)
