...
// checks if the AiConfigsMemberSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsMemberSummary{}

// AiConfigsMemberSummary struct for AiConfigsMemberSummary
type AiConfigsMemberSummary struct {
...
type _AiConfigsMemberSummary AiConfigsMemberSummary
...
func (o AiConfigsMemberSummary) MarshalJSON() ([]byte, error) {
...
func (o AiConfigsMemberSummary) ToMap() (map[string]interface{}, error) {
...
func (o *AiConfigsMemberSummary) UnmarshalJSON(data []byte) (err error) {
	...
	varAiConfigsMemberSummary := _AiConfigsMemberSummary{}

	err = json.Unmarshal(data, &varAiConfigsMemberSummary)

	if err != nil {
		return err
	}

	*o = AiConfigsMemberSummary(varAiConfigsMemberSummary)
...
type NullableAiConfigsMemberSummary struct {
	value *AiConfigsMemberSummary
	isSet bool
}

func (v NullableAiConfigsMemberSummary) Get() *AiConfigsMemberSummary {
	return v.value
}

func (v *NullableAiConfigsMemberSummary) Set(val *AiConfigsMemberSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsMemberSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsMemberSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsMemberSummary(val *AiConfigsMemberSummary) *NullableAiConfigsMemberSummary {
	return &NullableAiConfigsMemberSummary{value: val, isSet: true}
}

func (v NullableAiConfigsMemberSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsMemberSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
