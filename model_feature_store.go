...
// FeatureStore struct for FeatureStore
type FeatureStore struct {
	FeatureStoreRequest *FeatureStoreRequest `json:"featureStoreRequest,omitempty"`
	FormVariables []FormVariable `json:"formVariables,omitempty"`
	ValidationRequest *ValidationRequest `json:"validationRequest,omitempty"`
}
...
// GetFeatureStoreRequest returns the FeatureStoreRequest field value if set, zero value otherwise.
func (o *FeatureStore) GetFeatureStoreRequest() FeatureStoreRequest {
	if o == nil || o.FeatureStoreRequest == nil {
		var ret FeatureStoreRequest
		return ret
	}
	return *o.FeatureStoreRequest
}

// GetFeatureStoreRequestOk returns a tuple with the FeatureStoreRequest field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FeatureStore) GetFeatureStoreRequestOk() (*FeatureStoreRequest, bool) {
	if o == nil || o.FeatureStoreRequest == nil {
		return nil, false
	}
	return o.FeatureStoreRequest, true
}
...
// SetFeatureStoreRequest gets a reference to the given FeatureStoreRequest and assigns it to the FeatureStoreRequest field.
func (o *FeatureStore) SetFeatureStoreRequest(v FeatureStoreRequest) {
	o.FeatureStoreRequest = &v
}
...
// GetValidationRequest returns the ValidationRequest field value if set, zero value otherwise.
func (o *FeatureStore) GetValidationRequest() ValidationRequest {
	if o == nil || o.ValidationRequest == nil {
		var ret ValidationRequest
		return ret
	}
	return *o.ValidationRequest
}

// GetValidationRequestOk returns a tuple with the ValidationRequest field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FeatureStore) GetValidationRequestOk() (*ValidationRequest, bool) {
	if o == nil || o.ValidationRequest == nil {
		return nil, false
	}
	return o.ValidationRequest, true
}
...
// SetValidationRequest gets a reference to the given ValidationRequest and assigns it to the ValidationRequest field.
func (o *FeatureStore) SetValidationRequest(v ValidationRequest) {
	o.ValidationRequest = &v
}

func (o FeatureStore) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.FeatureStoreRequest != nil {
		toSerialize["featureStoreRequest"] = o.FeatureStoreRequest
	}
	if o.FormVariables != nil {
		toSerialize["formVariables"] = o.FormVariables
	}
	if o.ValidationRequest != nil {
		toSerialize["validationRequest"] = o.ValidationRequest
	}
	return json.Marshal(toSerialize)
}

type NullableFeatureStore struct {
	value *FeatureStore
	isSet bool
}

func (v NullableFeatureStore) Get() *FeatureStore {
	return v.value
}

func (v *NullableFeatureStore) Set(val *FeatureStore) {
	v.value = val
	v.isSet = true
}

func (v NullableFeatureStore) IsSet() bool {
	return v.isSet
}

func (v *NullableFeatureStore) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFeatureStore(val *FeatureStore) *NullableFeatureStore {
	return &NullableFeatureStore{value: val, isSet: true}
}

func (v NullableFeatureStore) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFeatureStore) UnmarshalJSON(src []byte) error {
	v.isSet = true
