...
// WebhookBodyTemplate struct for WebhookBodyTemplate
...
func (o WebhookBodyTemplate) MarshalJSON() ([]byte, error) {
...
type NullableWebhookBodyTemplate struct {
	value *WebhookBodyTemplate
	isSet bool
}

func (v NullableWebhookBodyTemplate) Get() *WebhookBodyTemplate {
	return v.value
}

func (v *NullableWebhookBodyTemplate) Set(val *WebhookBodyTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookBodyTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookBodyTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookBodyTemplate(val *WebhookBodyTemplate) *NullableWebhookBodyTemplate {
	return &NullableWebhookBodyTemplate{value: val, isSet: true}
}

func (v NullableWebhookBodyTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookBodyTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true
