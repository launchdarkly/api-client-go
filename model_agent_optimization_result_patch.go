...
// checks if the AgentOptimizationResultPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentOptimizationResultPatch{}

// AgentOptimizationResultPatch struct for AgentOptimizationResultPatch
type AgentOptimizationResultPatch struct {
	Status *AgentOptimizationResultStatus `json:"status,omitempty"`
	Activity *AgentOptimizationResultActivity `json:"activity,omitempty"`
...
type _AgentOptimizationResultPatch AgentOptimizationResultPatch
...
func NewAgentOptimizationResultPatch() *AgentOptimizationResultPatch {
	this := AgentOptimizationResultPatch{}
	return &this
}
...
// SetStatus gets a reference to the given AgentOptimizationResultStatus and assigns it to the Status field.
...
// SetActivity gets a reference to the given AgentOptimizationResultActivity and assigns it to the Activity field.
...
func (o AgentOptimizationResultPatch) MarshalJSON() ([]byte, error) {
...
func (o AgentOptimizationResultPatch) ToMap() (map[string]interface{}, error) {
...
func (o *AgentOptimizationResultPatch) UnmarshalJSON(data []byte) (err error) {
	varAgentOptimizationResultPatch := _AgentOptimizationResultPatch{}

	err = json.Unmarshal(data, &varAgentOptimizationResultPatch)

	if err != nil {
		return err
	}

	*o = AgentOptimizationResultPatch(varAgentOptimizationResultPatch)
...
type NullableAgentOptimizationResultPatch struct {
	value *AgentOptimizationResultPatch
	isSet bool
}

func (v NullableAgentOptimizationResultPatch) Get() *AgentOptimizationResultPatch {
	return v.value
}

func (v *NullableAgentOptimizationResultPatch) Set(val *AgentOptimizationResultPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentOptimizationResultPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentOptimizationResultPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentOptimizationResultPatch(val *AgentOptimizationResultPatch) *NullableAgentOptimizationResultPatch {
	return &NullableAgentOptimizationResultPatch{value: val, isSet: true}
}

func (v NullableAgentOptimizationResultPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentOptimizationResultPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
