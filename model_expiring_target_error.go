...
// checks if the ExpiringTargetError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpiringTargetError{}
...
type _ExpiringTargetError ExpiringTargetError
...
// GetInstructionIndexOk returns a tuple with the InstructionIndex field value
...
func (o ExpiringTargetError) ToMap() (map[string]interface{}, error) {
...
func (o *ExpiringTargetError) UnmarshalJSON(data []byte) (err error) {
	...
	varExpiringTargetError := _ExpiringTargetError{}

	err = json.Unmarshal(data, &varExpiringTargetError)

	if err != nil {
		return err
	}

	*o = ExpiringTargetError(varExpiringTargetError)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "instructionIndex")
...
func NewNullableExpiringTargetError(val *ExpiringTargetError) *NullableExpiringTargetError {
	return &NullableExpiringTargetError{value: val, isSet: true}
}
