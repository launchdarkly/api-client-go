...
// checks if the ActionOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActionOutput{}
...
type _ActionOutput ActionOutput
...
func (o ActionOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ActionOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varActionOutput := _ActionOutput{}

	err = json.Unmarshal(data, &varActionOutput)

	if err != nil {
		return err
	}

	*o = ActionOutput(varActionOutput)
