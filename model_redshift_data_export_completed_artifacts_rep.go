...
// checks if the RedshiftDataExportCompletedArtifactsRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RedshiftDataExportCompletedArtifactsRep{}

// RedshiftDataExportCompletedArtifactsRep struct for RedshiftDataExportCompletedArtifactsRep
type RedshiftDataExportCompletedArtifactsRep struct {
	...
	SqlSetupScript *string `json:"sqlSetupScript,omitempty"`
	// The auto-generated S3 staging bucket name.
	S3BucketName *string `json:"s3BucketName,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _RedshiftDataExportCompletedArtifactsRep RedshiftDataExportCompletedArtifactsRep
...
func NewRedshiftDataExportCompletedArtifactsRep() *RedshiftDataExportCompletedArtifactsRep {
	this := RedshiftDataExportCompletedArtifactsRep{}
	return &this
}
...
// GetSqlSetupScript returns the SqlSetupScript field value if set, zero value otherwise.
func (o *RedshiftDataExportCompletedArtifactsRep) GetSqlSetupScript() string {
	if o == nil || IsNil(o.SqlSetupScript) {
		var ret string
		return ret
	}
	return *o.SqlSetupScript
}

// GetSqlSetupScriptOk returns a tuple with the SqlSetupScript field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *RedshiftDataExportCompletedArtifactsRep) GetSqlSetupScriptOk() (*string, bool) {
	if o == nil || IsNil(o.SqlSetupScript) {
		return nil, false
	}
	return o.SqlSetupScript, true
}
...
// SetSqlSetupScript gets a reference to the given string and assigns it to the SqlSetupScript field.
...
func (o RedshiftDataExportCompletedArtifactsRep) MarshalJSON() ([]byte, error) {
...
func (o RedshiftDataExportCompletedArtifactsRep) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.SqlSetupScript) {
		toSerialize["sqlSetupScript"] = o.SqlSetupScript
	}
...
func (o *RedshiftDataExportCompletedArtifactsRep) UnmarshalJSON(data []byte) (err error) {
	varRedshiftDataExportCompletedArtifactsRep := _RedshiftDataExportCompletedArtifactsRep{}

	err = json.Unmarshal(data, &varRedshiftDataExportCompletedArtifactsRep)

	if err != nil {
		return err
	}

	*o = RedshiftDataExportCompletedArtifactsRep(varRedshiftDataExportCompletedArtifactsRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "sqlSetupScript")
...
type NullableRedshiftDataExportCompletedArtifactsRep struct {
	value *RedshiftDataExportCompletedArtifactsRep
	isSet bool
}

func (v NullableRedshiftDataExportCompletedArtifactsRep) Get() *RedshiftDataExportCompletedArtifactsRep {
	return v.value
}

func (v *NullableRedshiftDataExportCompletedArtifactsRep) Set(val *RedshiftDataExportCompletedArtifactsRep) {
	v.value = val
	v.isSet = true
}

func (v NullableRedshiftDataExportCompletedArtifactsRep) IsSet() bool {
	return v.isSet
}

func (v *NullableRedshiftDataExportCompletedArtifactsRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRedshiftDataExportCompletedArtifactsRep(val *RedshiftDataExportCompletedArtifactsRep) *NullableRedshiftDataExportCompletedArtifactsRep {
	return &NullableRedshiftDataExportCompletedArtifactsRep{value: val, isSet: true}
}

func (v NullableRedshiftDataExportCompletedArtifactsRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRedshiftDataExportCompletedArtifactsRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
