...
// checks if the InsightsChart type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightsChart{}

// InsightsChart struct for InsightsChart
type InsightsChart struct {
	Metadata InsightsChartMetadata `json:"metadata"`
	// Series data for the chart
	Series []InsightsChartSeries `json:"series"`
	AdditionalProperties map[string]interface{}
}

type _InsightsChart InsightsChart
...
func (o InsightsChart) ToMap() (map[string]interface{}, error) {
...
func (o *InsightsChart) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightsChart := _InsightsChart{}

	err = json.Unmarshal(data, &varInsightsChart)

	if err != nil {
		return err
	}

	*o = InsightsChart(varInsightsChart)
...
func NewNullableInsightsChart(val *InsightsChart) *NullableInsightsChart {
	return &NullableInsightsChart{value: val, isSet: true}
}
