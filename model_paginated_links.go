...
type _PaginatedLinks PaginatedLinks
...
func (o *PaginatedLinks) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedLinks := _PaginatedLinks{}

	err = json.Unmarshal(data, &varPaginatedLinks)

	if err != nil {
		return err
	}

	*o = PaginatedLinks(varPaginatedLinks)
