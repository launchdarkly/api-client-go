...
// checks if the VariationTool type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VariationTool{}

// VariationTool struct for VariationTool
type VariationTool struct {
...
type _VariationTool VariationTool
...
func (o VariationTool) ToMap() (map[string]interface{}, error) {
...
func (o *VariationTool) UnmarshalJSON(data []byte) (err error) {
	...
	varVariationTool := _VariationTool{}

	err = json.Unmarshal(data, &varVariationTool)

	if err != nil {
		return err
	}

	*o = VariationTool(varVariationTool)
...
type NullableVariationTool struct {
	value *VariationTool
	isSet bool
}

func (v NullableVariationTool) Get() *VariationTool {
	return v.value
}

func (v *NullableVariationTool) Set(val *VariationTool) {
	v.value = val
	v.isSet = true
}

func (v NullableVariationTool) IsSet() bool {
	return v.isSet
}

func (v *NullableVariationTool) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVariationTool(val *VariationTool) *NullableVariationTool {
	return &NullableVariationTool{value: val, isSet: true}
}

func (v NullableVariationTool) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVariationTool) UnmarshalJSON(src []byte) error {
	v.isSet = true
