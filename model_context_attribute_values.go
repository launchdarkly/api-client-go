...
// checks if the ContextAttributeValues type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextAttributeValues{}

// ContextAttributeValues struct for ContextAttributeValues
type ContextAttributeValues struct {
	// The kind associated with this collection of context attribute values.
	Kind string `json:"kind"`
	// A collection of context attribute values.
	Values []ContextAttributeValue `json:"values"`
	AdditionalProperties map[string]interface{}
}

type _ContextAttributeValues ContextAttributeValues
...
func (o ContextAttributeValues) ToMap() (map[string]interface{}, error) {
...
func (o *ContextAttributeValues) UnmarshalJSON(data []byte) (err error) {
	...
	varContextAttributeValues := _ContextAttributeValues{}

	err = json.Unmarshal(data, &varContextAttributeValues)

	if err != nil {
		return err
	}

	*o = ContextAttributeValues(varContextAttributeValues)
...
func NewNullableContextAttributeValues(val *ContextAttributeValues) *NullableContextAttributeValues {
	return &NullableContextAttributeValues{value: val, isSet: true}
}
