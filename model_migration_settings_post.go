...
// checks if the MigrationSettingsPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MigrationSettingsPost{}

// MigrationSettingsPost struct for MigrationSettingsPost
type MigrationSettingsPost struct {
...
type _MigrationSettingsPost MigrationSettingsPost
...
// GetStageCountOk returns a tuple with the StageCount field value
// and a boolean to check if the value has been set.
...
func (o MigrationSettingsPost) ToMap() (map[string]interface{}, error) {
...
func (o *MigrationSettingsPost) UnmarshalJSON(data []byte) (err error) {
	...
	varMigrationSettingsPost := _MigrationSettingsPost{}

	err = json.Unmarshal(data, &varMigrationSettingsPost)

	if err != nil {
		return err
	}

	*o = MigrationSettingsPost(varMigrationSettingsPost)
...
func NewNullableMigrationSettingsPost(val *MigrationSettingsPost) *NullableMigrationSettingsPost {
	return &NullableMigrationSettingsPost{value: val, isSet: true}
}
