...
func (o *Webhooks) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhooks := _Webhooks{}

	err = json.Unmarshal(data, &varWebhooks)

	if err != nil {
		return err
	}

	*o = Webhooks(varWebhooks)
