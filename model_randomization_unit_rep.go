...
// checks if the RandomizationUnitRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RandomizationUnitRep{}
...
type _RandomizationUnitRep RandomizationUnitRep
...
func (o RandomizationUnitRep) ToMap() (map[string]interface{}, error) {
...
func (o *RandomizationUnitRep) UnmarshalJSON(data []byte) (err error) {
	varRandomizationUnitRep := _RandomizationUnitRep{}

	err = json.Unmarshal(data, &varRandomizationUnitRep)

	if err != nil {
		return err
	}

	*o = RandomizationUnitRep(varRandomizationUnitRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_hidden")
		delete(additionalProperties, "_displayName")
