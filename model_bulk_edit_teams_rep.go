...
// checks if the BulkEditTeamsRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkEditTeamsRep{}
...
type _BulkEditTeamsRep BulkEditTeamsRep
...
func (o BulkEditTeamsRep) ToMap() (map[string]interface{}, error) {
...
func (o *BulkEditTeamsRep) UnmarshalJSON(data []byte) (err error) {
	varBulkEditTeamsRep := _BulkEditTeamsRep{}

	err = json.Unmarshal(data, &varBulkEditTeamsRep)

	if err != nil {
		return err
	}

	*o = BulkEditTeamsRep(varBulkEditTeamsRep)
