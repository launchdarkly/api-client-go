...
// SetItems gets a reference to the given []ProjectRep and assigns it to the Items field.
func (o *ProjectCollectionRep) SetItems(v []ProjectRep) {
	o.Items = &v
}

func (o ProjectCollectionRep) MarshalJSON() ([]byte, error) {
...
type NullableProjectCollectionRep struct {
	value *ProjectCollectionRep
	isSet bool
}

func (v NullableProjectCollectionRep) Get() *ProjectCollectionRep {
	return v.value
}

func (v *NullableProjectCollectionRep) Set(val *ProjectCollectionRep) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectCollectionRep) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectCollectionRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectCollectionRep(val *ProjectCollectionRep) *NullableProjectCollectionRep {
	return &NullableProjectCollectionRep{value: val, isSet: true}
}

func (v NullableProjectCollectionRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectCollectionRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
