...
// MetricQueryGroupByRep struct for MetricQueryGroupByRep
type MetricQueryGroupByRep struct {
	DimensionKey string `json:"dimensionKey"`
	DimensionKind string `json:"dimensionKind"`
	DimensionContextKind *string `json:"dimensionContextKind,omitempty"`
}
...
// GetDimensionContextKind returns the DimensionContextKind field value if set, zero value otherwise.
func (o *MetricQueryGroupByRep) GetDimensionContextKind() string {
	if o == nil || o.DimensionContextKind == nil {
		var ret string
		return ret
	}
	return *o.DimensionContextKind
}

// GetDimensionContextKindOk returns a tuple with the DimensionContextKind field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MetricQueryGroupByRep) GetDimensionContextKindOk() (*string, bool) {
	if o == nil || o.DimensionContextKind == nil {
		return nil, false
	}
	return o.DimensionContextKind, true
}
...
// SetDimensionContextKind gets a reference to the given string and assigns it to the DimensionContextKind field.
func (o *MetricQueryGroupByRep) SetDimensionContextKind(v string) {
	o.DimensionContextKind = &v
}

func (o MetricQueryGroupByRep) MarshalJSON() ([]byte, error) {
	...
	if o.DimensionContextKind != nil {
		toSerialize["dimensionContextKind"] = o.DimensionContextKind
	}
	return json.Marshal(toSerialize)
}

type NullableMetricQueryGroupByRep struct {
	value *MetricQueryGroupByRep
	isSet bool
}

func (v NullableMetricQueryGroupByRep) Get() *MetricQueryGroupByRep {
	return v.value
}

func (v *NullableMetricQueryGroupByRep) Set(val *MetricQueryGroupByRep) {
	v.value = val
	v.isSet = true
}

func (v NullableMetricQueryGroupByRep) IsSet() bool {
	return v.isSet
}

func (v *NullableMetricQueryGroupByRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetricQueryGroupByRep(val *MetricQueryGroupByRep) *NullableMetricQueryGroupByRep {
	return &NullableMetricQueryGroupByRep{value: val, isSet: true}
}

func (v NullableMetricQueryGroupByRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetricQueryGroupByRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
