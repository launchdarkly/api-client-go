...
// checks if the AIConfigVariationPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigVariationPatch{}
...
type _AIConfigVariationPatch AIConfigVariationPatch
...
func (o AIConfigVariationPatch) ToMap() (map[string]interface{}, error) {
...
func (o *AIConfigVariationPatch) UnmarshalJSON(data []byte) (err error) {
	varAIConfigVariationPatch := _AIConfigVariationPatch{}

	err = json.Unmarshal(data, &varAIConfigVariationPatch)

	if err != nil {
		return err
	}

	*o = AIConfigVariationPatch(varAIConfigVariationPatch)
