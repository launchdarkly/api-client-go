...
// checks if the ModelConfigPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModelConfigPost{}
...
type _ModelConfigPost ModelConfigPost
...
func (o ModelConfigPost) ToMap() (map[string]interface{}, error) {
...
func (o *ModelConfigPost) UnmarshalJSON(data []byte) (err error) {
	...
	varModelConfigPost := _ModelConfigPost{}

	err = json.Unmarshal(data, &varModelConfigPost)

	if err != nil {
		return err
	}

	*o = ModelConfigPost(varModelConfigPost)
