...
// checks if the LeadTimeStagesRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LeadTimeStagesRep{}
...
type _LeadTimeStagesRep LeadTimeStagesRep
...
func (o *LeadTimeStagesRep) GetDeployDurationMs() int64 {
	if o == nil || IsNil(o.DeployDurationMs) {
		var ret int64
		return ret
	}
...
func (o *LeadTimeStagesRep) GetTotalLeadTimeMs() int64 {
	if o == nil || IsNil(o.TotalLeadTimeMs) {
		var ret int64
		return ret
	}
...
func (o LeadTimeStagesRep) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DeployDurationMs) {
		toSerialize["deployDurationMs"] = o.DeployDurationMs
	}
	if !IsNil(o.TotalLeadTimeMs) {
...
func (o *LeadTimeStagesRep) UnmarshalJSON(data []byte) (err error) {
	...
	varLeadTimeStagesRep := _LeadTimeStagesRep{}

	err = json.Unmarshal(data, &varLeadTimeStagesRep)

	if err != nil {
		return err
	}

	*o = LeadTimeStagesRep(varLeadTimeStagesRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "waitDurationMs")
		delete(additionalProperties, "deployDurationMs")
		delete(additionalProperties, "totalLeadTimeMs")
