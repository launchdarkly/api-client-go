...
// checks if the FlagImportConfigurationPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagImportConfigurationPost{}
...
type _FlagImportConfigurationPost FlagImportConfigurationPost
...
func (o FlagImportConfigurationPost) ToMap() (map[string]interface{}, error) {
...
func (o *FlagImportConfigurationPost) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagImportConfigurationPost := _FlagImportConfigurationPost{}

	err = json.Unmarshal(data, &varFlagImportConfigurationPost)

	if err != nil {
		return err
	}

	*o = FlagImportConfigurationPost(varFlagImportConfigurationPost)
