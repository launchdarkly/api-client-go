...
// checks if the SdkKeysForGetSdkKeys type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdkKeysForGetSdkKeys{}

// SdkKeysForGetSdkKeys struct for SdkKeysForGetSdkKeys
type SdkKeysForGetSdkKeys struct {
	Links *SdkKeysSelfLink `json:"_links,omitempty"`
	Items []SdkKey `json:"items"`
	// The total number of SDK keys matching the query, before pagination.
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _SdkKeysForGetSdkKeys SdkKeysForGetSdkKeys
...
// SetLinks gets a reference to the given SdkKeysSelfLink and assigns it to the Links field.
...
func (o SdkKeysForGetSdkKeys) MarshalJSON() ([]byte, error) {
...
func (o SdkKeysForGetSdkKeys) ToMap() (map[string]interface{}, error) {
...
func (o *SdkKeysForGetSdkKeys) UnmarshalJSON(data []byte) (err error) {
	...
	varSdkKeysForGetSdkKeys := _SdkKeysForGetSdkKeys{}

	err = json.Unmarshal(data, &varSdkKeysForGetSdkKeys)

	if err != nil {
		return err
	}

	*o = SdkKeysForGetSdkKeys(varSdkKeysForGetSdkKeys)
...
type NullableSdkKeysForGetSdkKeys struct {
	value *SdkKeysForGetSdkKeys
	isSet bool
}

func (v NullableSdkKeysForGetSdkKeys) Get() *SdkKeysForGetSdkKeys {
	return v.value
}

func (v *NullableSdkKeysForGetSdkKeys) Set(val *SdkKeysForGetSdkKeys) {
	v.value = val
	v.isSet = true
}

func (v NullableSdkKeysForGetSdkKeys) IsSet() bool {
	return v.isSet
}

func (v *NullableSdkKeysForGetSdkKeys) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdkKeysForGetSdkKeys(val *SdkKeysForGetSdkKeys) *NullableSdkKeysForGetSdkKeys {
	return &NullableSdkKeysForGetSdkKeys{value: val, isSet: true}
}

func (v NullableSdkKeysForGetSdkKeys) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdkKeysForGetSdkKeys) UnmarshalJSON(src []byte) error {
	v.isSet = true
