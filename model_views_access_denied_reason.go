...
// checks if the ViewsAccessDeniedReason type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewsAccessDeniedReason{}

// ViewsAccessDeniedReason struct for ViewsAccessDeniedReason
type ViewsAccessDeniedReason struct {
...
type _ViewsAccessDeniedReason ViewsAccessDeniedReason
...
func (o ViewsAccessDeniedReason) MarshalJSON() ([]byte, error) {
...
func (o ViewsAccessDeniedReason) ToMap() (map[string]interface{}, error) {
...
func (o *ViewsAccessDeniedReason) UnmarshalJSON(data []byte) (err error) {
	...
	varViewsAccessDeniedReason := _ViewsAccessDeniedReason{}

	err = json.Unmarshal(data, &varViewsAccessDeniedReason)

	if err != nil {
		return err
	}

	*o = ViewsAccessDeniedReason(varViewsAccessDeniedReason)
...
type NullableViewsAccessDeniedReason struct {
	value *ViewsAccessDeniedReason
	isSet bool
}

func (v NullableViewsAccessDeniedReason) Get() *ViewsAccessDeniedReason {
	return v.value
}

func (v *NullableViewsAccessDeniedReason) Set(val *ViewsAccessDeniedReason) {
	v.value = val
	v.isSet = true
}

func (v NullableViewsAccessDeniedReason) IsSet() bool {
	return v.isSet
}

func (v *NullableViewsAccessDeniedReason) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewsAccessDeniedReason(val *ViewsAccessDeniedReason) *NullableViewsAccessDeniedReason {
	return &NullableViewsAccessDeniedReason{value: val, isSet: true}
}

func (v NullableViewsAccessDeniedReason) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewsAccessDeniedReason) UnmarshalJSON(src []byte) error {
	v.isSet = true
