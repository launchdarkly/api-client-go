...
// checks if the AuthorizedAppDataRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthorizedAppDataRep{}
...
type _AuthorizedAppDataRep AuthorizedAppDataRep
...
func (o AuthorizedAppDataRep) ToMap() (map[string]interface{}, error) {
...
func (o *AuthorizedAppDataRep) UnmarshalJSON(data []byte) (err error) {
	varAuthorizedAppDataRep := _AuthorizedAppDataRep{}

	err = json.Unmarshal(data, &varAuthorizedAppDataRep)

	if err != nil {
		return err
	}

	*o = AuthorizedAppDataRep(varAuthorizedAppDataRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "isScim")
		delete(additionalProperties, "name")
		delete(additionalProperties, "maintainerName")
