...
type Experiment struct {
	...
	AnalysisConfig *AnalysisConfigRep `json:"analysisConfig,omitempty"`
	MutableFieldsByStatus *MutableFieldsByStatusRep `json:"mutableFieldsByStatus,omitempty"`
...
func (o *Experiment) GetCurrentIteration() IterationRep {
	if o == nil || IsNil(o.CurrentIteration) {
...
func (o *Experiment) GetDraftIteration() IterationRep {
	if o == nil || IsNil(o.DraftIteration) {
		var ret IterationRep
		return ret
	}
...
func (o *Experiment) GetPreviousIterations() []IterationRep {
	if o == nil || IsNil(o.PreviousIterations) {
		var ret []IterationRep
		return ret
	}
...
// SetAnalysisConfig gets a reference to the given AnalysisConfigRep and assigns it to the AnalysisConfig field.
func (o *Experiment) SetAnalysisConfig(v AnalysisConfigRep) {
	o.AnalysisConfig = &v
}

// GetMutableFieldsByStatus returns the MutableFieldsByStatus field value if set, zero value otherwise.
func (o *Experiment) GetMutableFieldsByStatus() MutableFieldsByStatusRep {
	if o == nil || IsNil(o.MutableFieldsByStatus) {
		var ret MutableFieldsByStatusRep
		return ret
	}
	return *o.MutableFieldsByStatus
}

// GetMutableFieldsByStatusOk returns a tuple with the MutableFieldsByStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Experiment) GetMutableFieldsByStatusOk() (*MutableFieldsByStatusRep, bool) {
	if o == nil || IsNil(o.MutableFieldsByStatus) {
		return nil, false
	}
	return o.MutableFieldsByStatus, true
}
...
// SetMutableFieldsByStatus gets a reference to the given MutableFieldsByStatusRep and assigns it to the MutableFieldsByStatus field.
func (o *Experiment) SetMutableFieldsByStatus(v MutableFieldsByStatusRep) {
	o.MutableFieldsByStatus = &v
}
...
func (o Experiment) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DraftIteration) {
		toSerialize["draftIteration"] = o.DraftIteration
	}
	if !IsNil(o.PreviousIterations) {
		toSerialize["previousIterations"] = o.PreviousIterations
	}
	if !IsNil(o.AnalysisConfig) {
		toSerialize["analysisConfig"] = o.AnalysisConfig
	}
	if !IsNil(o.MutableFieldsByStatus) {
		toSerialize["mutableFieldsByStatus"] = o.MutableFieldsByStatus
	}
...
func (o *Experiment) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Experiment(varExperiment)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "methodology")
		...
		delete(additionalProperties, "draftIteration")
		delete(additionalProperties, "previousIterations")
		delete(additionalProperties, "analysisConfig")
		delete(additionalProperties, "mutableFieldsByStatus")
