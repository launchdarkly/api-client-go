...
// checks if the ReleasePipelineCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleasePipelineCollection{}

// ReleasePipelineCollection struct for ReleasePipelineCollection
type ReleasePipelineCollection struct {
...
type _ReleasePipelineCollection ReleasePipelineCollection
...
func NewReleasePipelineCollection(items []ReleasePipeline, totalCount int32) *ReleasePipelineCollection {
	this := ReleasePipelineCollection{}
	this.Items = items
...
func (o ReleasePipelineCollection) ToMap() (map[string]interface{}, error) {
...
func (o *ReleasePipelineCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varReleasePipelineCollection := _ReleasePipelineCollection{}

	err = json.Unmarshal(data, &varReleasePipelineCollection)

	if err != nil {
		return err
	}

	*o = ReleasePipelineCollection(varReleasePipelineCollection)
...
type NullableReleasePipelineCollection struct {
	value *ReleasePipelineCollection
	isSet bool
}
...
func NewNullableReleasePipelineCollection(val *ReleasePipelineCollection) *NullableReleasePipelineCollection {
	return &NullableReleasePipelineCollection{value: val, isSet: true}
}
