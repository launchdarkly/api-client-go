...
// checks if the AgentSkillPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentSkillPatch{}

// AgentSkillPatch struct for AgentSkillPatch
...
type _AgentSkillPatch AgentSkillPatch

// NewAgentSkillPatch instantiates a new AgentSkillPatch object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAgentSkillPatch() *AgentSkillPatch {
	this := AgentSkillPatch{}
	return &this
}

// NewAgentSkillPatchWithDefaults instantiates a new AgentSkillPatch object
...
func (o AgentSkillPatch) MarshalJSON() ([]byte, error) {
...
func (o AgentSkillPatch) ToMap() (map[string]interface{}, error) {
...
func (o *AgentSkillPatch) UnmarshalJSON(data []byte) (err error) {
	varAgentSkillPatch := _AgentSkillPatch{}

	err = json.Unmarshal(data, &varAgentSkillPatch)

	if err != nil {
		return err
	}

	*o = AgentSkillPatch(varAgentSkillPatch)
...
type NullableAgentSkillPatch struct {
	value *AgentSkillPatch
	isSet bool
}

func (v NullableAgentSkillPatch) Get() *AgentSkillPatch {
	return v.value
}

func (v *NullableAgentSkillPatch) Set(val *AgentSkillPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentSkillPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentSkillPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentSkillPatch(val *AgentSkillPatch) *NullableAgentSkillPatch {
	return &NullableAgentSkillPatch{value: val, isSet: true}
}

func (v NullableAgentSkillPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentSkillPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
