...
// checks if the CapabilityConfigPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilityConfigPost{}

// CapabilityConfigPost struct for CapabilityConfigPost
type CapabilityConfigPost struct {
	Approvals *ApprovalsCapabilityConfig `json:"approvals,omitempty"`
	AuditLogEventsHook *AuditLogEventsHookCapabilityConfigPost `json:"auditLogEventsHook,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _CapabilityConfigPost CapabilityConfigPost
...
func (o *CapabilityConfigPost) GetApprovals() ApprovalsCapabilityConfig {
	if o == nil || IsNil(o.Approvals) {
		var ret ApprovalsCapabilityConfig
		return ret
	}
	return *o.Approvals
}
...
// SetApprovals gets a reference to the given ApprovalsCapabilityConfig and assigns it to the Approvals field.
...
func (o *CapabilityConfigPost) GetAuditLogEventsHook() AuditLogEventsHookCapabilityConfigPost {
	if o == nil || IsNil(o.AuditLogEventsHook) {
		var ret AuditLogEventsHookCapabilityConfigPost
		return ret
	}
...
// SetAuditLogEventsHook gets a reference to the given AuditLogEventsHookCapabilityConfigPost and assigns it to the AuditLogEventsHook field.
func (o *CapabilityConfigPost) SetAuditLogEventsHook(v AuditLogEventsHookCapabilityConfigPost) {
	o.AuditLogEventsHook = &v
}

func (o CapabilityConfigPost) MarshalJSON() ([]byte, error) {
...
func (o CapabilityConfigPost) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Approvals) {
		toSerialize["approvals"] = o.Approvals
	}
	if !IsNil(o.AuditLogEventsHook) {
...
func (o *CapabilityConfigPost) UnmarshalJSON(data []byte) (err error) {
	varCapabilityConfigPost := _CapabilityConfigPost{}

	err = json.Unmarshal(data, &varCapabilityConfigPost)

	if err != nil {
		return err
	}

	*o = CapabilityConfigPost(varCapabilityConfigPost)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "approvals")
		delete(additionalProperties, "auditLogEventsHook")
...
type NullableCapabilityConfigPost struct {
	value *CapabilityConfigPost
	isSet bool
}

func (v NullableCapabilityConfigPost) Get() *CapabilityConfigPost {
	return v.value
}

func (v *NullableCapabilityConfigPost) Set(val *CapabilityConfigPost) {
	v.value = val
	v.isSet = true
}

func (v NullableCapabilityConfigPost) IsSet() bool {
	return v.isSet
}

func (v *NullableCapabilityConfigPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCapabilityConfigPost(val *CapabilityConfigPost) *NullableCapabilityConfigPost {
	return &NullableCapabilityConfigPost{value: val, isSet: true}
}

func (v NullableCapabilityConfigPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCapabilityConfigPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
