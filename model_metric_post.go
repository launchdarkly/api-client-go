...
// checks if the MetricPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricPost{}
...
// SetDenominator gets a reference to the given DenominatorPost and assigns it to the Denominator field.
...
func (o MetricPost) ToMap() (map[string]interface{}, error) {
...
func (o *MetricPost) UnmarshalJSON(data []byte) (err error) {
	...
	varMetricPost := _MetricPost{}

	err = json.Unmarshal(data, &varMetricPost)

	if err != nil {
		return err
	}

	*o = MetricPost(varMetricPost)
