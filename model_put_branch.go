...
// checks if the PutBranch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PutBranch{}
...
func (o *PutBranch) GetUpdateSequenceId() int64 {
	if o == nil || IsNil(o.UpdateSequenceId) {
		var ret int64
		return ret
	}
...
func (o PutBranch) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	toSerialize["head"] = o.Head
	if !IsNil(o.UpdateSequenceId) {
...
func (o *PutBranch) UnmarshalJSON(data []byte) (err error) {
	...
	varPutBranch := _PutBranch{}

	err = json.Unmarshal(data, &varPutBranch)

	if err != nil {
		return err
	}

	*o = PutBranch(varPutBranch)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "updateSequenceId")
		delete(additionalProperties, "syncTime")
		delete(additionalProperties, "references")
		delete(additionalProperties, "commitTime")
