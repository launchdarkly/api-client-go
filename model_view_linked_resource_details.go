...
// checks if the ViewLinkedResourceDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewLinkedResourceDetails{}

// ViewLinkedResourceDetails struct for ViewLinkedResourceDetails
type ViewLinkedResourceDetails struct {
	View *View `json:"view,omitempty"`
	Flag *ExpandedFlag `json:"flag,omitempty"`
	Segment *ExpandedSegment `json:"segment,omitempty"`
	AiConfig *ExpandedAIConfig `json:"aiConfig,omitempty"`
	Metric *ExpandedMetric `json:"metric,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ViewLinkedResourceDetails ViewLinkedResourceDetails
...
func NewViewLinkedResourceDetails() *ViewLinkedResourceDetails {
	this := ViewLinkedResourceDetails{}
	return &this
}
...
// SetFlag gets a reference to the given ExpandedFlag and assigns it to the Flag field.
...
// SetSegment gets a reference to the given ExpandedSegment and assigns it to the Segment field.
func (o *ViewLinkedResourceDetails) SetSegment(v ExpandedSegment) {
	o.Segment = &v
}

// GetAiConfig returns the AiConfig field value if set, zero value otherwise.
func (o *ViewLinkedResourceDetails) GetAiConfig() ExpandedAIConfig {
	if o == nil || IsNil(o.AiConfig) {
...
// GetAiConfigOk returns a tuple with the AiConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ViewLinkedResourceDetails) GetAiConfigOk() (*ExpandedAIConfig, bool) {
	if o == nil || IsNil(o.AiConfig) {
		return nil, false
	}
	return o.AiConfig, true
}
...
// SetAiConfig gets a reference to the given ExpandedAIConfig and assigns it to the AiConfig field.
...
// SetMetric gets a reference to the given ExpandedMetric and assigns it to the Metric field.
func (o *ViewLinkedResourceDetails) SetMetric(v ExpandedMetric) {
	o.Metric = &v
}

func (o ViewLinkedResourceDetails) MarshalJSON() ([]byte, error) {
...
func (o ViewLinkedResourceDetails) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AiConfig) {
		toSerialize["aiConfig"] = o.AiConfig
	}
	if !IsNil(o.Metric) {
...
func (o *ViewLinkedResourceDetails) UnmarshalJSON(data []byte) (err error) {
	varViewLinkedResourceDetails := _ViewLinkedResourceDetails{}

	err = json.Unmarshal(data, &varViewLinkedResourceDetails)

	if err != nil {
		return err
	}

	*o = ViewLinkedResourceDetails(varViewLinkedResourceDetails)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "aiConfig")
...
type NullableViewLinkedResourceDetails struct {
	value *ViewLinkedResourceDetails
	isSet bool
}

func (v NullableViewLinkedResourceDetails) Get() *ViewLinkedResourceDetails {
	return v.value
}

func (v *NullableViewLinkedResourceDetails) Set(val *ViewLinkedResourceDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableViewLinkedResourceDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableViewLinkedResourceDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewLinkedResourceDetails(val *ViewLinkedResourceDetails) *NullableViewLinkedResourceDetails {
	return &NullableViewLinkedResourceDetails{value: val, isSet: true}
}

func (v NullableViewLinkedResourceDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewLinkedResourceDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
