...
// checks if the FlagImportIntegrationLinks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagImportIntegrationLinks{}

// FlagImportIntegrationLinks struct for FlagImportIntegrationLinks
type FlagImportIntegrationLinks struct {
	Self Link `json:"self"`
...
type _FlagImportIntegrationLinks FlagImportIntegrationLinks
...
func NewFlagImportIntegrationLinks(self Link, parent Link, project Link) *FlagImportIntegrationLinks {
	this := FlagImportIntegrationLinks{}
	this.Self = self
	this.Parent = parent
...
func (o FlagImportIntegrationLinks) MarshalJSON() ([]byte, error) {
...
func (o FlagImportIntegrationLinks) ToMap() (map[string]interface{}, error) {
...
func (o *FlagImportIntegrationLinks) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagImportIntegrationLinks := _FlagImportIntegrationLinks{}

	err = json.Unmarshal(data, &varFlagImportIntegrationLinks)

	if err != nil {
		return err
	}

	*o = FlagImportIntegrationLinks(varFlagImportIntegrationLinks)
...
type NullableFlagImportIntegrationLinks struct {
	value *FlagImportIntegrationLinks
	isSet bool
}

func (v NullableFlagImportIntegrationLinks) Get() *FlagImportIntegrationLinks {
	return v.value
}

func (v *NullableFlagImportIntegrationLinks) Set(val *FlagImportIntegrationLinks) {
	v.value = val
	v.isSet = true
}

func (v NullableFlagImportIntegrationLinks) IsSet() bool {
	return v.isSet
}

func (v *NullableFlagImportIntegrationLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlagImportIntegrationLinks(val *FlagImportIntegrationLinks) *NullableFlagImportIntegrationLinks {
	return &NullableFlagImportIntegrationLinks{value: val, isSet: true}
}

func (v NullableFlagImportIntegrationLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlagImportIntegrationLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
