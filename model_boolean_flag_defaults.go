...
// checks if the BooleanFlagDefaults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BooleanFlagDefaults{}
...
type _BooleanFlagDefaults BooleanFlagDefaults
...
func (o BooleanFlagDefaults) ToMap() (map[string]interface{}, error) {
...
func (o *BooleanFlagDefaults) UnmarshalJSON(data []byte) (err error) {
	...
	varBooleanFlagDefaults := _BooleanFlagDefaults{}

	err = json.Unmarshal(data, &varBooleanFlagDefaults)

	if err != nil {
		return err
	}

	*o = BooleanFlagDefaults(varBooleanFlagDefaults)
