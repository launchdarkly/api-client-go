...
// checks if the ExpandedDirectlyLinkedFlag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedDirectlyLinkedFlag{}

// ExpandedDirectlyLinkedFlag struct for ExpandedDirectlyLinkedFlag
type ExpandedDirectlyLinkedFlag struct {
	Key string `json:"key"`
...
type _ExpandedDirectlyLinkedFlag ExpandedDirectlyLinkedFlag
...
func NewExpandedDirectlyLinkedFlag(key string, name string, links ViewsSelfLink) *ExpandedDirectlyLinkedFlag {
	this := ExpandedDirectlyLinkedFlag{}
	this.Key = key
	this.Name = name
	this.Links = links
	return &this
...
func (o ExpandedDirectlyLinkedFlag) MarshalJSON() ([]byte, error) {
...
func (o ExpandedDirectlyLinkedFlag) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedDirectlyLinkedFlag) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedDirectlyLinkedFlag := _ExpandedDirectlyLinkedFlag{}

	err = json.Unmarshal(data, &varExpandedDirectlyLinkedFlag)

	if err != nil {
		return err
	}

	*o = ExpandedDirectlyLinkedFlag(varExpandedDirectlyLinkedFlag)
...
type NullableExpandedDirectlyLinkedFlag struct {
	value *ExpandedDirectlyLinkedFlag
	isSet bool
}

func (v NullableExpandedDirectlyLinkedFlag) Get() *ExpandedDirectlyLinkedFlag {
	return v.value
}

func (v *NullableExpandedDirectlyLinkedFlag) Set(val *ExpandedDirectlyLinkedFlag) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedDirectlyLinkedFlag) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedDirectlyLinkedFlag) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedDirectlyLinkedFlag(val *ExpandedDirectlyLinkedFlag) *NullableExpandedDirectlyLinkedFlag {
	return &NullableExpandedDirectlyLinkedFlag{value: val, isSet: true}
}

func (v NullableExpandedDirectlyLinkedFlag) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedDirectlyLinkedFlag) UnmarshalJSON(src []byte) error {
	v.isSet = true
