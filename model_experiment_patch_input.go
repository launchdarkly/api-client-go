...
// checks if the ExperimentPatchInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExperimentPatchInput{}
...
type _ExperimentPatchInput ExperimentPatchInput
...
func (o ExperimentPatchInput) ToMap() (map[string]interface{}, error) {
...
func (o *ExperimentPatchInput) UnmarshalJSON(data []byte) (err error) {
	...
	varExperimentPatchInput := _ExperimentPatchInput{}

	err = json.Unmarshal(data, &varExperimentPatchInput)

	if err != nil {
		return err
	}

	*o = ExperimentPatchInput(varExperimentPatchInput)
...
func NewNullableExperimentPatchInput(val *ExperimentPatchInput) *NullableExperimentPatchInput {
	return &NullableExperimentPatchInput{value: val, isSet: true}
}
