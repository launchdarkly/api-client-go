...
func (a *ContextSettingsApiService) PutContextFlagSettingExecute(r ApiPutContextFlagSettingRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"contextKind"+"}", url.PathEscape(parameterValueToString(r.contextKind, "contextKind")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"contextKey"+"}", url.PathEscape(parameterValueToString(r.contextKey, "contextKey")), -1)
