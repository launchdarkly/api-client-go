...
// PostFilterRep struct for PostFilterRep
type PostFilterRep struct {
	// The filter key
	Key string `json:"key"`
	// The filter name
...
func (o PostFilterRep) MarshalJSON() ([]byte, error) {
...
type NullablePostFilterRep struct {
	value *PostFilterRep
	isSet bool
}

func (v NullablePostFilterRep) Get() *PostFilterRep {
	return v.value
}

func (v *NullablePostFilterRep) Set(val *PostFilterRep) {
	v.value = val
	v.isSet = true
}

func (v NullablePostFilterRep) IsSet() bool {
	return v.isSet
}

func (v *NullablePostFilterRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostFilterRep(val *PostFilterRep) *NullablePostFilterRep {
	return &NullablePostFilterRep{value: val, isSet: true}
}

func (v NullablePostFilterRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostFilterRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
