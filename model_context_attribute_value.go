...
// checks if the ContextAttributeValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextAttributeValue{}

// ContextAttributeValue struct for ContextAttributeValue
type ContextAttributeValue struct {
...
type _ContextAttributeValue ContextAttributeValue
...
func (o ContextAttributeValue) ToMap() (map[string]interface{}, error) {
...
func (o *ContextAttributeValue) UnmarshalJSON(data []byte) (err error) {
	...
	varContextAttributeValue := _ContextAttributeValue{}

	err = json.Unmarshal(data, &varContextAttributeValue)

	if err != nil {
		return err
	}

	*o = ContextAttributeValue(varContextAttributeValue)
...
func NewNullableContextAttributeValue(val *ContextAttributeValue) *NullableContextAttributeValue {
	return &NullableContextAttributeValue{value: val, isSet: true}
}
