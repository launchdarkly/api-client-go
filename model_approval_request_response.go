...
// checks if the ApprovalRequestResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApprovalRequestResponse{}
...
type _ApprovalRequestResponse ApprovalRequestResponse
...
func (o ApprovalRequestResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ApprovalRequestResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varApprovalRequestResponse := _ApprovalRequestResponse{}

	err = json.Unmarshal(data, &varApprovalRequestResponse)

	if err != nil {
		return err
	}

	*o = ApprovalRequestResponse(varApprovalRequestResponse)
