...
func (o *Metrics) GetGenerationCount() int32 {
	if o == nil || IsNil(o.GenerationCount) {
		var ret int32
		return ret
	}
...
func (o *Metrics) GetGenerationSuccessCount() int32 {
	if o == nil || IsNil(o.GenerationSuccessCount) {
		var ret int32
		return ret
	}
...
func (o *Metrics) GetGenerationErrorCount() int32 {
	if o == nil || IsNil(o.GenerationErrorCount) {
		var ret int32
		return ret
	}
...
func (o *Metrics) GetTimeToFirstTokenMs() int32 {
	if o == nil || IsNil(o.TimeToFirstTokenMs) {
		var ret int32
		return ret
	}
...
func (o *Metrics) GetSatisfactionRating() float32 {
	if o == nil || IsNil(o.SatisfactionRating) {
		var ret float32
		return ret
	}
...
func (o *Metrics) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Metrics(varMetrics)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "generationCount")
		delete(additionalProperties, "generationSuccessCount")
		delete(additionalProperties, "generationErrorCount")
		delete(additionalProperties, "thumbsUp")
		delete(additionalProperties, "thumbsDown")
		delete(additionalProperties, "durationMs")
		delete(additionalProperties, "timeToFirstTokenMs")
