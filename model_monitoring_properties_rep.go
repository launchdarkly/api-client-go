...
// MonitoringPropertiesRep struct for MonitoringPropertiesRep
type MonitoringPropertiesRep struct {
	// The monitoring window in milliseconds
	MonitoringWindowMilliseconds *int64 `json:"monitoringWindowMilliseconds,omitempty"`
	OnRegression OnRegressionRep `json:"onRegression"`
	OnProgression OnProgressionRep `json:"onProgression"`
	// The regressions on the experiment
	Regressions []RegressionRep `json:"regressions"`
	// The progressions on the experiment
	Progressions []ProgressionRep `json:"progressions"`
}
...
// GetOnRegression returns the OnRegression field value
func (o *MonitoringPropertiesRep) GetOnRegression() OnRegressionRep {
	if o == nil {
		var ret OnRegressionRep
		return ret
	}

	return o.OnRegression
}

// GetOnRegressionOk returns a tuple with the OnRegression field value
// and a boolean to check if the value has been set.
func (o *MonitoringPropertiesRep) GetOnRegressionOk() (*OnRegressionRep, bool) {
	if o == nil {
		return nil, false
	}
	return &o.OnRegression, true
}

// SetOnRegression sets field value
func (o *MonitoringPropertiesRep) SetOnRegression(v OnRegressionRep) {
	o.OnRegression = v
}

// GetOnProgression returns the OnProgression field value
func (o *MonitoringPropertiesRep) GetOnProgression() OnProgressionRep {
	if o == nil {
		var ret OnProgressionRep
		return ret
	}

	return o.OnProgression
}

// GetOnProgressionOk returns a tuple with the OnProgression field value
// and a boolean to check if the value has been set.
func (o *MonitoringPropertiesRep) GetOnProgressionOk() (*OnProgressionRep, bool) {
	if o == nil {
		return nil, false
	}
	return &o.OnProgression, true
}

// SetOnProgression sets field value
func (o *MonitoringPropertiesRep) SetOnProgression(v OnProgressionRep) {
	o.OnProgression = v
}

// GetRegressions returns the Regressions field value
func (o *MonitoringPropertiesRep) GetRegressions() []RegressionRep {
	if o == nil {
		var ret []RegressionRep
		return ret
	}
...
// GetRegressionsOk returns a tuple with the Regressions field value
// and a boolean to check if the value has been set.
...
// SetRegressions sets field value
func (o *MonitoringPropertiesRep) SetRegressions(v []RegressionRep) {
	o.Regressions = v
}

// GetProgressions returns the Progressions field value
func (o *MonitoringPropertiesRep) GetProgressions() []ProgressionRep {
	if o == nil {
		var ret []ProgressionRep
		return ret
	}

	return o.Progressions
}

// GetProgressionsOk returns a tuple with the Progressions field value
// and a boolean to check if the value has been set.
func (o *MonitoringPropertiesRep) GetProgressionsOk() ([]ProgressionRep, bool) {
	if o == nil {
		return nil, false
	}
	return o.Progressions, true
}

// SetProgressions sets field value
func (o *MonitoringPropertiesRep) SetProgressions(v []ProgressionRep) {
	o.Progressions = v
}

func (o MonitoringPropertiesRep) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.MonitoringWindowMilliseconds != nil {
		toSerialize["monitoringWindowMilliseconds"] = o.MonitoringWindowMilliseconds
	}
	if true {
		toSerialize["onRegression"] = o.OnRegression
	}
	if true {
		toSerialize["onProgression"] = o.OnProgression
	}
	if true {
		toSerialize["regressions"] = o.Regressions
	}
	if true {
		toSerialize["progressions"] = o.Progressions
	}
	return json.Marshal(toSerialize)
}

type NullableMonitoringPropertiesRep struct {
	value *MonitoringPropertiesRep
	isSet bool
}

func (v NullableMonitoringPropertiesRep) Get() *MonitoringPropertiesRep {
	return v.value
}

func (v *NullableMonitoringPropertiesRep) Set(val *MonitoringPropertiesRep) {
	v.value = val
	v.isSet = true
}

func (v NullableMonitoringPropertiesRep) IsSet() bool {
	return v.isSet
}

func (v *NullableMonitoringPropertiesRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonitoringPropertiesRep(val *MonitoringPropertiesRep) *NullableMonitoringPropertiesRep {
	return &NullableMonitoringPropertiesRep{value: val, isSet: true}
}

func (v NullableMonitoringPropertiesRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonitoringPropertiesRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
