...
// checks if the AIToolPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIToolPatch{}

// AIToolPatch struct for AIToolPatch
type AIToolPatch struct {
...
func (o *AIToolPatch) GetTags() []string {
...
// and a boolean to check if the value has been set.
func (o *AIToolPatch) GetTagsOk() ([]string, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *AIToolPatch) HasTags() bool {
	if o != nil && !IsNil(o.Tags) {
		return true
	}
...
func (o *AIToolPatch) SetTags(v []string) {
	o.Tags = v
}

func (o AIToolPatch) MarshalJSON() ([]byte, error) {
...
func (o AIToolPatch) ToMap() (map[string]interface{}, error) {
...
func (o *AIToolPatch) UnmarshalJSON(data []byte) (err error) {
	varAIToolPatch := _AIToolPatch{}

	err = json.Unmarshal(data, &varAIToolPatch)

	if err != nil {
		return err
	}

	*o = AIToolPatch(varAIToolPatch)
...
type NullableAIToolPatch struct {
	value *AIToolPatch
	isSet bool
}

func (v NullableAIToolPatch) Get() *AIToolPatch {
	return v.value
}

func (v *NullableAIToolPatch) Set(val *AIToolPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableAIToolPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableAIToolPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIToolPatch(val *AIToolPatch) *NullableAIToolPatch {
	return &NullableAIToolPatch{value: val, isSet: true}
}

func (v NullableAIToolPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIToolPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
