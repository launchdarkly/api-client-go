...
// checks if the QuickStats type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuickStats{}

// QuickStats struct for QuickStats
type QuickStats struct {
	ActiveConfigs int32 `json:"activeConfigs"`
	ActiveExperiments int32 `json:"activeExperiments"`
	AverageSatisfaction7D NullableFloat32 `json:"averageSatisfaction7D,omitempty"`
	SpendMonthToDate NullableFloat64 `json:"spendMonthToDate,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _QuickStats QuickStats
...
// GetActiveConfigs returns the ActiveConfigs field value
func (o *QuickStats) GetActiveConfigs() int32 {
	...
	return o.ActiveConfigs
}

// GetActiveConfigsOk returns a tuple with the ActiveConfigs field value
// and a boolean to check if the value has been set.
func (o *QuickStats) GetActiveConfigsOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ActiveConfigs, true
}

// SetActiveConfigs sets field value
func (o *QuickStats) SetActiveConfigs(v int32) {
	o.ActiveConfigs = v
}

// GetActiveExperiments returns the ActiveExperiments field value
func (o *QuickStats) GetActiveExperiments() int32 {
	...
	return o.ActiveExperiments
}

// GetActiveExperimentsOk returns a tuple with the ActiveExperiments field value
// and a boolean to check if the value has been set.
func (o *QuickStats) GetActiveExperimentsOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.ActiveExperiments, true
}

// SetActiveExperiments sets field value
func (o *QuickStats) SetActiveExperiments(v int32) {
	o.ActiveExperiments = v
}

// GetAverageSatisfaction7D returns the AverageSatisfaction7D field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *QuickStats) GetAverageSatisfaction7D() float32 {
	if o == nil || IsNil(o.AverageSatisfaction7D.Get()) {
		var ret float32
		return ret
	}
	return *o.AverageSatisfaction7D.Get()
}

// GetAverageSatisfaction7DOk returns a tuple with the AverageSatisfaction7D field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetAverageSatisfaction7D gets a reference to the given NullableFloat32 and assigns it to the AverageSatisfaction7D field.
func (o *QuickStats) SetAverageSatisfaction7D(v float32) {
	o.AverageSatisfaction7D.Set(&v)
}
// SetAverageSatisfaction7DNil sets the value for AverageSatisfaction7D to be an explicit nil
func (o *QuickStats) SetAverageSatisfaction7DNil() {
	o.AverageSatisfaction7D.Set(nil)
}
...
func (o *QuickStats) UnsetAverageSatisfaction7D() {
	o.AverageSatisfaction7D.Unset()
}

// GetSpendMonthToDate returns the SpendMonthToDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *QuickStats) GetSpendMonthToDate() float64 {
	if o == nil || IsNil(o.SpendMonthToDate.Get()) {
		var ret float64
		return ret
	}
	return *o.SpendMonthToDate.Get()
}

// GetSpendMonthToDateOk returns a tuple with the SpendMonthToDate field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetSpendMonthToDate gets a reference to the given NullableFloat64 and assigns it to the SpendMonthToDate field.
func (o *QuickStats) SetSpendMonthToDate(v float64) {
	o.SpendMonthToDate.Set(&v)
}
// SetSpendMonthToDateNil sets the value for SpendMonthToDate to be an explicit nil
func (o *QuickStats) SetSpendMonthToDateNil() {
	o.SpendMonthToDate.Set(nil)
}
...
func (o *QuickStats) UnsetSpendMonthToDate() {
	o.SpendMonthToDate.Unset()
}

func (o QuickStats) MarshalJSON() ([]byte, error) {
...
func (o QuickStats) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["activeConfigs"] = o.ActiveConfigs
	toSerialize["activeExperiments"] = o.ActiveExperiments
	if o.AverageSatisfaction7D.IsSet() {
		toSerialize["averageSatisfaction7D"] = o.AverageSatisfaction7D.Get()
	}
	if o.SpendMonthToDate.IsSet() {
		toSerialize["spendMonthToDate"] = o.SpendMonthToDate.Get()
	}
...
func (o *QuickStats) UnmarshalJSON(data []byte) (err error) {
	...
	varQuickStats := _QuickStats{}

	err = json.Unmarshal(data, &varQuickStats)

	if err != nil {
		return err
	}

	*o = QuickStats(varQuickStats)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "activeConfigs")
		delete(additionalProperties, "activeExperiments")
		delete(additionalProperties, "averageSatisfaction7D")
		delete(additionalProperties, "spendMonthToDate")
...
type NullableQuickStats struct {
	value *QuickStats
	isSet bool
}

func (v NullableQuickStats) Get() *QuickStats {
	return v.value
}

func (v *NullableQuickStats) Set(val *QuickStats) {
	v.value = val
	v.isSet = true
}

func (v NullableQuickStats) IsSet() bool {
	return v.isSet
}

func (v *NullableQuickStats) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuickStats(val *QuickStats) *NullableQuickStats {
	return &NullableQuickStats{value: val, isSet: true}
}

func (v NullableQuickStats) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuickStats) UnmarshalJSON(src []byte) error {
	v.isSet = true
