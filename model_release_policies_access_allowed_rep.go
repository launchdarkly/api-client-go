...
// checks if the ReleasePoliciesAccessAllowedRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleasePoliciesAccessAllowedRep{}

// ReleasePoliciesAccessAllowedRep struct for ReleasePoliciesAccessAllowedRep
type ReleasePoliciesAccessAllowedRep struct {
	Action string `json:"action"`
	Reason ReleasePoliciesAccessAllowedReason `json:"reason"`
	AdditionalProperties map[string]interface{}
}

type _ReleasePoliciesAccessAllowedRep ReleasePoliciesAccessAllowedRep
...
func NewReleasePoliciesAccessAllowedRep(action string, reason ReleasePoliciesAccessAllowedReason) *ReleasePoliciesAccessAllowedRep {
	this := ReleasePoliciesAccessAllowedRep{}
	this.Action = action
	this.Reason = reason
	return &this
}
...
func (o *ReleasePoliciesAccessAllowedRep) GetReason() ReleasePoliciesAccessAllowedReason {
	if o == nil {
		var ret ReleasePoliciesAccessAllowedReason
		return ret
	}
...
func (o ReleasePoliciesAccessAllowedRep) MarshalJSON() ([]byte, error) {
...
func (o ReleasePoliciesAccessAllowedRep) ToMap() (map[string]interface{}, error) {
...
func (o *ReleasePoliciesAccessAllowedRep) UnmarshalJSON(data []byte) (err error) {
	...
	varReleasePoliciesAccessAllowedRep := _ReleasePoliciesAccessAllowedRep{}

	err = json.Unmarshal(data, &varReleasePoliciesAccessAllowedRep)

	if err != nil {
		return err
	}

	*o = ReleasePoliciesAccessAllowedRep(varReleasePoliciesAccessAllowedRep)
...
type NullableReleasePoliciesAccessAllowedRep struct {
	value *ReleasePoliciesAccessAllowedRep
	isSet bool
}

func (v NullableReleasePoliciesAccessAllowedRep) Get() *ReleasePoliciesAccessAllowedRep {
	return v.value
}

func (v *NullableReleasePoliciesAccessAllowedRep) Set(val *ReleasePoliciesAccessAllowedRep) {
	v.value = val
	v.isSet = true
}

func (v NullableReleasePoliciesAccessAllowedRep) IsSet() bool {
	return v.isSet
}

func (v *NullableReleasePoliciesAccessAllowedRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleasePoliciesAccessAllowedRep(val *ReleasePoliciesAccessAllowedRep) *NullableReleasePoliciesAccessAllowedRep {
	return &NullableReleasePoliciesAccessAllowedRep{value: val, isSet: true}
}

func (v NullableReleasePoliciesAccessAllowedRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReleasePoliciesAccessAllowedRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
