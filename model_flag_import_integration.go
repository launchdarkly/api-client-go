...
// checks if the FlagImportIntegration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagImportIntegration{}
...
type _FlagImportIntegration FlagImportIntegration
...
func (o FlagImportIntegration) ToMap() (map[string]interface{}, error) {
...
func (o *FlagImportIntegration) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagImportIntegration := _FlagImportIntegration{}

	err = json.Unmarshal(data, &varFlagImportIntegration)

	if err != nil {
		return err
	}

	*o = FlagImportIntegration(varFlagImportIntegration)
