...
// checks if the UnauthorizedErrorRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnauthorizedErrorRep{}
...
type _UnauthorizedErrorRep UnauthorizedErrorRep
...
func (o UnauthorizedErrorRep) ToMap() (map[string]interface{}, error) {
...
func (o *UnauthorizedErrorRep) UnmarshalJSON(data []byte) (err error) {
	...
	varUnauthorizedErrorRep := _UnauthorizedErrorRep{}

	err = json.Unmarshal(data, &varUnauthorizedErrorRep)

	if err != nil {
		return err
	}

	*o = UnauthorizedErrorRep(varUnauthorizedErrorRep)
