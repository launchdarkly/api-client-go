...
@return UserTargetingExpirationOnFlagsForUser
*/
func (a *UserSettingsApiService) PatchExpiringUserTargetsForFlags(ctx context.Context, projectKey string, environmentKey string, userKey string, patchComment PatchComment) (UserTargetingExpirationOnFlagsForUser, *http.Response, error) {
	var (
