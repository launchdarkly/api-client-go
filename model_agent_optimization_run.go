...
// checks if the AgentOptimizationRun type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentOptimizationRun{}

// AgentOptimizationRun struct for AgentOptimizationRun
type AgentOptimizationRun struct {
	RunId string `json:"runId"`
	OptimizationKey string `json:"optimizationKey"`
...
type _AgentOptimizationRun AgentOptimizationRun
...
// GetOptimizationKey returns the OptimizationKey field value
func (o *AgentOptimizationRun) GetOptimizationKey() string {
	...
	return o.OptimizationKey
}

// GetOptimizationKeyOk returns a tuple with the OptimizationKey field value
// and a boolean to check if the value has been set.
func (o *AgentOptimizationRun) GetOptimizationKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.OptimizationKey, true
}

// SetOptimizationKey sets field value
...
func (o *AgentOptimizationRun) SetCompletedAtNil() {
...
func (o AgentOptimizationRun) MarshalJSON() ([]byte, error) {
...
func (o AgentOptimizationRun) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["runId"] = o.RunId
	toSerialize["optimizationKey"] = o.OptimizationKey
...
func (o *AgentOptimizationRun) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentOptimizationRun := _AgentOptimizationRun{}

	err = json.Unmarshal(data, &varAgentOptimizationRun)

	if err != nil {
		return err
	}

	*o = AgentOptimizationRun(varAgentOptimizationRun)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "runId")
		delete(additionalProperties, "optimizationKey")
...
type NullableAgentOptimizationRun struct {
	value *AgentOptimizationRun
	isSet bool
}

func (v NullableAgentOptimizationRun) Get() *AgentOptimizationRun {
	return v.value
}

func (v *NullableAgentOptimizationRun) Set(val *AgentOptimizationRun) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentOptimizationRun) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentOptimizationRun) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentOptimizationRun(val *AgentOptimizationRun) *NullableAgentOptimizationRun {
	return &NullableAgentOptimizationRun{value: val, isSet: true}
}

func (v NullableAgentOptimizationRun) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentOptimizationRun) UnmarshalJSON(src []byte) error {
	v.isSet = true
