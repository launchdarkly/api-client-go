...
func (o *ResolvedTitle) GetElements() []ResolvedUIBlockElement {
	if o == nil || o.Elements == nil {
		var ret []ResolvedUIBlockElement
		return ret
	}
	return *o.Elements
}
...
func (o *ResolvedTitle) GetLinkToReference() bool {
	if o == nil || o.LinkToReference == nil {
		var ret bool
		return ret
	}
	return *o.LinkToReference
}

// GetLinkToReferenceOk returns a tuple with the LinkToReference field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ResolvedTitle) GetLinkToReferenceOk() (*bool, bool) {
	if o == nil || o.LinkToReference == nil {
		return nil, false
	}
	return o.LinkToReference, true
}
...
func (o ResolvedTitle) MarshalJSON() ([]byte, error) {
	...
	if o.LinkToReference != nil {
		toSerialize["linkToReference"] = o.LinkToReference
	}
...
func (v NullableResolvedTitle) Get() *ResolvedTitle {
	return v.value
}
...
func NewNullableResolvedTitle(val *ResolvedTitle) *NullableResolvedTitle {
	return &NullableResolvedTitle{value: val, isSet: true}
}
