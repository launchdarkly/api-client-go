...
// ApplicationWithVersions struct for ApplicationWithVersions
type ApplicationWithVersions struct {
	Key string `json:"key"`
...
func (o ApplicationWithVersions) MarshalJSON() ([]byte, error) {
...
type NullableApplicationWithVersions struct {
	value *ApplicationWithVersions
	isSet bool
}

func (v NullableApplicationWithVersions) Get() *ApplicationWithVersions {
	return v.value
}

func (v *NullableApplicationWithVersions) Set(val *ApplicationWithVersions) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationWithVersions) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationWithVersions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationWithVersions(val *ApplicationWithVersions) *NullableApplicationWithVersions {
	return &NullableApplicationWithVersions{value: val, isSet: true}
}

func (v NullableApplicationWithVersions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationWithVersions) UnmarshalJSON(src []byte) error {
	v.isSet = true
