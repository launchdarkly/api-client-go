...
func (o *FeatureFlagConfig) GetContextTargets() []Target {
	if o == nil || IsNil(o.ContextTargets) {
		var ret []Target
		return ret
	}
...
func (o *FeatureFlagConfig) GetDebugEventsUntilDate() int64 {
	if o == nil || IsNil(o.DebugEventsUntilDate) {
		var ret int64
		return ret
	}
...
func (o FeatureFlagConfig) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DebugEventsUntilDate) {
...
func (o *FeatureFlagConfig) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFeatureFlagConfig)
	...
	*o = FeatureFlagConfig(varFeatureFlagConfig)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "sel")
		...
		delete(additionalProperties, "prerequisites")
		...
		delete(additionalProperties, "_debugEventsUntilDate")
		delete(additionalProperties, "_summary")
