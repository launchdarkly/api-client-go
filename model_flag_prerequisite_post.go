...
// checks if the FlagPrerequisitePost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagPrerequisitePost{}

// FlagPrerequisitePost struct for FlagPrerequisitePost
type FlagPrerequisitePost struct {
...
type _FlagPrerequisitePost FlagPrerequisitePost
...
func (o FlagPrerequisitePost) MarshalJSON() ([]byte, error) {
...
func (o FlagPrerequisitePost) ToMap() (map[string]interface{}, error) {
...
func (o *FlagPrerequisitePost) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagPrerequisitePost := _FlagPrerequisitePost{}

	err = json.Unmarshal(data, &varFlagPrerequisitePost)

	if err != nil {
		return err
	}

	*o = FlagPrerequisitePost(varFlagPrerequisitePost)
...
type NullableFlagPrerequisitePost struct {
	value *FlagPrerequisitePost
	isSet bool
}

func (v NullableFlagPrerequisitePost) Get() *FlagPrerequisitePost {
	return v.value
}

func (v *NullableFlagPrerequisitePost) Set(val *FlagPrerequisitePost) {
	v.value = val
	v.isSet = true
}

func (v NullableFlagPrerequisitePost) IsSet() bool {
	return v.isSet
}

func (v *NullableFlagPrerequisitePost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlagPrerequisitePost(val *FlagPrerequisitePost) *NullableFlagPrerequisitePost {
	return &NullableFlagPrerequisitePost{value: val, isSet: true}
}

func (v NullableFlagPrerequisitePost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlagPrerequisitePost) UnmarshalJSON(src []byte) error {
	v.isSet = true
