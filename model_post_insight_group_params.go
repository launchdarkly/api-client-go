...
// checks if the PostInsightGroupParams type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostInsightGroupParams{}
...
type _PostInsightGroupParams PostInsightGroupParams
...
func (o PostInsightGroupParams) ToMap() (map[string]interface{}, error) {
...
func (o *PostInsightGroupParams) UnmarshalJSON(data []byte) (err error) {
	...
	varPostInsightGroupParams := _PostInsightGroupParams{}

	err = json.Unmarshal(data, &varPostInsightGroupParams)

	if err != nil {
		return err
	}

	*o = PostInsightGroupParams(varPostInsightGroupParams)
