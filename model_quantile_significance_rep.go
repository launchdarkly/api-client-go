...
// QuantileSignificanceRep struct for QuantileSignificanceRep
type QuantileSignificanceRep struct {
	// Whether the treatment is significant against the control
	Significant *bool `json:"significant,omitempty"`
	// Whether the treatment is a regression against the control
...
func (o QuantileSignificanceRep) MarshalJSON() ([]byte, error) {
...
type NullableQuantileSignificanceRep struct {
	value *QuantileSignificanceRep
	isSet bool
}

func (v NullableQuantileSignificanceRep) Get() *QuantileSignificanceRep {
	return v.value
}

func (v *NullableQuantileSignificanceRep) Set(val *QuantileSignificanceRep) {
	v.value = val
	v.isSet = true
}

func (v NullableQuantileSignificanceRep) IsSet() bool {
	return v.isSet
}

func (v *NullableQuantileSignificanceRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuantileSignificanceRep(val *QuantileSignificanceRep) *NullableQuantileSignificanceRep {
	return &NullableQuantileSignificanceRep{value: val, isSet: true}
}

func (v NullableQuantileSignificanceRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuantileSignificanceRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
