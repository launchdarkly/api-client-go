...
type DynamicOptions struct {
	...
	Parser *DynamicOptionsParser `json:"parser,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DynamicOptions DynamicOptions
...
// SetParser gets a reference to the given DynamicOptionsParser and assigns it to the Parser field.
...
func (o *DynamicOptions) UnmarshalJSON(data []byte) (err error) {
	varDynamicOptions := _DynamicOptions{}

	err = json.Unmarshal(data, &varDynamicOptions)

	if err != nil {
		return err
	}

	*o = DynamicOptions(varDynamicOptions)
