...
// checks if the PatchUsersRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchUsersRequest{}
...
type _PatchUsersRequest PatchUsersRequest
...
func (o *PatchUsersRequest) GetInstructions() []InstructionUserRequest {
	if o == nil {
		var ret []InstructionUserRequest
		return ret
	}
...
func (o PatchUsersRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchUsersRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchUsersRequest := _PatchUsersRequest{}

	err = json.Unmarshal(data, &varPatchUsersRequest)

	if err != nil {
		return err
	}

	*o = PatchUsersRequest(varPatchUsersRequest)
...
func NewNullablePatchUsersRequest(val *PatchUsersRequest) *NullablePatchUsersRequest {
	return &NullablePatchUsersRequest{value: val, isSet: true}
}
