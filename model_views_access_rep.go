...
// checks if the ViewsAccessRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewsAccessRep{}

// ViewsAccessRep struct for ViewsAccessRep
type ViewsAccessRep struct {
	Denied []ViewsAccessDenied `json:"denied"`
	Allowed []ViewsAccessAllowedRep `json:"allowed"`
	AdditionalProperties map[string]interface{}
}

type _ViewsAccessRep ViewsAccessRep
...
func (o ViewsAccessRep) MarshalJSON() ([]byte, error) {
...
func (o ViewsAccessRep) ToMap() (map[string]interface{}, error) {
...
func (o *ViewsAccessRep) UnmarshalJSON(data []byte) (err error) {
	...
	varViewsAccessRep := _ViewsAccessRep{}

	err = json.Unmarshal(data, &varViewsAccessRep)

	if err != nil {
		return err
	}

	*o = ViewsAccessRep(varViewsAccessRep)
...
type NullableViewsAccessRep struct {
	value *ViewsAccessRep
	isSet bool
}

func (v NullableViewsAccessRep) Get() *ViewsAccessRep {
	return v.value
}

func (v *NullableViewsAccessRep) Set(val *ViewsAccessRep) {
	v.value = val
	v.isSet = true
}

func (v NullableViewsAccessRep) IsSet() bool {
	return v.isSet
}

func (v *NullableViewsAccessRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewsAccessRep(val *ViewsAccessRep) *NullableViewsAccessRep {
	return &NullableViewsAccessRep{value: val, isSet: true}
}

func (v NullableViewsAccessRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewsAccessRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
