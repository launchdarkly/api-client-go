...
// checks if the FlagMigrationSettingsRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagMigrationSettingsRep{}

// FlagMigrationSettingsRep struct for FlagMigrationSettingsRep
type FlagMigrationSettingsRep struct {
...
type _FlagMigrationSettingsRep FlagMigrationSettingsRep
...
// GetStageCountOk returns a tuple with the StageCount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlagMigrationSettingsRep) GetStageCountOk() (*int32, bool) {
	if o == nil || IsNil(o.StageCount) {
		return nil, false
	}
	return o.StageCount, true
}
...
func (o FlagMigrationSettingsRep) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.ContextKind) {
		toSerialize["contextKind"] = o.ContextKind
	}
	if !IsNil(o.StageCount) {
		toSerialize["stageCount"] = o.StageCount
	}
...
func (o *FlagMigrationSettingsRep) UnmarshalJSON(data []byte) (err error) {
	varFlagMigrationSettingsRep := _FlagMigrationSettingsRep{}

	err = json.Unmarshal(data, &varFlagMigrationSettingsRep)

	if err != nil {
		return err
	}

	*o = FlagMigrationSettingsRep(varFlagMigrationSettingsRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "contextKind")
		delete(additionalProperties, "stageCount")
...
type NullableFlagMigrationSettingsRep struct {
	value *FlagMigrationSettingsRep
	isSet bool
}
...
func NewNullableFlagMigrationSettingsRep(val *FlagMigrationSettingsRep) *NullableFlagMigrationSettingsRep {
	return &NullableFlagMigrationSettingsRep{value: val, isSet: true}
}
