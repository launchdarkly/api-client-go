...
// checks if the CoreLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CoreLink{}
...
func (o CoreLink) ToMap() (map[string]interface{}, error) {
...
func (o *CoreLink) UnmarshalJSON(data []byte) (err error) {
	...
	varCoreLink := _CoreLink{}

	err = json.Unmarshal(data, &varCoreLink)

	if err != nil {
		return err
	}

	*o = CoreLink(varCoreLink)
