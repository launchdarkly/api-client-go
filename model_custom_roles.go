...
// checks if the CustomRoles type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomRoles{}
...
func (o CustomRoles) ToMap() (map[string]interface{}, error) {
...
func (o *CustomRoles) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomRoles := _CustomRoles{}

	err = json.Unmarshal(data, &varCustomRoles)

	if err != nil {
		return err
	}

	*o = CustomRoles(varCustomRoles)
