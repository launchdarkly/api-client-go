...
// MetricQueryFilterRep struct for MetricQueryFilterRep
type MetricQueryFilterRep struct {
	DimensionKey string `json:"dimensionKey"`
	DimensionKind string `json:"dimensionKind"`
	DimensionKeyContextKind *string `json:"dimensionKeyContextKind,omitempty"`
	Op string `json:"op"`
...
// GetDimensionKind returns the DimensionKind field value
func (o *MetricQueryFilterRep) GetDimensionKind() string {
	...
	return o.DimensionKind
}

// GetDimensionKindOk returns a tuple with the DimensionKind field value
// and a boolean to check if the value has been set.
func (o *MetricQueryFilterRep) GetDimensionKindOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.DimensionKind, true
}

// SetDimensionKind sets field value
func (o *MetricQueryFilterRep) SetDimensionKind(v string) {
	o.DimensionKind = v
}

// GetDimensionKeyContextKind returns the DimensionKeyContextKind field value if set, zero value otherwise.
func (o *MetricQueryFilterRep) GetDimensionKeyContextKind() string {
	if o == nil || o.DimensionKeyContextKind == nil {
		var ret string
		return ret
	}
	return *o.DimensionKeyContextKind
}

// GetDimensionKeyContextKindOk returns a tuple with the DimensionKeyContextKind field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *MetricQueryFilterRep) GetDimensionKeyContextKindOk() (*string, bool) {
	if o == nil || o.DimensionKeyContextKind == nil {
		return nil, false
	}
	return o.DimensionKeyContextKind, true
}
...
// SetDimensionKeyContextKind gets a reference to the given string and assigns it to the DimensionKeyContextKind field.
func (o *MetricQueryFilterRep) SetDimensionKeyContextKind(v string) {
	o.DimensionKeyContextKind = &v
}
...
func (o MetricQueryFilterRep) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if true {
		toSerialize["dimensionKey"] = o.DimensionKey
	}
	if true {
		toSerialize["dimensionKind"] = o.DimensionKind
	}
	if o.DimensionKeyContextKind != nil {
		toSerialize["dimensionKeyContextKind"] = o.DimensionKeyContextKind
	}
	if true {
		toSerialize["op"] = o.Op
	}
...
type NullableMetricQueryFilterRep struct {
	value *MetricQueryFilterRep
	isSet bool
}

func (v NullableMetricQueryFilterRep) Get() *MetricQueryFilterRep {
	return v.value
}

func (v *NullableMetricQueryFilterRep) Set(val *MetricQueryFilterRep) {
	v.value = val
	v.isSet = true
}

func (v NullableMetricQueryFilterRep) IsSet() bool {
	return v.isSet
}

func (v *NullableMetricQueryFilterRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetricQueryFilterRep(val *MetricQueryFilterRep) *NullableMetricQueryFilterRep {
	return &NullableMetricQueryFilterRep{value: val, isSet: true}
}

func (v NullableMetricQueryFilterRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetricQueryFilterRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
