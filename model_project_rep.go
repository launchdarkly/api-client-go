...
// checks if the ProjectRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectRep{}
...
func (o *ProjectRep) GetDefaultReleasePipelineKey() string {
	if o == nil || IsNil(o.DefaultReleasePipelineKey) {
		var ret string
		return ret
	}
...
func (o ProjectRep) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DefaultReleasePipelineKey) {
...
func (o *ProjectRep) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectRep := _ProjectRep{}

	err = json.Unmarshal(data, &varProjectRep)

	if err != nil {
		return err
	}

	*o = ProjectRep(varProjectRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "defaultReleasePipelineKey")
