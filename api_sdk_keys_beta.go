...
type SDKKeysBetaApi interface {

	/*
	DeleteSdkKeyByKey Delete SDK key
	...
	@param sdkKeyKey The user-defined identifying key of the SDK key. This is used solely to identify an SDK key and is distinct from the value field, which is the actual SDK key value.
	@return ApiDeleteSdkKeyByKeyRequest
	*/
	DeleteSdkKeyByKey(ctx context.Context, projectKey string, environmentKey string, sdkKeyKey string) ApiDeleteSdkKeyByKeyRequest

	// DeleteSdkKeyByKeyExecute executes the request
	DeleteSdkKeyByKeyExecute(r ApiDeleteSdkKeyByKeyRequest) (*http.Response, error)

	/*
	GetSdkKeyByKey Get SDK key
	...
	@param environmentKey
	@param sdkKeyKey The user-defined identifying key of the SDK key. This is used solely to identify an SDK key and is distinct from the value field, which is the actual SDK key value.
	@return ApiGetSdkKeyByKeyRequest
	*/
	GetSdkKeyByKey(ctx context.Context, projectKey string, environmentKey string, sdkKeyKey string) ApiGetSdkKeyByKeyRequest

	// GetSdkKeyByKeyExecute executes the request
	//  @return SdkKey
	GetSdkKeyByKeyExecute(r ApiGetSdkKeyByKeyRequest) (*SdkKey, *http.Response, error)

	/*
	GetSdkKeys Get all environment SDK keys
	...
	@param projectKey
	@param environmentKey
	@return ApiGetSdkKeysRequest
	*/
	GetSdkKeys(ctx context.Context, projectKey string, environmentKey string) ApiGetSdkKeysRequest

	// GetSdkKeysExecute executes the request
	//  @return SdkKeysForGetSdkKeys
	GetSdkKeysExecute(r ApiGetSdkKeysRequest) (*SdkKeysForGetSdkKeys, *http.Response, error)

	/*
	PatchSdkKeyByKey Update SDK key
	...
	@param environmentKey
	@param sdkKeyKey The user-defined identifying key of the SDK key. This is used solely to identify an SDK key and is distinct from the value field, which is the actual SDK key value.
	@return ApiPatchSdkKeyByKeyRequest
	*/
	PatchSdkKeyByKey(ctx context.Context, projectKey string, environmentKey string, sdkKeyKey string) ApiPatchSdkKeyByKeyRequest

	// PatchSdkKeyByKeyExecute executes the request
	//  @return SdkKey
	PatchSdkKeyByKeyExecute(r ApiPatchSdkKeyByKeyRequest) (*SdkKey, *http.Response, error)

	/*
	PostSdkKey Create SDK key
	...
	@param projectKey
	@param environmentKey
	@return ApiPostSdkKeyRequest
	*/
	PostSdkKey(ctx context.Context, projectKey string, environmentKey string) ApiPostSdkKeyRequest

	// PostSdkKeyExecute executes the request
	//  @return SdkKey
	PostSdkKeyExecute(r ApiPostSdkKeyRequest) (*SdkKey, *http.Response, error)
}

// SDKKeysBetaApiService SDKKeysBetaApi service
type SDKKeysBetaApiService service

type ApiDeleteSdkKeyByKeyRequest struct {
	ctx context.Context
	ApiService SDKKeysBetaApi
	lDAPIVersion *string
	projectKey string
...
func (r ApiDeleteSdkKeyByKeyRequest) LDAPIVersion(lDAPIVersion string) ApiDeleteSdkKeyByKeyRequest {
	r.lDAPIVersion = &lDAPIVersion
	return r
}

func (r ApiDeleteSdkKeyByKeyRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteSdkKeyByKeyExecute(r)
}
...
Delete a specific SDK key by its key.
 ...
 @return ApiDeleteSdkKeyByKeyRequest
*/
func (a *SDKKeysBetaApiService) DeleteSdkKeyByKey(ctx context.Context, projectKey string, environmentKey string, sdkKeyKey string) ApiDeleteSdkKeyByKeyRequest {
	return ApiDeleteSdkKeyByKeyRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *SDKKeysBetaApiService) DeleteSdkKeyByKeyExecute(r ApiDeleteSdkKeyByKeyRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SDKKeysBetaApiService.DeleteSdkKeyByKey")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/environments/{environmentKey}/sdk-keys/{sdkKeyKey}"
	...
	localVarPath = strings.Replace(localVarPath, "{"+"sdkKeyKey"+"}", url.PathEscape(parameterValueToString(r.sdkKeyKey, "sdkKeyKey")), -1)
...
type ApiGetSdkKeyByKeyRequest struct {
	ctx context.Context
	ApiService SDKKeysBetaApi
	lDAPIVersion *string
	projectKey string
...
// Version of the endpoint.
func (r ApiGetSdkKeyByKeyRequest) LDAPIVersion(lDAPIVersion string) ApiGetSdkKeyByKeyRequest {
	r.lDAPIVersion = &lDAPIVersion
	return r
}

func (r ApiGetSdkKeyByKeyRequest) Execute() (*SdkKey, *http.Response, error) {
	return r.ApiService.GetSdkKeyByKeyExecute(r)
}
...
Get a specific SDK key by its key.
 ...
 @return ApiGetSdkKeyByKeyRequest
*/
func (a *SDKKeysBetaApiService) GetSdkKeyByKey(ctx context.Context, projectKey string, environmentKey string, sdkKeyKey string) ApiGetSdkKeyByKeyRequest {
	return ApiGetSdkKeyByKeyRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return SdkKey
func (a *SDKKeysBetaApiService) GetSdkKeyByKeyExecute(r ApiGetSdkKeyByKeyRequest) (*SdkKey, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SdkKey
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SDKKeysBetaApiService.GetSdkKeyByKey")
	if err != nil {
...
type ApiGetSdkKeysRequest struct {
	ctx context.Context
	ApiService SDKKeysBetaApi
	lDAPIVersion *string
	projectKey string
...
// Version of the endpoint.
func (r ApiGetSdkKeysRequest) LDAPIVersion(lDAPIVersion string) ApiGetSdkKeysRequest {
	r.lDAPIVersion = &lDAPIVersion
	return r
}
...
func (r ApiGetSdkKeysRequest) Filter(filter string) ApiGetSdkKeysRequest {
	r.filter = &filter
	return r
}

// The number of SDK keys to return. Defaults to 20. Maximum is 100.
func (r ApiGetSdkKeysRequest) Limit(limit int32) ApiGetSdkKeysRequest {
	r.limit = &limit
	return r
}

// The number of SDK keys to skip. Used for pagination.
func (r ApiGetSdkKeysRequest) Offset(offset int32) ApiGetSdkKeysRequest {
	r.offset = &offset
	return r
}
...
func (r ApiGetSdkKeysRequest) Sort(sort string) ApiGetSdkKeysRequest {
	r.sort = &sort
	return r
}

func (r ApiGetSdkKeysRequest) Execute() (*SdkKeysForGetSdkKeys, *http.Response, error) {
...
Get all SDK keys for a given project and environment. Can filter by kind.
 ...
 @return ApiGetSdkKeysRequest
*/
func (a *SDKKeysBetaApiService) GetSdkKeys(ctx context.Context, projectKey string, environmentKey string) ApiGetSdkKeysRequest {
	return ApiGetSdkKeysRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return SdkKeysForGetSdkKeys
func (a *SDKKeysBetaApiService) GetSdkKeysExecute(r ApiGetSdkKeysRequest) (*SdkKeysForGetSdkKeys, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SdkKeysForGetSdkKeys
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SDKKeysBetaApiService.GetSdkKeys")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/environments/{environmentKey}/sdk-keys"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", url.PathEscape(parameterValueToString(r.projectKey, "projectKey")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", url.PathEscape(parameterValueToString(r.environmentKey, "environmentKey")), -1)
...
type ApiPatchSdkKeyByKeyRequest struct {
	ctx context.Context
	ApiService SDKKeysBetaApi
	lDAPIVersion *string
	projectKey string
...
// Version of the endpoint.
func (r ApiPatchSdkKeyByKeyRequest) LDAPIVersion(lDAPIVersion string) ApiPatchSdkKeyByKeyRequest {
	r.lDAPIVersion = &lDAPIVersion
	return r
}

// An array of patches for updating an existing SDK key. The following fields are supported: &#x60;name&#x60;, &#x60;description&#x60;, &#x60;expiry&#x60;.
func (r ApiPatchSdkKeyByKeyRequest) SdkKeyPatch(sdkKeyPatch SdkKeyPatch) ApiPatchSdkKeyByKeyRequest {
	r.sdkKeyPatch = &sdkKeyPatch
	return r
}
...
func (r ApiPatchSdkKeyByKeyRequest) Version(version int32) ApiPatchSdkKeyByKeyRequest {
	r.version = &version
	return r
}

func (r ApiPatchSdkKeyByKeyRequest) Execute() (*SdkKey, *http.Response, error) {
	return r.ApiService.PatchSdkKeyByKeyExecute(r)
}
...
Update a an existing SDK key by its identifying key.
 ...
 @return ApiPatchSdkKeyByKeyRequest
*/
func (a *SDKKeysBetaApiService) PatchSdkKeyByKey(ctx context.Context, projectKey string, environmentKey string, sdkKeyKey string) ApiPatchSdkKeyByKeyRequest {
	return ApiPatchSdkKeyByKeyRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return SdkKey
func (a *SDKKeysBetaApiService) PatchSdkKeyByKeyExecute(r ApiPatchSdkKeyByKeyRequest) (*SdkKey, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SDKKeysBetaApiService.PatchSdkKeyByKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.sdkKeyPatch == nil {
		return localVarReturnValue, nil, reportError("sdkKeyPatch is required and must be specified")
	}
	...
	parameterAddToHeaderOrQuery(localVarHeaderParams, "LD-API-Version", r.lDAPIVersion, "simple", "")
	// body params
	localVarPostBody = r.sdkKeyPatch
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
type ApiPostSdkKeyRequest struct {
	ctx context.Context
	ApiService SDKKeysBetaApi
	lDAPIVersion *string
	projectKey string
...
// Version of the endpoint.
func (r ApiPostSdkKeyRequest) LDAPIVersion(lDAPIVersion string) ApiPostSdkKeyRequest {
	r.lDAPIVersion = &lDAPIVersion
	return r
}

// Parameters for creating a new SDK key
func (r ApiPostSdkKeyRequest) SdkKeyPost(sdkKeyPost SdkKeyPost) ApiPostSdkKeyRequest {
	r.sdkKeyPost = &sdkKeyPost
	return r
}

func (r ApiPostSdkKeyRequest) Execute() (*SdkKey, *http.Response, error) {
	return r.ApiService.PostSdkKeyExecute(r)
}
...
Create a new server-side or mobile SDK key.
 ...
 @return ApiPostSdkKeyRequest
*/
func (a *SDKKeysBetaApiService) PostSdkKey(ctx context.Context, projectKey string, environmentKey string) ApiPostSdkKeyRequest {
	return ApiPostSdkKeyRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return SdkKey
func (a *SDKKeysBetaApiService) PostSdkKeyExecute(r ApiPostSdkKeyRequest) (*SdkKey, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SDKKeysBetaApiService.PostSdkKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.sdkKeyPost == nil {
		return localVarReturnValue, nil, reportError("sdkKeyPost is required and must be specified")
	}
