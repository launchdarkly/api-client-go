...
func (r ApiGetConfigurationsRequest) Execute() ([]Integrations, *http.Response, error) {
...
*/
func (a *IntegrationsApiService) GetConfigurations(ctx context.Context) ApiGetConfigurationsRequest {
	return ApiGetConfigurationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []Integrations
func (a *IntegrationsApiService) GetConfigurationsExecute(r ApiGetConfigurationsRequest) ([]Integrations, *http.Response, error) {
	var (
