...
type ApiCreateSubscriptionRequest struct {
	...
	integrationsSubscriptionPost *IntegrationsSubscriptionPost
}

func (r ApiCreateSubscriptionRequest) IntegrationsSubscriptionPost(integrationsSubscriptionPost IntegrationsSubscriptionPost) ApiCreateSubscriptionRequest {
	r.integrationsSubscriptionPost = &integrationsSubscriptionPost
	return r
}

func (r ApiCreateSubscriptionRequest) Execute() (IntegrationSubscriptionRep, *_nethttp.Response, error) {
	return r.ApiService.CreateSubscriptionExecute(r)
}

/*
 * CreateSubscription Create integration configuration
 ...
 */
func (a *IntegrationsApiService) CreateSubscription(ctx _context.Context, integrationKey string) ApiCreateSubscriptionRequest {
	return ApiCreateSubscriptionRequest{
		ApiService: a,
		ctx: ctx,
 ...
 * @return IntegrationSubscriptionRep
 */
func (a *IntegrationsApiService) CreateSubscriptionExecute(r ApiCreateSubscriptionRequest) (IntegrationSubscriptionRep, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  IntegrationSubscriptionRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsApiService.CreateSubscription")
	if err != nil {
	...
	if r.integrationsSubscriptionPost == nil {
		return localVarReturnValue, nil, reportError("integrationsSubscriptionPost is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.integrationsSubscriptionPost
	if r.ctx != nil {
...
/*
 * DeleteSubscription Delete integration configuration
 ...
 */
func (a *IntegrationsApiService) DeleteSubscription(ctx _context.Context, integrationKey string, id string) ApiDeleteSubscriptionRequest {
	return ApiDeleteSubscriptionRequest{
		ApiService: a,
		ctx: ctx,
		integrationKey: integrationKey,
 ...
 * Execute executes the request
 */
func (a *IntegrationsApiService) DeleteSubscriptionExecute(r ApiDeleteSubscriptionRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsApiService.DeleteSubscription")
	if err != nil {
...
func (r ApiGetConfigurationsRequest) Execute() ([]InlineResponse2001, *_nethttp.Response, error) {
	return r.ApiService.GetConfigurationsExecute(r)
}

/*
 * GetConfigurations List integration configurations
 *  Get a list of all configured audit log event integrations associated with this account.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @return ApiGetConfigurationsRequest
 */
func (a *IntegrationsApiService) GetConfigurations(ctx _context.Context) ApiGetConfigurationsRequest {
	return ApiGetConfigurationsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *IntegrationsApiService) GetConfigurationsExecute(r ApiGetConfigurationsRequest) ([]InlineResponse2001, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsApiService.GetConfigurations")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetIntegrationSubscriptionByIDRequest struct {
	ctx _context.Context
	ApiService *IntegrationsApiService
	integrationKey string
	id string
...
func (r ApiGetIntegrationSubscriptionByIDRequest) Execute() (IntegrationSubscriptionRepCollection, *_nethttp.Response, error) {
	return r.ApiService.GetIntegrationSubscriptionByIDExecute(r)
}

/*
 * GetIntegrationSubscriptionByID Get configured integration by ID
 *  Get a subscription integration by ID.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param integrationKey The integration key
 * @param id The subscription ID
 * @return ApiGetIntegrationSubscriptionByIDRequest
 */
func (a *IntegrationsApiService) GetIntegrationSubscriptionByID(ctx _context.Context, integrationKey string, id string) ApiGetIntegrationSubscriptionByIDRequest {
	return ApiGetIntegrationSubscriptionByIDRequest{
		ApiService: a,
		ctx: ctx,
		integrationKey: integrationKey,
...
/*
 * Execute executes the request
 * @return IntegrationSubscriptionRepCollection
 */
func (a *IntegrationsApiService) GetIntegrationSubscriptionByIDExecute(r ApiGetIntegrationSubscriptionByIDRequest) (IntegrationSubscriptionRepCollection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  IntegrationSubscriptionRepCollection
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsApiService.GetIntegrationSubscriptionByID")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateSubscriptionRequest) Execute() (IntegrationSubscriptionRep, *_nethttp.Response, error) {
	return r.ApiService.UpdateSubscriptionExecute(r)
}

/*
 * UpdateSubscription Update subscription
 *  Update a subscription integration.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param integrationKey The integration key
 * @return ApiUpdateSubscriptionRequest
 */
func (a *IntegrationsApiService) UpdateSubscription(ctx _context.Context, integrationKey string) ApiUpdateSubscriptionRequest {
	return ApiUpdateSubscriptionRequest{
		ApiService: a,
		ctx: ctx,
		integrationKey: integrationKey,
 ...
 * @return IntegrationSubscriptionRep
 */
func (a *IntegrationsApiService) UpdateSubscriptionExecute(r ApiUpdateSubscriptionRequest) (IntegrationSubscriptionRep, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsApiService.UpdateSubscription")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
