...
// checks if the DependentFlag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DependentFlag{}
...
type _DependentFlag DependentFlag
...
func (o DependentFlag) ToMap() (map[string]interface{}, error) {
...
func (o *DependentFlag) UnmarshalJSON(data []byte) (err error) {
	...
	varDependentFlag := _DependentFlag{}

	err = json.Unmarshal(data, &varDependentFlag)

	if err != nil {
		return err
	}

	*o = DependentFlag(varDependentFlag)
