...
// checks if the AiConfigsAccessAllowedReason type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsAccessAllowedReason{}
...
type _AiConfigsAccessAllowedReason AiConfigsAccessAllowedReason
...
func (o AiConfigsAccessAllowedReason) ToMap() (map[string]interface{}, error) {
...
func (o *AiConfigsAccessAllowedReason) UnmarshalJSON(data []byte) (err error) {
	...
	varAiConfigsAccessAllowedReason := _AiConfigsAccessAllowedReason{}

	err = json.Unmarshal(data, &varAiConfigsAccessAllowedReason)

	if err != nil {
		return err
	}

	*o = AiConfigsAccessAllowedReason(varAiConfigsAccessAllowedReason)
