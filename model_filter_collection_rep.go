...
// FilterCollectionRep struct for FilterCollectionRep
type FilterCollectionRep struct {
	// The location and content type of related resources
	Links *map[string]Link `json:"_links,omitempty"`
	// The number of payload filters returned
	TotalCount *int32 `json:"totalCount,omitempty"`
	// An array of payload filters
	Items []FilterRep `json:"items,omitempty"`
}
...
// SetItems gets a reference to the given []FilterRep and assigns it to the Items field.
func (o *FilterCollectionRep) SetItems(v []FilterRep) {
	o.Items = v
}

func (o FilterCollectionRep) MarshalJSON() ([]byte, error) {
...
type NullableFilterCollectionRep struct {
	value *FilterCollectionRep
	isSet bool
}

func (v NullableFilterCollectionRep) Get() *FilterCollectionRep {
	return v.value
}

func (v *NullableFilterCollectionRep) Set(val *FilterCollectionRep) {
	v.value = val
	v.isSet = true
}

func (v NullableFilterCollectionRep) IsSet() bool {
	return v.isSet
}

func (v *NullableFilterCollectionRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFilterCollectionRep(val *FilterCollectionRep) *NullableFilterCollectionRep {
	return &NullableFilterCollectionRep{value: val, isSet: true}
}

func (v NullableFilterCollectionRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFilterCollectionRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
