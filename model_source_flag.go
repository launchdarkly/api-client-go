...
// checks if the SourceFlag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceFlag{}
...
func (o SourceFlag) ToMap() (map[string]interface{}, error) {
...
func (o *SourceFlag) UnmarshalJSON(data []byte) (err error) {
	...
	varSourceFlag := _SourceFlag{}

	err = json.Unmarshal(data, &varSourceFlag)

	if err != nil {
		return err
	}

	*o = SourceFlag(varSourceFlag)
