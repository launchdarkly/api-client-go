...
// checks if the RepositoryCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RepositoryCollectionRep{}
...
type _RepositoryCollectionRep RepositoryCollectionRep
...
func (o RepositoryCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *RepositoryCollectionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varRepositoryCollectionRep := _RepositoryCollectionRep{}

	err = json.Unmarshal(data, &varRepositoryCollectionRep)

	if err != nil {
		return err
	}

	*o = RepositoryCollectionRep(varRepositoryCollectionRep)
...
func NewNullableRepositoryCollectionRep(val *RepositoryCollectionRep) *NullableRepositoryCollectionRep {
	return &NullableRepositoryCollectionRep{value: val, isSet: true}
}
