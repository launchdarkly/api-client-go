...
// checks if the FlagFollowersGetRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagFollowersGetRep{}
...
type FlagFollowersGetRep struct {
	...
	Items []FollowFlagMember `json:"items"`
	AdditionalProperties map[string]interface{}
}

type _FlagFollowersGetRep FlagFollowersGetRep
...
func (o FlagFollowersGetRep) ToMap() (map[string]interface{}, error) {
...
func (o *FlagFollowersGetRep) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagFollowersGetRep := _FlagFollowersGetRep{}

	err = json.Unmarshal(data, &varFlagFollowersGetRep)

	if err != nil {
		return err
	}

	*o = FlagFollowersGetRep(varFlagFollowersGetRep)
...
func NewNullableFlagFollowersGetRep(val *FlagFollowersGetRep) *NullableFlagFollowersGetRep {
	return &NullableFlagFollowersGetRep{value: val, isSet: true}
}
