...
// checks if the IntegrationDeliveryConfigurationPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationDeliveryConfigurationPost{}
...
type _IntegrationDeliveryConfigurationPost IntegrationDeliveryConfigurationPost
...
func (o IntegrationDeliveryConfigurationPost) ToMap() (map[string]interface{}, error) {
...
func (o *IntegrationDeliveryConfigurationPost) UnmarshalJSON(data []byte) (err error) {
	...
	varIntegrationDeliveryConfigurationPost := _IntegrationDeliveryConfigurationPost{}

	err = json.Unmarshal(data, &varIntegrationDeliveryConfigurationPost)

	if err != nil {
		return err
	}

	*o = IntegrationDeliveryConfigurationPost(varIntegrationDeliveryConfigurationPost)
