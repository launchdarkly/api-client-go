 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return Environment*/
func (a *EnvironmentsApiService) PatchEnvironment(ctx context.Context, projectKey string, environmentKey string, patchDelta []PatchDelta) (Environment,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
func (a *EnvironmentsApiService) PostEnvironment(ctx context.Context, projectKey string, environmentBody EnvironmentBody) ( *http.Response, error) {
	var (
