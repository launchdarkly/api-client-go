...
// RestrictedModelsResponse struct for RestrictedModelsResponse
type RestrictedModelsResponse struct {
	Successes []string `json:"successes"`
	Errors []RestrictedModelError `json:"errors"`
...
func (o *RestrictedModelsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varRestrictedModelsResponse)
