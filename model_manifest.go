...
type Manifest struct {
	...
	FormVariables []FormVariable `json:"formVariables,omitempty"`
	HideOnIntegrationsPage *bool `json:"hideOnIntegrationsPage,omitempty"`
	Icons *Icons `json:"icons,omitempty"`
	Legacy *Legacy `json:"legacy,omitempty"`
	Links *Links `json:"links,omitempty"`
	Name *string `json:"name,omitempty"`
	OauthIntegrationKey *string `json:"oauthIntegrationKey,omitempty"`
	OtherCapabilities []string `json:"otherCapabilities,omitempty"`
...
// GetFormVariables returns the FormVariables field value if set, zero value otherwise.
func (o *Manifest) GetFormVariables() []FormVariable {
	if o == nil || o.FormVariables == nil {
		var ret []FormVariable
		return ret
	}
	return o.FormVariables
}

// GetFormVariablesOk returns a tuple with the FormVariables field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Manifest) GetFormVariablesOk() ([]FormVariable, bool) {
	if o == nil || o.FormVariables == nil {
		return nil, false
	}
	return o.FormVariables, true
}
...
// SetFormVariables gets a reference to the given []FormVariable and assigns it to the FormVariables field.
func (o *Manifest) SetFormVariables(v []FormVariable) {
	o.FormVariables = v
}

// GetHideOnIntegrationsPage returns the HideOnIntegrationsPage field value if set, zero value otherwise.
func (o *Manifest) GetHideOnIntegrationsPage() bool {
	if o == nil || o.HideOnIntegrationsPage == nil {
		var ret bool
		return ret
	}
	return *o.HideOnIntegrationsPage
}

// GetHideOnIntegrationsPageOk returns a tuple with the HideOnIntegrationsPage field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Manifest) GetHideOnIntegrationsPageOk() (*bool, bool) {
	if o == nil || o.HideOnIntegrationsPage == nil {
		return nil, false
	}
	return o.HideOnIntegrationsPage, true
}
...
// SetHideOnIntegrationsPage gets a reference to the given bool and assigns it to the HideOnIntegrationsPage field.
func (o *Manifest) SetHideOnIntegrationsPage(v bool) {
	o.HideOnIntegrationsPage = &v
}
...
// SetIcons gets a reference to the given Icons and assigns it to the Icons field.
...
// SetLegacy gets a reference to the given Legacy and assigns it to the Legacy field.
...
// GetOauthIntegrationKey returns the OauthIntegrationKey field value if set, zero value otherwise.
func (o *Manifest) GetOauthIntegrationKey() string {
	if o == nil || o.OauthIntegrationKey == nil {
		var ret string
		return ret
	}
	return *o.OauthIntegrationKey
}

// GetOauthIntegrationKeyOk returns a tuple with the OauthIntegrationKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Manifest) GetOauthIntegrationKeyOk() (*string, bool) {
	if o == nil || o.OauthIntegrationKey == nil {
		return nil, false
	}
	return o.OauthIntegrationKey, true
}
...
// SetOauthIntegrationKey gets a reference to the given string and assigns it to the OauthIntegrationKey field.
func (o *Manifest) SetOauthIntegrationKey(v string) {
	o.OauthIntegrationKey = &v
}

// GetOtherCapabilities returns the OtherCapabilities field value if set, zero value otherwise.
func (o *Manifest) GetOtherCapabilities() []string {
	if o == nil || o.OtherCapabilities == nil {
		var ret []string
		return ret
	}
	return o.OtherCapabilities
}

// GetOtherCapabilitiesOk returns a tuple with the OtherCapabilities field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Manifest) GetOtherCapabilitiesOk() ([]string, bool) {
	if o == nil || o.OtherCapabilities == nil {
		return nil, false
	}
	return o.OtherCapabilities, true
}
...
// SetOtherCapabilities gets a reference to the given []string and assigns it to the OtherCapabilities field.
func (o *Manifest) SetOtherCapabilities(v []string) {
	o.OtherCapabilities = v
}
...
// GetRequiresOAuth returns the RequiresOAuth field value if set, zero value otherwise.
func (o *Manifest) GetRequiresOAuth() bool {
	if o == nil || o.RequiresOAuth == nil {
		var ret bool
		return ret
	}
	return *o.RequiresOAuth
}

// GetRequiresOAuthOk returns a tuple with the RequiresOAuth field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Manifest) GetRequiresOAuthOk() (*bool, bool) {
	if o == nil || o.RequiresOAuth == nil {
		return nil, false
	}
	return o.RequiresOAuth, true
}
...
// SetRequiresOAuth gets a reference to the given bool and assigns it to the RequiresOAuth field.
...
func (o Manifest) MarshalJSON() ([]byte, error) {
	...
	if o.FormVariables != nil {
		toSerialize["formVariables"] = o.FormVariables
	}
	if o.HideOnIntegrationsPage != nil {
		toSerialize["hideOnIntegrationsPage"] = o.HideOnIntegrationsPage
	}
	if o.Icons != nil {
	...
	if o.OauthIntegrationKey != nil {
		toSerialize["oauthIntegrationKey"] = o.OauthIntegrationKey
	}
	if o.OtherCapabilities != nil {
		toSerialize["otherCapabilities"] = o.OtherCapabilities
	}
	if o.Overview != nil {
		toSerialize["overview"] = o.Overview
	}
	if o.RequiresOAuth != nil {
		toSerialize["requiresOAuth"] = o.RequiresOAuth
	}
