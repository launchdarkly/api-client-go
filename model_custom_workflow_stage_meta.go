...
// checks if the CustomWorkflowStageMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomWorkflowStageMeta{}
...
type _CustomWorkflowStageMeta CustomWorkflowStageMeta
...
func (o CustomWorkflowStageMeta) ToMap() (map[string]interface{}, error) {
...
func (o *CustomWorkflowStageMeta) UnmarshalJSON(data []byte) (err error) {
	varCustomWorkflowStageMeta := _CustomWorkflowStageMeta{}

	err = json.Unmarshal(data, &varCustomWorkflowStageMeta)

	if err != nil {
		return err
	}

	*o = CustomWorkflowStageMeta(varCustomWorkflowStageMeta)
