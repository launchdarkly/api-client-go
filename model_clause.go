...
// checks if the Clause type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Clause{}
...
func (o Clause) ToMap() (map[string]interface{}, error) {
...
func (o *Clause) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varClause)
