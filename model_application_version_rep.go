...
// checks if the ApplicationVersionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationVersionRep{}
...
type _ApplicationVersionRep ApplicationVersionRep
...
func (o ApplicationVersionRep) ToMap() (map[string]interface{}, error) {
...
func (o *ApplicationVersionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varApplicationVersionRep := _ApplicationVersionRep{}

	err = json.Unmarshal(data, &varApplicationVersionRep)

	if err != nil {
		return err
	}

	*o = ApplicationVersionRep(varApplicationVersionRep)
