...
// checks if the SubjectDataRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubjectDataRep{}
...
type _SubjectDataRep SubjectDataRep
...
func (o SubjectDataRep) ToMap() (map[string]interface{}, error) {
...
func (o *SubjectDataRep) UnmarshalJSON(data []byte) (err error) {
	varSubjectDataRep := _SubjectDataRep{}

	err = json.Unmarshal(data, &varSubjectDataRep)

	if err != nil {
		return err
	}

	*o = SubjectDataRep(varSubjectDataRep)
