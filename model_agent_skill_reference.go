...
// checks if the AgentSkillReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentSkillReference{}

// AgentSkillReference A usage of an agent skill in a specific config variation.
...
type _AgentSkillReference AgentSkillReference
...
func (o AgentSkillReference) MarshalJSON() ([]byte, error) {
...
func (o AgentSkillReference) ToMap() (map[string]interface{}, error) {
...
func (o *AgentSkillReference) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentSkillReference := _AgentSkillReference{}

	err = json.Unmarshal(data, &varAgentSkillReference)

	if err != nil {
		return err
	}

	*o = AgentSkillReference(varAgentSkillReference)
...
type NullableAgentSkillReference struct {
	value *AgentSkillReference
	isSet bool
}

func (v NullableAgentSkillReference) Get() *AgentSkillReference {
	return v.value
}

func (v *NullableAgentSkillReference) Set(val *AgentSkillReference) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentSkillReference) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentSkillReference) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentSkillReference(val *AgentSkillReference) *NullableAgentSkillReference {
	return &NullableAgentSkillReference{value: val, isSet: true}
}

func (v NullableAgentSkillReference) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentSkillReference) UnmarshalJSON(src []byte) error {
	v.isSet = true
