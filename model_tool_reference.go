...
// ToolReference A usage of an AI tool in a specific AgentControl config variation.
type ToolReference struct {
	...
	ToolVersion int32 `json:"toolVersion"`
...
// GetToolVersion returns the ToolVersion field value
...
// GetToolVersionOk returns a tuple with the ToolVersion field value
// and a boolean to check if the value has been set.
...
// SetToolVersion sets field value
...
func (o *ToolReference) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ToolReference(varToolReference)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "toolVersion")
