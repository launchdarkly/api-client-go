...
*/
func (a *MetricsApiService) DeleteMetric(ctx _context.Context, projectKey string, metricKey string) ApiDeleteMetricRequest {
	return ApiDeleteMetricRequest{
		ApiService: a,
		ctx: ctx,
...
*/
func (a *MetricsApiService) GetMetric(ctx _context.Context, projectKey string, metricKey string) ApiGetMetricRequest {
	return ApiGetMetricRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
*/
func (a *MetricsApiService) PatchMetric(ctx _context.Context, projectKey string, metricKey string) ApiPatchMetricRequest {
	return ApiPatchMetricRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
