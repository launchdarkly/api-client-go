...
type IPAllowlistBetaApi interface {

	/*
	CreateIpAllowlistEntry Create IP Allowlist Entry

	Create a new IP allowlist entry.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCreateIpAllowlistEntryRequest
	*/
	CreateIpAllowlistEntry(ctx context.Context) ApiCreateIpAllowlistEntryRequest

	// CreateIpAllowlistEntryExecute executes the request
	//  @return IpAllowlistEntryResponse
	CreateIpAllowlistEntryExecute(r ApiCreateIpAllowlistEntryRequest) (*IpAllowlistEntryResponse, *http.Response, error)

	/*
	DeleteIpAllowlistEntry Delete IP Allowlist Entry

	Delete an IP allowlist entry by id.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id Unique identifier for the allowlist entry
	@return ApiDeleteIpAllowlistEntryRequest
	*/
	DeleteIpAllowlistEntry(ctx context.Context, id string) ApiDeleteIpAllowlistEntryRequest

	// DeleteIpAllowlistEntryExecute executes the request
	DeleteIpAllowlistEntryExecute(r ApiDeleteIpAllowlistEntryRequest) (*http.Response, error)
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiGetIpAllowlistRequest
	*/
	GetIpAllowlist(ctx context.Context) ApiGetIpAllowlistRequest

	// GetIpAllowlistExecute executes the request
	//  @return IpAllowlistResponse
	GetIpAllowlistExecute(r ApiGetIpAllowlistRequest) (*IpAllowlistResponse, *http.Response, error)

	/*
	PatchIpAllowlistConfig Update IP Allowlist Configuration

	Update sessionAllowlistEnabled and apiTokenAllowlistEnabled settings.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiPatchIpAllowlistConfigRequest
	*/
	PatchIpAllowlistConfig(ctx context.Context) ApiPatchIpAllowlistConfigRequest

	// PatchIpAllowlistConfigExecute executes the request
	//  @return IpAllowlistResponse
	PatchIpAllowlistConfigExecute(r ApiPatchIpAllowlistConfigRequest) (*IpAllowlistResponse, *http.Response, error)

	/*
	PatchIpAllowlistEntry Update IP Allowlist Entry Description

	Update the description of an IP allowlist entry.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id Unique identifier for the allowlist entry
	@return ApiPatchIpAllowlistEntryRequest
	*/
	PatchIpAllowlistEntry(ctx context.Context, id string) ApiPatchIpAllowlistEntryRequest

	// PatchIpAllowlistEntryExecute executes the request
	//  @return IpAllowlistEntryResponse
	PatchIpAllowlistEntryExecute(r ApiPatchIpAllowlistEntryRequest) (*IpAllowlistEntryResponse, *http.Response, error)
}

// IPAllowlistBetaApiService IPAllowlistBetaApi service
type IPAllowlistBetaApiService service

type ApiCreateIpAllowlistEntryRequest struct {
	ctx context.Context
	ApiService IPAllowlistBetaApi
	createIpAllowlistEntryRequest *CreateIpAllowlistEntryRequest
}

func (r ApiCreateIpAllowlistEntryRequest) CreateIpAllowlistEntryRequest(createIpAllowlistEntryRequest CreateIpAllowlistEntryRequest) ApiCreateIpAllowlistEntryRequest {
	r.createIpAllowlistEntryRequest = &createIpAllowlistEntryRequest
	return r
}

func (r ApiCreateIpAllowlistEntryRequest) Execute() (*IpAllowlistEntryResponse, *http.Response, error) {
	return r.ApiService.CreateIpAllowlistEntryExecute(r)
}
...
Create a new IP allowlist entry.
 ...
 @return ApiCreateIpAllowlistEntryRequest
*/
func (a *IPAllowlistBetaApiService) CreateIpAllowlistEntry(ctx context.Context) ApiCreateIpAllowlistEntryRequest {
	return ApiCreateIpAllowlistEntryRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return IpAllowlistEntryResponse
func (a *IPAllowlistBetaApiService) CreateIpAllowlistEntryExecute(r ApiCreateIpAllowlistEntryRequest) (*IpAllowlistEntryResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *IpAllowlistEntryResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPAllowlistBetaApiService.CreateIpAllowlistEntry")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/account/ip-allowlist"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createIpAllowlistEntryRequest == nil {
		return localVarReturnValue, nil, reportError("createIpAllowlistEntryRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createIpAllowlistEntryRequest
	if r.ctx != nil {
...
type ApiDeleteIpAllowlistEntryRequest struct {
	ctx context.Context
	ApiService IPAllowlistBetaApi
	id string
}

func (r ApiDeleteIpAllowlistEntryRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteIpAllowlistEntryExecute(r)
}
...
Delete an IP allowlist entry by id.
 ...
 @return ApiDeleteIpAllowlistEntryRequest
*/
func (a *IPAllowlistBetaApiService) DeleteIpAllowlistEntry(ctx context.Context, id string) ApiDeleteIpAllowlistEntryRequest {
	return ApiDeleteIpAllowlistEntryRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *IPAllowlistBetaApiService) DeleteIpAllowlistEntryExecute(r ApiDeleteIpAllowlistEntryRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPAllowlistBetaApiService.DeleteIpAllowlistEntry")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/account/ip-allowlist/{id}"
...
func (r ApiGetIpAllowlistRequest) Search(search string) ApiGetIpAllowlistRequest {
	r.search = &search
	return r
}

// The number of entries to return. When omitted, all matching entries are returned. Maximum is 100.
func (r ApiGetIpAllowlistRequest) Limit(limit int32) ApiGetIpAllowlistRequest {
	r.limit = &limit
	return r
}

// The number of entries to skip. Used for pagination.
func (r ApiGetIpAllowlistRequest) Offset(offset int32) ApiGetIpAllowlistRequest {
	r.offset = &offset
	return r
}

func (r ApiGetIpAllowlistRequest) Execute() (*IpAllowlistResponse, *http.Response, error) {
	return r.ApiService.GetIpAllowlistExecute(r)
}
...
Get the current IP allowlist configuration and entries.
 ...
 @return ApiGetIpAllowlistRequest
*/
func (a *IPAllowlistBetaApiService) GetIpAllowlist(ctx context.Context) ApiGetIpAllowlistRequest {
	return ApiGetIpAllowlistRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return IpAllowlistResponse
func (a *IPAllowlistBetaApiService) GetIpAllowlistExecute(r ApiGetIpAllowlistRequest) (*IpAllowlistResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPAllowlistBetaApiService.GetIpAllowlist")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiPatchIpAllowlistConfigRequest struct {
	ctx context.Context
	ApiService IPAllowlistBetaApi
	patchIpAllowlistConfigRequest *PatchIpAllowlistConfigRequest
}

func (r ApiPatchIpAllowlistConfigRequest) PatchIpAllowlistConfigRequest(patchIpAllowlistConfigRequest PatchIpAllowlistConfigRequest) ApiPatchIpAllowlistConfigRequest {
	r.patchIpAllowlistConfigRequest = &patchIpAllowlistConfigRequest
	return r
}

func (r ApiPatchIpAllowlistConfigRequest) Execute() (*IpAllowlistResponse, *http.Response, error) {
	return r.ApiService.PatchIpAllowlistConfigExecute(r)
}
...
Update sessionAllowlistEnabled and apiTokenAllowlistEnabled settings.
 ...
 @return ApiPatchIpAllowlistConfigRequest
*/
func (a *IPAllowlistBetaApiService) PatchIpAllowlistConfig(ctx context.Context) ApiPatchIpAllowlistConfigRequest {
	return ApiPatchIpAllowlistConfigRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return IpAllowlistResponse
func (a *IPAllowlistBetaApiService) PatchIpAllowlistConfigExecute(r ApiPatchIpAllowlistConfigRequest) (*IpAllowlistResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPAllowlistBetaApiService.PatchIpAllowlistConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.patchIpAllowlistConfigRequest == nil {
		return localVarReturnValue, nil, reportError("patchIpAllowlistConfigRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.patchIpAllowlistConfigRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
...
type ApiPatchIpAllowlistEntryRequest struct {
	ctx context.Context
	ApiService IPAllowlistBetaApi
	id string
...
func (r ApiPatchIpAllowlistEntryRequest) PatchIpAllowlistEntryRequest(patchIpAllowlistEntryRequest PatchIpAllowlistEntryRequest) ApiPatchIpAllowlistEntryRequest {
	r.patchIpAllowlistEntryRequest = &patchIpAllowlistEntryRequest
	return r
}

func (r ApiPatchIpAllowlistEntryRequest) Execute() (*IpAllowlistEntryResponse, *http.Response, error) {
	return r.ApiService.PatchIpAllowlistEntryExecute(r)
}
...
Update the description of an IP allowlist entry.
 ...
 @return ApiPatchIpAllowlistEntryRequest
*/
func (a *IPAllowlistBetaApiService) PatchIpAllowlistEntry(ctx context.Context, id string) ApiPatchIpAllowlistEntryRequest {
	return ApiPatchIpAllowlistEntryRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return IpAllowlistEntryResponse
func (a *IPAllowlistBetaApiService) PatchIpAllowlistEntryExecute(r ApiPatchIpAllowlistEntryRequest) (*IpAllowlistEntryResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IPAllowlistBetaApiService.PatchIpAllowlistEntry")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.patchIpAllowlistEntryRequest == nil {
		return localVarReturnValue, nil, reportError("patchIpAllowlistEntryRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.patchIpAllowlistEntryRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["ApiKey"]; ok {
