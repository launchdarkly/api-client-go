...
// checks if the InvalidRequestErrorRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvalidRequestErrorRep{}
...
type _InvalidRequestErrorRep InvalidRequestErrorRep
...
func (o InvalidRequestErrorRep) ToMap() (map[string]interface{}, error) {
...
func (o *InvalidRequestErrorRep) UnmarshalJSON(data []byte) (err error) {
	...
	varInvalidRequestErrorRep := _InvalidRequestErrorRep{}

	err = json.Unmarshal(data, &varInvalidRequestErrorRep)

	if err != nil {
		return err
	}

	*o = InvalidRequestErrorRep(varInvalidRequestErrorRep)
