...
// checks if the TreatmentParameterInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TreatmentParameterInput{}
...
type _TreatmentParameterInput TreatmentParameterInput
...
func (o TreatmentParameterInput) ToMap() (map[string]interface{}, error) {
...
func (o *TreatmentParameterInput) UnmarshalJSON(data []byte) (err error) {
	...
	varTreatmentParameterInput := _TreatmentParameterInput{}

	err = json.Unmarshal(data, &varTreatmentParameterInput)

	if err != nil {
		return err
	}

	*o = TreatmentParameterInput(varTreatmentParameterInput)
...
func NewNullableTreatmentParameterInput(val *TreatmentParameterInput) *NullableTreatmentParameterInput {
	return &NullableTreatmentParameterInput{value: val, isSet: true}
}
