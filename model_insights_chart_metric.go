...
// checks if the InsightsChartMetric type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightsChartMetric{}
...
type _InsightsChartMetric InsightsChartMetric
...
func (o InsightsChartMetric) ToMap() (map[string]interface{}, error) {
...
func (o *InsightsChartMetric) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightsChartMetric := _InsightsChartMetric{}

	err = json.Unmarshal(data, &varInsightsChartMetric)

	if err != nil {
		return err
	}

	*o = InsightsChartMetric(varInsightsChartMetric)
