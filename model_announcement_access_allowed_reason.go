...
// checks if the AnnouncementAccessAllowedReason type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnnouncementAccessAllowedReason{}
...
type _AnnouncementAccessAllowedReason AnnouncementAccessAllowedReason
...
func (o AnnouncementAccessAllowedReason) ToMap() (map[string]interface{}, error) {
...
func (o *AnnouncementAccessAllowedReason) UnmarshalJSON(data []byte) (err error) {
	...
	varAnnouncementAccessAllowedReason := _AnnouncementAccessAllowedReason{}

	err = json.Unmarshal(data, &varAnnouncementAccessAllowedReason)

	if err != nil {
		return err
	}

	*o = AnnouncementAccessAllowedReason(varAnnouncementAccessAllowedReason)
