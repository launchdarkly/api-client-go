...
// checks if the VariationEvalSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VariationEvalSummary{}
...
type _VariationEvalSummary VariationEvalSummary
...
func (o VariationEvalSummary) ToMap() (map[string]interface{}, error) {
...
func (o *VariationEvalSummary) UnmarshalJSON(data []byte) (err error) {
	varVariationEvalSummary := _VariationEvalSummary{}

	err = json.Unmarshal(data, &varVariationEvalSummary)

	if err != nil {
		return err
	}

	*o = VariationEvalSummary(varVariationEvalSummary)
