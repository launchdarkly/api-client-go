...
// checks if the AnnouncementAccessDeniedReason type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnnouncementAccessDeniedReason{}
...
type _AnnouncementAccessDeniedReason AnnouncementAccessDeniedReason
...
func (o AnnouncementAccessDeniedReason) ToMap() (map[string]interface{}, error) {
...
func (o *AnnouncementAccessDeniedReason) UnmarshalJSON(data []byte) (err error) {
	...
	varAnnouncementAccessDeniedReason := _AnnouncementAccessDeniedReason{}

	err = json.Unmarshal(data, &varAnnouncementAccessDeniedReason)

	if err != nil {
		return err
	}

	*o = AnnouncementAccessDeniedReason(varAnnouncementAccessDeniedReason)
