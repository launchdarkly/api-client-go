...
// checks if the ReleasePhase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleasePhase{}
...
type _ReleasePhase ReleasePhase
...
func (o ReleasePhase) ToMap() (map[string]interface{}, error) {
...
func (o *ReleasePhase) UnmarshalJSON(data []byte) (err error) {
	...
	varReleasePhase := _ReleasePhase{}

	err = json.Unmarshal(data, &varReleasePhase)

	if err != nil {
		return err
	}

	*o = ReleasePhase(varReleasePhase)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_completionDate")
		delete(additionalProperties, "_completedBy")
		delete(additionalProperties, "_audiences")
		delete(additionalProperties, "status")
		delete(additionalProperties, "started")
		delete(additionalProperties, "_startedDate")
