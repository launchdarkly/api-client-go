...
// PostApplyRequest struct for PostApplyRequest
type PostApplyRequest struct {
	Endpoint *Endpoint `json:"endpoint,omitempty"`
	JsonBody *string `json:"jsonBody,omitempty"`
	Parser *ApprovalParser `json:"parser,omitempty"`
}
...
// SetParser gets a reference to the given ApprovalParser and assigns it to the Parser field.
func (o *PostApplyRequest) SetParser(v ApprovalParser) {
	o.Parser = &v
}

func (o PostApplyRequest) MarshalJSON() ([]byte, error) {
...
type NullablePostApplyRequest struct {
	value *PostApplyRequest
	isSet bool
}

func (v NullablePostApplyRequest) Get() *PostApplyRequest {
	return v.value
}

func (v *NullablePostApplyRequest) Set(val *PostApplyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePostApplyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePostApplyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostApplyRequest(val *PostApplyRequest) *NullablePostApplyRequest {
	return &NullablePostApplyRequest{value: val, isSet: true}
}

func (v NullablePostApplyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostApplyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
