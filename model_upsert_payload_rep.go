...
// checks if the UpsertPayloadRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpsertPayloadRep{}
...
type _UpsertPayloadRep UpsertPayloadRep
...
func (o UpsertPayloadRep) ToMap() (map[string]interface{}, error) {
...
func (o *UpsertPayloadRep) UnmarshalJSON(data []byte) (err error) {
	...
	varUpsertPayloadRep := _UpsertPayloadRep{}

	err = json.Unmarshal(data, &varUpsertPayloadRep)

	if err != nil {
		return err
	}

	*o = UpsertPayloadRep(varUpsertPayloadRep)
