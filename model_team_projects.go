...
// checks if the TeamProjects type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamProjects{}
...
type _TeamProjects TeamProjects
...
func (o TeamProjects) ToMap() (map[string]interface{}, error) {
...
func (o *TeamProjects) UnmarshalJSON(data []byte) (err error) {
	varTeamProjects := _TeamProjects{}

	err = json.Unmarshal(data, &varTeamProjects)

	if err != nil {
		return err
	}

	*o = TeamProjects(varTeamProjects)
...
func NewNullableTeamProjects(val *TeamProjects) *NullableTeamProjects {
	return &NullableTeamProjects{value: val, isSet: true}
}
