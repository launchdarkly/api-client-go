...
// MemberListRequest struct for MemberListRequest
type MemberListRequest struct {
	Endpoint *Endpoint `json:"endpoint,omitempty"`
	JsonBody *string `json:"jsonBody,omitempty"`
	Parser *MemberListParser `json:"parser,omitempty"`
}
...
// SetParser gets a reference to the given MemberListParser and assigns it to the Parser field.
func (o *MemberListRequest) SetParser(v MemberListParser) {
	o.Parser = &v
}

func (o MemberListRequest) MarshalJSON() ([]byte, error) {
...
type NullableMemberListRequest struct {
	value *MemberListRequest
	isSet bool
}

func (v NullableMemberListRequest) Get() *MemberListRequest {
	return v.value
}

func (v *NullableMemberListRequest) Set(val *MemberListRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableMemberListRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableMemberListRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMemberListRequest(val *MemberListRequest) *NullableMemberListRequest {
	return &NullableMemberListRequest{value: val, isSet: true}
}

func (v NullableMemberListRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMemberListRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
