...
// checks if the WeightedVariation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WeightedVariation{}
...
type _WeightedVariation WeightedVariation
...
func (o WeightedVariation) ToMap() (map[string]interface{}, error) {
...
func (o *WeightedVariation) UnmarshalJSON(data []byte) (err error) {
	...
	varWeightedVariation := _WeightedVariation{}

	err = json.Unmarshal(data, &varWeightedVariation)

	if err != nil {
		return err
	}

	*o = WeightedVariation(varWeightedVariation)
