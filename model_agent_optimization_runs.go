...
// checks if the AgentOptimizationRuns type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentOptimizationRuns{}

// AgentOptimizationRuns struct for AgentOptimizationRuns
type AgentOptimizationRuns struct {
	Links *PaginatedLinks `json:"_links,omitempty"`
	Items []AgentOptimizationRun `json:"items"`
	TotalCount *int32 `json:"totalCount,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AgentOptimizationRuns AgentOptimizationRuns
...
func (o AgentOptimizationRuns) MarshalJSON() ([]byte, error) {
...
func (o AgentOptimizationRuns) ToMap() (map[string]interface{}, error) {
...
func (o *AgentOptimizationRuns) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentOptimizationRuns := _AgentOptimizationRuns{}

	err = json.Unmarshal(data, &varAgentOptimizationRuns)

	if err != nil {
		return err
	}

	*o = AgentOptimizationRuns(varAgentOptimizationRuns)
...
type NullableAgentOptimizationRuns struct {
	value *AgentOptimizationRuns
	isSet bool
}

func (v NullableAgentOptimizationRuns) Get() *AgentOptimizationRuns {
	return v.value
}

func (v *NullableAgentOptimizationRuns) Set(val *AgentOptimizationRuns) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentOptimizationRuns) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentOptimizationRuns) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentOptimizationRuns(val *AgentOptimizationRuns) *NullableAgentOptimizationRuns {
	return &NullableAgentOptimizationRuns{value: val, isSet: true}
}

func (v NullableAgentOptimizationRuns) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentOptimizationRuns) UnmarshalJSON(src []byte) error {
	v.isSet = true
