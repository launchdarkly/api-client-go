...
// checks if the SdkVersionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdkVersionRep{}
...
type _SdkVersionRep SdkVersionRep
...
func (o SdkVersionRep) ToMap() (map[string]interface{}, error) {
...
func (o *SdkVersionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varSdkVersionRep := _SdkVersionRep{}

	err = json.Unmarshal(data, &varSdkVersionRep)

	if err != nil {
		return err
	}

	*o = SdkVersionRep(varSdkVersionRep)
