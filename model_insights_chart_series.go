...
// checks if the InsightsChartSeries type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightsChartSeries{}

// InsightsChartSeries struct for InsightsChartSeries
type InsightsChartSeries struct {
	Metadata InsightsChartSeriesMetadata `json:"metadata"`
	// Data points for the series
	Data []InsightsChartSeriesDataPoint `json:"data"`
	AdditionalProperties map[string]interface{}
}

type _InsightsChartSeries InsightsChartSeries
...
func (o *InsightsChartSeries) GetMetadata() InsightsChartSeriesMetadata {
	if o == nil {
		var ret InsightsChartSeriesMetadata
		return ret
	}
...
func (o *InsightsChartSeries) GetData() []InsightsChartSeriesDataPoint {
	if o == nil {
		var ret []InsightsChartSeriesDataPoint
		return ret
	}
...
func (o InsightsChartSeries) ToMap() (map[string]interface{}, error) {
...
func (o *InsightsChartSeries) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightsChartSeries := _InsightsChartSeries{}

	err = json.Unmarshal(data, &varInsightsChartSeries)

	if err != nil {
		return err
	}

	*o = InsightsChartSeries(varInsightsChartSeries)
...
func NewNullableInsightsChartSeries(val *InsightsChartSeries) *NullableInsightsChartSeries {
	return &NullableInsightsChartSeries{value: val, isSet: true}
}
