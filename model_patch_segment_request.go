...
// checks if the PatchSegmentRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchSegmentRequest{}
...
type _PatchSegmentRequest PatchSegmentRequest
...
func (o PatchSegmentRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchSegmentRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchSegmentRequest := _PatchSegmentRequest{}

	err = json.Unmarshal(data, &varPatchSegmentRequest)

	if err != nil {
		return err
	}

	*o = PatchSegmentRequest(varPatchSegmentRequest)
