...
// checks if the SourceEnv type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceEnv{}
...
func (o SourceEnv) ToMap() (map[string]interface{}, error) {
...
func (o *SourceEnv) UnmarshalJSON(data []byte) (err error) {
	varSourceEnv := _SourceEnv{}

	err = json.Unmarshal(data, &varSourceEnv)

	if err != nil {
		return err
	}

	*o = SourceEnv(varSourceEnv)
...
func NewNullableSourceEnv(val *SourceEnv) *NullableSourceEnv {
	return &NullableSourceEnv{value: val, isSet: true}
}
