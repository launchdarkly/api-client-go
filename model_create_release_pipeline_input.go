...
// checks if the CreateReleasePipelineInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateReleasePipelineInput{}
...
type _CreateReleasePipelineInput CreateReleasePipelineInput
...
func (o *CreateReleasePipelineInput) GetIsProjectDefault() bool {
	if o == nil || IsNil(o.IsProjectDefault) {
		var ret bool
		return ret
	}
...
func (o CreateReleasePipelineInput) ToMap() (map[string]interface{}, error) {
...
func (o *CreateReleasePipelineInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateReleasePipelineInput := _CreateReleasePipelineInput{}

	err = json.Unmarshal(data, &varCreateReleasePipelineInput)

	if err != nil {
		return err
	}

	*o = CreateReleasePipelineInput(varCreateReleasePipelineInput)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "isProjectDefault")
