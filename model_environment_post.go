...
// checks if the EnvironmentPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnvironmentPost{}
...
type _EnvironmentPost EnvironmentPost
...
func (o *EnvironmentPost) GetDefaultTrackEvents() bool {
	if o == nil || IsNil(o.DefaultTrackEvents) {
		var ret bool
		return ret
	}
...
func (o *EnvironmentPost) GetConfirmChanges() bool {
	if o == nil || IsNil(o.ConfirmChanges) {
		var ret bool
		return ret
	}
...
func (o *EnvironmentPost) GetRequireComments() bool {
	if o == nil || IsNil(o.RequireComments) {
		var ret bool
		return ret
	}
...
func (o EnvironmentPost) ToMap() (map[string]interface{}, error) {
...
func (o *EnvironmentPost) UnmarshalJSON(data []byte) (err error) {
	...
	varEnvironmentPost := _EnvironmentPost{}

	err = json.Unmarshal(data, &varEnvironmentPost)

	if err != nil {
		return err
	}

	*o = EnvironmentPost(varEnvironmentPost)
