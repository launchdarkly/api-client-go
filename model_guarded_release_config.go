...
var _ MappedNullable = &GuardedReleaseConfig{}
...
type _GuardedReleaseConfig GuardedReleaseConfig
...
func (o *GuardedReleaseConfig) UnmarshalJSON(data []byte) (err error) {
	...
	*o = GuardedReleaseConfig(varGuardedReleaseConfig)
...
type NullableGuardedReleaseConfig struct {
	value *GuardedReleaseConfig
	isSet bool
}

func (v NullableGuardedReleaseConfig) Get() *GuardedReleaseConfig {
	return v.value
}

func (v *NullableGuardedReleaseConfig) Set(val *GuardedReleaseConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableGuardedReleaseConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableGuardedReleaseConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuardedReleaseConfig(val *GuardedReleaseConfig) *NullableGuardedReleaseConfig {
	return &NullableGuardedReleaseConfig{value: val, isSet: true}
}

func (v NullableGuardedReleaseConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuardedReleaseConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
