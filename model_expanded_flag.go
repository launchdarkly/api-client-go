...
// checks if the ExpandedFlag type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedFlag{}

// ExpandedFlag Flag representation for Views API - contains only fields actually used by the Views service
type ExpandedFlag struct {
...
type _ExpandedFlag ExpandedFlag
...
func (o ExpandedFlag) MarshalJSON() ([]byte, error) {
...
func (o ExpandedFlag) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedFlag) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedFlag := _ExpandedFlag{}

	err = json.Unmarshal(data, &varExpandedFlag)

	if err != nil {
		return err
	}

	*o = ExpandedFlag(varExpandedFlag)
...
type NullableExpandedFlag struct {
	value *ExpandedFlag
	isSet bool
}

func (v NullableExpandedFlag) Get() *ExpandedFlag {
	return v.value
}

func (v *NullableExpandedFlag) Set(val *ExpandedFlag) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedFlag) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedFlag) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedFlag(val *ExpandedFlag) *NullableExpandedFlag {
	return &NullableExpandedFlag{value: val, isSet: true}
}

func (v NullableExpandedFlag) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedFlag) UnmarshalJSON(src []byte) error {
	v.isSet = true
