...
// checks if the PullRequestLeadTimeRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PullRequestLeadTimeRep{}
...
type _PullRequestLeadTimeRep PullRequestLeadTimeRep
...
func (o *PullRequestLeadTimeRep) GetReviewDurationMs() int64 {
	if o == nil || IsNil(o.ReviewDurationMs) {
		var ret int64
		return ret
	}
...
func (o *PullRequestLeadTimeRep) GetMaxWaitDurationMs() int64 {
	if o == nil || IsNil(o.MaxWaitDurationMs) {
		var ret int64
		return ret
	}
...
func (o *PullRequestLeadTimeRep) GetAvgWaitDurationMs() int64 {
	if o == nil || IsNil(o.AvgWaitDurationMs) {
		var ret int64
		return ret
	}
...
func (o *PullRequestLeadTimeRep) GetMaxDeployDurationMs() int64 {
	if o == nil || IsNil(o.MaxDeployDurationMs) {
		var ret int64
		return ret
	}
...
func (o *PullRequestLeadTimeRep) GetAvgDeployDurationMs() int64 {
	if o == nil || IsNil(o.AvgDeployDurationMs) {
		var ret int64
		return ret
	}
...
func (o *PullRequestLeadTimeRep) GetMaxTotalLeadTimeMs() int64 {
	if o == nil || IsNil(o.MaxTotalLeadTimeMs) {
		var ret int64
		return ret
	}
...
func (o *PullRequestLeadTimeRep) GetAvgTotalLeadTimeMs() int64 {
	if o == nil || IsNil(o.AvgTotalLeadTimeMs) {
		var ret int64
		return ret
	}
...
func (o *PullRequestLeadTimeRep) UnmarshalJSON(data []byte) (err error) {
	...
	varPullRequestLeadTimeRep := _PullRequestLeadTimeRep{}

	err = json.Unmarshal(data, &varPullRequestLeadTimeRep)

	if err != nil {
		return err
	}

	*o = PullRequestLeadTimeRep(varPullRequestLeadTimeRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "codingDurationMs")
		delete(additionalProperties, "reviewDurationMs")
		delete(additionalProperties, "maxWaitDurationMs")
		delete(additionalProperties, "avgWaitDurationMs")
		delete(additionalProperties, "maxDeployDurationMs")
		delete(additionalProperties, "avgDeployDurationMs")
		delete(additionalProperties, "maxTotalLeadTimeMs")
		delete(additionalProperties, "avgTotalLeadTimeMs")
