...
func (r ApiGetCustomWorkflowRequest) Execute() (*CustomWorkflowOutputRep, *http.Response, error) {
...
func (a *WorkflowsBetaApiService) GetCustomWorkflowExecute(r ApiGetCustomWorkflowRequest) (*CustomWorkflowOutputRep, *http.Response, error) {
	var (
...
func (r ApiGetWorkflowsRequest) Execute() (*CustomWorkflowsListingOutputRep, *http.Response, error) {
...
func (a *WorkflowsBetaApiService) GetWorkflowsExecute(r ApiGetWorkflowsRequest) (*CustomWorkflowsListingOutputRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiPostWorkflowRequest) Execute() (*CustomWorkflowOutputRep, *http.Response, error) {
...
// Execute executes the request
//  @return CustomWorkflowOutputRep
func (a *WorkflowsBetaApiService) PostWorkflowExecute(r ApiPostWorkflowRequest) (*CustomWorkflowOutputRep, *http.Response, error) {
	var (
