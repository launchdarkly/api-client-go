...
func (a *WorkflowsBetaApiService) GetCustomWorkflowExecute(r ApiGetCustomWorkflowRequest) (*CustomWorkflowOutput, *http.Response, error) {
	var (
...
func (a *WorkflowsBetaApiService) GetWorkflowsExecute(r ApiGetWorkflowsRequest) (*CustomWorkflowsListingOutput, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Execute executes the request
//  @return CustomWorkflowOutput
func (a *WorkflowsBetaApiService) PostWorkflowExecute(r ApiPostWorkflowRequest) (*CustomWorkflowOutput, *http.Response, error) {
	var (
