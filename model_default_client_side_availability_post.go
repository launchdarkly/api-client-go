...
// checks if the DefaultClientSideAvailabilityPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DefaultClientSideAvailabilityPost{}
...
type _DefaultClientSideAvailabilityPost DefaultClientSideAvailabilityPost
...
func (o DefaultClientSideAvailabilityPost) ToMap() (map[string]interface{}, error) {
...
func (o *DefaultClientSideAvailabilityPost) UnmarshalJSON(data []byte) (err error) {
	...
	varDefaultClientSideAvailabilityPost := _DefaultClientSideAvailabilityPost{}

	err = json.Unmarshal(data, &varDefaultClientSideAvailabilityPost)

	if err != nil {
		return err
	}

	*o = DefaultClientSideAvailabilityPost(varDefaultClientSideAvailabilityPost)
