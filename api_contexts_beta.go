...
type ApiPutFlagSettingForContextRequest struct {
	ctx context.Context
	ApiService *ContextsBetaApiService
	projectKey string
	environmentKey string
...
func (r ApiPutFlagSettingForContextRequest) ValuePut(valuePut ValuePut) ApiPutFlagSettingForContextRequest {
	r.valuePut = &valuePut
	return r
}

func (r ApiPutFlagSettingForContextRequest) Execute() (*http.Response, error) {
	return r.ApiService.PutFlagSettingForContextExecute(r)
}

/*
PutFlagSettingForContext Update flag settings for context
...
If you previously patched the flag, and the patch included the context's data, LaunchDarkly continues to use that data. If LaunchDarkly has never encountered the combination of the context's key and kind before, it calculates the flag values based on the context kind and key.
 ...
 @return ApiPutFlagSettingForContextRequest
*/
func (a *ContextsBetaApiService) PutFlagSettingForContext(ctx context.Context, projectKey string, environmentKey string, contextKind string, contextKey string, featureFlagKey string) ApiPutFlagSettingForContextRequest {
	return ApiPutFlagSettingForContextRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
func (a *ContextsBetaApiService) PutFlagSettingForContextExecute(r ApiPutFlagSettingForContextRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ContextsBetaApiService.PutFlagSettingForContext")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
