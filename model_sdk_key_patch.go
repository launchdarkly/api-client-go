...
// checks if the SdkKeyPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdkKeyPatch{}

// SdkKeyPatch struct for SdkKeyPatch
type SdkKeyPatch struct {
...
func (o SdkKeyPatch) MarshalJSON() ([]byte, error) {
...
func (o SdkKeyPatch) ToMap() (map[string]interface{}, error) {
...
func (o *SdkKeyPatch) UnmarshalJSON(data []byte) (err error) {
	varSdkKeyPatch := _SdkKeyPatch{}

	err = json.Unmarshal(data, &varSdkKeyPatch)

	if err != nil {
		return err
	}

	*o = SdkKeyPatch(varSdkKeyPatch)
...
type NullableSdkKeyPatch struct {
	value *SdkKeyPatch
	isSet bool
}

func (v NullableSdkKeyPatch) Get() *SdkKeyPatch {
	return v.value
}

func (v *NullableSdkKeyPatch) Set(val *SdkKeyPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableSdkKeyPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableSdkKeyPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdkKeyPatch(val *SdkKeyPatch) *NullableSdkKeyPatch {
	return &NullableSdkKeyPatch{value: val, isSet: true}
}

func (v NullableSdkKeyPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdkKeyPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
