...
// checks if the VariationOrRolloutRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VariationOrRolloutRep{}
...
type _VariationOrRolloutRep VariationOrRolloutRep
...
func (o VariationOrRolloutRep) ToMap() (map[string]interface{}, error) {
...
func (o *VariationOrRolloutRep) UnmarshalJSON(data []byte) (err error) {
	varVariationOrRolloutRep := _VariationOrRolloutRep{}

	err = json.Unmarshal(data, &varVariationOrRolloutRep)

	if err != nil {
		return err
	}

	*o = VariationOrRolloutRep(varVariationOrRolloutRep)
