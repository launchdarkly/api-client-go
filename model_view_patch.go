...
// checks if the ViewPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewPatch{}

// ViewPatch struct for ViewPatch
...
func (o ViewPatch) MarshalJSON() ([]byte, error) {
...
func (o ViewPatch) ToMap() (map[string]interface{}, error) {
...
func (o *ViewPatch) UnmarshalJSON(data []byte) (err error) {
	varViewPatch := _ViewPatch{}

	err = json.Unmarshal(data, &varViewPatch)

	if err != nil {
		return err
	}

	*o = ViewPatch(varViewPatch)
...
type NullableViewPatch struct {
	value *ViewPatch
	isSet bool
}

func (v NullableViewPatch) Get() *ViewPatch {
	return v.value
}

func (v *NullableViewPatch) Set(val *ViewPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableViewPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableViewPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewPatch(val *ViewPatch) *NullableViewPatch {
	return &NullableViewPatch{value: val, isSet: true}
}

func (v NullableViewPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
