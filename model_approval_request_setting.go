...
// checks if the ApprovalRequestSetting type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApprovalRequestSetting{}

// ApprovalRequestSetting Configuration that controls how changes to a resource are gated by approvals.
type ApprovalRequestSetting struct {
...
type _ApprovalRequestSetting ApprovalRequestSetting
...
func (o *ApprovalRequestSetting) SetAutoApplyApprovedChangesNil() {
...
func (o *ApprovalRequestSetting) SetServiceKindConfigurationIdNil() {
...
func (o ApprovalRequestSetting) MarshalJSON() ([]byte, error) {
...
func (o ApprovalRequestSetting) ToMap() (map[string]interface{}, error) {
...
func (o *ApprovalRequestSetting) UnmarshalJSON(data []byte) (err error) {
	...
	varApprovalRequestSetting := _ApprovalRequestSetting{}

	err = json.Unmarshal(data, &varApprovalRequestSetting)

	if err != nil {
		return err
	}

	*o = ApprovalRequestSetting(varApprovalRequestSetting)
...
type NullableApprovalRequestSetting struct {
	value *ApprovalRequestSetting
	isSet bool
}

func (v NullableApprovalRequestSetting) Get() *ApprovalRequestSetting {
	return v.value
}

func (v *NullableApprovalRequestSetting) Set(val *ApprovalRequestSetting) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalRequestSetting) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalRequestSetting) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalRequestSetting(val *ApprovalRequestSetting) *NullableApprovalRequestSetting {
	return &NullableApprovalRequestSetting{value: val, isSet: true}
}

func (v NullableApprovalRequestSetting) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalRequestSetting) UnmarshalJSON(src []byte) error {
	v.isSet = true
