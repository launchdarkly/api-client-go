...
// checks if the CustomWorkflowInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomWorkflowInput{}
...
type _CustomWorkflowInput CustomWorkflowInput
...
func (o CustomWorkflowInput) ToMap() (map[string]interface{}, error) {
...
func (o *CustomWorkflowInput) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomWorkflowInput := _CustomWorkflowInput{}

	err = json.Unmarshal(data, &varCustomWorkflowInput)

	if err != nil {
		return err
	}

	*o = CustomWorkflowInput(varCustomWorkflowInput)
