...
// checks if the DeploymentCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeploymentCollectionRep{}
...
type _DeploymentCollectionRep DeploymentCollectionRep
...
func (o DeploymentCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *DeploymentCollectionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varDeploymentCollectionRep := _DeploymentCollectionRep{}

	err = json.Unmarshal(data, &varDeploymentCollectionRep)

	if err != nil {
		return err
	}

	*o = DeploymentCollectionRep(varDeploymentCollectionRep)
