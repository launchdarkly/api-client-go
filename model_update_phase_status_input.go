...
// checks if the UpdatePhaseStatusInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdatePhaseStatusInput{}

// UpdatePhaseStatusInput struct for UpdatePhaseStatusInput
type UpdatePhaseStatusInput struct {
	Status *string `json:"status,omitempty"`
	// Extra configuration for audiences required upon phase initialization.
	Audiences []ReleaserAudienceConfigInput `json:"audiences,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _UpdatePhaseStatusInput UpdatePhaseStatusInput
...
func (o *UpdatePhaseStatusInput) GetAudiences() []ReleaserAudienceConfigInput {
	if o == nil || IsNil(o.Audiences) {
		var ret []ReleaserAudienceConfigInput
		return ret
	}
	return o.Audiences
}
...
// SetAudiences gets a reference to the given []ReleaserAudienceConfigInput and assigns it to the Audiences field.
func (o *UpdatePhaseStatusInput) SetAudiences(v []ReleaserAudienceConfigInput) {
	o.Audiences = v
}

func (o UpdatePhaseStatusInput) MarshalJSON() ([]byte, error) {
...
func (o UpdatePhaseStatusInput) ToMap() (map[string]interface{}, error) {
...
func (o *UpdatePhaseStatusInput) UnmarshalJSON(data []byte) (err error) {
	varUpdatePhaseStatusInput := _UpdatePhaseStatusInput{}

	err = json.Unmarshal(data, &varUpdatePhaseStatusInput)

	if err != nil {
		return err
	}

	*o = UpdatePhaseStatusInput(varUpdatePhaseStatusInput)
...
type NullableUpdatePhaseStatusInput struct {
	value *UpdatePhaseStatusInput
	isSet bool
}

func (v NullableUpdatePhaseStatusInput) Get() *UpdatePhaseStatusInput {
	return v.value
}

func (v *NullableUpdatePhaseStatusInput) Set(val *UpdatePhaseStatusInput) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdatePhaseStatusInput) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdatePhaseStatusInput) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdatePhaseStatusInput(val *UpdatePhaseStatusInput) *NullableUpdatePhaseStatusInput {
	return &NullableUpdatePhaseStatusInput{value: val, isSet: true}
}

func (v NullableUpdatePhaseStatusInput) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdatePhaseStatusInput) UnmarshalJSON(src []byte) error {
	v.isSet = true
