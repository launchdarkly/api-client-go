...
// checks if the IntegrationConfigurationsRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationConfigurationsRep{}
...
type IntegrationConfigurationsRep struct {
	...
	SnowflakeSetupScript *string `json:"snowflakeSetupScript,omitempty"`
	// SQL setup scripts (4 parts) for Redshift Native Experimentation setup. Present only for setup endpoint responses.
	RedshiftSetupScripts []string `json:"redshiftSetupScripts,omitempty"`
...
type _IntegrationConfigurationsRep IntegrationConfigurationsRep
...
func (o *IntegrationConfigurationsRep) GetCapabilityConfig() CapabilityConfigRep {
	if o == nil || IsNil(o.CapabilityConfig) {
...
// GetSnowflakeSetupScript returns the SnowflakeSetupScript field value if set, zero value otherwise.
func (o *IntegrationConfigurationsRep) GetSnowflakeSetupScript() string {
	if o == nil || IsNil(o.SnowflakeSetupScript) {
		var ret string
		return ret
	}
	return *o.SnowflakeSetupScript
}

// GetSnowflakeSetupScriptOk returns a tuple with the SnowflakeSetupScript field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IntegrationConfigurationsRep) GetSnowflakeSetupScriptOk() (*string, bool) {
	if o == nil || IsNil(o.SnowflakeSetupScript) {
		return nil, false
	}
	return o.SnowflakeSetupScript, true
}
...
// SetSnowflakeSetupScript gets a reference to the given string and assigns it to the SnowflakeSetupScript field.
func (o *IntegrationConfigurationsRep) SetSnowflakeSetupScript(v string) {
	o.SnowflakeSetupScript = &v
}

// GetRedshiftSetupScripts returns the RedshiftSetupScripts field value if set, zero value otherwise.
func (o *IntegrationConfigurationsRep) GetRedshiftSetupScripts() []string {
	if o == nil || IsNil(o.RedshiftSetupScripts) {
		var ret []string
		return ret
	}
	return o.RedshiftSetupScripts
}

// GetRedshiftSetupScriptsOk returns a tuple with the RedshiftSetupScripts field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IntegrationConfigurationsRep) GetRedshiftSetupScriptsOk() ([]string, bool) {
	if o == nil || IsNil(o.RedshiftSetupScripts) {
		return nil, false
	}
	return o.RedshiftSetupScripts, true
}
...
// SetRedshiftSetupScripts gets a reference to the given []string and assigns it to the RedshiftSetupScripts field.
func (o *IntegrationConfigurationsRep) SetRedshiftSetupScripts(v []string) {
	o.RedshiftSetupScripts = v
}
...
func (o IntegrationConfigurationsRep) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ConfigValues) {
		toSerialize["configValues"] = o.ConfigValues
	}
	if !IsNil(o.CapabilityConfig) {
		toSerialize["capabilityConfig"] = o.CapabilityConfig
	}
	if !IsNil(o.SnowflakeSetupScript) {
		toSerialize["snowflakeSetupScript"] = o.SnowflakeSetupScript
	}
	if !IsNil(o.RedshiftSetupScripts) {
		toSerialize["redshiftSetupScripts"] = o.RedshiftSetupScripts
	}
...
func (o *IntegrationConfigurationsRep) UnmarshalJSON(data []byte) (err error) {
	...
	varIntegrationConfigurationsRep := _IntegrationConfigurationsRep{}

	err = json.Unmarshal(data, &varIntegrationConfigurationsRep)

	if err != nil {
		return err
	}

	*o = IntegrationConfigurationsRep(varIntegrationConfigurationsRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_createdAt")
		delete(additionalProperties, "_integrationKey")
		delete(additionalProperties, "tags")
		delete(additionalProperties, "enabled")
		delete(additionalProperties, "_access")
		delete(additionalProperties, "configValues")
		delete(additionalProperties, "capabilityConfig")
		delete(additionalProperties, "snowflakeSetupScript")
		delete(additionalProperties, "redshiftSetupScripts")
		delete(additionalProperties, "redshiftIAMPermissionsPolicy")
		delete(additionalProperties, "redshiftIAMTrustPolicy")
		delete(additionalProperties, "_maintainerId")
