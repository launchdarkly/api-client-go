...
type FlagLink struct {
	...
	UiBlocks *UIBlocks `json:"uiBlocks,omitempty"`
}
...
// SetEmptyState gets a reference to the given EmptyState and assigns it to the EmptyState field.
...
// GetUiBlocks returns the UiBlocks field value if set, zero value otherwise.
func (o *FlagLink) GetUiBlocks() UIBlocks {
	if o == nil || o.UiBlocks == nil {
		var ret UIBlocks
		return ret
	}
	return *o.UiBlocks
...
// GetUiBlocksOk returns a tuple with the UiBlocks field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FlagLink) GetUiBlocksOk() (*UIBlocks, bool) {
	if o == nil || o.UiBlocks == nil {
		return nil, false
	}
	return o.UiBlocks, true
}
...
// SetUiBlocks gets a reference to the given UIBlocks and assigns it to the UiBlocks field.
func (o *FlagLink) SetUiBlocks(v UIBlocks) {
	o.UiBlocks = &v
}

func (o FlagLink) MarshalJSON() ([]byte, error) {
	...
	if o.UiBlocks != nil {
		toSerialize["uiBlocks"] = o.UiBlocks
	}
	return json.Marshal(toSerialize)
}

type NullableFlagLink struct {
	value *FlagLink
	isSet bool
}

func (v NullableFlagLink) Get() *FlagLink {
	return v.value
}

func (v *NullableFlagLink) Set(val *FlagLink) {
	v.value = val
	v.isSet = true
}

func (v NullableFlagLink) IsSet() bool {
	return v.isSet
}

func (v *NullableFlagLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlagLink(val *FlagLink) *NullableFlagLink {
	return &NullableFlagLink{value: val, isSet: true}
}

func (v NullableFlagLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlagLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
