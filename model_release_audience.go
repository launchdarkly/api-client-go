...
// checks if the ReleaseAudience type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleaseAudience{}
...
type _ReleaseAudience ReleaseAudience
...
func (o ReleaseAudience) ToMap() (map[string]interface{}, error) {
...
func (o *ReleaseAudience) UnmarshalJSON(data []byte) (err error) {
	...
	varReleaseAudience := _ReleaseAudience{}

	err = json.Unmarshal(data, &varReleaseAudience)

	if err != nil {
		return err
	}

	*o = ReleaseAudience(varReleaseAudience)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "segmentKeys")
		delete(additionalProperties, "status")
		delete(additionalProperties, "_ruleIds")
