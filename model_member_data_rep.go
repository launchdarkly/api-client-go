...
// checks if the MemberDataRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MemberDataRep{}
...
type _MemberDataRep MemberDataRep
...
func (o MemberDataRep) ToMap() (map[string]interface{}, error) {
...
func (o *MemberDataRep) UnmarshalJSON(data []byte) (err error) {
	varMemberDataRep := _MemberDataRep{}

	err = json.Unmarshal(data, &varMemberDataRep)

	if err != nil {
		return err
	}

	*o = MemberDataRep(varMemberDataRep)
