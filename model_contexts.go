...
// checks if the Contexts type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Contexts{}
...
func (o Contexts) ToMap() (map[string]interface{}, error) {
...
func (o *Contexts) UnmarshalJSON(data []byte) (err error) {
	...
	varContexts := _Contexts{}

	err = json.Unmarshal(data, &varContexts)

	if err != nil {
		return err
	}

	*o = Contexts(varContexts)
