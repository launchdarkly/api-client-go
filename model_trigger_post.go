...
// checks if the TriggerPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerPost{}
...
func (o TriggerPost) ToMap() (map[string]interface{}, error) {
...
func (o *TriggerPost) UnmarshalJSON(data []byte) (err error) {
	...
	varTriggerPost := _TriggerPost{}

	err = json.Unmarshal(data, &varTriggerPost)

	if err != nil {
		return err
	}

	*o = TriggerPost(varTriggerPost)
