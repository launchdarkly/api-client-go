...
// checks if the FailureReasonRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FailureReasonRep{}

// FailureReasonRep struct for FailureReasonRep
type FailureReasonRep struct {
...
type _FailureReasonRep FailureReasonRep
...
func (o FailureReasonRep) ToMap() (map[string]interface{}, error) {
...
func (o *FailureReasonRep) UnmarshalJSON(data []byte) (err error) {
	...
	varFailureReasonRep := _FailureReasonRep{}

	err = json.Unmarshal(data, &varFailureReasonRep)

	if err != nil {
		return err
	}

	*o = FailureReasonRep(varFailureReasonRep)
...
func NewNullableFailureReasonRep(val *FailureReasonRep) *NullableFailureReasonRep {
	return &NullableFailureReasonRep{value: val, isSet: true}
}
