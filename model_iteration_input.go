...
// checks if the IterationInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IterationInput{}
...
type IterationInput struct {
	...
	CovariateId *string `json:"covariateId,omitempty"`
	// The attributes that this iteration's results can be sliced by
	Attributes []string `json:"attributes,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _IterationInput IterationInput
...
func (o *IterationInput) GetPrimarySingleMetricKey() string {
	if o == nil || IsNil(o.PrimarySingleMetricKey) {
		var ret string
		return ret
	}
...
func (o *IterationInput) GetPrimaryFunnelKey() string {
	if o == nil || IsNil(o.PrimaryFunnelKey) {
		var ret string
		return ret
	}
...
// GetCovariateId returns the CovariateId field value if set, zero value otherwise.
func (o *IterationInput) GetCovariateId() string {
	if o == nil || IsNil(o.CovariateId) {
		var ret string
		return ret
	}
	return *o.CovariateId
}

// GetCovariateIdOk returns a tuple with the CovariateId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IterationInput) GetCovariateIdOk() (*string, bool) {
	if o == nil || IsNil(o.CovariateId) {
		return nil, false
	}
	return o.CovariateId, true
}
...
// SetCovariateId gets a reference to the given string and assigns it to the CovariateId field.
...
func (o IterationInput) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PrimarySingleMetricKey) {
		toSerialize["primarySingleMetricKey"] = o.PrimarySingleMetricKey
	}
	if !IsNil(o.PrimaryFunnelKey) {
	...
	if !IsNil(o.CovariateId) {
		toSerialize["covariateId"] = o.CovariateId
	}
...
func (o *IterationInput) UnmarshalJSON(data []byte) (err error) {
	...
	varIterationInput := _IterationInput{}

	err = json.Unmarshal(data, &varIterationInput)

	if err != nil {
		return err
	}

	*o = IterationInput(varIterationInput)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "primarySingleMetricKey")
		delete(additionalProperties, "primaryFunnelKey")
		...
		delete(additionalProperties, "covariateId")
