...
// checks if the AiConfigsFilter type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsFilter{}

// AiConfigsFilter struct for AiConfigsFilter
type AiConfigsFilter struct {
...
type _AiConfigsFilter AiConfigsFilter
...
func (o AiConfigsFilter) MarshalJSON() ([]byte, error) {
...
func (o AiConfigsFilter) ToMap() (map[string]interface{}, error) {
...
func (o *AiConfigsFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varAiConfigsFilter := _AiConfigsFilter{}

	err = json.Unmarshal(data, &varAiConfigsFilter)

	if err != nil {
		return err
	}

	*o = AiConfigsFilter(varAiConfigsFilter)
...
type NullableAiConfigsFilter struct {
	value *AiConfigsFilter
	isSet bool
}

func (v NullableAiConfigsFilter) Get() *AiConfigsFilter {
	return v.value
}

func (v *NullableAiConfigsFilter) Set(val *AiConfigsFilter) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsFilter) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsFilter) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsFilter(val *AiConfigsFilter) *NullableAiConfigsFilter {
	return &NullableAiConfigsFilter{value: val, isSet: true}
}

func (v NullableAiConfigsFilter) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsFilter) UnmarshalJSON(src []byte) error {
	v.isSet = true
