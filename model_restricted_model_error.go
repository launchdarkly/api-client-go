...
// checks if the RestrictedModelError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestrictedModelError{}

// RestrictedModelError struct for RestrictedModelError
type RestrictedModelError struct {
	Key string `json:"key"`
...
type _RestrictedModelError RestrictedModelError
...
func (o RestrictedModelError) MarshalJSON() ([]byte, error) {
...
func (o RestrictedModelError) ToMap() (map[string]interface{}, error) {
...
func (o *RestrictedModelError) UnmarshalJSON(data []byte) (err error) {
	...
	varRestrictedModelError := _RestrictedModelError{}

	err = json.Unmarshal(data, &varRestrictedModelError)

	if err != nil {
		return err
	}

	*o = RestrictedModelError(varRestrictedModelError)
...
type NullableRestrictedModelError struct {
	value *RestrictedModelError
	isSet bool
}

func (v NullableRestrictedModelError) Get() *RestrictedModelError {
	return v.value
}

func (v *NullableRestrictedModelError) Set(val *RestrictedModelError) {
	v.value = val
	v.isSet = true
}

func (v NullableRestrictedModelError) IsSet() bool {
	return v.isSet
}

func (v *NullableRestrictedModelError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestrictedModelError(val *RestrictedModelError) *NullableRestrictedModelError {
	return &NullableRestrictedModelError{value: val, isSet: true}
}

func (v NullableRestrictedModelError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestrictedModelError) UnmarshalJSON(src []byte) error {
	v.isSet = true
