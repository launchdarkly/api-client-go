...
// UIBlocks struct for UIBlocks
type UIBlocks struct {
	Context *FlagLinkContext `json:"context,omitempty"`
...
// SetContext gets a reference to the given FlagLinkContext and assigns it to the Context field.
...
func (o UIBlocks) MarshalJSON() ([]byte, error) {
...
type NullableUIBlocks struct {
	value *UIBlocks
	isSet bool
}

func (v NullableUIBlocks) Get() *UIBlocks {
	return v.value
}

func (v *NullableUIBlocks) Set(val *UIBlocks) {
	v.value = val
	v.isSet = true
}

func (v NullableUIBlocks) IsSet() bool {
	return v.isSet
}

func (v *NullableUIBlocks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUIBlocks(val *UIBlocks) *NullableUIBlocks {
	return &NullableUIBlocks{value: val, isSet: true}
}

func (v NullableUIBlocks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUIBlocks) UnmarshalJSON(src []byte) error {
	v.isSet = true
