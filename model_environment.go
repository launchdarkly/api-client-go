...
func (o *Environment) GetResourceApprovalSettings() map[string]ApprovalSettings {
	if o == nil || IsNil(o.ResourceApprovalSettings) {
...
func (o Environment) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ResourceApprovalSettings) {
...
func (o *Environment) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Environment(varEnvironment)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "mobileKey")
		...
		delete(additionalProperties, "resourceApprovalSettings")
