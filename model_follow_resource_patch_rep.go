...
// FollowResourcePatchRep struct for FollowResourcePatchRep
type FollowResourcePatchRep struct {
	Links map[string]Link `json:"_links"`
	FlagKey string `json:"flagKey"`
	ProjectKey *string `json:"projectKey,omitempty"`
	EnvironmentKey *string `json:"environmentKey,omitempty"`
	Followers []FollowFlagMember `json:"followers"`
...
func (o FollowResourcePatchRep) MarshalJSON() ([]byte, error) {
...
type NullableFollowResourcePatchRep struct {
	value *FollowResourcePatchRep
	isSet bool
}

func (v NullableFollowResourcePatchRep) Get() *FollowResourcePatchRep {
	return v.value
}

func (v *NullableFollowResourcePatchRep) Set(val *FollowResourcePatchRep) {
	v.value = val
	v.isSet = true
}

func (v NullableFollowResourcePatchRep) IsSet() bool {
	return v.isSet
}

func (v *NullableFollowResourcePatchRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFollowResourcePatchRep(val *FollowResourcePatchRep) *NullableFollowResourcePatchRep {
	return &NullableFollowResourcePatchRep{value: val, isSet: true}
}

func (v NullableFollowResourcePatchRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFollowResourcePatchRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
