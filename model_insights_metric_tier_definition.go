...
// checks if the InsightsMetricTierDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightsMetricTierDefinition{}

// InsightsMetricTierDefinition struct for InsightsMetricTierDefinition
type InsightsMetricTierDefinition struct {
...
type _InsightsMetricTierDefinition InsightsMetricTierDefinition
...
func NewInsightsMetricTierDefinition(indicator string, description string) *InsightsMetricTierDefinition {
	this := InsightsMetricTierDefinition{}
...
func (o InsightsMetricTierDefinition) ToMap() (map[string]interface{}, error) {
...
func (o *InsightsMetricTierDefinition) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightsMetricTierDefinition := _InsightsMetricTierDefinition{}

	err = json.Unmarshal(data, &varInsightsMetricTierDefinition)

	if err != nil {
		return err
	}

	*o = InsightsMetricTierDefinition(varInsightsMetricTierDefinition)
...
type NullableInsightsMetricTierDefinition struct {
	value *InsightsMetricTierDefinition
	isSet bool
}
...
func NewNullableInsightsMetricTierDefinition(val *InsightsMetricTierDefinition) *NullableInsightsMetricTierDefinition {
	return &NullableInsightsMetricTierDefinition{value: val, isSet: true}
}
