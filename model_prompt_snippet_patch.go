...
// checks if the PromptSnippetPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromptSnippetPatch{}

// PromptSnippetPatch struct for PromptSnippetPatch
type PromptSnippetPatch struct {
...
type _PromptSnippetPatch PromptSnippetPatch

// NewPromptSnippetPatch instantiates a new PromptSnippetPatch object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPromptSnippetPatch() *PromptSnippetPatch {
	this := PromptSnippetPatch{}
	return &this
}

// NewPromptSnippetPatchWithDefaults instantiates a new PromptSnippetPatch object
...
func (o PromptSnippetPatch) MarshalJSON() ([]byte, error) {
...
func (o PromptSnippetPatch) ToMap() (map[string]interface{}, error) {
...
func (o *PromptSnippetPatch) UnmarshalJSON(data []byte) (err error) {
	varPromptSnippetPatch := _PromptSnippetPatch{}

	err = json.Unmarshal(data, &varPromptSnippetPatch)

	if err != nil {
		return err
	}

	*o = PromptSnippetPatch(varPromptSnippetPatch)
...
type NullablePromptSnippetPatch struct {
	value *PromptSnippetPatch
	isSet bool
}

func (v NullablePromptSnippetPatch) Get() *PromptSnippetPatch {
	return v.value
}

func (v *NullablePromptSnippetPatch) Set(val *PromptSnippetPatch) {
	v.value = val
	v.isSet = true
}

func (v NullablePromptSnippetPatch) IsSet() bool {
	return v.isSet
}

func (v *NullablePromptSnippetPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromptSnippetPatch(val *PromptSnippetPatch) *NullablePromptSnippetPatch {
	return &NullablePromptSnippetPatch{value: val, isSet: true}
}

func (v NullablePromptSnippetPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromptSnippetPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
