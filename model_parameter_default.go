...
// checks if the ParameterDefault type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParameterDefault{}
...
type _ParameterDefault ParameterDefault
...
func (o *ParameterDefault) GetBooleanVariationValue() bool {
	if o == nil || IsNil(o.BooleanVariationValue) {
		var ret bool
		return ret
	}
...
func (o ParameterDefault) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if o.Value != nil {
		toSerialize["value"] = o.Value
	}
	if !IsNil(o.BooleanVariationValue) {
		toSerialize["booleanVariationValue"] = o.BooleanVariationValue
	}
	if !IsNil(o.RuleClause) {
...
func (o *ParameterDefault) UnmarshalJSON(data []byte) (err error) {
	varParameterDefault := _ParameterDefault{}

	err = json.Unmarshal(data, &varParameterDefault)

	if err != nil {
		return err
	}

	*o = ParameterDefault(varParameterDefault)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "value")
		delete(additionalProperties, "booleanVariationValue")
		delete(additionalProperties, "ruleClause")
