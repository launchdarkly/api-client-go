...
// checks if the ExperimentPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExperimentPost{}
...
type ExperimentPost struct {
	...
	AnalysisConfig *AnalysisConfigInput `json:"analysisConfig,omitempty"`
...
type _ExperimentPost ExperimentPost
...
// SetAnalysisConfig gets a reference to the given AnalysisConfigInput and assigns it to the AnalysisConfig field.
...
func (o ExperimentPost) ToMap() (map[string]interface{}, error) {
...
func (o *ExperimentPost) UnmarshalJSON(data []byte) (err error) {
	...
	varExperimentPost := _ExperimentPost{}

	err = json.Unmarshal(data, &varExperimentPost)

	if err != nil {
		return err
	}

	*o = ExperimentPost(varExperimentPost)
