...
// checks if the EvaluationReason type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EvaluationReason{}
...
type _EvaluationReason EvaluationReason
...
func (o EvaluationReason) ToMap() (map[string]interface{}, error) {
...
func (o *EvaluationReason) UnmarshalJSON(data []byte) (err error) {
	...
	varEvaluationReason := _EvaluationReason{}

	err = json.Unmarshal(data, &varEvaluationReason)

	if err != nil {
		return err
	}

	*o = EvaluationReason(varEvaluationReason)
