...
// ApprovalParser struct for ApprovalParser
type ApprovalParser struct {
	ApprovalId *string `json:"approvalId,omitempty"`
	ApprovalMatcher *string `json:"approvalMatcher,omitempty"`
	RejectionMatcher *string `json:"rejectionMatcher,omitempty"`
...
// GetApprovalMatcher returns the ApprovalMatcher field value if set, zero value otherwise.
func (o *ApprovalParser) GetApprovalMatcher() string {
	if o == nil || o.ApprovalMatcher == nil {
		var ret string
		return ret
	}
	return *o.ApprovalMatcher
}

// GetApprovalMatcherOk returns a tuple with the ApprovalMatcher field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApprovalParser) GetApprovalMatcherOk() (*string, bool) {
	if o == nil || o.ApprovalMatcher == nil {
		return nil, false
	}
	return o.ApprovalMatcher, true
}
...
// SetApprovalMatcher gets a reference to the given string and assigns it to the ApprovalMatcher field.
func (o *ApprovalParser) SetApprovalMatcher(v string) {
	o.ApprovalMatcher = &v
}

// GetRejectionMatcher returns the RejectionMatcher field value if set, zero value otherwise.
func (o *ApprovalParser) GetRejectionMatcher() string {
	if o == nil || o.RejectionMatcher == nil {
		var ret string
		return ret
	}
	return *o.RejectionMatcher
}

// GetRejectionMatcherOk returns a tuple with the RejectionMatcher field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ApprovalParser) GetRejectionMatcherOk() (*string, bool) {
	if o == nil || o.RejectionMatcher == nil {
		return nil, false
	}
	return o.RejectionMatcher, true
}
...
// SetRejectionMatcher gets a reference to the given string and assigns it to the RejectionMatcher field.
func (o *ApprovalParser) SetRejectionMatcher(v string) {
	o.RejectionMatcher = &v
}
...
func (o ApprovalParser) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	if o.ApprovalId != nil {
		toSerialize["approvalId"] = o.ApprovalId
	}
	if o.ApprovalMatcher != nil {
		toSerialize["approvalMatcher"] = o.ApprovalMatcher
	}
	if o.RejectionMatcher != nil {
		toSerialize["rejectionMatcher"] = o.RejectionMatcher
	}
	if o.StatusDisplay != nil {
		toSerialize["statusDisplay"] = o.StatusDisplay
	}
	if o.StatusValue != nil {
		toSerialize["statusValue"] = o.StatusValue
	}
	if o.UrlTemplate != nil {
		toSerialize["urlTemplate"] = o.UrlTemplate
	}
	return json.Marshal(toSerialize)
}

type NullableApprovalParser struct {
	value *ApprovalParser
	isSet bool
}

func (v NullableApprovalParser) Get() *ApprovalParser {
	return v.value
}

func (v *NullableApprovalParser) Set(val *ApprovalParser) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalParser) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalParser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalParser(val *ApprovalParser) *NullableApprovalParser {
	return &NullableApprovalParser{value: val, isSet: true}
}

func (v NullableApprovalParser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalParser) UnmarshalJSON(src []byte) error {
	v.isSet = true
