...
// checks if the FlagEventCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagEventCollectionRep{}
...
type _FlagEventCollectionRep FlagEventCollectionRep
...
func (o FlagEventCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *FlagEventCollectionRep) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagEventCollectionRep := _FlagEventCollectionRep{}

	err = json.Unmarshal(data, &varFlagEventCollectionRep)

	if err != nil {
		return err
	}

	*o = FlagEventCollectionRep(varFlagEventCollectionRep)
