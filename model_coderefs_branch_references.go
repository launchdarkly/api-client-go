...
// CoderefsBranchReferences struct for CoderefsBranchReferences
type CoderefsBranchReferences struct {
	Path *string `json:"path,omitempty"`
	Hint *string `json:"hint,omitempty"`
	Hunks *[]CoderefsHunk `json:"hunks,omitempty"`
}
...
// SetHunks gets a reference to the given []CoderefsHunk and assigns it to the Hunks field.
func (o *CoderefsBranchReferences) SetHunks(v []CoderefsHunk) {
	o.Hunks = &v
}

func (o CoderefsBranchReferences) MarshalJSON() ([]byte, error) {
...
type NullableCoderefsBranchReferences struct {
	value *CoderefsBranchReferences
	isSet bool
}

func (v NullableCoderefsBranchReferences) Get() *CoderefsBranchReferences {
	return v.value
}

func (v *NullableCoderefsBranchReferences) Set(val *CoderefsBranchReferences) {
	v.value = val
	v.isSet = true
}

func (v NullableCoderefsBranchReferences) IsSet() bool {
	return v.isSet
}

func (v *NullableCoderefsBranchReferences) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoderefsBranchReferences(val *CoderefsBranchReferences) *NullableCoderefsBranchReferences {
	return &NullableCoderefsBranchReferences{value: val, isSet: true}
}

func (v NullableCoderefsBranchReferences) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoderefsBranchReferences) UnmarshalJSON(src []byte) error {
	v.isSet = true
