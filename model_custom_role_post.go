...
// checks if the CustomRolePost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CustomRolePost{}
...
type _CustomRolePost CustomRolePost
...
func (o *CustomRolePost) GetResourceCategory() string {
	if o == nil || IsNil(o.ResourceCategory) {
		var ret string
		return ret
	}
...
func (o CustomRolePost) ToMap() (map[string]interface{}, error) {
...
func (o *CustomRolePost) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomRolePost := _CustomRolePost{}

	err = json.Unmarshal(data, &varCustomRolePost)

	if err != nil {
		return err
	}

	*o = CustomRolePost(varCustomRolePost)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "basePermissions")
		delete(additionalProperties, "resourceCategory")
