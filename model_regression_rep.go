...
// RegressionRep struct for RegressionRep
type RegressionRep struct {
...
func (o RegressionRep) MarshalJSON() ([]byte, error) {
...
type NullableRegressionRep struct {
	value *RegressionRep
	isSet bool
}

func (v NullableRegressionRep) Get() *RegressionRep {
	return v.value
}

func (v *NullableRegressionRep) Set(val *RegressionRep) {
	v.value = val
	v.isSet = true
}

func (v NullableRegressionRep) IsSet() bool {
	return v.isSet
}

func (v *NullableRegressionRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegressionRep(val *RegressionRep) *NullableRegressionRep {
	return &NullableRegressionRep{value: val, isSet: true}
}

func (v NullableRegressionRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegressionRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
