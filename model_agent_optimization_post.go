...
// checks if the AgentOptimizationPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentOptimizationPost{}

// AgentOptimizationPost struct for AgentOptimizationPost
type AgentOptimizationPost struct {
	Key string `json:"key"`
	AiConfigKey string `json:"aiConfigKey"`
	MaxAttempts int32 `json:"maxAttempts"`
	ModelChoices []string `json:"modelChoices,omitempty"`
	JudgeModel string `json:"judgeModel"`
	VariableChoices []map[string]interface{} `json:"variableChoices,omitempty"`
	AcceptanceStatements []AgentOptimizationAcceptanceStatement `json:"acceptanceStatements,omitempty"`
	Judges []AgentOptimizationJudge `json:"judges,omitempty"`
	UserInputOptions []string `json:"userInputOptions,omitempty"`
	GroundTruthResponses []string `json:"groundTruthResponses,omitempty"`
	...
	LatencyOptimization *bool `json:"latencyOptimization,omitempty"`
	TokenOptimization *bool `json:"tokenOptimization,omitempty"`
	AutoCommit *bool `json:"autoCommit,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AgentOptimizationPost AgentOptimizationPost
...
// GetAiConfigKey returns the AiConfigKey field value
func (o *AgentOptimizationPost) GetAiConfigKey() string {
	...
	return o.AiConfigKey
}

// GetAiConfigKeyOk returns a tuple with the AiConfigKey field value
// and a boolean to check if the value has been set.
func (o *AgentOptimizationPost) GetAiConfigKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.AiConfigKey, true
}

// SetAiConfigKey sets field value
...
// GetModelChoices returns the ModelChoices field value if set, zero value otherwise.
func (o *AgentOptimizationPost) GetModelChoices() []string {
	if o == nil || IsNil(o.ModelChoices) {
		var ret []string
		return ret
	}
	return o.ModelChoices
}

// GetModelChoicesOk returns a tuple with the ModelChoices field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AgentOptimizationPost) GetModelChoicesOk() ([]string, bool) {
	if o == nil || IsNil(o.ModelChoices) {
		return nil, false
	}
	return o.ModelChoices, true
}
...
// SetModelChoices gets a reference to the given []string and assigns it to the ModelChoices field.
...
// GetVariableChoices returns the VariableChoices field value if set, zero value otherwise.
func (o *AgentOptimizationPost) GetVariableChoices() []map[string]interface{} {
	if o == nil || IsNil(o.VariableChoices) {
		var ret []map[string]interface{}
		return ret
	}
	return o.VariableChoices
}

// GetVariableChoicesOk returns a tuple with the VariableChoices field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AgentOptimizationPost) GetVariableChoicesOk() ([]map[string]interface{}, bool) {
	if o == nil || IsNil(o.VariableChoices) {
		return nil, false
	}
	return o.VariableChoices, true
}
...
// SetVariableChoices gets a reference to the given []map[string]interface{} and assigns it to the VariableChoices field.
func (o *AgentOptimizationPost) SetVariableChoices(v []map[string]interface{}) {
	o.VariableChoices = v
}

// GetAcceptanceStatements returns the AcceptanceStatements field value if set, zero value otherwise.
func (o *AgentOptimizationPost) GetAcceptanceStatements() []AgentOptimizationAcceptanceStatement {
	if o == nil || IsNil(o.AcceptanceStatements) {
		var ret []AgentOptimizationAcceptanceStatement
		return ret
	}
	return o.AcceptanceStatements
}

// GetAcceptanceStatementsOk returns a tuple with the AcceptanceStatements field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AgentOptimizationPost) GetAcceptanceStatementsOk() ([]AgentOptimizationAcceptanceStatement, bool) {
	if o == nil || IsNil(o.AcceptanceStatements) {
		return nil, false
	}
	return o.AcceptanceStatements, true
}
...
// SetAcceptanceStatements gets a reference to the given []AgentOptimizationAcceptanceStatement and assigns it to the AcceptanceStatements field.
func (o *AgentOptimizationPost) SetAcceptanceStatements(v []AgentOptimizationAcceptanceStatement) {
	o.AcceptanceStatements = v
}
...
func (o *AgentOptimizationPost) GetJudges() []AgentOptimizationJudge {
	if o == nil || IsNil(o.Judges) {
		var ret []AgentOptimizationJudge
		return ret
	}
	return o.Judges
}
...
// SetJudges gets a reference to the given []AgentOptimizationJudge and assigns it to the Judges field.
func (o *AgentOptimizationPost) SetJudges(v []AgentOptimizationJudge) {
	o.Judges = v
}

// GetUserInputOptions returns the UserInputOptions field value if set, zero value otherwise.
func (o *AgentOptimizationPost) GetUserInputOptions() []string {
	if o == nil || IsNil(o.UserInputOptions) {
		var ret []string
		return ret
	}
	return o.UserInputOptions
}

// GetUserInputOptionsOk returns a tuple with the UserInputOptions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AgentOptimizationPost) GetUserInputOptionsOk() ([]string, bool) {
	if o == nil || IsNil(o.UserInputOptions) {
		return nil, false
	}
	return o.UserInputOptions, true
}
...
// SetUserInputOptions gets a reference to the given []string and assigns it to the UserInputOptions field.
func (o *AgentOptimizationPost) SetUserInputOptions(v []string) {
	o.UserInputOptions = v
}

// GetGroundTruthResponses returns the GroundTruthResponses field value if set, zero value otherwise.
func (o *AgentOptimizationPost) GetGroundTruthResponses() []string {
	if o == nil || IsNil(o.GroundTruthResponses) {
		var ret []string
		return ret
	}
	return o.GroundTruthResponses
}

// GetGroundTruthResponsesOk returns a tuple with the GroundTruthResponses field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AgentOptimizationPost) GetGroundTruthResponsesOk() ([]string, bool) {
	if o == nil || IsNil(o.GroundTruthResponses) {
		return nil, false
	}
	return o.GroundTruthResponses, true
}
...
// SetGroundTruthResponses gets a reference to the given []string and assigns it to the GroundTruthResponses field.
func (o *AgentOptimizationPost) SetGroundTruthResponses(v []string) {
	o.GroundTruthResponses = v
}
...
// GetVariationKey returns the VariationKey field value if set, zero value otherwise.
func (o *AgentOptimizationPost) GetVariationKey() string {
	if o == nil || IsNil(o.VariationKey) {
		var ret string
		return ret
	}
...
// GetVariationKeyOk returns a tuple with the VariationKey field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AgentOptimizationPost) GetVariationKeyOk() (*string, bool) {
	if o == nil || IsNil(o.VariationKey) {
		return nil, false
	}
	return o.VariationKey, true
}
...
// SetVariationKey gets a reference to the given string and assigns it to the VariationKey field.
...
// GetLatencyOptimization returns the LatencyOptimization field value if set, zero value otherwise.
func (o *AgentOptimizationPost) GetLatencyOptimization() bool {
	if o == nil || IsNil(o.LatencyOptimization) {
		var ret bool
		return ret
	}
	return *o.LatencyOptimization
}

// GetLatencyOptimizationOk returns a tuple with the LatencyOptimization field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AgentOptimizationPost) GetLatencyOptimizationOk() (*bool, bool) {
	if o == nil || IsNil(o.LatencyOptimization) {
		return nil, false
	}
	return o.LatencyOptimization, true
}
...
// SetLatencyOptimization gets a reference to the given bool and assigns it to the LatencyOptimization field.
func (o *AgentOptimizationPost) SetLatencyOptimization(v bool) {
	o.LatencyOptimization = &v
}

// GetTokenOptimization returns the TokenOptimization field value if set, zero value otherwise.
func (o *AgentOptimizationPost) GetTokenOptimization() bool {
	if o == nil || IsNil(o.TokenOptimization) {
		var ret bool
		return ret
	}
	return *o.TokenOptimization
}

// GetTokenOptimizationOk returns a tuple with the TokenOptimization field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AgentOptimizationPost) GetTokenOptimizationOk() (*bool, bool) {
	if o == nil || IsNil(o.TokenOptimization) {
		return nil, false
	}
	return o.TokenOptimization, true
}
...
// SetTokenOptimization gets a reference to the given bool and assigns it to the TokenOptimization field.
func (o *AgentOptimizationPost) SetTokenOptimization(v bool) {
	o.TokenOptimization = &v
}
...
func (o AgentOptimizationPost) MarshalJSON() ([]byte, error) {
...
func (o AgentOptimizationPost) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["key"] = o.Key
	toSerialize["aiConfigKey"] = o.AiConfigKey
	toSerialize["maxAttempts"] = o.MaxAttempts
	if !IsNil(o.ModelChoices) {
		toSerialize["modelChoices"] = o.ModelChoices
	}
	toSerialize["judgeModel"] = o.JudgeModel
	if !IsNil(o.VariableChoices) {
		toSerialize["variableChoices"] = o.VariableChoices
	}
	if !IsNil(o.AcceptanceStatements) {
		toSerialize["acceptanceStatements"] = o.AcceptanceStatements
	}
	if !IsNil(o.Judges) {
		toSerialize["judges"] = o.Judges
	}
	if !IsNil(o.UserInputOptions) {
		toSerialize["userInputOptions"] = o.UserInputOptions
	}
	if !IsNil(o.GroundTruthResponses) {
		toSerialize["groundTruthResponses"] = o.GroundTruthResponses
	}
	...
	if !IsNil(o.VariationKey) {
		toSerialize["variationKey"] = o.VariationKey
	}
	if !IsNil(o.Label) {
		toSerialize["label"] = o.Label
	}
	if !IsNil(o.LatencyOptimization) {
		toSerialize["latencyOptimization"] = o.LatencyOptimization
	}
	if !IsNil(o.TokenOptimization) {
		toSerialize["tokenOptimization"] = o.TokenOptimization
	}
...
func (o *AgentOptimizationPost) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentOptimizationPost := _AgentOptimizationPost{}

	err = json.Unmarshal(data, &varAgentOptimizationPost)

	if err != nil {
		return err
	}

	*o = AgentOptimizationPost(varAgentOptimizationPost)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "key")
		delete(additionalProperties, "aiConfigKey")
		delete(additionalProperties, "maxAttempts")
		delete(additionalProperties, "modelChoices")
		delete(additionalProperties, "judgeModel")
		delete(additionalProperties, "variableChoices")
		delete(additionalProperties, "acceptanceStatements")
		delete(additionalProperties, "judges")
		delete(additionalProperties, "userInputOptions")
		delete(additionalProperties, "groundTruthResponses")
		delete(additionalProperties, "metricKey")
		delete(additionalProperties, "tokenLimit")
		delete(additionalProperties, "variationKey")
		delete(additionalProperties, "label")
		delete(additionalProperties, "latencyOptimization")
		delete(additionalProperties, "tokenOptimization")
		delete(additionalProperties, "autoCommit")
...
type NullableAgentOptimizationPost struct {
	value *AgentOptimizationPost
	isSet bool
}

func (v NullableAgentOptimizationPost) Get() *AgentOptimizationPost {
	return v.value
}

func (v *NullableAgentOptimizationPost) Set(val *AgentOptimizationPost) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentOptimizationPost) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentOptimizationPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentOptimizationPost(val *AgentOptimizationPost) *NullableAgentOptimizationPost {
	return &NullableAgentOptimizationPost{value: val, isSet: true}
}

func (v NullableAgentOptimizationPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentOptimizationPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
