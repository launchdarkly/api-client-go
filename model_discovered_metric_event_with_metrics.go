...
// DiscoveredMetricEventWithMetrics struct for DiscoveredMetricEventWithMetrics
type DiscoveredMetricEventWithMetrics struct {
	EventKey string `json:"eventKey"`
	IsNumeric bool `json:"isNumeric"`
	Count int32 `json:"count"`
	FirstSeen int64 `json:"firstSeen"`
	LastSeen int64 `json:"lastSeen"`
	Metrics []MetricListingRep `json:"metrics"`
}
...
func NewDiscoveredMetricEventWithMetrics(eventKey string, isNumeric bool, count int32, firstSeen int64, lastSeen int64, metrics []MetricListingRep) *DiscoveredMetricEventWithMetrics {
	this := DiscoveredMetricEventWithMetrics{}
...
func (o DiscoveredMetricEventWithMetrics) MarshalJSON() ([]byte, error) {
...
type NullableDiscoveredMetricEventWithMetrics struct {
	value *DiscoveredMetricEventWithMetrics
	isSet bool
}

func (v NullableDiscoveredMetricEventWithMetrics) Get() *DiscoveredMetricEventWithMetrics {
	return v.value
}

func (v *NullableDiscoveredMetricEventWithMetrics) Set(val *DiscoveredMetricEventWithMetrics) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscoveredMetricEventWithMetrics) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscoveredMetricEventWithMetrics) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscoveredMetricEventWithMetrics(val *DiscoveredMetricEventWithMetrics) *NullableDiscoveredMetricEventWithMetrics {
	return &NullableDiscoveredMetricEventWithMetrics{value: val, isSet: true}
}

func (v NullableDiscoveredMetricEventWithMetrics) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscoveredMetricEventWithMetrics) UnmarshalJSON(src []byte) error {
	v.isSet = true
