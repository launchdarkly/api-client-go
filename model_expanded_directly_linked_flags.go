...
// checks if the ExpandedDirectlyLinkedFlags type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedDirectlyLinkedFlags{}

// ExpandedDirectlyLinkedFlags struct for ExpandedDirectlyLinkedFlags
type ExpandedDirectlyLinkedFlags struct {
	Items []ExpandedDirectlyLinkedFlag `json:"items"`
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _ExpandedDirectlyLinkedFlags ExpandedDirectlyLinkedFlags
...
func NewExpandedDirectlyLinkedFlags(items []ExpandedDirectlyLinkedFlag, totalCount int32) *ExpandedDirectlyLinkedFlags {
	this := ExpandedDirectlyLinkedFlags{}
	this.Items = items
...
func (o *ExpandedDirectlyLinkedFlags) GetItems() []ExpandedDirectlyLinkedFlag {
	if o == nil {
		var ret []ExpandedDirectlyLinkedFlag
		return ret
	}
...
func (o ExpandedDirectlyLinkedFlags) MarshalJSON() ([]byte, error) {
...
func (o ExpandedDirectlyLinkedFlags) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedDirectlyLinkedFlags) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedDirectlyLinkedFlags := _ExpandedDirectlyLinkedFlags{}

	err = json.Unmarshal(data, &varExpandedDirectlyLinkedFlags)

	if err != nil {
		return err
	}

	*o = ExpandedDirectlyLinkedFlags(varExpandedDirectlyLinkedFlags)
...
type NullableExpandedDirectlyLinkedFlags struct {
	value *ExpandedDirectlyLinkedFlags
	isSet bool
}

func (v NullableExpandedDirectlyLinkedFlags) Get() *ExpandedDirectlyLinkedFlags {
	return v.value
}

func (v *NullableExpandedDirectlyLinkedFlags) Set(val *ExpandedDirectlyLinkedFlags) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedDirectlyLinkedFlags) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedDirectlyLinkedFlags) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedDirectlyLinkedFlags(val *ExpandedDirectlyLinkedFlags) *NullableExpandedDirectlyLinkedFlags {
	return &NullableExpandedDirectlyLinkedFlags{value: val, isSet: true}
}

func (v NullableExpandedDirectlyLinkedFlags) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedDirectlyLinkedFlags) UnmarshalJSON(src []byte) error {
	v.isSet = true
