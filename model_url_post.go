...
// checks if the UrlPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UrlPost{}
...
func (o UrlPost) ToMap() (map[string]interface{}, error) {
...
func (o *UrlPost) UnmarshalJSON(data []byte) (err error) {
	varUrlPost := _UrlPost{}

	err = json.Unmarshal(data, &varUrlPost)

	if err != nil {
		return err
	}

	*o = UrlPost(varUrlPost)
