...
// checks if the FlagReferenceRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagReferenceRep{}
...
type _FlagReferenceRep FlagReferenceRep
...
func (o FlagReferenceRep) ToMap() (map[string]interface{}, error) {
...
func (o *FlagReferenceRep) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagReferenceRep := _FlagReferenceRep{}

	err = json.Unmarshal(data, &varFlagReferenceRep)

	if err != nil {
		return err
	}

	*o = FlagReferenceRep(varFlagReferenceRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "referencesAdded")
		delete(additionalProperties, "referencesRemoved")
