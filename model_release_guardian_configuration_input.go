...
// checks if the ReleaseGuardianConfigurationInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleaseGuardianConfigurationInput{}
...
type _ReleaseGuardianConfigurationInput ReleaseGuardianConfigurationInput
...
func (o *ReleaseGuardianConfigurationInput) GetMonitoringWindowMilliseconds() int64 {
	if o == nil || IsNil(o.MonitoringWindowMilliseconds) {
		var ret int64
		return ret
	}
...
func (o *ReleaseGuardianConfigurationInput) GetRolloutWeight() int32 {
	if o == nil || IsNil(o.RolloutWeight) {
		var ret int32
		return ret
	}
...
func (o ReleaseGuardianConfigurationInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.MonitoringWindowMilliseconds) {
		toSerialize["monitoringWindowMilliseconds"] = o.MonitoringWindowMilliseconds
	}
	if !IsNil(o.RolloutWeight) {
...
func (o *ReleaseGuardianConfigurationInput) UnmarshalJSON(data []byte) (err error) {
	varReleaseGuardianConfigurationInput := _ReleaseGuardianConfigurationInput{}

	err = json.Unmarshal(data, &varReleaseGuardianConfigurationInput)

	if err != nil {
		return err
	}

	*o = ReleaseGuardianConfigurationInput(varReleaseGuardianConfigurationInput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "monitoringWindowMilliseconds")
		delete(additionalProperties, "rolloutWeight")
