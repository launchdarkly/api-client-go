...
// checks if the ExpiringTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpiringTarget{}
...
type _ExpiringTarget ExpiringTarget
...
func (o ExpiringTarget) ToMap() (map[string]interface{}, error) {
...
func (o *ExpiringTarget) UnmarshalJSON(data []byte) (err error) {
	...
	varExpiringTarget := _ExpiringTarget{}

	err = json.Unmarshal(data, &varExpiringTarget)

	if err != nil {
		return err
	}

	*o = ExpiringTarget(varExpiringTarget)
