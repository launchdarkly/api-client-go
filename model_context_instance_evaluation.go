...
// checks if the ContextInstanceEvaluation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextInstanceEvaluation{}
...
type _ContextInstanceEvaluation ContextInstanceEvaluation
...
func (o ContextInstanceEvaluation) ToMap() (map[string]interface{}, error) {
...
func (o *ContextInstanceEvaluation) UnmarshalJSON(data []byte) (err error) {
	...
	varContextInstanceEvaluation := _ContextInstanceEvaluation{}

	err = json.Unmarshal(data, &varContextInstanceEvaluation)

	if err != nil {
		return err
	}

	*o = ContextInstanceEvaluation(varContextInstanceEvaluation)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_value")
