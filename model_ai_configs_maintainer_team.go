...
// checks if the AiConfigsMaintainerTeam type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsMaintainerTeam{}

// AiConfigsMaintainerTeam struct for AiConfigsMaintainerTeam
type AiConfigsMaintainerTeam struct {
	Key string `json:"key"`
	Name string `json:"name"`
	AdditionalProperties map[string]interface{}
}

type _AiConfigsMaintainerTeam AiConfigsMaintainerTeam
...
func (o AiConfigsMaintainerTeam) MarshalJSON() ([]byte, error) {
...
func (o AiConfigsMaintainerTeam) ToMap() (map[string]interface{}, error) {
...
func (o *AiConfigsMaintainerTeam) UnmarshalJSON(data []byte) (err error) {
	...
	varAiConfigsMaintainerTeam := _AiConfigsMaintainerTeam{}

	err = json.Unmarshal(data, &varAiConfigsMaintainerTeam)

	if err != nil {
		return err
	}

	*o = AiConfigsMaintainerTeam(varAiConfigsMaintainerTeam)
...
type NullableAiConfigsMaintainerTeam struct {
	value *AiConfigsMaintainerTeam
	isSet bool
}

func (v NullableAiConfigsMaintainerTeam) Get() *AiConfigsMaintainerTeam {
	return v.value
}

func (v *NullableAiConfigsMaintainerTeam) Set(val *AiConfigsMaintainerTeam) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsMaintainerTeam) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsMaintainerTeam) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsMaintainerTeam(val *AiConfigsMaintainerTeam) *NullableAiConfigsMaintainerTeam {
	return &NullableAiConfigsMaintainerTeam{value: val, isSet: true}
}

func (v NullableAiConfigsMaintainerTeam) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsMaintainerTeam) UnmarshalJSON(src []byte) error {
	v.isSet = true
