...
// checks if the FlagEventExperimentIteration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagEventExperimentIteration{}
...
type _FlagEventExperimentIteration FlagEventExperimentIteration
...
func (o FlagEventExperimentIteration) ToMap() (map[string]interface{}, error) {
...
func (o *FlagEventExperimentIteration) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagEventExperimentIteration := _FlagEventExperimentIteration{}

	err = json.Unmarshal(data, &varFlagEventExperimentIteration)

	if err != nil {
		return err
	}

	*o = FlagEventExperimentIteration(varFlagEventExperimentIteration)
