...
// checks if the FlagEventMemberRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagEventMemberRep{}
...
type _FlagEventMemberRep FlagEventMemberRep
...
func (o FlagEventMemberRep) ToMap() (map[string]interface{}, error) {
...
func (o *FlagEventMemberRep) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagEventMemberRep := _FlagEventMemberRep{}

	err = json.Unmarshal(data, &varFlagEventMemberRep)

	if err != nil {
		return err
	}

	*o = FlagEventMemberRep(varFlagEventMemberRep)
