...
// checks if the IntegrationDeliveryConfigurationResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationDeliveryConfigurationResponse{}
...
type _IntegrationDeliveryConfigurationResponse IntegrationDeliveryConfigurationResponse
...
func (o IntegrationDeliveryConfigurationResponse) ToMap() (map[string]interface{}, error) {
...
func (o *IntegrationDeliveryConfigurationResponse) UnmarshalJSON(data []byte) (err error) {
	varIntegrationDeliveryConfigurationResponse := _IntegrationDeliveryConfigurationResponse{}

	err = json.Unmarshal(data, &varIntegrationDeliveryConfigurationResponse)

	if err != nil {
		return err
	}

	*o = IntegrationDeliveryConfigurationResponse(varIntegrationDeliveryConfigurationResponse)
