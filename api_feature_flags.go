...
@return UserTargetingExpirationForFlags
*/
func (a *FeatureFlagsApiService) PatchExpiringUserTargets(ctx context.Context, projectKey string, environmentKey string, featureFlagKey string, patchComment PatchComment) (UserTargetingExpirationForFlags, *http.Response, error) {
	var (
