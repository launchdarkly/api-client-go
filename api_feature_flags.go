...
/* 
FeatureFlagsApiService Get a single change request for a feature flag
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectKey The project key, used to tie the flags together under one project so they can be managed together.
 * @param featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
 * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
...
*/
func (a *FeatureFlagsApiService) GetFeatureFlagChangeRequest(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, featureFlagChangeRequestId string) (FeatureFlagChangeRequests, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FeatureFlagChangeRequests
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagChangeRequestId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", fmt.Sprintf("%v", projectKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", fmt.Sprintf("%v", featureFlagKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", fmt.Sprintf("%v", environmentKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagChangeRequestId"+"}", fmt.Sprintf("%v", featureFlagChangeRequestId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FeatureFlagChangeRequests
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
FeatureFlagsApiService Get all change requests for a feature flag
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectKey The project key, used to tie the flags together under one project so they can be managed together.
 * @param featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
 * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
...
@return FeatureFlagChangeRequests
*/
func (a *FeatureFlagsApiService) GetFeatureFlagChangeRequests(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string) (FeatureFlagChangeRequests, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", fmt.Sprintf("%v", projectKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", fmt.Sprintf("%v", featureFlagKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", fmt.Sprintf("%v", environmentKey), -1)
...
/* 
FeatureFlagsApiService Apply change request for a feature flag
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectKey The project key, used to tie the flags together under one project so they can be managed together.
 * @param featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
 * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
...
@return FeatureFlagChangeRequests
*/
func (a *FeatureFlagsApiService) PostApplyFeatureFlagChangeRequest(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, featureFlagChangeRequestId string, featureFlagChangeRequestApplyConfigBody FeatureFlagChangeRequestApplyConfigBody) (FeatureFlagChangeRequests, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagChangeRequestId}/apply"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", fmt.Sprintf("%v", projectKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", fmt.Sprintf("%v", featureFlagKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", fmt.Sprintf("%v", environmentKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagChangeRequestId"+"}", fmt.Sprintf("%v", featureFlagChangeRequestId), -1)
	...
	// body params
	localVarPostBody = &featureFlagChangeRequestApplyConfigBody
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
 ...
 * @param featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
 * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
 * @param optional nil or *PostFeatureFlagChangeRequestOpts - Optional Parameters:
     * @param "FeatureFlagChangeRequestConfigBody" (optional.Interface of FeatureFlagChangeRequestConfigBody) -  Create a new feature flag change request

@return FeatureFlagChangeRequest
*/

type PostFeatureFlagChangeRequestOpts struct { 
	FeatureFlagChangeRequestConfigBody optional.Interface
}

func (a *FeatureFlagsApiService) PostFeatureFlagChangeRequest(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, localVarOptionals *PostFeatureFlagChangeRequestOpts) (FeatureFlagChangeRequest, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FeatureFlagChangeRequest
	)
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.FeatureFlagChangeRequestConfigBody.IsSet() {
		
		localVarOptionalFeatureFlagChangeRequestConfigBody, localVarOptionalFeatureFlagChangeRequestConfigBodyok := localVarOptionals.FeatureFlagChangeRequestConfigBody.Value().(FeatureFlagChangeRequestConfigBody)
		if !localVarOptionalFeatureFlagChangeRequestConfigBodyok {
				return localVarReturnValue, nil, reportError("featureFlagChangeRequestConfigBody should be FeatureFlagChangeRequestConfigBody")
		}
		localVarPostBody = &localVarOptionalFeatureFlagChangeRequestConfigBody
	}
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FeatureFlagChangeRequest
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
FeatureFlagsApiService Review change request for a feature flag
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectKey The project key, used to tie the flags together under one project so they can be managed together.
 * @param featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
 * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
...
@return FeatureFlagChangeRequests
*/
func (a *FeatureFlagsApiService) PostReviewFeatureFlagChangeRequest(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, featureFlagChangeRequestId string, featureFlagChangeRequestReviewConfigBody FeatureFlagChangeRequestReviewConfigBody) (FeatureFlagChangeRequests, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagChangeRequestId}/review"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", fmt.Sprintf("%v", projectKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", fmt.Sprintf("%v", featureFlagKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", fmt.Sprintf("%v", environmentKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagChangeRequestId"+"}", fmt.Sprintf("%v", featureFlagChangeRequestId), -1)
	...
	// body params
	localVarPostBody = &featureFlagChangeRequestReviewConfigBody
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
