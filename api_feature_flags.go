...
/* 
FeatureFlagsApiService Delete an approval request for a feature flag
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectKey The project key, used to tie the flags together under one project so they can be managed together.
 ...
 * @param optional nil or *DeleteFeatureFlagApprovalRequestOpts - Optional Parameters:
     * @param "FeatureFlagApprovalRequestConfigBody" (optional.Interface of FeatureFlagApprovalRequestConfigBody) -  Create a new feature flag approval request


*/

type DeleteFeatureFlagApprovalRequestOpts struct { 
	FeatureFlagApprovalRequestConfigBody optional.Interface
}

func (a *FeatureFlagsApiService) DeleteFeatureFlagApprovalRequest(ctx context.Context, projectKey string, environmentKey string, featureFlagKey string, featureFlagApprovalRequestId string, localVarOptionals *DeleteFeatureFlagApprovalRequestOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagApprovalRequestId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", fmt.Sprintf("%v", projectKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", fmt.Sprintf("%v", environmentKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", fmt.Sprintf("%v", featureFlagKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagApprovalRequestId"+"}", fmt.Sprintf("%v", featureFlagApprovalRequestId), -1)
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.FeatureFlagApprovalRequestConfigBody.IsSet() {
		
		localVarOptionalFeatureFlagApprovalRequestConfigBody, localVarOptionalFeatureFlagApprovalRequestConfigBodyok := localVarOptionals.FeatureFlagApprovalRequestConfigBody.Value().(FeatureFlagApprovalRequestConfigBody)
		if !localVarOptionalFeatureFlagApprovalRequestConfigBodyok {
				return nil, reportError("featureFlagApprovalRequestConfigBody should be FeatureFlagApprovalRequestConfigBody")
		}
		localVarPostBody = &localVarOptionalFeatureFlagApprovalRequestConfigBody
	}
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
...
/* 
FeatureFlagsApiService Get a single approval request for a feature flag
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectKey The project key, used to tie the flags together under one project so they can be managed together.
 * @param featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
 * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
...
*/
func (a *FeatureFlagsApiService) GetFeatureFlagApprovalRequest(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, featureFlagApprovalRequestId string) (FeatureFlagApprovalRequests, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FeatureFlagApprovalRequests
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FeatureFlagApprovalRequests
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
FeatureFlagsApiService Get all approval requests for a feature flag
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectKey The project key, used to tie the flags together under one project so they can be managed together.
 * @param featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
 * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
...
@return FeatureFlagApprovalRequests
*/
func (a *FeatureFlagsApiService) GetFeatureFlagApprovalRequests(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string) (FeatureFlagApprovalRequests, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", fmt.Sprintf("%v", projectKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", fmt.Sprintf("%v", featureFlagKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", fmt.Sprintf("%v", environmentKey), -1)
...
/* 
FeatureFlagsApiService Apply approval request for a feature flag
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectKey The project key, used to tie the flags together under one project so they can be managed together.
 * @param featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
 * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
...
@return FeatureFlagApprovalRequests
*/
func (a *FeatureFlagsApiService) PostApplyFeatureFlagApprovalRequest(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, featureFlagApprovalRequestId string, featureFlagApprovalRequestApplyConfigBody FeatureFlagApprovalRequestApplyConfigBody) (FeatureFlagApprovalRequests, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagApprovalRequestId}/apply"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", fmt.Sprintf("%v", projectKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", fmt.Sprintf("%v", featureFlagKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", fmt.Sprintf("%v", environmentKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagApprovalRequestId"+"}", fmt.Sprintf("%v", featureFlagApprovalRequestId), -1)
	...
	// body params
	localVarPostBody = &featureFlagApprovalRequestApplyConfigBody
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/* 
FeatureFlagsApiService Create an approval request for a feature flag
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectKey The project key, used to tie the flags together under one project so they can be managed together.
 * @param featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
 * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
 * @param featureFlagApprovalRequestId The feature flag approval request ID
 * @param optional nil or *PostFeatureFlagApprovalRequestOpts - Optional Parameters:
     * @param "FeatureFlagApprovalRequestConfigBody" (optional.Interface of FeatureFlagApprovalRequestConfigBody) -  Create a new feature flag approval request

@return FeatureFlagApprovalRequest
*/

type PostFeatureFlagApprovalRequestOpts struct { 
	FeatureFlagApprovalRequestConfigBody optional.Interface
}

func (a *FeatureFlagsApiService) PostFeatureFlagApprovalRequest(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, featureFlagApprovalRequestId string, localVarOptionals *PostFeatureFlagApprovalRequestOpts) (FeatureFlagApprovalRequest, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FeatureFlagApprovalRequest
	)
	...
	if localVarOptionals != nil && localVarOptionals.FeatureFlagApprovalRequestConfigBody.IsSet() {
		...
		localVarOptionalFeatureFlagApprovalRequestConfigBody, localVarOptionalFeatureFlagApprovalRequestConfigBodyok := localVarOptionals.FeatureFlagApprovalRequestConfigBody.Value().(FeatureFlagApprovalRequestConfigBody)
		if !localVarOptionalFeatureFlagApprovalRequestConfigBodyok {
				return localVarReturnValue, nil, reportError("featureFlagApprovalRequestConfigBody should be FeatureFlagApprovalRequestConfigBody")
		}
		localVarPostBody = &localVarOptionalFeatureFlagApprovalRequestConfigBody
	}
	if ctx != nil {
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FeatureFlagApprovalRequest
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/* 
FeatureFlagsApiService Review approval request for a feature flag
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectKey The project key, used to tie the flags together under one project so they can be managed together.
 * @param featureFlagKey The feature flag&#39;s key. The key identifies the flag in your code.
 * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
...
@return FeatureFlagApprovalRequests
*/
func (a *FeatureFlagsApiService) PostReviewFeatureFlagApprovalRequest(ctx context.Context, projectKey string, featureFlagKey string, environmentKey string, featureFlagApprovalRequestId string, featureFlagApprovalRequestReviewConfigBody FeatureFlagApprovalRequestReviewConfigBody) (FeatureFlagApprovalRequests, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{projectKey}/flags/{featureFlagKey}/environments/{environmentKey}/approval-requests/{featureFlagApprovalRequestId}/review"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", fmt.Sprintf("%v", projectKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", fmt.Sprintf("%v", featureFlagKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", fmt.Sprintf("%v", environmentKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagApprovalRequestId"+"}", fmt.Sprintf("%v", featureFlagApprovalRequestId), -1)
	...
	// body params
	localVarPostBody = &featureFlagApprovalRequestReviewConfigBody
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
