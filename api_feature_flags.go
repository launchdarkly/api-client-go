 ...
 * @param optional nil or *FeatureFlagsApiDeleteApprovalRequestOpts - Optional Parameters:
...
func (a *FeatureFlagsApiService) FlagsProjectKeyEnvironmentKeyFeatureFlagKeyDependentFlagsGet(ctx context.Context, projectKey string, environmentKey string, featureFlagKey string) (DependentFlagsByEnvironment, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flags/{projectKey}/{environmentKey}/{featureFlagKey}/dependent-flags"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", fmt.Sprintf("%v", projectKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"environmentKey"+"}", fmt.Sprintf("%v", environmentKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", fmt.Sprintf("%v", featureFlagKey), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v DependentFlagsByEnvironment
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
func (a *FeatureFlagsApiService) FlagsProjectKeyFeatureFlagKeyDependentFlagsGet(ctx context.Context, projectKey string, featureFlagKey string) (MultiEnvironmentDependentFlags, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flags/{projectKey}/{featureFlagKey}/dependent-flags"
	localVarPath = strings.Replace(localVarPath, "{"+"projectKey"+"}", fmt.Sprintf("%v", projectKey), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"featureFlagKey"+"}", fmt.Sprintf("%v", featureFlagKey), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MultiEnvironmentDependentFlags
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param environmentKey The environment key, used to tie together flag configuration and users under one environment so they can be managed together.
 * @param approvalRequestId The approval request ID
 * @param optional nil or *FeatureFlagsApiPostApprovalRequestOpts - Optional Parameters:
     * @param "ApprovalRequestConfigBody" (optional.Interface of ApprovalRequestConfigBody) -  Create a new approval request
 ...
 * @param optional nil or *FeatureFlagsApiPostFeatureFlagOpts - Optional Parameters:
