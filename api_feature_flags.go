...
*/
func (a *FeatureFlagsApiService) CopyFeatureFlag(ctx _context.Context, projectKey string, featureFlagKey string) ApiCopyFeatureFlagRequest {
	return ApiCopyFeatureFlagRequest{
		ApiService: a,
		ctx: ctx,
...
*/
func (a *FeatureFlagsApiService) DeleteFeatureFlag(ctx _context.Context, projectKey string, featureFlagKey string) ApiDeleteFeatureFlagRequest {
	return ApiDeleteFeatureFlagRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
*/
func (a *FeatureFlagsApiService) GetExpiringUserTargets(ctx _context.Context, projectKey string, environmentKey string, featureFlagKey string) ApiGetExpiringUserTargetsRequest {
	return ApiGetExpiringUserTargetsRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
*/
func (a *FeatureFlagsApiService) GetFeatureFlag(ctx _context.Context, projectKey string, featureFlagKey string) ApiGetFeatureFlagRequest {
	return ApiGetFeatureFlagRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
*/
func (a *FeatureFlagsApiService) GetFeatureFlagStatus(ctx _context.Context, projectKey string, environmentKey string, featureFlagKey string) ApiGetFeatureFlagStatusRequest {
	return ApiGetFeatureFlagStatusRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
*/
func (a *FeatureFlagsApiService) GetFeatureFlagStatuses(ctx _context.Context, projectKey string, environmentKey string) ApiGetFeatureFlagStatusesRequest {
	return ApiGetFeatureFlagStatusesRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
*/
func (a *FeatureFlagsApiService) GetFeatureFlags(ctx _context.Context, projectKey string) ApiGetFeatureFlagsRequest {
	return ApiGetFeatureFlagsRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
*/
func (a *FeatureFlagsApiService) PatchExpiringUserTargets(ctx _context.Context, projectKey string, environmentKey string, featureFlagKey string) ApiPatchExpiringUserTargetsRequest {
	return ApiPatchExpiringUserTargetsRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
Adds a new targeting rule to the flag. The rule may contain `clauses` and serve the variation that `variationId` indicates, or serve a percent rollout that `rolloutWeights` and `rolloutBucketBy` indicate.

If `beforeRuleId` is set, adds the new rule before the indicated rule. Otherwise, adds the new rule to the end of the list.
...
- `clause`: New `clause` object, with `attribute` (string), `op` (string), and `values` (array of strings, numbers, or dates) properties.
...
*/
func (a *FeatureFlagsApiService) PatchFeatureFlag(ctx _context.Context, projectKey string, featureFlagKey string) ApiPatchFeatureFlagRequest {
	return ApiPatchFeatureFlagRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
*/
func (a *FeatureFlagsApiService) PostFeatureFlag(ctx _context.Context, projectKey string) ApiPostFeatureFlagRequest {
	return ApiPostFeatureFlagRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
