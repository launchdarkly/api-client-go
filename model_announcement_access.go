...
// checks if the AnnouncementAccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnnouncementAccess{}

// AnnouncementAccess struct for AnnouncementAccess
type AnnouncementAccess struct {
	Denied []AnnouncementAccessDenied `json:"denied"`
	Allowed []AnnouncementAccessAllowedRep `json:"allowed"`
	AdditionalProperties map[string]interface{}
}

type _AnnouncementAccess AnnouncementAccess
...
func (o AnnouncementAccess) MarshalJSON() ([]byte, error) {
...
func (o AnnouncementAccess) ToMap() (map[string]interface{}, error) {
...
func (o *AnnouncementAccess) UnmarshalJSON(data []byte) (err error) {
	...
	varAnnouncementAccess := _AnnouncementAccess{}

	err = json.Unmarshal(data, &varAnnouncementAccess)

	if err != nil {
		return err
	}

	*o = AnnouncementAccess(varAnnouncementAccess)
...
type NullableAnnouncementAccess struct {
	value *AnnouncementAccess
	isSet bool
}

func (v NullableAnnouncementAccess) Get() *AnnouncementAccess {
	return v.value
}

func (v *NullableAnnouncementAccess) Set(val *AnnouncementAccess) {
	v.value = val
	v.isSet = true
}

func (v NullableAnnouncementAccess) IsSet() bool {
	return v.isSet
}

func (v *NullableAnnouncementAccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnnouncementAccess(val *AnnouncementAccess) *NullableAnnouncementAccess {
	return &NullableAnnouncementAccess{value: val, isSet: true}
}

func (v NullableAnnouncementAccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnnouncementAccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
