...
// checks if the InsightGroupCollectionScoreMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightGroupCollectionScoreMetadata{}

// InsightGroupCollectionScoreMetadata struct for InsightGroupCollectionScoreMetadata
type InsightGroupCollectionScoreMetadata struct {
	Period InsightPeriod `json:"period"`
	LastPeriod InsightPeriod `json:"lastPeriod"`
	AdditionalProperties map[string]interface{}
}

type _InsightGroupCollectionScoreMetadata InsightGroupCollectionScoreMetadata
...
func NewInsightGroupCollectionScoreMetadata(period InsightPeriod, lastPeriod InsightPeriod) *InsightGroupCollectionScoreMetadata {
	this := InsightGroupCollectionScoreMetadata{}
	this.Period = period
...
func (o InsightGroupCollectionScoreMetadata) ToMap() (map[string]interface{}, error) {
...
func (o *InsightGroupCollectionScoreMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightGroupCollectionScoreMetadata := _InsightGroupCollectionScoreMetadata{}

	err = json.Unmarshal(data, &varInsightGroupCollectionScoreMetadata)

	if err != nil {
		return err
	}

	*o = InsightGroupCollectionScoreMetadata(varInsightGroupCollectionScoreMetadata)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "period")
		delete(additionalProperties, "lastPeriod")
...
type NullableInsightGroupCollectionScoreMetadata struct {
	value *InsightGroupCollectionScoreMetadata
	isSet bool
}
...
func NewNullableInsightGroupCollectionScoreMetadata(val *InsightGroupCollectionScoreMetadata) *NullableInsightGroupCollectionScoreMetadata {
	return &NullableInsightGroupCollectionScoreMetadata{value: val, isSet: true}
}
