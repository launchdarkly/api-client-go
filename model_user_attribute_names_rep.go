...
// checks if the UserAttributeNamesRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserAttributeNamesRep{}
...
type _UserAttributeNamesRep UserAttributeNamesRep
...
func (o UserAttributeNamesRep) ToMap() (map[string]interface{}, error) {
...
func (o *UserAttributeNamesRep) UnmarshalJSON(data []byte) (err error) {
	varUserAttributeNamesRep := _UserAttributeNamesRep{}

	err = json.Unmarshal(data, &varUserAttributeNamesRep)

	if err != nil {
		return err
	}

	*o = UserAttributeNamesRep(varUserAttributeNamesRep)
