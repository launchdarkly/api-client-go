...
// checks if the ReleaseProgression type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleaseProgression{}
...
type ReleaseProgression struct {
	...
	ActivePhaseStatus *string `json:"activePhaseStatus,omitempty"`
	// The location and content type of related resources
	Links map[string]Link `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ReleaseProgression ReleaseProgression
...
func (o *ReleaseProgression) GetActivePhaseId() string {
	if o == nil || IsNil(o.ActivePhaseId) {
		var ret string
		return ret
	}
...
// GetActivePhaseStatus returns the ActivePhaseStatus field value if set, zero value otherwise.
func (o *ReleaseProgression) GetActivePhaseStatus() string {
	if o == nil || IsNil(o.ActivePhaseStatus) {
		var ret string
		return ret
	}
	return *o.ActivePhaseStatus
}

// GetActivePhaseStatusOk returns a tuple with the ActivePhaseStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ReleaseProgression) GetActivePhaseStatusOk() (*string, bool) {
	if o == nil || IsNil(o.ActivePhaseStatus) {
		return nil, false
	}
	return o.ActivePhaseStatus, true
}
...
// SetActivePhaseStatus gets a reference to the given string and assigns it to the ActivePhaseStatus field.
func (o *ReleaseProgression) SetActivePhaseStatus(v string) {
	o.ActivePhaseStatus = &v
}
...
func (o ReleaseProgression) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ActivePhaseId) {
		toSerialize["activePhaseId"] = o.ActivePhaseId
	}
	if !IsNil(o.ActivePhaseStatus) {
		toSerialize["activePhaseStatus"] = o.ActivePhaseStatus
	}
...
func (o *ReleaseProgression) UnmarshalJSON(data []byte) (err error) {
	...
	varReleaseProgression := _ReleaseProgression{}

	err = json.Unmarshal(data, &varReleaseProgression)

	if err != nil {
		return err
	}

	*o = ReleaseProgression(varReleaseProgression)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "_createdAt")
		delete(additionalProperties, "_completedAt")
		delete(additionalProperties, "flagKey")
		delete(additionalProperties, "activePhaseId")
		delete(additionalProperties, "activePhaseStatus")
