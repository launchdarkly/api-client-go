...
// checks if the AiConfigsMetricDataSourceRefRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsMetricDataSourceRefRep{}

// AiConfigsMetricDataSourceRefRep struct for AiConfigsMetricDataSourceRefRep
type AiConfigsMetricDataSourceRefRep struct {
	Key string `json:"key"`
...
type _AiConfigsMetricDataSourceRefRep AiConfigsMetricDataSourceRefRep
...
func NewAiConfigsMetricDataSourceRefRep(key string) *AiConfigsMetricDataSourceRefRep {
	this := AiConfigsMetricDataSourceRefRep{}
	this.Key = key
	return &this
}
...
func (o AiConfigsMetricDataSourceRefRep) MarshalJSON() ([]byte, error) {
...
func (o AiConfigsMetricDataSourceRefRep) ToMap() (map[string]interface{}, error) {
...
func (o *AiConfigsMetricDataSourceRefRep) UnmarshalJSON(data []byte) (err error) {
	...
	varAiConfigsMetricDataSourceRefRep := _AiConfigsMetricDataSourceRefRep{}

	err = json.Unmarshal(data, &varAiConfigsMetricDataSourceRefRep)

	if err != nil {
		return err
	}

	*o = AiConfigsMetricDataSourceRefRep(varAiConfigsMetricDataSourceRefRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_name")
...
type NullableAiConfigsMetricDataSourceRefRep struct {
	value *AiConfigsMetricDataSourceRefRep
	isSet bool
}

func (v NullableAiConfigsMetricDataSourceRefRep) Get() *AiConfigsMetricDataSourceRefRep {
	return v.value
}

func (v *NullableAiConfigsMetricDataSourceRefRep) Set(val *AiConfigsMetricDataSourceRefRep) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsMetricDataSourceRefRep) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsMetricDataSourceRefRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsMetricDataSourceRefRep(val *AiConfigsMetricDataSourceRefRep) *NullableAiConfigsMetricDataSourceRefRep {
	return &NullableAiConfigsMetricDataSourceRefRep{value: val, isSet: true}
}

func (v NullableAiConfigsMetricDataSourceRefRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsMetricDataSourceRefRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
