...
// checks if the FeatureFlagScheduledChange type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FeatureFlagScheduledChange{}
...
type FeatureFlagScheduledChange struct {
	...
	MaintainerServiceTokenId *string `json:"_maintainerServiceTokenId,omitempty"`
...
type _FeatureFlagScheduledChange FeatureFlagScheduledChange
...
// GetMaintainerServiceTokenId returns the MaintainerServiceTokenId field value if set, zero value otherwise.
func (o *FeatureFlagScheduledChange) GetMaintainerServiceTokenId() string {
	if o == nil || IsNil(o.MaintainerServiceTokenId) {
		var ret string
		return ret
	}
	return *o.MaintainerServiceTokenId
}

// GetMaintainerServiceTokenIdOk returns a tuple with the MaintainerServiceTokenId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *FeatureFlagScheduledChange) GetMaintainerServiceTokenIdOk() (*string, bool) {
	if o == nil || IsNil(o.MaintainerServiceTokenId) {
		return nil, false
	}
	return o.MaintainerServiceTokenId, true
}
...
// SetMaintainerServiceTokenId gets a reference to the given string and assigns it to the MaintainerServiceTokenId field.
func (o *FeatureFlagScheduledChange) SetMaintainerServiceTokenId(v string) {
	o.MaintainerServiceTokenId = &v
}
...
func (o FeatureFlagScheduledChange) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["_id"] = o.Id
	toSerialize["_creationDate"] = o.CreationDate
	toSerialize["_maintainerId"] = o.MaintainerId
	if !IsNil(o.MaintainerServiceTokenId) {
		toSerialize["_maintainerServiceTokenId"] = o.MaintainerServiceTokenId
	}
...
func (o *FeatureFlagScheduledChange) UnmarshalJSON(data []byte) (err error) {
	...
	varFeatureFlagScheduledChange := _FeatureFlagScheduledChange{}

	err = json.Unmarshal(data, &varFeatureFlagScheduledChange)

	if err != nil {
		return err
	}

	*o = FeatureFlagScheduledChange(varFeatureFlagScheduledChange)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_maintainerServiceTokenId")
