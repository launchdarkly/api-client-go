...
type _ResourceAccess ResourceAccess
...
func (o *ResourceAccess) UnmarshalJSON(data []byte) (err error) {
	varResourceAccess := _ResourceAccess{}

	err = json.Unmarshal(data, &varResourceAccess)

	if err != nil {
		return err
	}

	*o = ResourceAccess(varResourceAccess)
