...
// checks if the AiConfigsAccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiConfigsAccess{}

// AiConfigsAccess struct for AiConfigsAccess
type AiConfigsAccess struct {
	Denied []AiConfigsAccessDenied `json:"denied"`
	Allowed []AiConfigsAccessAllowedRep `json:"allowed"`
	AdditionalProperties map[string]interface{}
}

type _AiConfigsAccess AiConfigsAccess
...
func (o *AiConfigsAccess) GetAllowed() []AiConfigsAccessAllowedRep {
	if o == nil {
		var ret []AiConfigsAccessAllowedRep
		return ret
	}
...
func (o AiConfigsAccess) MarshalJSON() ([]byte, error) {
...
func (o AiConfigsAccess) ToMap() (map[string]interface{}, error) {
...
func (o *AiConfigsAccess) UnmarshalJSON(data []byte) (err error) {
	...
	varAiConfigsAccess := _AiConfigsAccess{}

	err = json.Unmarshal(data, &varAiConfigsAccess)

	if err != nil {
		return err
	}

	*o = AiConfigsAccess(varAiConfigsAccess)
...
type NullableAiConfigsAccess struct {
	value *AiConfigsAccess
	isSet bool
}

func (v NullableAiConfigsAccess) Get() *AiConfigsAccess {
	return v.value
}

func (v *NullableAiConfigsAccess) Set(val *AiConfigsAccess) {
	v.value = val
	v.isSet = true
}

func (v NullableAiConfigsAccess) IsSet() bool {
	return v.isSet
}

func (v *NullableAiConfigsAccess) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAiConfigsAccess(val *AiConfigsAccess) *NullableAiConfigsAccess {
	return &NullableAiConfigsAccess{value: val, isSet: true}
}

func (v NullableAiConfigsAccess) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAiConfigsAccess) UnmarshalJSON(src []byte) error {
	v.isSet = true
