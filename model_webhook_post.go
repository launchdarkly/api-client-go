...
// checks if the WebhookPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookPost{}
...
func (o WebhookPost) ToMap() (map[string]interface{}, error) {
...
func (o *WebhookPost) UnmarshalJSON(data []byte) (err error) {
	...
	varWebhookPost := _WebhookPost{}

	err = json.Unmarshal(data, &varWebhookPost)

	if err != nil {
		return err
	}

	*o = WebhookPost(varWebhookPost)
