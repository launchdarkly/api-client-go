...
// checks if the ContextRecord type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextRecord{}
...
type _ContextRecord ContextRecord
...
func (o *ContextRecord) GetAssociatedContexts() int32 {
	if o == nil || IsNil(o.AssociatedContexts) {
		var ret int32
		return ret
	}
...
func (o ContextRecord) ToMap() (map[string]interface{}, error) {
...
func (o *ContextRecord) UnmarshalJSON(data []byte) (err error) {
	...
	varContextRecord := _ContextRecord{}

	err = json.Unmarshal(data, &varContextRecord)

	if err != nil {
		return err
	}

	*o = ContextRecord(varContextRecord)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "associatedContexts")
