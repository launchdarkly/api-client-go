...
// checks if the HoldoutsCollectionRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HoldoutsCollectionRep{}
...
type _HoldoutsCollectionRep HoldoutsCollectionRep
...
func (o HoldoutsCollectionRep) ToMap() (map[string]interface{}, error) {
...
func (o *HoldoutsCollectionRep) UnmarshalJSON(data []byte) (err error) {
	varHoldoutsCollectionRep := _HoldoutsCollectionRep{}

	err = json.Unmarshal(data, &varHoldoutsCollectionRep)

	if err != nil {
		return err
	}

	*o = HoldoutsCollectionRep(varHoldoutsCollectionRep)
