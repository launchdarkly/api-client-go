...
// checks if the MethodNotAllowedErrorRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MethodNotAllowedErrorRep{}
...
type _MethodNotAllowedErrorRep MethodNotAllowedErrorRep
...
func (o MethodNotAllowedErrorRep) ToMap() (map[string]interface{}, error) {
...
func (o *MethodNotAllowedErrorRep) UnmarshalJSON(data []byte) (err error) {
	...
	varMethodNotAllowedErrorRep := _MethodNotAllowedErrorRep{}

	err = json.Unmarshal(data, &varMethodNotAllowedErrorRep)

	if err != nil {
		return err
	}

	*o = MethodNotAllowedErrorRep(varMethodNotAllowedErrorRep)
