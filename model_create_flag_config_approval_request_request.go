...
// checks if the CreateFlagConfigApprovalRequestRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateFlagConfigApprovalRequestRequest{}
...
type _CreateFlagConfigApprovalRequestRequest CreateFlagConfigApprovalRequestRequest
...
func (o CreateFlagConfigApprovalRequestRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateFlagConfigApprovalRequestRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateFlagConfigApprovalRequestRequest := _CreateFlagConfigApprovalRequestRequest{}

	err = json.Unmarshal(data, &varCreateFlagConfigApprovalRequestRequest)

	if err != nil {
		return err
	}

	*o = CreateFlagConfigApprovalRequestRequest(varCreateFlagConfigApprovalRequestRequest)
