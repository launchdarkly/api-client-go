...
// checks if the AnnouncementResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnnouncementResponse{}
...
type _AnnouncementResponse AnnouncementResponse
...
func (o AnnouncementResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AnnouncementResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAnnouncementResponse := _AnnouncementResponse{}

	err = json.Unmarshal(data, &varAnnouncementResponse)

	if err != nil {
		return err
	}

	*o = AnnouncementResponse(varAnnouncementResponse)
