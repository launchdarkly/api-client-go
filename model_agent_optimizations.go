...
// checks if the AgentOptimizations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentOptimizations{}

// AgentOptimizations struct for AgentOptimizations
type AgentOptimizations struct {
	Links *PaginatedLinks `json:"_links,omitempty"`
	Items []AgentOptimization `json:"items"`
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _AgentOptimizations AgentOptimizations
...
func (o AgentOptimizations) MarshalJSON() ([]byte, error) {
...
func (o AgentOptimizations) ToMap() (map[string]interface{}, error) {
...
func (o *AgentOptimizations) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentOptimizations := _AgentOptimizations{}

	err = json.Unmarshal(data, &varAgentOptimizations)

	if err != nil {
		return err
	}

	*o = AgentOptimizations(varAgentOptimizations)
...
type NullableAgentOptimizations struct {
	value *AgentOptimizations
	isSet bool
}

func (v NullableAgentOptimizations) Get() *AgentOptimizations {
	return v.value
}

func (v *NullableAgentOptimizations) Set(val *AgentOptimizations) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentOptimizations) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentOptimizations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentOptimizations(val *AgentOptimizations) *NullableAgentOptimizations {
	return &NullableAgentOptimizations{value: val, isSet: true}
}

func (v NullableAgentOptimizations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentOptimizations) UnmarshalJSON(src []byte) error {
	v.isSet = true
