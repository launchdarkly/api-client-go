...
// checks if the Destinations type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Destinations{}
...
type _Destinations Destinations
...
func (o Destinations) ToMap() (map[string]interface{}, error) {
...
func (o *Destinations) UnmarshalJSON(data []byte) (err error) {
	varDestinations := _Destinations{}

	err = json.Unmarshal(data, &varDestinations)

	if err != nil {
		return err
	}

	*o = Destinations(varDestinations)
