...
// checks if the FlagConfigApprovalRequestResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagConfigApprovalRequestResponse{}
...
type _FlagConfigApprovalRequestResponse FlagConfigApprovalRequestResponse
...
func (o FlagConfigApprovalRequestResponse) ToMap() (map[string]interface{}, error) {
...
func (o *FlagConfigApprovalRequestResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagConfigApprovalRequestResponse := _FlagConfigApprovalRequestResponse{}

	err = json.Unmarshal(data, &varFlagConfigApprovalRequestResponse)

	if err != nil {
		return err
	}

	*o = FlagConfigApprovalRequestResponse(varFlagConfigApprovalRequestResponse)
