...
// checks if the WorkflowTemplateOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkflowTemplateOutput{}
...
type _WorkflowTemplateOutput WorkflowTemplateOutput
...
func (o WorkflowTemplateOutput) ToMap() (map[string]interface{}, error) {
...
func (o *WorkflowTemplateOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varWorkflowTemplateOutput := _WorkflowTemplateOutput{}

	err = json.Unmarshal(data, &varWorkflowTemplateOutput)

	if err != nil {
		return err
	}

	*o = WorkflowTemplateOutput(varWorkflowTemplateOutput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "_id")
		delete(additionalProperties, "_key")
		delete(additionalProperties, "name")
		delete(additionalProperties, "_creationDate")
		delete(additionalProperties, "_ownerId")
