...
// checks if the ContextInstanceEvaluationReason type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextInstanceEvaluationReason{}
...
type _ContextInstanceEvaluationReason ContextInstanceEvaluationReason
...
func (o *ContextInstanceEvaluationReason) GetPrerequisiteKey() string {
	if o == nil || IsNil(o.PrerequisiteKey) {
		var ret string
		return ret
	}
...
func (o ContextInstanceEvaluationReason) ToMap() (map[string]interface{}, error) {
...
func (o *ContextInstanceEvaluationReason) UnmarshalJSON(data []byte) (err error) {
	...
	varContextInstanceEvaluationReason := _ContextInstanceEvaluationReason{}

	err = json.Unmarshal(data, &varContextInstanceEvaluationReason)

	if err != nil {
		return err
	}

	*o = ContextInstanceEvaluationReason(varContextInstanceEvaluationReason)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "prerequisiteKey")
		delete(additionalProperties, "inExperiment")
		delete(additionalProperties, "errorKind")
