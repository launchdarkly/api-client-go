...
*/
func (a *OAuth2ClientsBetaApiService) CreateOAuth2Client(ctx context.Context) ApiCreateOAuth2ClientRequest {
	return ApiCreateOAuth2ClientRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OAuth2ClientsBetaApiService) CreateOAuth2ClientExecute(r ApiCreateOAuth2ClientRequest) (*Client, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuth2ClientsBetaApiService.CreateOAuth2Client")
	if err != nil {
...
*/
func (a *OAuth2ClientsBetaApiService) DeleteOAuthClient(ctx context.Context, clientId string) ApiDeleteOAuthClientRequest {
	return ApiDeleteOAuthClientRequest{
		ApiService: a,
		ctx: ctx,
		clientId: clientId,
...
func (a *OAuth2ClientsBetaApiService) DeleteOAuthClientExecute(r ApiDeleteOAuthClientRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuth2ClientsBetaApiService.DeleteOAuthClient")
	if err != nil {
...
func (a *OAuth2ClientsBetaApiService) GetOAuthClientByIdExecute(r ApiGetOAuthClientByIdRequest) (*Client, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuth2ClientsBetaApiService.GetOAuthClientById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *OAuth2ClientsBetaApiService) GetOAuthClients(ctx context.Context) ApiGetOAuthClientsRequest {
	return ApiGetOAuthClientsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OAuth2ClientsBetaApiService) GetOAuthClientsExecute(r ApiGetOAuthClientsRequest) (*ClientCollection, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuth2ClientsBetaApiService.GetOAuthClients")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *OAuth2ClientsBetaApiService) PatchOAuthClient(ctx context.Context, clientId string) ApiPatchOAuthClientRequest {
	return ApiPatchOAuthClientRequest{
		ApiService: a,
		ctx: ctx,
		clientId: clientId,
...
// Execute executes the request
//  @return Client
func (a *OAuth2ClientsBetaApiService) PatchOAuthClientExecute(r ApiPatchOAuthClientRequest) (*Client, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OAuth2ClientsBetaApiService.PatchOAuthClient")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
