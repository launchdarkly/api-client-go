...
// checks if the AssignedToRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssignedToRep{}

// AssignedToRep struct for AssignedToRep
type AssignedToRep struct {
...
type _AssignedToRep AssignedToRep
...
func (o AssignedToRep) MarshalJSON() ([]byte, error) {
...
func (o AssignedToRep) ToMap() (map[string]interface{}, error) {
...
func (o *AssignedToRep) UnmarshalJSON(data []byte) (err error) {
	varAssignedToRep := _AssignedToRep{}

	err = json.Unmarshal(data, &varAssignedToRep)

	if err != nil {
		return err
	}

	*o = AssignedToRep(varAssignedToRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "membersCount")
		delete(additionalProperties, "teamsCount")
...
type NullableAssignedToRep struct {
	value *AssignedToRep
	isSet bool
}

func (v NullableAssignedToRep) Get() *AssignedToRep {
	return v.value
}

func (v *NullableAssignedToRep) Set(val *AssignedToRep) {
	v.value = val
	v.isSet = true
}

func (v NullableAssignedToRep) IsSet() bool {
	return v.isSet
}

func (v *NullableAssignedToRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssignedToRep(val *AssignedToRep) *NullableAssignedToRep {
	return &NullableAssignedToRep{value: val, isSet: true}
}

func (v NullableAssignedToRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssignedToRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
