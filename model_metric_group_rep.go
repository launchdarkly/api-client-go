...
// checks if the MetricGroupRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricGroupRep{}
...
type _MetricGroupRep MetricGroupRep
...
func (o MetricGroupRep) ToMap() (map[string]interface{}, error) {
...
func (o *MetricGroupRep) UnmarshalJSON(data []byte) (err error) {
	...
	varMetricGroupRep := _MetricGroupRep{}

	err = json.Unmarshal(data, &varMetricGroupRep)

	if err != nil {
		return err
	}

	*o = MetricGroupRep(varMetricGroupRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_lastModified")
