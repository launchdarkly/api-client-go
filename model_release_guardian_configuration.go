...
// checks if the ReleaseGuardianConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleaseGuardianConfiguration{}
...
type _ReleaseGuardianConfiguration ReleaseGuardianConfiguration
...
func (o ReleaseGuardianConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *ReleaseGuardianConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varReleaseGuardianConfiguration := _ReleaseGuardianConfiguration{}

	err = json.Unmarshal(data, &varReleaseGuardianConfiguration)

	if err != nil {
		return err
	}

	*o = ReleaseGuardianConfiguration(varReleaseGuardianConfiguration)
