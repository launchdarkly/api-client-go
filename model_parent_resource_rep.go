...
// checks if the ParentResourceRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ParentResourceRep{}
...
type _ParentResourceRep ParentResourceRep
...
func (o ParentResourceRep) ToMap() (map[string]interface{}, error) {
...
func (o *ParentResourceRep) UnmarshalJSON(data []byte) (err error) {
	varParentResourceRep := _ParentResourceRep{}

	err = json.Unmarshal(data, &varParentResourceRep)

	if err != nil {
		return err
	}

	*o = ParentResourceRep(varParentResourceRep)
