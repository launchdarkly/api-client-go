...
// checks if the InsightsRepository type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightsRepository{}
...
type _InsightsRepository InsightsRepository
...
func (o InsightsRepository) ToMap() (map[string]interface{}, error) {
...
func (o *InsightsRepository) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightsRepository := _InsightsRepository{}

	err = json.Unmarshal(data, &varInsightsRepository)

	if err != nil {
		return err
	}

	*o = InsightsRepository(varInsightsRepository)
