...
// checks if the StatusServiceUnavailable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatusServiceUnavailable{}
...
type _StatusServiceUnavailable StatusServiceUnavailable
...
func (o StatusServiceUnavailable) ToMap() (map[string]interface{}, error) {
...
func (o *StatusServiceUnavailable) UnmarshalJSON(data []byte) (err error) {
	...
	varStatusServiceUnavailable := _StatusServiceUnavailable{}

	err = json.Unmarshal(data, &varStatusServiceUnavailable)

	if err != nil {
		return err
	}

	*o = StatusServiceUnavailable(varStatusServiceUnavailable)
...
type NullableStatusServiceUnavailable struct {
	value *StatusServiceUnavailable
	isSet bool
}
...
func NewNullableStatusServiceUnavailable(val *StatusServiceUnavailable) *NullableStatusServiceUnavailable {
	return &NullableStatusServiceUnavailable{value: val, isSet: true}
}
