...
// checks if the AccessAllowedRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccessAllowedRep{}
...
type _AccessAllowedRep AccessAllowedRep
...
func (o AccessAllowedRep) ToMap() (map[string]interface{}, error) {
...
func (o *AccessAllowedRep) UnmarshalJSON(data []byte) (err error) {
	...
	varAccessAllowedRep := _AccessAllowedRep{}

	err = json.Unmarshal(data, &varAccessAllowedRep)

	if err != nil {
		return err
	}

	*o = AccessAllowedRep(varAccessAllowedRep)
...
func NewNullableAccessAllowedRep(val *AccessAllowedRep) *NullableAccessAllowedRep {
	return &NullableAccessAllowedRep{value: val, isSet: true}
}
