...
// checks if the HoldoutDetailRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HoldoutDetailRep{}
...
type _HoldoutDetailRep HoldoutDetailRep
...
func (o *HoldoutDetailRep) GetRelatedExperiments() []Experiment {
	if o == nil || IsNil(o.RelatedExperiments) {
		var ret []Experiment
		return ret
	}
...
func (o HoldoutDetailRep) ToMap() (map[string]interface{}, error) {
...
func (o *HoldoutDetailRep) UnmarshalJSON(data []byte) (err error) {
	...
	varHoldoutDetailRep := _HoldoutDetailRep{}

	err = json.Unmarshal(data, &varHoldoutDetailRep)

	if err != nil {
		return err
	}

	*o = HoldoutDetailRep(varHoldoutDetailRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "isDirty")
		delete(additionalProperties, "createdAt")
		delete(additionalProperties, "updatedAt")
		delete(additionalProperties, "baseExperiment")
		delete(additionalProperties, "relatedExperiments")
