...
// checks if the TagsCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagsCollection{}
...
type _TagsCollection TagsCollection
...
func (o TagsCollection) ToMap() (map[string]interface{}, error) {
...
func (o *TagsCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varTagsCollection := _TagsCollection{}

	err = json.Unmarshal(data, &varTagsCollection)

	if err != nil {
		return err
	}

	*o = TagsCollection(varTagsCollection)
