...
// checks if the ViewPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewPost{}

// ViewPost struct for ViewPost
...
func NewViewPost(key string, name string) *ViewPost {
	...
	var generateSdkKeys bool = false
...
func (o ViewPost) MarshalJSON() ([]byte, error) {
...
func (o ViewPost) ToMap() (map[string]interface{}, error) {
...
func (o *ViewPost) UnmarshalJSON(data []byte) (err error) {
	...
	varViewPost := _ViewPost{}

	err = json.Unmarshal(data, &varViewPost)

	if err != nil {
		return err
	}

	*o = ViewPost(varViewPost)
...
type NullableViewPost struct {
	value *ViewPost
	isSet bool
}

func (v NullableViewPost) Get() *ViewPost {
	return v.value
}

func (v *NullableViewPost) Set(val *ViewPost) {
	v.value = val
	v.isSet = true
}

func (v NullableViewPost) IsSet() bool {
	return v.isSet
}

func (v *NullableViewPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewPost(val *ViewPost) *NullableViewPost {
	return &NullableViewPost{value: val, isSet: true}
}

func (v NullableViewPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
