...
// checks if the SubscriptionPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionPost{}
...
type _SubscriptionPost SubscriptionPost
...
func (o SubscriptionPost) ToMap() (map[string]interface{}, error) {
...
func (o *SubscriptionPost) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionPost := _SubscriptionPost{}

	err = json.Unmarshal(data, &varSubscriptionPost)

	if err != nil {
		return err
	}

	*o = SubscriptionPost(varSubscriptionPost)
