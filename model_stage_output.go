...
// checks if the StageOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StageOutput{}
...
func (o StageOutput) ToMap() (map[string]interface{}, error) {
...
func (o *StageOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varStageOutput := _StageOutput{}

	err = json.Unmarshal(data, &varStageOutput)

	if err != nil {
		return err
	}

	*o = StageOutput(varStageOutput)
