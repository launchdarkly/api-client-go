...
// checks if the CompletedBy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CompletedBy{}
...
type _CompletedBy CompletedBy

// NewCompletedBy instantiates a new CompletedBy object
...
// NewCompletedByWithDefaults instantiates a new CompletedBy object
...
func (o CompletedBy) ToMap() (map[string]interface{}, error) {
...
func (o *CompletedBy) UnmarshalJSON(data []byte) (err error) {
	varCompletedBy := _CompletedBy{}

	err = json.Unmarshal(data, &varCompletedBy)

	if err != nil {
		return err
	}

	*o = CompletedBy(varCompletedBy)
...
func NewNullableCompletedBy(val *CompletedBy) *NullableCompletedBy {
	return &NullableCompletedBy{value: val, isSet: true}
}
