...
func (o *CustomRole) GetPresetBundleVersion() int32 {
	if o == nil || IsNil(o.PresetBundleVersion) {
		var ret int32
		return ret
	}
...
func (o *CustomRole) GetPresetStatements() []Statement {
	if o == nil || IsNil(o.PresetStatements) {
		var ret []Statement
		return ret
	}
...
func (o CustomRole) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PresetBundleVersion) {
		toSerialize["_presetBundleVersion"] = o.PresetBundleVersion
	}
	if !IsNil(o.PresetStatements) {
...
func (o *CustomRole) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CustomRole(varCustomRole)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_presetBundleVersion")
		delete(additionalProperties, "_presetStatements")
