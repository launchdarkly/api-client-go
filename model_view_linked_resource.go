...
// checks if the ViewLinkedResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewLinkedResource{}
...
type ViewLinkedResource struct {
	...
	ResourceDetails *ViewLinkedResourceDetails `json:"resourceDetails,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ViewLinkedResource ViewLinkedResource
...
func (o *ViewLinkedResource) GetResourceDetails() ViewLinkedResourceDetails {
	if o == nil || IsNil(o.ResourceDetails) {
		var ret ViewLinkedResourceDetails
		return ret
	}
...
// SetResourceDetails gets a reference to the given ViewLinkedResourceDetails and assigns it to the ResourceDetails field.
func (o *ViewLinkedResource) SetResourceDetails(v ViewLinkedResourceDetails) {
	o.ResourceDetails = &v
}

func (o ViewLinkedResource) MarshalJSON() ([]byte, error) {
...
func (o ViewLinkedResource) ToMap() (map[string]interface{}, error) {
...
func (o *ViewLinkedResource) UnmarshalJSON(data []byte) (err error) {
	...
	varViewLinkedResource := _ViewLinkedResource{}

	err = json.Unmarshal(data, &varViewLinkedResource)

	if err != nil {
		return err
	}

	*o = ViewLinkedResource(varViewLinkedResource)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "resourceDetails")
...
type NullableViewLinkedResource struct {
	value *ViewLinkedResource
	isSet bool
}

func (v NullableViewLinkedResource) Get() *ViewLinkedResource {
	return v.value
}

func (v *NullableViewLinkedResource) Set(val *ViewLinkedResource) {
	v.value = val
	v.isSet = true
}

func (v NullableViewLinkedResource) IsSet() bool {
	return v.isSet
}

func (v *NullableViewLinkedResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewLinkedResource(val *ViewLinkedResource) *NullableViewLinkedResource {
	return &NullableViewLinkedResource{value: val, isSet: true}
}

func (v NullableViewLinkedResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewLinkedResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
