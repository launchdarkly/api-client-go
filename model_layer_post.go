...
// checks if the LayerPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LayerPost{}
...
func (o LayerPost) ToMap() (map[string]interface{}, error) {
...
func (o *LayerPost) UnmarshalJSON(data []byte) (err error) {
	...
	varLayerPost := _LayerPost{}

	err = json.Unmarshal(data, &varLayerPost)

	if err != nil {
		return err
	}

	*o = LayerPost(varLayerPost)
