...
// checks if the RecentTriggerBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecentTriggerBody{}
...
type _RecentTriggerBody RecentTriggerBody
...
func (o RecentTriggerBody) ToMap() (map[string]interface{}, error) {
...
func (o *RecentTriggerBody) UnmarshalJSON(data []byte) (err error) {
	varRecentTriggerBody := _RecentTriggerBody{}

	err = json.Unmarshal(data, &varRecentTriggerBody)

	if err != nil {
		return err
	}

	*o = RecentTriggerBody(varRecentTriggerBody)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "timestamp")
		delete(additionalProperties, "jsonBody")
