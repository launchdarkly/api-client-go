...
// checks if the ExpandedLinkedAIConfigs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedLinkedAIConfigs{}

// ExpandedLinkedAIConfigs struct for ExpandedLinkedAIConfigs
type ExpandedLinkedAIConfigs struct {
	Items []ExpandedAIConfig `json:"items"`
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _ExpandedLinkedAIConfigs ExpandedLinkedAIConfigs
...
func (o ExpandedLinkedAIConfigs) MarshalJSON() ([]byte, error) {
...
func (o ExpandedLinkedAIConfigs) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedLinkedAIConfigs) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedLinkedAIConfigs := _ExpandedLinkedAIConfigs{}

	err = json.Unmarshal(data, &varExpandedLinkedAIConfigs)

	if err != nil {
		return err
	}

	*o = ExpandedLinkedAIConfigs(varExpandedLinkedAIConfigs)
...
type NullableExpandedLinkedAIConfigs struct {
	value *ExpandedLinkedAIConfigs
	isSet bool
}

func (v NullableExpandedLinkedAIConfigs) Get() *ExpandedLinkedAIConfigs {
	return v.value
}

func (v *NullableExpandedLinkedAIConfigs) Set(val *ExpandedLinkedAIConfigs) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedLinkedAIConfigs) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedLinkedAIConfigs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedLinkedAIConfigs(val *ExpandedLinkedAIConfigs) *NullableExpandedLinkedAIConfigs {
	return &NullableExpandedLinkedAIConfigs{value: val, isSet: true}
}

func (v NullableExpandedLinkedAIConfigs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedLinkedAIConfigs) UnmarshalJSON(src []byte) error {
	v.isSet = true
