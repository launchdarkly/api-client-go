...
// checks if the FlagCopyConfigPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagCopyConfigPost{}
...
type _FlagCopyConfigPost FlagCopyConfigPost
...
func (o FlagCopyConfigPost) ToMap() (map[string]interface{}, error) {
...
func (o *FlagCopyConfigPost) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagCopyConfigPost := _FlagCopyConfigPost{}

	err = json.Unmarshal(data, &varFlagCopyConfigPost)

	if err != nil {
		return err
	}

	*o = FlagCopyConfigPost(varFlagCopyConfigPost)
