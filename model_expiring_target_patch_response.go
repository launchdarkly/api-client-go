...
// checks if the ExpiringTargetPatchResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpiringTargetPatchResponse{}
...
type _ExpiringTargetPatchResponse ExpiringTargetPatchResponse
...
func (o ExpiringTargetPatchResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ExpiringTargetPatchResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varExpiringTargetPatchResponse := _ExpiringTargetPatchResponse{}

	err = json.Unmarshal(data, &varExpiringTargetPatchResponse)

	if err != nil {
		return err
	}

	*o = ExpiringTargetPatchResponse(varExpiringTargetPatchResponse)
