...
// checks if the NamingConvention type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NamingConvention{}

// NamingConvention struct for NamingConvention
...
type _NamingConvention NamingConvention
...
// SetCase gets a reference to the given string and assigns it to the Case field.
...
func (o NamingConvention) MarshalJSON() ([]byte, error) {
...
func (o NamingConvention) ToMap() (map[string]interface{}, error) {
...
func (o *NamingConvention) UnmarshalJSON(data []byte) (err error) {
	varNamingConvention := _NamingConvention{}

	err = json.Unmarshal(data, &varNamingConvention)

	if err != nil {
		return err
	}

	*o = NamingConvention(varNamingConvention)
...
type NullableNamingConvention struct {
	value *NamingConvention
	isSet bool
}

func (v NullableNamingConvention) Get() *NamingConvention {
	return v.value
}

func (v *NullableNamingConvention) Set(val *NamingConvention) {
	v.value = val
	v.isSet = true
}

func (v NullableNamingConvention) IsSet() bool {
	return v.isSet
}

func (v *NullableNamingConvention) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNamingConvention(val *NamingConvention) *NullableNamingConvention {
	return &NullableNamingConvention{value: val, isSet: true}
}

func (v NullableNamingConvention) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNamingConvention) UnmarshalJSON(src []byte) error {
	v.isSet = true
