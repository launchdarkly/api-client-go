...
// checks if the MetricInMetricGroupInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricInMetricGroupInput{}

// MetricInMetricGroupInput struct for MetricInMetricGroupInput
type MetricInMetricGroupInput struct {
	// The metric key
	Key string `json:"key"`
...
type _MetricInMetricGroupInput MetricInMetricGroupInput
...
func (o MetricInMetricGroupInput) ToMap() (map[string]interface{}, error) {
...
func (o *MetricInMetricGroupInput) UnmarshalJSON(data []byte) (err error) {
	...
	varMetricInMetricGroupInput := _MetricInMetricGroupInput{}

	err = json.Unmarshal(data, &varMetricInMetricGroupInput)

	if err != nil {
		return err
	}

	*o = MetricInMetricGroupInput(varMetricInMetricGroupInput)
...
type NullableMetricInMetricGroupInput struct {
	value *MetricInMetricGroupInput
	isSet bool
}
...
func NewNullableMetricInMetricGroupInput(val *MetricInMetricGroupInput) *NullableMetricInMetricGroupInput {
	return &NullableMetricInMetricGroupInput{value: val, isSet: true}
}
