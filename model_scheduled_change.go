...
// ScheduledChange struct for ScheduledChange
...
func (o ScheduledChange) MarshalJSON() ([]byte, error) {
...
type NullableScheduledChange struct {
	value *ScheduledChange
	isSet bool
}

func (v NullableScheduledChange) Get() *ScheduledChange {
	return v.value
}

func (v *NullableScheduledChange) Set(val *ScheduledChange) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduledChange) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduledChange) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduledChange(val *ScheduledChange) *NullableScheduledChange {
	return &NullableScheduledChange{value: val, isSet: true}
}

func (v NullableScheduledChange) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduledChange) UnmarshalJSON(src []byte) error {
	v.isSet = true
