...
// checks if the BigSegmentStoreStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BigSegmentStoreStatus{}
...
type _BigSegmentStoreStatus BigSegmentStoreStatus
...
func (o *BigSegmentStoreStatus) GetPotentiallyStale() bool {
	if o == nil || IsNil(o.PotentiallyStale) {
		var ret bool
		return ret
	}
...
func (o BigSegmentStoreStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Available) {
		toSerialize["available"] = o.Available
	}
	if !IsNil(o.PotentiallyStale) {
...
func (o *BigSegmentStoreStatus) UnmarshalJSON(data []byte) (err error) {
	varBigSegmentStoreStatus := _BigSegmentStoreStatus{}

	err = json.Unmarshal(data, &varBigSegmentStoreStatus)

	if err != nil {
		return err
	}

	*o = BigSegmentStoreStatus(varBigSegmentStoreStatus)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "available")
		delete(additionalProperties, "potentiallyStale")
