...
type Links struct {
	LaunchdarklyDocs *string `json:"launchdarklyDocs,omitempty"`
...
// GetLaunchdarklyDocs returns the LaunchdarklyDocs field value if set, zero value otherwise.
func (o *Links) GetLaunchdarklyDocs() string {
	if o == nil || o.LaunchdarklyDocs == nil {
		var ret string
		return ret
	}
	return *o.LaunchdarklyDocs
}

// GetLaunchdarklyDocsOk returns a tuple with the LaunchdarklyDocs field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Links) GetLaunchdarklyDocsOk() (*string, bool) {
	if o == nil || o.LaunchdarklyDocs == nil {
		return nil, false
	}
	return o.LaunchdarklyDocs, true
}
...
// SetLaunchdarklyDocs gets a reference to the given string and assigns it to the LaunchdarklyDocs field.
func (o *Links) SetLaunchdarklyDocs(v string) {
	o.LaunchdarklyDocs = &v
}
...
// GetSupportWebsite returns the SupportWebsite field value if set, zero value otherwise.
func (o *Links) GetSupportWebsite() string {
	if o == nil || o.SupportWebsite == nil {
		var ret string
		return ret
	}
	return *o.SupportWebsite
}

// GetSupportWebsiteOk returns a tuple with the SupportWebsite field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Links) GetSupportWebsiteOk() (*string, bool) {
	if o == nil || o.SupportWebsite == nil {
		return nil, false
	}
	return o.SupportWebsite, true
}
...
// SetSupportWebsite gets a reference to the given string and assigns it to the SupportWebsite field.
...
func (o Links) MarshalJSON() ([]byte, error) {
	...
	if o.LaunchdarklyDocs != nil {
		toSerialize["launchdarklyDocs"] = o.LaunchdarklyDocs
	}
	...
	if o.SupportWebsite != nil {
		toSerialize["supportWebsite"] = o.SupportWebsite
	}
