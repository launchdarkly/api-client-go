...
// checks if the ProjectSummaryCollection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectSummaryCollection{}
...
type _ProjectSummaryCollection ProjectSummaryCollection
...
func (o ProjectSummaryCollection) ToMap() (map[string]interface{}, error) {
...
func (o *ProjectSummaryCollection) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectSummaryCollection := _ProjectSummaryCollection{}

	err = json.Unmarshal(data, &varProjectSummaryCollection)

	if err != nil {
		return err
	}

	*o = ProjectSummaryCollection(varProjectSummaryCollection)
