...
// ApplicationVersionAdoption struct for ApplicationVersionAdoption
type ApplicationVersionAdoption struct {
...
func NewApplicationVersionAdoption() *ApplicationVersionAdoption {
	this := ApplicationVersionAdoption{}
	return &this
}
...
func (o ApplicationVersionAdoption) MarshalJSON() ([]byte, error) {
...
type NullableApplicationVersionAdoption struct {
	value *ApplicationVersionAdoption
	isSet bool
}

func (v NullableApplicationVersionAdoption) Get() *ApplicationVersionAdoption {
	return v.value
}

func (v *NullableApplicationVersionAdoption) Set(val *ApplicationVersionAdoption) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationVersionAdoption) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationVersionAdoption) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationVersionAdoption(val *ApplicationVersionAdoption) *NullableApplicationVersionAdoption {
	return &NullableApplicationVersionAdoption{value: val, isSet: true}
}

func (v NullableApplicationVersionAdoption) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationVersionAdoption) UnmarshalJSON(src []byte) error {
	v.isSet = true
