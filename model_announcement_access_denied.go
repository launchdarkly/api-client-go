...
// checks if the AnnouncementAccessDenied type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnnouncementAccessDenied{}

// AnnouncementAccessDenied struct for AnnouncementAccessDenied
type AnnouncementAccessDenied struct {
	Action string `json:"action"`
	Reason AnnouncementAccessDeniedReason `json:"reason"`
	AdditionalProperties map[string]interface{}
}

type _AnnouncementAccessDenied AnnouncementAccessDenied
...
func (o *AnnouncementAccessDenied) GetReason() AnnouncementAccessDeniedReason {
	if o == nil {
		var ret AnnouncementAccessDeniedReason
		return ret
	}
...
func (o AnnouncementAccessDenied) MarshalJSON() ([]byte, error) {
...
func (o AnnouncementAccessDenied) ToMap() (map[string]interface{}, error) {
...
func (o *AnnouncementAccessDenied) UnmarshalJSON(data []byte) (err error) {
	...
	varAnnouncementAccessDenied := _AnnouncementAccessDenied{}

	err = json.Unmarshal(data, &varAnnouncementAccessDenied)

	if err != nil {
		return err
	}

	*o = AnnouncementAccessDenied(varAnnouncementAccessDenied)
...
type NullableAnnouncementAccessDenied struct {
	value *AnnouncementAccessDenied
	isSet bool
}

func (v NullableAnnouncementAccessDenied) Get() *AnnouncementAccessDenied {
	return v.value
}

func (v *NullableAnnouncementAccessDenied) Set(val *AnnouncementAccessDenied) {
	v.value = val
	v.isSet = true
}

func (v NullableAnnouncementAccessDenied) IsSet() bool {
	return v.isSet
}

func (v *NullableAnnouncementAccessDenied) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnnouncementAccessDenied(val *AnnouncementAccessDenied) *NullableAnnouncementAccessDenied {
	return &NullableAnnouncementAccessDenied{value: val, isSet: true}
}

func (v NullableAnnouncementAccessDenied) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnnouncementAccessDenied) UnmarshalJSON(src []byte) error {
	v.isSet = true
