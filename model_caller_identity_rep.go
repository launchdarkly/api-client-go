...
// checks if the CallerIdentityRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CallerIdentityRep{}
...
type _CallerIdentityRep CallerIdentityRep
...
func (o CallerIdentityRep) ToMap() (map[string]interface{}, error) {
...
func (o *CallerIdentityRep) UnmarshalJSON(data []byte) (err error) {
	varCallerIdentityRep := _CallerIdentityRep{}

	err = json.Unmarshal(data, &varCallerIdentityRep)

	if err != nil {
		return err
	}

	*o = CallerIdentityRep(varCallerIdentityRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "authKind")
		delete(additionalProperties, "tokenKind")
