...
// checks if the ExperimentEnabledPeriodRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExperimentEnabledPeriodRep{}
...
type _ExperimentEnabledPeriodRep ExperimentEnabledPeriodRep
...
func (o ExperimentEnabledPeriodRep) ToMap() (map[string]interface{}, error) {
...
func (o *ExperimentEnabledPeriodRep) UnmarshalJSON(data []byte) (err error) {
	varExperimentEnabledPeriodRep := _ExperimentEnabledPeriodRep{}

	err = json.Unmarshal(data, &varExperimentEnabledPeriodRep)

	if err != nil {
		return err
	}

	*o = ExperimentEnabledPeriodRep(varExperimentEnabledPeriodRep)
