...
// ProductAnalyticsBetaApiService ProductAnalyticsBetaApi service
type ProductAnalyticsBetaApiService service

type ApiPostMetricsAnalyticsEventsQueryRequest struct {
	ctx context.Context
	ApiService *ProductAnalyticsBetaApiService
	projectKey string
	environmentKey string
	postProductAnalyticsQueryRep *PostProductAnalyticsQueryRep
}

func (r ApiPostMetricsAnalyticsEventsQueryRequest) PostProductAnalyticsQueryRep(postProductAnalyticsQueryRep PostProductAnalyticsQueryRep) ApiPostMetricsAnalyticsEventsQueryRequest {
	r.postProductAnalyticsQueryRep = &postProductAnalyticsQueryRep
	return r
}

func (r ApiPostMetricsAnalyticsEventsQueryRequest) Execute() (*ProductAnalyticsQueryResultsRep, *http.Response, error) {
	return r.ApiService.PostMetricsAnalyticsEventsQueryExecute(r)
}

/*
PostMetricsAnalyticsEventsQuery Query metrics analytics events

Get analytics of metric events.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectKey The project key
 @param environmentKey The environment key
 @return ApiPostMetricsAnalyticsEventsQueryRequest
*/
func (a *ProductAnalyticsBetaApiService) PostMetricsAnalyticsEventsQuery(ctx context.Context, projectKey string, environmentKey string) ApiPostMetricsAnalyticsEventsQueryRequest {
	return ApiPostMetricsAnalyticsEventsQueryRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return ProductAnalyticsQueryResultsRep
func (a *ProductAnalyticsBetaApiService) PostMetricsAnalyticsEventsQueryExecute(r ApiPostMetricsAnalyticsEventsQueryRequest) (*ProductAnalyticsQueryResultsRep, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ProductAnalyticsQueryResultsRep
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProductAnalyticsBetaApiService.PostMetricsAnalyticsEventsQuery")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/projects/{projectKey}/environments/{environmentKey}/metrics/query"
	...
	if r.postProductAnalyticsQueryRep == nil {
		return localVarReturnValue, nil, reportError("postProductAnalyticsQueryRep is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.postProductAnalyticsQueryRep
	if r.ctx != nil {
