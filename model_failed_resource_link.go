...
// checks if the FailedResourceLink type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FailedResourceLink{}

// FailedResourceLink struct for FailedResourceLink
type FailedResourceLink struct {
...
type _FailedResourceLink FailedResourceLink
...
func (o FailedResourceLink) MarshalJSON() ([]byte, error) {
...
func (o FailedResourceLink) ToMap() (map[string]interface{}, error) {
...
func (o *FailedResourceLink) UnmarshalJSON(data []byte) (err error) {
	...
	varFailedResourceLink := _FailedResourceLink{}

	err = json.Unmarshal(data, &varFailedResourceLink)

	if err != nil {
		return err
	}

	*o = FailedResourceLink(varFailedResourceLink)
...
type NullableFailedResourceLink struct {
	value *FailedResourceLink
	isSet bool
}

func (v NullableFailedResourceLink) Get() *FailedResourceLink {
	return v.value
}

func (v *NullableFailedResourceLink) Set(val *FailedResourceLink) {
	v.value = val
	v.isSet = true
}

func (v NullableFailedResourceLink) IsSet() bool {
	return v.isSet
}

func (v *NullableFailedResourceLink) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFailedResourceLink(val *FailedResourceLink) *NullableFailedResourceLink {
	return &NullableFailedResourceLink{value: val, isSet: true}
}

func (v NullableFailedResourceLink) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFailedResourceLink) UnmarshalJSON(src []byte) error {
	v.isSet = true
