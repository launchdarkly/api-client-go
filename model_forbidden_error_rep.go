...
// checks if the ForbiddenErrorRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForbiddenErrorRep{}
...
type _ForbiddenErrorRep ForbiddenErrorRep
...
func (o ForbiddenErrorRep) ToMap() (map[string]interface{}, error) {
...
func (o *ForbiddenErrorRep) UnmarshalJSON(data []byte) (err error) {
	...
	varForbiddenErrorRep := _ForbiddenErrorRep{}

	err = json.Unmarshal(data, &varForbiddenErrorRep)

	if err != nil {
		return err
	}

	*o = ForbiddenErrorRep(varForbiddenErrorRep)
