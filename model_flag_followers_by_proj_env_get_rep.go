...
// checks if the FlagFollowersByProjEnvGetRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagFollowersByProjEnvGetRep{}
...
type _FlagFollowersByProjEnvGetRep FlagFollowersByProjEnvGetRep
...
func NewFlagFollowersByProjEnvGetRep(links map[string]Link) *FlagFollowersByProjEnvGetRep {
	this := FlagFollowersByProjEnvGetRep{}
	this.Links = links
	return &this
}
...
func (o FlagFollowersByProjEnvGetRep) ToMap() (map[string]interface{}, error) {
...
func (o *FlagFollowersByProjEnvGetRep) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagFollowersByProjEnvGetRep := _FlagFollowersByProjEnvGetRep{}

	err = json.Unmarshal(data, &varFlagFollowersByProjEnvGetRep)

	if err != nil {
		return err
	}

	*o = FlagFollowersByProjEnvGetRep(varFlagFollowersByProjEnvGetRep)
...
type NullableFlagFollowersByProjEnvGetRep struct {
	value *FlagFollowersByProjEnvGetRep
	isSet bool
}
...
func NewNullableFlagFollowersByProjEnvGetRep(val *FlagFollowersByProjEnvGetRep) *NullableFlagFollowersByProjEnvGetRep {
	return &NullableFlagFollowersByProjEnvGetRep{value: val, isSet: true}
}
