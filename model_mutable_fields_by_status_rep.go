...
// checks if the MutableFieldsByStatusRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MutableFieldsByStatusRep{}

// MutableFieldsByStatusRep struct for MutableFieldsByStatusRep
type MutableFieldsByStatusRep struct {
	NotStarted *map[string][]string `json:"not_started,omitempty"`
	Running *map[string][]string `json:"running,omitempty"`
	Stopped *map[string][]string `json:"stopped,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MutableFieldsByStatusRep MutableFieldsByStatusRep

// NewMutableFieldsByStatusRep instantiates a new MutableFieldsByStatusRep object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMutableFieldsByStatusRep() *MutableFieldsByStatusRep {
	this := MutableFieldsByStatusRep{}
	return &this
}

// NewMutableFieldsByStatusRepWithDefaults instantiates a new MutableFieldsByStatusRep object
...
// GetNotStarted returns the NotStarted field value if set, zero value otherwise.
func (o *MutableFieldsByStatusRep) GetNotStarted() map[string][]string {
	if o == nil || IsNil(o.NotStarted) {
...
// GetNotStartedOk returns a tuple with the NotStarted field value if set, nil otherwise
...
// SetNotStarted gets a reference to the given map[string][]string and assigns it to the NotStarted field.
...
// SetRunning gets a reference to the given map[string][]string and assigns it to the Running field.
...
// SetStopped gets a reference to the given map[string][]string and assigns it to the Stopped field.
func (o *MutableFieldsByStatusRep) SetStopped(v map[string][]string) {
	o.Stopped = &v
}

func (o MutableFieldsByStatusRep) MarshalJSON() ([]byte, error) {
...
func (o MutableFieldsByStatusRep) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.NotStarted) {
		toSerialize["not_started"] = o.NotStarted
	}
	if !IsNil(o.Running) {
...
func (o *MutableFieldsByStatusRep) UnmarshalJSON(data []byte) (err error) {
	varMutableFieldsByStatusRep := _MutableFieldsByStatusRep{}

	err = json.Unmarshal(data, &varMutableFieldsByStatusRep)

	if err != nil {
		return err
	}

	*o = MutableFieldsByStatusRep(varMutableFieldsByStatusRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "not_started")
...
type NullableMutableFieldsByStatusRep struct {
	value *MutableFieldsByStatusRep
	isSet bool
}

func (v NullableMutableFieldsByStatusRep) Get() *MutableFieldsByStatusRep {
	return v.value
}

func (v *NullableMutableFieldsByStatusRep) Set(val *MutableFieldsByStatusRep) {
	v.value = val
	v.isSet = true
}

func (v NullableMutableFieldsByStatusRep) IsSet() bool {
	return v.isSet
}

func (v *NullableMutableFieldsByStatusRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMutableFieldsByStatusRep(val *MutableFieldsByStatusRep) *NullableMutableFieldsByStatusRep {
	return &NullableMutableFieldsByStatusRep{value: val, isSet: true}
}

func (v NullableMutableFieldsByStatusRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMutableFieldsByStatusRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
