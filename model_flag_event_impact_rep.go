...
// checks if the FlagEventImpactRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagEventImpactRep{}
...
type _FlagEventImpactRep FlagEventImpactRep
...
func (o *FlagEventImpactRep) GetEvaluationsSummary() EvaluationsSummary {
	if o == nil || IsNil(o.EvaluationsSummary) {
...
func (o FlagEventImpactRep) ToMap() (map[string]interface{}, error) {
...
func (o *FlagEventImpactRep) UnmarshalJSON(data []byte) (err error) {
	varFlagEventImpactRep := _FlagEventImpactRep{}

	err = json.Unmarshal(data, &varFlagEventImpactRep)

	if err != nil {
		return err
	}

	*o = FlagEventImpactRep(varFlagEventImpactRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "evaluationsSummary")
