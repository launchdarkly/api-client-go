...
type _FeatureFlags FeatureFlags
...
func (o *FeatureFlags) GetTotalCountWithDifferences() int32 {
	if o == nil || IsNil(o.TotalCountWithDifferences) {
		var ret int32
		return ret
	}
...
func (o FeatureFlags) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TotalCountWithDifferences) {
...
func (o *FeatureFlags) UnmarshalJSON(data []byte) (err error) {
	...
	varFeatureFlags := _FeatureFlags{}

	err = json.Unmarshal(data, &varFeatureFlags)

	if err != nil {
		return err
	}

	*o = FeatureFlags(varFeatureFlags)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "totalCountWithDifferences")
