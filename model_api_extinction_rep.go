...
// ApiExtinctionRep struct for ApiExtinctionRep
type ApiExtinctionRep struct {
...
func (o ApiExtinctionRep) MarshalJSON() ([]byte, error) {
...
type NullableApiExtinctionRep struct {
	value *ApiExtinctionRep
	isSet bool
}

func (v NullableApiExtinctionRep) Get() *ApiExtinctionRep {
	return v.value
}

func (v *NullableApiExtinctionRep) Set(val *ApiExtinctionRep) {
	v.value = val
	v.isSet = true
}

func (v NullableApiExtinctionRep) IsSet() bool {
	return v.isSet
}

func (v *NullableApiExtinctionRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiExtinctionRep(val *ApiExtinctionRep) *NullableApiExtinctionRep {
	return &NullableApiExtinctionRep{value: val, isSet: true}
}

func (v NullableApiExtinctionRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiExtinctionRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
