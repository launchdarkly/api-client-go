...
// checks if the ExperimentAllocationRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExperimentAllocationRep{}
...
type _ExperimentAllocationRep ExperimentAllocationRep
...
func (o ExperimentAllocationRep) ToMap() (map[string]interface{}, error) {
...
func (o *ExperimentAllocationRep) UnmarshalJSON(data []byte) (err error) {
	...
	varExperimentAllocationRep := _ExperimentAllocationRep{}

	err = json.Unmarshal(data, &varExperimentAllocationRep)

	if err != nil {
		return err
	}

	*o = ExperimentAllocationRep(varExperimentAllocationRep)
