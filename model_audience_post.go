...
// checks if the AudiencePost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AudiencePost{}
...
type _AudiencePost AudiencePost
...
func (o AudiencePost) ToMap() (map[string]interface{}, error) {
...
func (o *AudiencePost) UnmarshalJSON(data []byte) (err error) {
	...
	varAudiencePost := _AudiencePost{}

	err = json.Unmarshal(data, &varAudiencePost)

	if err != nil {
		return err
	}

	*o = AudiencePost(varAudiencePost)
