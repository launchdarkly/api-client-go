...
// checks if the ConflictOutput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConflictOutput{}
...
type _ConflictOutput ConflictOutput
...
func (o ConflictOutput) ToMap() (map[string]interface{}, error) {
...
func (o *ConflictOutput) UnmarshalJSON(data []byte) (err error) {
	...
	varConflictOutput := _ConflictOutput{}

	err = json.Unmarshal(data, &varConflictOutput)

	if err != nil {
		return err
	}

	*o = ConflictOutput(varConflictOutput)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "stageId")
...
func NewNullableConflictOutput(val *ConflictOutput) *NullableConflictOutput {
	return &NullableConflictOutput{value: val, isSet: true}
}
