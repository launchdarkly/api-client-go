...
// checks if the UnlinkResourceSuccessResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnlinkResourceSuccessResponse{}

// UnlinkResourceSuccessResponse struct for UnlinkResourceSuccessResponse
type UnlinkResourceSuccessResponse struct {
...
type _UnlinkResourceSuccessResponse UnlinkResourceSuccessResponse
...
func NewUnlinkResourceSuccessResponse(successCount int32, failureCount int32) *UnlinkResourceSuccessResponse {
	this := UnlinkResourceSuccessResponse{}
...
func (o UnlinkResourceSuccessResponse) MarshalJSON() ([]byte, error) {
...
func (o UnlinkResourceSuccessResponse) ToMap() (map[string]interface{}, error) {
...
func (o *UnlinkResourceSuccessResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varUnlinkResourceSuccessResponse := _UnlinkResourceSuccessResponse{}

	err = json.Unmarshal(data, &varUnlinkResourceSuccessResponse)

	if err != nil {
		return err
	}

	*o = UnlinkResourceSuccessResponse(varUnlinkResourceSuccessResponse)
...
type NullableUnlinkResourceSuccessResponse struct {
	value *UnlinkResourceSuccessResponse
	isSet bool
}

func (v NullableUnlinkResourceSuccessResponse) Get() *UnlinkResourceSuccessResponse {
	return v.value
}

func (v *NullableUnlinkResourceSuccessResponse) Set(val *UnlinkResourceSuccessResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUnlinkResourceSuccessResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUnlinkResourceSuccessResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnlinkResourceSuccessResponse(val *UnlinkResourceSuccessResponse) *NullableUnlinkResourceSuccessResponse {
	return &NullableUnlinkResourceSuccessResponse{value: val, isSet: true}
}

func (v NullableUnlinkResourceSuccessResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnlinkResourceSuccessResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
