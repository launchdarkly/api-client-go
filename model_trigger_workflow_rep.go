...
// checks if the TriggerWorkflowRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TriggerWorkflowRep{}
...
type TriggerWorkflowRep struct {
	...
	LastFailedAt *int64 `json:"_lastFailedAt,omitempty"`
...
type _TriggerWorkflowRep TriggerWorkflowRep
...
func (o *TriggerWorkflowRep) GetRecentTriggerBodies() []RecentTriggerBody {
	if o == nil || IsNil(o.RecentTriggerBodies) {
...
func (o TriggerWorkflowRep) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LastFailedAt) {
		toSerialize["_lastFailedAt"] = o.LastFailedAt
	}
...
func (o *TriggerWorkflowRep) UnmarshalJSON(data []byte) (err error) {
	varTriggerWorkflowRep := _TriggerWorkflowRep{}

	err = json.Unmarshal(data, &varTriggerWorkflowRep)

	if err != nil {
		return err
	}

	*o = TriggerWorkflowRep(varTriggerWorkflowRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_lastFailedAt")
		delete(additionalProperties, "_integrationKey")
		delete(additionalProperties, "instructions")
		delete(additionalProperties, "_lastTriggeredAt")
		delete(additionalProperties, "_recentTriggerBodies")
		delete(additionalProperties, "_triggerCount")
		delete(additionalProperties, "triggerURL")
