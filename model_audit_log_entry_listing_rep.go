...
// checks if the AuditLogEntryListingRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuditLogEntryListingRep{}
...
type AuditLogEntryListingRep struct {
	...
	RelatedFlag *RelatedFlag `json:"relatedFlag,omitempty"`
	RelatedExperiment *RelatedExperiment `json:"relatedExperiment,omitempty"`
	RelatedAIConfig *RelatedAIConfig `json:"relatedAIConfig,omitempty"`
...
type _AuditLogEntryListingRep AuditLogEntryListingRep
...
// GetRelatedFlag returns the RelatedFlag field value if set, zero value otherwise.
func (o *AuditLogEntryListingRep) GetRelatedFlag() RelatedFlag {
	if o == nil || IsNil(o.RelatedFlag) {
		var ret RelatedFlag
		return ret
	}
	return *o.RelatedFlag
}

// GetRelatedFlagOk returns a tuple with the RelatedFlag field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuditLogEntryListingRep) GetRelatedFlagOk() (*RelatedFlag, bool) {
	if o == nil || IsNil(o.RelatedFlag) {
		return nil, false
	}
	return o.RelatedFlag, true
}

// HasRelatedFlag returns a boolean if a field has been set.
func (o *AuditLogEntryListingRep) HasRelatedFlag() bool {
	if o != nil && !IsNil(o.RelatedFlag) {
		return true
	}
...
// SetRelatedFlag gets a reference to the given RelatedFlag and assigns it to the RelatedFlag field.
func (o *AuditLogEntryListingRep) SetRelatedFlag(v RelatedFlag) {
	o.RelatedFlag = &v
}

// GetRelatedExperiment returns the RelatedExperiment field value if set, zero value otherwise.
func (o *AuditLogEntryListingRep) GetRelatedExperiment() RelatedExperiment {
	if o == nil || IsNil(o.RelatedExperiment) {
		var ret RelatedExperiment
		return ret
	}
	return *o.RelatedExperiment
}

// GetRelatedExperimentOk returns a tuple with the RelatedExperiment field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuditLogEntryListingRep) GetRelatedExperimentOk() (*RelatedExperiment, bool) {
	if o == nil || IsNil(o.RelatedExperiment) {
		return nil, false
	}
	return o.RelatedExperiment, true
}

// HasRelatedExperiment returns a boolean if a field has been set.
func (o *AuditLogEntryListingRep) HasRelatedExperiment() bool {
	if o != nil && !IsNil(o.RelatedExperiment) {
		return true
	}
...
// SetRelatedExperiment gets a reference to the given RelatedExperiment and assigns it to the RelatedExperiment field.
func (o *AuditLogEntryListingRep) SetRelatedExperiment(v RelatedExperiment) {
	o.RelatedExperiment = &v
}

// GetRelatedAIConfig returns the RelatedAIConfig field value if set, zero value otherwise.
func (o *AuditLogEntryListingRep) GetRelatedAIConfig() RelatedAIConfig {
	if o == nil || IsNil(o.RelatedAIConfig) {
		var ret RelatedAIConfig
		return ret
	}
	return *o.RelatedAIConfig
}

// GetRelatedAIConfigOk returns a tuple with the RelatedAIConfig field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AuditLogEntryListingRep) GetRelatedAIConfigOk() (*RelatedAIConfig, bool) {
	if o == nil || IsNil(o.RelatedAIConfig) {
		return nil, false
	}
	return o.RelatedAIConfig, true
}

// HasRelatedAIConfig returns a boolean if a field has been set.
func (o *AuditLogEntryListingRep) HasRelatedAIConfig() bool {
	if o != nil && !IsNil(o.RelatedAIConfig) {
		return true
	}
...
// SetRelatedAIConfig gets a reference to the given RelatedAIConfig and assigns it to the RelatedAIConfig field.
func (o *AuditLogEntryListingRep) SetRelatedAIConfig(v RelatedAIConfig) {
	o.RelatedAIConfig = &v
}
...
func (o AuditLogEntryListingRep) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RelatedFlag) {
		toSerialize["relatedFlag"] = o.RelatedFlag
	}
	if !IsNil(o.RelatedExperiment) {
		toSerialize["relatedExperiment"] = o.RelatedExperiment
	}
	if !IsNil(o.RelatedAIConfig) {
		toSerialize["relatedAIConfig"] = o.RelatedAIConfig
	}
	if !IsNil(o.Subject) {
...
func (o *AuditLogEntryListingRep) UnmarshalJSON(data []byte) (err error) {
	...
	varAuditLogEntryListingRep := _AuditLogEntryListingRep{}

	err = json.Unmarshal(data, &varAuditLogEntryListingRep)

	if err != nil {
		return err
	}

	*o = AuditLogEntryListingRep(varAuditLogEntryListingRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_accountId")
		delete(additionalProperties, "date")
		delete(additionalProperties, "accesses")
		delete(additionalProperties, "kind")
		delete(additionalProperties, "name")
		delete(additionalProperties, "description")
		delete(additionalProperties, "shortDescription")
		delete(additionalProperties, "comment")
		delete(additionalProperties, "relatedFlag")
		delete(additionalProperties, "relatedExperiment")
		delete(additionalProperties, "relatedAIConfig")
		delete(additionalProperties, "subject")
		delete(additionalProperties, "member")
		delete(additionalProperties, "token")
		delete(additionalProperties, "app")
		delete(additionalProperties, "titleVerb")
