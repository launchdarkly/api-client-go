...
// checks if the GetAnnouncementsPublic200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAnnouncementsPublic200Response{}

// GetAnnouncementsPublic200Response struct for GetAnnouncementsPublic200Response
type GetAnnouncementsPublic200Response struct {
	Items []AnnouncementResponse `json:"items"`
	Links AnnouncementPaginatedLinks `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _GetAnnouncementsPublic200Response GetAnnouncementsPublic200Response
...
func (o *GetAnnouncementsPublic200Response) GetLinks() AnnouncementPaginatedLinks {
	if o == nil {
		var ret AnnouncementPaginatedLinks
		return ret
	}
...
func (o GetAnnouncementsPublic200Response) MarshalJSON() ([]byte, error) {
...
func (o GetAnnouncementsPublic200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetAnnouncementsPublic200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAnnouncementsPublic200Response := _GetAnnouncementsPublic200Response{}

	err = json.Unmarshal(data, &varGetAnnouncementsPublic200Response)

	if err != nil {
		return err
	}

	*o = GetAnnouncementsPublic200Response(varGetAnnouncementsPublic200Response)
...
type NullableGetAnnouncementsPublic200Response struct {
	value *GetAnnouncementsPublic200Response
	isSet bool
}

func (v NullableGetAnnouncementsPublic200Response) Get() *GetAnnouncementsPublic200Response {
	return v.value
}

func (v *NullableGetAnnouncementsPublic200Response) Set(val *GetAnnouncementsPublic200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAnnouncementsPublic200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAnnouncementsPublic200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAnnouncementsPublic200Response(val *GetAnnouncementsPublic200Response) *NullableGetAnnouncementsPublic200Response {
	return &NullableGetAnnouncementsPublic200Response{value: val, isSet: true}
}

func (v NullableGetAnnouncementsPublic200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAnnouncementsPublic200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
