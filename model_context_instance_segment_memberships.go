...
// checks if the ContextInstanceSegmentMemberships type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContextInstanceSegmentMemberships{}

// ContextInstanceSegmentMemberships struct for ContextInstanceSegmentMemberships
type ContextInstanceSegmentMemberships struct {
	Items []ContextInstanceSegmentMembership `json:"items"`
	// The location and content type of related resources
	Links map[string]Link `json:"_links"`
	AdditionalProperties map[string]interface{}
}

type _ContextInstanceSegmentMemberships ContextInstanceSegmentMemberships
...
func NewContextInstanceSegmentMemberships(items []ContextInstanceSegmentMembership, links map[string]Link) *ContextInstanceSegmentMemberships {
	this := ContextInstanceSegmentMemberships{}
	this.Items = items
	this.Links = links
	return &this
}
...
func (o *ContextInstanceSegmentMemberships) GetItems() []ContextInstanceSegmentMembership {
	if o == nil {
		var ret []ContextInstanceSegmentMembership
		return ret
	}
...
func (o ContextInstanceSegmentMemberships) ToMap() (map[string]interface{}, error) {
...
func (o *ContextInstanceSegmentMemberships) UnmarshalJSON(data []byte) (err error) {
	...
	varContextInstanceSegmentMemberships := _ContextInstanceSegmentMemberships{}

	err = json.Unmarshal(data, &varContextInstanceSegmentMemberships)

	if err != nil {
		return err
	}

	*o = ContextInstanceSegmentMemberships(varContextInstanceSegmentMemberships)
...
type NullableContextInstanceSegmentMemberships struct {
	value *ContextInstanceSegmentMemberships
	isSet bool
}
...
func NewNullableContextInstanceSegmentMemberships(val *ContextInstanceSegmentMemberships) *NullableContextInstanceSegmentMemberships {
	return &NullableContextInstanceSegmentMemberships{value: val, isSet: true}
}
