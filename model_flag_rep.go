...
// checks if the FlagRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagRep{}
...
func (o *FlagRep) GetTargetingRule() string {
	if o == nil || IsNil(o.TargetingRule) {
		var ret string
		return ret
	}
...
func (o *FlagRep) GetTargetingRuleDescription() string {
	if o == nil || IsNil(o.TargetingRuleDescription) {
		var ret string
		return ret
	}
...
func (o *FlagRep) GetTargetingRuleClauses() []interface{} {
	if o == nil || IsNil(o.TargetingRuleClauses) {
		var ret []interface{}
		return ret
	}
...
func (o *FlagRep) GetFlagConfigVersion() int32 {
	if o == nil || IsNil(o.FlagConfigVersion) {
		var ret int32
		return ret
	}
...
func (o *FlagRep) GetNotInExperimentVariationId() string {
	if o == nil || IsNil(o.NotInExperimentVariationId) {
		var ret string
		return ret
	}
...
func (o *FlagRep) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varFlagRep)

	if err != nil {
		return err
	}

	*o = FlagRep(varFlagRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "targetingRule")
		delete(additionalProperties, "targetingRuleDescription")
		delete(additionalProperties, "targetingRuleClauses")
		delete(additionalProperties, "flagConfigVersion")
		delete(additionalProperties, "notInExperimentVariationId")
