...
// checks if the AIConfigTargetingEnvironmentRuleClause type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AIConfigTargetingEnvironmentRuleClause{}

// AIConfigTargetingEnvironmentRuleClause struct for AIConfigTargetingEnvironmentRuleClause
type AIConfigTargetingEnvironmentRuleClause struct {
...
type _AIConfigTargetingEnvironmentRuleClause AIConfigTargetingEnvironmentRuleClause
...
func NewAIConfigTargetingEnvironmentRuleClause(attribute string, id string, negate bool, op string, values []interface{}) *AIConfigTargetingEnvironmentRuleClause {
	this := AIConfigTargetingEnvironmentRuleClause{}
...
func (o AIConfigTargetingEnvironmentRuleClause) MarshalJSON() ([]byte, error) {
...
func (o AIConfigTargetingEnvironmentRuleClause) ToMap() (map[string]interface{}, error) {
...
func (o *AIConfigTargetingEnvironmentRuleClause) UnmarshalJSON(data []byte) (err error) {
	...
	varAIConfigTargetingEnvironmentRuleClause := _AIConfigTargetingEnvironmentRuleClause{}

	err = json.Unmarshal(data, &varAIConfigTargetingEnvironmentRuleClause)

	if err != nil {
		return err
	}

	*o = AIConfigTargetingEnvironmentRuleClause(varAIConfigTargetingEnvironmentRuleClause)
...
type NullableAIConfigTargetingEnvironmentRuleClause struct {
	value *AIConfigTargetingEnvironmentRuleClause
	isSet bool
}

func (v NullableAIConfigTargetingEnvironmentRuleClause) Get() *AIConfigTargetingEnvironmentRuleClause {
	return v.value
}

func (v *NullableAIConfigTargetingEnvironmentRuleClause) Set(val *AIConfigTargetingEnvironmentRuleClause) {
	v.value = val
	v.isSet = true
}

func (v NullableAIConfigTargetingEnvironmentRuleClause) IsSet() bool {
	return v.isSet
}

func (v *NullableAIConfigTargetingEnvironmentRuleClause) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAIConfigTargetingEnvironmentRuleClause(val *AIConfigTargetingEnvironmentRuleClause) *NullableAIConfigTargetingEnvironmentRuleClause {
	return &NullableAIConfigTargetingEnvironmentRuleClause{value: val, isSet: true}
}

func (v NullableAIConfigTargetingEnvironmentRuleClause) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAIConfigTargetingEnvironmentRuleClause) UnmarshalJSON(src []byte) error {
	v.isSet = true
