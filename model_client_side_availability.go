...
// checks if the ClientSideAvailability type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClientSideAvailability{}
...
type _ClientSideAvailability ClientSideAvailability
...
func (o *ClientSideAvailability) GetUsingMobileKey() bool {
	if o == nil || IsNil(o.UsingMobileKey) {
		var ret bool
		return ret
	}
...
func (o *ClientSideAvailability) GetUsingEnvironmentId() bool {
	if o == nil || IsNil(o.UsingEnvironmentId) {
		var ret bool
		return ret
	}
...
func (o ClientSideAvailability) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.UsingMobileKey) {
		toSerialize["usingMobileKey"] = o.UsingMobileKey
	}
	if !IsNil(o.UsingEnvironmentId) {
...
func (o *ClientSideAvailability) UnmarshalJSON(data []byte) (err error) {
	varClientSideAvailability := _ClientSideAvailability{}

	err = json.Unmarshal(data, &varClientSideAvailability)

	if err != nil {
		return err
	}

	*o = ClientSideAvailability(varClientSideAvailability)
