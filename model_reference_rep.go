...
// checks if the ReferenceRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReferenceRep{}
...
type _ReferenceRep ReferenceRep
...
func (o ReferenceRep) ToMap() (map[string]interface{}, error) {
...
func (o *ReferenceRep) UnmarshalJSON(data []byte) (err error) {
	...
	varReferenceRep := _ReferenceRep{}

	err = json.Unmarshal(data, &varReferenceRep)

	if err != nil {
		return err
	}

	*o = ReferenceRep(varReferenceRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "hunks")
