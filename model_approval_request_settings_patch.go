...
// checks if the ApprovalRequestSettingsPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApprovalRequestSettingsPatch{}

// ApprovalRequestSettingsPatch struct for ApprovalRequestSettingsPatch
type ApprovalRequestSettingsPatch struct {
	...
	AutoApplyApprovedChanges NullableBool `json:"autoApplyApprovedChanges,omitempty"`
	...
	ServiceKindConfigurationId NullableString `json:"serviceKindConfigurationId,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ApprovalRequestSettingsPatch ApprovalRequestSettingsPatch
...
func NewApprovalRequestSettingsPatch(environmentKey string, resourceKind string) *ApprovalRequestSettingsPatch {
	this := ApprovalRequestSettingsPatch{}
...
// GetAutoApplyApprovedChanges returns the AutoApplyApprovedChanges field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ApprovalRequestSettingsPatch) GetAutoApplyApprovedChanges() bool {
	if o == nil || IsNil(o.AutoApplyApprovedChanges.Get()) {
		var ret bool
		return ret
	}
	return *o.AutoApplyApprovedChanges.Get()
}
...
func (o *ApprovalRequestSettingsPatch) GetAutoApplyApprovedChangesOk() (*bool, bool) {
	...
	return o.AutoApplyApprovedChanges.Get(), o.AutoApplyApprovedChanges.IsSet()
}
...
func (o *ApprovalRequestSettingsPatch) HasAutoApplyApprovedChanges() bool {
	if o != nil && o.AutoApplyApprovedChanges.IsSet() {
		return true
	}
...
// SetAutoApplyApprovedChanges gets a reference to the given NullableBool and assigns it to the AutoApplyApprovedChanges field.
func (o *ApprovalRequestSettingsPatch) SetAutoApplyApprovedChanges(v bool) {
	o.AutoApplyApprovedChanges.Set(&v)
}
// SetAutoApplyApprovedChangesNil sets the value for AutoApplyApprovedChanges to be an explicit nil
func (o *ApprovalRequestSettingsPatch) SetAutoApplyApprovedChangesNil() {
	o.AutoApplyApprovedChanges.Set(nil)
}
...
func (o *ApprovalRequestSettingsPatch) UnsetAutoApplyApprovedChanges() {
	o.AutoApplyApprovedChanges.Unset()
}
...
func (o *ApprovalRequestSettingsPatch) GetBypassApprovalsForPendingChanges() bool {
	if o == nil || IsNil(o.BypassApprovalsForPendingChanges) {
		var ret bool
		return ret
	}
...
func (o *ApprovalRequestSettingsPatch) GetCanApplyDeclinedChanges() bool {
	if o == nil || IsNil(o.CanApplyDeclinedChanges) {
		var ret bool
		return ret
	}
...
func (o *ApprovalRequestSettingsPatch) GetCanReviewOwnRequest() bool {
	if o == nil || IsNil(o.CanReviewOwnRequest) {
		var ret bool
		return ret
	}
...
func (o *ApprovalRequestSettingsPatch) GetMinNumApprovals() int32 {
	if o == nil || IsNil(o.MinNumApprovals) {
		var ret int32
		return ret
	}
...
func (o *ApprovalRequestSettingsPatch) GetRequiredApprovalTags() []string {
	if o == nil || IsNil(o.RequiredApprovalTags) {
		var ret []string
		return ret
	}
...
// GetServiceKindConfigurationId returns the ServiceKindConfigurationId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ApprovalRequestSettingsPatch) GetServiceKindConfigurationId() string {
	if o == nil || IsNil(o.ServiceKindConfigurationId.Get()) {
		var ret string
		return ret
	}
	return *o.ServiceKindConfigurationId.Get()
}
...
func (o *ApprovalRequestSettingsPatch) GetServiceKindConfigurationIdOk() (*string, bool) {
	...
	return o.ServiceKindConfigurationId.Get(), o.ServiceKindConfigurationId.IsSet()
}
...
func (o *ApprovalRequestSettingsPatch) HasServiceKindConfigurationId() bool {
	if o != nil && o.ServiceKindConfigurationId.IsSet() {
		return true
	}
...
// SetServiceKindConfigurationId gets a reference to the given NullableString and assigns it to the ServiceKindConfigurationId field.
func (o *ApprovalRequestSettingsPatch) SetServiceKindConfigurationId(v string) {
	o.ServiceKindConfigurationId.Set(&v)
}
// SetServiceKindConfigurationIdNil sets the value for ServiceKindConfigurationId to be an explicit nil
func (o *ApprovalRequestSettingsPatch) SetServiceKindConfigurationIdNil() {
	o.ServiceKindConfigurationId.Set(nil)
}
...
func (o *ApprovalRequestSettingsPatch) UnsetServiceKindConfigurationId() {
	o.ServiceKindConfigurationId.Unset()
}

func (o ApprovalRequestSettingsPatch) MarshalJSON() ([]byte, error) {
...
func (o ApprovalRequestSettingsPatch) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if o.AutoApplyApprovedChanges.IsSet() {
		toSerialize["autoApplyApprovedChanges"] = o.AutoApplyApprovedChanges.Get()
	}
	if !IsNil(o.BypassApprovalsForPendingChanges) {
		toSerialize["bypassApprovalsForPendingChanges"] = o.BypassApprovalsForPendingChanges
	}
	if !IsNil(o.CanApplyDeclinedChanges) {
		toSerialize["canApplyDeclinedChanges"] = o.CanApplyDeclinedChanges
	}
	if !IsNil(o.CanReviewOwnRequest) {
		toSerialize["canReviewOwnRequest"] = o.CanReviewOwnRequest
	}
	toSerialize["environmentKey"] = o.EnvironmentKey
	if !IsNil(o.MinNumApprovals) {
		toSerialize["minNumApprovals"] = o.MinNumApprovals
	}
	if !IsNil(o.Required) {
		toSerialize["required"] = o.Required
	}
	if !IsNil(o.RequiredApprovalTags) {
	...
	if !IsNil(o.ServiceKind) {
		toSerialize["serviceKind"] = o.ServiceKind
	}
	if o.ServiceKindConfigurationId.IsSet() {
		toSerialize["serviceKindConfigurationId"] = o.ServiceKindConfigurationId.Get()
	}
...
func (o *ApprovalRequestSettingsPatch) UnmarshalJSON(data []byte) (err error) {
	...
	varApprovalRequestSettingsPatch := _ApprovalRequestSettingsPatch{}

	err = json.Unmarshal(data, &varApprovalRequestSettingsPatch)

	if err != nil {
		return err
	}

	*o = ApprovalRequestSettingsPatch(varApprovalRequestSettingsPatch)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "autoApplyApprovedChanges")
		delete(additionalProperties, "bypassApprovalsForPendingChanges")
		delete(additionalProperties, "canApplyDeclinedChanges")
		delete(additionalProperties, "canReviewOwnRequest")
		delete(additionalProperties, "environmentKey")
		delete(additionalProperties, "minNumApprovals")
		delete(additionalProperties, "required")
		delete(additionalProperties, "requiredApprovalTags")
		delete(additionalProperties, "resourceKind")
		delete(additionalProperties, "serviceConfig")
		delete(additionalProperties, "serviceKind")
		delete(additionalProperties, "serviceKindConfigurationId")
...
type NullableApprovalRequestSettingsPatch struct {
	value *ApprovalRequestSettingsPatch
	isSet bool
}

func (v NullableApprovalRequestSettingsPatch) Get() *ApprovalRequestSettingsPatch {
	return v.value
}

func (v *NullableApprovalRequestSettingsPatch) Set(val *ApprovalRequestSettingsPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalRequestSettingsPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalRequestSettingsPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalRequestSettingsPatch(val *ApprovalRequestSettingsPatch) *NullableApprovalRequestSettingsPatch {
	return &NullableApprovalRequestSettingsPatch{value: val, isSet: true}
}

func (v NullableApprovalRequestSettingsPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalRequestSettingsPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
