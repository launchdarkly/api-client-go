...
// InternalEnvironment struct for InternalEnvironment
type InternalEnvironment struct {
	...
	Pubnub InternalPubnubRep `json:"_pubnub"`
}
...
// GetPubnub returns the Pubnub field value
func (o *InternalEnvironment) GetPubnub() InternalPubnubRep {
	if o == nil {
		var ret InternalPubnubRep
		return ret
	}
...
// GetPubnubOk returns a tuple with the Pubnub field value
// and a boolean to check if the value has been set.
func (o *InternalEnvironment) GetPubnubOk() (*InternalPubnubRep, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Pubnub, true
}

// SetPubnub sets field value
func (o *InternalEnvironment) SetPubnub(v InternalPubnubRep) {
	o.Pubnub = v
}

func (o InternalEnvironment) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["_pubnub"] = o.Pubnub
	}
	return json.Marshal(toSerialize)
}

type NullableInternalEnvironment struct {
	value *InternalEnvironment
	isSet bool
}

func (v NullableInternalEnvironment) Get() *InternalEnvironment {
	return v.value
}

func (v *NullableInternalEnvironment) Set(val *InternalEnvironment) {
	v.value = val
	v.isSet = true
}

func (v NullableInternalEnvironment) IsSet() bool {
	return v.isSet
}

func (v *NullableInternalEnvironment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInternalEnvironment(val *InternalEnvironment) *NullableInternalEnvironment {
	return &NullableInternalEnvironment{value: val, isSet: true}
}

func (v NullableInternalEnvironment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInternalEnvironment) UnmarshalJSON(src []byte) error {
	v.isSet = true
