...
// checks if the ExpandedDirectlyLinkedSegments type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedDirectlyLinkedSegments{}

// ExpandedDirectlyLinkedSegments struct for ExpandedDirectlyLinkedSegments
type ExpandedDirectlyLinkedSegments struct {
	Items []ExpandedDirectlyLinkedSegment `json:"items"`
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _ExpandedDirectlyLinkedSegments ExpandedDirectlyLinkedSegments
...
func NewExpandedDirectlyLinkedSegments(items []ExpandedDirectlyLinkedSegment, totalCount int32) *ExpandedDirectlyLinkedSegments {
	this := ExpandedDirectlyLinkedSegments{}
	this.Items = items
...
func (o *ExpandedDirectlyLinkedSegments) GetItems() []ExpandedDirectlyLinkedSegment {
	if o == nil {
		var ret []ExpandedDirectlyLinkedSegment
		return ret
	}
...
func (o ExpandedDirectlyLinkedSegments) MarshalJSON() ([]byte, error) {
...
func (o ExpandedDirectlyLinkedSegments) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedDirectlyLinkedSegments) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedDirectlyLinkedSegments := _ExpandedDirectlyLinkedSegments{}

	err = json.Unmarshal(data, &varExpandedDirectlyLinkedSegments)

	if err != nil {
		return err
	}

	*o = ExpandedDirectlyLinkedSegments(varExpandedDirectlyLinkedSegments)
...
type NullableExpandedDirectlyLinkedSegments struct {
	value *ExpandedDirectlyLinkedSegments
	isSet bool
}

func (v NullableExpandedDirectlyLinkedSegments) Get() *ExpandedDirectlyLinkedSegments {
	return v.value
}

func (v *NullableExpandedDirectlyLinkedSegments) Set(val *ExpandedDirectlyLinkedSegments) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedDirectlyLinkedSegments) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedDirectlyLinkedSegments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedDirectlyLinkedSegments(val *ExpandedDirectlyLinkedSegments) *NullableExpandedDirectlyLinkedSegments {
	return &NullableExpandedDirectlyLinkedSegments{value: val, isSet: true}
}

func (v NullableExpandedDirectlyLinkedSegments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedDirectlyLinkedSegments) UnmarshalJSON(src []byte) error {
	v.isSet = true
