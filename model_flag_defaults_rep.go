...
// checks if the FlagDefaultsRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagDefaultsRep{}
...
type _FlagDefaultsRep FlagDefaultsRep
...
func (o *FlagDefaultsRep) GetBooleanDefaults() BooleanDefaults {
	if o == nil || IsNil(o.BooleanDefaults) {
...
func (o FlagDefaultsRep) ToMap() (map[string]interface{}, error) {
...
func (o *FlagDefaultsRep) UnmarshalJSON(data []byte) (err error) {
	varFlagDefaultsRep := _FlagDefaultsRep{}

	err = json.Unmarshal(data, &varFlagDefaultsRep)

	if err != nil {
		return err
	}

	*o = FlagDefaultsRep(varFlagDefaultsRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "booleanDefaults")
