...
type _Prerequisite Prerequisite
...
func (o *Prerequisite) UnmarshalJSON(data []byte) (err error) {
	...
	varPrerequisite := _Prerequisite{}

	err = json.Unmarshal(data, &varPrerequisite)

	if err != nil {
		return err
	}

	*o = Prerequisite(varPrerequisite)
