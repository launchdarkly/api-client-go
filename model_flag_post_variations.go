...
// FlagPostVariations struct for FlagPostVariations
type FlagPostVariations struct {
...
func (o FlagPostVariations) MarshalJSON() ([]byte, error) {
...
type NullableFlagPostVariations struct {
	value *FlagPostVariations
	isSet bool
}

func (v NullableFlagPostVariations) Get() *FlagPostVariations {
	return v.value
}

func (v *NullableFlagPostVariations) Set(val *FlagPostVariations) {
	v.value = val
	v.isSet = true
}

func (v NullableFlagPostVariations) IsSet() bool {
	return v.isSet
}

func (v *NullableFlagPostVariations) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlagPostVariations(val *FlagPostVariations) *NullableFlagPostVariations {
	return &NullableFlagPostVariations{value: val, isSet: true}
}

func (v NullableFlagPostVariations) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlagPostVariations) UnmarshalJSON(src []byte) error {
	v.isSet = true
