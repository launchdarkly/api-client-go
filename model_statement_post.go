...
// checks if the StatementPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatementPost{}
...
type _StatementPost StatementPost
...
func (o StatementPost) ToMap() (map[string]interface{}, error) {
...
func (o *StatementPost) UnmarshalJSON(data []byte) (err error) {
	...
	varStatementPost := _StatementPost{}

	err = json.Unmarshal(data, &varStatementPost)

	if err != nil {
		return err
	}

	*o = StatementPost(varStatementPost)
