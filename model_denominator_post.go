...
// checks if the DenominatorPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DenominatorPost{}

// DenominatorPost struct for DenominatorPost
...
type _DenominatorPost DenominatorPost
...
// SetFilters gets a reference to the given EventFilter and assigns it to the Filters field.
...
func (o *DenominatorPost) GetWinsorExcludeImputed() bool {
...
// and a boolean to check if the value has been set.
func (o *DenominatorPost) GetWinsorExcludeImputedOk() (*bool, bool) {
	if o == nil || IsNil(o.WinsorExcludeImputed) {
		return nil, false
	}
...
func (o *DenominatorPost) HasWinsorExcludeImputed() bool {
	if o != nil && !IsNil(o.WinsorExcludeImputed) {
		return true
	}
...
func (o *DenominatorPost) SetWinsorExcludeImputed(v bool) {
...
func (o DenominatorPost) MarshalJSON() ([]byte, error) {
...
func (o DenominatorPost) ToMap() (map[string]interface{}, error) {
...
func (o *DenominatorPost) UnmarshalJSON(data []byte) (err error) {
	varDenominatorPost := _DenominatorPost{}

	err = json.Unmarshal(data, &varDenominatorPost)

	if err != nil {
		return err
	}

	*o = DenominatorPost(varDenominatorPost)
...
type NullableDenominatorPost struct {
	value *DenominatorPost
	isSet bool
}

func (v NullableDenominatorPost) Get() *DenominatorPost {
	return v.value
}

func (v *NullableDenominatorPost) Set(val *DenominatorPost) {
	v.value = val
	v.isSet = true
}

func (v NullableDenominatorPost) IsSet() bool {
	return v.isSet
}

func (v *NullableDenominatorPost) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDenominatorPost(val *DenominatorPost) *NullableDenominatorPost {
	return &NullableDenominatorPost{value: val, isSet: true}
}

func (v NullableDenominatorPost) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDenominatorPost) UnmarshalJSON(src []byte) error {
	v.isSet = true
