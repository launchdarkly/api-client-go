...
// UIBlockElement struct for UIBlockElement
type UIBlockElement struct {
...
func (o UIBlockElement) MarshalJSON() ([]byte, error) {
...
type NullableUIBlockElement struct {
	value *UIBlockElement
	isSet bool
}

func (v NullableUIBlockElement) Get() *UIBlockElement {
	return v.value
}

func (v *NullableUIBlockElement) Set(val *UIBlockElement) {
	v.value = val
	v.isSet = true
}

func (v NullableUIBlockElement) IsSet() bool {
	return v.isSet
}

func (v *NullableUIBlockElement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUIBlockElement(val *UIBlockElement) *NullableUIBlockElement {
	return &NullableUIBlockElement{value: val, isSet: true}
}

func (v NullableUIBlockElement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUIBlockElement) UnmarshalJSON(src []byte) error {
	v.isSet = true
