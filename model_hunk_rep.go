...
// checks if the HunkRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HunkRep{}
...
func (o HunkRep) ToMap() (map[string]interface{}, error) {
...
func (o *HunkRep) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varHunkRep)

	if err != nil {
		return err
	}

	*o = HunkRep(varHunkRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "startingLineNumber")
		delete(additionalProperties, "lines")
		delete(additionalProperties, "projKey")
