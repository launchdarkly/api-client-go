...
// checks if the SimpleHoldoutRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SimpleHoldoutRep{}
...
type _SimpleHoldoutRep SimpleHoldoutRep
...
func (o SimpleHoldoutRep) ToMap() (map[string]interface{}, error) {
...
func (o *SimpleHoldoutRep) UnmarshalJSON(data []byte) (err error) {
	varSimpleHoldoutRep := _SimpleHoldoutRep{}

	err = json.Unmarshal(data, &varSimpleHoldoutRep)

	if err != nil {
		return err
	}

	*o = SimpleHoldoutRep(varSimpleHoldoutRep)
