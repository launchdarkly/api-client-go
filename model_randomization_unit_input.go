...
// checks if the RandomizationUnitInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RandomizationUnitInput{}
...
type _RandomizationUnitInput RandomizationUnitInput
...
func (o *RandomizationUnitInput) GetStandardRandomizationUnit() string {
	if o == nil || IsNil(o.StandardRandomizationUnit) {
		var ret string
		return ret
	}
...
func (o RandomizationUnitInput) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["randomizationUnit"] = o.RandomizationUnit
	if !IsNil(o.Default) {
		toSerialize["default"] = o.Default
	}
	if !IsNil(o.StandardRandomizationUnit) {
...
func (o *RandomizationUnitInput) UnmarshalJSON(data []byte) (err error) {
	...
	varRandomizationUnitInput := _RandomizationUnitInput{}

	err = json.Unmarshal(data, &varRandomizationUnitInput)

	if err != nil {
		return err
	}

	*o = RandomizationUnitInput(varRandomizationUnitInput)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "standardRandomizationUnit")
