...
`func NewExpandableApprovalRequestResponse(id string, version int32, creationDate int64, serviceKind string, reviewStatus string, allReviews []ReviewResponse, notifyMemberIds []string, status string, instructions []map[string]interface{}, conflicts []Conflict, links map[string]Link, ) *ExpandableApprovalRequestResponse`
...
`func (o *ExpandableApprovalRequestResponse) GetLinks() map[string]Link`

GetLinks returns the Links field if non-nil, zero value otherwise.

### GetLinksOk

`func (o *ExpandableApprovalRequestResponse) GetLinksOk() (*map[string]Link, bool)`
...
`func (o *ExpandableApprovalRequestResponse) SetLinks(v map[string]Link)`
...
`func (o *ExpandableApprovalRequestResponse) GetResourceIdentifier() string`

GetResourceIdentifier returns the ResourceIdentifier field if non-nil, zero value otherwise.

### GetResourceIdentifierOk

`func (o *ExpandableApprovalRequestResponse) GetResourceIdentifierOk() (*string, bool)`
...
`func (o *ExpandableApprovalRequestResponse) SetResourceIdentifier(v string)`

SetResourceIdentifier sets ResourceIdentifier field to given value.

### HasResourceIdentifier

`func (o *ExpandableApprovalRequestResponse) HasResourceIdentifier() bool`
