...
// checks if the SdkKeyForPutSdkKeyViews type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdkKeyForPutSdkKeyViews{}

// SdkKeyForPutSdkKeyViews struct for SdkKeyForPutSdkKeyViews
type SdkKeyForPutSdkKeyViews struct {
	Links *ParentAndSelfLinks `json:"_links,omitempty"`
	Kind SdkKeyKind `json:"kind"`
	...
	CreatedByMemberId *string `json:"_createdByMemberId,omitempty"`
	...
	ViewSummaries []ViewSummary `json:"viewSummaries,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SdkKeyForPutSdkKeyViews SdkKeyForPutSdkKeyViews
...
// GetCreatedByMemberId returns the CreatedByMemberId field value if set, zero value otherwise.
func (o *SdkKeyForPutSdkKeyViews) GetCreatedByMemberId() string {
	if o == nil || IsNil(o.CreatedByMemberId) {
		var ret string
		return ret
	}
	return *o.CreatedByMemberId
}

// GetCreatedByMemberIdOk returns a tuple with the CreatedByMemberId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SdkKeyForPutSdkKeyViews) GetCreatedByMemberIdOk() (*string, bool) {
	if o == nil || IsNil(o.CreatedByMemberId) {
		return nil, false
	}
	return o.CreatedByMemberId, true
}
...
// SetCreatedByMemberId gets a reference to the given string and assigns it to the CreatedByMemberId field.
func (o *SdkKeyForPutSdkKeyViews) SetCreatedByMemberId(v string) {
	o.CreatedByMemberId = &v
}
...
// GetViewSummaries returns the ViewSummaries field value if set, zero value otherwise.
func (o *SdkKeyForPutSdkKeyViews) GetViewSummaries() []ViewSummary {
	if o == nil || IsNil(o.ViewSummaries) {
		var ret []ViewSummary
		return ret
	}
	return o.ViewSummaries
}

// GetViewSummariesOk returns a tuple with the ViewSummaries field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SdkKeyForPutSdkKeyViews) GetViewSummariesOk() ([]ViewSummary, bool) {
	if o == nil || IsNil(o.ViewSummaries) {
		return nil, false
	}
	return o.ViewSummaries, true
}
...
// SetViewSummaries gets a reference to the given []ViewSummary and assigns it to the ViewSummaries field.
func (o *SdkKeyForPutSdkKeyViews) SetViewSummaries(v []ViewSummary) {
	o.ViewSummaries = v
}

func (o SdkKeyForPutSdkKeyViews) MarshalJSON() ([]byte, error) {
...
func (o SdkKeyForPutSdkKeyViews) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CreatedByMemberId) {
		toSerialize["_createdByMemberId"] = o.CreatedByMemberId
	}
	toSerialize["_createdAt"] = o.CreatedAt
	toSerialize["_updatedAt"] = o.UpdatedAt
	toSerialize["_version"] = o.Version
	if !IsNil(o.ViewSummaries) {
		toSerialize["viewSummaries"] = o.ViewSummaries
	}
...
func (o *SdkKeyForPutSdkKeyViews) UnmarshalJSON(data []byte) (err error) {
	...
	varSdkKeyForPutSdkKeyViews := _SdkKeyForPutSdkKeyViews{}

	err = json.Unmarshal(data, &varSdkKeyForPutSdkKeyViews)

	if err != nil {
		return err
	}

	*o = SdkKeyForPutSdkKeyViews(varSdkKeyForPutSdkKeyViews)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "_createdByMemberId")
		delete(additionalProperties, "_createdAt")
		delete(additionalProperties, "_updatedAt")
		delete(additionalProperties, "_version")
		delete(additionalProperties, "viewSummaries")
...
type NullableSdkKeyForPutSdkKeyViews struct {
	value *SdkKeyForPutSdkKeyViews
	isSet bool
}

func (v NullableSdkKeyForPutSdkKeyViews) Get() *SdkKeyForPutSdkKeyViews {
	return v.value
}

func (v *NullableSdkKeyForPutSdkKeyViews) Set(val *SdkKeyForPutSdkKeyViews) {
	v.value = val
	v.isSet = true
}

func (v NullableSdkKeyForPutSdkKeyViews) IsSet() bool {
	return v.isSet
}

func (v *NullableSdkKeyForPutSdkKeyViews) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdkKeyForPutSdkKeyViews(val *SdkKeyForPutSdkKeyViews) *NullableSdkKeyForPutSdkKeyViews {
	return &NullableSdkKeyForPutSdkKeyViews{value: val, isSet: true}
}

func (v NullableSdkKeyForPutSdkKeyViews) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdkKeyForPutSdkKeyViews) UnmarshalJSON(src []byte) error {
	v.isSet = true
