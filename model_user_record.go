...
func (o *UserRecord) UnmarshalJSON(data []byte) (err error) {
	varUserRecord := _UserRecord{}

	err = json.Unmarshal(data, &varUserRecord)

	if err != nil {
		return err
	}

	*o = UserRecord(varUserRecord)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "sortValue")
