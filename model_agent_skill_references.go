...
// checks if the AgentSkillReferences type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentSkillReferences{}

// AgentSkillReferences struct for AgentSkillReferences
type AgentSkillReferences struct {
	...
	Items []AgentSkillReference `json:"items"`
	// The total number of references.
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _AgentSkillReferences AgentSkillReferences
...
func (o AgentSkillReferences) MarshalJSON() ([]byte, error) {
...
func (o AgentSkillReferences) ToMap() (map[string]interface{}, error) {
...
func (o *AgentSkillReferences) UnmarshalJSON(data []byte) (err error) {
	...
	varAgentSkillReferences := _AgentSkillReferences{}

	err = json.Unmarshal(data, &varAgentSkillReferences)

	if err != nil {
		return err
	}

	*o = AgentSkillReferences(varAgentSkillReferences)
...
type NullableAgentSkillReferences struct {
	value *AgentSkillReferences
	isSet bool
}

func (v NullableAgentSkillReferences) Get() *AgentSkillReferences {
	return v.value
}

func (v *NullableAgentSkillReferences) Set(val *AgentSkillReferences) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentSkillReferences) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentSkillReferences) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentSkillReferences(val *AgentSkillReferences) *NullableAgentSkillReferences {
	return &NullableAgentSkillReferences{value: val, isSet: true}
}

func (v NullableAgentSkillReferences) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentSkillReferences) UnmarshalJSON(src []byte) error {
	v.isSet = true
