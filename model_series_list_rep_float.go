...
// checks if the SeriesListRepFloat type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SeriesListRepFloat{}

// SeriesListRepFloat struct for SeriesListRepFloat
type SeriesListRepFloat struct {
	...
	Series []map[string]float32 `json:"series"`
	...
	ProjectedSeries []map[string]float32 `json:"projectedSeries,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _SeriesListRepFloat SeriesListRepFloat
...
// GetProjectedSeries returns the ProjectedSeries field value if set, zero value otherwise.
func (o *SeriesListRepFloat) GetProjectedSeries() []map[string]float32 {
	if o == nil || IsNil(o.ProjectedSeries) {
		var ret []map[string]float32
		return ret
	}
	return o.ProjectedSeries
}

// GetProjectedSeriesOk returns a tuple with the ProjectedSeries field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SeriesListRepFloat) GetProjectedSeriesOk() ([]map[string]float32, bool) {
	if o == nil || IsNil(o.ProjectedSeries) {
		return nil, false
	}
	return o.ProjectedSeries, true
}
...
// SetProjectedSeries gets a reference to the given []map[string]float32 and assigns it to the ProjectedSeries field.
func (o *SeriesListRepFloat) SetProjectedSeries(v []map[string]float32) {
	o.ProjectedSeries = v
}

func (o SeriesListRepFloat) MarshalJSON() ([]byte, error) {
...
func (o SeriesListRepFloat) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["_links"] = o.Links
	toSerialize["metadata"] = o.Metadata
	toSerialize["series"] = o.Series
	if !IsNil(o.ProjectedSeries) {
		toSerialize["projectedSeries"] = o.ProjectedSeries
	}
...
func (o *SeriesListRepFloat) UnmarshalJSON(data []byte) (err error) {
	...
	varSeriesListRepFloat := _SeriesListRepFloat{}

	err = json.Unmarshal(data, &varSeriesListRepFloat)

	if err != nil {
		return err
	}

	*o = SeriesListRepFloat(varSeriesListRepFloat)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "projectedSeries")
...
type NullableSeriesListRepFloat struct {
	value *SeriesListRepFloat
	isSet bool
}

func (v NullableSeriesListRepFloat) Get() *SeriesListRepFloat {
	return v.value
}

func (v *NullableSeriesListRepFloat) Set(val *SeriesListRepFloat) {
	v.value = val
	v.isSet = true
}

func (v NullableSeriesListRepFloat) IsSet() bool {
	return v.isSet
}

func (v *NullableSeriesListRepFloat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSeriesListRepFloat(val *SeriesListRepFloat) *NullableSeriesListRepFloat {
	return &NullableSeriesListRepFloat{value: val, isSet: true}
}

func (v NullableSeriesListRepFloat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSeriesListRepFloat) UnmarshalJSON(src []byte) error {
	v.isSet = true
