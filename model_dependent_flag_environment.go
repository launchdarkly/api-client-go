...
// checks if the DependentFlagEnvironment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DependentFlagEnvironment{}
...
type _DependentFlagEnvironment DependentFlagEnvironment
...
func (o DependentFlagEnvironment) ToMap() (map[string]interface{}, error) {
...
func (o *DependentFlagEnvironment) UnmarshalJSON(data []byte) (err error) {
	...
	varDependentFlagEnvironment := _DependentFlagEnvironment{}

	err = json.Unmarshal(data, &varDependentFlagEnvironment)

	if err != nil {
		return err
	}

	*o = DependentFlagEnvironment(varDependentFlagEnvironment)
