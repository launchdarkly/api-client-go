...
// OnRegression struct for OnRegression
type OnRegression struct {
...
func (o OnRegression) MarshalJSON() ([]byte, error) {
...
type NullableOnRegression struct {
	value *OnRegression
	isSet bool
}

func (v NullableOnRegression) Get() *OnRegression {
	return v.value
}

func (v *NullableOnRegression) Set(val *OnRegression) {
	v.value = val
	v.isSet = true
}

func (v NullableOnRegression) IsSet() bool {
	return v.isSet
}

func (v *NullableOnRegression) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOnRegression(val *OnRegression) *NullableOnRegression {
	return &NullableOnRegression{value: val, isSet: true}
}

func (v NullableOnRegression) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOnRegression) UnmarshalJSON(src []byte) error {
	v.isSet = true
