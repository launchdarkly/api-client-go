...
// checks if the LayerRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LayerRep{}
...
func (o LayerRep) ToMap() (map[string]interface{}, error) {
...
func (o *LayerRep) UnmarshalJSON(data []byte) (err error) {
	...
	varLayerRep := _LayerRep{}

	err = json.Unmarshal(data, &varLayerRep)

	if err != nil {
		return err
	}

	*o = LayerRep(varLayerRep)
