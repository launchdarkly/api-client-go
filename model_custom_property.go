...
type _CustomProperty CustomProperty
...
func (o *CustomProperty) UnmarshalJSON(data []byte) (err error) {
	...
	varCustomProperty := _CustomProperty{}

	err = json.Unmarshal(data, &varCustomProperty)

	if err != nil {
		return err
	}

	*o = CustomProperty(varCustomProperty)
