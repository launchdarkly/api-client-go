...
// checks if the ViewLinkRequestSegmentIdentifier type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ViewLinkRequestSegmentIdentifier{}

// ViewLinkRequestSegmentIdentifier struct for ViewLinkRequestSegmentIdentifier
type ViewLinkRequestSegmentIdentifier struct {
	EnvironmentId string `json:"environmentId"`
	SegmentKey string `json:"segmentKey"`
	AdditionalProperties map[string]interface{}
}

type _ViewLinkRequestSegmentIdentifier ViewLinkRequestSegmentIdentifier
...
func NewViewLinkRequestSegmentIdentifier(environmentId string, segmentKey string) *ViewLinkRequestSegmentIdentifier {
	this := ViewLinkRequestSegmentIdentifier{}
...
func (o ViewLinkRequestSegmentIdentifier) MarshalJSON() ([]byte, error) {
...
func (o ViewLinkRequestSegmentIdentifier) ToMap() (map[string]interface{}, error) {
...
func (o *ViewLinkRequestSegmentIdentifier) UnmarshalJSON(data []byte) (err error) {
	...
	varViewLinkRequestSegmentIdentifier := _ViewLinkRequestSegmentIdentifier{}

	err = json.Unmarshal(data, &varViewLinkRequestSegmentIdentifier)

	if err != nil {
		return err
	}

	*o = ViewLinkRequestSegmentIdentifier(varViewLinkRequestSegmentIdentifier)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "environmentId")
		delete(additionalProperties, "segmentKey")
...
type NullableViewLinkRequestSegmentIdentifier struct {
	value *ViewLinkRequestSegmentIdentifier
	isSet bool
}

func (v NullableViewLinkRequestSegmentIdentifier) Get() *ViewLinkRequestSegmentIdentifier {
	return v.value
}

func (v *NullableViewLinkRequestSegmentIdentifier) Set(val *ViewLinkRequestSegmentIdentifier) {
	v.value = val
	v.isSet = true
}

func (v NullableViewLinkRequestSegmentIdentifier) IsSet() bool {
	return v.isSet
}

func (v *NullableViewLinkRequestSegmentIdentifier) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableViewLinkRequestSegmentIdentifier(val *ViewLinkRequestSegmentIdentifier) *NullableViewLinkRequestSegmentIdentifier {
	return &NullableViewLinkRequestSegmentIdentifier{value: val, isSet: true}
}

func (v NullableViewLinkRequestSegmentIdentifier) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableViewLinkRequestSegmentIdentifier) UnmarshalJSON(src []byte) error {
	v.isSet = true
