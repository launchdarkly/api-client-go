...
// checks if the PullRequestRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PullRequestRep{}
...
type _PullRequestRep PullRequestRep
...
func (o *PullRequestRep) GetMergeCommitKey() string {
	if o == nil || IsNil(o.MergeCommitKey) {
		var ret string
		return ret
	}
...
func (o PullRequestRep) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MergeTime) {
		toSerialize["mergeTime"] = o.MergeTime
	}
	if !IsNil(o.MergeCommitKey) {
...
func (o *PullRequestRep) UnmarshalJSON(data []byte) (err error) {
	...
	varPullRequestRep := _PullRequestRep{}

	err = json.Unmarshal(data, &varPullRequestRep)

	if err != nil {
		return err
	}

	*o = PullRequestRep(varPullRequestRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "mergeTime")
		delete(additionalProperties, "mergeCommitKey")
		delete(additionalProperties, "baseCommitKey")
		delete(additionalProperties, "headCommitKey")
		delete(additionalProperties, "filesChanged")
		delete(additionalProperties, "linesAdded")
		delete(additionalProperties, "linesDeleted")
		delete(additionalProperties, "url")
		delete(additionalProperties, "deployments")
		delete(additionalProperties, "flagReferences")
