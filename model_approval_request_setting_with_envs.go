...
// checks if the ApprovalRequestSettingWithEnvs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApprovalRequestSettingWithEnvs{}

// ApprovalRequestSettingWithEnvs struct for ApprovalRequestSettingWithEnvs
type ApprovalRequestSettingWithEnvs struct {
	// Environment-specific overrides.
	Environments *map[string]ApprovalRequestSetting `json:"environments,omitempty"`
	Default *ApprovalRequestSetting `json:"_default,omitempty"`
	Strict *ApprovalRequestSetting `json:"_strict,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _ApprovalRequestSettingWithEnvs ApprovalRequestSettingWithEnvs
...
func NewApprovalRequestSettingWithEnvs() *ApprovalRequestSettingWithEnvs {
	this := ApprovalRequestSettingWithEnvs{}
	return &this
}
...
func (o *ApprovalRequestSettingWithEnvs) GetEnvironments() map[string]ApprovalRequestSetting {
	if o == nil || IsNil(o.Environments) {
		var ret map[string]ApprovalRequestSetting
		return ret
	}
...
// SetEnvironments gets a reference to the given map[string]ApprovalRequestSetting and assigns it to the Environments field.
...
func (o *ApprovalRequestSettingWithEnvs) GetDefault() ApprovalRequestSetting {
	if o == nil || IsNil(o.Default) {
		var ret ApprovalRequestSetting
		return ret
	}
	return *o.Default
}
...
// SetDefault gets a reference to the given ApprovalRequestSetting and assigns it to the Default field.
...
// SetStrict gets a reference to the given ApprovalRequestSetting and assigns it to the Strict field.
func (o *ApprovalRequestSettingWithEnvs) SetStrict(v ApprovalRequestSetting) {
	o.Strict = &v
}

func (o ApprovalRequestSettingWithEnvs) MarshalJSON() ([]byte, error) {
...
func (o ApprovalRequestSettingWithEnvs) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.Environments) {
		toSerialize["environments"] = o.Environments
	}
	if !IsNil(o.Default) {
		toSerialize["_default"] = o.Default
	}
	if !IsNil(o.Strict) {
		toSerialize["_strict"] = o.Strict
	}
...
func (o *ApprovalRequestSettingWithEnvs) UnmarshalJSON(data []byte) (err error) {
	varApprovalRequestSettingWithEnvs := _ApprovalRequestSettingWithEnvs{}

	err = json.Unmarshal(data, &varApprovalRequestSettingWithEnvs)

	if err != nil {
		return err
	}

	*o = ApprovalRequestSettingWithEnvs(varApprovalRequestSettingWithEnvs)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "environments")
		delete(additionalProperties, "_default")
		delete(additionalProperties, "_strict")
...
type NullableApprovalRequestSettingWithEnvs struct {
	value *ApprovalRequestSettingWithEnvs
	isSet bool
}

func (v NullableApprovalRequestSettingWithEnvs) Get() *ApprovalRequestSettingWithEnvs {
	return v.value
}

func (v *NullableApprovalRequestSettingWithEnvs) Set(val *ApprovalRequestSettingWithEnvs) {
	v.value = val
	v.isSet = true
}

func (v NullableApprovalRequestSettingWithEnvs) IsSet() bool {
	return v.isSet
}

func (v *NullableApprovalRequestSettingWithEnvs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApprovalRequestSettingWithEnvs(val *ApprovalRequestSettingWithEnvs) *NullableApprovalRequestSettingWithEnvs {
	return &NullableApprovalRequestSettingWithEnvs{value: val, isSet: true}
}

func (v NullableApprovalRequestSettingWithEnvs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApprovalRequestSettingWithEnvs) UnmarshalJSON(src []byte) error {
	v.isSet = true
