...
// checks if the InsightPeriod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightPeriod{}
...
type _InsightPeriod InsightPeriod
...
func (o InsightPeriod) ToMap() (map[string]interface{}, error) {
...
func (o *InsightPeriod) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightPeriod := _InsightPeriod{}

	err = json.Unmarshal(data, &varInsightPeriod)

	if err != nil {
		return err
	}

	*o = InsightPeriod(varInsightPeriod)
...
func NewNullableInsightPeriod(val *InsightPeriod) *NullableInsightPeriod {
	return &NullableInsightPeriod{value: val, isSet: true}
}
