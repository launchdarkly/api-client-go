...
// LayersBetaApiService LayersBetaApi service
type LayersBetaApiService service

type ApiCreateLayerRequest struct {
	ctx context.Context
	ApiService LayersBetaApi
	projectKey string
	layerPost *LayerPost
}
...
Create a layer. Experiments running in the same layer are granted mutually-exclusive traffic.
 ...
 @return ApiCreateLayerRequest
*/
func (a *LayersBetaApiService) CreateLayer(ctx context.Context, projectKey string) ApiCreateLayerRequest {
	return ApiCreateLayerRequest{
		ApiService: a,
		ctx: ctx,
...
//  @return LayerRep
func (a *LayersBetaApiService) CreateLayerExecute(r ApiCreateLayerRequest) (*LayerRep, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LayersBetaApiService.CreateLayer")
	if err != nil {
...
Get a collection of all layers for a project
 ...
 @return ApiGetLayersRequest
*/
func (a *LayersBetaApiService) GetLayers(ctx context.Context, projectKey string) ApiGetLayersRequest {
	return ApiGetLayersRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return LayerCollectionRep
func (a *LayersBetaApiService) GetLayersExecute(r ApiGetLayersRequest) (*LayerCollectionRep, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LayersBetaApiService.GetLayers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
```
 ...
 @return ApiUpdateLayerRequest
*/
func (a *LayersBetaApiService) UpdateLayer(ctx context.Context, projectKey string, layerKey string) ApiUpdateLayerRequest {
	return ApiUpdateLayerRequest{
		ApiService: a,
		ctx: ctx,
		projectKey: projectKey,
...
// Execute executes the request
//  @return LayerRep
func (a *LayersBetaApiService) UpdateLayerExecute(r ApiUpdateLayerRequest) (*LayerRep, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LayersBetaApiService.UpdateLayer")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
