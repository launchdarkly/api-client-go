...
// checks if the WarehouseDestinationSetupScriptRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WarehouseDestinationSetupScriptRep{}

// WarehouseDestinationSetupScriptRep struct for WarehouseDestinationSetupScriptRep
type WarehouseDestinationSetupScriptRep struct {
	...
	PublicKeyPkcs8 *string `json:"publicKeyPkcs8,omitempty"`
	// For Redshift, present only when clusterIdentifier, clusterRegion, and clusterAwsAccountId are supplied in the request body.
	RedshiftIAMPermissionsPolicy *string `json:"redshiftIAMPermissionsPolicy,omitempty"`
	// For Redshift, present only when clusterIdentifier, clusterRegion, and clusterAwsAccountId are supplied in the request body.
	RedshiftIAMTrustPolicy *string `json:"redshiftIAMTrustPolicy,omitempty"`
	// The auto-generated S3 staging bucket name (ClickHouse and Redshift)
	S3BucketName *string `json:"s3BucketName,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _WarehouseDestinationSetupScriptRep WarehouseDestinationSetupScriptRep
...
func NewWarehouseDestinationSetupScriptRep() *WarehouseDestinationSetupScriptRep {
	this := WarehouseDestinationSetupScriptRep{}
	return &this
}
...
// GetPublicKeyPkcs8 returns the PublicKeyPkcs8 field value if set, zero value otherwise.
func (o *WarehouseDestinationSetupScriptRep) GetPublicKeyPkcs8() string {
	if o == nil || IsNil(o.PublicKeyPkcs8) {
		var ret string
		return ret
	}
	return *o.PublicKeyPkcs8
}

// GetPublicKeyPkcs8Ok returns a tuple with the PublicKeyPkcs8 field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WarehouseDestinationSetupScriptRep) GetPublicKeyPkcs8Ok() (*string, bool) {
	if o == nil || IsNil(o.PublicKeyPkcs8) {
		return nil, false
	}
	return o.PublicKeyPkcs8, true
}
...
// SetPublicKeyPkcs8 gets a reference to the given string and assigns it to the PublicKeyPkcs8 field.
func (o *WarehouseDestinationSetupScriptRep) SetPublicKeyPkcs8(v string) {
	o.PublicKeyPkcs8 = &v
}

// GetRedshiftIAMPermissionsPolicy returns the RedshiftIAMPermissionsPolicy field value if set, zero value otherwise.
func (o *WarehouseDestinationSetupScriptRep) GetRedshiftIAMPermissionsPolicy() string {
	if o == nil || IsNil(o.RedshiftIAMPermissionsPolicy) {
		var ret string
		return ret
	}
	return *o.RedshiftIAMPermissionsPolicy
}

// GetRedshiftIAMPermissionsPolicyOk returns a tuple with the RedshiftIAMPermissionsPolicy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WarehouseDestinationSetupScriptRep) GetRedshiftIAMPermissionsPolicyOk() (*string, bool) {
	if o == nil || IsNil(o.RedshiftIAMPermissionsPolicy) {
		return nil, false
	}
	return o.RedshiftIAMPermissionsPolicy, true
}
...
// SetRedshiftIAMPermissionsPolicy gets a reference to the given string and assigns it to the RedshiftIAMPermissionsPolicy field.
func (o *WarehouseDestinationSetupScriptRep) SetRedshiftIAMPermissionsPolicy(v string) {
	o.RedshiftIAMPermissionsPolicy = &v
}

// GetRedshiftIAMTrustPolicy returns the RedshiftIAMTrustPolicy field value if set, zero value otherwise.
func (o *WarehouseDestinationSetupScriptRep) GetRedshiftIAMTrustPolicy() string {
	if o == nil || IsNil(o.RedshiftIAMTrustPolicy) {
		var ret string
		return ret
	}
	return *o.RedshiftIAMTrustPolicy
}

// GetRedshiftIAMTrustPolicyOk returns a tuple with the RedshiftIAMTrustPolicy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WarehouseDestinationSetupScriptRep) GetRedshiftIAMTrustPolicyOk() (*string, bool) {
	if o == nil || IsNil(o.RedshiftIAMTrustPolicy) {
		return nil, false
	}
	return o.RedshiftIAMTrustPolicy, true
}
...
// SetRedshiftIAMTrustPolicy gets a reference to the given string and assigns it to the RedshiftIAMTrustPolicy field.
func (o *WarehouseDestinationSetupScriptRep) SetRedshiftIAMTrustPolicy(v string) {
	o.RedshiftIAMTrustPolicy = &v
}
...
func (o WarehouseDestinationSetupScriptRep) MarshalJSON() ([]byte, error) {
...
func (o WarehouseDestinationSetupScriptRep) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PublicKeyPkcs8) {
		toSerialize["publicKeyPkcs8"] = o.PublicKeyPkcs8
	}
	if !IsNil(o.RedshiftIAMPermissionsPolicy) {
		toSerialize["redshiftIAMPermissionsPolicy"] = o.RedshiftIAMPermissionsPolicy
	}
	if !IsNil(o.RedshiftIAMTrustPolicy) {
		toSerialize["redshiftIAMTrustPolicy"] = o.RedshiftIAMTrustPolicy
	}
...
func (o *WarehouseDestinationSetupScriptRep) UnmarshalJSON(data []byte) (err error) {
	varWarehouseDestinationSetupScriptRep := _WarehouseDestinationSetupScriptRep{}

	err = json.Unmarshal(data, &varWarehouseDestinationSetupScriptRep)

	if err != nil {
		return err
	}

	*o = WarehouseDestinationSetupScriptRep(varWarehouseDestinationSetupScriptRep)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "publicKeyPkcs8")
		delete(additionalProperties, "redshiftIAMPermissionsPolicy")
		delete(additionalProperties, "redshiftIAMTrustPolicy")
		delete(additionalProperties, "s3BucketName")
...
type NullableWarehouseDestinationSetupScriptRep struct {
	value *WarehouseDestinationSetupScriptRep
	isSet bool
}

func (v NullableWarehouseDestinationSetupScriptRep) Get() *WarehouseDestinationSetupScriptRep {
	return v.value
}

func (v *NullableWarehouseDestinationSetupScriptRep) Set(val *WarehouseDestinationSetupScriptRep) {
	v.value = val
	v.isSet = true
}

func (v NullableWarehouseDestinationSetupScriptRep) IsSet() bool {
	return v.isSet
}

func (v *NullableWarehouseDestinationSetupScriptRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWarehouseDestinationSetupScriptRep(val *WarehouseDestinationSetupScriptRep) *NullableWarehouseDestinationSetupScriptRep {
	return &NullableWarehouseDestinationSetupScriptRep{value: val, isSet: true}
}

func (v NullableWarehouseDestinationSetupScriptRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWarehouseDestinationSetupScriptRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
