...
// checks if the FlagTriggerInput type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagTriggerInput{}
...
type _FlagTriggerInput FlagTriggerInput
...
func (o FlagTriggerInput) ToMap() (map[string]interface{}, error) {
...
func (o *FlagTriggerInput) UnmarshalJSON(data []byte) (err error) {
	varFlagTriggerInput := _FlagTriggerInput{}

	err = json.Unmarshal(data, &varFlagTriggerInput)

	if err != nil {
		return err
	}

	*o = FlagTriggerInput(varFlagTriggerInput)
