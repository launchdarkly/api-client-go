...
// checks if the ReleasePoliciesAccessDenied type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReleasePoliciesAccessDenied{}

// ReleasePoliciesAccessDenied struct for ReleasePoliciesAccessDenied
type ReleasePoliciesAccessDenied struct {
	Action string `json:"action"`
	Reason ReleasePoliciesAccessDeniedReason `json:"reason"`
	AdditionalProperties map[string]interface{}
}

type _ReleasePoliciesAccessDenied ReleasePoliciesAccessDenied
...
func NewReleasePoliciesAccessDenied(action string, reason ReleasePoliciesAccessDeniedReason) *ReleasePoliciesAccessDenied {
	this := ReleasePoliciesAccessDenied{}
	this.Action = action
	this.Reason = reason
	return &this
}
...
func (o *ReleasePoliciesAccessDenied) GetReason() ReleasePoliciesAccessDeniedReason {
	if o == nil {
		var ret ReleasePoliciesAccessDeniedReason
		return ret
	}
...
func (o ReleasePoliciesAccessDenied) MarshalJSON() ([]byte, error) {
...
func (o ReleasePoliciesAccessDenied) ToMap() (map[string]interface{}, error) {
...
func (o *ReleasePoliciesAccessDenied) UnmarshalJSON(data []byte) (err error) {
	...
	varReleasePoliciesAccessDenied := _ReleasePoliciesAccessDenied{}

	err = json.Unmarshal(data, &varReleasePoliciesAccessDenied)

	if err != nil {
		return err
	}

	*o = ReleasePoliciesAccessDenied(varReleasePoliciesAccessDenied)
...
type NullableReleasePoliciesAccessDenied struct {
	value *ReleasePoliciesAccessDenied
	isSet bool
}

func (v NullableReleasePoliciesAccessDenied) Get() *ReleasePoliciesAccessDenied {
	return v.value
}

func (v *NullableReleasePoliciesAccessDenied) Set(val *ReleasePoliciesAccessDenied) {
	v.value = val
	v.isSet = true
}

func (v NullableReleasePoliciesAccessDenied) IsSet() bool {
	return v.isSet
}

func (v *NullableReleasePoliciesAccessDenied) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReleasePoliciesAccessDenied(val *ReleasePoliciesAccessDenied) *NullableReleasePoliciesAccessDenied {
	return &NullableReleasePoliciesAccessDenied{value: val, isSet: true}
}

func (v NullableReleasePoliciesAccessDenied) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReleasePoliciesAccessDenied) UnmarshalJSON(src []byte) error {
	v.isSet = true
