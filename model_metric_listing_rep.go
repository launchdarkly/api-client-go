...
// checks if the MetricListingRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricListingRep{}
...
type _MetricListingRep MetricListingRep
...
func (o *MetricListingRep) GetWinsorExcludeImputed() bool {
...
// and a boolean to check if the value has been set.
func (o *MetricListingRep) GetWinsorExcludeImputedOk() (*bool, bool) {
	if o == nil || IsNil(o.WinsorExcludeImputed) {
		return nil, false
	}
...
func (o *MetricListingRep) HasWinsorExcludeImputed() bool {
	if o != nil && !IsNil(o.WinsorExcludeImputed) {
		return true
	}
...
func (o *MetricListingRep) SetWinsorExcludeImputed(v bool) {
...
func (o MetricListingRep) ToMap() (map[string]interface{}, error) {
...
func (o *MetricListingRep) UnmarshalJSON(data []byte) (err error) {
	...
	varMetricListingRep := _MetricListingRep{}

	err = json.Unmarshal(data, &varMetricListingRep)

	if err != nil {
		return err
	}

	*o = MetricListingRep(varMetricListingRep)
