...
// checks if the MetricV2Rep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetricV2Rep{}
...
func (o *MetricV2Rep) GetAnalysisUnit() string {
...
// and a boolean to check if the value has been set.
func (o *MetricV2Rep) GetAnalysisUnitOk() (*string, bool) {
	if o == nil || IsNil(o.AnalysisUnit) {
		return nil, false
	}
...
func (o *MetricV2Rep) HasAnalysisUnit() bool {
	if o != nil && !IsNil(o.AnalysisUnit) {
		return true
	}
...
func (o *MetricV2Rep) SetAnalysisUnit(v string) {
	o.AnalysisUnit = &v
}
...
func (o MetricV2Rep) ToMap() (map[string]interface{}, error) {
...
func (o *MetricV2Rep) UnmarshalJSON(data []byte) (err error) {
	...
	varMetricV2Rep := _MetricV2Rep{}

	err = json.Unmarshal(data, &varMetricV2Rep)

	if err != nil {
		return err
	}

	*o = MetricV2Rep(varMetricV2Rep)
