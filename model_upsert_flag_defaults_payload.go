...
// checks if the UpsertFlagDefaultsPayload type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpsertFlagDefaultsPayload{}
...
type _UpsertFlagDefaultsPayload UpsertFlagDefaultsPayload
...
func (o UpsertFlagDefaultsPayload) ToMap() (map[string]interface{}, error) {
...
func (o *UpsertFlagDefaultsPayload) UnmarshalJSON(data []byte) (err error) {
	...
	varUpsertFlagDefaultsPayload := _UpsertFlagDefaultsPayload{}

	err = json.Unmarshal(data, &varUpsertFlagDefaultsPayload)

	if err != nil {
		return err
	}

	*o = UpsertFlagDefaultsPayload(varUpsertFlagDefaultsPayload)
