...
// ExperimentQuantileResultsRep struct for ExperimentQuantileResultsRep
type ExperimentQuantileResultsRep struct {
	// The location and content type of related resources
	Links *map[string]Link `json:"_links,omitempty"`
	// A list of the results for each treatment
	TreatmentResults []TreatmentQuantileResultRep `json:"treatmentResults,omitempty"`
	// The target percentile
	Percentile *int64 `json:"percentile,omitempty"`
	// The confidence level of percentile interval
...
func NewExperimentQuantileResultsRep() *ExperimentQuantileResultsRep {
	this := ExperimentQuantileResultsRep{}
	return &this
}
...
func (o *ExperimentQuantileResultsRep) GetTreatmentResults() []TreatmentQuantileResultRep {
	if o == nil || o.TreatmentResults == nil {
		var ret []TreatmentQuantileResultRep
		return ret
	}
...
// SetTreatmentResults gets a reference to the given []TreatmentQuantileResultRep and assigns it to the TreatmentResults field.
...
// SetConfidence gets a reference to the given int64 and assigns it to the Confidence field.
...
func (o ExperimentQuantileResultsRep) MarshalJSON() ([]byte, error) {
...
type NullableExperimentQuantileResultsRep struct {
	value *ExperimentQuantileResultsRep
	isSet bool
}

func (v NullableExperimentQuantileResultsRep) Get() *ExperimentQuantileResultsRep {
	return v.value
}

func (v *NullableExperimentQuantileResultsRep) Set(val *ExperimentQuantileResultsRep) {
	v.value = val
	v.isSet = true
}

func (v NullableExperimentQuantileResultsRep) IsSet() bool {
	return v.isSet
}

func (v *NullableExperimentQuantileResultsRep) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExperimentQuantileResultsRep(val *ExperimentQuantileResultsRep) *NullableExperimentQuantileResultsRep {
	return &NullableExperimentQuantileResultsRep{value: val, isSet: true}
}

func (v NullableExperimentQuantileResultsRep) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExperimentQuantileResultsRep) UnmarshalJSON(src []byte) error {
	v.isSet = true
