...
// checks if the ExpandedLinkedResources type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpandedLinkedResources{}

// ExpandedLinkedResources Details on linked resources for a view - requires passing the 'allResources' expand field
type ExpandedLinkedResources struct {
	Items ExpandedLinkedResourcesItems `json:"items"`
	TotalCount int32 `json:"totalCount"`
	AdditionalProperties map[string]interface{}
}

type _ExpandedLinkedResources ExpandedLinkedResources
...
func (o *ExpandedLinkedResources) GetItems() ExpandedLinkedResourcesItems {
	if o == nil {
		var ret ExpandedLinkedResourcesItems
		return ret
	}
...
func (o ExpandedLinkedResources) MarshalJSON() ([]byte, error) {
...
func (o ExpandedLinkedResources) ToMap() (map[string]interface{}, error) {
...
func (o *ExpandedLinkedResources) UnmarshalJSON(data []byte) (err error) {
	...
	varExpandedLinkedResources := _ExpandedLinkedResources{}

	err = json.Unmarshal(data, &varExpandedLinkedResources)

	if err != nil {
		return err
	}

	*o = ExpandedLinkedResources(varExpandedLinkedResources)
...
type NullableExpandedLinkedResources struct {
	value *ExpandedLinkedResources
	isSet bool
}

func (v NullableExpandedLinkedResources) Get() *ExpandedLinkedResources {
	return v.value
}

func (v *NullableExpandedLinkedResources) Set(val *ExpandedLinkedResources) {
	v.value = val
	v.isSet = true
}

func (v NullableExpandedLinkedResources) IsSet() bool {
	return v.isSet
}

func (v *NullableExpandedLinkedResources) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpandedLinkedResources(val *ExpandedLinkedResources) *NullableExpandedLinkedResources {
	return &NullableExpandedLinkedResources{value: val, isSet: true}
}

func (v NullableExpandedLinkedResources) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpandedLinkedResources) UnmarshalJSON(src []byte) error {
	v.isSet = true
