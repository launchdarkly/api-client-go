...
// checks if the InsightsMetricScore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InsightsMetricScore{}
...
type _InsightsMetricScore InsightsMetricScore
...
func (o *InsightsMetricScore) GetDiffVsLastPeriod() int32 {
	if o == nil || IsNil(o.DiffVsLastPeriod) {
		var ret int32
		return ret
	}
...
func (o *InsightsMetricScore) UnmarshalJSON(data []byte) (err error) {
	...
	varInsightsMetricScore := _InsightsMetricScore{}

	err = json.Unmarshal(data, &varInsightsMetricScore)

	if err != nil {
		return err
	}

	*o = InsightsMetricScore(varInsightsMetricScore)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "score")
		delete(additionalProperties, "aggregateOf")
		delete(additionalProperties, "diffVsLastPeriod")
		delete(additionalProperties, "indicator")
		delete(additionalProperties, "indicatorRange")
