...
// checks if the VersionsRep type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VersionsRep{}
...
func (o VersionsRep) ToMap() (map[string]interface{}, error) {
...
func (o *VersionsRep) UnmarshalJSON(data []byte) (err error) {
	...
	varVersionsRep := _VersionsRep{}

	err = json.Unmarshal(data, &varVersionsRep)

	if err != nil {
		return err
	}

	*o = VersionsRep(varVersionsRep)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "validVersions")
