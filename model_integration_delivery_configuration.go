...
// checks if the IntegrationDeliveryConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntegrationDeliveryConfiguration{}
...
type _IntegrationDeliveryConfiguration IntegrationDeliveryConfiguration
...
func (o IntegrationDeliveryConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *IntegrationDeliveryConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varIntegrationDeliveryConfiguration := _IntegrationDeliveryConfiguration{}

	err = json.Unmarshal(data, &varIntegrationDeliveryConfiguration)

	if err != nil {
		return err
	}

	*o = IntegrationDeliveryConfiguration(varIntegrationDeliveryConfiguration)
