...
// checks if the FlagSempatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlagSempatch{}

// FlagSempatch struct for FlagSempatch
type FlagSempatch struct {
	Instructions []map[string]interface{} `json:"instructions"`
	Comment *string `json:"comment,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _FlagSempatch FlagSempatch
...
func (o FlagSempatch) ToMap() (map[string]interface{}, error) {
...
func (o *FlagSempatch) UnmarshalJSON(data []byte) (err error) {
	...
	varFlagSempatch := _FlagSempatch{}

	err = json.Unmarshal(data, &varFlagSempatch)

	if err != nil {
		return err
	}

	*o = FlagSempatch(varFlagSempatch)
...
func NewNullableFlagSempatch(val *FlagSempatch) *NullableFlagSempatch {
	return &NullableFlagSempatch{value: val, isSet: true}
}
