...
*/
func (a *TeamsBetaApiService) DeleteTeam(ctx _context.Context, teamKey string) ApiDeleteTeamRequest {
	return ApiDeleteTeamRequest{
		ApiService: a,
		ctx: ctx,
		teamKey: teamKey,
...
func (a *TeamsBetaApiService) DeleteTeamExecute(r ApiDeleteTeamRequest) (*_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"teamKey"+"}", _neturl.PathEscape(parameterToString(r.teamKey, "")), -1)
...
func (r ApiGetTeamRequest) Execute() (Team, *_nethttp.Response, error) {
...
*/
func (a *TeamsBetaApiService) GetTeam(ctx _context.Context, teamKey string) ApiGetTeamRequest {
	return ApiGetTeamRequest{
		ApiService: a,
		ctx: ctx,
		teamKey: teamKey,
...
// Execute executes the request
//  @return Team
func (a *TeamsBetaApiService) GetTeamExecute(r ApiGetTeamRequest) (Team, *_nethttp.Response, error) {
	var (
...
func (r ApiGetTeamMaintainersRequest) Execute() (TeamMaintainers, *_nethttp.Response, error) {
...
*/
func (a *TeamsBetaApiService) GetTeamMaintainers(ctx _context.Context, teamKey string) ApiGetTeamMaintainersRequest {
	return ApiGetTeamMaintainersRequest{
		ApiService: a,
		ctx: ctx,
		teamKey: teamKey,
...
func (a *TeamsBetaApiService) GetTeamMaintainersExecute(r ApiGetTeamMaintainersRequest) (TeamMaintainers, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamsBetaApiService.GetTeamMaintainers")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetTeamRolesRequest) Execute() (TeamCustomRoles, *_nethttp.Response, error) {
...
*/
func (a *TeamsBetaApiService) GetTeamRoles(ctx _context.Context, teamKey string) ApiGetTeamRolesRequest {
	return ApiGetTeamRolesRequest{
		ApiService: a,
		ctx: ctx,
		teamKey: teamKey,
...
func (a *TeamsBetaApiService) GetTeamRolesExecute(r ApiGetTeamRolesRequest) (TeamCustomRoles, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TeamsBetaApiService.GetTeamRoles")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetTeamsRequest) Execute() (Teams, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return Teams
func (a *TeamsBetaApiService) GetTeamsExecute(r ApiGetTeamsRequest) (Teams, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiPatchTeamRequest) Execute() (Team, *_nethttp.Response, error) {
...
*/
func (a *TeamsBetaApiService) PatchTeam(ctx _context.Context, teamKey string) ApiPatchTeamRequest {
	return ApiPatchTeamRequest{
		ApiService: a,
		ctx: ctx,
		teamKey: teamKey,
...
// Execute executes the request
//  @return Team
func (a *TeamsBetaApiService) PatchTeamExecute(r ApiPatchTeamRequest) (Team, *_nethttp.Response, error) {
	var (
...
func (r ApiPostTeamRequest) Execute() (Team, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return Team
func (a *TeamsBetaApiService) PostTeamExecute(r ApiPostTeamRequest) (Team, *_nethttp.Response, error) {
	var (
...
*/
func (a *TeamsBetaApiService) PostTeamMembers(ctx _context.Context, teamKey string) ApiPostTeamMembersRequest {
	return ApiPostTeamMembersRequest{
		ApiService: a,
		ctx: ctx,
		teamKey: teamKey,
